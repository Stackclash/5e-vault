  ...
  - name: Warlock
    ...
    spells:
      ...
      - name: "[[5. Mechanics/Spells/Eldritch Blast.md|Eldritch Blast]]"
        level: 0
        isPrepared: true
      - name: "[[5. Mechanics/Spells/Thunderclap.md|Thunderclap]]"
        level: 0
        isPrepared: true
      ...
      - name: "[[5. Mechanics/Spells/Armor Of Agathys.md|Armor Of Agathys]]"
        level: 1
        isPrepared: false
      - name: "[[5. Mechanics/Spells/Cloud Of Daggers.md|Cloud Of Daggers]]"
        level: 2
        isPrepared: false
      - name: "[[5. Mechanics/Spells/Remove Curse.md|Remove Curse]]"
        level: 3
        isPrepared: false
      - name: "[[5. Mechanics/Spells/Dispel Magic.md|Dispel Magic]]"
        level: 3
        isPrepared: false
currencies:
  cp: 70
...
abilities:
  - label: strength
    value: "{{frontmatter.abilityScores.strength.value}}"
proficiencies:
  - charisma
  - wisdom
```
...
const codeblock = `\`\`\`skills
proficiencies:
  - ${Object.keys(context.bound.skills).reduce((acc, curr) => {
      if (context.bound.skills[curr].proficiency) acc.push(curr)
      return acc
    }, []).join('\n  - ')}
expertise:
  - ${Object.keys(context.bound.skills).reduce((acc, curr) => {
      if (context.bound.skills[curr].expertise) acc.push(curr)
      return acc
    }, []).join('\n  - ')}
\`\`\``
