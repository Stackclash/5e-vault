...
classes:
  - name: "[[5. Mechanics/Classes/Rogue.md|Rogue]]"
    subClass: "[[5. Mechanics/Classes/Rogue Swashbuckler (XGE).md|Rogue Swashbuckler (XGE)]]"
    level: 10
abilityScores:
  strength:
    value: 8
