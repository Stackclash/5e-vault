...
>  |
>  ---|---|
> **Party Location** | `$= await dv.view('partyLocation', { current: dv.current() })` |
...
`$= await dv.view('utils/editingView', {current: dv.current(), type: 'number', field: 'travel_bonus', options: ['class(mb-25)']})`
## **Characters**
> [!cards|dataview 3]
>```dataview
> TABLE WITHOUT ID
