  ...
  "node_modules/lodash.clonedeep/index.js"(exports, module2) {
    ...
    function arrayLikeKeys(value, inherited) {
      ...
      for (var key in value) {
        if ((inherited || hasOwnProperty4.call(value, key)) && !(skipIndexes && (key == "length" || isIndex(key, length)))) {
          result.push(key);
        }
      }
      return result;
    ...
    if (DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag || Map2 && getTag(new Map2()) != mapTag || Promise2 && getTag(Promise2.resolve()) != promiseTag || Set2 && getTag(new Set2()) != setTag || WeakMap2 && getTag(new WeakMap2()) != weakMapTag) {
      getTag = function(value) {
        var result = objectToString3.call(value), Ctor = result == objectTag ? value.constructor : void 0, ctorString = Ctor ? toSource(Ctor) : void 0;
        if (ctorString) {
          switch (ctorString) {
    ...
    function isArguments(value) {
      return isArrayLikeObject(value) && hasOwnProperty4.call(value, "callee") && (!propertyIsEnumerable.call(value, "callee") || objectToString3.call(value) == argsTag);
    }
...
var DateTokenType = /* @__PURE__ */ ((DateTokenType2) => {
  DateTokenType2["number"] = "NUMBER";
  DateTokenType2["string"] = "STRING";
...
function isDefinedAsObject(value) {
  return isDefined(value) && value instanceof Object;
}
function createNumberDateTokenConfiguration(defaultValue = {}) {
  return {
    minLeght: 2,
    name: "",
    type: "NUMBER" /* number */,
...
function dateTokenConfigurationIsTypeString(value) {
  return value.type === "STRING" /* string */;
}
function dateTokenConfigurationIsTypeNumber(value) {
  return value.type === "NUMBER" /* number */;
}
function parseAbstractDate(groupsToCheck, metadataString, reg) {
...
function resolveFlowCollection({ composeNode: composeNode2, composeEmptyNode: composeEmptyNode2 }, ctx, fc, onError, tag) {
  ...
  const NodeClass = (_a = tag == null ? void 0 : tag.nodeClass) != null ? _a : isMap3 ? YAMLMap : YAMLSeq;
...
function getTagsFromMetadataOrTagObject(settings, metaData, tags) {
  let output = [];
...
function getBodyFromContextOrDocument(rawFileText, context) {
  ...
  if (!rawFileText.length || overrideBody)
    return overrideBody;
...
async function getDataFromNoteMetadata(context, tagsToFind) {
...
async function getDataFromNoteBody(body, context, tagsToFind) {
...
(((\\s|\\d|[a-z]|-)*):(.*)
  ...
  const matches2 = body.match(inlineEventBlockRegExp);
  if (!matches2)
    return [];
  matches2.unshift();
  const output = [];
  for (const block of matches2) {
    ...
    output.push({
      cardData: await extractCardData(
        context,
        matchPositionInBody !== -1 ? body.slice(matchPositionInBody + block.length) : void 0
      ),
      context
    });
  }
...
async function extractCardData(context, rawFileContent) {
  ...
  const fileTitle = ((_a = c.frontmatter) == null ? void 0 : _a[settings.metadataKeyEventTitleOverride]) || file.basename;
...
function createDuplicateChecker() {
  ...
  return (type, key) => {
    if (cache2[key]) {
      warn3(`${type} property "${key}" is already defined in ${cache2[key]}.`);
    } else {
      cache2[key] = type;
    }
  };
...
function compileToFunction(template, options) {
  if (!isString(template)) {
    if (template.nodeType) {
      ...
      warn3(`invalid template option: `, template);
      return NOOP;
    }
  }
  const key = template;
  ...
  if (template[0] === "#") {
    ...
    if (!el) {
      warn3(`Template element not found or is empty: ${template}`);
    }
    ...
    if (isNumber(ret) && ret === NOT_REOSLVED) {
      ...
      if (__root && isString2(key) && isResolvedTranslateMessage(warnType, arg2)) {
        if (_fallbackRoot && (isTranslateFallbackWarn(_fallbackWarn, key) || isTranslateMissingWarn(_missingWarn, key))) {
          warn4(getWarnMessage2(I18nWarnCodes.FALLBACK_TO_ROOT, {
            key,
            type: warnType
          }));
        }
...
function convertComposerOptions(options) {
  ...
  if (options.formatter) {
    warn4(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_FORMATTER));
  }
  if (options.preserveDirectiveContent) {
    warn4(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_PRESERVE_DIRECTIVE));
  }
...
function vTDirective(i18n) {
  const _process = (binding) => {
    ...
    if (modifiers.preserve) {
      warn4(getWarnMessage2(I18nWarnCodes.NOT_SUPPORTED_PRESERVE));
    }
...
function apply(app, i18n, ...options) {
  ...
  if (globalInstall && useI18nComponentName) {
    warn4(getWarnMessage2(I18nWarnCodes.COMPONENT_NAME_LEGACY_COMPATIBLE, {
...
// src/i18n.config.ts
var i18n_config_default = () => createI18n({
  locale: "en",
  fallbackLocale: "en",
  messages: {
    en: en_default
...
var VNav_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    const __returned__ = { navigationTargets, emit: emit2 };
...
// src/composable/hasSlot.ts
function hasSlot(slot, slotProps = {}) {
  if (!slot)
    return false;
...
var VLabel_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const hasLabel = hasSlot(slots["label"]);
    const hasDescription = hasSlot(slots["description"]);
    const __returned__ = { slots, hasLabel, hasDescription };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.hasLabel || $setup.hasDescription ? (openBlock(), createElementBlock("div", _hoisted_13, [
    $setup.hasLabel ? (openBlock(), createElementBlock("label", {
      key: 0,
      for: $props.inputId,
    ...
    $setup.hasDescription ? (openBlock(), createElementBlock("summary", _hoisted_3, [
      renderSlot(_ctx.$slots, "description")
    ])) : createCommentVNode("v-if", true)
  ])) : createCommentVNode("v-if", true);
}

// src/components/VLabel.vue
VLabel_default.render = render4;
...
var VInput_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    const __returned__ = { props, emit: emit2, handleInputEvent, typedType, VLabel: VLabel_default2 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_15, [
    createBaseVNode("div", null, [
      ...
      !!_ctx.$slots.description ? (openBlock(), createElementBlock("summary", _hoisted_32, [
        renderSlot(_ctx.$slots, "description")
      ])) : createCommentVNode("v-if", true)
    ]),
    createBaseVNode(
...
VCheckbox_default.render = render6;
...
var _hoisted_42 = { class: "v-grid-display slim" };
var _hoisted_5 = ["href"];
var _hoisted_6 = /* @__PURE__ */ createBaseVNode(
  "hr",
  null,
  null,
  -1
...
var _hoisted_7 = { class: "v-grid-display slim" };
var _hoisted_8 = /* @__PURE__ */ createBaseVNode(
  "a",
...
function render9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_17, [
    ...
    (openBlock(), createElementBlock(
      Fragment,
      null,
      renderList($setup.checkboxKeys, (key) => {
        return createBaseVNode("section", _hoisted_42, [
          createVNode(
            $setup["VHeader"],
            null,
            {
              default: withCtx(() => [
                createTextVNode(
                  toDisplayString(_ctx.$t(`settings.title.${key}`)),
                  1
                  /* TEXT */
                )
              ]),
          ...
          createVNode($setup["VCheckbox"], {
            ...
            description: withCtx(() => [
              createVNode(_component_i18n_t, {
                ...
                _ctx.$te(`settings.linkValue.${key}`) && _ctx.$te(`settings.linkText.${key}`) ? {
                  name: "linkText",
                  fn: withCtx(() => [
                    createBaseVNode("a", {
                      href: _ctx.$t(`settings.linkValue.${key}`)
                    }, toDisplayString(_ctx.$t(`settings.linkText.${key}`)), 9, _hoisted_5)
                  ]),
                  key: "0"
                } : void 0
              ]), 1032, ["keypath"])
            ...
            _: 2
            /* DYNAMIC */
          }, 1032, ["value", "input-id", "onUpdate:value"])
        ]);
      }),
      64
      /* STABLE_FRAGMENT */
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_19, [
    ...
    createBaseVNode("select", {
      value: $props.modelValue,
      onInput: $setup.handleSelectInput
    }, [
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList($props.options, (option) => {
          return openBlock(), createElementBlock("option", { value: option }, toDisplayString(_ctx.$t(`${$props.translationKey}.${option}`)), 9, _hoisted_34);
        }),
        256
        /* UNKEYED_FRAGMENT */
      ))
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    function handleDictionaryUpdateAtIndex(index, entryValue) {
      ...
      if (isDefined(entryValue))
        ...
        clone.dictionary.splice(index, 1);
      emit2("update:modelValue", clone);
    }
    const __returned__ = { props, emit: emit2, handleUpdateType, addMemberToDictionary, handleDictionaryUpdateAtIndex, get availableDateTokenTypeArray() {
      return availableDateTokenTypeArray;
    }, get dateTokenConfigurationIsTypeNumber() {
      ...
      default: withCtx(() => [
        $setup.dateTokenConfigurationIsTypeNumber($props.modelValue) ? (openBlock(), createElementBlock("div", _hoisted_210, [
          createVNode($setup["VInput"], {
            ...
            "onUpdate:value": _cache[0] || (_cache[0] = ($event) => $setup.emit("update:modelValue", {
              ...$props.modelValue,
              minLeght: $event
            })),
            type: "number",
...
var VAdvancedDateFormats_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    function handleTokenResync() {
      emit2("update:value", {
        dateTokenConfiguration: [
          ...
          ...unconfiguredTokens.value.map(
            (name) => createNumberDateTokenConfiguration({ name })
          )
        ]
      });
    }
    ...
    const __returned__ = { props, emit: emit2, targetKeys, unconfiguredTokens, handleTokenResync, handleResetToDefault, VInput: VInput_default2, VButton: VButton_default2, VConfigureDateTokenArray: VConfigureDateTokenArray_default2, VHeader: VHeader_default, VWarningBlock: VWarningBlock_default2 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function render19(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("section", _hoisted_116, [
    ...
    createVNode(Transition, { name: "fade" }, {
      default: withCtx(() => [
        !!$setup.unconfiguredTokens.length ? (openBlock(), createBlock($setup["VWarningBlock"], { key: 0 }, {
          title: withCtx(() => [
            createTextVNode(
              toDisplayString(_ctx.$t("settings.warning.title.tokenMismatch")),
              1
              /* TEXT */
            )
          ]),
          text: withCtx(() => [
            createBaseVNode("div", null, [
              createBaseVNode("ul", _hoisted_211, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList($setup.unconfiguredTokens, (token) => {
                    return openBlock(), createElementBlock(
                      "li",
                      null,
              ...
              createTextVNode(
                " " + toDisplayString(_ctx.$t("settings.warning.text.tokenMismatchList")),
                1
                /* TEXT */
              )
            ]),
            createVNode($setup["VButton"], {
              ...
              onClick: $setup.handleTokenResync
            }, {
              default: withCtx(() => [
                createTextVNode(
                  toDisplayString(_ctx.$t("settings.warning.button.syncTokens")),
                  1
                  /* TEXT */
                )
              ]),
    ...
    createVNode($setup["VHeader"], null, {
      default: withCtx(() => [
        createTextVNode(
          toDisplayString(_ctx.$t("settings.title.advancedDateFormatsTokenConfiguration")),
          1
          /* TEXT */
        )
      ]),
...
var VCreateInputFormat_default = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    tokenConfigurations: { type: Array, required: true }
  },
  emits: ["update:value"],
  setup(__props, { expose: __expose, emit: emit2 }) {
    __expose();
            ...
            renderList($setup.tryOutResults, (value, index) => {
              return openBlock(), createElementBlock("li", null, [
                createBaseVNode(
                  "b",
                  null,
                  toDisplayString($props.tokenConfigurations[index].name),
                  1
                  /* TEXT */
                ),
                _hoisted_44,
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    const outputTryout = computed2(() => {
      return formatAbstractDate(abstractDate.value, {
        ...
        dateParserGroupPriority: props.tokenConfigurations.map((e) => e.name).join(","),
  ...
  return openBlock(), createElementBlock("section", _hoisted_120, [
    ...
    createBaseVNode("ul", null, [
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList($props.tokenConfigurations, (token) => {
          return openBlock(), createElementBlock(
            "li",
            null,
            toDisplayString(token.name),
            1
            /* TEXT */
          );
        }),
...
var FlowState = /* @__PURE__ */ ((FlowState2) => {
  ...
  FlowState2[FlowState2["token-configuration"] = 2] = "token-configuration";
  FlowState2[FlowState2["input-format"] = 3] = "input-format";
  FlowState2[FlowState2["output-format"] = 4] = "output-format";
  FlowState2[FlowState2["final"] = 5] = "final";
  return FlowState2;
})(FlowState || {});
  ...
  setup(__props, { expose: __expose, emit: emit2 }) {
    ...
    function handlePreviousClick() {
      switch (flowProgress.value) {
        ...
        case 3 /* input-format */:
          return flowProgress.value = 2 /* token-configuration */;
        case 4 /* output-format */:
          return flowProgress.value = 3 /* input-format */;
        default:
          return flowProgress.value = 0 /* not-started */;
      }
    }
    function handleNextClick() {
      switch (flowProgress.value) {
        ...
        case 2 /* token-configuration */:
          return flowProgress.value = 3 /* input-format */;
        case 3 /* input-format */:
          return flowProgress.value = 4 /* output-format */;
        case 4 /* output-format */:
          return flowProgress.value = 5 /* final */;
        default:
          return flowProgress.value = 0 /* not-started */;
      }
    }
    function handleSave() {
      emit2("update:value", {
        ...
        dateParserGroupPriority: tokenConfigurations.value.map(({ name }) => name).join(","),
        dateParserRegex: inputRegex.value
      });
      flowProgress.value = 0 /* not-started */;
    }
    const __returned__ = { emit: emit2, FlowState, flowProgress, tokenConfigurations, inputRegex, outputFormat, handlePreviousClick, handleNextClick, handleSave, VButton: VButton_default2, VCreateDateTokens: VCreateDateTokens_default2, VCreateInputFormat: VCreateInputFormat_default2, VCreateOutputFormat: VCreateOutputFormat_default2, VDateFormatCreationConfirmation: VDateFormatCreationConfirmation_default2, VConfigureDateTokenArray: VConfigureDateTokenArray_default2 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
  ...
  return openBlock(), createBlock(Transition, { mode: "out-in" }, {
    default: withCtx(() => [
      $setup.flowProgress === $setup.FlowState["not-started"] ? (openBlock(), createElementBlock("section", _hoisted_121, [
        ...
        createVNode(Transition, { mode: "out-in" }, {
          default: withCtx(() => [
            $setup.flowProgress === $setup.FlowState["token-creation"] ? (openBlock(), createBlock($setup["VCreateDateTokens"], {
              key: 0,
              modelValue: $setup.tokenConfigurations,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $setup.tokenConfigurations = $event)
            }, null, 8, ["modelValue"])) : $setup.flowProgress == $setup.FlowState["token-configuration"] ? (openBlock(), createBlock($setup["VConfigureDateTokenArray"], {
              key: 1,
              modelValue: $setup.tokenConfigurations,
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $setup.tokenConfigurations = $event)
              ...
              "onUpdate:value": _cache[3] || (_cache[3] = ($event) => $setup.inputRegex = $event),
              "token-configurations": $setup.tokenConfigurations
            }, null, 8, ["value", "token-configurations"])) : $setup.flowProgress === $setup.FlowState["output-format"] ? (openBlock(), createBlock($setup["VCreateOutputFormat"], {
              key: 3,
              value: $setup.outputFormat,
              "onUpdate:value": _cache[4] || (_cache[4] = ($event) => $setup.outputFormat = $event),
              "token-configurations": $setup.tokenConfigurations
            }, null, 8, ["value", "token-configurations"])) : createCommentVNode("v-if", true)
          ]),
          _: 1
          /* STABLE */
        }),
        ...
        }, null, 8, ["token-configurations", "input-regex", "output-format"])
      ]))
    ]),
    _: 1
    /* STABLE */
...
var TimelineSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    const i18n = i18n_config_default();
...
var AprilsAutomaticTimelinesPlugin = class extends import_obsidian4.Plugin {
  ...
  async run(source, element, { sourcePath }) {
    ...
    for (const context of creationContext) {
      ...
      if (!finalSettings.lookForInlineEventsInNotes)
        continue;
      const body = (baseData == null ? void 0 : baseData.cardData.body) || await context.file.vault.cachedRead(context.file);
      const inlineEvents = (await getDataFromNoteBody(body, context, tagsToFind)).filter(isDefined);
