...
"traits":
  - "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
      ...
      \n1/day each: [dancing lights](/compendium/spells/dancing-lights.md), [mage\
      \ hand](/compendium/spells/mage-hand.md), [minor illusion](/compendium/spells/minor-illusion.md)"
  ...
  - "desc": "As a bonus action, the dragon can magically turn [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ spell). Any equipment the dragon wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
      \ with it."
...
"source":
  - "MM"
"image": "/compendium/bestiary/dragon/token/faerie-dragon-red.webp"
```
^statblock
