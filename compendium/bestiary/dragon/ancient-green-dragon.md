...
- "desc": "- Grasping roots and vines erupt in a 20-foot radius centered on a point\
    ...
    \ of it. The creature must succeed on a DC 15 Wisdom saving throw or be [charmed](/compendium/rules/conditions.md#Charmed)\
    \ by the dragon until initiative count 20 on the next round.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-green-dragon.md)\
    \ or [ancient](compendium/bestiary/dragon/ancient-green-dragon.md)) green dragon\
    ...
    \ to animate up to three Humanoid corpses, which become [zombies](compendium/bestiary/undead/zombie.md).\
...
"source":
- "MM"
"image": "compendium/bestiary/dragon/token/ancient-green-dragon.webp"
```
^statblock
