...
- "desc": "The dragon uses one of the following breath weapons:\n\n- Fire Breath.\
    ...
    \ area must succeed on a DC 21 Constitution saving throw or fall [unconscious](/compendium/rules/conditions.md#Unconscious)\
...
- "desc": "- A strong wind blows around the dragon. Each creature within 60 feet of\
    ...
    \ away from the dragon and knocked [prone](/compendium/rules/conditions.md#Prone).\
...
- "desc": "At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-brass-dragon.md)\
    ...
    \ be knocked [prone](/compendium/rules/conditions.md#Prone). Gases and vapors\
    ...
    \ in the wind's direction, and the wind can't knock the dragon [prone](/compendium/rules/conditions.md#Prone).\
...
- "desc": "- Tracks appear in the sand within 6 miles of the dragon's lair. The tracks\
    ...
    \ DC 20 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
