...
- "desc": "The dragon reaches into the mind of a target it can see within 60 feet\
    ...
    \ saving throw. On a failed save, the target becomes [frightened](/compendium/rules/conditions.md#Frightened)\
...
- "desc": "The dragon exhales a swirling cloud of pollen and red and purple petals\
    ...
    \ throw. On a failed save, the creature becomes [charmed](/compendium/rules/conditions.md#Charmed)\
...
- "desc": "The oleander dragon sings a magical song. Each enemy that can hear it must\
    ...
    \ and be [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute. A creature\
