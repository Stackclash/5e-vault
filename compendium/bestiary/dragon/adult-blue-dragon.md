...
- "desc": "- Part of the ceiling collapses above one creature that the dragon can\
    ...
    \ throw or take 10 (3d6) bludgeoning damage and be knocked [prone](/compendium/rules/conditions.md#Prone)\
    \ and buried. The buried target is [restrained](/compendium/rules/conditions.md#Restrained)\
    ...
    \ cloud must succeed on a DC 15 Constitution saving throw or be [blinded](/compendium/rules/conditions.md#Blinded)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-blue-dragon.md)\
    ...
    \ to the bottom of the pit, taking 7 (2d6) bludgeoning damage and landing [prone](/compendium/rules/conditions.md#Prone).\
...
- "desc": "- Thunderstorms rage within 6 miles of the lair.  \n- Dust devils scour\
    ...
    \ Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. Otherwise,\
...
- "desc": "Any of these effects might appear in the area around a blue dragon's lair,\
    ...
    \ attempt a DC 15 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
...
"source":
- "MM"
"image": "compendium/bestiary/dragon/token/adult-blue-dragon.webp"
```
^statblock
