...
"lair_actions":
  ...
  - "desc": "- Part of the ceiling collapses above one creature that the dragon can\
      ...
      \ saving throw or take 10 (3d6) bludgeoning damage and be knocked [prone](/compendium/rules/conditions.md#Prone)\
      ...
      \ in the cloud must succeed on a DC 15 Constitution saving throw or be [blinded](/compendium/rules/conditions.md#Blinded)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
...
"regional_effects":
  ...
  - "desc": "- Thunderstorms rage within 6 miles of the lair.  \n- Dust devils scour\
      ...
      \ 20 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. Otherwise,\
  ...
  - "desc": "Any of these effects might appear in the area around a blue dragon's\
      ...
      \ can attempt a DC 15 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
