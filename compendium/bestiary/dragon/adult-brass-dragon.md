...
***Bite.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 6|avg` (`2d10 + 6`) piercing damage.
...
- **Fire Breath.** The dragon exhales fire in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 18 Dexterity saving throw, taking 45 (`dice: 13d6|avg` (`13d6`)) fire damage on a failed save, or half as much damage on a successful one.  
