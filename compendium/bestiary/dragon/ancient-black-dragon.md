...
- "desc": "The dragon beats its wings. Each creature within 15 feet of the dragon\
    ...
    \ damage and be knocked [prone](/compendium/rules/conditions.md#Prone). The dragon\
...
- "desc": "- Pools of water that the dragon can see within 120 feet of it surge outward\
    ...
    \ the water and knocked [prone](/compendium/rules/conditions.md#Prone).  \n- A\
    ...
    \ must make on a DC 15 Constitution saving throw, taking 10 (3d6) piercing damage\
    ...
    \ or dies. The darkness spreads around corners. A creature with [darkvision](/compendium/rules/senses.md#Darkvision)\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-black-dragon.md)\
    ...
    \ make a DC 15 Constitution saving throw, taking 10 (3d6) poison damage on a failed\
    \ save, or half as much damage on a successful one. The cylinder is \"difficult\
    ...
    \ saving throw or be [restrained](/compendium/rules/conditions.md#Restrained)\
...
- "desc": "Any of these effects might appear in the area around a black dragon's lair,\
    ...
    \ within 6 miles of the lair, imposing disadvantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
...
"source":
- "MM"
"image": "compendium/bestiary/dragon/token/ancient-black-dragon.webp"
```
^statblock
