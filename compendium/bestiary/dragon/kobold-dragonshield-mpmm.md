...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the kobold is [frightened](compendium/rules/conditions.md#frightened)\
    \ or [paralyzed](compendium/rules/conditions.md#paralyzed) by an effect that allows\
