...
*Source: Monster Manual p. 97, Tasha's Cauldron of Everything, Vecna: Eve of Ruin. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*
...
- "desc": "- Magma erupts from a point on the ground the dragon can see within 120\
    ...
    \ a DC 13 Constitution saving throw or be [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ until the end of its turn. While [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ in this way, a creature is [incapacitated](/compendium/rules/conditions.md#Incapacitated).\
    \  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-red-dragon.md)\
    \ or [ancient](compendium/bestiary/dragon/ancient-red-dragon.md)) red dragon can\
    ...
    \ its turn must succeed on a DC 15 Constitution saving throw or be [poisoned](/compendium/rules/conditions.md#Poisoned)\
