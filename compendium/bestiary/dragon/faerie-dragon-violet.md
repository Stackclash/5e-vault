...
- "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \ [hallucinatory terrain](compendium/spells/hallucinatory-terrain.md), [mage hand](compendium/spells/mage-hand.md),\
    \ [major image](compendium/spells/major-image.md), [minor illusion](compendium/spells/minor-illusion.md),\
    \ [mirror image](compendium/spells/mirror-image.md), [polymorph](compendium/spells/polymorph.md),\
...
- "desc": "As a bonus action, the dragon can magically turn [invisible](/compendium/rules/conditions.md#Invisible)\
    ...
    \ Any equipment the dragon wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
    \ with it."
