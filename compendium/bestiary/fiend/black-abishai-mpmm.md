...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The abishai casts [darkness](/compendium/spells/darkness.md) at a point\
    \ within 120 feet of it, requiring no spell components or [concentration](compendium/rules/status.md#concentration).\
...
***Creeping Darkness (Recharge 6).*** The abishai casts [darkness](/compendium/spells/darkness.md) at a point within 120 feet of it, requiring no spell components or [concentration](compendium/rules/status.md#concentration). Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.
