...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 11 (2d4\
    ...
    \ successful one. On a failure, the target is [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 100/400 ft., one target. Hit:\
    ...
    \ 17 Dexterity saving throw or be [restrained](/compendium/rules/conditions.md#Restrained)\
    ...
    \ The target takes 22 (4d10) lightning damage and must make a successful DC 17\
