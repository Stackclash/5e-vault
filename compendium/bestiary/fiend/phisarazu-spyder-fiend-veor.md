...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 15 (2d10\
    \ + 4) piercing damage plus 9 (2d8) poison damage, and the target has the [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
- "desc": "The phisarazu expels shimmering webs in a 60-foot cone. Creatures and objects\
    ...
    \ time they emit dim light for 10 feet and can't benefit from the [invisible](/compendium/rules/conditions.md#Invisible)\
    ...
    \ condition for 1 minute. A [stunned](/compendium/rules/conditions.md#Stunned)\
...
"source":
- "VEoR"
"image": "compendium/bestiary/fiend/token/phisarazu-spyder-fiend-veor.webp"
```
^statblock
