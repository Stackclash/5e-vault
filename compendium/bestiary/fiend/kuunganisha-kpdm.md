...
"traits":
  ...
  - "desc": "The master of a kuunganisha familiar can cast a spell through the creature,\
      ...
      \ as if the spell originated from the kuunganisha, not the master. The spell\
      \ effect occurs on the kuunganisha's turn, though the master must cast the spell\
      \ during the master's turn. Concentration spells must still be maintained by\
      \ the master."
...
"actions":
  ...
  - "desc": "The kuunganisha magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ on a spell). Any equipment the fiend wears or carries becomes [invisible](/compendium/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "KPDM"
