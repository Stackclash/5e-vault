...
- "desc": "The canoloth can't be [surprised](/compendium/rules/conditions.md#Surprised)\
    \ unless it's [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
  "name": "Uncanny Senses"
"actions":
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 30 ft., one target. Hit: 10 (1d12\
    ...
    \ it is [grappled](/compendium/rules/conditions.md#Grappled) (escape DC 15), pulled\
    \ up to 30 feet toward the canoloth, and [restrained](/compendium/rules/conditions.md#Restrained)\
