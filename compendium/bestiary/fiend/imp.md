...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The imp magically turns [invisible](compendium/rules/conditions.md#invisible)\
    ...
    \ Any equipment the imp wears or carries is [invisible](compendium/rules/conditions.md#invisible)\
    \ with it."
  "name": "Invisibility"
"source":
- "MM"
