...
- "desc": "The amnizu targets one or two creatures that it can see within 60 feet\
    ...
    \ necrotic damage and be [blinded](/compendium/rules/conditions.md#Blinded) until\
...
- "desc": "The amnizu targets one creature it can see within 60 feet of it. That creature\
    ...
    \ damage and become [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute.\
    \ A [stunned](/compendium/rules/conditions.md#Stunned) creature repeats the saving\
    \ throw at the end of each of its turns, ending the effect on itself on a success.\
    \ If the target is [stunned](/compendium/rules/conditions.md#Stunned) for the\
