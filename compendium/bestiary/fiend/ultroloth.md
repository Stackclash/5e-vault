...
- "desc": "The ultroloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\nAt will: [alter self](compendium/spells/alter-self.md), [clairvoyance](compendium/spells/clairvoyance.md),\
    ...
    \ [invisibility](compendium/spells/invisibility.md) (self only), [suggestion](compendium/spells/suggestion.md)\n\
