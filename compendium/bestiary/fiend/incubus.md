...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The fiend ignores the range restriction on its telepathy when communicating\
    \ with a creature it has [charmed](compendium/rules/conditions.md#charmed). The\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a DC\
    \ 15 Wisdom saving throw or be magically [charmed](compendium/rules/conditions.md#charmed)\
    \ for 1 day. The [charmed](compendium/rules/conditions.md#charmed) target obeys\
    ...
    \ hours.\n\nThe fiend can have only one target [charmed](compendium/rules/conditions.md#charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The fiend kisses a creature [charmed](compendium/rules/conditions.md#charmed)\
...
The succubus or incubus resorts to charming a victim magically only when necessary, usually as a form of self-defense. A [charmed](compendium/rules/conditions.md#charmed) creature isn't responsible for its actions, so forcing it to behave against its will won't bring the fiend closer to the ultimate prize: the victim's soul.
