...
"traits":
  - "desc": "The fiend ignores the range restriction on its telepathy when communicating\
      \ with a creature it has [charmed](/compendium/rules/conditions.md#Charmed).\
...
"actions":
  ...
  - "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a\
      \ DC 15 Wisdom saving throw or be magically [charmed](/compendium/rules/conditions.md#Charmed)\
