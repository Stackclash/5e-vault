...
"traits":
  ...
  - "desc": "Any creature hostile to the pit fiend that starts its turn within 20\
      ...
      \ fiend is [incapacitated](/compendium/rules/conditions.md#Incapacitated). On\
      \ a failed save, the creature is [frightened](/compendium/rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 22\
      ...
      \ start of each of its turns. The [poisoned](/compendium/rules/conditions.md#Poisoned)\
