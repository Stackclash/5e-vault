...
"actions":
  ...
  - "desc": "The barghest casts one of the following spells, requiring no material\
      ...
      \nAt will: [levitate](/compendium/spells/levitate.md), [minor illusion](/compendium/spells/minor-illusion.md),\
      \ [pass without trace](/compendium/spells/pass-without-trace.md)\n\n1/day\
      \ each: [charm person](/compendium/spells/charm-person.md), [dimension door](/compendium/spells/dimension-door.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/compendium/bestiary/fiend/token/barghest-mpmm.webp"
```
^statblock
