...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature other than a stench kow that starts its turn within 5 feet\
    \ of the stench kow must succeed on a DC 12 Constitution saving throw or be [poisoned](compendium/rules/conditions.md#poisoned)\
...
***Gore.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) piercing damage. If the stench kow moved at least 20 feet straight toward the target immediately before the hit, the target takes an extra 7 (`dice: 2d6|avg` (`2d6`)) piercing damage.
```
^statblock
