...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 15 (2d10\
    ...
    \ it must succeed on a DC 18 Constitution saving throw or have the [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ condition for 1 minute. While [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ in this way, a creature can't regain hit points. A [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"source":
- "VEoR"
"image": "compendium/bestiary/fiend/token/quavilithku-spyder-fiend-veor.webp"
```
^statblock
