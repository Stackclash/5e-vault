...
- "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    ...
    \ poison damage and become poisoned for 1 minute. The target can repeat the saving\
    \ throw at the end of each of its turns, ending the effect on itself on a success."
  "name": "Claw (Bite in Beast Form)"
- "desc": "One creature of the quasit's choice within 20 feet of it must succeed on\
    \ a DC 10 Wisdom saving throw or be frightened for 1 minute. The target can repeat\
    \ the saving throw at the end of each of its turns, with disadvantage if the quasit\
