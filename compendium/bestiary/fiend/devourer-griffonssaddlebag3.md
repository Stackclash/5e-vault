...
"traits":
  ...
  - "desc": "While in dim light or darkness, the devourer can take the Hide action\
      \ as a bonus action. While in darkness, the devourer is [invisible](/compendium/rules/conditions.md#Invisible)\
...
"actions":
  ...
  - "desc": "The devourer magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ on a spell). Any equipment the devourer wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "GriffonsSaddlebag3"
