...
- "desc": "At the start of each of the wastrilith's turns, exposed water within 30\
    ...
    \ is [poisoned](/compendium/rules/conditions.md#Poisoned) for 1 minute. At the\
    \ end of this time, the [poisoned](/compendium/rules/conditions.md#Poisoned) creature\
    \ must repeat the saving throw. On a failure, the creature takes 18 (4d8) poison\
    \ damage and is [poisoned](/compendium/rules/conditions.md#Poisoned) until it\
