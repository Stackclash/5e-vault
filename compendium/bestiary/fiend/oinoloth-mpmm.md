...
"actions":
  ...
  - "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
      ...
      \ on the target or remove one of the following conditions from it: [blinded](/compendium/rules/conditions.md#Blinded),\
      ...
      \ by a [wish](/compendium/spells/wish.md) spell or by casting [greater restoration](/compendium/spells/greater-restoration.md)\
  ...
  - "desc": "The oinoloth casts one of the following spells, requiring no material\
      ...
      \ each: [feeblemind](/compendium/spells/feeblemind.md), [globe of invulnerability](/compendium/spells/globe-of-invulnerability.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on\
      ...
      \ and is [poisoned](/compendium/rules/conditions.md#Poisoned). On a successful\
      \ save, the creature is immune to the oinoloth's Bringer of Plagues for the\
      \ next 24 hours.\n\nThe [poisoned](/compendium/rules/conditions.md#Poisoned)\
      \ creature can't regain hit points. After every 24 hours that elapse, the [poisoned](/compendium/rules/conditions.md#Poisoned)\
