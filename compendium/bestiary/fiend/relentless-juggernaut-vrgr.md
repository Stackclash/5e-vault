...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 11\
      ...
      \ it must succeed on a DC 18 Strength saving throw or be knocked [prone](/compendium/rules/conditions.md#Prone)."
    "name": "Fist"
  ...
  - "desc": "The target takes 22 (5d8) bludgeoning damage and is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "The target takes 14 (4d6) slashing damage, and the implement vanishes.\
      ...
      \ requires a successful DC 15 Wisdom ([Medicine](/compendium/rules/skills.md#Medicine))\
      \ check."
...
"source":
  - "VRGR"
"image": "/compendium/bestiary/fiend/token/relentless-juggernaut-vrgr.webp"
```
^statblock
