...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 14 (2d10\
    ...
    \ a [ghoul](compendium/bestiary/undead/ghoul.md)  unless it has been revived or\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12 (2d8\
    ...
    \ succeed on a DC 12 Constitution saving throw or be [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
