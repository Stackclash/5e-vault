...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one target.\
    ...
    \ reduces its Charisma to 0. It rises 24 hours later as a [ghoul](compendium/bestiary/undead/ghoul.md)\
...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one target.\
    ...
    \ be [paralyzed](/compendium/rules/conditions.md#paralyzed) for 1 minute. The\
