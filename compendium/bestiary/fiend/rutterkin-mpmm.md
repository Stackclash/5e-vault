...
- "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    ...
    \ [poisoned](/compendium/rules/conditions.md#poisoned). At the end of each long\
    \ rest, the [poisoned](/compendium/rules/conditions.md#poisoned) target can repeat\
    \ the saving throw, ending the effect on itself on a success. If the target is\
    \ reduced to 0 hit points while [poisoned](/compendium/rules/conditions.md#poisoned)\
