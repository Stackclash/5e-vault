...
"traits":
  - "desc": "When a creature that isn't a demon starts its turn within 30 feet of\
      ...
      \ more rutterkins. On a failed save, the creature becomes [frightened](/compendium/rules/conditions.md#Frightened)\
      \ of the rutterkins for 1 minute. While [frightened](/compendium/rules/conditions.md#Frightened)\
      \ in this way, the creature is [restrained](/compendium/rules/conditions.md#Restrained).\
      \ At the end of each of the [frightened](/compendium/rules/conditions.md#Frightened)\
...
"actions":
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 12\
      ...
      \ a DC 13 Constitution saving throw against disease or become [poisoned](/compendium/rules/conditions.md#Poisoned).\
      \ At the end of each long rest, the [poisoned](/compendium/rules/conditions.md#Poisoned)\
      \ target can repeat the saving throw, ending the effect on itself on a success.\
      \ If the target is reduced to 0 hit points while [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "/compendium/bestiary/fiend/token/rutterkin-mpmm.webp"
```
^statblock
