...
- "desc": "The oblex casts one of the following spells, requiring no spell components\
    ...
    \ door](compendium/spells/dimension-door.md), [dominate person](compendium/spells/dominate-person.md),\
...
- "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
    ...
    \ or until it benefits from the [greater restoration](compendium/spells/greater-restoration.md)\
    \ or [heal](compendium/spells/heal.md) spell. Constructs, Oozes, Plants, and Undead\
    ...
    \ point the target becomes [unconscious](/compendium/rules/conditions.md#unconscious)\
...
- "MPMM"
- "MTF"
"image": "compendium/bestiary/ooze/token/elder-oblex-mpmm.webp"
```
^statblock
