...
"actions":
  ...
  - "desc": "One Large or smaller creature that the slithering tracker can see within\
    ...
    "name": "Life Leech"
"bonus_actions":
  - "desc": "If underwater, the slithering tracker takes the [Hide](/compendium/rules/actions.md#Hide)\
      \ action, and it makes the Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
