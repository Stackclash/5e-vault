...
- monster/size/large
- monster/type/ooze
aliases: ["Prismatic Ooze"]
---
# [Prismatic Ooze](compendium\bestiary\ooze/prismatic-ooze-griffonssaddlebag3.md)
...
"cr": "5"
"traits":
- "desc": "The ooze's Prismatic [Nature](/compendium/rules/skills.md#Nature) is initially\
...
- "desc": "The ooze has advantage on attack rolls against any creature it has [surprised](/compendium/rules/conditions.md#Surprised)."
  "name": "Ambusher"
- "desc": "The ooze absorbs the optical qualities of crystals it touches. While the\
    ...
    \ not moved or taken an action since the start of its last turn, it is [invisible](/compendium/rules/conditions.md#Invisible)\
...
- "desc": "A creature or object that touches the ooze or hits it with a melee attack\
    ...
    \ the ooze's Prismatic [Nature](/compendium/rules/skills.md#Nature) trait."
  "name": "Prismatic Form"
"actions":
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    \ + 3) bludgeoning damage plus 18 (4d8) damage of the type associated with the\
    \ ooze's Prismatic [Nature](/compendium/rules/skills.md#Nature) trait."
  "name": "Pseudopod"
"source":
- "GriffonsSaddlebag3"
```
