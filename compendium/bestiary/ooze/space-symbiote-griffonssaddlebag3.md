...
- Space Symbiote
---
# [Space Symbiote](compendium/bestiary/ooze/space-symbiote-griffonssaddlebag3.md)
...
"traits":
  - "desc": "When the symbiote kills a humanoid with a melee attack or touches a humanoid\
      ...
      \nThe reanimated creature is friendly to the symbiote and has the statistics\
      \ of a zombie, but it has a flying speed of 20 feet and can hover."
    "name": "Alien Animation"
  - "desc": "The symbiote can move through a space as narrow as 1 inch wide without\
      \ squeezing."
    "name": "Amorphous"
  - "desc": "The symbiote has advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
      \ checks made to hide in Wild Space or the Astral Plane."
    "name": "Space Camouflage"
  - "desc": "The symbiote knows the distance and direction to each creature it has\
      \ reanimated as long as it and the creature are on the same plane of existence.\
      \ In addition, it can magically communicate simple ideas and images with any\
      \ such creature."
    "name": "Symbiotic Bond"
"actions":
