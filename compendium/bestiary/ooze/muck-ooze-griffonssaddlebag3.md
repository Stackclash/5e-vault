...
- Muck Ooze
---
# [Muck Ooze](compendium/bestiary/ooze/muck-ooze-griffonssaddlebag3.md)
...
"cr": "2"
"traits":
  - "desc": "Whenever the ooze is subjected to acid damage, it takes no damage and\
  ...
  - "desc": "Moving through nonmagical difficult terrain costs the ooze no extra movement.\
      ...
      \ without taking damage from them if they have thorns, spines, or a  similar\
      \ hazard."
    "name": "Swamp Stride"
"actions":
  ...
  - "desc": "The ooze lunges at a Large or smaller creature it can see within 10 feet\
      ...
      \ enveloped, the target's speed is halved, it has disadvantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
      ...
      \ action to make a DC 12 Strength check. On a success, the ooze falls to the\
      \ ground in its space, and the target escapes and enters a space of its choice\
