...
- "desc": "Even when the cube is in plain sight, it takes a successful DC 15 Wisdom\
    ...
    \ space while unaware of the cube is [surprised](/compendium/rules/conditions.md#Surprised)\
    \ by the cube."
  "name": "Transparent"
"actions":
...
- "desc": "The cube moves up to its speed. While doing so, it can enter Large or smaller\
    ...
    \ [restrained](/compendium/rules/conditions.md#Restrained), and takes 21 (6d6)\
