...
- Creatures native to the unicorn's domain have an easier time hiding; they have advantage on all Dexterity ([Stealth](compendium/rules/skills.md#Stealth)) checks made to hide.  
