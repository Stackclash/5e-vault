...
- "desc": "The princip's spellcasting ability is Wisdom (spell save DC 14). It can\
    ...
    \ will: [aid](compendium/spells/aid.md), [enhance ability](compendium/spells/enhance-ability.md),\
    \ [lesser restoration](compendium/spells/lesser-restoration.md), [shield of faith](compendium/spells/shield-of-faith.md)\n\
    \n3/day each: [haste](compendium/spells/haste.md), [remove curse](compendium/spells/remove-curse.md),\
...
"source":
- "SaF"
"image": "compendium/bestiary/celestial/token/princip-saf.webp"
```
^statblock
