...
"traits":
  ...
  - "desc": "Evil creatures have disadvantage on attack rolls against all allies within\
      \ 5 feet of the throne. Allies in this area can't be [charmed](/compendium/rules/conditions.md#Charmed),\
...
"actions":
  - "desc": "Ranged Spell Attack: +8 to hit, range 120 ft., one target. Hit: 10\
      ...
      \ into the throne's burning rings. The target is [grappled](/compendium/rules/conditions.md#Grappled)\
      \ (escape DC 17). Until the grapple ends, the target is [restrained](/compendium/rules/conditions.md#Restrained),\
  ...
  - "desc": "The wheel spins around the creature [grappled](/compendium/rules/conditions.md#Grappled)\
