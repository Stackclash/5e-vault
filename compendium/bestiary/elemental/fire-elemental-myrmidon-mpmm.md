...
***Water Susceptibility.*** For every 5 feet the myrmidon moves in 1 foot or more of water, it takes `dice: 1d4|avg` (`1d4`) cold damage.

## Actions

***Multiattack.*** The myrmidon makes three Scimitar attacks.

***Scimitar.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) force damage.

***Fiery Strikes (Recharge 6).*** The myrmidon uses Multiattack. Each attack that hits deals an extra 7 (`dice: 2d6|avg` (`2d6`)) fire damage.
```
^statblock