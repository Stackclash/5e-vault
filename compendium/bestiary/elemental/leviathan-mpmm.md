...
- "desc": "The leviathan magically creates a wave of water that extends from a point\
    ...
    \ save, a creature takes half as much damage and isn't knocked [prone](/compendium/rules/conditions.md#Prone).\
...
- "MPMM"
- "MTF"
"image": "compendium/bestiary/elemental/token/leviathan-mpmm.webp"
```
^statblock
