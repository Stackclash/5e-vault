...
aliases: ["Gargoyle, Ancient"]
---
# [Gargoyle, Ancient](compendium\bestiary\elemental/gargoyle-ancient-griffonssaddlebag3.md)
...
"actions":
- "desc": "The gargoyle makes three attacks: one with its bite and two with its fists."
  "name": "Multiattack"
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 19 (3d8\
  ...
  "name": "Fist"
- "desc": "The gargoyle glares at one creature it can see within 60 feet of it. The\
    \ target must make a DC 17 Constitution saving throw. On a failed save, the target\
    \ magically begins turning to stone and is [restrained](/compendium/rules/conditions.md#Restrained).\n\
