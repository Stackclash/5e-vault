...
"actions":
  - "desc": "As a bonus action, the Source focuses its gaze on an ally within 30 feet.\
      ...
      \ 10 minutes, after which the diamonds turn to worthless dust, restoring the\
  ...
  - "desc": "The Source focuses its gaze on an enemy within 30 feet. If the target's\
      ...
      \ On a failed save, the creature magically begins to turn to stone and is [restrained](/compendium/rules/conditions.md#Restrained).\
      \ At the end of its next turn, it must repeat the saving throw. On a success,\
      \ the effect ends. On a failure, the creature is [petrified](/compendium/rules/conditions.md#Petrified)\
  ...
  - "desc": "The Source causes a 30-foot-long wall of solid stone to thrust up through\
      ...
      \ 10 feet high. Each panel has AC 15 and 180 hit points. If reduced to 0 hit\
      \ points, a panel crumbles, leaving loose scree that counts as difficult terrain.\
      \ The wall lasts for 10 minutes, then turns to dust.\n\nIf the wall is summoned\
      \ in a creature's space, the creature is pushed to one side of the wall, chosen\
      \ by the summoner. If a creature would be surrounded on all sides by the wall\
      \ (or the wall and another solid surface), that creature can make a Dexterity\
      \ saving throw. On a success, it can use its reaction to move up to its speed\
