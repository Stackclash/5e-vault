...
- "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
    ...
    \ [concentration](/compendium/rules/conditions.md#concentration) is broken. The\
    ...
    \ dice: 5d6|avg (5d6) bludgeoning damage, is knocked [prone](/compendium/rules/conditions.md#prone),\
...
- "desc": "The zaratan can use this option only if it is retracted in its shell. It\
    \ regains dice: 5d20|avg (5d20) hit points. The next time it takes a legendary\
