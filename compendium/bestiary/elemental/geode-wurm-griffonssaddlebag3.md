...
- Geode Wurm
---
# [Geode Wurm](compendium/bestiary/elemental/geode-wurm-griffonssaddlebag3.md)
...
"traits":
  ...
  - "desc": "A creature takes 10 (3d6) slashing damage at the start of each of its\
      \ turns while [grappled](/compendium/rules/conditions.md#Grappled) by the wurm."
    "name": "Jagged Body"
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 19\
      \ (3d8 + 6) bludgeoning damage. If the target is Large or smaller, it is [grappled](/compendium/rules/conditions.md#Grappled)\
      ...
      \ and the wurm can't constrict another target."
    "name": "Constrict"
"source":
  - "GriffonsSaddlebag3"
```
