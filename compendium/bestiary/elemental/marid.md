...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The marid's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ water](/compendium/spells/create-or-destroy-water.md), [detect evil and good](/compendium/spells/detect-evil-and-good.md),\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The marid magically shoots water in a 60-foot line that is 5 feet wide.\
    ...
    \ or smaller, is pushed up to 20 feet away from the marid and knocked [prone](compendium/rules/conditions.md#prone).\
