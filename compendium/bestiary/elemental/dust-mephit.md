...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When the mephit dies, it explodes in a burst of dust. Each creature within\
    \ 5 feet of it must then succeed on a DC 10 Constitution saving throw or be [blinded](compendium/rules/conditions.md#blinded)\
    \ for 1 minute. A [blinded](compendium/rules/conditions.md#blinded) creature can\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The mephit exhales a 15-foot cone of blinding dust. Each creature in that\
    \ area must succeed on a DC 10 Dexterity saving throw or be [blinded](compendium/rules/conditions.md#blinded)\
