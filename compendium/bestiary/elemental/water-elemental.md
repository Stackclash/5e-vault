...
"actions":
  ...
  - "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
      ...
      \ is Large or smaller, it is also [grappled](/compendium/rules/conditions.md#Grappled)\
      ...
      \ one time. At the start of each of the elemental's turns, each target [grappled](/compendium/rules/conditions.md#Grappled)\
