...
- "desc": "The tempest is always at the center of a storm dice: 1d6 + 4|avg (1d6\
    ...
    \ open flames and imposes disadvantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
...
- "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
    ...
    \ by 5 or more, the creature is also [stunned](/compendium/rules/conditions.md#stunned)\
