...
- "desc": "When summoned, the Pillar of Water appears in a 10-by-10-foot space. All\
    ...
    \ can't breathe unless they can breathe water, are [restrained](/compendium/rules/conditions.md#restrained),\
    \ and take dice: 6d6|avg (6d6) bludgeoning damage at the start of each of\
    \ the pillar's turns.\n\nAs an action, a [restrained](/compendium/rules/conditions.md#restrained)\
    \ creature can make a DC 15 Strength ([Athletics](/compendium/rules/skills.md#Athletics))\
...
- "desc": "As a bonus action, the pillar disappears, depositing any suspended creatures\
    \ on the ground, [prone](/compendium/rules/conditions.md#prone). On its summoner's\
    \ next turn, it appears again anywhere within 60 feet of the summoner."
  "name": "Reform"
"source":
- "SaF"
"image": "compendium/bestiary/elemental/token/pillar-of-water-saf.webp"
```
^statblock
