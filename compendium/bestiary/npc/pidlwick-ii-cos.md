...
```ad-statblock
title: Pidlwick II
![](/compendium/bestiary/npc/token/pidlwick-ii.png#token)
...
***Dart.*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 20/60 ft., one target. Hit: `dice: 1d4 + 2|avg` (`1d4 + 2`) piercing damage.
```
^statblock