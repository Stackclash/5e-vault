...
- "desc": "Kaylan has the following flaws:\n\nForbiddance. Kaylan can't enter a\
    ...
    \ heart while Kaylan is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by Kaylan,\
