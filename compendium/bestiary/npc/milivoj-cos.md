...
```ad-statblock
title: Milivoj
![](/compendium/bestiary/npc/token/milivoj.png#token)
...
***Shovel.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2|avg` (`1d4 + 2`) bludgeoning damage.
```
^statblock
