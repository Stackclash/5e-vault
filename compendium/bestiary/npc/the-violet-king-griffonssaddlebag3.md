...
"traits":
  ...
  - "desc": "After the Violet King rolls dice to restore hit points to a single creature\
    ...
    "name": "Overrule"
  - "desc": "As a bonus action, the Violet King can summon his rapier, causing it\
      \ to teleport instantly to his hand."
    "name": "Bonded Weapon"
"actions":
...
"reactions":
  - "desc": "When the Violet King or a creature within 5 feet of him would be hit\
      \ by an attack, he adds 5 to the target's AC against that attack. To do so,\
      \ he must see the attacker and be wielding his rapier."
    "name": "Superior Parry"
"source":
  - "GriffonsSaddlebag3"
```
