...
condition: healthy
images: 
- compendium/bestiary/npc/img/escher.webp
relationships: []
aliases: [Escher]
pronounced: 
race: 
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by Escher,\
    ...
    \ and Escher regains hit points equal to that amount. The reduction lasts until\
