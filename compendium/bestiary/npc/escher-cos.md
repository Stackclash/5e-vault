...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Escher, [incapacitated](compendium/rules/conditions.md#incapacitated), or\
...
```ad-statblock
title: Escher
![](/compendium/bestiary/npc/token/escher.png#token)
...
_Stake to the Heart._ Escher is destroyed if a piercing weapon made of wood is driven into its heart while it is [incapacitated](compendium/rules/conditions.md#incapacitated) in its resting place.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one willing creature, or a creature that is [grappled](compendium/rules/conditions.md#grappled) by Escher, [incapacitated](compendium/rules/conditions.md#incapacitated), or [restrained](compendium/rules/conditions.md#restrained). Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) piercing damage plus `dice: 2d6|avg` (`2d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and Escher regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0.

***Claws.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one creature. Hit: `dice: 2d4 + 3|avg` (`2d4 + 3`) slashing damage. Instead of dealing damage, Escher can grapple the target (escape DC 13).
```
^statblock
