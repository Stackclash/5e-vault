...
"traits":
  ...
  - "desc": "Helga has the following flaws:\n\n- Forbiddance. Helga can't enter\
      ...
      \ made of wood is driven into its heart while it is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature,\
      ...
      \ by Helga, [incapacitated](/compendium/rules/conditions.md#Incapacitated),\
      \ or [restrained](/compendium/rules/conditions.md#Restrained). Hit: 6 (1d6\
...
"source":
  - "CoS"
"image": "/compendium/bestiary/npc/token/helga-ruvak-cos.webp"
```
^statblock
