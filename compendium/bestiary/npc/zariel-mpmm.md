...
***Flail.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 8|avg` (`2d8 + 8`) force damage plus `dice: 8d8|avg` (`8d8`) fire damage.

***Longsword.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 8|avg` (`2d8 + 8`) radiant damage, or 19 (`dice: 2d10 + 8|avg` (`2d10 + 8`)) radiant damage when used with two hands, plus `dice: 8d8|avg` (`8d8`) fire damage.
...
***Immolating Gaze (Costs 2 Actions).*** Zariel turns her magical gaze toward one creature she can see within 120 feet of her and commands it to burn. The target must succeed on a DC 26 Wisdom saving throw or take `dice: 4d10|avg` (`4d10`) fire damage.
