...
- "desc": "Zariel touches one creature within 10 feet of her. The target must succeed\
    ...
    \ [poisoned](/compendium/rules/conditions.md#Poisoned) for 1 minute. While [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ in this way, the target is [blinded](/compendium/rules/conditions.md#Blinded)\
    \ and [deafened](/compendium/rules/conditions.md#Deafened). The target can repeat\
...
- "desc": "- Fireball. Zariel casts the [fireball](compendium/spells/fireball.md)\
    ...
    \ become [frightened](/compendium/rules/conditions.md#Frightened) of the illusion\
