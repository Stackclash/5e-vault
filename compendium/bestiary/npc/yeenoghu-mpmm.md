...
location: 
condition: healthy
image: compendium/bestiary/npc/img/yeenoghu.webp
relationships: []
tags: 
aliases: [Yeenoghu]
pronounced: 
...
- "desc": "Melee Weapon Attack: dice: d20+16 (+16 to hit), reach 15 ft., one target.\
    ...
    \ must succeed on a DC 17 Constitution saving throw or be [paralyzed](/compendium/rules/conditions.md#paralyzed)\
    \ until the start of Yeenoghu's next turn.  "
  "name": "Flail"
