...
condition: healthy
images: 
- compendium/bestiary/npc/img/yeenoghu.webp
relationships: []
aliases: [Yeenoghu]
pronounced: 
race: 
...
- "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one target. Hit: 22\
    ...
    \ or be [paralyzed](/compendium/rules/conditions.md#Paralyzed) until the start\
...
- "desc": "- Incite the Pack. Until the next initiative count 20, all gnolls and\
    ...
    \ and is [restrained](/compendium/rules/conditions.md#Restrained) by being impaled\
    \ on the spike. A creature can use an action to remove itself (or a creature it\
    \ can reach) from the spike, ending the restrained condition.  \n- Pack Rush.\
