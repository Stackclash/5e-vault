...
# **`=this.file.name`**
*Source: Vecna: Eve of Ruin p. 113*
...
"cr": "3"
"traits":
  - "desc": "Riffel can use its action to polymorph into a wolf-humanoid hybrid or\
    ...
    "name": "Shapechanger"
  - "desc": "Riffel has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
      \ checks that rely on hearing or smell."
    "name": "Keen Hearing and Smell"
"actions":
  - "desc": "Riffel makes two attacks: two with its spear (humanoid form) or one with\
...
"source":
  - "VEoR"
"image": "/compendium/bestiary/npc/token/riffel-veor.webp"
```
^statblock
