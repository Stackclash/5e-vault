...
location: 
condition: healthy
image: compendium/bestiary/npc/img/titivilus.webp
relationships: []
tags: 
aliases: [Titivilus]
pronounced: 
...
- "desc": "Titivilus targets one creature he can see within 10 feet of him. The target\
    ...
    \ in this way, the target must take the [Dash](/compendium/rules/actions.md#Dash)\
    ...
    \ [Dash](/compendium/rules/actions.md#Dash) action. The target can repeat the\
