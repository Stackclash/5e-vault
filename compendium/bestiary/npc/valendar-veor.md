...
"cr": "3"
"traits":
- "desc": "Valendar can use its action to polymorph into a wolf-humanoid hybrid or\
  ...
  "name": "Shapechanger"
- "desc": "Valendar has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
    \ checks that rely on hearing or smell."
  "name": "Keen Hearing and Smell"
"actions":
- "desc": "Valendar makes two attacks: two with its spear (humanoid form) or one with\
...
"source":
- "VEoR"
"image": "compendium/bestiary/npc/token/valendar-veor.webp"
```
^statblock
