...
- "desc": "- Command. Graz'zt casts the command spell on every creature of his\
    ...
    \ within the lair have disadvantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
    \ checks made to hide.  "
  "name": ""
"regional_effects":
...
- "desc": "- Agitated Beasts. Wild beasts within 6 miles of the lair break into\
    ...
    \ ([Insight](/compendium/rules/skills.md#Insight)) checks have disadvantage, and\
    \ all Charisma ([Deception](/compendium/rules/skills.md#Deception)) and Charisma\
    \ ([Persuasion](/compendium/rules/skills.md#Persuasion)) checks have advantage.\
