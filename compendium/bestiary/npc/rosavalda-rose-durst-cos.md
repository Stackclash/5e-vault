...
"actions":
  ...
  - "desc": "One humanoid that Rose can see within 5 feet of it must succeed on a\
      ...
      \ turned or forced out by an effect like the [dispel evil and good](/compendium/spells/dispel-evil-and-good.md)\
...
"source":
  - "CoS"
"image": "/compendium/bestiary/npc/token/rosavalda-rose-durst-cos.webp"
```
^statblock
