...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Deathly Choir"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Rahadin has advantage on saving throws against being [charmed](compendium/rules/conditions.md#charmed),\
...
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Rahadin attacks three times with his scimitar, or twice with his [poisoned](compendium/rules/conditions.md#poisoned)\
    \ darts."
  "name": "Multiattack"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Rahadin
![](/compendium/bestiary/npc/token/rahadin.png#token)
*Medium humanoid(elf), Lawful Evil*

- **Armor Class** 18 ([studded leather](/compendium/items/studded-leather-armor.md))
...
***Deathly Choir.*** Any creature within 10 feet of Rahadin that isn't protected by a [mind blank](/compendium/spells/mind-blank.md) spell hears in its mind the screams of the thousands of people Rahadin has killed. As a bonus action, Rahadin can force all creatures that can hear the screams to make a DC 16 Wisdom saving throw. Each creature takes `dice: 3d10|avg` (`3d10`) psychic damage on a failed save, or half as much damage on a successful one.

***Fey Ancestry.*** Rahadin has advantage on saving throws against being [charmed](compendium/rules/conditions.md#charmed), and magic can't put him to sleep.
...
**1/day**: [magic weapon](/compendium/spells/magic-weapon.md), [nondetection](/compendium/spells/nondetection.md)

**3/day**: [misty step](/compendium/spells/misty-step.md), [phantom steed](/compendium/spells/phantom-steed.md)

## Actions

***Multiattack.*** Rahadin attacks three times with his scimitar, or twice with his [poisoned](compendium/rules/conditions.md#poisoned) darts.

***Scimitar.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 6|avg` (`1d6 + 6`) slashing damage.

***Poisoned Dart.*** *Ranged Weapon Attack:* `dice: d20+10` (+10 to hit), range 20/60 ft., one target. Hit: `dice: 1d4 + 6|avg` (`1d4 + 6`) piercing damage plus `dice: 2d4|avg` (`2d4`) poison damage.
```
^statblock