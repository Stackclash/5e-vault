...
```ad-statblock
title: Cyrus Belview
![](/compendium/bestiary/npc/token/cyrus-belview.png#token)
...
***Keen Hearing and Smell.*** The mongrelfolk has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception)) checks that rely on hearing or smell.
