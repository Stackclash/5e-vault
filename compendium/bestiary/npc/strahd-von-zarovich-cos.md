...
| 13–15 | `dice:1d4+1\|noform\|avg` (`1d4 + 1`) [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) |
...
- "desc": "Strahd is a 9th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ objects](compendium/spells/animate-objects.md), [scrying](compendium/spells/scrying.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by Strahd,\
...
- "desc": "While Strahd is in Castle Ravenloft, he can take lair actions as long as\
    \ he isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
  "name": ""
...
- "desc": "- Until initiative count 20 of the next round, Strahd can pass through\
    ...
    \ and then disappears. The apparition has the statistics of a [specter](compendium/bestiary/undead/specter.md).\
    ...
    \ becomes a [shadow](compendium/bestiary/undead/shadow.md) that obeys Strahd's\
    \ commands, acting on initiative count 20. A [greater restoration](compendium/spells/greater-restoration.md)\
    \ spell or a [remove curse](compendium/spells/remove-curse.md) spell cast on the\
