...
- "desc": "Windfall casts one of the following spells, requiring no material components\
    ...
    \ [Detect Magic](compendium/spells/detect-magic.md), [Light](compendium/spells/light.md),\
    \ [Thaumaturgy](compendium/spells/thaumaturgy.md)\n\n1/day: [Hold Monster](compendium/spells/hold-monster.md)\n\
    \n2/day each: [Hypnotic Pattern](compendium/spells/hypnotic-pattern.md), [Sending](compendium/spells/sending.md)\n\
    \n3/day each: [Shatter](compendium/spells/shatter.md), [Unseen Servant](compendium/spells/unseen-servant.md)"
  "name": "Spellcasting"
- "desc": "A brilliant array of chromatic colors emanates from Windfall, causing attack\
    ...
    \ Windfall has the [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
- "desc": "Windfall wears an iridescent magic coat that was tailored specifically\
    ...
    \ a [Robe of Scintillating Colors](compendium/items/robe-of-scintillating-colors.md)."
...
- "desc": "Windfall targets one creature she can see within 60 feet of herself and\
    ...
    \ [frightened](/compendium/rules/conditions.md#Frightened) condition until the\
