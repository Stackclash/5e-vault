...
- "desc": "When Vladimir's body is destroyed, his soul lingers. After 24 hours, the\
  ...
  "name": "Rejuvenation"
- "desc": "Vladimir wields a [+2 greatsword](compendium/items/2-weapon.md) with a\
    \ hilt sculpted to resemble silver dragon wings and a pommel shaped like a silver\
    \ dragon's head clutching a black opal between its teeth. "
...
"source":
- "CoS"
"image": "compendium/bestiary/npc/token/vladimir-horngaard-cos.webp"
```
^statblock
