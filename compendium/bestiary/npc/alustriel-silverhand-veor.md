...
- "desc": "Alustriel casts one of the following spells, using Intelligence as the\
    ...
    \ [Telepathy](compendium/spells/telepathy.md), [Teleport](compendium/spells/teleport.md),\
    \ [Time Stop](compendium/spells/time-stop.md)\n\n2/day each: [Detect Thoughts](compendium/spells/detect-thoughts.md),\
...
- "desc": "Alustriel carries a magic staff known as the Staff of Silverymoon. In the\
    ...
    \ Power](compendium/items/staff-of-power.md)."
...
- "desc": "Ranged Spell Attack: +14 to hit, range 120 ft., one target. Hit: 65\
    ...
    \ 22 Charisma saving throw. On a failed save, the target has the [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
- "desc": "Brilliant silver fire harmlessly wreathes Alustriel and empowers her. The\
    \ silver fire lasts for 1 hour or until she has the [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
