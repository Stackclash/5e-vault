...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shapechanger"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Kiril has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception))\
...
![](/compendium/bestiary/npc/token/kiril-stoyanovich.png#token)
...
***Keen Hearing and Smell.*** Kiril has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception)) checks that rely on hearing or smell.
