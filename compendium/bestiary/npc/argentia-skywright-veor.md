...
"cr": "3"
"traits":
- "desc": "Argentia can use its action to polymorph into a wolf-humanoid hybrid or\
  ...
  "name": "Shapechanger"
- "desc": "Argentia has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
    \ checks that rely on hearing or smell."
  "name": "Keen Hearing and Smell"
"actions":
- "desc": "Argentia makes two attacks: two with its spear (humanoid form) or one with\
...
"source":
- "VEoR"
"image": "compendium/bestiary/npc/token/argentia-skywright-veor.webp"
```
^statblock
