...
location: 
condition: healthy
image: compendium/bestiary/npc/img/belashyrra.webp
relationships: []
tags: 
aliases: [Belashyrra]
pronounced: 
...
The Lord of Eyes has followers across Khorvaire, and its cults are typically driven by mad visions. Devoted cultists can grow eyes in unusual locations, and might have [darkvision](/compendium/rules/senses.md#darkvision) or other supernatural abilities when they view the world through those eyes. Beholderkin often advise or lead Belashyrra's cults, and cultists typically treat these aberrations as divine beings.
...
- "desc": "If a creature tries to read Belashyrra's thoughts or deals psychic damage\
    ...
    \ [stunned](/compendium/rules/conditions.md#stunned) for 1 minute. The [stunned](/compendium/rules/conditions.md#stunned)\
...
- "desc": "Belashyrra shoots one of the following magical eye rays of its choice,\
    ...
    \ any means short of a [wish](compendium/spells/wish.md) spell.  \n- 2. Domination\
    \ Ray. The target must succeed on a DC 22 Wisdom saving throw or be [charmed](/compendium/rules/conditions.md#charmed)\
    \ by Belashyrra for 1 minute or until the target takes damage. Belashyrra can\
    \ issue telepathic commands to the [charmed](/compendium/rules/conditions.md#charmed)\
    ...
    \ and be [blinded](/compendium/rules/conditions.md#blinded) for 1 minute. Until\
    \ this blindness ends, Belyshyrra can see through the [blinded](/compendium/rules/conditions.md#blinded)\
    \ creature's eyes. The [blinded](/compendium/rules/conditions.md#blinded) creature\
...
- "desc": "Belashyrra rips at the bonds of reality in its immediate area. Each creature\
    ...
    \ or take dice: 3d12|avg (3d12) force damage and gain one level of [exhaustion](/compendium/rules/conditions.md#exhaustion)."
