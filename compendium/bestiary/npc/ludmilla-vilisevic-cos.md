...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by Ludmilla,\
    ...
    \ and Ludmilla regains hit points equal to that amount. The reduction lasts until\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 8 (2d4\
    \ + 3) slashing damage. Instead of dealing damage, Ludmilla can grapple the target\
    \ (escape DC 13)."
  "name": "Claws"
"source":
- "CoS"
