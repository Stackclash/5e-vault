...
"alignment": "Lawful Neutral"
"ac": !!int "14"
"ac_class": "[hide armor](/compendium/items/hide-armor.md); 17 natural armor in dragon\
  \ form"
"hp": !!int "117"
"hit_dice": "18d8 + 36"
"modifier": !!int "2"
...
"actions":
  ...
  - "desc": "Vincent exhales a plume of energy in a 25-foot cone. Each creature in\
      \ the area must make a DC 16 Dexterity saving throw, taking 14 (4d6) damage\
      \ of the type associated with Vincent's dragon type (see the [Dragon Damage\
  ...
  - "desc": "Vincent uses his action to magically polymorph into a Medium dragon of\
      ...
      \ table), or back into his humanoid form. When Vincent polymorphs, it gains\
      \ 120 temporary hit points, and he can choose whether his equipment falls to\
      \ the ground, melds into his new form, or is worn by the new form (if possible).\
      \ He reverts to his humanoid form after 6 hours, if he dies, or if he falls\
      \ [unconscious](/compendium/rules/conditions.md#Unconscious). His statistics\
      \ are the same in each form, other than his AC and speed, as noted."
