...
- "desc": "If Kaybella is subjected to an effect that allows her to make a Dexterity\
    \ saving throw to take only half damage, Kaybella instead takes no damage if she\
...
- "desc": "Kaybella deals an extra 31 (9d6) damage when it hits a target with a weapon\
