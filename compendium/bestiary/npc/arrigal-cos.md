...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Arrigal deals an extra 14 (dice: 4d6|avg (4d6)) damage when it hits\
    ...
    \ the target is within 5 feet of an ally of Arrigal that isn't [incapacitated](compendium/rules/conditions.md#incapacitated)\
...
```ad-statblock
title: Arrigal
![](/compendium/bestiary/npc/token/arrigal.png#token)
...
***Sneak Attack (1/Turn).*** Arrigal deals an extra 14 (`dice: 4d6|avg` (`4d6`)) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Arrigal that isn't [incapacitated](compendium/rules/conditions.md#incapacitated) and Arrigal doesn't have disadvantage on the attack roll.
