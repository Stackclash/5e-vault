...
location: 
condition: healthy
image: compendium/bestiary/npc/img/arrigal.webp
relationships: []
tags: 
aliases: [Arrigal]
pronounced: 
...
- "desc": "Arrigal deals an extra dice: 4d6|avg (4d6) damage when it hits a target\
    ...
    \ is within 5 feet of an ally of Arrigal that isn't [incapacitated](/compendium/rules/conditions.md#incapacitated)\
