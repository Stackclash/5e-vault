...
- "desc": "During its first turn, Arrigal has advantage on attack rolls against any\
    \ creature that hasn't taken a turn. Any hit Arrigal scores against a [surprised](/compendium/rules/conditions.md#Surprised)\
...
- "desc": "Arrigal deals an extra 14 (4d6) damage when it hits a target with a weapon\
    ...
    \ feet of an ally of Arrigal that isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
