...
# **`=this.file.name`**
*Source: Vecna: Eve of Ruin p. 132*
...
"cr": "8"
"traits":
  - "desc": "During its first turn, Laysa has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Laysa scores against a [surprised](/compendium/rules/conditions.md#Surprised)\
      \ creature is a critical hit."
    "name": "Assassinate"
  - "desc": "If Laysa is subjected to an effect that allows it to make a Dexterity\
      \ saving throw to take only half damage, Laysa instead takes no damage if it\
      \ succeeds on the saving throw, and only half damage if it fails."
    "name": "Evasion"
  - "desc": "Laysa deals an extra 14 (4d6) damage when it hits a target with a weapon\
      \ attack and has advantage on the attack roll, or when the target is within\
      \ 5 feet of an ally of Laysa that isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
      \ and Laysa doesn't have disadvantage on the attack roll."
    "name": "Sneak Attack (1/Turn)"
"actions":
  - "desc": "Laysa makes two shortsword attacks."
    "name": "Multiattack"
...
"source":
  - "VEoR"
"image": "/compendium/bestiary/npc/token/laysa-matulin-veor.webp"
```
^statblock
