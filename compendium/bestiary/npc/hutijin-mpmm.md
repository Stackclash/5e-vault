...
condition: healthy
images: 
- compendium/bestiary/npc/img/hutijin.webp
relationships: []
aliases: [Hutijin]
pronounced: 
race: 
...
- "desc": "Melee Weapon Attack: +15 to hit, reach 5 ft., one target. Hit: 15 (2d6\
    ...
    \ or become [poisoned](/compendium/rules/conditions.md#Poisoned). While [poisoned](/compendium/rules/conditions.md#Poisoned)\
