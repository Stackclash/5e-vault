...
condition: healthy
images: 
- /compendium/bestiary/npc/img/060-cos05-11.webp
relationships: []
aliases: [Majesto]
pronounced: 
race: 
...
"actions":
  ...
  - "desc": "Majesto magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ on a spell). Any equipment Majesto wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "CoS"
"image": "/compendium/bestiary/npc/token/majesto-cos.webp"
```
^statblock
