...
- "desc": "Sangora has the following flaws:\n\nForbiddance. Sangora can't enter\
    ...
    \ heart while Sangora is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by Sangora,\
...
- "desc": "Sangora targets one humanoid it can see within 30 feet of it. If the target\
    ...
    \ this magic or be [charmed](/compendium/rules/conditions.md#Charmed) by Sangora.\
    \ The [charmed](/compendium/rules/conditions.md#Charmed) target regards Sangora\
