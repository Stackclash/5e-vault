...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Volenta, [incapacitated](/compendium/rules/conditions.md#incapacitated),\
    ...
    \ damage taken, and Volenta regains hit points equal to that amount. The reduction\
...
"source":
- "CoS"
"image": "compendium/bestiary/npc/token/volenta-popofsky-cos.webp"
```
^statblock
