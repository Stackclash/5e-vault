...
condition: healthy
images: 
- compendium/bestiary/npc/img/vecna-the-archlich.webp
relationships: []
...
"actions":
  ...
  - "desc": "Vecna conjures a torrent of flying, spectral entities that fill a 120-foot\
      ...
      \ save, the creature takes 36 (8d8) necrotic damage and has the [frightened](/compendium/rules/conditions.md#Frightened)\
      \ condition for 1 minute. On a successful save, the creature takes half as much\
      \ damage only. A [frightened](/compendium/rules/conditions.md#Frightened) creature\
  ...
  - "desc": "Vecna causes necrotic magic to engulf one creature he can see within\
      ...
      \ taking 96 (8d8 + 60) necrotic damage on a failed save or half as much damage\
      \ on a successful one. A Humanoid killed by this magic rises as a zombie at\
      \ the start of Vecna's next turn and acts immediately after Vecna in the initiative\
...
"bonus_actions":
  - "desc": "Vecna teleports, along with any equipment he is wearing or carrying,\
      \ up to 30 feet to an unoccupied space he can see. He can cause each creature\
      \ of his choice within 15 feet of his destination space to take 10 (3d6) psychic\
...
"source":
  - "VEoR"
"image": "compendium/bestiary/npc/token/vecna-the-archlich-veor.webp"
```
^statblock
