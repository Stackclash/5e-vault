...
- "desc": "Melee Weapon Attack: +13 to hit, reach 10 ft., one target. Hit: 17\
    ...
    \ it must succeed on a DC 21 Constitution saving throw or have the [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
- "desc": "Miska magically ends the [charmed](/compendium/rules/conditions.md#Charmed)\
    \ and [frightened](/compendium/rules/conditions.md#Frightened) conditions on himself\
