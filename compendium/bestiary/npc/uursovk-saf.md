...
location: 
condition: healthy
image: https://raw.githubusercontent.com/TheGiddyLimit/homebrew/master/_img/SaF/uursovk.jpg
relationships: []
tags: 
aliases: [Uursovk]
pronounced: 
...
- "desc": "Any creature that starts its turn within 10 feet of Uursovk must make a\
    \ DC 16 Intelligence saving throw. On a failure, the creature is [poisoned](/compendium/rules/conditions.md#poisoned)\
...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one creature.\
  ...
  "name": "Bite"
- "desc": "Ranged Weapon Attack: dice: d20+6 (+6 to hit), range 60/180 ft., one\
    \ target. Hit: dice: 2d8 + 2|avg (2d8 + 2) piercing damage."
  "name": "Bone Spine"
...
"source":
- "SaF"
"image": "compendium/bestiary/npc/token/uursovk-saf.webp"
```
^statblock
