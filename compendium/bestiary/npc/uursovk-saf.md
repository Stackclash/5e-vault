...
"traits":
  ...
  - "desc": "Any creature that starts its turn within 10 feet of Uursovk must make\
      \ a DC 16 Intelligence saving throw. On a failure, the creature is [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "Uursovk targets two adjacent creatures, who must each make a DC 16 Constitution\
      ...
      \ to the sum of their hit points, has ability scores equal to the higher of\
      \ each score, and inherits any conditions of the targets. The new entity is\
      \ treated as an individual in combat, but can take any action that either original\
      \ target could take. At the end of each round, the two targets can make DC 16\
      \ Constitution saving throws to revert to their original forms (still sans armor),\
      \ but both targets must succeed in order to end the effect. Otherwise, the effect\
      \ ends after 1 hour"
    "name": "Meld Flesh"
"source":
  - "SaF"
