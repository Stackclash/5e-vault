...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hut is [incapacitated](compendium/rules/conditions.md#incapacitated)\
    \ while the magic gem that animates it is in the area of an [antimagic field](/compendium/spells/antimagic-field.md).\
...
***Antimagic Susceptibility.*** The hut is [incapacitated](compendium/rules/conditions.md#incapacitated) while the magic gem that animates it is in the area of an [antimagic field](/compendium/spells/antimagic-field.md). If targeted by [dispel magic](/compendium/spells/dispel-magic.md), the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](compendium/rules/conditions.md#unconscious) for 1 minute.
