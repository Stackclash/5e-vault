...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Doru, [incapacitated](compendium/rules/conditions.md#incapacitated), or [restrained](compendium/rules/conditions.md#restrained).\
    \ Hit: dice: 1d6 + 3|avg (1d6 + 3) piercing damage plus dice: 2d6|avg (2d6)\
    \ necrotic damage. The target's hit point maximum is reduced by an amount equal\
    \ to the necrotic damage taken, and Doru regains hit points equal to that amount.\
...
"source":
- "CoS"
"image": "/compendium/bestiary/npc/token/doru.png"
aliases: ["Doru"]
---
# Doru
*Source: Curse of Strahd p. 47, Derived from Vampire Spawn (MM)*  

```ad-statblock
title: Doru
![](/compendium/bestiary/npc/token/doru.png#token)
...
_Forbiddance._ Doru can't enter a residence without an invitation from one of the occupants.

_Harmed by Running Water._ Doru takes 20 acid damage when it ends its turn in running water.

_Stake to the Heart._ Doru is destroyed if a piercing weapon made of wood is driven into its heart while it is [incapacitated](compendium/rules/conditions.md#incapacitated) in its resting place.

_Sunlight Hypersensitivity._ Doru takes 20 radiant damage when it starts its turn in sunlight. While in sunlight, it has disadvantage on attack rolls and ability checks.

## Actions

***Multiattack.*** Doru makes two attacks, only one of which can be a bite attack.

***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one willing creature, or a creature that is [grappled](compendium/rules/conditions.md#grappled) by Doru, [incapacitated](compendium/rules/conditions.md#incapacitated), or [restrained](compendium/rules/conditions.md#restrained). Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) piercing damage plus `dice: 2d6|avg` (`2d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and Doru regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0.

***Claws.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one creature. Hit: `dice: 2d4 + 3|avg` (`2d4 + 3`) slashing damage. Instead of dealing damage, Doru can grapple the target (escape DC 13).
```
^statblock
