...
location: 
condition: healthy
image: compendium/bestiary/npc/img/doru.webp
relationships: []
tags: 
aliases: [Doru]
pronounced: 
...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Doru, [incapacitated](/compendium/rules/conditions.md#incapacitated), or\
...
"source":
- "CoS"
"image": "compendium/bestiary/npc/token/doru-cos.webp"
```
^statblock
