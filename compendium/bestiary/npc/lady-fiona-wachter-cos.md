...
- "desc": "Fiona is a 5th-level spellcaster. Her spellcasting ability is Wisdom (spell\
    ...
    \n1st level (4 slots): [command](compendium/spells/command.md), [purify food\
    \ and drink](compendium/spells/purify-food-and-drink.md), [sanctuary](compendium/spells/sanctuary.md)\n\
    \n2nd level (3 slots): [augury](compendium/spells/augury.md), [gentle repose](compendium/spells/gentle-repose.md),\
    \ [hold person](compendium/spells/hold-person.md)\n\n3rd level (2 slots):\
    \ [animate dead](compendium/spells/animate-dead.md), [create food and water](compendium/spells/create-food-and-water.md)"
  "name": "spells"
