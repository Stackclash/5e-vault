...
condition: healthy
images: 
- /compendium/bestiary/npc/img/thornboldt-thorn-durst.webp
relationships: []
...
"actions":
  ...
  - "desc": "One humanoid that Thorn can see within 5 feet of it must succeed on a\
      ...
      \ is turned or forced out by an effect like the [dispel evil and good](/compendium/spells/dispel-evil-and-good.md)\
...
"source":
  - "CoS"
"image": "/compendium/bestiary/npc/token/thornboldt-thorn-durst-cos.webp"
```
^statblock
