...
"cr": "7"
"traits":
- "desc": "Vaeve's spellcasting ability is Charisma (spell save DC 12). It can innately\
...
- "desc": "Vaeve is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
    \ (spell save DC 14, +6 to hit with spell attacks). Vaeve has the following wizard\
    ...
    \ (2 slots): [cloudkill](compendium/spells/cloudkill.md)"
  "name": "Spellcasting"
- "desc": "Vaeve has advantage on saving throws against being [charmed](/compendium/rules/conditions.md#Charmed),\
    \ and magic can't put Vaeve to sleep."
  "name": "Fey Ancestry"
- "desc": "While in sunlight, Vaeve has disadvantage on attack rolls, as well as on\
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "Vaeve magically summons a [quasit](compendium/bestiary/fiend/quasit.md),\
...
"source":
- "VEoR"
"image": "compendium/bestiary/npc/token/vaeve-veor.webp"
```
^statblock
