...
condition: healthy
images: 
- compendium/bestiary/npc/img/bael.webp
relationships: []
aliases: [Bael]
pronounced: 
race: 
...
"traits":
  - "desc": "Any creature, other than a devil, that starts its turn within 10 feet\
      \ of Bael must succeed on a DC 22 Wisdom saving throw or be [frightened](/compendium/rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "Each of Bael's allies within 60 feet of him can't be [charmed](/compendium/rules/conditions.md#Charmed)\
      \ or [frightened](/compendium/rules/conditions.md#Frightened) until the end\
      \ of his next turn."
...
"source":
  - "MPMM"
  - "MTF"
"image": "compendium/bestiary/npc/token/bael-mpmm.webp"
```
^statblock
