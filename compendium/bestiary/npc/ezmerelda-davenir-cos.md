...
condition: healthy
images: 
- /compendium/bestiary/npc/img/ezmerelda-davenir.webp
relationships: []
...
Ezmerelda keeps a [deck of tarokka cards](/compendium/decks/tarokka-deck-cos.md) in her wagon (chapter 11, area V1). Although the cards aren't magical, Ezmerelda can use them to perform a card reading for the characters (see chapter 1), like the one that can be performed by Madam Eva.
...
"traits":
  - "desc": "Ezmerelda is a 7th-level spellcaster. Her spellcasting ability is Intelligence\
      ...
      \ (4 slots): [protection from evil and good](/compendium/spells/protection-from-evil-and-good.md),\
      \ [magic missile](/compendium/spells/magic-missile.md), [shield](/compendium/spells/shield.md)\n\
      \n2nd level (3 slots): [darkvision](/compendium/spells/darkvision.md), [knock](/compendium/spells/knock.md),\
      \ [mirror image](/compendium/spells/mirror-image.md)\n\n3rd level (3 slots):\
      \ [clairvoyance](/compendium/spells/clairvoyance.md), [lightning bolt](/compendium/spells/lightning-bolt.md),\
...
"actions":
  ...
  - "desc": "Ezmerelda targets one creature that she can see within 30 feet of her.\
      ...
      \ choice. The curse lasts until ended with a [greater restoration](/compendium/spells/greater-restoration.md)\
  ...
  - "desc": "Ezmerelda targets one creature that she can see within 10 feet of her\
      ...
      \ Ezmerelda is [blinded](/compendium/rules/conditions.md#Blinded) until the\
...
"source":
  - "CoS"
"image": "/compendium/bestiary/npc/token/ezmerelda-davenir-cos.webp"
```
^statblock
