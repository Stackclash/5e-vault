...
"actions":
  ...
  - "desc": "Baron Malgas chooses a target he can see within 30 feet. The target must\
      ...
      \ the effect on itself on a success. Casting [mending](compendium/spells/mending.md)\
      \ on the affected hand also ends the effect. If the target succeeds on a saving\
      \ throw, the creature becomes immune to the baron's Melt Flesh for the next\
      \ 24 hours."
    "name": "Melt Flesh"
"source":
  - "SaF"
