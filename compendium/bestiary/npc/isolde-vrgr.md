...
condition: healthy
images: 
- /compendium/bestiary/npc/img/isolde.webp
relationships: []
aliases: [Isolde]
...
"gear":
  - "[nepenthe](/compendium/items/nepenthe-vrgr.md)"
...
"traits":
  ...
  - "desc": "While holding [Nepenthe](/compendium/items/nepenthe-vrgr.md), Isolde\
      \ creates an aura in a 10-foot radius around her. While this aura is active,\
      \ Isolde and all creatures friendly to her in the aura have advantage on saving\
...
"actions":
  ...
  - "desc": "One humanoid Isolde can see within 30 feet of it must succeed on a DC\
      \ 14 Wisdom saving throw or be magically [charmed](/compendium/rules/conditions.md#Charmed)\
      ...
      \ creature or receives a suicidal command from Isolde, the target can repeat\
      ...
      \ immune to Isolde's Fiendish Charm for the next 24 hours."
    "name": "Fiendish Charm"
"source":
  - "VRGR"
"image": "/compendium/bestiary/npc/token/isolde-vrgr.webp"
```
^statblock
