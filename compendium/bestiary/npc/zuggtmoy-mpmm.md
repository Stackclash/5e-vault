...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
    ...
    \ is [charmed](compendium/rules/conditions.md#charmed) by her and can't be reinfected\
    \ by these spores."
...
***Pseudopod.*** *Melee Weapon Attack:* ++13 to hit, reach 10 ft., one target. Hit: `dice: 2d8 + 6|avg` (`2d8 + 6`) force damage plus `dice: 2d8|avg` (`2d8`) poison damage.
...
- **Summon Fungi.** Zuggtmoy causes four [gas spores](/compendium/bestiary/plant/gas-spore.md) or [violet fungi](/compendium/bestiary/plant/violet-fungus.md) to appear in unoccupied spaces that she chooses within the lair. They vanish after 1 hour.  
...
- If Zuggtmoy dies, these effects fade over the course of `dice: 1d10|avg` (`1d10`) days.  
```
^statblock