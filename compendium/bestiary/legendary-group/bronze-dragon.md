...
- A thunderclap originates at a point the dragon can see within 120 feet of it. Each creature within a 20-foot radius centered on that point must make a DC 15 Constitution saving throw or take `dice:1d10|noform|avg|text(5)` (`1d10`) thunder damage and be [deafened](/compendium/rules/conditions.md#Deafened) until the end of its next turn.  
