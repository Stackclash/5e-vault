...
- Orcus causes skeletal arms to rise from an area on the ground in a 20-foot square that he can see. They last until the next initiative count 20. Each creature in that area when the arms appear must succeed on a DC 23 Strength saving throw or be [restrained](/compendium/rules/conditions.md#restrained) until the arms disappear or until Orcus releases their grasp (no action required).  
