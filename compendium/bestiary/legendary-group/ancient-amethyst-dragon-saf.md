...
- The dragon manifests [believe](compendium/optional-features/believe-saf.md) at no cost.  
- The dragon manifests [forget](compendium/optional-features/forget-saf.md) at no cost. If it forces the target to forget a spell, the dragon knows that spell and can cast it using Intelligence as its spellcasting ability, with a DC of 23.  
