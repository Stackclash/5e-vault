...
- "desc": "Prerequisite: 3rd-level retainer\n\nUsing their signature attack, the\
    \ cutpurse attacks a weak point on an enemy creature, causing them to fall [prone](/compendium/rules/conditions.md#prone).\
...
- "desc": "Prerequisite: 5th-level retainer\n\nThe cutpurse throws a satchel of\
    ...
    \ throw or be [blinded](/compendium/rules/conditions.md#blinded). At the end of\
    \ each of its following turns, a [blinded](/compendium/rules/conditions.md#blinded)\
...
- "desc": "Prerequisite: 7th-level retainer\n\nThe cutpurse throws a smoke bomb\
    ...
    \ must make a Constitution saving throw. On a failed save, it takes dice: 3d10|avg\
