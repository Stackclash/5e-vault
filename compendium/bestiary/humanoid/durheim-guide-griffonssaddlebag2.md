...
aliases: ["Durheim Guide"]
---
# [Durheim Guide](compendium\bestiary\humanoid/durheim-guide-griffonssaddlebag2.md)
...
- "desc": "If the guide is subjected to an effect that allows it to make a Dexterity\
  ...
  "name": "Evasion"
- "desc": "The guide can cast [mage hand](compendium/spells/mage-hand.md) at will,\
    ...
    \ make the hand [invisible](/compendium/rules/conditions.md#Invisible)."
  "name": "Spirit Hand"
- "desc": "When the guide hits a creature with a melee attack, it can force the target\
    \ to make a DC 13 Constitution saving throw. On a failed save, the target is [stunned](/compendium/rules/conditions.md#Stunned)\
