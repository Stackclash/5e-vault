...
"actions":
  - "desc": "The duergar makes two Iron Fist attacks and two Stomping Foot attacks.\
      ...
      \ [opportunity attacks](/compendium/rules/actions.md#Opportunity%20Attack).\
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 23\
      ...
      \ away in a straight line and be knocked [prone](/compendium/rules/conditions.md#Prone)."
    "name": "Iron Fist"
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 10\
      \ (1d10 + 5) bludgeoning damage, or 21 (3d10 + 5) to a [prone](/compendium/rules/conditions.md#Prone)\
      \ target."
    "name": "Stomping Foot"
