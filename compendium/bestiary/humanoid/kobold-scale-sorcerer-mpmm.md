...
***Chromatic Bolt.*** *Ranged Spell Attack:* `dice: d20+4` (+4 to hit), range 60 feet, one target. Hit: `dice: 2d6 + 2|avg` (`2d6 + 2`) of a type of the kobold's choice: acid, cold, fire, lightning, poison, or thunder.
```
^statblock
