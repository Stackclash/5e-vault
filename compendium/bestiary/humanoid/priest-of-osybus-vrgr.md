...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ creature, it is [paralyzed](compendium/rules/conditions.md#paralyzed) until\
...
![](/compendium/bestiary/humanoid/token/priest-of-osybus.png#token)
