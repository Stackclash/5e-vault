...
![](/compendium/bestiary/humanoid/token/barovian-commoner.png#token)
...
***Pitchfork.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 1d6|avg` (`1d6`) piercing damage.
```
^statblock
