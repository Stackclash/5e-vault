...
- "desc": "The dighrogh attempts to swallow a target it is grappling that is at least\
    ...
    \ throw or be swallowed, ending the grapple. The swallowed target is [blinded](/compendium/rules/conditions.md#Blinded)\
    ...
    \ and can escape from the corpse using 5 feet of movement, exiting [prone](/compendium/rules/conditions.md#Prone)."
  "name": "Swallow"
"source":
- "GriffonsSaddlebag3"
```
