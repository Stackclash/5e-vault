...
***Dark One's Own Luck (Recharges after a Short or Long Rest).*** When the goblin makes an ability check or saving throw, it can add a `dice: d10|avg` (`d10`) to the roll. It can do this after the roll is made but before any of the roll's effects occur.
