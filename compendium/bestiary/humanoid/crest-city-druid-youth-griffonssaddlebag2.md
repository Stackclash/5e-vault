...
---
# [Crest City Druid (Youth)](compendium/bestiary/humanoid/crest-city-druid-youth-griffonssaddlebag2.md)
...
"ac": !!int "13"
"ac_class": "[hide armor](/compendium/items/hide-armor.md); 16 from natural armor\
  \ in dragon form"
"hp": !!int "78"
"hit_dice": "12d8 + 24"
"modifier": !!int "1"
...
"traits":
  - "desc": "The druid is an 8th-level spellcaster. Its spellcasting ability is Wisdom\
      ...
      \ [plant growth](/compendium/spells/plant-growth.md), [protection from energy](/compendium/spells/protection-from-energy.md),\
      \ [wind wall](/compendium/spells/wind-wall.md)\n\n4th level (2 slots): [dominate\
      \ beast](/compendium/spells/dominate-beast.md), [polymorph](/compendium/spells/polymorph.md)"
...
"actions":
  - "desc": "In dragon form, the druid makes two attacks: one with its bite and one\
    ...
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +3 to hit (+6 to hit with [shillelagh](/compendium/spells/shillelagh.md)),\
      \ reach 5 ft., one target. Hit: 2 (d4) slashing damage, or 7 (1d8 + 3) slashing\
  ...
  - "desc": "The druid exhales a plume of energy in a 20-foot cone. Each creature\
      \ in the area must make a DC 14 Dexterity saving throw, taking 10 (3d6) damage\
      \ of the type associated with the druid's dragon type (see the [Dragon Damage\
      \ Type](/compendium/tables/dragon-damage-type-griffonssaddlebag2.md) table)\
  ...
  - "desc": "The druid can use its action to magically polymorph into a Medium dragon\
      ...
      \ 80 temporary hit points, and it can choose whether its equipment falls to\
      \ the ground, melds into its new form, or is worn by the new form (if possible).\
      \ It reverts to its humanoid form after 4 hours, if it dies, or if it falls\
      \ [unconscious](/compendium/rules/conditions.md#Unconscious). Its statistics\
      \ are the same in each form, other than its AC and speed, as noted."
