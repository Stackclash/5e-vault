...
- "desc": "The diviner casts one of the following spells, using Intelligence as the\
    ...
    \ [arcane eye](compendium/spells/arcane-eye.md), [detect magic](compendium/spells/detect-magic.md),\
...
- "desc": "The diviner magically creates a burst of illumination in a 10-foot-radius\
    ...
    \ (10d8) psychic damage and is [stunned](/compendium/rules/conditions.md#Stunned)\
