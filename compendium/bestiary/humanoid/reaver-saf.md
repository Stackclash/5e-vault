...
- "desc": "Prerequisite: 7th-level retainer\n\nThe reaver roars with bestial might.\
    \ Enemies within 30 feet must make a Wisdom saving throw or become [frightened](/compendium/rules/conditions.md#frightened).\
    \ On each of its turns, a [frightened](/compendium/rules/conditions.md#frightened)\
    \ creature must take the Dash action and move away from the reaver by the safest\
    \ route unless there is nowhere to move. If the [frightened](/compendium/rules/conditions.md#frightened)\
