...
aliases: ["Physiker"]
---
# [Physiker](compendium\bestiary\humanoid/physiker-griffonssaddlebag3.md)
...
- "desc": "When the physiker hits a creature with a melee attack, it can force the\
    ...
    \ is [stunned](/compendium/rules/conditions.md#Stunned) until the end of the physiker's\
    \ next turn."
  "name": "Stunning Strike (Recharge 5-6)"
- "desc": "While the physiker is wearing no armor and wielding no shield, its AC includes\
    \ its Wisdom modifier."
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 7 (1d6\
  ...
  "name": "Unarmed Strike"
- "desc": "The physiker casts the [enhance ability](compendium/spells/enhance-ability.md)\
...
- "desc": "The physiker touches a creature or harmlessly launches a blowgun needle\
    ...
    \nOnce a creature regains hit points in this way, it can't do so again until it\
...
- "desc": "When the physiker is hit by a ranged weapon attack, it deflects the missile,\
    ...
    \ is reduced to 0, the physiker catches the missile if it's small enough to hold\
    \ in one hand and the physiker has a hand free. It can then make a ranged weapon\
    \ attack with the caught missile, which has an attack bonus of +7, a normal range\
    \ of 20 feet, and a long range of 60 feet. On a hit, the target takes 7 (1d6 +\
    \ 4) damage of the missile's type."
