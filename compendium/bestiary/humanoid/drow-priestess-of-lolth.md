...
"traits":
  - "desc": "The drow is a 10th-level spellcaster. Her spellcasting ability is Wisdom\
      ...
      \ slots): [lesser restoration](/compendium/spells/lesser-restoration.md),\
      \ [protection from poison](/compendium/spells/protection-from-poison.md), [web](/compendium/spells/web.md)\n\
      ...
      \ slots): [insect plague](/compendium/spells/insect-plague.md), [mass cure\
...
"source":
  - "MM"
"image": "/compendium/bestiary/humanoid/token/drow-priestess-of-lolth.webp"
```
^statblock
