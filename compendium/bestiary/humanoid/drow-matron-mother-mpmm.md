...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft., one target.\
    ...
    \ or become [frightened](compendium/rules/conditions.md#frightened) of the drow\
    \ for 1 minute. The [frightened](compendium/rules/conditions.md#frightened) target\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 15 ft., one creature.\
    ...
    \ times by the [rod](/compendium/items/tentacle-rod.md) on one turn, the target\
