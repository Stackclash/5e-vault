...
"actions":
  ...
  - "desc": "The duergar magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ is broken (as if [concentrating](/compendium/rules/conditions.md#Concentration)\
...
"bonus_actions":
  - "desc": "For 1 minute, the duergar magically decreases in size, along with anything\
      ...
      \ ([Stealth](/compendium/rules/skills.md#Stealth)) checks and a +5 bonus to\
      \ its AC. It can also take a bonus action on each of its turns to take the [Hide](/compendium/rules/actions.md#Hide)\
      \ action."
