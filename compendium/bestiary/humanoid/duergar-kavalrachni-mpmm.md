...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The duergar magically turns [invisible](compendium/rules/conditions.md#invisible)\
    ...
    \ with it. While the [invisible](compendium/rules/conditions.md#invisible) duergar\
    \ is mounted, the mount is [invisible](compendium/rules/conditions.md#invisible)\
