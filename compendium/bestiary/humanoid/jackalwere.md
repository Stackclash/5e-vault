...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shapechanger"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The jackalwere has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception))\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The jackalwere gazes at one creature it can see within 30 feet of it. The\
    ...
    \ to a magical slumber, falling [unconscious](compendium/rules/conditions.md#unconscious)\
    ...
    \ gaze for the next 24 hours. Undead and creatures immune to being [charmed](compendium/rules/conditions.md#charmed)\
