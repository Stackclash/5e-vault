...
"actions":
  ...
  - "desc": "The drow casts one of the following spells, requiring no material components\
      ...
      \ will: [dancing lights](/compendium/spells/dancing-lights.md), [darkness](/compendium/spells/darkness.md)\n\
...
"source":
  - "MPMM"
  - "MTF"
"image": "/compendium/bestiary/humanoid/token/drow-shadowblade-mpmm.webp"
```
^statblock
