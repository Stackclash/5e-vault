...
***Scimitar.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 5|avg` (`1d6 + 5`) slashing damage plus `dice: 6d8|avg` (`6d8`) poison damage.

***Arcane Eruption.*** *Ranged Spell Attack:* `dice: d20+10` (+10 to hit), range 120 ft., one target. Hit: `dice: 8d8|avg` (`8d8`) force damage, and the drow can push the target up to 10 feet away if it is a Large or smaller creature.
