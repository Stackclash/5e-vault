...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Each creature in a 20-foot-radius sphere centered on a point the inquisitor\
    ...
    \ or take dice: 6d8 + 4|avg (6d8 + 4) force damage and be knocked [prone](compendium/rules/conditions.md#prone)\
...
![](/compendium/bestiary/humanoid/token/inquisitor-of-the-tome.png#token)
