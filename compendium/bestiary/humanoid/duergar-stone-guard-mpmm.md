...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The duergar has advantage on attack rolls and Dexterity saving throws while\
    \ standing within 5 feet of an ally wielding a [shield](/compendium/items/shield.md)."
...
***Shortsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) piercing damage, or 11 (`dice: 2d6 + 4|avg` (`2d6 + 4`)) piercing damage while under the effect of Enlarge.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) piercing damage, or 11 (`dice: 2d6 + 4|avg` (`2d6 + 4`)) piercing damage while under the effect of Enlarge.
