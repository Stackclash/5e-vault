...
- "desc": "Prerequisite: 3rd-level retainer\n\nThe tracker casts the [hunter's mark](compendium/spells/hunters-mark.md)\
    \ spell."
  "name": "Hunter's Mark (3/Day)"
- "desc": "Prerequisite: 5th-level retainer\n\nThe tracker casts the [find traps](compendium/spells/find-traps.md)\
    \ spell."
...
- "desc": "Prerequisite: 7th-level retainer\n\nWhen a creature the tracker can see\
    ...
    \ knocks the target [prone](/compendium/rules/conditions.md#prone)."
