...
***Fire Lance.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 10 ft., one target. Hit: `dice: 1d12 + 3|avg` (`1d12 + 3`) piercing damage, or 16 (`dice: 2d12 + 3|avg` (`2d12 + 3`)) piercing damage while under the effect of Enlarge, plus `dice: 1d6|avg` (`1d6`) fire damage.

***Fire Spray (Recharge 5-6).*** From its fire lance, the duergar shoots a 15-foot cone of fire or a line of fire 30 feet long and 5 feet wide. Each creature in that area must make a DC 12 Dexterity saving throw, taking 10 (`dice: 3d6|avg` (`3d6`)) fire damage on a failed save, or half as much damage on a successful one.
