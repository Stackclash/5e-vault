...
"traits":
  - "desc": "The priest is an 8th-level spellcaster. Its spellcasting ability is Wisdom\
      ...
      \ [shatter](/compendium/spells/shatter.md)\n\n3rd level (3 slots): [mass\
      \ healing word](/compendium/spells/mass-healing-word.md), [sending](/compendium/spells/sending.md),\
      \ [spirit guardians](/compendium/spells/spirit-guardians.md)\n\n4th level\
      \ (2 slots): [dimension door](/compendium/spells/dimension-door.md), [Mordenkainen's\
  ...
  - "desc": "As a bonus action, the priest can cause a faint, divine ringing to emanate\
      \ from it for 1 minute. Each friendly creature within 10 feet of the priest\
      \ that hears the sound (including the priest) can immediately make a saving\
      \ throw against one effect on it that's causing it to be [charmed](/compendium/rules/conditions.md#Charmed)\
      \ or [frightened](/compendium/rules/conditions.md#Frightened). A hostile creature\
      \ within 10 feet of the priest that hears the sound instead takes 3 (d6) psychic\
      \ damage. For the duration, the priest can use a bonus action on each of its\
      \ subsequent turns to send out the wave again."
    "name": "Holy Clangor (Recharges After a Short or Long Rest)"
"actions":
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 10\
      \ (2d6 + 3) bludgeoning damage plus 4 (d8) thunder damage."
    "name": "Maul"
"reactions":
  - "desc": "When a creature the priest can see within 60 feet of it is reduced to\
      \ 0 hit points, the priest causes a foretelling death knell to emit from that\
      \ creature.\n\nThe death knell is audible out to a range of 10 feet, and each\
      \ creature the priest chooses that can hear it must make a DC 14 Wisdom saving\
      \ throw. On a failed save, the creature is [frightened](/compendium/rules/conditions.md#Frightened)\
      \ of the triggering target (or whatever is left of it) until the end of its\
      \ next turn. A [frightened](/compendium/rules/conditions.md#Frightened) creature\
      \ is [incapacitated](/compendium/rules/conditions.md#Incapacitated) for the\
      \ duration as it contemplates its own mortality. Each time the creature takes\
