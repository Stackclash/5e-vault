...
- "desc": "Each enemy within 30 feet of the blackguard must succeed on a DC 13 Wisdom\
    ...
    \ of the blackguard for 1 minute. If a [frightened](/compendium/rules/conditions.md#Frightened)\
...
- "desc": "Immediately after the blackguard hits a target with an attack roll, the\
    ...
    \ choice:"
  "name": "Smite"
- "desc": "The target is [blinded](/compendium/rules/conditions.md#Blinded) for 1\
    \ minute. The [blinded](/compendium/rules/conditions.md#Blinded) target can repeat\
