...
- "BGDIA"
- "DSotDQ"
"image": "/compendium/bestiary/humanoid/token/hobgoblin-captain.png"
aliases: ["Hobgoblin Captain"]
---
# Hobgoblin Captain
*Source: Monster Manual p. 186, Hoard of the Dragon Queen, Princes of the Apocalypse, Storm King's Thunder, Waterdeep: Dungeon of the Mad Mage, Baldur's Gate: Descent Into Avernus, Dragonlance: Shadow of the Dragon Queen*  
...
***Martial Advantage.*** Once per turn, the hobgoblin can deal an extra 10 (`dice: 3d6|avg` (`3d6`)) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the hobgoblin that isn't [incapacitated](compendium/rules/conditions.md#incapacitated).

## Actions

***Multiattack.*** The hobgoblin makes two greatsword attacks.

***Greatsword.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2|avg` (`2d6 + 2`) slashing damage.
