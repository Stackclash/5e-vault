...
- "desc": "At the start of each of the warlock's turns, each creature of its choice\
    ...
    \ 3d6|avg (3d6) psychic damage, provided that the warlock isn't [incapacitated](/compendium/rules/conditions.md#incapacitated)."
...
- "desc": "The warlock opens a momentary extraplanar rift within 60 feet of it. The\
    ...
    \ (2d8) psychic damage and is [frightened](/compendium/rules/conditions.md#frightened)\
    \ of the warlock until the start of the warlock's next turn. On a successful save,\
    \ a creature takes half as much damage and isn't [frightened](/compendium/rules/conditions.md#frightened)."
  "name": "Howling Void"
"source":
- "MPMM"
- "VGM"
