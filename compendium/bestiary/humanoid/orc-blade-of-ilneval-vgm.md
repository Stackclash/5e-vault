...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 3|avg` (`2d8 + 3`) slashing damage, or 14 (`dice: 2d10 + 3|avg` (`2d10 + 3`)) slashing damage when used with two hands.
