...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Khurgorbaeyag saw fit to gift this goblin with powers that enable it to\
    \ dominate others. The goblin has dice: 1d3|avg (1d3) other [goblins](/compendium/bestiary/humanoid/goblin.md)\
...
***Khurgorbaeyag's Gift.*** Khurgorbaeyag saw fit to gift this goblin with powers that enable it to dominate others. The goblin has `dice: 1d3|avg` (`1d3`) other [goblins](/compendium/bestiary/humanoid/goblin.md) that slavishly obey its orders.
