...
- "desc": "Once per turn, the hobgoblin can deal an extra 14 (4d6) damage to a creature\
    ...
    \ the hobgoblin that isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
...
- "desc": "For 1 minute, the hobgoblin can utter a special command or warning whenever\
    ...
    \ die at a time. This effect ends if the hobgoblin is [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
