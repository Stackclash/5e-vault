...
- "desc": "The kobold uses one of the following options (choose one or roll a d8);\
    ...
    \ space within 20 feet of it, and it breaks open on impact. A [swarm of rot grubs](compendium/bestiary/beast/swarm-of-rot-grubs-mpmm.md)\
    ...
    \ saving throw, or it retches and is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
    ...
    \ each of the swarm's turns, there's a 50 percent chance that the swarm disperses.\
    \  "
