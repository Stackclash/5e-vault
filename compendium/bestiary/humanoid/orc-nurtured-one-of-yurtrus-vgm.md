...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When the orc is reduced to 0 hit points, it explodes, and any creature\
    ...
    \ save, the creature takes dice: 4d6|avg (4d6) poison damage and becomes [poisoned](compendium/rules/conditions.md#poisoned).\
    \ On a success, the creature takes half as much damage and isn't [poisoned](compendium/rules/conditions.md#poisoned).\
    \ A creature [poisoned](compendium/rules/conditions.md#poisoned) by this effect\
    \ can repeat the save at the end of each of its turn, ending the effect on itself\
    \ on a success. While [poisoned](compendium/rules/conditions.md#poisoned) by this\
