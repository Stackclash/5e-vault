...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The mongrelfolk has one of the following extraordinary features, determined\
    ...
    \ The mongrelfolk has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception))\
    ...
    \ start.\n\n20: Two-Headed. The mongrelfolk has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception))\
...
11–15: Keen Hearing and Smell. The mongrelfolk has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception)) checks that rely on hearing or smell.
