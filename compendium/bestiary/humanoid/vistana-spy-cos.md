...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The spy deals an extra 7 (dice: 2d6|avg (2d6)) damage when it hits\
    ...
    \ the target is within 5 feet of an ally of the spy that isn't [incapacitated](compendium/rules/conditions.md#incapacitated)\
