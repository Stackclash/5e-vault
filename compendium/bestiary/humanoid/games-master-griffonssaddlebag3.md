...
"traits":
  ...
  - "desc": "As a bonus action, the master spreads a flurry of dice on the ground\
      ...
      \ it must succeed on a DC 15 Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics))\
      \ check or fall [prone](/compendium/rules/conditions.md#Prone) and take 3 (d6)\
      \ bludgeoning damage."
    "name": "Scatter Dice"
