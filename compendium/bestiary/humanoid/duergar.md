...
"actions":
  ...
  - "desc": "The duergar magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
      \ until it attacks, casts a spell, or uses its Enlarge, or until its [concentration](/compendium/rules/conditions.md#Concentration)\
      \ is broken, up to 1 hour (as if [concentrating](/compendium/rules/conditions.md#Concentration)\
