...
"traits":
  - "desc": "The druid is a 4th-level spellcaster. Its spellcasting ability is Wisdom\
      ...
      \n1st level (4 slots): [entangle](/compendium/spells/entangle.md), [longstrider](/compendium/spells/longstrider.md),\
...
"actions":
  - "desc": "Melee Weapon Attack: +2 to hit (+4 to hit with shillelagh), reach 5\
      ...
      \ if wielded with two hands, or 6 (1d8 + 2) bludgeoning damage with [shillelagh](/compendium/spells/shillelagh.md)."
    "name": "Quarterstaff"
"source":
  - "MM"
  - "CoS"
  - "VEoR"
"image": "/compendium/bestiary/humanoid/token/druid.webp"
```
^statblock
