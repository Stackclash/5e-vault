...
---
# [Pirate Demolitionist](compendium/bestiary/humanoid/pirate-demolitionist-griffonssaddlebag3.md)
...
"cr": "4"
"traits":
  - "desc": "If the demolitionist is subjected to an effect that allows it to make\
      \ a Dexterity saving throw to take only half damage, the demolitionist instead\
      \ takes no damage if it succeeds on the saving throw, and only half damage if\
      \ it fails."
    "name": "Evasion"
  - "desc": "The demolitionist has advantage on any ability check it makes to set,\
      \ disarm, or search for traps."
    "name": "Trap Adept"
"actions":
  ...
  - "desc": "The demolitionist ignites the fuse of one of its handheld bombs, tossing\
      ...
      \ the area must make a DC 14 Dexterity saving throw. A target takes 14 (4d6)\
      \ fire damage and 5 (2d4) piercing damage on a failed save, or half as much\
      \ damage on a successful one. The fire spreads around corners and ignites flammable\
