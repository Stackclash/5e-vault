...
"ac": !!int "13"
"ac_class": "[hide armor](/compendium/items/hide-armor.md); 15 from natural armor\
  \ in dragon form"
"hp": !!int "39"
"hit_dice": "6d8 + 12"
"modifier": !!int "1"
...
"actions":
  - "desc": "Melee Weapon Attack: +2 to hit (+4 to hit with [shillelagh](/compendium/spells/shillelagh.md)),\
      \ reach 5 ft., one target. Hit: 2 (d4) slashing damage, or 6 (1d8 + 2) slashing\
  ...
  - "desc": "The druid exhales a plume of energy in a 15-foot cone. Each creature\
      \ in the area must make a DC 12 Dexterity saving throw, taking 7 (2d6) damage\
  ...
  - "desc": "The druid can use its action to magically polymorph into a Medium dragon\
      ...
      \ 40 temporary hit points, and it can choose whether its equipment falls to\
      \ the ground, melds into its new form, or is worn by the new form (if possible).\
      \ It reverts to its humanoid form after 2 hours, if it dies, or if it falls\
