...
"traits":
  - "desc": "The witch's innate spellcasting ability is Charisma (spell save DC 13).\
      ...
      \nAt will: [detect magic](/compendium/spells/detect-magic.md), [disguise\
      \ self](/compendium/spells/disguise-self.md)\n\n3/day each: [bane](/compendium/spells/bane.md),\
      \ [command](/compendium/spells/command.md), [sleep](/compendium/spells/sleep.md)\
  ...
  - "desc": "The witch can take the Disengage or Hide action as a bonus action on\
      \ each of its turns."
    "name": "Nimble Escape"
  - "desc": "The witch deals an extra 14 (4d6) damage when it hits a target with a\
      \ weapon attack and has advantage on the attack roll, or when the target is\
      \ within 5 feet of an ally of the witch that isn't incapacitated and the witch\
