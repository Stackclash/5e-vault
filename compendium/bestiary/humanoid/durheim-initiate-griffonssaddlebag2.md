...
- Durheim Initiate
---
# [Durheim Initiate](compendium/bestiary/humanoid/durheim-initiate-griffonssaddlebag2.md)
...
"cr": "1/2"
"traits":
  - "desc": "The initiate can cast [mage hand](/compendium/spells/mage-hand.md) at\
      ...
      \ the spell, it can make the hand [invisible](/compendium/rules/conditions.md#Invisible)."
    "name": "Spirit Hand"
  - "desc": "While the initiate is wearing no armor and wielding no shield, its AC\
