...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The sahuagin is a 6th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ (trident)\n\n3rd level (3 3rd-level slots): [mass healing word](/compendium/spells/mass-healing-word.md),\
...
**1st level (4 1st-level slots)**: [bless](/compendium/spells/bless.md), [detect magic](/compendium/spells/detect-magic.md), [guiding bolt](/compendium/spells/guiding-bolt.md)

**2nd level (3 2nd-level slots)**: [hold person](/compendium/spells/hold-person.md), [spiritual weapon](/compendium/spells/spiritual-weapon.md) (trident)

**3rd level (3 3rd-level slots)**: [mass healing word](/compendium/spells/mass-healing-word.md), [tongues](/compendium/spells/tongues.md)
