...
---
# [Fireforge Phalanx Elite](compendium/bestiary/humanoid/fireforge-phalanx-elite-griffonssaddlebag3.md)
...
"ac": !!int "20"
"ac_class": "[plate](/compendium/items/plate-armor.md), [shield](/compendium/items/shield.md)"
"hp": !!int "127"
"hit_dice": "15d8 + 60"
"modifier": !!int "0"
"stats":
...
"traits":
  ...
  - "desc": "If the elite moves at least 10 feet straight toward a Large or smaller\
    ...
    "name": "Charge"
  - "desc": "The elite has advantage on saving throws against being [poisoned](/compendium/rules/conditions.md#Poisoned)."
...
"reactions":
  - "desc": "When a creature attacks the elite or another target within 5 feet of\
      \ it, the elite imposes disadvantage on the attack roll. To do so, the elite\
      \ must see the attacker and be wielding a shield. If the attack hits, the damage\
      \ the target takes is reduced by 14 (4d6). If the attack misses, the elite immediately\
