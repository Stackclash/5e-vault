...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12 (2d8\
    ...
    \ target is stable but [poisoned](/compendium/rules/conditions.md#Poisoned) for\
    \ 1 hour, even after regaining hit points, and is [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
...
- "desc": "Ranged Weapon Attack: +8 to hit, range 30/60 ft., one target. Hit:\
    \ The target is [restrained](/compendium/rules/conditions.md#Restrained) by webbing.\
    \ As an action, the [restrained](/compendium/rules/conditions.md#Restrained) target\
