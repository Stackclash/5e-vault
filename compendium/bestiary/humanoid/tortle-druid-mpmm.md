...
"traits":
  - "desc": "The tortle can hold its breath for 1 hour."
    "name": "Hold Breath"
"actions":
  - "desc": "The tortle makes four Claw attacks or two [Nature](/compendium/rules/skills.md#Nature)'s\
      \ Wrath attacks."
    "name": "Multiattack"
  ...
  - "desc": "The tortle withdraws into its shell. Until it emerges, it gains a +4\
      ...
      \ While in its shell, the tortle is [prone](/compendium/rules/conditions.md#Prone),\
