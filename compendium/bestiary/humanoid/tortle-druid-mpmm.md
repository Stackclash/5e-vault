...
***Nature's Wrath.*** *Ranged Spell Attack:* `dice: d20+4` (+4 to hit), range 90 ft., one target. Hit: `dice: 2d6 + 2|avg` (`2d6 + 2`) damage of a type chosen by the tortle: cold, fire, lightning, or thunder.
