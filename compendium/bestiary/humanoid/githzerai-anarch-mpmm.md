...
- "desc": "- Create Object. The anarch casts the creation spell (as a 9th-level\
    ...
    \ used in Limbo, the object remains until the anarch's [concentration](/compendium/rules/conditions.md#Concentration)\
    \ is broken, regardless of its composition. If the anarch moves more than 120\
    \ feet from the object, the anarch's [concentration](/compendium/rules/conditions.md#Concentration)\
