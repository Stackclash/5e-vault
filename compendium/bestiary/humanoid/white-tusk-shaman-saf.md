...
- "desc": "As a bonus action, the orc can transform into a dire wolf for up to 4 hours.\
    ...
    \ true form.\n\nThe orc also reverts to its true form if it dies or falls [unconscious](/compendium/rules/conditions.md#unconscious).\
...
"source":
- "SaF"
"image": "compendium/bestiary/humanoid/token/white-tusk-shaman-saf.webp"
```
^statblock
