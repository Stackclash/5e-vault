...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+3 (+3 to hit), range 5/15 ft., one\
    \ Large or smaller creature. Hit: The target is [restrained](compendium/rules/conditions.md#restrained).\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
    ...
    \ [grappled](compendium/rules/conditions.md#grappled) while the weapon is stuck.\
