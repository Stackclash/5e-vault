...
"traits":
  - "desc": "During its first turn, the assassin has advantage on attack rolls against\
      ...
      \ a [surprised](/compendium/rules/conditions.md#Surprised) creature is a critical\
      \ hit."
    "name": "Assassinate"
  ...
  - "desc": "The assassin deals an extra 14 (4d6) damage when it hits a target with\
      ...
      \ within 5 feet of an ally of the assassin that isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
"source":
  - "CoS"
"image": "/compendium/bestiary/humanoid/token/vistana-assassin-cos.webp"
```
^statblock
