...
- "desc": "The count's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \nAt will: [misty step](compendium/spells/misty-step.md), [hunter's mark](compendium/spells/hunters-mark.md)\n\
    \n3/day: [blur](compendium/spells/blur.md), [mirror image](compendium/spells/mirror-image.md)"
  "name": "innate"
...
- "desc": "As a member of the Court of Arcadia, the count can cast [dominate monster](compendium/spells/dominate-monster.md)\
...
"source":
- "SaF"
"image": "compendium/bestiary/fey/token/orchid-count-saf.webp"
```
^statblock
