...
"actions":
  ...
  - "desc": "Melee  or Ranged Weapon Attack: +8 to hit, reach 5 ft. or range 120\
      ...
      \ saving throw or have the [poisoned](/compendium/rules/conditions.md#Poisoned)\
  ...
  - "desc": "Melee Weapon Attack: +8 to hit, reach 30 ft., one target. Hit: The\
      ...
      \ [restrained](/compendium/rules/conditions.md#Restrained) in this way takes\
      ...
      \ [grappled](/compendium/rules/conditions.md#Grappled) by that vine no longer\
      \ has the [grappled](/compendium/rules/conditions.md#Grappled) condition. All\
  ...
  - "desc": "The dryad casts one of the following spells, requiring no material components\
      ...
      \ will: [Druidcraft](/compendium/spells/druidcraft.md)\n\n2/day each:\
      \ [Pass without Trace](/compendium/spells/pass-without-trace.md), [Spike Growth](/compendium/spells/spike-growth.md)\n\
