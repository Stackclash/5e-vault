...
- "desc": "Ranged Weapon Attack: +6 to hit, range 40/160 ft., one target. Hit:\
    ...
    \ If its saving throw result is 5 or lower, the [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
- "desc": "The sprite magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
    ...
    \ a spell). Any equipment the sprite wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
    \ with it."
  "name": "Invisibility"
"source":
- "MM"
