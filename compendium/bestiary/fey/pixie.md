...
- "desc": "The pixie's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \ [detect evil and good](compendium/spells/detect-evil-and-good.md), [detect thoughts](compendium/spells/detect-thoughts.md),\
    \ [dispel magic](compendium/spells/dispel-magic.md), [entangle](compendium/spells/entangle.md),\
    \ [fly](compendium/spells/fly.md), [phantasmal force](compendium/spells/phantasmal-force.md),\
...
- "desc": "The pixie magically turns [invisible](/compendium/rules/conditions.md#Invisible)\
    ...
    \ Any equipment the pixie wears or carries is [invisible](/compendium/rules/conditions.md#Invisible)\
    \ with it."
