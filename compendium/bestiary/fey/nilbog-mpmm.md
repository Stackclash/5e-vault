...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature that attempts to damage the nilbog must first succeed on a\
    \ DC 12 Charisma saving throw or be [charmed](compendium/rules/conditions.md#charmed)\
    \ until the end of the creature's next turn. A creature [charmed](compendium/rules/conditions.md#charmed)\
