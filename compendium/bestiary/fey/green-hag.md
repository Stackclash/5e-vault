...
- "desc": "The hag magically turns [invisible](/compendium/rules/conditions.md#invisible)\
    ...
    \ ends (as if concentrating on a spell). While [invisible](/compendium/rules/conditions.md#invisible),\
    \ she leaves no physical evidence of her passage, so she can be tracked only by\
    \ magic. Any equipment she wears or carries is [invisible](/compendium/rules/conditions.md#invisible)\
    \ with her."
