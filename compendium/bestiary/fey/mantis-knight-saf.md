...
- "desc": "The knight's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \nAt will: [heroism](compendium/spells/heroism.md), [shield of faith](compendium/spells/shield-of-faith.md)"
  "name": "innate"
...
- "desc": "As a member of the Court of Arcadia, the knight can cast [dominate monster](compendium/spells/dominate-monster.md)\
...
"source":
- "SaF"
"image": "compendium/bestiary/fey/token/mantis-knight-saf.webp"
```
^statblock
