...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any non-eladrin creature that starts its turn within 60 feet of the eladrin\
    ...
    \ creature, the [charmed](compendium/rules/conditions.md#charmed) creature can\
...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2|avg` (`1d8 + 2`) slashing damage, or 7 (`dice: 1d10 + 2|avg` (`1d10 + 2`)) slashing damage if used with two hands, plus `dice: 5d8|avg` (`5d8`) psychic damage.
