...
- "desc": "The hag's spellcasting ability is Charisma (spell save DC 15). She can\
    ...
    \ [sleep](compendium/spells/sleep.md) (dice: 9d8|avg (9d8))"
  "name": "innate"
...
- "desc": "Melee Spell Attack: dice: d20+7 (+7 to hit), reach 5 ft., one creature.\
    \ Hit: dice: 4d6 + 4|avg (4d6 + 4) psychic damage. If the target is [unconscious](/compendium/rules/conditions.md#unconscious),\
...
"reactions":
- "desc": "When an [unconscious](/compendium/rules/conditions.md#unconscious) creature\
