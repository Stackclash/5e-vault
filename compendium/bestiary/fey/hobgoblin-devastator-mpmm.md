...
***Devastating Bolt.*** *Ranged Spell Attack:* `dice: d20+5` (+5 to hit), range 60 ft., one target. Hit: `dice: 4d8 + 3|avg` (`4d8 + 3`) force damage, and the target is knocked [prone](compendium/rules/conditions.md#prone).
```
^statblock
