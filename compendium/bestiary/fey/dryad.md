...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dryad targets one humanoid or beast that she can see within 30 feet\
    ...
    \ throw or be magically [charmed](compendium/rules/conditions.md#charmed). The\
    \ [charmed](compendium/rules/conditions.md#charmed) creature regards the dryad\
    ...
    \ and up to three beasts [charmed](compendium/rules/conditions.md#charmed) at\
    \ a time."
  "name": "Fey Charm"
"source":
- "MM"
