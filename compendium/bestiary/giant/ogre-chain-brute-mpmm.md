...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 10 ft., one target.\
    ...
    \ make a DC 14 Constitution saving throw or be [stunned](/compendium/rules/conditions.md#stunned)\
...
- "desc": "The ogre swings its chain, and every creature within 10 feet of it must\
    ...
    \ dice: 1d8 + 4|avg (1d8 + 4) bludgeoning damage and is knocked [prone](/compendium/rules/conditions.md#prone).\
...
- "MPMM"
- "MTF"
"image": "compendium/bestiary/giant/token/ogre-chain-brute-mpmm.webp"
```
^statblock
