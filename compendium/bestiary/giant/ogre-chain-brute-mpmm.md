...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 13 (2d8\
    ...
    \ throw or be [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute.\
...
- "desc": "The ogre swings its chain, and every creature within 10 feet of it must\
    ...
    \ 8 (1d8 + 4) bludgeoning damage and is knocked [prone](/compendium/rules/conditions.md#Prone).\
