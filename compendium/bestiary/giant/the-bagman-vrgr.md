...
"traits":
  ...
  - "desc": "If a creature tries to read the Bagman's thoughts, that creature must\
      \ succeed on a DC 8 Intelligence saving throw or be [stunned](/compendium/rules/conditions.md#Stunned)\
...
"source":
  - "VRGR"
"image": "/compendium/bestiary/giant/token/the-bagman-vrgr.webp"
```
^statblock
