...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 5 ft., one creature.\
    ...
    \ on a DC 15 Wisdom saving throw or be [stunned](compendium/rules/conditions.md#stunned)\
    \ for 1 minute. The [stunned](compendium/rules/conditions.md#stunned) target can\
