...
- Bog Troll
---
# [Bog Troll](compendium/bestiary/giant/bog-troll-griffonssaddlebag3.md)
...
"traits":
  ...
  - "desc": "Any creature that starts its turn within 10 feet of the troll must succeed\
      \ on a DC 17 Constitution saving throw or be [poisoned](/compendium/rules/conditions.md#Poisoned)\
      \ until the start of the creature's next turn. On a successful saving throw,\
      \ the creature is immune to the stench of all bog trolls for 1 hour."
    "name": "Stench"
  - "desc": "The troll has advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
