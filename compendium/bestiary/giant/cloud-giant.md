...
- "desc": "The giant's innate spellcasting ability is Charisma. It can innately cast\
    ...
    \ fall](compendium/spells/feather-fall.md), [fly](compendium/spells/fly.md), [misty\
    \ step](compendium/spells/misty-step.md), [telekinesis](compendium/spells/telekinesis.md)"
  "name": "innate"
- "desc": "The giant has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
