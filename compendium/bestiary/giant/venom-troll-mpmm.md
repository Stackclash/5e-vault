...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 7 (1d6\
      \ + 4) piercing damage plus 4 (d8) poison damage, and the creature is [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "/compendium/bestiary/giant/token/venom-troll-mpmm.webp"
```
^statblock
