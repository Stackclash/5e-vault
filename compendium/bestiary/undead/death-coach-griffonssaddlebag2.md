...
"traits":
  - "desc": "The death coach's spellcasting ability is Charisma (spell save DC 20.\
      ...
      \ each: [bestow curse](/compendium/spells/bestow-curse.md), [blight](/compendium/spells/blight.md)\n\
  ...
  - "desc": "The area within 60 feet of the death coach is under the effects of a\
      \ [silence](/compendium/spells/silence.md) spell. The death coach is immune\
      \ to this effect."
    "name": "Silencing Aura"
  - "desc": "If the death coach moves at least 20 feet straight toward a creature\
      ...
      \ If the target is [prone](/compendium/rules/conditions.md#Prone), the death\
      \ coach can make another attack with its hooves against the target as a bonus\
      \ action."
