...
- "desc": "The alhoon casts one of the following spells, requiring no material components\
    ...
    \ of invulnerability](compendium/spells/globe-of-invulnerability.md), [invisibility](compendium/spells/invisibility.md),\
    \ [modify memory](compendium/spells/modify-memory.md), [plane shift](compendium/spells/plane-shift.md)\
    \ (self only), [wall of force](compendium/spells/wall-of-force.md)"
  "name": "spells"
...
- "desc": "The alhoon magically emits psychic energy in a 60-foot cone. Each creature\
    ...
    \ 4d8 + 4|avg (4d8 + 4) psychic damage and be [stunned](/compendium/rules/conditions.md#stunned)\
