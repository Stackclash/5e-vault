...
- "desc": "As a bonus action, the will-o'-wisp can target one creature it can see\
    ...
    \ target dies, the will-o'-wisp regains dice: 3d6|avg (3d6) hit points."
  "name": "Consume Life"
...
- "desc": "The will-o'-wisp and its light magically become [invisible](/compendium/rules/conditions.md#invisible)\
    \ until it attacks or uses its Consume Life, or until its [concentration](/compendium/rules/conditions.md#concentration)\
