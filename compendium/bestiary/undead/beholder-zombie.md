...
"condition_immunities": "[poisoned](/compendium/rules/conditions.md#Poisoned), [prone](/compendium/rules/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "The zombie uses a random magical eye ray, choosing a target that it can\
      ...
      \ The targeted creature must succeed on a DC 14 Wisdom saving throw or be [frightened](/compendium/rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- 3. Enervation\
...
"source":
  - "MM"
  - "VEoR"
"image": "/compendium/bestiary/undead/token/beholder-zombie.webp"
```
^statblock
