...
"actions":
  ...
  - "desc": "Ranged Spell Attack: +6 to hit, range 120 ft., one target. Hit: 13\
      ...
      \ on a DC 16 Strength saving throw or become [restrained](/compendium/rules/conditions.md#Restrained)\
  ...
  - "desc": "The deathlock casts one of the following spells, using Charisma as the\
      ...
      \ [darkness](/compendium/spells/darkness.md), [dimension door](/compendium/spells/dimension-door.md),\
      \ [dispel magic](/compendium/spells/dispel-magic.md), [fly](/compendium/spells/fly.md),\
