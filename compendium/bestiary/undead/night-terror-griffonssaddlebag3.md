...
- Night Terror
---
# [Night Terror](compendium/bestiary/undead/night-terror-griffonssaddlebag3.md)
...
"condition_immunities": "[charmed](/compendium/rules/conditions.md#Charmed), [exhaustion](/compendium/rules/conditions.md#Exhaustion),\
  \ [frightened](/compendium/rules/conditions.md#Frightened), [petrified](/compendium/rules/conditions.md#Petrified),\
...
"traits":
  - "desc": "The night terror's spellcasting ability is Charisma (spell save DC 15).\
      ...
      \ components:\n\nAt will: [silent image](/compendium/spells/silent-image.md),\
      \ [thaumaturgy](/compendium/spells/thaumaturgy.md)\n\n3/day each: [bane](/compendium/spells/bane.md),\
  ...
  - "desc": "The night terror can use its action to polymorph into a Small or Medium\
      ...
      \ are the same in each form, but it can only use its flying speed in humanoid\
      \ form if it's polymorphed into a race that is able to fly. Any equipment it\
  ...
  - "desc": "Creatures within 30 feet of the night terror have disadvantage on saving\
      \ throws against being [frightened](/compendium/rules/conditions.md#Frightened),\
      \ and [frightened](/compendium/rules/conditions.md#Frightened) creatures in\
      \ the aura have disadvantage on saving throws against the night terror's spells\
      \ and effects. In addition, the night terror gains 5 temporary hit points at\
      \ the start of each of its turns for each creature within this aura that is\
      \ [frightened](/compendium/rules/conditions.md#Frightened). 14 THE GRIFFON'S\
      \ SADDLEBAG"
    "name": "Aura of Fear"
...
"actions":
  - "desc": "The night terror makes two attacks with its Nightmarish Touch. It can\
    ...
    "name": "Multiattack"
  - "desc": "Melee Spell Attack: +7 to hit (with advantage if the target is [frightened](/compendium/rules/conditions.md#Frightened)),\
  ...
  - "desc": "Each creature within 60 feet of the night terror must succeed on a DC\
      \ 15 Wisdom saving throw or become [frightened](/compendium/rules/conditions.md#Frightened)\
      \ as it is flooded with horrific visions of its deepest fears. While [frightened](/compendium/rules/conditions.md#Frightened)\
      \ in this way, the creature's speed is reduced to 0, and it takes 11 (2d10)\
      \ psychic damage if it starts its turn within 30 feet of the night terror. A\
