...
- monster/size/medium
- monster/type/undead
aliases: ["Priest of Osybus (Blazing Boon)"]
---
# [Priest of Osybus (Blazing Boon)](compendium\bestiary\undead/priest-of-osybus-blazing-boon-vrgr.md)
*Source: Van Richten's Guide to Ravenloft p. 241, Vecna: Eve of Ruin*

```statblock
"name": "Priest of Osybus (Blazing Boon) (VRGR)"
"size": "Medium"
"type": "undead"
"alignment": "Unaligned"
"ac": !!int "14"
...
- "desc": "The priest sloughs off its flesh, and its skeleton crumbles away, leaving\
    \ only its skull. Its stat block is replaced by that of a [flameskull](compendium/bestiary/undead/flameskull.md),\
