...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one creature. Hit: 7 (1d6\
    \ + 4) piercing damage, and if the target is a creature, it is [grappled](/compendium/rules/conditions.md#Grappled)\
    \ (escape DC 15)."
  "name": "Tentacles"
- "desc": "The mind flayer targets one creature it is grappling. The target must succeed\
    ...
    \ of [exhaustion](/compendium/rules/conditions.md#Exhaustion). The mind flayer\
