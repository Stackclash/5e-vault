...
"traits":
  ...
  - "desc": "When the deathwolf falls, it descends at a rate of 60 feet per round\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 14\
      ...
      \ the [frightened](/compendium/rules/conditions.md#Frightened) condition. This\
      \ curse lasts until removed by the [Remove Curse](/compendium/spells/remove-curse.md)\
  ...
  - "desc": "The deathwolf creates a terrifying phantom of itself in the mind of a\
      ...
      \ on a DC 17 Intelligence saving throw or have the [frightened](/compendium/rules/conditions.md#Frightened)\
      \ condition for 1 minute.\n\nWhile the target is [frightened](/compendium/rules/conditions.md#Frightened),\
      \ the phantom deals 21 (6d6) psychic damage to the target at the start of each\
      \ of the target's turns. A [frightened](/compendium/rules/conditions.md#Frightened)\
...
"reactions":
  ...
  - "desc": "When a creature within 5 feet of the deathwolf makes an attack roll against\
      ...
      \ the deathwolf makes one Claw attack against the creature."
    "name": "Imposing Slash"
...
"source":
  - "VEoR"
"image": "/compendium/bestiary/undead/token/deathwolf-veor.webp"
```
^statblock
