...
*Source: Monster Manual p. 297, Curse of Strahd. Available in the SRD.*  
...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    \ creature, or a creature that is grappled by the vampire, incapacitated, or restrained.\
    ...
    \ target dies if this effect reduces its hit point maximum to 0. A humanoid slain\
    \ in this way and then buried in the ground rises the following night as a [vampire\
