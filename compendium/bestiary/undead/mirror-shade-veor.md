...
"condition_immunities": "[blinded](/compendium/rules/conditions.md#Blinded), [exhaustion](/compendium/rules/conditions.md#Exhaustion),\
...
"traits":
  - "desc": "If the mirror shade is within 5 feet of a reflective surface—such as\
      ...
      \ must succeed on a DC 18 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
...
"actions":
  ...
  - "desc": "The mirror shade targets one creature it can see within 60 feet of itself\
      ...
      \ psychic damage and has the [frightened](/compendium/rules/conditions.md#Frightened)\
...
"source":
  - "VEoR"
"image": "/compendium/bestiary/undead/token/mirror-shade-veor.webp"
```
^statblock
