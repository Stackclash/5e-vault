...
---
# [Demilich (Trap Soul)](compendium\bestiary\undead/demilich-trap-soul.md)
...
- "desc": "Each creature with in 30 feet of the demilich must make a DC 15 Constitution\
    ...
    \ the  [greater restoration](compendium/spells/greater-restoration.md) spell or\
    \ similar magic."
...
- "desc": "- The tomb trembles violently for a moment. Each creature on the floor\
    \ of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](/compendium/rules/conditions.md#Prone).\
...
- "desc": "- The first time a non-evil creature enters the tomb's area, the creature\
    ...
    \ saving throws against being [charmed](/compendium/rules/conditions.md#Charmed)\
    \ or [frightened](/compendium/rules/conditions.md#Frightened), and against features\
