...
- monster/size/medium
- monster/type/undead
aliases: ["Priest of Osybus (Dread Boon)"]
---
# [Priest of Osybus (Dread Boon)](compendium\bestiary\undead/priest-of-osybus-dread-boon-vrgr.md)
*Source: Van Richten's Guide to Ravenloft p. 241, Vecna: Eve of Ruin*

```statblock
"name": "Priest of Osybus (Dread Boon) (VRGR)"
"size": "Medium"
"type": "undead"
"alignment": "Unaligned"
"ac": !!int "14"
...
- "desc": "Eerie whispers can now be heard around the priest. Any non-Undead creature\
    \ that starts its turn within 30 feet of the priest must succeed on a DC 15 Wisdom\
    \ saving throw or be [frightened](/compendium/rules/conditions.md#Frightened)\
    \ of the priest until the start of the creature's next turn."
  "name": "Dread Boon"
"actions":
