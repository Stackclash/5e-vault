...
- monster/size/tiny
- monster/type/undead
aliases: ["Skeletal Raven"]
---
# [Skeletal Raven](compendium\bestiary\undead/skeletal-raven-griffonssaddlebag3.md)
...
- "desc": "The raven can mimic simple sounds it has heard, such as a person whispering,\
    ...
    \ tell they are imitations with a successful DC 8 Wisdom ([Insight](/compendium/rules/skills.md#Insight))\
    \ check."
  "name": "Mimicry"
