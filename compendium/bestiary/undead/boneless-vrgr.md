...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The boneless makes two Slam attacks. If both attacks hit a Large or smaller\
    \ creature, the creature is [grappled](compendium/rules/conditions.md#grappled)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Slam"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The boneless wraps its body around a Large or smaller creature [grappled](compendium/rules/conditions.md#grappled)\
    \ by it. While the boneless is attached, the target is [blinded](compendium/rules/conditions.md#blinded)\
...
```ad-statblock
title: Boneless
![](/compendium/bestiary/undead/token/boneless.png#token)
