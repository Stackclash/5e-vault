...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the skull lord is subjected to an effect that allows it to make a Dexterity\
    ...
    \ it isn't [incapacitated](compendium/rules/conditions.md#incapacitated)."
  "name": "Evasion"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
***Master of the Grave.*** While within 30 feet of the skull lord, any Undead ally of the skull lord makes saving throws with advantage, and that ally regains `dice: 1d6|avg` (`1d6`) hit points whenever it starts its turn there.
...
***Bone Staff.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3|avg` (`1d8 + 3`) bludgeoning damage plus `dice: 6d6|avg` (`6d6`) necrotic damage.

***Deathly Ray.*** *Ranged Spell Attack:* `dice: d20+10` (+10 to hit), range 60 ft., one target. Hit: `dice: 5d8 + 5|avg` (`5d8 + 5`) necrotic damage.
