...
"traits":
  - "desc": "If the skull lord is subjected to an effect that allows it to make a\
      ...
      \ it fails, provided it isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
    "name": "Evasion"
...
"legendary_actions":
  - "desc": "The skull lord makes one Bone Staff or Deathly Ray attack."
    "name": "Attack"
  - "desc": "The skull lord moves up to its speed without provoking [opportunity attacks](/compendium/rules/actions.md#Opportunity%20Attack)."
    "name": "Move"
