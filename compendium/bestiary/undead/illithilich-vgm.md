...
The lich magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 18 Intelligence saving throw or take `dice:5d8+5|noform|noparens|avg|text(27)` (`5d8 + 5`) psychic damage and be [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one creature. Hit:\
      \ 21 (3d10 + 5) psychic damage. If the target is Large or smaller, it is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "Melee Weapon Attack: +12 to hit, reach 5 ft., one [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
      \ humanoid [grappled](/compendium/rules/conditions.md#Grappled) by the lich.\
  ...
  - "desc": "The illithilich magically emits psychic energy in a 60-foot cone. Each\
      ...
      \ take 27 (5d8 + 5) psychic damage and be [stunned](/compendium/rules/conditions.md#Stunned)\
...
"legendary_actions":
  ...
  - "desc": "The illithilich uses a spell slot to cast a 1st-, 2nd-, or 3rd-level\
