...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or\
    \ a creature that is [grappled](/compendium/rules/conditions.md#Grappled) by the\
    \ vampire, [incapacitated](/compendium/rules/conditions.md#Incapacitated), or\
    \ [restrained](/compendium/rules/conditions.md#Restrained). Hit: 7 (1d6 + 4)\
    ...
    \ night as a [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) under\
