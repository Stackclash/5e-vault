...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ [bestow curse](/compendium/spells/bestow-curse.md), [nondetection](/compendium/spells/nondetection.md)\n\
    ...
    \ 5th-level slots): [dominate person](/compendium/spells/dominate-person.md)"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When it drops to 0 hit points outside its resting place, the vampire transforms\
    ...
    \ then [paralyzed](compendium/rules/conditions.md#paralyzed) until it regains\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The vampire has the following flaws:\n\n_Forbiddance._ The vampire can't\
    ...
    \ into the vampire's heart while the vampire is [incapacitated](compendium/rules/conditions.md#incapacitated)\
    \ in its resting place, the vampire is [paralyzed](compendium/rules/conditions.md#paralyzed)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    \ creature, or a creature that is [grappled](compendium/rules/conditions.md#grappled)\
    \ by the vampire, [incapacitated](compendium/rules/conditions.md#incapacitated),\
    \ or [restrained](compendium/rules/conditions.md#restrained). Hit: dice: 1d6\
    ...
    \ in the ground rises the following night as a [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
    ...
    \ throw against this magic or be [charmed](compendium/rules/conditions.md#charmed)\
    \ by the vampire. The [charmed](compendium/rules/conditions.md#charmed) target\
  ...
  "name": "Charm"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The vampire magically calls dice: 2d4|avg (2d4) swarms of [bats](/compendium/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](/compendium/bestiary/beast/swarm-of-rats.md), provided that the sun\
    \ isn't up. While outdoors, the vampire can call dice: 3d6|avg (3d6) [wolves](/compendium/bestiary/beast/wolf.md)\
...
_Stake to the Heart._ If a piercing weapon made of wood is driven into the vampire's heart while the vampire is [incapacitated](compendium/rules/conditions.md#incapacitated) in its resting place, the vampire is [paralyzed](compendium/rules/conditions.md#paralyzed) until the stake is removed.
...
**1st level (4 1st-level slots)**: [comprehend languages](/compendium/spells/comprehend-languages.md), [fog cloud](/compendium/spells/fog-cloud.md), [sleep](/compendium/spells/sleep.md)

**2nd level (3 2nd-level slots)**: [detect thoughts](/compendium/spells/detect-thoughts.md), [gust of wind](/compendium/spells/gust-of-wind.md), [mirror image](/compendium/spells/mirror-image.md)

**3rd level (3 3rd-level slots)**: [animate dead](/compendium/spells/animate-dead.md), [bestow curse](/compendium/spells/bestow-curse.md), [nondetection](/compendium/spells/nondetection.md)

**4th level (3 4th-level slots)**: [blight](/compendium/spells/blight.md), [greater invisibility](/compendium/spells/greater-invisibility.md)
...
***Children of the Night (1/Day).*** The vampire magically calls `dice: 2d4|avg` (`2d4`) swarms of [bats](/compendium/bestiary/beast/swarm-of-bats.md) or [rats](/compendium/bestiary/beast/swarm-of-rats.md), provided that the sun isn't up. While outdoors, the vampire can call `dice: 3d6|avg` (`3d6`) [wolves](/compendium/bestiary/beast/wolf.md) instead. The called creatures arrive in `dice: 1d4|avg` (`1d4`) rounds, acting as allies of the vampire and obeying its spoken commands. The beasts remain for 1 hour, until the vampire dies, or until the vampire dismisses them as a bonus action.
