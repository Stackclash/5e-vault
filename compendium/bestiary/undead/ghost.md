...
"actions":
  ...
  - "desc": "One humanoid that the ghost can see within 5 feet of it must succeed\
      ...
      \ disappears, and the target is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
      ...
      \ Intelligence, Wisdom, Charisma, and immunity to being [charmed](/compendium/rules/conditions.md#Charmed)\
      \ and [frightened](/compendium/rules/conditions.md#Frightened). It otherwise\
      ...
      \ ghost is turned or forced out by an effect like the [dispel evil and good](/compendium/spells/dispel-evil-and-good.md)\
...
"source":
  ...
  - "TCE"
  - "VEoR"
"image": "/compendium/bestiary/undead/token/ghost.webp"
```
^statblock
