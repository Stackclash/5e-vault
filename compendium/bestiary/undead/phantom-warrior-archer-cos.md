...
![](/compendium/bestiary/undead/token/phantom-warrior-archer.png#token)
...
***Spectral Longbow.*** *Ranged Weapon Attack:* `dice: d20+2` (+2 to hit), range 150/600 ft., one target. Hit: `dice: 1d8|avg` (`1d8`) force damage.
```
^statblock