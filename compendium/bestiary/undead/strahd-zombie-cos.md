...
"traits":
  - "desc": "Whenever the zombie takes at least 5 bludgeoning or slashing damage at\
      ...
      \ its bite attack and its body is [blinded](/compendium/rules/conditions.md#Blinded)\
      ...
      \ speed is halved if it's missing a leg. If it loses both legs, it falls [prone](/compendium/rules/conditions.md#Prone).\
