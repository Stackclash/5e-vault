...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The naga is a 5th-level spellcaster (spell save DC 12, dice: d20+4 (+4\
    ...
    \ slots): [command](/compendium/spells/command.md), [shield of faith](/compendium/spells/shield-of-faith.md)\n\
    ...
    \ slots): [bestow curse](/compendium/spells/bestow-curse.md)"
  "name": "spells"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
**1st level (4 1st-level slots)**: [command](/compendium/spells/command.md), [shield of faith](/compendium/spells/shield-of-faith.md)
