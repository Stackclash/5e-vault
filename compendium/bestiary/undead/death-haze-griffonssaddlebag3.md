...
"traits":
  - "desc": "The haze continuously projects the image of a humanoid in its space,\
      ...
      \ to be an illusion, the haze's true smoky form is [invisible](/compendium/rules/conditions.md#Invisible),\
      ...
      \ ([Investigation](/compendium/rules/skills.md#Investigation)) check. If a creature\
      ...
      \ is suppressed. If targeted by [dispel magic](/compendium/spells/dispel-magic.md),\
...
"actions":
  - "desc": "The haze attempts to control the perceptions of a creature it can see\
      ...
      \ or become [charmed](/compendium/rules/conditions.md#Charmed) by the haze for\
      \ 1 hour or until its [concentration](/compendium/rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/compendium/rules/conditions.md#Concentration)\
      \ on a spell). While [charmed](/compendium/rules/conditions.md#Charmed) in this\
  ...
  - "desc": "The haze floods the mind of one creature in its space with visions of\
      ...
      \ [frightened](/compendium/rules/conditions.md#Frightened) until the end of\
