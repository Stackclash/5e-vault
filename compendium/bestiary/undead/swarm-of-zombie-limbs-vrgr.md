...
- "desc": "Melee Weapon Attack: +4 to hit, reach 0 ft., one creature in the swarm's\
    \ space. Hit: 7 (2d6) necrotic damage, and the creature must succeed on a DC\
    \ 12 Strength saving throw or be [restrained](/compendium/rules/conditions.md#Restrained).\
...
"source":
- "VRGR"
"image": "compendium/bestiary/undead/token/swarm-of-zombie-limbs-vrgr.webp"
```
^statblock
