...
"traits":
  - "desc": "The puppeteer's spellcasting ability is Intelligence (spell save DC 19,\
      ...
      \ (4d8)\n\n3/day each: [color spray](/compendium/spells/color-spray.md)\
      \ (as a 5th-level spell), [scorching ray](/compendium/spells/scorching-ray.md)\
  ...
  - "desc": "If the puppeteer moves at least 20 feet straight toward a target and\
      ...
      \ puppeteer and knocked [prone](/compendium/rules/conditions.md#Prone)."
    "name": "Charge"
  ...
  - "desc": "As a bonus action, the puppeteer can magically turn [invisible](/compendium/rules/conditions.md#Invisible)\
      ...
      \ [concentration](/compendium/rules/conditions.md#Concentration) ends (as if\
      \ [concentrating](/compendium/rules/conditions.md#Concentration) on a spell).\
      \ Any strings the puppeteer has attached to a creature and any equipment the\
      \ puppeteer wears or carries are [invisible](/compendium/rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
...
"actions":
  ...
  - "desc": "The puppeteer attempts to flick or throw one creature within 5 feet of\
      ...
      \ the target is flung up to 60 feet away from the puppeteer and knocked [prone](/compendium/rules/conditions.md#Prone),\
  ...
  - "desc": "The puppeteer launches a string from each of its fingertips at one creature\
      ...
      \ [restrained](/compendium/rules/conditions.md#Restrained) in this way, the\
  ...
  - "desc": "The puppeteer attempts to take total control of a creature that has at\
      ...
      \ ([Persuasion](/compendium/rules/skills.md#Persuasion)) check, it uses the\
...
"legendary_actions":
  ...
  - "desc": "The puppeteer snaps its fingers creating a sonic boom that is audible\
      ...
      \ thunder damage and is [stunned](/compendium/rules/conditions.md#Stunned) until\
      \ the end of the puppeteer's next turn. On a successful save, a creature takes\
      \ half as much damage and isn't [stunned](/compendium/rules/conditions.md#Stunned).\
