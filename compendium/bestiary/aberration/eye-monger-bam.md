...
"traits":
  ...
  - "desc": "If the eye monger is motionless and has its eye and mouth closed at the\
      ...
      \ a DC 18 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
...
"actions":
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12\
      ...
      \ eye monger can swallow one creature at a time. A swallowed creature is [blinded](/compendium/rules/conditions.md#Blinded)\
      ...
      \ gullet, the eye monger regurgitates the swallowed creature, which falls [prone](/compendium/rules/conditions.md#Prone)\
