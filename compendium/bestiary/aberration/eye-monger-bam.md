...
- "desc": "If the eye monger is motionless and has its eye and mouth closed at the\
    ...
    \ DC 18 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation))\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12 (2d6\
    ...
    \ can swallow one creature at a time. A swallowed creature is [blinded](/compendium/rules/conditions.md#Blinded)\
    \ and [restrained](/compendium/rules/conditions.md#Restrained), has total cover\
    ...
    \ the eye monger regurgitates the swallowed creature, which falls [prone](/compendium/rules/conditions.md#Prone)\
    ...
    \ by it and can escape from the corpse by using 10 feet of movement, exiting [prone](/compendium/rules/conditions.md#Prone)."
  "name": "Bite"
"source":
- "BAM"
- "VEoR"
"image": "compendium/bestiary/aberration/token/eye-monger-bam.webp"
```
^statblock
