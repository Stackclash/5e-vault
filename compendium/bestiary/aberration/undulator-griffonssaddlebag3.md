...
"actions":
  ...
  - "desc": "The undulator emits a sonorous, mind-altering tone. Each creature within\
      \ 60 feet of the undulator that can hear it must make a DC 18 Wisdom saving\
      \ throw. On a failed save, a creature becomes [charmed](/compendium/rules/conditions.md#Charmed)\
...
"legendary_actions":
  ...
  - "desc": "The undulator slams creatures [grappled](/compendium/rules/conditions.md#Grappled)\
      ...
      \ DC 18 Constitution saving throw or take 19 (4d6 + 5) bludgeoning damage and\
      \ be [stunned](/compendium/rules/conditions.md#Stunned) until the end of the\
      \ undulator's next turn. On a successful save, the target takes half the bludgeoning\
