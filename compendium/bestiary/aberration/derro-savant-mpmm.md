...
***Chromatic Beam.*** The derro launches a brilliant beam of magical energy in a 5-foot-wide line that is 60 feet long. Each creature in the line must make a DC 12 Dexterity saving throw, taking 21 (`dice: 6d6|avg` (`6d6`)) radiant damage on a failed save, or half as much damage on a successful one.
```
^statblock
