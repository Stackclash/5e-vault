...
> 
> Someone who is proficient in Wisdom ([Medicine](/compendium/rules/skills.md#Medicine)) can remove the gem from an [incapacitated](/compendium/rules/conditions.md#incapacitated) slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([Medicine](/compendium/rules/skills.md#Medicine)) check. Each failed attempt deals `dice: 4d10|avg` (`4d10`) psychic damage to the slaad.
...
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one target.\
    ...
    \ transforms into a [red slaad](compendium/bestiary/aberration/red-slaad.md) or,\
    \ if it has the ability to cast spells of 3rd level or higher, a [green slaad](compendium/bestiary/aberration/green-slaad.md).\
