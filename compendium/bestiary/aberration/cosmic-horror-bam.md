...
- "desc": "Melee Weapon Attack: +14 to hit, reach 30 ft., one target. Hit: 18\
    \ (3d6 + 8) force damage, and if the target is a creature, it is [grappled](/compendium/rules/conditions.md#Grappled)\
...
"legendary_actions":
- "desc": "The horror crushes one creature it is grappling. The [grappled](/compendium/rules/conditions.md#Grappled)\
...
- "BAM"
- "VEoR"
"image": "compendium/bestiary/aberration/token/cosmic-horror-bam.webp"
```
^statblock
