...
- "desc": "The seer can move through other creatures and objects as if they were difficult\
    \ terrain, and its movement doesn't provoke [opportunity attacks](/compendium/rules/actions.md#Opportunity%20Attack).\n\
...
- "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 10 (1d8\
    ...
    \ creature, it must succeed on a DC 19 Constitution saving throw or be [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
- "MPMM"
- "MTF"
"image": "compendium/bestiary/aberration/token/star-spawn-seer-mpmm.webp"
```
^statblock
