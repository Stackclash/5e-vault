...
"traits":
  - "desc": "The seer can move through other creatures and objects as if they were\
      \ difficult terrain, and its movement doesn't provoke [opportunity attacks](/compendium/rules/actions.md#Opportunity%20Attack).\n\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 10\
      ...
      \ [incapacitated](/compendium/rules/conditions.md#Incapacitated) until the end\
      \ of its next turn."
    "name": "Comet Staff"
