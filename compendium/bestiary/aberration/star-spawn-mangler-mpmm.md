...
- "desc": "The mangler makes six Claw attacks. Either before or after these attacks,\
    \ it can move up to its speed without provoking [opportunity attacks](/compendium/rules/actions.md#Opportunity%20Attack)."
  "name": "Flurry of Claws (Recharge 5-6)"
"bonus_actions":
- "desc": "While in dim light or darkness, the mangler takes the [Hide](/compendium/rules/actions.md#Hide)\
    \ action."
  "name": "Shadow Stealth"
"source":
- "MPMM"
