...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +8 to hit, reach 20 ft., one target. Hit: 11\
      \ (2d6 + 4) piercing damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "One creature [grappled](/compendium/rules/conditions.md#Grappled) by\
      \ a tentacle of the death kiss must make a DC 16 Constitution saving throw.\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/compendium/bestiary/aberration/token/death-kiss-mpmm.webp"
```
^statblock
