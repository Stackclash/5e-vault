...
"traits":
  - "desc": "When a creature that can see the gauth's central eye starts its turn\
      ...
      \ saving throw if the gauth isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "The gauth shoots three of the following magical eye rays at random (roll\
      ...
      \ succeed on a DC 14 Constitution saving throw or be [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
      ...
      \ Wisdom saving throw or fall asleep and remain [unconscious](/compendium/rules/conditions.md#Unconscious)\
