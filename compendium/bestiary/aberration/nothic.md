...
"cr": "2"
"traits":
  - "desc": "The nothic has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The nothic targets one creature it can see within 30 feet of it. The\
    ...
    "name": "Rotting Gaze"
  - "desc": "The nothic targets one creature it can see within 30 feet of it. The\
      \ target must contest its Charisma ([Deception](/compendium/rules/skills.md#Deception))\
      \ check against the nothic's Wisdom ([Insight](/compendium/rules/skills.md#Insight))\
      \ check. If the nothic wins, it magically learns one fact or secret about the\
      \ target. The target automatically wins if it is immune to being [charmed](/compendium/rules/conditions.md#Charmed)."
    "name": "Weird Insight"
"source":
  - "MM"
  - "CoS"
