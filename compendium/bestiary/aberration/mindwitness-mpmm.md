...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit:\
      \ 20 (4d8 + 2) psychic damage. If the target is Large or smaller, it is [grappled](/compendium/rules/conditions.md#Grappled)\
      \ (escape DC 13), and it must succeed on a DC 13 Intelligence saving throw or\
      \ be [restrained](/compendium/rules/conditions.md#Restrained) until this grapple\
      \ ends."
    "name": "Tentacles"
  - "desc": "The mindwitness shoots one magical eye ray at random (roll a d6, and\
      ...
      \ saving throw or be [frightened](/compendium/rules/conditions.md#Frightened)\
      ...
      \ succeed on a DC 13 Constitution saving throw or be [stunned](/compendium/rules/conditions.md#Stunned)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- 6 Telekinetic\
      ...
      \ and it is [restrained](/compendium/rules/conditions.md#Restrained) by the\
      \ ray's telekinetic grip until the start of the mindwitness's next turn or until\
      \ the mindwitness is [incapacitated](/compendium/rules/conditions.md#Incapacitated).\
