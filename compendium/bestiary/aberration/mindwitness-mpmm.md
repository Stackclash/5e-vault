...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit: 20\
    \ (4d8 + 2) psychic damage. If the target is Large or smaller, it is [grappled](/compendium/rules/conditions.md#Grappled)\
...
- "desc": "The mindwitness shoots one magical eye ray at random (roll a d6, and reroll\
    ...
    \ or be [frightened](/compendium/rules/conditions.md#Frightened) for 1 minute.\
    ...
    \ or be [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute. The target\
    ...
    \ moves it up to 30 feet in any direction, and it is [restrained](/compendium/rules/conditions.md#Restrained)\
