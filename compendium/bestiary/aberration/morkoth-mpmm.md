...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 15 ft., one target. Hit: 15\
      \ (3d8 + 2) bludgeoning damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "The morkoth projects a 30-foot cone of magical energy. Each creature\
      ...
      \ creature is [charmed](/compendium/rules/conditions.md#Charmed) by the morkoth\
      ...
      \ its actions to [Dash](/compendium/rules/actions.md#Dash) until it is within\
      \ 5 feet of the morkoth. A [charmed](/compendium/rules/conditions.md#Charmed)\
...
"regional_effects":
  ...
  - "desc": "- Alter Water. With a thought (no action required), the morkoth can\
      ...
      \ 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. An\
