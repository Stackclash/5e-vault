...
- "desc": "Melee Weapon Attack: +6 to hit, reach 15 ft., one target. Hit: 15 (3d8\
    ...
    \ 15 (3d8 + 2) bludgeoning damage at the start of each of its turns, and the morkoth\
...
- "desc": "The morkoth projects a 30-foot cone of magical energy. Each creature in\
    ...
    \ tries to get as close to the morkoth as possible, using its actions to [Dash](/compendium/rules/actions.md#Dash)\
...
- "desc": "On initiative count 20 (losing initiative ties), the morkoth can take one\
  ...
  "name": ""
- "desc": "- Cast a Spell. The morkoth casts [darkness](compendium/spells/darkness.md),\
    \ [dispel magic](compendium/spells/dispel-magic.md), or [misty step](compendium/spells/misty-step.md),\
...
- "desc": "- Alter Water. With a thought (no action required), the morkoth can\
    ...
    \ it can be recovered with a successful DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
    ...
    \ can activate or suppress at any time while it's in its lair and not [incapacitated](/compendium/rules/conditions.md#Incapacitated).\
