...
"traits":
  ...
  - "desc": "While in bright light, the cloaker has disadvantage on attack rolls and\
      \ Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that\
      \ rely on sight."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 10\
      ...
      \ attaches to the target's head, and the target is [blinded](/compendium/rules/conditions.md#Blinded)\
