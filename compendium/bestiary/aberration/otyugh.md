...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 7 (1d8\
    ...
    \ DC 13) and [restrained](/compendium/rules/conditions.md#Restrained) until the\
    \ grapple ends. The otyugh has two tentacles, each of which can grapple one target."
  "name": "Tentacle"
- "desc": "The otyugh slams creatures [grappled](/compendium/rules/conditions.md#Grappled)\
    ...
    \ [stunned](/compendium/rules/conditions.md#Stunned) until the end of the otyugh's\
