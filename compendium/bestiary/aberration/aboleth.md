...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 12\
      ...
      \ can be removed only by [heal](/compendium/spells/heal.md) or another disease-curing\
      \ spell of 6th level or higher. When the creature is outside a body of water,\
      \ it takes 6 (d12) acid damage every 10 minutes unless moisture is applied to\
  ...
  - "desc": "The aboleth targets one creature it can see within 30 feet of it. The\
      \ target must succeed on a DC 14 Wisdom saving throw or be magically [charmed](/compendium/rules/conditions.md#Charmed)\
      \ by the aboleth until the aboleth dies or until it is on a different plane\
      \ of existence from the target. The [charmed](/compendium/rules/conditions.md#Charmed)\
...
"legendary_actions":
  ...
  - "desc": "The aboleth makes one tail attack."
    "name": "Tail Swipe"
  - "desc": "One creature [charmed](/compendium/rules/conditions.md#Charmed) by the\
...
"lair_actions":
  - "desc": "When fighting inside its lair, an aboleth can invoke the ambient magic\
    ...
    "name": ""
  - "desc": "- The aboleth casts [phantasmal force](/compendium/spells/phantasmal-force.md)\
      \ (no components required) on any number of creatures it can see within 60 feet\
      \ of it. While maintaining [concentration](/compendium/rules/conditions.md#Concentration)\
      ...
      \ or be pulled up to 20 feet into the water and knocked [prone](/compendium/rules/conditions.md#Prone).\
...
"regional_effects":
  ...
  - "desc": "- Underground surfaces within 1 mile of the aboleth's lair are slimy\
      ...
      \ the aboleth has seen before or in any location a creature [charmed](/compendium/rules/conditions.md#Charmed)\
      \ by the aboleth can currently see. Once created, the image lasts for as long\
      \ as the aboleth maintains [concentration](/compendium/rules/conditions.md#Concentration),\
      \ as if [concentrating](/compendium/rules/conditions.md#Concentration) on a\
      \ spell. Although the image is intangible, it looks, sounds, and can move like\
...
"source":
  - "MM"
"image": "/compendium/bestiary/aberration/token/aboleth.webp"
```
^statblock
