...
"traits":
  - "desc": "The intellect devourer can sense the presence and location of any creature\
      ...
      \ of interposing barriers, unless the creature is protected by a [mind blank](/compendium/spells/mind-blank.md)\
      \ spell."
...
"actions":
  ...
  - "desc": "The intellect devourer targets one creature it can see within 10 feet\
      ...
      \ that score is reduced to 0. The target is [stunned](/compendium/rules/conditions.md#Stunned)\
  ...
  - "desc": "The intellect devourer initiates an Intelligence contest with an [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
      ...
      \ and good](/compendium/spells/protection-from-evil-and-good.md). If it wins\
      ...
      \ [wish](/compendium/spells/wish.md). By spending 5 feet of its movement, the\
...
"source":
  - "MM"
"image": "/compendium/bestiary/aberration/token/intellect-devourer.webp"
```
^statblock
