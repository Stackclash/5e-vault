...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 10 ft., one creature.\
    ...
    \ succeed on a DC 11 Constitution saving throw or be [poisoned](compendium/rules/conditions.md#poisoned)\
    \ for 1 minute. The [poisoned](compendium/rules/conditions.md#poisoned) target\
    \ is [paralyzed](compendium/rules/conditions.md#paralyzed), and it can repeat\
    \ the saving throw at the end of each of its turns, ending the effect on a success.\n\
    \nThe target is also [grappled](compendium/rules/conditions.md#grappled) (escape\
    \ DC 15). If the target is Medium or smaller, it is also [restrained](compendium/rules/conditions.md#restrained)\
...
***Beak.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 2|avg` (`2d4 + 2`) piercing damage.
```
^statblock
