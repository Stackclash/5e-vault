...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 15 ft., one target.\
    \ Hit: dice: 1d6 + 4|avg (1d6 + 4) bludgeoning damage. The target is [grappled](/compendium/rules/conditions.md#grappled)\
...
"source":
- "ERLW"
"image": "compendium/bestiary/aberration/token/dolgaunt-erlw.webp"
```
^statblock
