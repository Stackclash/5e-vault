...
"actions":
  - "desc": "Melee Weapon Attack: +7 to hit, reach 30 ft., one target. Hit: 20\
      ...
      \ the grapple ends. The elder brain can have up to four targets [grappled](/compendium/rules/conditions.md#Grappled)\
      \ at a time."
    "name": "Tentacle"
  - "desc": "Creatures of the elder brain's choice within 60 feet of it must succeed\
      ...
      \ and be [stunned](/compendium/rules/conditions.md#Stunned) for 1 minute. A\
...
"legendary_actions":
  - "desc": "The elder brain targets one creature within 120 feet of it with which\
      \ it has a psychic link. The elder brain breaks the creature's [concentration](/compendium/rules/conditions.md#Concentration)\
