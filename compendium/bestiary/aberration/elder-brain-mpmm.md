...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 30 ft., one target.\
    ...
    \ Huge or smaller creature, it is [grappled](compendium/rules/conditions.md#grappled)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The elder brain targets one creature within 120 feet of it with which it\
    \ has a psychic link. The elder brain breaks the creature's [concentration](compendium/rules/status.md#concentration)\
