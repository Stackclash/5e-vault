...
- "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 30 ft., one target.\
    ...
    \ a Huge or smaller creature, it is [grappled](/compendium/rules/conditions.md#grappled)\
    ...
    \ up to four targets [grappled](/compendium/rules/conditions.md#grappled) at a\
    \ time."
  "name": "Tentacle"
- "desc": "Creatures of the elder brain's choice within 60 feet of it must succeed\
    ...
    \ psychic damage and be [stunned](/compendium/rules/conditions.md#stunned) for\
