...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature other than a catoblepas that starts its turn within 10 feet\
    \ of the catoblepas must succeed on a DC 16 Constitution saving throw or be [poisoned](compendium/rules/conditions.md#poisoned)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 10 ft., one target.\
    ...
    \ succeed on a DC 16 Constitution saving throw or be [stunned](compendium/rules/conditions.md#stunned)\
...
```ad-statblock
title: Catoblepas
![](/compendium/bestiary/monstrosity/token/catoblepas.png#token)
