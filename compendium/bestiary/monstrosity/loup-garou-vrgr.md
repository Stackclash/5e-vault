...
```ad-statblock
title: Loup Garou
![](/compendium/bestiary/monstrosity/token/loup-garou.png#token)
...
***Claws (Dire Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) slashing damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [prone](compendium/rules/conditions.md#prone).
