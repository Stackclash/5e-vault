...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 25\
      \ (4d10 + 3) piercing damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
      \ (escape DC 14) if it is a Medium or smaller creature. Until the grapple ends,\
      \ the target is [frightened](/compendium/rules/conditions.md#Frightened), and\
