...
- "desc": "At the end of the borthak's turn, slippery ice covers surfaces within 10\
    ...
    \ turn there, it must succeed on a DC 16 Dexterity saving throw or have the [prone](/compendium/rules/conditions.md#Prone)\
...
- "desc": "The borthak spews acid at a creature it can see within 120 feet of itself.\
    ...
    \ creature takes 24 (7d6) acid damage and has the [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"source":
- "VEoR"
"image": "compendium/bestiary/monstrosity/token/borthak-veor.webp"
```
^statblock
