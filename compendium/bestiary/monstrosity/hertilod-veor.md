...
"traits":
  ...
  - "desc": "If the hertilod takes lightning damage, its speed is halved until the\
      ...
      \ a space within 10 feet of the hertilod and has the [prone](/compendium/rules/conditions.md#Prone)\
      \ condition."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +12 to hit, reach 10 ft., one target. Hit: 15\
      ...
      \ or be swallowed by the hertilod. A swallowed creature has the [blinded](/compendium/rules/conditions.md#Blinded)\
      ...
      \ 10 feet of the hertilod and has the [prone](/compendium/rules/conditions.md#Prone)\
