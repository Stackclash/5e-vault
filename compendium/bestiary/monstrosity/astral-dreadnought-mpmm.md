...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dreadnought's eye creates an area of antimagic, as in the [antimagic\
    ...
    \ doesn't function while the eye is closed or while the dreadnought is [blinded](compendium/rules/conditions.md#blinded)."
  "name": "Antimagic Cone"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+16 (+16 to hit), reach 10 ft., one target.\
    ...
    \ or smaller creature and this damage reduces it to 0 hit points or it is [incapacitated](compendium/rules/conditions.md#incapacitated),\
