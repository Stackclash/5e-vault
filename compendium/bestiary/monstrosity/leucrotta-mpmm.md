...
"traits":
  - "desc": "The leucrotta can mimic Beast sounds and Humanoid voices. A creature\
      ...
      \ DC 14 Wisdom ([Insight](/compendium/rules/skills.md#Insight)) check."
    "name": "Mimicry"
  - "desc": "Any creature other than a leucrotta or gnoll that starts its turn within\
      ...
      \ or be [poisoned](/compendium/rules/conditions.md#Poisoned) until the start\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11\
    ...
    "name": "Hooves"
"bonus_actions":
  - "desc": "Immediately after the leucrotta makes a Hooves attack, it takes the [Disengage](/compendium/rules/actions.md#Disengage)\
      \ action."
