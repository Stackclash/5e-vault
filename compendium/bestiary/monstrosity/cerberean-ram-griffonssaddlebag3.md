...
aliases: ["Cerberean Ram"]
---
# [Cerberean Ram](compendium\bestiary\monstrosity/cerberean-ram-griffonssaddlebag3.md)
...
- "desc": "The ram has advantage on Wisdom (Perception) checks and on saving throws\
    \ against being [blinded](/compendium/rules/conditions.md#Blinded), [charmed](/compendium/rules/conditions.md#Charmed),\
    \ [deafened](/compendium/rules/conditions.md#Deafened), [frightened](/compendium/rules/conditions.md#Frightened),\
    \ [stunned](/compendium/rules/conditions.md#Stunned), or knocked [unconscious](/compendium/rules/conditions.md#Unconscious)."
  "name": "Three Heads"
"actions":
- "desc": "The ram makes three attacks with its horns.\n\nIt can choose to simultaneously\
    ...
    \ throw against being knocked [prone](/compendium/rules/conditions.md#Prone)."
  "name": "Multiattack"
