...
- "desc": "Melee Weapon Attack: dice: d20+19 (+19 to hit), reach 10 ft., one target.\
    ...
    \ a creature, it is [grappled](/compendium/rules/conditions.md#grappled) (escape\
...
- "desc": "The tarrasque makes one bite attack against a Large or smaller creature\
    ...
    \ longer [restrained](/compendium/rules/conditions.md#restrained) by it and can\
    \ escape from the corpse by using 30 feet of movement, exiting [prone](/compendium/rules/conditions.md#prone)."
  "name": "Swallow"
"legendary_actions":
