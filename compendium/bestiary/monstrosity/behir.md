...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one Large or smaller\
      ...
      \ damage. The target is [grappled](/compendium/rules/conditions.md#Grappled)\
      \ (escape DC 16) if the behir isn't already constricting a creature, and the\
      \ target is [restrained](/compendium/rules/conditions.md#Restrained) until this\
      \ grapple ends."
    "name": "Constrict"
  ...
  - "desc": "The behir makes one bite attack against a Medium or smaller target it\
      ...
      \ the creature, which falls [prone](/compendium/rules/conditions.md#Prone) in\
