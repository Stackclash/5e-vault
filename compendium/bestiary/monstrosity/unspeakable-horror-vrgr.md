...
"traits":
  ...
  - "desc": "The horror can move through the space of another creature. The first\
      ...
      \ the creature must succeed on a DC 16 Strength saving throw or be knocked [prone](/compendium/rules/conditions.md#Prone)."
...
"source":
  - "VRGR"
"image": "/compendium/bestiary/monstrosity/token/unspeakable-horror-vrgr.webp"
```
^statblock
