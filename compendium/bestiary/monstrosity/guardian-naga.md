...
- "desc": "The naga is an 11th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [command](compendium/spells/command.md), [cure wounds](compendium/spells/cure-wounds.md),\
...
- "desc": "If it dies, the naga returns to life in dice: 1d6|avg (1d6) days and\
    \ regains all its hit points. Only a [wish](compendium/spells/wish.md) spell can\
