...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one target.\
    ...
    \ the target is [restrained](compendium/rules/conditions.md#restrained), and the\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one Medium\
    ...
    \ is also swallowed, and the grapple ends. The swallowed creature is [blinded](compendium/rules/conditions.md#blinded)\
    ...
    \ a time. While the banderhobb isn't [incapacitated](compendium/rules/conditions.md#incapacitated),\
