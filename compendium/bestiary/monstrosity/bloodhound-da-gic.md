...
"traits":
  - "desc": "The bloodhound knows the most direct path to a tracked creature. If the\
      \ creature is not on the same plane of existence as the bloodhound, it knows\
      \ the closest arcane portal to that plane."
    "name": "Planar Travel"
  - "desc": "The bloodhound has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
      \ checks that rely on hearing or smell."
    "name": "Keen Hearing and Smell"
  - "desc": "The bloodhound has advantage on an attack roll against a creature if\
      \ at least one of the bloodhound's allies is within 5 feet of the creature and\
      \ the ally isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated)."
    "name": "Pack Tactics"
"actions":
  ...
  - "desc": "Ranged Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit:\
      \ The creature is [restrained](/compendium/rules/conditions.md#Restrained).\
