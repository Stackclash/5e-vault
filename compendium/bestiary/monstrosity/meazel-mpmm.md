...
statblock: inline
cr: 1
environments: desert, forest, grassland, hill, mountain, swamp, underdark, urban
size: Medium
tags:
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target of the meazel's\
    \ size or smaller. Hit: 6 (1d6 + 3) bludgeoning damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
...
"bonus_actions":
- "desc": "While in dim light or darkness, the meazel takes the [Hide](/compendium/rules/actions.md#Hide)\
    \ action."
  "name": "Shadow Stealth"
"source":
- "MPMM"
