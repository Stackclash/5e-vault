...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target\
    ...
    \ damage, and the target is [grappled](compendium/rules/conditions.md#grappled)\
...
***Garrote.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target of the meazel's size or smaller. Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) bludgeoning damage, and the target is [grappled](compendium/rules/conditions.md#grappled) (escape DC 13 with disadvantage). Until the grapple ends, the target takes `dice: 2d6 + 3|avg` (`2d6 + 3`) bludgeoning damage at the start of each of the meazel's turns. The meazel can't make weapon attacks while grappling a creature in this way.

***Shortsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) piercing damage plus `dice: 1d6|avg` (`1d6`) necrotic damage
