...
"actions":
  ...
  - "desc": "The yuan-ti targets up to five creatures that it can see within 60 feet\
      ...
      \ on a creature immune to being [charmed](/compendium/rules/conditions.md#Charmed)."
  ...
  - "desc": "The yuan-ti casts one of the following spells, requiring no material\
      ...
      \ (snakes only), [guidance](/compendium/spells/guidance.md), [mage hand](/compendium/spells/mage-hand.md),\
