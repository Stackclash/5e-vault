...
- "desc": "Melee Weapon Attack: +7 to hit, reach 50 ft., one creature. Hit: The\
    \ target is [grappled](/compendium/rules/conditions.md#Grappled) (escape DC 15).\
    \ Until the grapple ends, the target is [restrained](/compendium/rules/conditions.md#Restrained)\
