...
"actions":
  ...
  - "desc": "If the bulette jumps at least 15 feet as part of its movement, it can\
      ...
      \ or Dexterity saving throw (target's choice) or be knocked [prone](/compendium/rules/conditions.md#Prone)\
      ...
      \ [prone](/compendium/rules/conditions.md#Prone), and is pushed 5 feet out of\
      \ the bulette's space into an unoccupied space of the creature's choice. If\
      \ no unoccupied space is within range, the creature instead falls [prone](/compendium/rules/conditions.md#Prone)\
