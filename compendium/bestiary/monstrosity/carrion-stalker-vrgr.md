...
- "desc": "The carrion stalker releases a burst of larvae in a 10-foot-radius sphere\
    ...
    \ [poisoned](/compendium/rules/conditions.md#Poisoned) in this way takes 7 (2d6)\
    ...
    \ the [poisoned](/compendium/rules/conditions.md#Poisoned) condition instantly\
    ...
    \ the corpse, and one survives to become a fully grown carrion stalker in 1d4\
    \ weeks. Any effect that cures diseases or removes the [poisoned](/compendium/rules/conditions.md#Poisoned)\
    \ condition that targets the corpse instantly kills the larvae."
  "name": "Larval Burst (1/Day)"
"source":
- "VRGR"
"image": "compendium/bestiary/monstrosity/token/carrion-stalker-vrgr.webp"
```
^statblock
