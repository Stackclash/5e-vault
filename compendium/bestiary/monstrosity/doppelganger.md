...
"traits":
  ...
  - "desc": "In the first round of a combat, the doppelganger has advantage on attack\
      \ rolls against any creature it [surprised](/compendium/rules/conditions.md#Surprised)."
    "name": "Ambusher"
...
"actions":
  ...
  - "desc": "The doppelganger magically reads the surface thoughts of one creature\
      ...
      \ thoughts, as long as the doppelganger's [concentration](/compendium/rules/conditions.md#Concentration)\
      \ isn't broken (as if [concentrating](/compendium/rules/conditions.md#Concentration)\
