...
- "desc": "The doppelganger magically reads the surface thoughts of one creature within\
    ...
    \ the doppelganger has advantage on Wisdom ([Insight](/compendium/rules/skills.md#Insight))\
    \ and Charisma ([Deception](/compendium/rules/skills.md#Deception), [Intimidation](/compendium/rules/skills.md#Intimidation),\
    \ and [Persuasion](/compendium/rules/skills.md#Persuasion)) checks against the\
    \ target."
  "name": "Read Thoughts"
"source":
- "MM"
