...
"traits":
  - "desc": "When a shadow mastiff howls, all creatures within a 300-foot radius who\
      ...
      \ be panicked. On each of its turns, a panicked creature must take the [Dash](/compendium/rules/actions.md#Dash)\
  ...
  - "desc": "Whenever a shadow mastiff hits an opponent with a bite attack for the\
      \ first time on a turn, the opponent falls [prone](/compendium/rules/conditions.md#Prone)\
