...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Proboscis"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The strigoi magically summons dice: 1d4 + 2|avg (1d4 + 2) [stirges](/compendium/bestiary/beast/stirge.md)\
...
```ad-statblock
title: Strigoi
![](/compendium/bestiary/monstrosity/token/strigoi.png#token)
...
***Ravenous Children (1/Day).*** The strigoi magically summons `dice: 1d4 + 2|avg` (`1d4 + 2`) [stirges](/compendium/bestiary/beast/stirge.md) (see their entry in the Monster Manual) in unoccupied spaces it can see within 30 feet of it. The stirges are under the strigoi's control and act immediately after the strigoi in the initiative order. The stirges disappear after 1 hour, when the strigoi dies, or when the strigoi dismisses them (no action required).
```
^statblock