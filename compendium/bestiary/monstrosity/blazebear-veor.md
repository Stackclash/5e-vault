...
- "desc": "The blazebear targets two creatures it can see within 120 feet of itself.\
    \ Each target must succeed on a DC 15 Wisdom saving throw or have the [stunned](/compendium/rules/conditions.md#Stunned)\
...
"source":
- "VEoR"
"image": "compendium/bestiary/monstrosity/token/blazebear-veor.webp"
```
^statblock
