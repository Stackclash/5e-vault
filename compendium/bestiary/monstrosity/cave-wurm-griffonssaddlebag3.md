...
- "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 20\
    ...
    \ A swallowed creature is [blinded](/compendium/rules/conditions.md#Blinded) and\
    ...
    \ that turn or regurgitate all swallowed creatures, which fall [prone](/compendium/rules/conditions.md#Prone)\
    ...
    \ and can escape from the corpse by using 20 feet of movement, exiting [prone](/compendium/rules/conditions.md#Prone)."
  "name": "Bite"
- "desc": "Melee Weapon Attack: +11 to hit, reach 15 ft., one target. Hit: 17\
    ...
    \ throw or be knocked [prone](/compendium/rules/conditions.md#Prone). If the saving\
    \ throw fails by 5 or more, the target is also [stunned](/compendium/rules/conditions.md#Stunned)\
