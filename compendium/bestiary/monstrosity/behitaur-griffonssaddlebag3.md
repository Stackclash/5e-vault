...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11\
      \ (2d6 + 4) bludgeoning damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "The behitaur exhales a line of lightning that is 15 feet long and 5 feet\
      \ wide. Each creature in that line must make a DC 12 Dexterity saving throw,\
