...
aliases: ["Mimic Cart"]
---
# [Mimic Cart](compendium\bestiary\monstrosity/mimic-cart-griffonssaddlebag3.md)
...
- "desc": "The mimic adheres to anything that touches it. A creature adhered to the\
    \ mimic is also [grappled](/compendium/rules/conditions.md#Grappled) by it (escape\
