...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +19 to hit, reach 5 ft., one target. Hit: 23\
      ...
      \ a Large or smaller creature [grappled](/compendium/rules/conditions.md#Grappled)\
      ...
      \ it takes 28 (8d6) acid damage and 28 (8d6) psychic damage at the start of\
      \ each of the kraken's turns.\n\nIf the kraken takes 60 damage or more on a\
      \ single turn from a creature inside it, the kraken must succeed on a DC 27\
      \ Constitution saving throw at the end of that turn or regurgitate all swallowed\
      \ creatures, which fall [prone](/compendium/rules/conditions.md#Prone) in a\
      \ space within 10 feet of the kraken. If the kraken dies, a swallowed creature\
      \ is no longer [restrained](/compendium/rules/conditions.md#Restrained) by it\
      \ and can escape from the corpse using 15 feet of movement, exiting [prone](/compendium/rules/conditions.md#Prone)."
    "name": "Bite"
  ...
  - "desc": "One Large or smaller object held or creature [grappled](/compendium/rules/conditions.md#Grappled)\
      ...
      \ take the same damage and be knocked [prone](/compendium/rules/conditions.md#Prone)."
    "name": "Fling"
  - "desc": "The kraken magically emits a flurry of psionic energy affecting each\
      \ creature within 120 feet of it that has an Intelligence score of 3 or higher.\
...
"legendary_actions":
  ...
  - "desc": "The kraken expels an ink cloud in a 60-foot-radius sphere around itself.\
      ...
      \ there must succeed on a DC 25 Constitution saving throw, taking 22 (4d10)\
      \ poison damage on a failed save, or half as much damage on a successful one.\
      \ A strong wind or current disperses the cloud, which otherwise disappears at\
