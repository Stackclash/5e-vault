...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
      ...
      \ roll, it attaches by engulfing the target's head, and the target is also [blinded](/compendium/rules/conditions.md#Blinded)\
...
"source":
  - "MM"
"image": "/compendium/bestiary/monstrosity/token/darkmantle.webp"
```
^statblock
