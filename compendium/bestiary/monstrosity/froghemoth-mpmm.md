...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 22\
      ...
      \ or smaller creature. A swallowed creature is [blinded](/compendium/rules/conditions.md#Blinded)\
      ...
      \ or regurgitate all swallowed creatures, each of which falls [prone](/compendium/rules/conditions.md#Prone)\
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 20 ft., one target. Hit: 19\
      \ (3d8 + 6) bludgeoning damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
