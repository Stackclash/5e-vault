...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft., one target.\
    ...
    \ if it is a Medium or smaller creature. A swallowed creature is [blinded](compendium/rules/conditions.md#blinded)\
    ...
    \ all swallowed creatures, each of which falls [prone](compendium/rules/conditions.md#prone)\
    ...
    \ by it and can escape from the corpse using 10 feet of movement, exiting [prone](compendium/rules/conditions.md#prone)."
  "name": "Bite"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 20 ft., one target.\
    \ Hit: dice: 3d8 + 6|avg (3d8 + 6) bludgeoning damage, and the target is [grappled](compendium/rules/conditions.md#grappled)\
