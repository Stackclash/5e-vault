...
aliases: ["Mimic Keg"]
---
# [Mimic Keg](compendium\bestiary\monstrosity/mimic-keg-griffonssaddlebag2.md)
...
"condition_immunities": "[drunkenness](/compendium/rules/conditions.md#Drunkenness),\
...
- "desc": "The mimic can use its action to polymorph into a keg, mug, vat, or other\
    ...
    \ are the same in each form, except when it polymorphs into an object it can choose\
    \ to change its size to Tiny or Small until it polymorphs back into its true form.\
...
- "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
    \ adhered to the mimic is also [grappled](/compendium/rules/conditions.md#Grappled)\
...
- "desc": "The mimic has advantage on attack rolls against any creature [grappled](/compendium/rules/conditions.md#Grappled)\
    \ by it."
  "name": "Grappler"
"actions":
