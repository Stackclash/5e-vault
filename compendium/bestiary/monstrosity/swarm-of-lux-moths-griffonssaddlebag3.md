...
"traits":
  ...
  - "desc": "Creatures behind the swarm are heavily obscured. Other creatures are\
      \ [blinded](/compendium/rules/conditions.md#Blinded) while they are within the\
      \ swarm's space."
  ...
  - "desc": "As a bonus action, the swarm can shape itself to assume any Medium-sized\
      ...
      \ ([Perception](/compendium/rules/skills.md#Perception)) check to identify the\
...
"actions":
  ...
  - "desc": "The swarm illuminates their bodies and swirls in a mesmerizing pattern.\
      ...
      \ a moth must make a DC 11 Wisdom saving throw or become [charmed](/compendium/rules/conditions.md#Charmed)\
