...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 10 ft., one target.\
    \ Hit: dice: 1d6 + 3|avg (1d6 + 3) piercing damage, and the target is [grappled](compendium/rules/conditions.md#grappled)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one creature.\
    ...
    \ or be [poisoned](compendium/rules/conditions.md#poisoned) for 1 minute. If it\
    \ fails the saving throw by 5 or more, the target is also [paralyzed](compendium/rules/conditions.md#paralyzed)\
    \ while [poisoned](compendium/rules/conditions.md#poisoned). The target can repeat\
