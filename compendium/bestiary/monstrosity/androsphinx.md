...
"traits":
  - "desc": "The sphinx is a 12th-level spellcaster. Its spellcasting ability is Wisdom\
      ...
      \ slots): [flame strike](/compendium/spells/flame-strike.md), [greater restoration](/compendium/spells/greater-restoration.md)\n\
...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Each time it roars before finishing\
      ...
      \ Wisdom saving throw is [frightened](/compendium/rules/conditions.md#Frightened)\
      ...
      \ and [frightened](/compendium/rules/conditions.md#Frightened) for 1 minute.\
      \ A [frightened](/compendium/rules/conditions.md#Frightened) creature is [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
      ...
      \ thunder damage and is knocked [prone](/compendium/rules/conditions.md#Prone).\
...
"lair_actions":
  ...
  - "desc": "- The flow of time is altered such that every creature in the lair must\
      ...
      \ choice), but never any younger than 1 year old. A [greater restoration](/compendium/spells/greater-restoration.md)\
