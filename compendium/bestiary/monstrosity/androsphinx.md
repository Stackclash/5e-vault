...
- "desc": "The sphinx is a 12th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [command](compendium/spells/command.md), [detect evil\
    \ and good](compendium/spells/detect-evil-and-good.md), [detect magic](compendium/spells/detect-magic.md)\n\
...
- "desc": "The sphinx emits a magical roar. Each time it roars before finishing a\
    ...
    \ save, the creature takes half as much damage and isn't knocked [prone](/compendium/rules/conditions.md#Prone).\
    \  "
  "name": "Roar (3/Day)"
"legendary_actions":
...
- "desc": "- The flow of time is altered such that every creature in the lair must\
    ...
    \ change. A [wish](compendium/spells/wish.md) spell can return the caster and\
