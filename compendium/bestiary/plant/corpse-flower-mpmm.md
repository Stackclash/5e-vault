...
With or without corpses nested in its body, a corpse flower exudes a stench of decay that can overwhelm the senses of nearby creatures, causing them to become nauseated. The stench, which serves as a defense mechanism, fades `dice:2d4|noform|avg` (`2d4`) days after the corpse flower dies.
...
- "desc": "Each creature that starts its turn within 10 feet of the corpse flower\
    ...
    \ creature is a Construct or an Undead. On a failed save, the creature is [poisoned](/compendium/rules/conditions.md#Poisoned)\
