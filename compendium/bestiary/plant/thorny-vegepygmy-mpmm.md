...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The thorny has advantage on Dexterity ([Stealth](compendium/rules/skills.md#Stealth))\
...
***Thorny Body.*** At the start of its turn, the thorny deals 2 (`dice: 1d4|avg` (`1d4`)) piercing damage to any creature grappling it.
