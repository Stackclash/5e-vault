...
"traits":
  - "desc": "A creature that touches the deathcap or hits it with a melee attack while\
      ...
      \ be [poisoned](/compendium/rules/conditions.md#Poisoned) for 1 minute. A [poisoned](/compendium/rules/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 15 ft., one target. Hit: 10\
      ...
      \ is Medium or smaller, it is [grappled](/compendium/rules/conditions.md#Grappled)\
