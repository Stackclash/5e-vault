...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The shambling mound makes two slam attacks. If both attacks hit a Medium\
    \ or smaller target, the target is [grappled](compendium/rules/conditions.md#grappled)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Slam"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The shambling mound engulfs a Medium or smaller creature [grappled](compendium/rules/conditions.md#grappled)\
    \ by it. The engulfed target is [blinded](compendium/rules/conditions.md#blinded),\
    \ [restrained](compendium/rules/conditions.md#restrained), and unable to breathe,\
