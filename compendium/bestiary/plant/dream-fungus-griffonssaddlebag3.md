...
"actions":
  - "desc": "The fungus ejects spores at one creature it can see within 10 feet of\
      \ it. The target must succeed on a DC 10 Wisdom saving throw or become [charmed](/compendium/rules/conditions.md#Charmed)\
      ...
      Whenever the [charmed](/compendium/rules/conditions.md#Charmed) creature chooses\
      ...
      \ it's using. If an enemy provokes an opportunity attack from the [charmed](/compendium/rules/conditions.md#Charmed)\
      \ creature, the creature must make that attack if it is able to."
    "name": "Frenzying Spores"
  - "desc": "The fungus ejects spores at one creature it can see within 10 feet of\
      \ it. The target must succeed on a DC 10 Wisdom saving throw or become [frightened](/compendium/rules/conditions.md#Frightened)\
