...
- "desc": "When the queen dies, she releases a 10-foot-radius cloud of fungal spores.\
    ...
    \ for 1 minute. If the saving throw fails by 5 or more, the creature is also [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10 (2d6\
    ...
    \ or smaller, it is also [grappled](/compendium/rules/conditions.md#Grappled)."
  "name": "Clutch"
...
- "desc": "The target must succeed on a DC 14 Constitution saving throw against disease\
    \ or become [poisoned](/compendium/rules/conditions.md#Poisoned) until the disease\
