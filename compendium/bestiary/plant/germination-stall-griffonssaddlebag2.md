...
"traits":
  - "desc": "The stall's innate spellcasting ability is Charisma (spell save DC 15).\
      ...
      \ [comprehend languages](/compendium/spells/comprehend-languages.md), [suggestion](/compendium/spells/suggestion.md),\
  ...
  - "desc": "Whenever a humanoid ends its turn within 60 feet of the stall, it must\
      ...
      \ [charmed](/compendium/rules/conditions.md#Charmed) by the stall and must use\
  ...
  - "desc": "The stall is indistinguishable from a normal merchant stall. However,\
      ...
      \ it that is under the effect of a [detect poison and disease](/compendium/spells/detect-poison-and-disease.md)\
...
"actions":
  - "desc": "The stall causes dark, creeping vines to protrude from itself and its\
      ...
      \ by the vines for 1 minute. While [restrained](/compendium/rules/conditions.md#Restrained)\
      ...
      \ [restrained](/compendium/rules/conditions.md#Restrained) creatures it chooses\
      \ as a bonus action."
  ...
  - "desc": "The stall attempts to magically compel one creature [charmed](/compendium/rules/conditions.md#Charmed)\
      ...
      \ a [seed coin](/compendium/bestiary/plant/seed-coin-griffonssaddlebag2.md).\
      ...
      \ regurgitates the coin and is no longer [charmed](/compendium/rules/conditions.md#Charmed)\
