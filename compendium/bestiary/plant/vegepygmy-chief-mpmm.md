...
"actions":
  ...
  - "desc": "A 15-foot-radius cloud of toxic spores extends out from the vegepygmy.\
      ...
      \ Plant must succeed on a DC 12 Constitution saving throw or be [poisoned](/compendium/rules/conditions.md#Poisoned).\
...
"source":
  - "MPMM"
  - "VGM"
"image": "/compendium/bestiary/plant/token/vegepygmy-chief-mpmm.webp"
```
^statblock
