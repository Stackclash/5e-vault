...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the beast moves at least 20 feet straight toward a target and then hits\
    ...
    \ saving throw against your spell save DC or be knocked [prone](compendium/rules/conditions.md#prone)."
  "name": "Charge"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
***Charge.*** If the beast moves at least 20 feet straight toward a target and then hits it with a maul attack on the same turn, the target takes an extra `dice: 1d6|avg` (`1d6`) slashing damage. If the target is a creature, it must succeed on a Strength saving throw against your spell save DC or be knocked [prone](compendium/rules/conditions.md#prone).
