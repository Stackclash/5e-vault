...
"actions":
  - "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 4 (1d6\
      \ + 1) piercing damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "The frog makes one bite attack against a Small or smaller target it is\
      ...
      \ The swallowed target is [blinded](/compendium/rules/conditions.md#Blinded)\
      ...
      \ no longer [restrained](/compendium/rules/conditions.md#Restrained) by it and\
