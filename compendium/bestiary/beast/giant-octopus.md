...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 15 ft., one target. Hit: 10\
      \ (2d6 + 3) bludgeoning damage. If the target is a creature, it is [grappled](/compendium/rules/conditions.md#Grappled)\
...
"source":
  - "MM"
  - "TCE"
"image": "/compendium/bestiary/beast/token/giant-octopus.webp"
```
^statblock
