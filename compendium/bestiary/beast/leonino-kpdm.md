...
- "desc": "The flight of a leonino is especially silent and difficult to notice in\
    \ forests and urban settings. It has advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth))\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 5 (1d4\
    ...
    \ or be [charmed](/compendium/rules/conditions.md#Charmed) by the leonino for\
    \ 1 hour."
  "name": "Bite"
"source":
- "KPDM"
