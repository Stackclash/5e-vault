...
"traits":
  ...
  - "desc": "The serpent can hold its breath for up to 30 minutes."
    "name": "Hold Breath"
  - "desc": "If the serpent hasn't moved on its turn, it can use its Death Roll as\
      \ a bonus action. After it uses this bonus action, its speed is 0 until the\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 13\
      ...
      \ it is [grappled](/compendium/rules/conditions.md#Grappled) (escape DC 14).\n\
  ...
  - "desc": "The serpent thrashes and spins violently. When it does so, it can make\
      ...
      \ or [restrained](/compendium/rules/conditions.md#Restrained) on a success.\
      \ If the serpent is grappling another creature when it performs this maneuver,\
      \ that creature must succeed on a DC 14 Constitution saving throw or become\
      \ [stunned](/compendium/rules/conditions.md#Stunned) until the end of the serpent's\
      \ next turn."
    "name": "Death Roll"
"source":
  - "GriffonsSaddlebag3"
