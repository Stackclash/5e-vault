...
"actions":
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (1d10\
      \ + 2) piercing damage plus 5 (d10) poison damage, and the target is [grappled](/compendium/rules/conditions.md#Grappled)\
  ...
  - "desc": "The toad makes one bite attack against a Medium or smaller target it\
      ...
      \ ends. The swallowed target is [blinded](/compendium/rules/conditions.md#Blinded)\
