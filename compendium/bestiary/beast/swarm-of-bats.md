...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The swarm can't use its blindsight while [deafened](compendium/rules/conditions.md#deafened)."
  "name": "Echolocation"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
***Echolocation.*** The swarm can't use its blindsight while [deafened](compendium/rules/conditions.md#deafened).

***Keen Hearing.*** The swarm has advantage on Wisdom ([Perception](compendium/rules/skills.md#Perception)) checks that rely on hearing.
