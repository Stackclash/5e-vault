...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the triceratops moves at least 20 feet straight toward a creature and\
    ...
    \ a DC 13 Strength saving throw or be knocked [prone](compendium/rules/conditions.md#prone).\
    \ If the target is [prone](compendium/rules/conditions.md#prone), the triceratops\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Gore"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one [prone](compendium/rules/conditions.md#prone)\
...
***Gore.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 4d8 + 6|avg` (`4d8 + 6`) piercing damage.

***Stomp.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one [prone](compendium/rules/conditions.md#prone) creature. Hit: `dice: 3d10 + 6|avg` (`3d10 + 6`) bludgeoning damage
```
^statblock
