...
- "desc": "If the clawfoot moves at least 20 feet straight toward a creature and then\
    ...
    \ 11 Strength saving throw or be knocked [prone](/compendium/rules/conditions.md#prone).\
    \ If the target is [prone](/compendium/rules/conditions.md#prone), the clawfoot\
