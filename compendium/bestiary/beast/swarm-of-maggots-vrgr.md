...
---
# [Swarm of Maggots](compendium/bestiary/beast/swarm-of-maggots-vrgr.md)
...
- "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 0 ft., one target\
    ...
    \n- 1-2. The creature is [blinded](/compendium/rules/conditions.md#blinded)\
    \ until it finishes a long rest.  \n- 3-4. The creature's hit point maximum\
    \ decreases by dice: 2d4|avg (2d4), and the reduction can't be removed until\
    \ the disease ends. The creature dies if its hit point maximum drops to 0.  \n\
    - 5-6. The creature has disadvantage on ability checks and attack rolls until\
    \ it finishes its next long rest.  \n\n    The disease lasts until it's removed\
    \ by magic or until the creature rolls the same random effect for the disease\
    \ two long rests in a row.  "
  "name": "Infestation"
"source":
- "VRGR"
"image": "compendium/bestiary/beast/token/swarm-of-maggots-vrgr.webp"
```
^statblock
