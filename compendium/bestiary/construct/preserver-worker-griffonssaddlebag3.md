...
aliases: ["Preserver Worker"]
---
# [Preserver Worker](compendium\bestiary\construct/preserver-worker-griffonssaddlebag3.md)
...
"cr": "5"
"traits":
- "desc": "If damage reduces the worker to 0 hit points, it drops to 1 hit point instead.\
    \ This trait doesn't function if the damage is from a critical hit. When this\
    \ trait is activated, the worker gains a +5 bonus to its AC and all saving throws\
