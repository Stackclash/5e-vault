...
---
# [Animated Object (Large)](compendium\bestiary\construct/animated-object-large.md)
...
- "desc": "If the object lacks legs or other appendages it can use for locomotion,\
  ...
  "name": "Animated"
"actions":
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12 (2d10\
    \ + 2) bludgeoning damage."
  "name": "Slam"
"source":
- "PHB"
"image": "compendium/bestiary/construct/token/animated-object-large.webp"
```
^statblock
