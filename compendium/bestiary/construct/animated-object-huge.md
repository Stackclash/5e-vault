...
"source":
- "PHB"
"image": "/compendium/bestiary/construct/token/animated-object-huge.png"
...
![](/compendium/bestiary/construct/token/animated-object-huge.png#token)
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d12 + 4|avg` (`2d12 + 4`) bludgeoning damage.
```
^statblock