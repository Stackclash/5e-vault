...
```statblock
"name": "Sivvar's Writing Desk (KPDM)"
"size": "Medium"
"type": "construct"
"alignment": "Unaligned"
"ac": !!int "14"
...
"cr": "1"
"traits":
- "desc": "The desk is incapacitated while in the area of an [antimagic field](compendium/spells/antimagic-field.md).\
    \ If targeted by [dispel magic](compendium/spells/dispel-magic.md), the desk must\
...
- "desc": "The drawers of the desk are locked by a modified version of the [arcane\
    \ lock](compendium/spells/arcane-lock.md) spell. The desk opens its drawers when\
...
- "desc": "If the desk hits the same target with both claw attacks, it rakes the victim\
  ...
  "name": "Rake"
"reactions":
- "desc": "The desk can use [dimension door](compendium/spells/dimension-door.md)\
