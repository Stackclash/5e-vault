...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6\
    ...
    \ within 30 feet, it takes the [Dash](/compendium/rules/actions.md#Dash) action,\
    \ moving toward the nearest creature.  \n- 3–4 Paralysis. The target is [paralyzed](/compendium/rules/conditions.md#Paralyzed)\
...
- "MPMM"
- "MTF"
"image": "compendium/bestiary/construct/token/clockwork-iron-cobra-mpmm.webp"
```
^statblock
