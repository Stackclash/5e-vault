...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ stone and is [restrained](compendium/rules/conditions.md#restrained) until the\
    \ end of its next turn, when it must repeat the saving throw. The effect ends\
    \ if the second save is successful; otherwise the target is [petrified](compendium/rules/conditions.md#petrified)\
    \ for 24 hours."
