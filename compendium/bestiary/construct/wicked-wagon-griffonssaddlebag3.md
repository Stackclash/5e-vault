...
"traits":
  ...
  - "desc": "If the wagon or one of its allies riding in it kills a humanoid, that\
      ...
      \ targeted by a [dispel evil and good](/compendium/spells/dispel-evil-and-good.md)\
      ...
      \ can discern the hag's true nature by succeeding on a Wisdom ([Insight](/compendium/rules/skills.md#Insight))\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +8 to hit, reach 15 ft., one target. Hit: 18\
      ...
      \ it is [grappled](/compendium/rules/conditions.md#Grappled) (escape DC 15).\
      \ Until this grapple ends, the target is [restrained](/compendium/rules/conditions.md#Restrained).\
  ...
  - "desc": "The wagon moves up to its speed in a straight line.\n\nDuring this movement,\
      ...
      \ bludgeoning damage and is knocked [prone](/compendium/rules/conditions.md#Prone).\
