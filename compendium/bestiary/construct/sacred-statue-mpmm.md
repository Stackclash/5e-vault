...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the statue is motionless at the start of combat, it has advantage on\
    ...
    \ or act, that creature must succeed on a DC 18 Intelligence ([Investigation](compendium/rules/skills.md#Investigation))\
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 6d12 + 4|avg` (`6d12 + 4`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+8` (+8 to hit), range 60 ft./240 ft., one target. Hit: `dice: 6d10 + 4|avg` (`6d10 + 4`) bludgeoning damage.
```
^statblock