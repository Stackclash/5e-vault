...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 5 ft., one target.\
    ...
    \ it must succeed on a DC 11 Wisdom saving throw or be [frightened](compendium/rules/conditions.md#frightened)\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The scarecrow targets one creature it can see within 30 feet of it. If\
    ...
    \ saving throw or be magically [frightened](compendium/rules/conditions.md#frightened)\
    \ until the end of the scarecrow's next turn. The [frightened](compendium/rules/conditions.md#frightened)\
    \ target is [paralyzed](compendium/rules/conditions.md#paralyzed)."
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1|avg` (`2d4 + 1`) slashing damage. If the target is a creature, it must succeed on a DC 11 Wisdom saving throw or be [frightened](compendium/rules/conditions.md#frightened) until the end of the scarecrow's next turn.
