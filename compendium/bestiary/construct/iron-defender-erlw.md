...
"cr": "1"
"traits":
- "desc": "The defender has advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
    \ checks."
  "name": "Keen Senses"
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ (1d6) piercing damage and be [grappled](/compendium/rules/conditions.md#grappled)\
    \ (escape DC 13). The defender can have only one creature [grappled](/compendium/rules/conditions.md#grappled)\
