...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The retriever targets one creature it can see within 60 feet of it. The\
    \ target must succeed on a DC 18 Constitution saving throw or be [paralyzed](compendium/rules/conditions.md#paralyzed)\
    \ for 1 minute. The [paralyzed](compendium/rules/conditions.md#paralyzed) target\
    \ can repeat the saving throw at the end of each of its turns, ending the effect\
    \ on itself on a success.\n\nIf the [paralyzed](compendium/rules/conditions.md#paralyzed)\
