...
"traits":
  - "desc": "The rug is [incapacitated](/compendium/rules/conditions.md#Incapacitated)\
      ...
      \ If targeted by [dispel magic](/compendium/spells/dispel-magic.md), the rug\
  ...
  - "desc": "While it is grappling a creature, the rug takes only half the damage\
      \ dealt to it, and the creature [grappled](/compendium/rules/conditions.md#Grappled)\
...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one Medium or smaller\
      \ creature. Hit: The creature is [grappled](/compendium/rules/conditions.md#Grappled)\
