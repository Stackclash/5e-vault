...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ [prone](compendium/rules/conditions.md#prone). On a successful save, a creature\
...
![](/compendium/bestiary/construct/token/mighty-servant-of-leuk-o.png#token)
...
***Destructive Fist.*** *Melee Weapon Attack:* `dice: d20+17` (+17 to hit), reach 10 ft., one target. Hit: `dice: 4d12 + 10|avg` (`4d12 + 10`) force damage. Or Ranged Weapon Attack: `dice: d20+17` (+17 to hit), range 120 ft., one target. Hit: `dice: 4d12 + 10|avg` (`4d12 + 10`) force damage. If the target is an object, it takes triple damage.

***Crushing Leap.*** If the servant jumps at least 25 feet as part of its movement, it can then use this action to land on its feet in a space that contains one or more other creatures. Each of those creatures is pushed to an unoccupied space within 5 feet of the servant and must make a DC 25 Dexterity saving throw. On a failed save, a creature takes `dice: 4d12|avg` (`4d12`) bludgeoning damage and is knocked [prone](compendium/rules/conditions.md#prone). On a successful save, a creature takes half as much damage and isn't knocked [prone](compendium/rules/conditions.md#prone).
```
^statblock