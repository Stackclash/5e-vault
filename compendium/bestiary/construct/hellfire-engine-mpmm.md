...
- "desc": "The hellfire engine moves up to its speed in a straight line. During this\
    ...
    \ the [prone](/compendium/rules/conditions.md#Prone) creature's space, the creature\
    \ is also [restrained](/compendium/rules/conditions.md#Restrained) until it's\
    \ no longer in the same space as the hellfire engine. While [restrained](/compendium/rules/conditions.md#Restrained)\
...
- "desc": "The hellfire engine uses one of the following options (choose one or roll\
    ...
    \ from the River Styx as a [lemure](compendium/bestiary/fiend/lemure.md) in Avernus\
    \ in 1d4 hours. If the creature isn't revived before then, only a [wish](compendium/spells/wish.md)\
