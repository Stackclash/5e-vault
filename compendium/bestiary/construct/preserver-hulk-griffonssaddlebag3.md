...
"actions":
  ...
  - "desc": "Ranged Weapon Attack: +5 to hit, range 60 ft., one target. Hit: 13\
      ...
      \ saving throw or become [restrained](/compendium/rules/conditions.md#Restrained)\
      \ by energy bindings. A creature can use its action to make a DC 15 Strength\
      \ check, freeing itself or another creature within its reach from the bindings\
      \ on a success."
    "name": "Laser"
"source":
  - "GriffonsSaddlebag3"
