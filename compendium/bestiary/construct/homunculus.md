...
"actions":
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 1\
      ...
      \ If the saving throw fails by 5 or more, the target is instead [poisoned](/compendium/rules/conditions.md#Poisoned)\
      \ for 5 (d10) minutes and [unconscious](/compendium/rules/conditions.md#Unconscious)\
