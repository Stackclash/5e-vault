...
"traits":
  - "desc": "If the carrionette is motionless at the start of combat, it has advantage\
      ...
      \ move or act, that creature must succeed on a DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The carrionette targets a creature it can see within 15 feet of it that\
      ...
      \ body, and the target is [unconscious](/compendium/rules/conditions.md#Unconscious)\
      ...
      \ die. A [protection from evil and good](/compendium/spells/protection-from-evil-and-good.md)\
...
"source":
  - "VRGR"
"image": "/compendium/bestiary/construct/token/carrionette-vrgr.webp"
```
^statblock
