...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The carrionette targets a creature it can see within 15 feet of it that\
    ...
    \ the target is [unconscious](compendium/rules/conditions.md#unconscious) for\
...
```ad-statblock
title: Carrionette
![](/compendium/bestiary/construct/token/carrionette.png#token)
