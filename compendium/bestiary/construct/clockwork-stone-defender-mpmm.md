...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one target.\
    \ Hit: dice: 2d6 + 4|avg (2d6 + 4) bludgeoning damage, and if the target is\
    \ Large or smaller, it is knocked [prone](compendium/rules/conditions.md#prone)."
  "name": "Slam"
"reactions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- **Hit Points** `dice: 14d8 + 42|text(105)` (14d8 + 42) 
- **Speed** walk 30 ft.
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [prone](compendium/rules/conditions.md#prone).
