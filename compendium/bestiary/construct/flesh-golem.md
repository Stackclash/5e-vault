...
To create a golem, one requires a [manual of golems](compendium/items/manual-of-golems-dmg.md). The comprehensive illustrations and instructions in a manual detail the process for creating a golem of a particular type.
...
- "desc": "Whenever the golem starts its turn with 40 hit points or fewer, roll a\
    ...
    \ a DC 15 Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check.\
...
- "MM"
- "CoS"
"image": "compendium/bestiary/construct/token/flesh-golem.webp"
```
^statblock
