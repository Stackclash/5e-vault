...
|----|------|-------------|-------|--------|----------|
| 5 | Yagnoloth Ichor (3 vials) | As slippery as the contracts the yagnoloth writes, traces of this ichor can actually be found in the ink that they use in their business with potential employers. There is nothing stopping us from doing the same with the ichor in order to write nefarious contracts or simple coded messages. **Requires [enchanted vial](compendium/items/enchanted-vial-hhhvi.md).** | 55 gp | 1 lb | [Confidant's Ink](compendium/items/confidants-ink-hhhviii.md) |
