...
| 8 | ***Enforcement.*** You must satisfy an earlier contract by bringing a specific person to the Nine Hells whose time is up. You are accompanied by `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [bloodhounds](/compendium/bestiary/monstrosity/bloodhound-da-gic.md) |
