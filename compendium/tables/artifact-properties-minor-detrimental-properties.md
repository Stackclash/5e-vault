...
| 11-15 | While attuned to the artifact, you are [blinded](/compendium/rules/conditions.md#Blinded) when you are more than 10 feet away from it. |
...
| 51-55 | While attuned to the artifact, you are [deafened](/compendium/rules/conditions.md#Deafened) when you are more than 10 feet away from it. |
...
| 81-85 | While attuned to the artifact, you deal `dice:1d6\|noform\|noparens\|avg` (`d6`) necrotic damage to any plant you touch that isn't a creature. |
