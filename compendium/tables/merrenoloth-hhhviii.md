...
|----|------|-------------|-------|--------|----------|
| 5 | Merrenoloth Ichor (3 vials) | The ichor of a merrenoloth has a briny odor to it, like the kind of brackish seawater found in the depths of an old ship. It carries some traces of the merrenoloth's mastery of ships, and some superstitious sailors have taken to mixing it with tar and using it to coat their ships to ward them from harm. **Requires [enchanted vial](compendium/items/enchanted-vial-hhhvi.md).**<br /><br />**Use.** As an action, you may rub this ichor into your hands. For the next 24 hours, you have advantage on any ability check made to helm, steer, or sail a ship. | 2 gp | 1 lb | — |
