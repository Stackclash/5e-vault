...
| 5–6 | A circle of `dice:4d4\|noform\|noparens\|avg` (`4d4`) [druids](/compendium/bestiary/humanoid/druid.md) that are developing a ritual to channel (75%) or cleanse (25%) the Grymclover Forest's corruption. |
| 7–8 | `dice:1d10\|noform\|noparens\|avg` (`d10`) [gray oozes](/compendium/bestiary/ooze/gray-ooze.md) (45%), `dice:1d6\|noform\|noparens\|avg` (`d6`) [ochre jellies](/compendium/bestiary/ooze/ochre-jelly.md) (35%), or `dice:1d3\|noform\|noparens\|avg` (`d3`) [black puddings](/compendium/bestiary/ooze/black-pudding.md) (20%) milling about aimlessly. |
...
| 11–13 | The brambles of the forest encircle the party to impede travel. Each character must succeed on a DC 14 Constitution saving throw or take `dice:2d6\|noform\|noparens\|avg` (`2d6`) piercing damage and gain one level of [exhaustion](/compendium/rules/conditions.md#Exhaustion) from the constricting vegetation. |
...
| 16–17 | `dice:3d4\|noform\|noparens\|avg` (`3d4`) [awakened shrubs](/compendium/bestiary/plant/awakened-shrub.md) (40%), `dice:1d10\|noform\|noparens\|avg` (`d10`) [awakened trees](/compendium/bestiary/plant/awakened-tree.md) (30%), or `dice:1d4\|noform\|noparens\|avg` (`d4`) [shambling mounds](/compendium/bestiary/plant/shambling-mound.md) (30%) originally made from the forest's natural plant life, but now corrupted by the forest's choking brambles. |
