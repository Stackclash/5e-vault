...
|-----------|-------------------|
| 1–5 | The character causes a random effect from the [Wild Magic Surge](/compendium/tables/wild-magic-surge-phb.md) table in the "Player's Handbook". |
...
| 8–9 | A number (`dice:2d4\|noform\|noparens\|avg` (`2d4`)) of the Staring Cats of Uldun-dar appear within 30 feet of the character. These sapient, hyper-dimensional [cats](/compendium/bestiary/beast/cat.md) have uneven numbers of eyes and are not hostile, but they ominously share reports on how the character died in multiple parallel dimensions. The cats vanish after the character's next long rest. |
