...
| 20 | Manual Ashes (small pouch) | The final step of creating a new golem is to sprinkle the ashes of a [manual of golem creation](compendium/items/manual-of-iron-golems.md) over the inanimate body. Some of these these ashes become stuck to the freshly made body and can be recovered. Of course, such a small amount would not be able to animate a full body, but can be used to animate a much smaller creation. | 2,000 gp | 1 lb | [Golem Companion](compendium/items/golem-companion-hhhvi.md) |
^dc-item-description-value-weight-crafting