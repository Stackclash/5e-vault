...
`dice: [](githyanki-trinket-table-hhhviii.md#^item-value-weight)`

| dice: d8 | Item | Value | Weight |
|----------|------|-------|--------|
| 1 | `dice:1d4\|noform\|avg` (`1d4`) energy stimulating chewable roots | 8 sp | — |
...
| 6 | 1 [whetstone](compendium/items/whetstone.md) | 1 cp | 1 lb |
| 7 | 1 set of dragon reins | 10 gp | 3 lb |
| 8 | `dice:1d8\|noform\|avg` (`1d8`) stolen trinkets | 10 gp | 2 lb |
^item-value-weight