...
| 25 | Mark of Varpak | An everlasting one is a frost giant that has been touched by Varpak. By devouring a troll sent by the ravenous god, the stomach of a frost giant changes irrevocably, bearing what resemble bite marks as Varpak devours anything the frost giant eats. These marks can be excised from an everlasting one's stomach and used to enchant weapons with a dangerous blessing. | 3,795 gp | 12 lb | [Bite of Varpak](compendium/items/bite-of-varpak-hhhvii.md) |
^dc-item-description-value-weight-crafting