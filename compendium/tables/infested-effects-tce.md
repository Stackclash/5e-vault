...
| 26–30 | A cluster of `dice: 1d4 + 2\|avg` (`1d4 + 2`) faintly glowing grubs appears in an unoccupied space within 30 feet of the party. Any creature that consumes one of these succulent grubs receives the benefits of a [potion of healing](compendium/items/potion-of-healing.md). |
...
| 91–95 | Tiny arachnids invade unattended spaces. The next time one random creature in the region dons its clothing or armor after finishing a long rest, it must succeed on a DC 16 Constitution saving throw or take 11 (`dice: 2d10\|avg` (`2d10`)) poison damage. |
| 96–00 | Countless tiny, bloodsucking insects infest the region for the next `dice: 1d6\|avg` (`1d6`) hours. Every hour, each creature in the region must succeed on a DC 10 Constitution saving throw or gain 1 level of [exhaustion](/compendium/rules/conditions.md#exhaustion). The insects don't affect creatures that are immune to disease. |
^infested-effects