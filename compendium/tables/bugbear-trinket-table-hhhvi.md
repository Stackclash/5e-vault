...
|----------|------|-------|--------|
| 1 | `dice:1d4\|noform\|avg` (`1d4`) days' worth of [rations](compendium/items/rations-1-day.md) (mouldy produce) | 8 cp | 2 lb |
...
| 8 | `dice:10d10\|noform\|avg` (`10d10`) [silver pieces](compendium/items/silver-sp.md) | Varies | Varies |
^item-value-weight