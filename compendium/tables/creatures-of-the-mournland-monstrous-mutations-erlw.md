...
| 2 | The creature has developed magical camouflage. It gains proficiency in the [Stealth](/compendium/rules/skills.md#Stealth) skill, and it has the Chameleon Skin trait: it has advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks made to hide. |
