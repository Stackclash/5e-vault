...
|----------|------|-------|--------|
| 1 | `dice: 1d4\|avg` (`1d4`) day's worth of [rations](compendium/items/rations-1-day.md) | 5 sp | 2 lb |
...
| 8 | `dice: 7d10\|avg` (`7d10`) [gold pieces](compendium/items/gold-gp.md) | Varies | Varies |
^item-value-weight