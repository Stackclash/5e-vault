...
| 25–34 | Reflections of `dice: 1d4\|avg` (`1d4`) creatures in the region emerge from mirrors and attack. The [reflections](compendium/bestiary/fey/reflection-tce.md) are two-dimensional, shimmering versions of the creatures that cast them. Treat the reflections as [shadows](compendium/bestiary/undead/shadow.md) that are fey instead of undead and vulnerable to bludgeoning damage instead of radiant. |
