...
| 15 | Slaad Egg Gland | Underneath the claws of the red slaad lies a marble sized pouch that houses hundreds of miniscule slaad eggs. It is difficult to harvest this gland without crushing the eggs (or accidentally injecting yourself), but successfully doing so will yield a truly wicked potion ingredient that should only be reserved for one's worst enemies. | 60 gp | 1 lb | [Chest Burster](compendium/items/chest-burster-hhhvi.md) |
^dc-item-description-value-weight-crafting