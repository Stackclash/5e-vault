...
|-----------|---------------|
| 1 | You were turned into a toad and remained in that form for `dice:1d4\|noform\|noparens\|avg` (`d4`) weeks. |
| 2 | You were [petrified](/compendium/rules/conditions.md#Petrified) and remained a stone statue for a time until someone freed you. |
| 3 | You were enslaved by a hag, a satyr, or some other being and lived in that creature's thrall for `dice:1d6\|noform\|noparens\|avg` (`d6`) years. |
| 4 | A dragon held you as a prisoner for `dice:1d4\|noform\|noparens\|avg` (`d4`) months until adventurers killed it. |
...
| 7 | You went insane for `dice:1d6\|noform\|noparens\|avg` (`d6`) years and recently regained your sanity. A tic or some other bit of odd behavior might linger. |
