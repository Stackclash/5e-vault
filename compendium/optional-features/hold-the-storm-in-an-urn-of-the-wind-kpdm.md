...
aliases: ["Hold the Storm in An Urn of the Wind"]
---
...
**Power (3rd level)** By drawing this hieroglyph in the air for three consecutive turns (each one requiring an action), you gain the ability to cast [wind wall](compendium/spells/wind-wall.md).
...
**Mastery Power:** Immediately after performing a 10-minute ritual with Special incense, you can cast a modified version of [wind walk](compendium/spells/wind-walk.md). Unlike the spell, this power affects up to five creatures, and the effect lasts for up to 2 hours and requires your concentration.