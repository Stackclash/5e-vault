...
The homunculus regains `dice:2d6|noform|avg` (`2d6`) hit points if the [mending](compendium/spells/mending.md) spell is cast on it. If you or the homunculus dies, it vanishes, leaving its heart in its space.