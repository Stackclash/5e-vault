...
***Prerequisites*** Proficiency with [Smith's Tools](compendium/items/smiths-tools.md)
...
Any character that is proficient in the [smith's tools](compendium/items/smiths-tools.md) may be considered a blacksmith for crafting purposes.