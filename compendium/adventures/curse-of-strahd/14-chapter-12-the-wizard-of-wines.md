...
On his first turn, from behind the wine rack, the druid casts a [thunderwave](compendium/spells/thunderwave.md) spell, which shatters `dice: 1d20 + 10|avg` (`1d20 + 10`) of the wine bottles as it resounds throughout the cellar. The druid then orders the needle blights to attack.
