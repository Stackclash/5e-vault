...
![](/compendium/adventures/curse-of-strahd/img/104-cos11-01.png#center)
...
Following in the vampire hunter's footsteps is his protégé, [Ezmerelda d'Avenir](/compendium/bestiary/npc/ezmerelda-davenir-cos.md), who has taken to living in the tower while she searches for her mentor. She isn't present when the characters arrive, however.
...
The wagon radiates an aura of conjuration magic if it is scrutinized with a [detect magic](/compendium/spells/detect-magic.md) spell. A character who casts an [identify](/compendium/spells/identify.md) spell on the wagon learns the command words needed to operate it.

> [!gallery]
> ![Map 11.1: Van Richten's Tower (Area V)](/compendium/adventures/curse-of-strahd/img/105-027.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/106-cos1101.jpg#gallery)
...
The wagon has a hidden trapdoor in its underbelly that can be detected by a character who scuttles under the wagon and succeeds on a DC 13 Wisdom ([Perception](compendium/rules/skills.md#Perception)) check. The trapdoor opens into the wagon and is the only safe way inside.
...
- A wooden trunk covered with claw marks that holds a [battleaxe](/compendium/items/battleaxe.md), a [flail](/compendium/items/flail.md), a [morningstar](/compendium/items/morningstar.md), a [light crossbow](/compendium/items/light-crossbow.md), and 10 silvered crossbow bolts  
- A narrow wardrobe containing three sets of [fine clothes](/compendium/items/fine-clothes.md), two sets of [traveler's clothes](/compendium/items/travelers-clothes.md), several pairs of shoes, a harlequin mask, and three wigs  
- A [climber's kit](/compendium/items/climbers-kit.md), a [disguise kit](/compendium/items/disguise-kit.md), a [healer's kit](/compendium/items/healers-kit.md), and a [poisoner's kit](/compendium/items/poisoners-kit.md)  
...
- Three sets of [manacles](/compendium/items/manacles.md)  
- A [shovel](/compendium/items/shovel.md)  
- A wooden chest containing a gold holy symbol of the Morninglord (worth 100 gp), three [vials of holy water](/compendium/items/holy-water-flask.md), three vials of perfume, two vials of [antitoxin](/compendium/items/antitoxin-vial.md), a [50-foot coil of hempen rope](/compendium/items/hempen-rope-50-feet.md), a [tinderbox](/compendium/items/tinderbox.md), a [steel mirror](/compendium/items/steel-mirror.md), a sharpened wooden stake, and a [spyglass](/compendium/items/spyglass.md)  
- Two spell scrolls ([major image](/compendium/spells/major-image.md) and [remove curse](/compendium/spells/remove-curse.md))  
...
![](/compendium/adventures/curse-of-strahd/img/107-cos11-02.png#center)
...
![](/compendium/adventures/curse-of-strahd/img/108-cos11-03.png#center)

A creature that touches the door without first disabling the trap causes lightning to envelop the tower. Any creature outside the tower and within 10 feet of it must succeed on a DC 15 Dexterity saving throw, with disadvantage if it is wearing armor made of metal, taking 22 (`dice: 4d10|avg` (`4d10`)) lightning damage on a failed save, or half damage on a successful one. As long as the effect persists, any creature that enters the lightning for the first time on a turn or starts its turn there takes `dice: 4d10|avg` (`4d10`) lightning damage. The lightning lasts for 10 minutes.
...
If the arm positions are done out of order, a [young blue dragon](/compendium/bestiary/dragon/young-blue-dragon.md) magically appears within 30 feet of the door and attacks all creatures it can see. The characters can keep trying to open the door while the dragon is attacking them. The dragon disappears if it is reduced to 0 hit points or if the characters open the door.
...
The four statues are [clay golems](/compendium/bestiary/construct/clay-golem.md) that defend themselves if attacked. Otherwise, their sole purpose is to operate the elevator, which they do by pulling on the chains. The chains attach to a 5-foot-square wooden platform that normally rests on the fourth floor.
...
Van Richten spent several months in this room, reviewing a lifetime's worth of research on [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md)—notes that, once he committed them to memory, he burned in the stove. He also burned his journals. Ezmerelda searched the room, hoping to find a clue to her mentor's plan or whereabouts. Among the things she found here was a rolled-up map of Barovia and a burned page from van Richten's journal, which she took and hid in her wagon (area V1).

The standing armor is a suit of [animated armor](/compendium/bestiary/construct/animated-armor.md). It is [incapacitated](compendium/rules/conditions.md#incapacitated) until someone speaks the command word ("Khazan") within 10 feet of it, whereupon the armor follows the commands of the one who activated it. If 24 hours pass without its receiving a new instruction from its controller, the animated armor becomes [incapacitated](compendium/rules/conditions.md#incapacitated) until someone reactivates it. If it is reduced to 0 hit points, the armor falls to pieces and is destroyed.

A lavender aroma emanates from the wooden chest, which is unlocked and safe to open. It contains the severed head of a human Vistana named Yan. Its flesh has a waxy complexion and has been embalmed with magic oils. If a [speak with dead](/compendium/spells/speak-with-dead.md) spell is cast on his head (which would need to be taken somewhere away from the tower's _spell drain effect_), Yan reveals that he was banished from his clan for stealing. A half-elf bard named [Rictavio](/compendium/bestiary/npc/rictavio-cos.md) offered Yan a ride in his carnival wagon. The two traveled together for several days, but their time together was tense. When it was clear that [Rictavio](/compendium/bestiary/npc/rictavio-cos.md) was looking for a road to Barovia, Yan tried to steal the wagon as well as [Rictavio](/compendium/bestiary/npc/rictavio-cos.md)'s pet monkey, but [Rictavio](/compendium/bestiary/npc/rictavio-cos.md) got the better of him and drove a sword through his gullet.

The magic oils preserving Yan's head allow it to remember conversations it has while under the effect of [speak with dead](/compendium/spells/speak-with-dead.md). [Rictavio](/compendium/bestiary/npc/rictavio-cos.md) has cast [speak with dead](/compendium/spells/speak-with-dead.md) on the head twice to ask questions about the Vistani of Barovia. Yan believes that the half-elf plans to cause great harm to the Vistani and begs the characters to warn his people. He doesn't know where his body is.
...
Leading the hunt is [Kiril Stoyanovich](/compendium/bestiary/npc/kiril-stoyanovich-cos.md), a [werewolf](/compendium/bestiary/humanoid/werewolf.md) with 90 hit points. Accompanying him are six normal [werewolves](/compendium/bestiary/humanoid/werewolf.md) and nine [wolves](/compendium/bestiary/beast/wolf.md). While in wolf form, the werewolves are indistinguishable from ordinary wolves. They either remain in wolf form or assume hybrid form.
...
[Ezmerelda d'Avenir](/compendium/bestiary/npc/ezmerelda-davenir-cos.md) (see appendix D) returns to Van Richten's Tower after confronting Strahd in Castle Ravenloft and barely escaping with her life. She arrives on the back of a [riding horse](/compendium/bestiary/beast/riding-horse.md) stolen from the Vistani camp outside Vallaki (chapter 5, area N9).
...
From this moment on, Strahd gains a new goal: kill [Ezmerelda d'Avenir](/compendium/bestiary/npc/ezmerelda-davenir-cos.md). Knowing that his Vistani spies might be conflicted at the thought of slaying one of their own, Strahd relies on the druids and the werewolves of the Svalich Woods, as well as human spies and vampire spawn hidden in Barovia's settlements, to help him find and kill Ezmerelda. If Strahd learns that she and the characters are working together, he invites the characters to Ravenloft, expecting that Ezmerelda will accompany them. The characters receive their invitation in the form of a letter delivered by one of Strahd's spies. If the characters open and read the letter, show the players the "Strahd's Invitation" handout in appendix F. If the characters head toward the castle, they have no threatening random encounters on the way.

![](/compendium/adventures/curse-of-strahd/img/109-cos11-05.png#center)