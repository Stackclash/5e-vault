...
Some [brooms of animated attack](/compendium/bestiary/construct/broom-of-animated-attack-cos.md) allow their creators to ride them, in which case they behave like typical brooms of flying. A broom of animated attack, however, can carry only half the weight that a broom of flying can (see chapter 7, ""Treasure"," of the "Dungeon Master's Guide").
...
[Strahd zombies](strahd-zombie-cos.md) are undead that serve the vampire [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md). Created from the long-dead guards of Castle Ravenloft, they were called into being through dark magic by Strahd himself.
