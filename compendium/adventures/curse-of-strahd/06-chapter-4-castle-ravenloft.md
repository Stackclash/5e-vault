...
![](compendium/adventures/curse-of-strahd/img/023-cos04-01.webp#center)
...
In most circumstances, a random encounter occurs on a roll of 18 or higher on a `dice:d20|noform|avg` (`d20`). To determine what the characters encounter, consult the table below.

**Random Encounters in Castle Ravenloft**

| d12 + d8 | Encounter |
|----------|-----------|
| 2 | [Ezmerelda d'Avenir](compendium/bestiary/npc/ezmerelda-davenir-cos.md) (see appendix D) |
| 3 | [Rahadin](compendium/bestiary/npc/rahadin-cos.md) (see appendix D) |
| 4 | 1 black [cat](compendium/bestiary/beast/cat.md) |
| 5 | 1 [broom of animated attack](compendium/bestiary/construct/broom-of-animated-attack-cos.md) (see appendix D) |
| 6 | `dice:1d4+1\|noform\|avg` (`1d4 + 1`) [flying swords](compendium/bestiary/construct/flying-sword.md) |
| 7 | Blinsky toy |
| 8 | [Unseen servant](compendium/spells/unseen-servant.md) |
| 9 | `dice:1d4\|noform\|avg` (`1d4`) [commoners](compendium/bestiary/humanoid/barovian-commoner-cos.md) |
| 10 | `dice:2d6\|noform\|avg` (`2d6`) [crawling claws](compendium/bestiary/undead/crawling-claw.md) |
| 11 | `dice:1d6\|noform\|avg` (`1d6`) [shadows](compendium/bestiary/undead/shadow.md) |
| 12 | `dice:1d6\|noform\|avg` (`1d6`) [swarms of bats](compendium/bestiary/beast/swarm-of-bats.md) |
| 13 | 1 crawling [Strahd zombie](compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
| 14 | `dice:1d4+1\|noform\|avg` (`1d4 + 1`) Vistani [thugs](compendium/bestiary/humanoid/vistana-thug-cos.md) |
| 15 | `dice:1d4\|noform\|avg` (`1d4`) [wights](compendium/bestiary/undead/wight.md) |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [Barovian witch](compendium/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) |
| 19 | `dice:1d4+1\|noform\|avg` (`1d4 + 1`) [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) |
| 20 | [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) (see appendix D) |
^random-encounters-in-castle-ravenloft
...
Angry [villagers](compendium/bestiary/humanoid/commoner.md) who have entered the castle brandish torches and pitchforks in a ridiculous display of force. Everywhere they go, they shout for justice. They follow the characters unless prevented from doing so. As long as these Barovians are with the adventurers, random encounters occur on a roll of 9 or higher.
...
Characters can try to hide from the witch (who has [darkvision](/compendium/rules/senses.md#Darkvision)) or catch her by surprise. This [Barovian witch](compendium/bestiary/humanoid/barovian-witch-cos.md) is one of the servants of Strahd dwelling in area K56. She is calling out the name of her black cat familiar, which has gone missing. If the characters confront her, the old bat spits at them and begins casting a spell.
...
If the characters capture or kill the [cat](compendium/bestiary/beast/cat.md), this encounter doesn't occur again. If this result comes up again, treat it as no encounter.
...
The toy has a slogan stitched or printed on it in tiny letters: "Is No Fun, Is No Blinsky!" Roll a `dice:d6|noform|avg` (`d6`) to determine the specific toy:
...
When it gets within 5 feet of a party member, the [broom](compendium/bestiary/construct/broom-of-animated-attack-cos.md) attacks.
...
The groans are coming from a [Strahd zombie](compendium/bestiary/undead/strahd-zombie-cos.md) that is missing both of its legs, so that only its head, torso, and arms remain. It uses its arms to drag itself across the floor. The crawling zombie has 15 hit points remaining.

If the characters are moving quietly and not using light sources, they can try to hide from the crawling zombie.

#### Ezmerelda d'Avenir

[Ezmerelda](compendium/bestiary/npc/ezmerelda-davenir-cos.md) has cast a [greater invisibility](compendium/spells/greater-invisibility.md) spell on herself and is stealthily exploring the castle. Choose one character in the back rank of the party's marching order, and read the following text to that character's player:
...
If more than two [flying swords](compendium/bestiary/construct/flying-sword.md) are encountered, the others aren't far behind. These weapons drift about the castle and attack intruders within range of their [blindsight](/compendium/rules/senses.md#Blindsight).
...
A giant spider made this cocoon. Characters who can reach it can cut it open to free whatever is inside. Roll a `dice:d6|noform|avg` (`d6`) to determine the cocoon's contents:
...
| 2 | A [Barovian witch](compendium/bestiary/humanoid/barovian-witch-cos.md) (see appendix D). She screams like a wild animal and begins casting spells. |
| 3 | A [Strahd zombie](compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D). It fights until killed. |
| 4 | A Barovian lunatic (CN male [commoner](compendium/bestiary/humanoid/commoner.md)). If freed, he cackles until silenced or until a [calm emotions](compendium/spells/calm-emotions.md) spell is cast on him. A [lesser restoration](compendium/spells/lesser-restoration.md) spell cures his madness, at which point he tries to flee the castle. |
| 5 | A dead Barovian that serves as host to a [swarm of insects (spiders)](compendium/bestiary/beast/swarm-of-spiders.md). The baby giant spiders (each one the size of a tarantula) crawl out of the Barovian's gaping mouth or burst forth from its distended belly. |
| 6 | A [Vistana bandit](compendium/bestiary/humanoid/vistana-bandit-cos.md) (CN male or female). The Vistana knows the castle's layout and helps the characters until Strahd or more Vistani appear, at which point the treacherous Vistana turns on the characters. |
^cocoons-contents

#### Rahadin

If [Rahadin](compendium/bestiary/npc/rahadin-cos.md) was killed or captured in a previous encounter, this encounter doesn't occur. Otherwise, Strahd's mysterious chamberlain approaches quietly. A character whose passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score meets or exceeds [Rahadin](compendium/bestiary/npc/rahadin-cos.md)'s Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) check hear him.
...
[Rahadin](compendium/bestiary/npc/rahadin-cos.md) directs the characters to a random location in the castle, determined by rolling a `dice:d6|noform|avg` (`d6`):
...
If the characters ask [Rahadin](compendium/bestiary/npc/rahadin-cos.md) to lead the way, he declines. If the characters ask for directions, he tells them whether they need to ascend, descend, or remain on the level they're at. If they attack him, he fights to the death. Otherwise, he doesn't leave until after they do.

#### Shadows

If one or more characters have a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 16 or higher, read:
...
[Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) makes a surprise appearance.
...
Any character who has a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score lower than 19 is [surprised](/compendium/rules/conditions.md#Surprised) as Strahd appears seemingly out of nowhere. The vampire prefers to attack a [surprised](/compendium/rules/conditions.md#Surprised) character, choosing the one closest to him. Otherwise, see appendix D for the vampire's tactics.
...
These [bats](compendium/bestiary/beast/swarm-of-bats.md) are the servants of Strahd. They attack the characters without provocation.
...
To determine what the character finds, roll on the [Trinkets table](compendium/items/trinket-cos.md) in appendix A.
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [unseen servant](compendium/spells/unseen-servant.md) spell in the "Player's Handbook"). Roll a `dice:d6|noform|avg` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking `dice:8d10|noform|avg|text(44)` (`8d10`) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [potion of healing](compendium/items/potion-of-healing.md). |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice:1d4\|noform\|avg` (`1d4`) hungry [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) (see below), which arrive in `dice:1d4+1\|noform\|avg` (`1d4 + 1`) rounds. |
...
If any character has a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 16 or higher, the party isn't [surprised](/compendium/rules/conditions.md#Surprised). In that case, read:
...
These minions of Strahd—former adventurers all—creep along ceilings and drop down on unsuspecting prey. The [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) fight until destroyed.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [wights](compendium/bestiary/undead/wight.md). These undead soldiers once served as guard captains in Castle Ravenloft. They still wear bits of tattered livery, and they attack the living on sight.

##### Treasure

The wights carry longswords that have the crest of Barovia worked into their cross guards. Each wight also carries a pouch holding `dice:2d20|noform|avg` (`2d20`) ep, each coin of Barovian mintage and featuring the profiled visage of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md).
...
> [!gallery]
> ![Map 2: Walls of Ravenloft](compendium/adventures/curse-of-strahd/img/024-005.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/024-005-player.webp#gallery)

> [!gallery]
> ![Walls of Ravenloft (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-02-walls.webp#gallery)
> ![Walls of Ravenloft (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-02-walls-player.webp#gallery)
...
Characters who enter a gate tower find themselves on a flagstone floor with a hollow tower stretching high above them. The mechanisms for raising and lowering the drawbridge and portcullis fill both gate towers. The latch mechanism in each tower is magically activated by a word that only Strahd knows. It can also be activated with a successful casting of [dispel magic](compendium/spells/dispel-magic.md) (DC 14). Neither the drawbridge nor the portcullis will move until both latches are activated.
...
The portcullis is unlocked and can be lifted with a successful DC 15 Strength check. It can also be opened with a command word that only Strahd and [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) (area K62) know. Unless the portcullis is wedged or propped open, it falls back into place once it is let go.
...
If a character who has a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 15 or higher peers over the wall, add:
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is looking out over the balcony.
...
> [!gallery]
> ![Map 3: Main Floor](compendium/adventures/curse-of-strahd/img/025-006.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/025-006-player.webp#gallery)

> [!gallery]
> ![Main Floor (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-03-main-floor.webp#gallery)
> ![Main Floor (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-03-main-floor-player.webp#gallery)
...
The figure slumped on the altar is all that remains of Gustav Herrenghast, a lawful evil human cleric who tried to obtain the [Icon of Ravenloft](compendium/items/icon-of-ravenloft-cos.md) and did not survive the attempt. See "Treasure" below for more information on the icon and Gustav's possessions.

A sculpted stone railing cordons off the upstairs balcony, which is described in area K28.

#### Treasure

The statuette on the altar is an artifact called the [Icon of Ravenloft](compendium/items/icon-of-ravenloft-cos.md) (see appendix C). Any evil creature that touches the statuette must make a DC 17 Constitution saving throw, taking `dice:16d10|noform|avg|text(88)` (`16d10`) radiant damage on a failed save, or half as much damage on a successful one. The statuette is safe for all creatures to handle once it is no longer in contact with the altar.

Gustav's corpse wears a handsome, fur-lined black cloak embroidered with golden thread (worth 250 gp) and a suit of [chain mail](compendium/items/chain-mail.md), both nonmagical. Gustav's black mace is a [mace of terror](compendium/items/mace-of-terror.md).

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it lies on the floor behind the altar.

If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is among the bats fluttering below the ceiling or he is standing at one end of the chapel—a dark shape in the vast hall.
...
Both suits of armor are mechanical traps, each one activated by a pressure plate hidden in the floor in front of its alcove. A character who searches for traps in one of these locations notices both pressure plates with a successful DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check.

When 40 or more pounds of weight are placed on a pressure plate, the suit of armor nearest to that plate springs forward, flailing its arms and wielding its mace. Any creature standing on a pressure plate when its trap triggers must succeed on a DC 14 Dexterity saving throw or take `dice:2d6|noform|avg|text(7)` (`2d6`) bludgeoning damage from the flailing armor. After leaping out and attacking, the armor retracts. The pressure plate resets after 1 minute, after which its armor trap can be triggered again.
...
![](compendium/adventures/curse-of-strahd/img/027-cos04-05.webp#center)
...
The Heart of Sorrow is held aloft by the will of Strahd. Casting [dispel magic](compendium/spells/dispel-magic.md) on it has no effect.

##### Animated Halberds

Mounted on the walls along the section of staircase nearest the heart are ten [animated halberds](compendium/bestiary/construct/animated-halberd-cos.md); use the stat block for the [flying sword](compendium/bestiary/construct/flying-sword.md) in the "Monster Manual", but increase each halberd's damage to `dice:1d10+1|noform|avg` (`1d10 + 1`) and reduce its AC to 15. The halberds attack any creature that threatens the Heart of Sorrow.

##### Vampire Spawn

Strahd senses if any damage is done to the Heart of Sorrow and sends four [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) to destroy those responsible. These vampire spawn are former adventurers whom Strahd defeated long ago. They use their Spider Climb feature to scuttle along the tower walls and arrive in 3 rounds.
...
The skeletons, which were assembled by [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) (see area K62), are held together with wire frames and hung on pegs. They pose no threat.
...
> [!gallery]
> ![Map 4: Court of the Count](compendium/adventures/curse-of-strahd/img/028-007.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/028-007-player.webp#gallery)

> [!gallery]
> ![Court of the Count (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-04-court-revised.webp#gallery)
> ![Court of the Count (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-04-court-player-revised.webp#gallery)
...
A secret door in the south wall leads to area K13. It is hidden by dust and cobwebs, and requires a successful DC 16 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check to find.
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is sitting on the wooden throne.
...
Characters who examine the ceiling can, with a successful DC 20 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check, spot pulleys and a rope that run the full length of the corridor along the ceiling, well hidden by the cobwebs. These items are explained in "Flight of the Vampire" below.
...
Two [Strahd zombies](compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D) are slouched on the thrones. They remain motionless until one of them is disturbed or another creature comes within a zombie's reach, whereupon they attack.
...
The staircase climbs from area K16 to area K28. It seems unstable but is sturdy. The creatures in area K28 can't be [surprised](/compendium/rules/conditions.md#Surprised) by anyone climbing the creaky steps.
...
The figure is [Lief Lipsiege](compendium/bestiary/npc/lief-lipsiege-cos.md) (CE male human [commoner](compendium/bestiary/humanoid/commoner.md)), an accountant. He is chained to the heavy wooden desk and has no interest in the characters or their concerns. Under no circumstances does he voluntarily leave the room. Lief pulls the rope the instant he feels threatened.

![Lief Lipsiege](compendium/adventures/curse-of-strahd/img/029-cos04-07.webp#center)

Pulling the rope requires an action. When the rope is pulled, a tremendously loud gong sounds. One or more creatures arrive `dice:1d6|noform|avg` (`1d6`) rounds later, attacking any characters still in the room. Determine the creatures randomly by rolling a `dice:d4|noform|avg` (`d4`):

`dice: [](06-chapter-4-castle-ravenloft.md#^creature)`

| dice: d4 | Creature |
|----------|----------|
| 1 | `dice:1d6\|noform\|avg` (`1d6`) [shadows](compendium/bestiary/undead/shadow.md) |
| 2 | `dice:1d4\|noform\|avg` (`1d4`) [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) |
| 3 | `dice:1d4\|noform\|avg` (`1d4`) [wights](compendium/bestiary/undead/wight.md) |
| 4 | 1 [wraith](compendium/bestiary/undead/wraith.md) and `dice:1d4+1\|noform\|avg` (`1d4 + 1`) [specters](compendium/bestiary/undead/specter.md) |
^creature

Lief was pressed into service by Strahd many years ago. He keeps all the books for Strahd, recording the vampire's riches and conquests. Lief has been here longer than he can remember. He is grumpy because Strahd doesn't allow him to know about all his treasures. Even so, Lief has found out where one of Strahd's secret treasures lies. If he is treated with kindness, Lief will divulge the hiding place of the [Holy Symbol of Ravenkind](compendium/items/holy-symbol-of-ravenkind-cos.md), as indicated by your card reading. Lief can draw a crude map showing a route to that location. His map is geographically accurate, but he admits that it doesn't acknowledge or avoid any dangers that might lie along the way. Lief doesn't necessarily know the most direct path to the symbol's location.
...
The room contains hundreds of worthless books and scrolls describing accounting procedures. The first character who spends at least 10 minutes searching the room and succeeds on a DC 15 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check finds a book with a bloodstained leather cover. The pages of this book have been hollowed out, creating a hole in which Lief has hidden the iron key that unlocks the four wooden chests in this room.

Two of the locked chests contain 10,000 cp each. A third chest contains 1,000 gp. The fourth chest holds 500 pp, hidden under which is a [manual of bodily health](compendium/items/manual-of-bodily-health.md).
...
The maid, [Helga Ruvak](compendium/bestiary/npc/helga-ruvak-cos.md), is a [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) who claims to be the daughter of the village bootmaker, kidnapped and forced into service by Strahd. She pleads, on her hands and knees if necessary, to be saved from this awful place.
...
> [!gallery]
> ![Map 5: Rooms of Weeping](compendium/adventures/curse-of-strahd/img/030-008.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/030-008-player.webp#gallery)

> [!gallery]
> ![Rooms of Weeping (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-05-weeping.webp#gallery)
> ![Rooms of Weeping (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-05-weeping-player.webp#gallery)
...
The dark figures are four [swarms of rats](compendium/bestiary/beast/swarm-of-rats.md) piled atop one another to form manlike shapes (two swarms per alcove). These rats are under Strahd's control and attack anyone that tries to move through this area.
...
- Strahd's hate assumes a corporeal form, bursts out of the cake (the symbol of Sergei and Tatyana's love), and escapes through the window. "Strahd's hate" has the statistics of an [invisible stalker](compendium/bestiary/elemental/invisible-stalker.md) and tries to kill whichever character is carrying the groom figurine.  
...
The painting above the fireplace depicts Tatyana, a beautiful young woman with auburn hair. Strahd commissioned the painting over four centuries ago to impress his beloved. The fact that [Ireena Kolyana](compendium/bestiary/npc/ireena-kolyana-cos.md) looks exactly like Tatyana is proof to Strahd that both women were born with the same soul.

The back wall of the fireplace contains a secret door, which is opened by lifting the poker from its stand. The fire must be extinguished in order for anyone to reach the secret door safely. Otherwise, a creature that enters the fireplace for the first time on a turn or starts its turn there takes `dice:1d10|noform|avg|text(5)` (`1d10`) fire damage and catches fire. Until someone takes an action to douse the flames on the creature, it takes `dice:1d10|noform|avg|text(5)` (`1d10`) fire damage at the start of each of its turns. (This fire damage is cumulative with the damage from standing in the fireplace.)
...
Roll a `dice:d12|noform|avg` (`d12`) and consult the following table to determine the subject matter of a randomly chosen book.

![Tatyana](compendium/adventures/curse-of-strahd/img/031-cos04-09.webp#center)
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is sitting back in one of the overstuffed chairs, staring into the fire.
...
Most of the hall is full of giant spider [webs](compendium/traps-hazards/webs.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who stray from the unobstructed path through the webs risk becoming stuck.

#### Secret Doors

At the west end of the hall are two secret doors.

The secret door on the west wall can't be opened from this side, except by magic (such as a [knock](compendium/spells/knock.md) spell). See area K38 for more information on this secret door. If the characters pass through this door coming from area K38, it closes and locks behind them if they don't take measures to prop it open.

A narrow secret door at the western end of the south wall is hidden behind a mass of webs. If these webs are cleared away, characters can search for the secret door, finding it with a successful DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. The door can be pulled open to reveal area K31b.
...
The rope is attached to a great bell mounted in a wooden framework 50 feet overhead. Pulling the rope or attempting to climb it brings forth a loud, long "GONG." That sound causes five [giant spiders](compendium/bestiary/beast/giant-spider.md) to drop from their webs and attack. The spiders attack only if they are attacked or if the bell is sounded.

Most of the belfry is filled with giant spider [webs](compendium/traps-hazards/webs.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). Characters who blunder into them risk becoming stuck.
...
The plundered riches of Strahd's secret hoard lie within this adamantine tower, which is actually a [Daern's instant fortress](compendium/items/daerns-instant-fortress.md) (see chapter 7, "Treasure," of the "Dungeon Master's Guide"). Only Strahd knows the command word to alter its shape and size, which can't be done until every bit of treasure inside it is removed. Only Strahd can open the two means of entry: a sealed adamantine door set into the base of the tower on the north side, and an adamantine trapdoor on the roof.
...
The ground floor of the [Daern's instant fortress](compendium/items/daerns-instant-fortress.md) contains 50,000 cp, 10,000 sp, 10,000 gp, 1,000 pp, 15 assorted gems (100 gp each), and a [+2 shield](compendium/items/2-shield.md) emblazoned with a stylized silver dragon that is the emblem of the Order of the Silver Dragon (see chapter 7). The shield whispers warnings to its bearer, granting a +2 bonus to initiative if the bearer isn't [incapacitated](/compendium/rules/conditions.md#Incapacitated).

The upper floor of the tower contains 10 pieces of jewelry (250 gp each) in a red velvet sack, an [alchemy jug](compendium/items/alchemy-jug.md), a [helm of brilliance](compendium/items/helm-of-brilliance.md), a [rod of the pact keeper, +1](compendium/items/1-rod-of-the-pact-keeper.md), and an unlocked wooden coffer with four compartments, each one containing a [potion of greater healing](compendium/items/potion-of-greater-healing.md).

#### Fortunes of Ravenloft

If your card reading reveals that a treasure is here, it is lying atop the coins on the ground floor inside the tower.

If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is perched atop the tower.
...
![Gertruda](compendium/adventures/curse-of-strahd/img/032-cos04-10.webp#center)
...
The figure on the bed is [Gertruda](compendium/bestiary/npc/gertruda-cos.md) (NG female human [commoner](compendium/bestiary/humanoid/commoner.md)), the daughter of [Mad Mary](compendium/bestiary/npc/mad-mary-cos.md) (see chapter 3, area E3). [Gertruda](compendium/bestiary/npc/gertruda-cos.md) is oblivious to any danger to herself—especially from Strahd, who has [charmed](/compendium/rules/conditions.md#Charmed) her. Sheltered by her mother, she was never allowed to leave home as a child. She finally slipped away and made her way to the castle, drawn by its majesty.

[Gertruda](compendium/bestiary/npc/gertruda-cos.md) is innocent, and years spent as a shut-in have twisted her sense of reality. Consequently, she maintains a fairy-tale view of life. When faced with a decision, she almost always makes the most simplistic choice. She is naive to the point of being a danger to herself and others. Fortunately for her, Strahd has not yet bitten her, though he intends to. (If he can do so while the characters look on helplessly, so much the better.)

Next to the bed, set into the north wall, is a secret door. It can be pushed open to reveal a dusty hall that ends at a similar secret door in the back of an alcove (see area K45 for details). [Gertruda](compendium/bestiary/npc/gertruda-cos.md) doesn't know that this secret door exists.
...
If the characters loiter on the parapets or atop the castle walls for more than 5 minutes, they encounter [Strahd's animated armor](compendium/bestiary/npc/strahds-animated-armor-cos.md) (see appendix D) making the rounds. It patrols the parapets and the outer walls of Ravenloft day and night. Under a darkened sky, characters without [darkvision](/compendium/rules/senses.md#Darkvision) are more likely to hear the clatter of the armor approaching before they can see it.
...
> [!gallery]
> ![Map 6: Spires of Ravenloft](compendium/adventures/curse-of-strahd/img/033-009.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/033-009-player.webp#gallery)
...
![](compendium/adventures/curse-of-strahd/img/034-cos04-11.webp#center)

The ornate rug is actually a [rug of smothering](compendium/bestiary/construct/rug-of-smothering.md). It attacks creatures, other than undead, that move across it or anyone who tries to move it or otherwise disturb it. Underneath the rug is a bare stone floor.
...
The portrait on the wall depicts [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) before he became a vampire. Even in life, he was pale. The eyes of the portrait seem to watch and follow the characters as they explore the area. The picture frame is bolted to the wall and can't be removed without destroying it.

If the characters attack the rug or the picture, or if they attempt to remove either item, the [guardian portrait](compendium/bestiary/construct/guardian-portrait-cos.md) (see appendix D) attacks.
...
The youthful man on the couch is [Escher](compendium/bestiary/npc/escher-cos.md), a dashing [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) to whom Strahd has shown favor in the past. [Escher](compendium/bestiary/npc/escher-cos.md) is feeling somewhat neglected of late and has retreated here until Strahd's mood improves. If attacked, he hurls himself out the window and lands like a cat on the roof of the keep (area K53). He leads pursuers right to Strahd, wherever the lord of the castle happens to be (and regardless of whether the characters are ready to face Strahd).

![Escher and the Three Brides](compendium/adventures/curse-of-strahd/img/035-cos04-20.webp#center)

In conversation, [Escher](compendium/bestiary/npc/escher-cos.md) displays wit with a hint of melancholy. Beneath his arch mood is a dread that Strahd is growing bored of him and will lock him in the catacombs (area K84) with Strahd's other castoff consorts.

The leaded windows are fitted with iron hinges and can be opened. They can be locked from the inside, though they are currently unlocked. The leaded glass doesn't allow for much of a view. If a character opens a window and leaves it open, there's a 50 percent chance that a [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) crawling around the outside wall of the tower notices the open window and investigates.
...
On the third finger of his left hand, [Escher](compendium/bestiary/npc/escher-cos.md) wears a platinum ring engraved with tiny roses and thorns (worth 150 gp). Around his neck, he wears a gold and ruby pendant (worth 750 gp).
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice:1d4|noform|avg` (`1d4`) [Barovian witches](compendium/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with [sleep](compendium/spells/sleep.md) spells. A witch retreats to area K56 if wounded.
...
The trapdoor can be found after a search of the room and a successful DC 13 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. Locating the trapdoor doesn't enable someone to discover its opening mechanism. The door has a hidden lock and can be opened by pulling down on the hook from which the black cloak hangs. Once it has been found, the trapdoor can be opened by pulling on the hook, or it can be unlocked by someone using thieves' tools, a [knock](compendium/spells/knock.md) spell, or similar magic. It swings down when unlocked.
...
The chimney leads down 60 feet to the blazing fireplace in area K37. A creature that starts its turn in the chimney takes `dice:1d6|noform|avg|text(3)` (`1d6`) fire damage.
...
A character must succeed on a DC 15 Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics)) check to traverse the roof. The check succeeds automatically if the character crawls. If the check fails by 5 or more, the character slides off the edge of the roof ans falls 40 feet to the castle parapet (area K46).
...
The three [cats](compendium/bestiary/beast/cat.md) are familiars of the witches in area K56. If the familiars see the characters here, the witches are alerted to their presence.
...
There is a secret trapdoor in the northeast corner of the floor. Because of the trail through the dust, the trapdoor can be found without an ability check. Tapping or knocking on the trapdoor three times releases a hidden latch, causing the trapdoor to swing down. Area K51 lies below. (There's no ability check that will let the characters figure out the trick to opening the door. They can get that information from the witches, or perhaps by using a [divination](compendium/spells/divination.md) spell or similar magic.)

### K56. Cauldron

> [!gallery]
> ![Maps 7-10: Spires and Tower of Ravenloft](compendium/adventures/curse-of-strahd/img/036-010.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/036-010-player.webp#gallery)
...
The [Barovian witches](compendium/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) that dwell in this area have sworn themselves to Strahd's service in exchange for arcane power. Seven witches are present when the characters arrive, minus any that might have been encountered and defeated in area K50. If the witches are expecting the characters, they cast [invisibility](compendium/spells/invisibility.md) spells and stand quietly in the corners of the room, hoping that the cauldron draws their prey inside. Although they prefer to attack at range with their spells, they can grow magic claws using [alter self](compendium/spells/alter-self.md).
...
Each witch carries a [potion of healing](compendium/items/potion-of-healing.md) that she made herself. There is a 30 percent chance that a potion has "gone bad," in which case it's actually a [potion of poison](compendium/items/potion-of-poison.md).

Not visible from the entrance is a small table behind the cauldron on which sits an opened spellbook, seemingly on the verge of falling apart. The book is evil. Any non-evil creature that touches it or starts its turn with the book in its possession takes `dice:1d10|noform|avg|text(5)` (`1d10`) psychic damage. The book contains the following spells:

> [!note] 
> 
> 1st level: [burning hands](compendium/spells/burning-hands.md), [charm person](compendium/spells/charm-person.md), [detect magic](compendium/spells/detect-magic.md), [find familiar](compendium/spells/find-familiar.md), [fog cloud](compendium/spells/fog-cloud.md), [mage armor](compendium/spells/mage-armor.md), [protection from evil and good](compendium/spells/protection-from-evil-and-good.md), [ray of sickness](compendium/spells/ray-of-sickness.md), [sleep](compendium/spells/sleep.md), [Tasha's hideous laughter](compendium/spells/tashas-hideous-laughter.md), [unseen servant](compendium/spells/unseen-servant.md), [witch bolt](compendium/spells/witch-bolt.md)
> 
> 2nd level: [alter self](compendium/spells/alter-self.md), [arcane lock](compendium/spells/arcane-lock.md), [cloud of daggers](compendium/spells/cloud-of-daggers.md), [darkness](compendium/spells/darkness.md), [enlarge/reduce](compendium/spells/enlarge-reduce.md), [invisibility](compendium/spells/invisibility.md), [knock](compendium/spells/knock.md), [misty step](compendium/spells/misty-step.md)
^23d
...
Hiding in the rafters is [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) (see appendix D). A character spots [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) with a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score that meets or exceeds its Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) check. If [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) is spotted, read:
...
Although he appears to be a petite man wearing face paint and a fool's costume, [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) is actually a clockwork effigy of the real-life Pidlwick, who lies entombed in the catacombs. The dark paint on his face is soot.

If the characters see [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) in bright light, read:
...
[Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) can't speak and doesn't have an expressive face, so he relies mostly on hand gestures and simple diagrams to communicate. He understands Common but can't read or write.
...
![](compendium/adventures/curse-of-strahd/img/037-cos19-10.webp#center)

#### Treasure

The iron chest is locked, and its key is with [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) in area K62.
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is standing next to the iron chest.
...
Characters who remain on the roof are accosted by ten [swarms of bats](compendium/bestiary/beast/swarm-of-bats.md), which arrive in 3 rounds. If the characters descend into the tower, the bats don't follow and instead fly into the high tower (area K59), descend its central shaft (area K18a), and roost in the catacombs (area K84).
...
> [!gallery]
> ![Map 11: Larders of Ill Ome...](compendium/adventures/curse-of-strahd/img/038-011.webp#gallery "Map 11: Larders of Ill Omen & Map 12: Dungeon and Catacombs")
> ![Player Version](compendium/adventures/curse-of-strahd/img/038-011-player.webp#gallery)

> [!gallery]
> ![Larders of Ill Omen (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-08-larders.webp#gallery)
> ![Larders of Ill Omen (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-08-larders-player.webp#gallery)

> [!gallery]
> ![Dungeon and Catacombs (Battlemap; DM Version)](compendium/adventures/curse-of-strahd/img/map-4-09-dungeons-and-catacombs.webp#gallery)
> ![Dungeon and Catacombs (Battlemap; Player Version)](compendium/adventures/curse-of-strahd/img/map-4-09-dungeons-and-catacombs-player.webp#gallery)
...
> [!gallery]
> ![Map: Elevator Trap](compendium/adventures/curse-of-strahd/img/039-012.webp#gallery)
> ![Player Version](compendium/adventures/curse-of-strahd/img/040-cos401.webp#gallery)
...
A character who searches for traps while crossing the hall and succeeds on a DC 15 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check detects seams in the floor, walls, and ceiling that suggest that the middle section isn't attached to the rest of the hall. A character who makes a successful DC 15 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check discerns that the trap can't be disarmed from this location.

The middle 10-foot section of the hall is a cleverly hidden elevator compartment, open to the north and south so that it appears to be part of the passageway. When the trap is sprung, two steel portcullises drop from the ceiling at lightning speed to seal off the compartment, trapping within those creatures that triggered the trap. An instant later, the closed-off elevator is propelled up the western half of a 20-foot-wide, 170-foot-tall shaft (area K31a) to the sounds of turning gears and rattling chains. Magic sleep gas fills the compartment as it rises, and a creature trapped inside must succeed on a DC 15 Constitution saving throw or fall [unconscious](/compendium/rules/conditions.md#Unconscious) as though affected by a [sleep](compendium/spells/sleep.md) spell.
...
All creatures trapped inside the elevator (including [unconscious](/compendium/rules/conditions.md#Unconscious) ones) must roll initiative. The compartment takes 1 round to reach the top of the shaft, stopping just beneath area K47. Each creature inside has one turn to act before the compartment comes to a dead stop. Their initiative rolls determine the order in which the occupants act. Conscious party members can take whatever actions they like. They might search for a way out, wake sleeping party members, cast spells, or take other actions. [Unconscious](/compendium/rules/conditions.md#Unconscious) ones can do nothing.

A character who uses an action to search the ceiling of the elevator finds a secret trapdoor with a successful DC 10 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. The trapdoor opens downward.

Any creature on top of the elevator when it reaches the top of the shaft must make a successful DC 15 Dexterity saving throw to avoid being crushed against the ceiling of the shaft. The character takes `dice:8d10|noform|avg|text(44)` (`8d10`) bludgeoning damage on a failed save, or half as much damage on a successful one. When the elevator comes to a stop, its portcullises retract.
...
The figure approaching is [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md), a [mongrelfolk](compendium/bestiary/humanoid/mongrelfolk-cos.md) (see appendix D) and Strahd's faithful servant. He stands 4 feet, 9 inches tall but appears shorter because of his hunched posture. He has the Keen Hearing and Smell feature. The left side his face is covered with lizard scales, and he has the ears of a panther. His left foot looks like a duck's webbed foot, and his arms have patches of black dog fur.

The light in the hall comes from a lantern on the floor behind Cyrus. If the characters have their own light sources, Cyrus sees them, but he will not attack first. He wears a loop of twine around his neck, hanging from which is an iron key and a decorative wooden pendant fitted with a varnished human eyeball. The key unlocks the iron chest in area K60. The wooden pendant is a *hag eye* given to Cyrus by the [night hag](compendium/bestiary/fiend/night-hag.md) [Morgantha](compendium/bestiary/npc/morgantha-cos.md) (see chapter 6), so that she could spy on Strahd. Cyrus doesn't know that the necklace is magical. See the "Hag Covens" sidebar in the hags entry in the "Monster Manual" for information about the *hag eye*.

![Cyrus Belview](compendium/adventures/curse-of-strahd/img/041-cos04-16.webp#center)
...
The rats are harmless. [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) (see area K62) treats them like pets.
...
Five of these casks are rotted and empty. The wine name burned on each is Red Dragon Crush. Lining the interior of the sixth one is a patch of [yellow mold](compendium/traps-hazards/yellow-mold.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide"). A character who inspects the cask closely and succeeds on a DC 13 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check sees yellow mold in the cracks between the planks of the cask. If this cask is smashed open, the yellow mold releases a cloud of spores.
...
If your card reading reveals that a treasure is here, it is inside one of the empty casks along the north wall, hidden there by [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md).
...
If a character looks into the pot, three human [zombies](compendium/bestiary/undead/zombie.md) rise up from the bubbling depths and attack. The zombies are slowly being boiled to death, and each has only 13 hit points remaining. If [Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) (see area K62) is present when the zombies attack, he grabs a heavy club and tries to beat them back into the pot. Cyrus explains that he just isn't the cook he used to be, and his meals tend to get out of hand these days.
...
[Cyrus Belview](compendium/bestiary/npc/cyrus-belview-cos.md) (see area K62) uses this room as his lair. There is nothing of value here.
...
Once a mess hall for the castle guards, this room is now [desecrated ground](compendium/traps-hazards/desecrated-ground.md) (see ""Wilderness Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide").
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is sitting comfortably at one end of the table, holding the skull of a long-dead foe.
...
Three of the alcoves contain nothing of value. A loose flagstone in the southeast alcove covers a hidden cubbyhole in the floor, in which is hidden a moldy sack containing 150 ep. The coins have the profiled visage of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) stamped on them. A character who searches the alcove can find the loose flagstone with a successful DC 10 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check.
...
If he has not been defeated elsewhere, [Rahadin](compendium/bestiary/npc/rahadin-cos.md) (see appendix D) is here, waiting for the characters to arrive so he can kill them.

A [shadow demon](compendium/bestiary/fiend/shadow-demon.md) also haunts this room. In the round after the characters engage [Rahadin](compendium/bestiary/npc/rahadin-cos.md), the demon leaps out and attacks the nearest character from behind. The character doesn't notice the demon, unless the character's passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score meets or exceeds the demon's Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) check. Both [Rahadin](compendium/bestiary/npc/rahadin-cos.md) and the shadow demon fight until slain.
...
![Map: Traps in Area K73](compendium/adventures/curse-of-strahd/img/042-cos04-17.webp#center)
...
The rusty iron door connecting this hall to area K73 is submerged in 5 feet of water and requires a successful DC 10 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check to open.
...
Scattered across the floor of this cell are 3,000 ep. The coins have the profiled visage of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) stamped on them. A character can scoop up one hundred coins every minute.
...
Scattered across the floor of this cell are 300 pp. The coins have the profiled visage of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) stamped on them. A character can scoop up one hundred coins every minute.
...
A search of the corpse yields a sheathed [longsword](compendium/items/longsword.md) and two belt pouches, one containing five gemstones (50 gp each) and the other containing a [potion of heroism](compendium/items/potion-of-heroism.md).
...
A secret door is 5 feet up from the floor on the north wall of this cell. The secret door can't be opened from this side without the use of a [knock](compendium/spells/knock.md) spell or similar magic. Behind the secret door is a chute of polished black marble that slants upward (area K82).
...
- While attuned to the weapon, the sword's wielder can use the sword to cast the [crusader's mantle](compendium/spells/crusaders-mantle.md) spell. Once used, this property of the sword can't be used again until the next dawn.  
...
The man is [Emil Toranescu](compendium/bestiary/npc/emil-toranescu-cos.md), a [werewolf](compendium/bestiary/humanoid/werewolf.md) with 72 hit points. He claims to be a resident of Vallaki who was chased by dire wolves to the castle. He begs the characters to rescue him, offering to help them in exchange.

![Emil Toranescu](compendium/adventures/curse-of-strahd/img/043-cos04-18.webp#center)
...
Scattered across the floor of this cell are 2,100 ep. The coins have the profiled visage of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) stamped on them. A character can scoop up one hundred coins every minute.
...
This cell is linked to a teleport trap in area K73. The skeletal remains of a dwarf fighter lie at the bottom of the cell, enclosed in rusted plate armor. The dwarf's nonmagical but usable [battleaxe](compendium/items/battleaxe.md) lies nearby.
...
As soon as one or more characters move more than 10 feet into the room, six [Strahd zombies](compendium/bestiary/undead/strahd-zombie-cos.md) rise slowly out of the water, their slime-gray arms clawing upward through the water as they attack.

![](compendium/adventures/curse-of-strahd/img/044-cos04-19.webp#center)
...
The two statues are [iron golems](compendium/bestiary/construct/iron-golem.md). Each horse and rider is considered one creature, and they are inseparable. The golems will not leave the room under any circumstances, and they attack only under specific conditions (see the "Development" section that follows).
...
The brazier's flame is magical and sheds no warmth. A successful casting of [dispel magic](compendium/spells/dispel-magic.md) (DC 16) extinguishes the flame for 1 hour. The fire is permanently extinguished if the brazier is destroyed. The brazier has AC 17, 25 hit points, immunity to poison and psychic damage, and resistance to all other damage.
...
Inscribed on the landing, hidden under years of dust, is a [glyph of warding](compendium/spells/glyph-of-warding.md). If the characters brush away the dust, someone can spot the glyph with a successful DC 15 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check.

The glyph triggers the first time a living creature passes over it. Triggering it activates a [major image](compendium/spells/major-image.md) spell, conjuring an illusion of [Strahd von Zarovich](compendium/bestiary/npc/strahd-von-zarovich-cos.md) that appears either halfway up the stairs leading to area K72 or halfway down the stairs leading to area K78, so that the vampire appears in front of the triggering character. When "Strahd" appears, read:
...
Near the midpoint of the tunnel is a trapdoor hidden under a layer of fog. Characters can't spot the trapdoor passively, but an active search accompanied by a successful DC 20 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check locates it. Unless the trapdoor is fastened shut with an iron spike or by some other means, it opens when 100 pounds of weight or more is placed on it. When the trapdoor opens, everyone who is standing on it slides into the marble chute below (area K82). The trapdoor then resets.
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `dice:2d4|noform|avg` (`2d4`) [swarms of bats](compendium/bestiary/beast/swarm-of-bats.md) form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.

#### Teleport Traps

Invisible teleport traps are located between crypts 37 and 38, between crypt 37 and the wall south of it, and between crypt 38 and the wall south of it. The traps can't be perceived except with a [detect magic](compendium/spells/detect-magic.md) spell, which reveals an aura of conjuration magic in the trapped areas. Although the traps can't be disarmed, a successful casting of [dispel magic](compendium/spells/dispel-magic.md) (DC 16) on a trap suppresses its magic for 1 minute, allowing characters to move safely through its area. A trap is also suppressed while wholly or partly in the area of an [antimagic field](compendium/spells/antimagic-field.md).

These teleport traps form a protective ring around the entrance to Strahd's tomb (area K86). Any creature that enters one of these 10-foot-square spaces is instantly teleported away, switching places with one of the [wights](compendium/bestiary/undead/wight.md) in crypt 14. The wight materializes in the creature's previous location and attacks any living creature it sees.
...
A [detect magic](compendium/spells/detect-magic.md) spell reveals that the thighbone radiates an aura of evocation magic. See appendix C for more information on [Saint Markovia's thighbone](compendium/items/saint-markovias-thighbone-cos.md).
...
Endorovich's spirit is trapped inside one of the gargoyles. If anyone disturbs the bones on the slab, one of the [gargoyles](compendium/bestiary/elemental/gargoyle.md) awakens and attacks. If the gargoyle is reduced to 0 hit points, Endorovich's spirit moves to the second gargoyle, which then awakens and attacks. Both gargoyles have maximum hit points (77). Once the second [gargoyle](compendium/bestiary/elemental/gargoyle.md) is destroyed, Endorovich's spirit is laid to rest.
...
If [Pidlwick II](compendium/bestiary/npc/pidlwick-ii-cos.md) (see area K59) is with the party, it refuses to enter the crypt. The slab in this crypt is 4 feet long (instead of the usual 6 feet long). The bones atop the slab belong to the fool servant of Duchess Dorfniya Dilisnya (see crypt 8).

##### Treasure

If the characters explore this crypt after summoning the ghost of Pidlwick in area K36, they find a small, flat wooden box on the marble slab next to Pidlwick's bones. The box contains a full [deck of illusions](compendium/items/deck-of-illusions.md).
...
The slab upon which the helm rests is weight-sensitive. If the helm is removed from the slab without 10 pounds of weight immediately being added, poisonous gas pours out of the slab's hollow interior and fills the crypt. A character who searches the slab for traps and succeeds on a DC 12 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check spots tiny holes bored into the slab's marble base. It's from these holes that the gas spews forth.

A creature in the crypt when the gas is released must make a DC 14 Constitution saving throw, taking `dice:4d10|noform|avg|text(22)` (`4d10`) poison damage on a failed save, or half as much damage on a successful one.
...
The stoppered drinking horn is a water-resistant [powder horn](compendium/items/gunpowder-horn.md) loaded with gunpowder, and the "weird-looking scepter" is a [musket](compendium/items/musket.md). The fat pouch contains 20 silver marbles (silvered bullets for the musket). For more information on firearms and explosives, see chapter 9, ""Dungeon Master's Workshop"," of the "Dungeon Master's Guide".
...
The glider has AC 12, 1 hit point, and a 15-foot wingspan. Any damage causes it to break and become inoperable. A [mending](compendium/spells/mending.md) cantrip can repair the damage, provided all the broken pieces are present.
...
The skull's [black opal eye-gems](compendium/items/black-opal.md) are worth 1,000 gp apiece. The skull also has eight amber teeth worth 100 gp each.

Any creature that stands inside the crypt and boldly speaks the name "Khazan" causes the Pillarstone of Ravenloft to tremble as a [staff of power](compendium/items/staff-of-power.md) materializes above the marble slab and hovers in place. The first creature to grab hold of the staff must make a DC 17 Constitution saving throw, taking `dice:8d10|noform|avg|text(44)` (`8d10`) lightning damage on a failed save, or half as much damage on a successful one. Afterward, the [staff of power](compendium/items/staff-of-power.md) can be held and used normally. If no one grabs the staff within 1 round of its appearance, it vanishes, never to return.
...
The stone door of this crypt has been carefully laid to one side. Through the swirly mists of the perpetual fog, freshly engraved letters spell out the words "[Ireena Kolyana](compendium/bestiary/npc/ireena-kolyana-cos.md): Wife."
...
This [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) is an old wife of Strahd's. Once she realizes that the characters aren't her husband, Sasha tears away her web shroud like an unloved wedding dress and attacks.
...
Reducing the banshee to 0 hit points causes it to discorporate. Patrina's spirit can't rest, however, until she is formally wed to Strahd; the banshee re-forms in her crypt 24 hours later. Casting a [hallow](compendium/spells/hallow.md) spell on the crypt prevents the banshee from returning for as long as the spell lasts.
...
A [detect magic](compendium/spells/detect-magic.md) spell cast here reveals that Stefan's skull radiates a faint aura of necromancy magic. As long as the skull remains in the crypt, it will answer up to five questions put to it, as though a [speak with dead](compendium/spells/speak-with-dead.md) spell had been cast on it. This property recharges each day at dawn. In life, Stefan was neither observant nor well informed. If the skull is questioned about Strahd or Castle Ravenloft, all the information it provides is untrue.
...
A [detect magic](compendium/spells/detect-magic.md) spell cast here reveals that Intree's skull radiates a faint aura of necromancy magic. As long as the skull remains in the crypt, it will answer up to five questions put to it, as though a [speak with dead](compendium/spells/speak-with-dead.md) spell had been cast on it. This property recharges each day at dawn. Unlike Stefan Gregorovich in crypt 25, Intree was well educated and astute. If the skull is questioned about Strahd or the castle, the information it provides is true.
...
Three [giant wolf spiders](compendium/bestiary/beast/giant-wolf-spider.md) infest this otherwise empty crypt. The spiders make no noise and leap out to attack anyone who moves in front of the crypt's gaping doorway.
...
If the bell is rung inside the crypt, magic fire sweeps through the crypt to scorch Chef Ofenheiss's bones. A creature in the crypt must make a DC 17 Dexterity saving throw, taking `dice:4d10|noform|avg|text(22)` (`4d10`) fire damage on a failed save, or half damage on a successful one. Any creature that fails its save catches fire, taking `dice:1d10|noform|avg|text(5)` (`1d10`) fire damage at the end of each of its turns until it or another creature uses an action to douse the flames.
...
A patch of [brown mold](compendium/traps-hazards/brown-mold.md) (see ""Dungeon Hazards"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide") fills the crypt. Characters within 5 feet of the crypt's open doorway are affected.
...
Hidden under the brown mold next to the baron's bones is a [luck blade](compendium/items/luck-blade.md) with one wish remaining. If a creature uses the wish to try to escape from Barovia, the spell fails. If a creature uses the sword to wish for Strahd's destruction, the wish doesn't destroy Strahd but rather teleports him to within 5 feet of the sword.
...
The floor of the crypt is actually the cover of a 30-foot-deep spiked pit. The cover opens if 100 pounds of weight or more are placed on it. It splits down the middle, east to west, and its doors are spring-loaded. After a victim or victims fall into the pit, its doors snap shut. (See ""Sample Traps"" in chapter 5, "Adventure Environments," of the "Dungeon Master's Guide" the rules on locking pits and spiked pits.) The spikes at the bottom of the pit are made of iron but aren't [poisoned](/compendium/rules/conditions.md#Poisoned).

##### Treasure

A human skeleton (the remains of a dead adventurer) wrapped in bits of studded leather armor lies amid the spikes at the bottom of the pit. A shattered lantern and a rusty [crowbar](compendium/items/crowbar.md) lie nearby. Tied to the corpse's leather belt is a [50-foot coil of hempen rope](compendium/items/hempen-rope-50-feet.md), a [dagger](compendium/items/dagger.md) in a worn scabbard, a pouch containing 25 pp, and a stoppered wooden tube containing a [spell scroll](compendium/items/spell-scroll-dmg.md) of [magic circle](compendium/spells/magic-circle.md).
...
A [detect magic](compendium/spells/detect-magic.md) spell reveals that both alcoves radiate strong auras of conjuration magic.
...
An [invisible](/compendium/rules/conditions.md#Invisible) [imp](compendium/bestiary/fiend/imp.md) is perched atop the owlbear. If someone tries to open the sarcophagus, the imp says in Common, "I wouldn't do that if I were you!" The imp is magically bound to King Dostron's remains and must watch over them for several more centuries before its contract are fulfilled. It isn't obligated to protect the contents of the crypt (so it will not attack), and it delights in telling lies and engaging in mischief. For instance, it warns the characters that the sarcophagus is trapped, and that opening the lid will free a pit fiend bound within.
...
The floor here is an illusion that hides a 20-foot-deep pit. The sides of the pit are polished smooth; a creature without a climbing speed can't move along them without the aid of magic or a climber's kit. At the bottom of the pit are six starving [ghouls](compendium/bestiary/undead/ghoul.md). A permanent [silence](compendium/spells/silence.md) spell suppresses sound in the pit. The silence can be dispelled, as can the illusory floor (DC 14 for both).

##### Treasure

Sir Jarnwald was "entombed" here, so far as he was pushed into the crypt and devoured by the ghouls. What remains of him lies scattered on the pit floor: a few scraps of clothing, a handful of teeth, and a [signet ring](compendium/items/signet-ring.md) that bears a stylized "J" (worth 25 gp).
...
Three [hell hounds](compendium/bestiary/fiend/hell-hound.md) lunge forth and attack, fighting to the death. In the round after they attack, General Grislek's [wraith](compendium/bestiary/undead/wraith.md) emerges from the crypt, uttering commands to the hounds in Infernal. Once these evil creatures are slain, the characters can inspect the crypt more closely.
...
A [mending](compendium/spells/mending.md) cantrip can repair the spear, which is broken into three pieces of roughly equal length. If repaired, it can be wielded as a silvered, nonmagical spear.
...
The [nightmare](compendium/bestiary/fiend/nightmare.md), [Beucephalus](compendium/bestiary/npc/beucephalus-cos.md), is Strahd's steed. It has 104 hit points. If the characters slay it, Strahd hunts them down mercilessly. When the steed wants to leave the castle, it flies up the central shaft of the high tower (area K18a), exiting through the gash in the tower roof (area K59).
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is lying across Sergei's coffin, weeping.
...
Lying under the earth near the east wall of the tomb are three [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) brides dressed in soiled gowns and wearing dirt-encrusted jewelry (see "Treasure" below). They rise to attack anyone who approaches Strahd's coffin.

A [detect magic](compendium/spells/detect-magic.md) spell reveals that the western and eastern alcoves radiate strong auras of conjuration magic. The central alcove is nonmagical.
...
[Ludmilla Vilisevic](compendium/bestiary/npc/ludmilla-vilisevic-cos.md) wears a soiled white wedding gown, a gold tiara (worth 750 gp), and ten gold bracelets (worth 100 gp each).

[Anastrasya Karelova](compendium/bestiary/npc/anastrasya-karelova-cos.md) wears a stained and tattered red wedding gown, a black and crimson silk head scarf sewn with precious jewels (worth 750 gp), and a platinum necklace with a black opal pendant (worth 1,500 gp).

[Volenta Popofsky](compendium/bestiary/npc/volenta-popofsky-cos.md) wears a faded gold wedding gown, a platinum mask shaped vaguely like a skull (750 gp), and ten platinum rings set with gemstones (worth 250 gp each).
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is in his coffin, ready to attack anyone who opens the lid.
...
![King Barov and Queen Ravenovia](compendium/adventures/curse-of-strahd/img/045-cos04-21.webp#center)
...
If your card reading indicates an encounter with [Strahd](compendium/bestiary/npc/strahd-von-zarovich-cos.md) in this area, he is in a frenzy of rage and despair.