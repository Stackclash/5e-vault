...
![](/compendium/adventures/curse-of-strahd/img/023-cos04-01.png#center)
...
| 6 | `dice: 1d4 + 1|avg` (`1d4 + 1`) [flying swords](/compendium/bestiary/construct/flying-sword.md) |
| 7 | Blinsky toy |
...
| 15 | `dice: 1d4|avg` (`1d4`) [wights](/compendium/bestiary/undead/wight.md) |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [Barovian witch](/compendium/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) |
| 19 | `dice: 1d4 + 1|avg` (`1d4 + 1`) [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) |
...
[Rahadin](/compendium/bestiary/npc/rahadin-cos.md) directs the characters to a random location in the castle, determined by rolling a `dice: d6|avg` (`d6`):
...
Any character who has a passive Wisdom ([Perception](compendium/rules/skills.md#Perception)) score lower than 19 is surprised as Strahd appears seemingly out of nowhere. The vampire prefers to attack a surprised character, choosing the one closest to him. Otherwise, see appendix D for the vampire's tactics.
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [unseen servant](/compendium/spells/unseen-servant.md) spell in the "Player's Handbook"). Roll a `dice: d6|avg` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking 44 (`dice: 8d10|avg` (`8d10`)) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [potion of healing](/compendium/items/potion-of-healing.md). |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice: 1d4|avg` (`1d4`) hungry [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) (see below), which arrive in `dice: 1d4 + 1|avg` (`1d4 + 1`) rounds. |
...
If any character has a passive Wisdom ([Perception](compendium/rules/skills.md#Perception)) score of 16 or higher, the party isn't surprised. In that case, read:
...
The wights carry longswords that have the crest of Barovia worked into their cross guards. Each wight also carries a pouch holding `dice: 2d20|avg` (`2d20`) ep, each coin of Barovian mintage and featuring the profiled visage of [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md).
...
> [!gallery]
> ![Map 2: Walls of Ravenloft](/compendium/adventures/curse-of-strahd/img/024-005.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/024-005-player.jpg#gallery)
...
> [!gallery]
> ![Map 3: Main Floor](/compendium/adventures/curse-of-strahd/img/025-006.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/025-006-player.jpg#gallery)
...
![](/compendium/adventures/curse-of-strahd/img/026-cos04-04.png#center)
...
The statuette on the altar is an artifact called the [Icon of Ravenloft](/compendium/items/icon-of-ravenloft-cos.md) (see appendix C). Any evil creature that touches the statuette must make a DC 17 Constitution saving throw, taking 88 (`dice: 16d10|avg` (`16d10`)) radiant damage on a failed save, or half as much damage on a successful one. The statuette is safe for all creatures to handle once it is no longer in contact with the altar.
...
![](/compendium/adventures/curse-of-strahd/img/027-cos04-05.jpg#center)
...
> [!gallery]
> ![Map 4: Court of the Count](/compendium/adventures/curse-of-strahd/img/028-007.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/028-007-player.jpg#gallery)
...
![Lief Lipsiege](/compendium/adventures/curse-of-strahd/img/029-cos04-07.png#center)
...
| 2 | `dice: 1d4|avg` (`1d4`) [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) |
| 3 | `dice: 1d4|avg` (`1d4`) [wights](/compendium/bestiary/undead/wight.md) |
| 4 | 1 [wraith](/compendium/bestiary/undead/wraith.md) and `dice: 1d4 + 1|avg` (`1d4 + 1`) [specters](/compendium/bestiary/undead/specter.md) |
^creature
...
> [!gallery]
> ![Map 5: Rooms of Weeping](/compendium/adventures/curse-of-strahd/img/030-008.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/030-008-player.png#gallery)
...
The lute, though old and covered in dust, has survived the passage of time. It is a magic instrument of the bards called a [Doss lute](/compendium/items/instrument-of-the-bards-doss-lute.md).
...
![Tatyana](/compendium/adventures/curse-of-strahd/img/031-cos04-09.png#center)
...
![Gertruda](/compendium/adventures/curse-of-strahd/img/032-cos04-10.png#center)
...
> [!gallery]
> ![Map 6: Spires of Ravenloft](/compendium/adventures/curse-of-strahd/img/033-009.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/033-009-player.png#gallery)
...
![](/compendium/adventures/curse-of-strahd/img/034-cos04-11.png#center)
...
![Escher and the Three Brides](/compendium/adventures/curse-of-strahd/img/035-cos04-20.png#center)
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice: 1d4|avg` (`1d4`) [Barovian witches](/compendium/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with [sleep](/compendium/spells/sleep.md) spells. A witch retreats to area K56 if wounded.
...
> ![Player Version](/compendium/adventures/curse-of-strahd/img/036-010-player.jpg#gallery)
...
Each witch carries a [potion of healing](/compendium/items/potion-of-healing.md) that she made herself. There is a 30|30 percent% chance chance that a potion has "gone bad," in which case it's actually a [potion of poison](/compendium/items/potion-of-poison.md).
...
![](/compendium/adventures/curse-of-strahd/img/037-cos19-10.png#center)
...
> [!gallery]
> ![Map 11: Larders of Ill Ome...](/compendium/adventures/curse-of-strahd/img/038-011.jpg#gallery "Map 11: Larders of Ill Omen & Map 12: Dungeon and Catacombs")
> ![Player Version](/compendium/adventures/curse-of-strahd/img/038-011-player.jpg#gallery)
...
> [!gallery]
> ![Map: Elevator Trap](/compendium/adventures/curse-of-strahd/img/039-012.jpg#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/040-cos401.jpg#gallery)
...
The light in the hall comes from a lantern on the floor behind Cyrus. If the characters have their own light sources, Cyrus sees them, but he will not attack first. He wears a loop of twine around his neck, hanging from which is an iron key and a decorative wooden pendant fitted with a varnished human eyeball. The key unlocks the iron chest in area K60. The wooden pendant is a _hag eye_ given to Cyrus by the [night hag](/compendium/bestiary/fiend/night-hag.md) [Morgantha](/compendium/bestiary/npc/morgantha-cos.md) (see chapter 6), so that she could spy on Strahd. Cyrus doesn't know that the necklace is magical. See the "Hag Covens" sidebar in the hags entry in the "Monster Manual" for information about the _hag eye_.

![Cyrus Belview](/compendium/adventures/curse-of-strahd/img/041-cos04-16.png#center)
...
![Map: Traps in Area K73](/compendium/adventures/curse-of-strahd/img/042-cos04-17.png#center)
...
![Emil Toranescu](/compendium/adventures/curse-of-strahd/img/043-cos04-18.png#center)
...
![](/compendium/adventures/curse-of-strahd/img/044-cos04-19.jpg#center)
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `dice: 2d4|avg` (`2d4`) [swarms of bats](/compendium/bestiary/beast/swarm-of-bats.md) form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.
...
The compartment under the slab holds a small, black leather case containing three spell scrolls ([cone of cold](/compendium/spells/cone-of-cold.md), [fireball](/compendium/spells/fireball.md), and [lightning bolt](/compendium/spells/lightning-bolt.md)).
...
![King Barov and Queen Ravenovia](/compendium/adventures/curse-of-strahd/img/045-cos04-21.png#center)
