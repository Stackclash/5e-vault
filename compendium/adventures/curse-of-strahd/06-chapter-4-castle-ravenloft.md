...
| 6 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [flying swords](/compendium/bestiary/construct/flying-sword.md) |
| 7 | Blinsky toy |
| 8 | [Unseen servant](/compendium/spells/unseen-servant.md) |
| 9 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [commoners](/compendium/bestiary/humanoid/barovian-commoner-cos.md) |
| 10 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [crawling claws](/compendium/bestiary/undead/crawling-claw.md) |
| 11 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [shadows](/compendium/bestiary/undead/shadow.md) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [swarms of bats](/compendium/bestiary/beast/swarm-of-bats.md) |
| 13 | 1 crawling [Strahd zombie](/compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
| 14 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) Vistani [thugs](/compendium/bestiary/humanoid/vistana-thug-cos.md) |
| 15 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [wights](/compendium/bestiary/undead/wight.md) |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [Barovian witch](/compendium/bestiary/humanoid/barovian-witch-cos.md) (see appendix D) |
| 19 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) |
...
[Rahadin](/compendium/bestiary/npc/rahadin-cos.md) directs the characters to a random location in the castle, determined by rolling a `dice:d6|noform|noparens|avg` (`d6`):
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [unseen servant](/compendium/spells/unseen-servant.md) spell in the "Player's Handbook"). Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking `dice:8d10\|noform\|noparens\|avg\|text(44)` (`8d10`) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [potion of healing](/compendium/items/potion-of-healing.md). |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice:1d4\|noform\|noparens\|avg` (`d4`) hungry [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) (see below), which arrive in `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) rounds. |
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [shadows](/compendium/bestiary/undead/shadow.md) |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) |
| 3 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [wights](/compendium/bestiary/undead/wight.md) |
| 4 | 1 [wraith](/compendium/bestiary/undead/wraith.md) and `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [specters](/compendium/bestiary/undead/specter.md) |
^creature
...
The lute, though old and covered in dust, has survived the passage of time. It is a magic [instrument of the bards](/compendium/items/instrument-of-the-bards.md) called a [Doss lute](/compendium/items/instrument-of-the-bards-doss-lute.md).
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice:1d4|noform|noparens|avg` (`d4`) [Barovian witches](/compendium/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with [sleep](/compendium/spells/sleep.md) spells. A witch retreats to area K56 if wounded.
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `dice:2d4|noform|noparens|avg` (`2d4`) [swarms of bats](/compendium/bestiary/beast/swarm-of-bats.md) form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.
...
A creature in the crypt when the gas is released must make a DC 14 Constitution saving throw, taking `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) poison damage on a failed save, or half as much damage on a successful one.
...
If the bell is rung inside the crypt, magic fire sweeps through the crypt to scorch Chef Ofenheiss's bones. A creature in the crypt must make a DC 17 Dexterity saving throw, taking `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) fire damage on a failed save, or half damage on a successful one. Any creature that fails its save catches fire, taking `dice:1d10|noform|noparens|avg|text(5)` (`d10`) fire damage at the end of each of its turns until it or another creature uses an action to douse the flames.
