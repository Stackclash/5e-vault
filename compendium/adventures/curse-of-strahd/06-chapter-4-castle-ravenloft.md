...
The groans are coming from a [Strahd zombie](strahd-zombie-cos.md) that is missing both of its legs, so that only its head, torso, and arms remain. It uses its arms to drag itself across the floor. The crawling zombie has 15 hit points remaining.

If the characters are moving quietly and not using light sources, they can try to hide from the crawling zombie.

#### Ezmerelda d'Avenir

[Ezmerelda](/compendium/bestiary/npc/ezmerelda-davenir-cos.md) has cast a greater invisibility spell on herself and is stealthily exploring the castle. Choose one character in the back rank of the party's marching order, and read the following text to that character's player:
...
| 3 | A [Strahd zombie](strahd-zombie-cos.md) (see appendix D). It fights until killed. |
| 4 | A Barovian lunatic (CN male [commoner](/compendium/bestiary/humanoid/commoner.md)). If freed, he cackles until silenced or until a calm emotions spell is cast on him. A lesser restoration spell cures his madness, at which point he tries to flee the castle. |
...
To determine what the character finds, roll on the [Trinkets table](trinket-cos.md) in appendix A.
...
These minions of Strahd—former adventurers all—creep along ceilings and drop down on unsuspecting prey. The [vampire spawn](vampire-spawn.md) fight until destroyed.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [wights](wight.md). These undead soldiers once served as guard captains in Castle Ravenloft. They still wear bits of tattered livery, and they attack the living on sight.
...
The figure slumped on the altar is all that remains of Gustav Herrenghast, a lawful evil human cleric who tried to obtain the [Icon of Ravenloft](icon-of-ravenloft-cos.md) and did not survive the attempt. See "Treasure" below for more information on the icon and Gustav's possessions.

A sculpted stone railing cordons off the upstairs balcony, which is described in area K28.

#### Treasure

The statuette on the altar is an artifact called the [Icon of Ravenloft](icon-of-ravenloft-cos.md) (see appendix C). Any evil creature that touches the statuette must make a DC 17 Constitution saving throw, taking 88 (`dice: 16d10|avg` (`16d10`)) radiant damage on a failed save, or half as much damage on a successful one. The statuette is safe for all creatures to handle once it is no longer in contact with the altar.
...
Strahd senses if any damage is done to the Heart of Sorrow and sends four [vampire spawn](vampire-spawn.md) to destroy those responsible. These vampire spawn are former adventurers whom Strahd defeated long ago. They use their Spider Climb feature to scuttle along the tower walls and arrive in 3 rounds.
...
Two [Strahd zombies](strahd-zombie-cos.md) (see appendix D) are slouched on the thrones. They remain motionless until one of them is disturbed or another creature comes within a zombie's reach, whereupon they attack.
...
Lief was pressed into service by Strahd many years ago. He keeps all the books for Strahd, recording the vampire's riches and conquests. Lief has been here longer than he can remember. He is grumpy because Strahd doesn't allow him to know about all his treasures. Even so, Lief has found out where one of Strahd's secret treasures lies. If he is treated with kindness, Lief will divulge the hiding place of the [Holy Symbol of Ravenkind](holy-symbol-of-ravenkind-cos.md), as indicated by your card reading. Lief can draw a crude map showing a route to that location. His map is geographically accurate, but he admits that it doesn't acknowledge or avoid any dangers that might lie along the way. Lief doesn't necessarily know the most direct path to the symbol's location.
...
The maid, [Helga Ruvak](/compendium/bestiary/npc/helga-ruvak-cos.md), is a [vampire spawn](vampire-spawn.md) who claims to be the daughter of the village bootmaker, kidnapped and forced into service by Strahd. She pleads, on her hands and knees if necessary, to be saved from this awful place.
...
The youthful man on the couch is [Escher](/compendium/bestiary/npc/escher-cos.md), a dashing [vampire spawn](vampire-spawn.md) to whom Strahd has shown favor in the past. [Escher](/compendium/bestiary/npc/escher-cos.md) is feeling somewhat neglected of late and has retreated here until Strahd's mood improves. If attacked, he hurls himself out the window and lands like a cat on the roof of the keep (area K53). He leads pursuers right to Strahd, wherever the lord of the castle happens to be (and regardless of whether the characters are ready to face Strahd).
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice: 1d4|avg` (`1d4`) [Barovian witches](/compendium/bestiary/humanoid/barovian-witch-cos.md) from area K56. They try to subdue the party with sleep spells. A witch retreats to area K56 if wounded.
...
As soon as one or more characters move more than 10 feet into the room, six [Strahd zombies](strahd-zombie-cos.md) rise slowly out of the water, their slime-gray arms clawing upward through the water as they attack.
...
Inscribed on the landing, hidden under years of dust, is a glyph of warding. If the characters brush away the dust, someone can spot the glyph with a successful DC 15 Intelligence ([Investigation](compendium/rules/skills.md#Investigation)) check.

The glyph triggers the first time a living creature passes over it. Triggering it activates a major image spell, conjuring an illusion of [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md) that appears either halfway up the stairs leading to area K72 or halfway down the stairs leading to area K78, so that the vampire appears in front of the triggering character. When "Strahd" appears, read:
...
These teleport traps form a protective ring around the entrance to Strahd's tomb (area K86). Any creature that enters one of these 10-foot-square spaces is instantly teleported away, switching places with one of the [wights](wight.md) in crypt 14. The wight materializes in the creature's previous location and attacks any living creature it sees.
...
A detect magic spell reveals that the thighbone radiates an aura of evocation magic. See appendix C for more information on [Saint Markovia's thighbone](saint-markovias-thighbone-cos.md).
...
This vault contains fifteen [wights](wight.md) (one per coffin), minus any that have been teleported away (see "Teleport Traps" at the start of this section). Lifting a coffin's lid requires an action and a successful DC 15 Strength check.
...
This [vampire spawn](vampire-spawn.md) is an old wife of Strahd's. Once she realizes that the characters aren't her husband, Sasha tears away her web shroud like an unloved wedding dress and attacks.
...
Lying under the earth near the east wall of the tomb are three [vampire spawn](vampire-spawn.md) brides dressed in soiled gowns and wearing dirt-encrusted jewelry (see "Treasure" below). They rise to attack anyone who approaches Strahd's coffin.
