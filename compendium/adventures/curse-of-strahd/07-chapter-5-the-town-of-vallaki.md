...
[Rictavio](/compendium/bestiary/npc/rictavio-cos.md) wears a hat of disguise and a ring of mind shielding to conceal his identity. He carries an iron key that unlocks the door to his carnival wagon (area N5).
...
Inside the locked chest are 140 ep, 70 pp, two elixirs of health, three potions of healing, and a gray bag of tricks. The coins are embossed with the profiled likeness of [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md).
...
Urwin carries the key to the locked iron strongbox. The lock can be picked with thieves' tools and a successful DC 20 Dexterity check. The box contains a sack of 150 ep (each coin bearing the profiled visage of [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md)), six pieces of jewelry (worth 250 gp each), and three potions of healing.
...
Victor's spellbook contains all the spells Victor has prepared (see the [mage](/compendium/bestiary/humanoid/mage.md) stat block in the "Monster Manual") as well as the following spells: animate dead, blight, cloudkill, darkvision, glyph of warding, levitate, remove curse, and thunderwave.
...
Characters who have the [Tome of Strahd](tome-of-strahd-cos.md) (see appendix C) realize that the handwriting in Lady Lovina's letter is identical to Strahd's handwriting, suggesting that Strahd and Lord Vasili are one and the same.
