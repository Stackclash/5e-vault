...
![](/compendium/adventures/curse-of-strahd/img/094-cos09-01.webp#center)
...
> [!gallery]
> ![Map 9.1: Tsolenka Pass (Area T)](/compendium/adventures/curse-of-strahd/img/095-025.webp#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/096-cos901.webp#gallery)
...
These statues are actually two [petrified](/compendium/rules/conditions.md#Petrified) [vrocks](/compendium/bestiary/fiend/vrock.md). If they are attacked, or if the characters bypass the gatehouse, the vrocks revert to flesh and attack, pursuing prey that flees and fighting until slain.

### T3. Curtain of Green Flame

A curtain of green flame fills the eastern archway of the gatehouse. Any creature that enters the curtain for the first time on a turn or starts its turn in the green flame takes `dice:6d10|noform|noparens|avg|text(33)` (`6d10`) fire damage.

A successful casting of [dispel magic](/compendium/spells/dispel-magic.md) (DC 16) suppresses the curtain for 1 minute. The curtain is also suppressed within an [antimagic field](/compendium/spells/antimagic-field.md).

### T4. Guard Tower, Ground Floor

The tower door is made of ironbound wood and barred from within. A character can force open the door with a successful DC 22 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check.
...
The forms are six [snow maidens](/compendium/bestiary/undead/snow-maiden-cos.md). Use the [specter](/compendium/bestiary/undead/specter.md) statistics, with the following modifications:
...
The cloaked rider is a manifestation of [Strahd von Zarovich](/compendium/bestiary/npc/strahd-von-zarovich-cos.md)—a grim warning to proceed no further. If the characters interact with the manifestation in any way, the rider and horse disperse like ash in the wind.
...
![](/compendium/adventures/curse-of-strahd/img/097-cos09-03.webp#center)

### Bloodhorn's Charge

As the characters make their way along Tsolenka Pass, they encounter a beast that the druids and berserkers of Barovia call [Sangzor](/compendium/bestiary/npc/sangzor-cos.md) ("Bloodhorn"):
...
If no character has a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 16 or higher, the party is [surprised](/compendium/rules/conditions.md#Surprised). Otherwise, read:
...
[Sangzor](/compendium/bestiary/npc/sangzor-cos.md) is a [giant goat](/compendium/bestiary/beast/giant-goat.md) known for its supernatural resilience and evil disposition. Mountain folk have been hunting it for years. Modify its statistics as follows:
...
A character who wears [Sangzor](/compendium/bestiary/npc/sangzor-cos.md)'s pelt can command the respect of the berserkers who inhabit Strahd's domain. They will not attack the character or that character's companions unless provoked.