...
![](/compendium/adventures/curse-of-strahd/img/004-cos02-01.webp#center)
...
The land of Barovia resides in its own demiplane, isolated from all other planes, including the Material Plane. No spell—not even [wish](/compendium/spells/wish.md)—allows one to escape from Strahd's domain. [Astral projection](/compendium/spells/astral-projection.md), [teleport](/compendium/spells/teleport.md), [plane shift](/compendium/spells/plane-shift.md), and similar spells cast for the purpose of leaving Barovia simply fail, as do effects that banish a creature to another plane of existence. These restrictions apply to magic items and artifacts that have properties that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](/compendium/spells/etherealness.md) spell and the Etherealness feature of incorporeal undead, is the exception to this rule. A creature that enters the Border Ethereal from Strahd's domain is pulled back into Barovia upon leaving that plane.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](/compendium/spells/sending.md)), Strahd's domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally in Barovia, as does magic that involves an extradimensional space. Any spells cast within such an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](/compendium/spells/mordenkainens-magnificent-mansion.md)) are subject to the same restrictions as magic cast in Barovia.
...
> [!note] 
> 
> [Alarm](/compendium/spells/alarm.md): Instead of hearing a mental ping when the alarm is triggered, the caster hears a scream.
> 
> [Bigby's hand](/compendium/spells/bigbys-hand.md): The conjured hand is skeletal.
> 
> [Find familiar](/compendium/spells/find-familiar.md): The familiar is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find steed](/compendium/spells/find-steed.md): The summoned steed is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find the path](/compendium/spells/find-the-path.md): A child's spirit appears and guides the caster to the desired location. The spirit can't be harmed and doesn't speak.
> 
> [Fog cloud](/compendium/spells/fog-cloud.md): Misty, harmless claws form in the fog.
> 
> [Gust of wind](/compendium/spells/gust-of-wind.md): A ghastly moan accompanies the summoned wind.
> 
> [Mage hand](/compendium/spells/mage-hand.md): The summoned hand is skeletal.
> 
> [Maze](/compendium/spells/maze.md): The surfaces of the demiplane's maze are made of mortared skulls and bones.
> 
> [Phantom steed](/compendium/spells/phantom-steed.md): The steed resembles a skeletal horse.
> 
> [Rary's telepathic bond](/compendium/spells/rarys-telepathic-bond.md): Characters linked together by the spell can't shake the feeling that something vile is telepathically eavesdropping on them.
> 
> [Revivify](/compendium/spells/revivify.md): A creature restored to life by a [revivify](/compendium/spells/revivify.md) spell screams upon regaining consciousness, as though waking from some horrible nightmare.
> 
> [Spirit guardians](/compendium/spells/spirit-guardians.md): The spirits appear as ghostly, skeletal warriors.
> 
> [Wall of stone](/compendium/spells/wall-of-stone.md): A wall created by the spell has ghastly faces sculpted into it, as though tortured spirits were somehow trapped within the stone.
^0a7
...
When a humanoid who has been dead for at least 24 hours returns to life, either by way of a spell or some supernatural means, it gains a random form of indefinite madness brought on by the realization that its spirit is trapped in Barovia, likely forever. To determine how this madness is expressed, roll on the [Indefinite Madness](/compendium/tables/indefinite-madness.md) table in chapter 8 of the "Dungeon Master's Guide".
...
![](/compendium/adventures/curse-of-strahd/img/005-cos02-02.webp#center)
...
[Ireena Kolyana](/compendium/bestiary/npc/ireena-kolyana-cos.md) and her brother Ismark both have souls, as do all Vistani. Which Barovians have souls and which don't is left up to you.
...
![](/compendium/adventures/curse-of-strahd/img/006-cos02-03.webp#center)
...
The curse is a repayment for an injustice or a slight. The target must succeed on a Wisdom saving throw to avoid the curse. The saving throw DC is 8 + the Vistana's proficiency bonus + the Vistana's Charisma modifier. The curse lasts until ended with a [remove curse](/compendium/spells/remove-curse.md) spell, a [greater restoration](/compendium/spells/greater-restoration.md) spell, or similar magic. It doesn't end when the target dies. If a cursed target is returned to life, the curse remains in effect.
...
- The target is unable to perform a certain kind of act involving fine motor control, such as tying knots, writing, playing an instrument, sewing, or casting spells that have somatic components. When this curse ends, the Vistana takes `dice:1d6|noform|noparens|avg` (`d6`) psychic damage.  
- The target's appearance changes in a sinister yet purely cosmetic way. For example, the curse can place a scar on the target's face, turn the target's teeth into yellow fangs, or give the target bad breath. When this curse ends, the Vistana it takes `dice:1d6|noform|noparens|avg` (`d6`) psychic damage.  
- A nonmagical item in the target's possession (chosen by the DM) disappears and can't be found until the curse ends. The lost item can weigh no more than 1 pound. When this curse ends, the Vistana takes `dice:1d6|noform|noparens|avg` (`d6`) psychic damage.  
- The target gains vulnerability to a damage type of the Vistana's choice. When this curse ends, the Vistana takes `dice:3d6|noform|noparens|avg` (`3d6`) psychic damage.  
- The target has disadvantage on ability checks and saving throws tied to one ability score of the Vistana's choice. When this curse ends, the Vistana takes `dice:3d6|noform|noparens|avg` (`3d6`) psychic damage.  
- The target's attunement to one magic item (chosen by the DM) ends, and the target can't attune to the chosen item until the curse ends. When this curse ends, the Vistana takes `dice:5d6|noform|noparens|avg` (`5d6`) psychic damage.  
- The target is [blinded](/compendium/rules/conditions.md#Blinded), [deafened](/compendium/rules/conditions.md#Deafened), or both. When this curse ends, the Vistana takes `dice:5d6|noform|noparens|avg` (`5d6`) psychic damage.  

### Evil Eye

As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the [animal friendship](/compendium/spells/animal-friendship.md), [charm person](/compendium/spells/charm-person.md), or [hold person](/compendium/spells/hold-person.md) spell (Vistana's choice), but requires neither somatic nor material components. The spell save DC is 8 + the caster's proficiency bonus + the caster's Charisma modifier. If the target succeeds on the save, the Vistana is [blinded](/compendium/rules/conditions.md#Blinded) until the end of the Vistana's next turn.
...
- If the characters are on a road, an encounter occurs on a roll of 18 or higher on a `dice:d20|noform|noparens|avg` (`d20`).  
- If the characters are in the wilderness, an encounter occurs on a roll of 15 or higher on a `dice:d20|noform|noparens|avg` (`d20`).  
...
| d12 + d8 | Encounter |
|----------|-----------|
| 2 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [commoners](/compendium/bestiary/humanoid/barovian-commoner-cos.md) |
| 3 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scouts](/compendium/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
| 7 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [Vistani bandits](/compendium/bestiary/humanoid/vistana-bandit-cos.md) |
| 8 | Skeletal rider |
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [swarm of ravens](/compendium/bestiary/beast/swarm-of-ravens.md) (50%) or 1 [wereraven](/compendium/bestiary/humanoid/wereraven-vrgr.md) (see appendix D) in raven form (50%) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [dire wolves](/compendium/bestiary/beast/dire-wolf.md) |
| 13 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/compendium/bestiary/beast/wolf.md) |
| 14 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [berserkers](/compendium/bestiary/humanoid/berserker.md) |
| 15 | Corpse |
| 16 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [werewolves](/compendium/bestiary/humanoid/werewolf.md) in human form |
| 17 | 1 [druid](/compendium/bestiary/humanoid/druid.md) with `dice:2d6\|noform\|noparens\|avg` (`2d6`) [twig blights](/compendium/bestiary/plant/twig-blight.md) |
| 18 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [needle blights](/compendium/bestiary/plant/needle-blight.md) |
| 19 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scarecrows](/compendium/bestiary/construct/scarecrow.md) |
...
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice:1d8\|noform\|noparens\|avg` (`d8`) [swarm of bats](/compendium/bestiary/beast/swarm-of-bats.md) |
| 10 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [dire wolves](/compendium/bestiary/beast/dire-wolf.md) |
| 11 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/compendium/bestiary/beast/wolf.md) |
| 12 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [berserkers](/compendium/bestiary/humanoid/berserker.md) |
| 13 | 1 [druid](/compendium/bestiary/humanoid/druid.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [twig blights](/compendium/bestiary/plant/twig-blight.md) |
| 14 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [needle blights](/compendium/bestiary/plant/needle-blight.md) |
| 15 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [werewolves](/compendium/bestiary/humanoid/werewolf.md) in wolf form |
| 16 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [zombies](/compendium/bestiary/undead/zombie.md) |
| 17 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scarecrows](/compendium/bestiary/construct/scarecrow.md) |
| 18 | `dice:1d8\|noform\|noparens\|avg` (`d8`) [Strahd zombies](/compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
...
If the characters are moving quietly and not carrying light sources, they can try to hide from these Barovians, who carry pitchforks (+2 to hit) instead of clubs, dealing `dice:1d6|noform|noparens|avg|text(3)` (`d6`) piercing damage on a hit.
...
Roll a `dice:d6|noform|noparens|avg` (`d6`) to determine the nature of the corpse:
...
The [clothes](/compendium/items/common-clothes.md) have a drab Barovian style to them. They belong to a wereraven or werewolf.
...
As an action, the revenant can attack twice with its longsword, wielding the weapon with both hands and dealing `dice:2d10+4|noform|noparens|avg|text(15)` (`2d10 + 4`) slashing damage on each hit.
...
The human [skeleton](/compendium/bestiary/undead/skeleton.md) and [warhorse skeleton](/compendium/bestiary/undead/warhorse-skeleton.md) are all that remain of a rider and mount, both of whom perished trying to escape through the fog that surrounds Barovia. They are doomed to ride through the valley in search of another way out, without hope of salvation. The skeletons ignore the characters unless attacked.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [Strahd zombies](/compendium/bestiary/undead/strahd-zombie-cos.md). These undead soldiers once served as guards in Castle Ravenloft. They fled the castle after Strahd became a vampire but couldn't avoid their master's wrath. They still wear bits of tattered livery, and they attack the living on sight.
...
A random character finds a lost trinket. Roll on the [Trinkets table](/compendium/items/trinket-cos.md) in appendix A, select a specific trinket from the table, or create one on the fly.
...
The wereraven belongs to a secret order called the Keepers of the Feather. If the characters don't spot it, the wereraven shadows them for `dice:1d4|noform|noparens|avg` (`d4`) hours. At the end of that time, or anytime sooner if the characters attack it, the creature flies home to report what it has seen.
...
The light is a [will-o'-wisp](/compendium/bestiary/undead/will-o-wisp.md) that enters the ruined tower and becomes [invisible](/compendium/rules/conditions.md#Invisible), hoping to lure the characters inside to their doom.

The floor of the tower is made of packed earth. Its interior is [desecrated ground](/compendium/traps-hazards/desecrated-ground.md) (see ""Wilderness Hazards"" in chapter 5 of the "Dungeon Master's Guide"). Against the inside wall of the tower, across from the open doorway, is a closed, empty wooden chest.

If the characters disturb the chest, `dice:3d6|noform|noparens|avg` (`3d6`) [zombies](/compendium/bestiary/undead/zombie.md) erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
...
These unfortunate Barovians fell prey to the evils of the land and now shamble from place to place as a [ravenous mob](/compendium/bestiary/undead/zombie.md).
...
> [!gallery]
> ![Map 2.1: Barovia](/compendium/adventures/curse-of-strahd/img/007-001.webp#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/008-cos201.webp#gallery)
...
![](/compendium/adventures/curse-of-strahd/img/009-cos02-04.webp#center)
...
> [!gallery]
> ![Map 2.2: Tser Pool Encampment](/compendium/adventures/curse-of-strahd/img/010-cos02-06.webp#gallery)
> ![Player Version](/compendium/adventures/curse-of-strahd/img/011-cos202.webp#gallery)
...
| 14–16 | Pouch containing `dice:4d6\|noform\|noparens\|avg` (`4d6`) gemstones worth 100 gp each |
| 17–19 | Sack containing `dice:3d6\|noform\|noparens\|avg` (`3d6`) pieces of cheap jewelry worth 25 gp total and `dice:1d6\|noform\|noparens\|avg` (`d6`) pieces of fine jewelry worth 250 gp each |
| 20 | One magic item (roll once on [Magic Item Table B](/compendium/tables/magic-item-table-b.md) in the "Dungeon Master's Guide") |
^treasure
...
Under normal circumstances, a [greater restoration](/compendium/spells/greater-restoration.md) spell cast on the Mad Mage would restore his wits and ends the madness, allowing him to remember that he is none other than Mordenkainen, an [archmage](/compendium/bestiary/humanoid/archmage.md) of Oerth and the leader of a powerful group of adventurers called the Circle of Eight. But in this case, the Mad Mage has cast a [mind blank](/compendium/spells/mind-blank.md) spell on himself. As long as that spell remains in effect, his sanity can't be restored by any spell. If the characters surmise that powerful magic is preventing them from restoring the Mad Mage's wits, they can, with a successful DC 15 Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check, convince the Mad Mage to divulge the reason why their spell failed. A character can also ascertain the cause of the spell's failure with a successful DC 18 Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) check. The Mad Mage's [mind blank](/compendium/spells/mind-blank.md) spell has a remaining duration of `dice:3d6|noform|noparens|avg` (`3d6`) hours, after which his madness can be cured normally.

The Mad Mage has a different spell list from that of the [archmage](/compendium/bestiary/humanoid/archmage.md) in the "Monster Manual", and he has already used one 1st-level spell slot to cast [mage armor](/compendium/spells/mage-armor.md) on himself, one 4th-level spell slot to cast [polymorph](/compendium/spells/polymorph.md) on himself, one 7th-level spell slot to cast [Mordenkainen's magnificent mansion](/compendium/spells/mordenkainens-magnificent-mansion.md) (see "The Mad Mage's Mansion"), and one 8th-level spell slot to cast [mind blank](/compendium/spells/mind-blank.md) on himself.
...
> 
> 2nd level (3 slots): [mirror image](/compendium/spells/mirror-image.md), [misty step](/compendium/spells/misty-step.md), [web](/compendium/spells/web.md)
> 
...
> 
> 4th level (3 slots): [Mordenkainen's faithful hound](/compendium/spells/mordenkainens-faithful-hound.md), [polymorph](/compendium/spells/polymorph.md), [stoneskin](/compendium/spells/stoneskin.md)
> 
> 5th level (3 slots): [Bigby's hand](/compendium/spells/bigbys-hand.md), [cone of cold](/compendium/spells/cone-of-cold.md), [scrying](/compendium/spells/scrying.md)
> 
> 6th level (1 slot): [true seeing](/compendium/spells/true-seeing.md)
> 
> 7th level (1 slot): [Mordenkainen's magnificent mansion](/compendium/spells/mordenkainens-magnificent-mansion.md)
> 
> 8th level (1 slot): [mind blank](/compendium/spells/mind-blank.md)
> 
> 9th level (1 slot): [time stop](/compendium/spells/time-stop.md)
^128

#### The Mad Mage's Mansion

If the characters rescue the [archmage](/compendium/bestiary/humanoid/archmage.md) from his madness, he invites them to his "mansion." He leads them up the mountain to an invisible doorway that serves as the entrance to his extradimensional lair, created using the [Mordenkainen's magnificent mansion](/compendium/spells/mordenkainens-magnificent-mansion.md) spell. There, he provides them with food and sanctuary away from the prying eyes of Strahd and his spies. Characters are free to take a short or long rest, during which time they aren't disturbed.
...
The [archmage](/compendium/bestiary/humanoid/archmage.md) has never had his fortune read by [Madam Eva](/compendium/bestiary/npc/madam-eva-cos.md) and doesn't care to, but if he is told about the [Holy Symbol of Ravenkind](/compendium/items/holy-symbol-of-ravenkind-cos.md), the [Tome of Strahd](/compendium/items/tome-of-strahd-cos.md), and the [Sunsword](/compendium/items/sunsword-cos.md), he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.
