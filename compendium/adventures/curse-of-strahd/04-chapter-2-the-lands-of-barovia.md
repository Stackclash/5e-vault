...
| 16 | `dice: 3d6\|avg` (`3d6`) [zombies](compendium/bestiary/undead/zombie.md) |
| 17 | `dice: 1d6\|avg` (`1d6`) [scarecrows](compendium/bestiary/construct/scarecrow.md) |
| 18 | `dice: 1d8\|avg` (`1d8`) [Strahd zombies](compendium/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
...
If the characters disturb the chest, `dice: 3d6|avg` (`3d6`) [zombies](compendium/bestiary/undead/zombie.md) erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
