...
![The next piece of the Rod ...](/compendium/adventures/vecna-eve-of-ruin/img/061-04-001-the-colossus-warforged.webp#center "The next piece of the Rod of Seven Parts is inside an enormous war machine")

Searching for the [third piece](/compendium/items/rod-of-seven-parts-veor.md) of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) takes the characters to the continent of Khorvaire on Eberron. The scars of the Last War are still fresh on Khorvaire. Nowhere is this truer than in the Mournland, a once-glorious nation destroyed during the apocalyptic Day of Mourning. Here, the characters must search for the next piece of the rod.
...
This chapter begins after the characters retrieve the second piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md). The characters can knit the pieces together or keep them separate, as described in the introduction. Regardless, when a character holds the second piece of the rod, they intuitively know that the next piece is located somewhere on the continent of Khorvaire on the world of Eberron.
...
This chapter first describes Mount Ironrot, including locations and encounters awaiting the characters. The chapter then details the ruins of a colossus called Landro, whose dangers the characters must survive to claim the third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md).

### Character Advancement

The characters should be 13th level when this chapter begins. The characters gain a level after they retrieve the third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) from the graymatter engine of Landro.
...
The third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) is found in area L28 within Landro. For more information about the rod and the spell this piece allows its wielder to cast, see this book's introduction.
...
![The Mount Ironrot region i...](/compendium/adventures/vecna-eve-of-ruin/img/062-04-002-mount-ironrot-region.webp#center "The Mount Ironrot region is a wasteland scattered with broken war machines")
...
- **Impeded Navigation.** In outdoor areas, creatures have disadvantage on Wisdom ([Survival](/compendium/rules/skills.md#Survival)) checks made to navigate.  
- **Lightly Obscured.** Mist perpetually shrouds outdoor areas, rendering them "lightly obscured".  
- **Muddled Magic.** Creatures and objects within 1 mile of Mount Ironrot can't be perceived through magical scrying sensors. Spells or magical effects that would reveal a creature's or object's location fail while that creature or object is within 1 mile of the mountain. The third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) points only to Mount Ironrot without precision.  
...
> [!gallery]
> ![Map 4.1: Mount Ironrot Outskirts](/compendium/adventures/vecna-eve-of-ruin/img/063-map-4-01-mount-ironrot-outskirts.webp#gallery)
> ![Player Version](/compendium/adventures/vecna-eve-of-ruin/img/064-map-4-01-mount-ironrot-outskirts-player.webp#gallery)
...
A [Detect Magic](/compendium/spells/detect-magic.md) spell reveals an aura of conjuration magic emanating from the oval. This oval served as a conduit for powerful teleportation magic in Cyre, but the Day of Mourning rendered its magic unstable. The oval serves as a portal to Sigil while the characters carry the second piece of the rod.

If a creature tries to teleport to the Mournland using a [Teleport](/compendium/spells/teleport.md) spell, a [Plane Shift](/compendium/spells/plane-shift.md) spell, or similar magic, the spell's caster must make a DC 15 Constitution saving throw. On a failed save, the spell fails and has no effect. On a successful save, the spell works, but teleported creatures arrive in an empty space near this oval, regardless of their intended destination in the Mournland.
...
This unusually large colossus contains the third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md). Landro is described later in this chapter.
...
![](/compendium/adventures/vecna-eve-of-ruin/img/065-04-011-kalyth.webp#center)
...
A character who searches the area and succeeds on a DC 14 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check spots a loose brick among the bridge's remains. Behind the brick are a [Potion of Healing (greater)](/compendium/items/potion-of-greater-healing.md) and a moldy hunk of bread—part of the veterans' provisions.
...
From this base, pilgrims venture out to find relics or lost warforged. At such times, `dice:2d4|noform|noparens|avg` (`2d4`) pilgrims (use the [warforged warrior](/compendium/bestiary/construct/warforged-warrior-veor.md) stat block in appendix A) remain in Ialos to guard the mill or patrol its surroundings. When no expedition is underway, thirteen pilgrims (including their leader, Mercy, who also uses the [warforged warrior](/compendium/bestiary/construct/warforged-warrior-veor.md) stat block) occupy Ialos. The pilgrims defend their home against attackers, but they flee when they're outmatched.

The following locations are keyed to map 4.2:

> [!gallery]
> ![Map 4.2: Ialos](/compendium/adventures/vecna-eve-of-ruin/img/066-4-02-ialos.webp#gallery)
> ![Player Version](/compendium/adventures/vecna-eve-of-ruin/img/067-4-02-ialos-player.webp#gallery)
...
- **Docents.** Half a dozen metal orbs line one shelf, but only one is a functional Docent (see the "Docent" section later in this chapter). These items were taken from the area's ruined colossi. A character can touch a piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) to the working Docent to determine the location of the third piece (see the "Finding a Docent" section later in this chapter).  
- **Magic Ring.** An iron ring etched with angelic feathers hangs from a silver chain on the wall. This is a [Ring of Feather Falling](/compendium/items/ring-of-feather-falling.md).  
...
The characters spot a band of five bipeds walking single file across a distant ridge. These are warforged pilgrims. Each uses the [warforged warrior](/compendium/bestiary/construct/warforged-warrior-veor.md) stat block (see appendix A).
...
![Mercy](/compendium/adventures/vecna-eve-of-ruin/img/068-04-013-mercy.webp#center)
...
As they pass between scorched thickets, the characters are ambushed by violent followers of a bloodthirsty warmonger called the Lord of Blades. These scouts have orders to search the region for a suitable colossus to turn into a new outpost, but they'll happily make time to slay a few people in their way. The scouting party includes two [blade scouts](/compendium/bestiary/construct/blade-scout-veor.md) and one [blade lieutenant](/compendium/bestiary/construct/blade-lieutenant-veor.md) (see appendix A for both stat blocks).

The blades fight until destroyed. They remain tight-lipped if captured, but if a character demands information and succeeds on a DC 15 Charisma ([Intimidation](/compendium/rules/skills.md#Intimidation)) check, the lieutenant says his party's commander is a powerful warforged headhunter named Glaive. "She'll make mincemeat out of you, interlopers!" the lieutenant scoffs. The blades can point the party to ruined colossi in the area but otherwise have no useful information.

![Warforged try to survive i...](/compendium/adventures/vecna-eve-of-ruin/img/069-04-003-mount-ironrot.webp#center "Warforged try to survive in the blasted wilderness around Mount Ironrot")

## Finding a Docent

The party's first task in the Mournland is to find a working Docent to which they can tune the second piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md). In the course of their exploration, they learn that the only operational *Docent* in the region is in a storeroom in Ialos.
...
If the resolution allows the warforged pilgrims to keep their *Docents* and no one is harmed in the dispute, once it's clear the characters are looking for a piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md), Mercy tells the characters the following about Landro's unique power source:
...
Regardless of which side, if any, the characters take in this conflict, the characters must pair the second piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) to the working Docent in Ialos to continue the adventure. (A character need not be attuned to the *Docent* to pair the *Docent* to the rod piece.)
...
![A Docent](/compendium/adventures/vecna-eve-of-ruin/img/070-04-004-docent.webp#center)
...
Whenever you end your turn with 0 hit points, the Docent can make a Wisdom ([Medicine](/compendium/rules/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the Docent stabilizes you.
...
- **Skills.** The Docent has a +7 bonus to ability checks using one of the following skills (roll a `dice:d4|noform|noparens|avg` (`d4`)): (1) [Arcana](/compendium/rules/skills.md#Arcana), (2) [History](/compendium/rules/skills.md#History), (3) [Investigation](/compendium/rules/skills.md#Investigation), or (4) [Nature](/compendium/rules/skills.md#Nature).  
- **Spells.** The Docent knows one of the following spells and can cast it at will, requiring no spell components (roll a `dice:d6|noform|noparens|avg` (`d6`)): (1–2) [Detect Evil and Good](/compendium/spells/detect-evil-and-good.md) or (3–6) [Detect Magic](/compendium/spells/detect-magic.md). The Docent decides when to cast the spell.  
...
The easiest way to enter the colossus is through the mountain caves that lead to area L5. The characters can also search higher up the mountain along outdoor paths for the entrances to caverns that lead to areas L11 and L16. Searching for area L11 takes `dice:2d4|noform|noparens|avg` (`2d4`) hours, and during the characters' search, a hungry [roc](/compendium/bestiary/monstrosity/roc.md) ambushes them. Searching for area L16 takes `dice:3d4|noform|noparens|avg` (`3d4`) hours, and during the characters' search, they stumble on a nest with two [rocs](/compendium/bestiary/monstrosity/roc.md) and one roc egg the height of a human. The angry roc parents attack the characters, though the rocs don't pursue if the characters flee.
...
The piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md) linked to the graymatter engine creates special gravity-altering effects in parts of Landro. The areas affected by these effects are denoted on map 4.3 as the swirled features in areas L5, L6, L7, L8, and L9. These have the following effects:

- **Antigravity Wells.** Landro's ankles, legs, knees, hips, spine, and elbow are filled with magical energy meant to allow the colossus's body to bend and rotate freely. Creatures and objects can enter and exit these permeable "antigravity wells" like any normal space. While inside an antigravity well, a creature is affected by a [Levitate](/compendium/spells/levitate.md) spell (no saving throw). Regular notches in the walls make it relatively easy for creatures to move up or down a well to reach other areas of the colossus.  
...
- **Psychic Damage.** For each ounce of graymatter fluid consumed, the creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage. A creature killed by this damage rises as a [zombie](/compendium/bestiary/undead/zombie.md) `dice:1d4|noform|noparens|avg` (`d4`) hours after dying.  

#### Invisible Barrier

The graymatter engine creates an invisible barrier around the intact parts of Landro. Nothing can penetrate the barrier, which is similar to the effect of a [Wall of Force](/compendium/spells/wall-of-force.md) spell, though a [Disintegrate](/compendium/spells/disintegrate.md) spell can't destroy it. The barrier is broken in compromised sections of Landro (areas L5, L11, and L16).
...
> [!gallery]
> ![Map 4.3: Landro](/compendium/adventures/vecna-eve-of-ruin/img/072-4-03-landro.webp#gallery)
> ![Player Version](/compendium/adventures/vecna-eve-of-ruin/img/073-4-03-landro-player.webp#gallery)
...
A character who examines the area and succeeds on a DC 12 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check notices a thick layer of powdery residue has settled across the scene, suggesting the remains have possibly been here for years. Anyone who examined the thin, gray liquid in the cave entrance realizes that the white powder is residue from this liquid.

The corpses are Cyran soldiers who were instantly killed by mysterious magic on the Day of Mourning. The Mournland's magic has preserved their bodies, which a character can determine by examining the corpses and succeeding on a DC 15 Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) or Wisdom ([Medicine](/compendium/rules/skills.md#Medicine)) check.

If a creature picks up the armor or weapons, two [flying swords](/compendium/bestiary/construct/flying-sword.md) and two suits of [animated armor](/compendium/bestiary/construct/animated-armor.md) rise from the scattered gear to reclaim the stolen treasure. They attack the thief and the thief's allies, but they don't pursue foes outside this area.
...
Regardless of whether the characters fight the strike squad, if they search this area, they find a comatose [warforged warrior](/compendium/bestiary/construct/warforged-warrior-veor.md) (see appendix A) in the northeast corner of this area. A character who tries to rouse the warrior and succeeds at a DC 18 Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check wakes the warrior, who identifies themself as Filch. Filch wandered in here shortly after the Day of Mourning looking for their best friend, the warforged Mercy (see the "Warforged Pilgrims" section earlier in this chapter). The stress of the situation caused Filch's comatose state. Mercy and Filch would be happy to be reunited.

![Filch](/compendium/adventures/vecna-eve-of-ruin/img/074-04-010-filch.webp#center)
...
Within the mushroom patch are two [shriekers](/compendium/bestiary/plant/shrieker.md). The shriekers' high-pitched screams might attract the Brelish soldiers from area L3 or alert one of Glaive's scouts to the characters' location.
...
A weapon rack on the wall opposite Landro's spine contains two [halberds](/compendium/items/halberd.md) and one [hand crossbow](/compendium/items/hand-crossbow.md) with a case of 20 [bolts](/compendium/items/crossbow-bolts-20.md).
...
The ceiling here is 20 feet high. Any characters proficient in [tinker's tools](/compendium/items/tinkers-tools.md) or [woodcarver's tools](/compendium/items/woodcarvers-tools.md) can assemble a set of either tools from the items in this room with 1 minute of work.
...
The lawful good [ghost](/compendium/bestiary/undead/ghost.md), who says its name is Chandry, pleads with the characters to help it reunite with its comrades inside Landro.
...
![A strange pool found insid...](/compendium/adventures/vecna-eve-of-ruin/img/075-04-006-dragonshard-pool.webp#center "A strange pool found inside Landro has magical effects on items dipped into it")
...
A suit of [chain mail](/compendium/items/chain-mail.md), two [shortswords](/compendium/items/shortsword.md), and a [mace](/compendium/items/mace.md) lie on the floor. All are twisted and malformed, as if they were affected by a roll of 3 or 4 on the Dragonshard Pool Effects table.
...
The monster dwelling here is a [blazebear](/compendium/bestiary/monstrosity/blazebear-veor.md) (see appendix A). It attacks any creature it sees and fights until destroyed.
...
Assuming they haven't both been defeated, one of Glaive's [blade scouts](/compendium/bestiary/construct/blade-scout-veor.md) (see appendix A) hides on the overhang here while the other scout hides down the eastern tunnel, near area L16. When the characters are within range, the scouts fire their crossbows at a random character.
...
Without the aid of antigravity magic, a creature can climb the notched walls inside the shaft only by succeeding on a DC 12 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check. From this area, the shaft stretches up 100 feet before terminating at the roof of Landro's head (area L28).

#### L19: Muster Point

Three Cyran soldiers in full regalia stand diligently at the arrow slits in this 30-foot-tall gathering hall. When they become aware of the characters, the soldiers turn to the party, revealing ghostly, screaming skulls instead of faces. The soldiers are three hostile [wights](/compendium/bestiary/undead/wight.md). Three [will-o'-wisps](/compendium/bestiary/undead/will-o-wisp.md), previously [invisible](/compendium/rules/conditions.md#Invisible), appear at the start of combat and fight alongside the wights.
...
The table is a magically animated servant (use the [stone golem](/compendium/bestiary/construct/stone-golem.md) stat block). It is designed to defend Landro from enemy boarders. As soon as a creature disturbs the table's contents, the table reveals its true nature and attacks.
...
The chest is a [mimic](/compendium/bestiary/monstrosity/mimic.md) in disguise. As soon as a creature touches it, the mimic attacks. Once it has grappled a creature, the mimic attempts to drag its victim outside so it can drop the victim off the edge of the walkway (area L22). Creatures that fall take `dice:13d6|noform|noparens|avg|text(45)` (`13d6`) bludgeoning damage.
...
As soon as a character is halfway up this area, Glaive activates the weapon, which ejects a jet of water in a 60-foot line. Any creature in this line must succeed on a DC 15 Dexterity saving throw or take `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) bludgeoning damage and fall down to area L18, landing with the [prone](/compendium/rules/conditions.md#Prone) condition.

Glaive compromised the weapons system when she moved it; once fired, it breaks, losing its magic.

#### L27: Weapons System

![Glaive and her subordinate...](/compendium/adventures/vecna-eve-of-ruin/img/076-04-007-glaive-and-subordinates.webp#center "Glaive and her subordinates might confront the heroes inside Landro's weapons systems room")
...
In this 15-foot-tall room, which is effectively Landro's mouth, [Glaive](/compendium/bestiary/npc/glaive-veor.md) makes her final stand against the characters if she has survived this long. Her [blade scouts](/compendium/bestiary/construct/blade-scout-veor.md) (see appendix A), Rack and Crunch, fight alongside her if they're still alive.
...
This chamber contains false walls made of thin metal plates. A character investigating the walls can tell that they are hollow by succeeding on a DC 17 Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check. Behind these walls stand four defense sentinels bound to the graymatter engine (each uses the [shield guardian](/compendium/bestiary/construct/shield-guardian.md) stat block but is Medium instead of Large).
...
As long as the graymatter engine is active, the rod piece floating above the engine's ceramic shell is held in place with powerful magic. As an action, a creature can try to remove the piece. A creature that touches the piece must make a DC 15 Wisdom saving throw. On a failed save, the creature takes `dice:2d10|noform|noparens|avg|text(11)` (`2d10`) psychic damage, and the piece doesn't move. On a successful save, the creature takes half as much damage but is able to grab and move the piece freely. Successfully casting [Dispel Magic](/compendium/spells/dispel-magic.md) (DC 14) on the piece suppresses the magic for 1 minute, during which time the piece can be touched and removed without requiring creatures to make a saving throw.

When the piece is removed, the four defense sentinels attack the characters, and Landro's shutdown sequence begins (see the "Shutdown Sequence" section below). For more about the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md), see this book's introduction.

### Graymatter Guardian

![The graymatter engine serv...](/compendium/adventures/vecna-eve-of-ruin/img/077-04-008-graymatter-engine.webp#center "The graymatter engine serves as Landro's brain, though it can't control the colossus's mechanical systems")
...
The animated fluid takes the shape of a tall, lithe humanoid and introduces itself as Landro. This neutral-aligned being uses the [water elemental](/compendium/bestiary/elemental/water-elemental.md) stat block, except it has telepathy out to 30 feet.
...
![Landro](/compendium/adventures/vecna-eve-of-ruin/img/078-04-012-landro.webp#center)
...
![Elemental Gem (Emerald)](/compendium/adventures/vecna-eve-of-ruin/img/079-04-009-emerald-elemental-gem.webp#center)
...
When an id crystal touches the graymatter engine, the graymatter engine's consciousness is transferred to the crystal, which becomes an [Elemental Gem (emerald)](/compendium/items/elemental-gem-emerald.md).
...
Once they've acquired the third piece of the [Rod of Seven Parts](/compendium/items/rod-of-seven-parts-veor.md), the characters can return to the oval portal on Mount Ironrot's outskirts. Stepping through the portal returns the characters to the sanctum in Sigil.