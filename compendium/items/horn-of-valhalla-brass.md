...
A brass horn summons `dice:3d4+3|noform|avg` (`3d4 + 3`) [berserkers](compendium/bestiary/humanoid/berserker.md). To use the brass horn, you must be proficient with all simple weapons.
