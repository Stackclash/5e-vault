...
The harp creates a magical breath of fire. Each creature in a 30-foot cone, originating from the harp, must make a Dexterity saving throw. A creature takes `dice:8d6|noform|avg` (`8d6`) fire damage on a failed save, or half as much damage on a successful one. A creature that's [frightened](/compendium/rules/conditions.md#Frightened) of you makes the saving throw with disadvantage.
