...
Any creature other than you in the cylinder when it appears must make a DC 13 Strength saving throw. On a failed save, a creature takes `dice:4d6|noform|noparens|avg` (`4d6`) bludgeoning damage and is pushed away from you to the nearest unoccupied space outside of the cylinder. On a successful save, a creature takes half as much damage and isn't pushed.
