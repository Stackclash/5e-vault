...
Saint Markovia's thighbone has the properties of a mace of disruption. If it scores one or more hits against a [vampire](compendium/bestiary/undead/vampire.md) or a [vampire spawn](compendium/bestiary/undead/vampire-spawn.md) in the course of a single battle, the thighbone crumbles into dust once the battle concludes.
