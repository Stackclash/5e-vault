...
When you hit a target with this weapon while it has at least 1 projection, the ghostly projections become razor sharp. Targets hit by the sword take an extra `dice:1d4|noform|avg` (`1d4`) slashing damage for each projection the sword has.
