...
A creature remains cursed in this way until targeted by a [wish](/compendium/spells/wish.md) spell or divine intervention. Removing the crown fails to end the curse. While a cursed creature may not reveal that the diadem is cursed, its allies may be able to deduce its presence and effects based on the creature's behavior.
