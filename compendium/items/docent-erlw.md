...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `dice: d4|avg` (`d4`)): (1) [Arcana](/compendium/rules/skills.md#Arcana), (2) [History](/compendium/rules/skills.md#History), (3) [Investigation](/compendium/rules/skills.md#Investigation), or (4) [Nature](/compendium/rules/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `dice: d6|avg` (`d6`)): (1–2) [detect evil and good](compendium/spells/detect-evil-and-good.md) or (3–6) [detect magic](compendium/spells/detect-magic.md). The docent decides when to cast the spell.
