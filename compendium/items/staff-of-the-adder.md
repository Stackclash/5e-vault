...
![](/compendium/items/img/staff-of-the-adder.webp#right)  
...
You can make a melee attack using the snake head, which has a reach of 5 feet. Your proficiency bonus applies to the attack roll. On a hit, the target takes `dice:1d6|noform|noparens|avg` (`d6`) piercing damage and must succeed on a DC 15 Constitution saving throw or take `dice:3d6|noform|noparens|avg` (`3d6`) poison damage.
