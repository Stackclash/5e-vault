...
Anything brought into the demiplane is shunted back to the original room when the mirror is removed from the wall. While the painting remains, it is indistinguishable from a regular painting. A successful DC 15 Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) or Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check can reveal the true nature of the painting, but not what command words are required to use it.
