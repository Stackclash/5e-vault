...
This warm ushanka bears the symbol of a clan of winter wolves, made as a gift to a hunter who aided them against an invasion of giants. While wearing the hat, you gain resistance to cold damage. In addition, you have advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks that rely on hearing or smell and on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks made to hide in snowy terrain. You can speak and understand Winter Wolf, and you have advantage on Charisma checks made to interact with winter wolves.

## Summon Winter Wolf

This hat is bound to a celestial spirit loyal to the winter wolf clan. While wearing the hat, you can cast the [find steed](/compendium/spells/find-steed.md) spell with the following changes:

The spirit assumes the form of a [winter wolf](/compendium/bestiary/monstrosity/winter-wolf.md) and its creature type is always celestial.
