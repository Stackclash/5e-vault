...
While wearing this cloak, you have advantage on ability checks made to escape from a [grapple](/compendium/rules/actions.md#Grapple). Whenever you make an ability check to escape a grapple or free yourself from restraints, the creature or object holding you takes `dice:1d10|noform|noparens|avg` (`d10`) piercing damage as the cloak's fabric magically splits into a toothed maw to bite it.
