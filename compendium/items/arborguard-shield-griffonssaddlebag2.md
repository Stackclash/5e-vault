...
The wall lasts as long as you concentrate (as if concentrating on a spell), to a maximum of 1 minute, or until it's dispelled by a [dispel magic](compendium/spells/dispel-magic.md) spell of 6th-level or higher, or until you are no longer holding the shield. Once this property of the shield has been used, it can't be used again until the next dawn.
