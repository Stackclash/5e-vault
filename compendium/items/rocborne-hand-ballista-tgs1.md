...
This massive, beast-hunting crossbow is carried with its two handles from above instead of by being held from below. You gain a +1 bonus to attack and damage rolls made with this magic weapon. This crossbow uses twice the normal amount of ammunition each time you fire it and deals an extra `dice:1d10|noform|noparens|avg` (`d10`) piercing damage to any target it hits. The weapon emits a [roc](/compendium/bestiary/monstrosity/roc.md)-like screech that's audible out to 100 feet each time it's fired.
