...
The staff has 15 charges for the following properties and regains `dice:2d6+3|noform|noparens|avg` (`2d6 + 3`) expended charges daily at dusk. If you expend the last charge, roll a `dice:d20|noform|noparens|avg` (`d20`). On a 1, the staff disintegrates in a plume of pitch black smoke and emits a terrifying scream audible out to 300 feet.
