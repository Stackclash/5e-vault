...
The caterpillar is considered a magical object and is not a creature. It has AC 10, 15 hit points, and has resistance to all damage types. If the [mending](compendium/spells/mending.md) spell is cast on the caterpillar while it has at least 1 hit point, it regains `dice:2d6|noform|avg` (`2d6`) hit points. If the caterpillar drops to 0 hit points, it can't be used again for 24 hours, at which point it regains all its hit points.
