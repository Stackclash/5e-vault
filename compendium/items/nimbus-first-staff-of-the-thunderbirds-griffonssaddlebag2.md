...
---
# Nimbus, First Staff of the Thunderbirds
*Staff, weapon ([quarterstaff](/compendium/items/quarterstaff.md)), spellcasting focus, major, artifact (requires attunement)*  
...
- The staff can be used as a [broom of flying](/compendium/items/broom-of-flying.md).  
- *(Prerequisite: 5th level)* While holding the staff, you can use a bonus action to cast the [shillelagh](/compendium/spells/shillelagh.md) spell with it.  
- *(Prerequisite: 5th level druid or ranger)* The staff gains 8 charges and regains `dice:1d6+2|noform|noparens|avg` (`1d6 + 2`) expended charges daily at dawn. While holding it, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC: [create or destroy water](/compendium/spells/create-or-destroy-water.md) (1 charge), [fog cloud](/compendium/spells/fog-cloud.md) (1 charge), [misty step](/compendium/spells/misty-step.md) (2 charges), [sleet storm](/compendium/spells/sleet-storm.md) (3 charges), or [thunderwave](/compendium/spells/thunderwave.md) (2nd-level version, 2 charges). If you activate another property that causes the staff to gain charges, the total number of charges and regained charges are cumulative.  
