...
If a [solar](/compendium/bestiary/celestial/solar.md) tears the book in two, the book is destroyed for `dice:1d100|noform|noparens|avg` (`d100`) years, after which it reforms in some dark corner of the multiverse.
