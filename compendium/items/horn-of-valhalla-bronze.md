...
A bronze horn summons `dice:4d4+4|noform|noparens|avg` (`4d4 + 4`) [berserkers](/compendium/bestiary/humanoid/berserker.md). To use the bronze horn, you must be proficient with medium armor.
