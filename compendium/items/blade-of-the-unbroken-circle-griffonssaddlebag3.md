...
While holding the sword, you can use an action to expend some of its charges to cast one of the following spells from it (save DC 17): [barkskin](compendium/spells/barkskin.md) (2 charges), [plant growth](compendium/spells/plant-growth.md) (3 charges), [regenerate](compendium/spells/regenerate.md) (7 charges), [tree stride](compendium/spells/tree-stride.md) (5 charges), or [wall of thorns](compendium/spells/wall-of-thorns.md) (6 charges). If you're a druid, this version of the [barkskin](compendium/spells/barkskin.md) spell prevents your AC from being less than 18, instead of 16.
