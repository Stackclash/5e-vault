...
The saucepan also functions as a [mace](/compendium/items/mace.md), granting you a +1 bonus to attack and damage rolls made with it. The saucepan deals an extra `dice:1d4|noform|noparens|avg` (`d4`) thunder damage to any target it hits that's either wearing metal armor or made of metal or stone.
