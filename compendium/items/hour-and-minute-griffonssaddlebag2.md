...
---
# Hour and Minute
*Melee weapon ([dagger](/compendium/items/dagger.md)), major, very rare (requires attunement)*  
...
If you attune to one of the weapons while another creature is attuned to the other, you are each aware of the other creature's attunement and must make an Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) check contested by the other creature's Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) check. The creature that wins the contest remains attuned to the item, and for the next 24 hours, its attunement cannot be broken by another creature attempting to attune to the other weapon. The creature that loses the contest is no longer attuned to the weapon.
...
- When you roll a 20 on an attack roll using Hour (the [dagger](/compendium/items/dagger.md)) against a creature, that creature is subjected to the effect of the [slow](/compendium/spells/slow.md) spell until the end of your next turn.  
- When you roll a 20 on an attack roll using Minute (the [shortsword](/compendium/items/shortsword.md)), you gain the effect of the [haste](/compendium/spells/haste.md) spell until the start of your next turn. When the effect ends, you don't suffer the normal effects of the spell ending.  
