...
In addition, while holding the staff, you can use an action to summon a flock of spectral sheep. The sheep run in a line 20 feet long and 10 feet wide originating from you before disappearing. Each creature of your choice in the area must make a Wisdom saving throw against your spell save DC, taking `dice:2d6|noform|noparens|avg` (`2d6`) psychic damage on a failed save, or half as much damage on a successful one. If a creature fails the saving throw and has 20 hit points or fewer after taking this damage, it also falls asleep. Undead and creatures immune to being charmed can't be put to sleep in this way. A sleeping creature is [unconscious](/compendium/rules/conditions.md#Unconscious) and stays asleep for 1 minute, until it takes damage, or until someone uses an action to shake or slap the creature awake. Once this property of the staff has been used, it can't be used again until the next dawn. 
