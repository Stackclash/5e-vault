...
This scroll has been carelessly flattened, folded, and scrawled on with childlike scribbles. In doing so, some of its original scripts and diagrams have been covered or replaced, and a large anvil has been proudly drawn at its center. A creature investigating the scroll can make a DC 15 Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) check. On a success, it determines that, while the scroll's original spell is no longer usable, its magic has merely been changed.
