...
While wearing the apron, you gain a +5 bonus to any ability check made using a set of [painter's supplies](compendium/items/painters-supplies.md). Using the apron's paints and your hands, the muralist's mark can be used on its own as a set of [painter's supplies](compendium/items/painters-supplies.md).
