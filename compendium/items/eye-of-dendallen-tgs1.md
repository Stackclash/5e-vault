...
While you're attuned to this item, you can cast the [see invisibility](/compendium/spells/see-invisibility.md) spell at will.
...
You can see normally through the eye of Dendallen while it's in your socket. In addition, you have [darkvision](/compendium/rules/senses.md#Darkvision) out to a range of 60 feet. If you already had darkvision, the eye increases its range by 30 feet. As a bonus action, you can concentrate on looking through the eye to peer through magical darkness in this way for 1 minute. Once this property of the eye has been used, it can't be used again until the following dusk.

## Dendallen Familiar

The eye also doubles as a gruesome familiar. As an action, you can command the eye to crawl out of your eye socket and move independently of you. Use the abilities described in the [find familiar](/compendium/spells/find-familiar.md) spell when commanding the eye of Dendallen. The eye is undead, has 5 hit points, an AC of 12, a walking and climbing speed of 20 feet, does not require air to breathe, has darkvision out to a range of 60 feet, and has a +6 bonus to Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks. If the eye is slain or you dismiss it, it reappears inside your open eye socket with a sickly sound. The eyeball appears pitch black if it's slain and loses this feature as well as its benefits to your vision until the following dusk.

Unattuning to the eye or targeting it with the [remove curse](/compendium/spells/remove-curse.md) spell causes it to pull itself out of the socket and try to escape. Slaying the eye while it is unattuned to a creature destroys the item.
