...
---
# Hammer of the Eternal Quake
*Weapon ([warhammer](compendium/items/warhammer.md)), legendary (requires attunement)*  
...
In addition, while holding this hammer you may use the [Attack](/compendium/rules/actions.md#Attack) action to slam its head into the ground, creating a shockwave that forces all targets within 30 feet of you to succeed on a DC 20 Dexterity saving throw or be knocked [prone](/compendium/rules/conditions.md#Prone). If you are able to make multiple attacks with the [Attack](/compendium/rules/actions.md#Attack) action, this attack replaces one of them.
