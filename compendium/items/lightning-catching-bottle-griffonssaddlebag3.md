...
While holding the bottle, you can use an action to unstopper it and release the trapped lightning inside, duplicating the effect of the [lightning bolt](/compendium/spells/lightning-bolt.md) spell (save DC 15) with the following changes:
