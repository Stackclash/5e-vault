...
Once the broom has been used to sweep for the third time in this way, it can't do so again until `dice:1d4-1|noform|noparens|avg` (`1d4 - 1`) days have passed. If you roll a 1 on the `dice:d4|noform|noparens|avg` (`d4`), the broom regains all uses of this property and can be used again immediately.

A trap, for the purpose of this item, includes anything that would inflict a sudden or unexpected effect you consider harmful or undesirable, which was specifically intended as such by its creator. Thus, the item would sense an area affected by the [alarm](/compendium/spells/alarm.md) spell, a glyph of warding, or a mechanical pit trap, but it would not reveal a natural weakness in the floor, an unstable ceiling, or a hidden sinkhole.
