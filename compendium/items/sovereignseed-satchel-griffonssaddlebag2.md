...
| dice: d6 | Seed |
|----------|------|
| 1 | **Binding Bur.** You can throw this jagged bur as if it were a [dart](compendium/items/dart.md) or use it as a sling bullet. A Large or smaller creature hit by the bur must succeed on a DC 15 Strength saving throw or be [restrained](/compendium/rules/conditions.md#Restrained) by it for 1 minute, as the bur rapidly grows to form a series of entangling plants around it. A creature [restrained](/compendium/rules/conditions.md#Restrained) in this way can use its action to make a DC 15 Strength check, freeing itself on a success. The bur withers and is destroyed once a creature succeeds on the saving throw or is no longer [restrained](/compendium/rules/conditions.md#Restrained) by it. |
