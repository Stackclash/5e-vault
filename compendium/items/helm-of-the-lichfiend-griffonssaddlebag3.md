...
The [skeleton](/compendium/bestiary/undead/skeleton.md) deals an extra `dice:1d6|noform|noparens|avg` (`d6`) fire damage to any target it hits.

A creature that touches the skeleton or hits it with a melee attack while within 5 feet of it takes `dice:1d6|noform|noparens|avg` (`d6`) fire damage.
