...
- On a hit, roll `dice:10d10|noform|noparens|avg` (`10d10`). If the total is greater than the target's remaining number of hit points, the target falls asleep and is [unconscious](/compendium/rules/conditions.md#Unconscious) for 1 hour, until the sleeper takes damage, or someone uses an action to shake or slap the sleeper awake.  
