...
The head and spikes of this morningstar are made of covolt. Arcs of electricity snap between its spikes while you hold it. When you hit with an attack using this magic weapon, the target takes an extra `dice:1d6|noform|noparens|avg` (`d6`) lightning damage.
