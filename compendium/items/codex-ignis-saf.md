...
You are always protected by an invisible [fire shield](compendium/spells/fire-shield.md) spell. Whenever you take damage from a melee attack, your fire armor erupts in flame, revealing itself and dealing damage to the attacker in equal amount to the damage taken (instead of `dice:2d8|noform|avg` (`2d8`)).
