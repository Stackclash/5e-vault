...
While holding the rod, you can use an action to cast the [sunburst](/compendium/spells/sunburst.md) spell from it (save DC 16), centered on you. You take no damage from the spell when cast in this way, but are still [blinded](/compendium/rules/conditions.md#Blinded) if you fail the saving throw. Each time the rod is used to cast this spell, there is a 50 percent chance that the rod loses this property. When that happens, the rod no longer requires you to be attuned to it in order to use its properties.
