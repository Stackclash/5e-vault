...
The iron horn summons `dice: 5d4 + 5|avg` (`5d4 + 5`) [berserkers](compendium/bestiary/humanoid/berserker.md). To use the iron horn, you must be proficient with all martial weapons.
