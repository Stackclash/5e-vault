...
This staff has 10 charges and regains `dice:1d6+4|noform|noparens|avg` (`1d6 + 4`) expended charges daily at dawn. If you expend the last charge, roll a `dice:d20|noform|noparens|avg` (`d20`). On a 1, a [swarm of insects](/compendium/bestiary/beast/swarm-of-insects.md) consumes and destroys the staff, then disperses.
