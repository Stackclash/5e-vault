...
In the hands of one who is attuned to it, this scepter can be used as a [quarterstaff](/compendium/items/quarterstaff.md) that grants a +3 bonus to attack and damage rolls made with it. The scepter deals an extra `dice:2d6|noform|noparens|avg` (`2d6`) poison damage on a hit.
