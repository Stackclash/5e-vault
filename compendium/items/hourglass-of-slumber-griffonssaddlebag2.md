...
The hourglass has 3 charges and regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges daily at dusk. While holding it, you can expend 1 or more of the glass's charges to turn it over and cast the [sleep](/compendium/spells/sleep.md) spell from it. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend. This version of the spell has the following changes:
