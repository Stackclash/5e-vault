...
While holding the sphere, you can use an action to cast either the [haste](/compendium/spells/haste.md) or [slow](/compendium/spells/slow.md) spell (save DC 18, no concentration required) from it. Once the sphere has been used to cast a spell in this way, it can't be used to cast that spell again. When the sphere has been used to cast both of these spells, it loses this property.
