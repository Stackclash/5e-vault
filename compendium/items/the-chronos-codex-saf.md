...
The duplicate remains in this manifold of the timescape for `dice:4+1d4|noform|noparens|avg` (`4 + 1d4`) rounds, after which it returns to its own time. If it drops to 0 hit points, it automatically returns—[unconscious](/compendium/rules/conditions.md#Unconscious)—to its original manifold.
