...
Your link to a vehicle ends when the vehicle is destroyed. It ends early if you use an action to mentally sever the link, or if you perform the ritual again with a different vehicle. If the linked vehicle is destroyed, you also take `dice:3d10|noform|avg` (`3d10`) psychic damage before the link is severed.

## Spells

The staff has 10 charges. While holding the staff, you can use an action to expend 1 or more of its charges to cast one of the following spells from it: [animal messenger](compendium/spells/animal-messenger.md) (1 charge), floating disk (1 charge), [levitate](compendium/spells/levitate.md) (2 charges; save DC 15), [mending](compendium/spells/mending.md) (no charges), [rope trick](compendium/spells/rope-trick.md) (2 charges), [teleport](compendium/spells/teleport.md) (7 charges), or [water walk](compendium/spells/water-walk.md) (3 charges). This version of the [teleport](compendium/spells/teleport.md) spell targets only yourself, and the destination must be a location on the linked vehicle. The staff regains `dice:1d6+4|noform|avg` (`1d6 + 4`) expended charges daily at dawn. If you expend the last charge, roll a `dice:d20|noform|avg` (`d20`). On a 1, the staff loses this property.
