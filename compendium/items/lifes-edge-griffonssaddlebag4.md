...
---
# Life's Edge
*Weapon ([greatsword](compendium/items/greatsword.md)), legendary (requires attunement by a paladin)*  
...
When another creature that you can see within your aura magically regains hit points, you can use your reaction to spend any number of hit points from your Lay on Hands pool. The amount of hit points restored to the creature is reduced by that amount.

## Summon Preserver

You can use an action to spend 40 hit points from your Lay on Hands pool to cast the [guardian of faith](compendium/spells/guardian-of-faith.md) spell, which has the following changes. Whenever a friendly creature enters a space within 10 feet of the guardian or starts its turn there, it can choose to gain up to 20 temporary hit points. If you have 17 or more levels in the paladin class, the radius of this effect increases to 30 feet. When the combined number of hit points granted as temporary hit points or dealt as radiant damage reaches 60, the guardian vanishes.
