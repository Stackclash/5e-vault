...
- **5-6.** The shield converts some of the spell's energy into a burst of destructive force. Each creature within 30 feet of you must make a DC 15 Constitution saving throw, taking `dice:1d6|noform|noparens|avg` (`d6`) force damage per level of the spell on a failed save, or half as much damage on a successful one.  
