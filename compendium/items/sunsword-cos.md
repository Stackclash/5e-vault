...
---
# Sunsword
*Weapon ([longsword](/compendium/items/longsword.md)), legendary (requires attunement)*  
![](/compendium/items/img/sunsword.webp#right)  
...
The hilt, which is sentient, knows that it can never be reunited with its original crystal blade. It has, however, gained the properties of a [sun blade](/compendium/items/sun-blade.md):
...
- You gain a +2 bonus to attack and damage rolls made with this weapon, which deals radiant damage instead of slashing damage. When you hit an undead with it, that target takes an extra `dice:1d8|noform|noparens|avg` (`d8`) radiant damage.  
