...
When you make a Charisma ([Performance](/compendium/rules/skills.md#Performance)) check using the fiddle, you can expend 1 or more of its charges to add `dice:1d6|noform|avg` (`1d6`) to the check for each expended charge. If you're a bard, this bonus uses your Bardic Inspiration die instead, but doesn't expend any uses of your Bardic Inspiration feature.
