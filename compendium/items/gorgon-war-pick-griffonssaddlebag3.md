...
This war pick is made from the metal armor of a gorgon and designed in its visage. You gain a +2 bonus to attack and damage rolls made with this magic weapon. If you move at least 20 feet straight toward a target and then hit it with this weapon on the same turn, that target takes an extra `dice:1d6|noform|avg` (`1d6`) piercing damage from the attack. You can deal this extra damage only once per turn.
