...
When you successfully [shove](/compendium/rules/actions.md#Shove) a creature, using the shield to push it, that creature also takes `dice:1d6|noform|avg` (`1d6`) necrotic damage.
