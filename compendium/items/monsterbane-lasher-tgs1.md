...
This mithral whip was once used by a powerful monster hunter. You gain a +1 bonus to attack and damage rolls made with this magic weapon. In addition, targets hit by the whip take an extra `dice:1d4|noform|noparens|avg` (`d4`) slashing damage from its attacks.
