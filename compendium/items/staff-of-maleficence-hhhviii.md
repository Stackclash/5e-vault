...
You use the staff to cast any of the following spells using your spell save DC. Spells are cast at their lowest level, but you may increase their level by spending 1 extra charge per increased spell level: [charm person](compendium/spells/charm-person.md) (1 charge), [witch bolt](compendium/spells/witch-bolt.md) (1 charge), [hold person](compendium/spells/hold-person.md) (2 charges), [ray of enfeeblement](compendium/spells/ray-of-enfeeblement.md) (2 charges), [confusion](compendium/spells/confusion.md) (4 charges), [dominate person](compendium/spells/dominate-person.md) (5 charges), [geas](compendium/spells/geas.md) (5 charges), [circle of death](compendium/spells/circle-of-death.md) (6 charges), [disintegrate](compendium/spells/disintegrate.md) (6 charges), [feeblemind](compendium/spells/feeblemind.md) (8 charges).

## Paralysis

As an action, you expend 3 charges and slam this staff into the ground, releasing a shockwave of atrophic energy that interferes with the motor functions of all creatures around you. All creatures within 30 feet of you must succeed on a DC 20 Wisdom saving throw or be [paralyzed](/compendium/rules/conditions.md#Paralyzed) for 1 minute. A [paralyzed](/compendium/rules/conditions.md#Paralyzed) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. Undead and constructs are immune to this effect.

## Extend Dominion

As an action, you expend 4 charges and target one creature within 30 feet that you can see that is [charmed](/compendium/rules/conditions.md#Charmed) by you. Any elapsed duration of that [charm](/compendium/rules/conditions.md#Charmed) effect is reset as if that creature had just become [charmed](/compendium/rules/conditions.md#Charmed) by you. In addition, until that [charm](/compendium/rules/conditions.md#Charmed) effect ends, any saving throw that creature makes to end that [charm](/compendium/rules/conditions.md#Charmed) effect is made at disadvantage.
