...
As an action, one dose of the ointment can be swallowed or applied to the skin. The creature that receives it regains `dice:2d8+2|noform|noparens|avg` (`2d8 + 2`) hit points, ceases to be [poisoned](/compendium/rules/conditions.md#Poisoned), and is cured of any disease.
