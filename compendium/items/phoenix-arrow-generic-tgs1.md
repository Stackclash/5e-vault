...
This bolt or arrow is fletched with [phoenix](/compendium/bestiary/elemental/phoenix-mpmm.md) feathers and is magically bound to a small [quiver](/compendium/items/quiver.md). You have a +1 bonus to attack and damage rolls made with this piece of magic ammunition. Once fired, the ammunition bursts into flames upon impact and deals fire damage instead of piercing. At the start of your next turn, the arrow leaves behind a small pile of ash and reappears in its quiver.

You can speak the ammunition's command word as a bonus action before firing it to set it ablaze. If you fire it on that same turn, the arrow or bolt deals an extra `dice:1d6|noform|noparens|avg` (`d6`) fire damage to any target it hits, but turns to ash before reaching its target if fired at a target more than 30 feet away. The arrow reappears in its quiver immediately after making this attack.
