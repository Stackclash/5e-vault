...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/GriffonsSaddlebag3/Starmetal-Flail.webp#right)  
...
You gain a +2 bonus to attack and damage rolls made with this magic weapon, which also has the finesse property. Targets hit by the weapon take an extra `dice:1d6|noform|noparens|avg` (`d6`) fire damage, as the fire within it burns with meteoric heat.
