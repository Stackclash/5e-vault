...
Whenever you score a critical hit, roll a `dice:d6|noform|noparens|avg` (`d6`) on the Undead row of the [Servitors](/compendium/tables/servitors-saf.md) chart (page 31). A bell tolls and the rolled servitors burst from the ground. These undead fight for you and obey your commands. The undead turn to dust after 1 minute or if they drop to 0 hit points.
