...
- Your unarmed strikes deal an additional `dice: 1d6|avg` (`1d6`) lightning damage.  
...
If you are in living storm form while in an area under the effect of the [control weather](compendium/spells/control-weather.md) spell or similar magic, you instantly revert to your true form. Once this item's ability has been used once, it cannot be used again until the next dawn.
