...
---
# Armor of the Gnoll Lord
*Light armor ([studded leather armor](compendium/items/studded-leather-armor.md)), cursed item, artifact (requires attunement)*  
...
Using this armor, you may cast the [detect magic](compendium/spells/detect-magic.md) spell at will, and you may cast the [dispel magic](compendium/spells/dispel-magic.md), [fear](compendium/spells/fear.md), and [invisibility](compendium/spells/invisibility.md) spells up to 3 times each. All expended uses are restored after your next long rest.
...
Whenever a creature within 100 feet of you that you can see hits you with a weapon attack, you may use your reaction to cause an iron spike—6 feet tall and 1 inch in diameter—to burst from the ground beneath them. That creature must then succeed on a DC 18 Dexterity saving throw or be impaled upon this spike, taking `dice:4d8|noform|avg` (`4d8`) piercing damage and becoming [restrained](/compendium/rules/conditions.md#Restrained). A creature can use an action to remove itself (or a creature it can reach) from the spike, ending the [restrained](/compendium/rules/conditions.md#Restrained) condition. Spikes disappear at the start of your next turn if nothing is currently impaled on them.
