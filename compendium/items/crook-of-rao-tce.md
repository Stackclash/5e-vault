...
| 26-45 | `dice:2d4\|noform\|avg` (`2d4`) [imps](compendium/bestiary/fiend/imp.md) and `dice:2d4\|noform\|avg` (`2d4`) [quasits](compendium/bestiary/fiend/quasit.md) appear. |
| 46-60 | `dice:1d8\|noform\|avg` (`1d8`) [succubi](compendium/bestiary/fiend/succubus.md)/[incubi](compendium/bestiary/fiend/incubus.md) appear. |
| 61-70 | `dice:1d10\|noform\|avg` (`1d10`) [barbed devils](compendium/bestiary/fiend/barbed-devil.md) and `dice:1d10\|noform\|avg` (`1d10`) [vrocks](compendium/bestiary/fiend/vrock.md) appear. |
