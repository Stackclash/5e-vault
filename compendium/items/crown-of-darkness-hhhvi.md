...
The crown recovers `dice:1d8+1|noform|noparens|avg` (`1d8 + 1`) charges at midnight. While wearing and attuned to the crown, you also gain advantage on any Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks made to [hide](/compendium/rules/actions.md#Hide) in dim light or darkness, and [darkvision](/compendium/rules/senses.md#Darkvision) out to 60 ft.
