...
- If the wielder of this weapon moves at least 15 feet straight towards a target and then hits them with a melee weapon attack with this weapon, that target suffers an extra `dice: 4d8|avg` (`4d8`) bludgeoning damage and must succeed on a DC 21 Strength saving throw or be pushed up to 20 feet away and knocked [prone](/compendium/rules/conditions.md#prone).  
