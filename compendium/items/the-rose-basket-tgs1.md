...
As an action, you can speak the rapier's command word and touch its point to the ground at your feet. When you do, silver rosebushes sprout from the ground in a 25-foot square, centered on your location. The area becomes difficult terrain, and when a creature moves into or within the area, it takes `dice:2d4|noform|noparens|avg` (`2d4`) piercing damage for every 5 feet it travels. While holding this rapier, you can pass through this area as if it were normal terrain, and you don't take damage from moving within it. The rosebushes remain for 1 minute or until you dismiss them as a bonus action. Once this property has been used, it can't be used again until the next dawn.
