...
A creature that can see the sensor (such as a creature benefiting from see invisibility or [truesight](/compendium/rules/senses.md#Truesight)) sees a watchful owl. The sensor is considered to have a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 15 for the purposes of detecting a triggering creature or effect.
