...
The typical [Orostead iced tea](/compendium/items/orostead-iced-tea-griffonssaddlebag2.md), a common potion, is a specialty alcoholic beverage that creates harmless sensory effects with each sip. When made, a tea has enough for `dice:6+1d4|noform|noparens|avg` (`6 + 1d4`) sips before it's used up, instead of a single use. You can take a sip as an action. When you drink this potion, roll on the table below to determine which one of the following effects occur:
...
| 4 | You gain the effect of the [speak with animals](/compendium/spells/speak-with-animals.md) spell for 1 minute. |
