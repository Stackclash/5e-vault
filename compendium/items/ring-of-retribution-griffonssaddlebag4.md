...
As a bonus action, you can use your Channel Divinity to present the ring of retribution and cast the [protection from evil and good](compendium/spells/protection-from-evil-and-good.md) spell from it, targeting yourself only. For the duration, when a creature affected by the spell hits you with an attack, it automatically takes `dice:1d8|noform|avg` (`1d8`) radiant damage.
