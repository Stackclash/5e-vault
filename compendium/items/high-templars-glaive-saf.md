...
Whenever you score a critical hit, roll a `dice:d6|noform|avg` (`d6`) on the Court of Elements row of the [Servitors](compendium/tables/servitors-saf.md) chart (page 31). A tear opens to the elemental plane of Quintessence and the rolled servitor steps through. This servitor fights for you and obeys your commands. They return to Alloy, the Burning City, after 1 minute or if they drop to 0 hit points.
