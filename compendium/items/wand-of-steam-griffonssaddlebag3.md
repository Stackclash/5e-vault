...
The shaft of this wand is a clear glass tube filled with bubbling water. This wand has 3 charges and regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges daily at dawn. While holding the wand, you can use an action to expend 1 of its charges to cast the [fog cloud](/compendium/spells/fog-cloud.md) spell from it, which has the following changes:
