...
---
# Polaris Magistrate Gavel
*Weapon ([light hammer](/compendium/items/light-hammer.md)), major, rare (requires attunement by a lawful creature)*  
...
The gavel has 3 charges and regains all expended charges daily at dawn. As an action while holding the gavel, you can expend 1 of its charges to cast the [command](/compendium/spells/command.md) spell from it, or 2 charges to cast the [zone of truth](/compendium/spells/zone-of-truth.md) spell, using a spell save DC of 15. Alternatively, you can expend 2 charges to cast the [command](/compendium/spells/command.md) spell from the gavel at 2nd level.
