...
This pocket can be tied onto a belt or similarly worn as extra storage. On its own, the pocket can hold up to 6 cubic inches of total volume. However, if the pocket is left in an extradimensional space such as a [bag of holding](compendium/items/bag-of-holding.md) or handy haversack for at least one hour, it forms a magical connection to that space. You can reach into a magic pocket with such a connection using an action to access the extradimensional space, provided that the source of that space is within 60 feet of you.
