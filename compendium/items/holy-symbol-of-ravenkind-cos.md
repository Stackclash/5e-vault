...
![](/compendium/items/img/holy-symbol-of-ravenkind.webp#right)  
...
The holy symbol has 10 charges for the following properties. It regains `dice:1d6+4|noform|noparens|avg` (`1d6 + 4`) charges daily at dawn.

## Hold Vampires

As an action, you can expend 1 charge and present the holy symbol to make it flare with holy power. Vampires and [vampire spawn](/compendium/bestiary/undead/vampire-spawn.md) within 30 feet of the holy symbol when it flares must make a DC 15 Wisdom saving throw. On a failed save, a target is [paralyzed](/compendium/rules/conditions.md#Paralyzed) for 1 minute. It can repeat the saving throw at the end of its turns to end the effect on itself.
