...
When you drink this potion, you go slightly mad for the next `dice:1d4|noform|noparens|avg` (`d4`) hours. While in this state, you gain the ability to sense the presence of any creature within 30 feet of you that is [invisible](/compendium/rules/conditions.md#Invisible) or on the Ethereal Plane. You can pinpoint such a creature that is moving.
