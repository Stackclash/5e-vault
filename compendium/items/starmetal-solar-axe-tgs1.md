...
While wielding the fused greataxe, you gain a +1 bonus to attack and damage rolls made with this magic weapon. While you hold this axe, flames erupt from its edges and a small star burns in its center. These flames shed bright light in a 20-foot radius and dim light for an additional 20 feet. The light is sunlight. The greataxe deals an extra `dice:2d6|noform|noparens|avg` (`2d6`) fire damage to any target it hits.
