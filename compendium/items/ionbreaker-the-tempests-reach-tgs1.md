...
---
# Ionbreaker, the Tempest's Reach
*Weapon ([longbow](/compendium/items/longbow.md)), major, artifact (requires attunement)*  
...
This bow was crafted by a powerful [djinni](/compendium/bestiary/elemental/djinni.md) in the Stormheart: a perpetual maelstrom of wind and electricity in the Elemental Plane of Air. Lost to time, it has remained in the storm for untold centuries absorbing the volatile magic that runs rampant there. You gain a +3 bonus to attack and damage rolls made with this magic weapon.

## A Storm is Coming

While the bow is on your person, you add a `dice:d10|noform|noparens|avg` (`d10`) to your initiative at the start of every combat.

## Fast as Lightning

When you take the [Attack](/compendium/rules/actions.md#Attack) action, you can make one attack with the bow as a bonus action.
...
While you're attuned to the bow, you're subjected to the chaotic magic of the Stormheart whenever you take lightning damage. When you do, roll a `dice:d8|noform|noparens|avg` (`d8`) and use the table below to determine the resulting effect.
...
| 2 | You are thrown 20 feet in a random direction and knocked [prone](/compendium/rules/conditions.md#Prone). |
| 3 | You are [deafened](/compendium/rules/conditions.md#Deafened) for 1 hour. |
| 4 | You can't take reactions for 1 minute. |
| 5 | You cast [fog cloud](/compendium/spells/fog-cloud.md), centered on a point within 5 feet of you, without requiring concentration that remains for `dice:1d4\|noform\|noparens\|avg` (`d4`) rounds. |
