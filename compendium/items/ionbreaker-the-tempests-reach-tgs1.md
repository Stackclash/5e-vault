...
| 5 | You cast [fog cloud](compendium/spells/fog-cloud.md), centered on a point within 5 feet of you, without requiring concentration that remains for `dice:1d4\|noform\|avg` (`1d4`) rounds. |
