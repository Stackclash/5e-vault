...
You gain a +1 bonus to attack and damage rolls made with these magic weapons. Once per round, if both blades strike a single foe, they deal an extra `dice:1d6|noform|noparens|avg` (`d6`) fire damage.

When you score a critical hit with either blade, roll a `dice:d6|noform|noparens|avg` (`d6`) on the Devils row of the [Servitors](/compendium/tables/servitors-saf.md) chart (page 31). Flames burst from the ground and the rolled servitor appears. This servitor fights for you and obeys your commands. They return to Hell after 1 minute or if they drop to 0 hit points.
