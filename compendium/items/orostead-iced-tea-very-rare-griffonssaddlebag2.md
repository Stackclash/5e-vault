...
The following [Orostead iced tea](compendium/items/orostead-iced-tea-griffonssaddlebag2.md) is a very rare variant with additional properties. It also tastes better. When made, a tea has enough for `dice:6+1d4|noform|avg` (`6 + 1d4`) sips before it's used up, instead of a single use. You can take a sip as an action.
