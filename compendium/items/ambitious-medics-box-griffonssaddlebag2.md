...
The left side is locked by a metal clasp decorated with a sun. From dawn until dusk, you can open the left side of the box, which contains the same contents and functions identically to a [healer's kit](compendium/items/healers-kit.md). Each day at dusk, the left side of the box magically closes and regains all expended uses of its healer's kit.
...
While attuned to the box, you are proficient in the [Medicine](/compendium/rules/skills.md#Medicine) skill and can open either side of the box at any time. If you're already proficient in the [Medicine](/compendium/rules/skills.md#Medicine) skill, your proficiency bonus is doubled for any ability check you make that uses that skill.
