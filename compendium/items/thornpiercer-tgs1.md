...
The first creature hit by this weapon on each of your turns must make a DC 17 Constitution saving throw. On a failed save, a creature takes an extra `dice:1d6|noform|noparens|avg` (`d6`) poison damage and is [poisoned](/compendium/rules/conditions.md#Poisoned) until the end of its next turn.
