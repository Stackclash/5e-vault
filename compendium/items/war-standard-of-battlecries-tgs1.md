...
This standard has 4 charges and regains `dice:1d4|noform|noparens|avg` (`d4`) expended charges daily at dawn. If you're within 15 feet of the extended standard, you can use a bonus action to expend 1 of its charges to shout the command word, "Charge!" and immediately take the [Dash](/compendium/rules/actions.md#Dash) action (no action required). When you do, other allies within 15 feet of the standard can take the Dash action as a bonus action on their next turn.
