...
While holding the urn, you can use an action to speak its second command word to animate your body's shadow, transforming it into an undead creature. When you do, your body's shadow detaches from you and becomes a [shadow](/compendium/bestiary/undead/shadow.md) in an unoccupied space that you can see within 10 feet of you.

On your turn, you can mentally command the shadow if you aren't [incapacitated](/compendium/rules/conditions.md#Incapacitated). You decide what action the shadow takes and where it moves during its next turn, or you can issue it a general command, such as to attack your enemies or guard a location. The GM has the shadow's statistics. This shadow doesn't cause a new one to appear when a non-evil humanoid dies from its attacks.
