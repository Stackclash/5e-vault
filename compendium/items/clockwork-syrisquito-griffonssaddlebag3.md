...
The syrisquito has a glass vial at its end that holds up to one ounce of liquid. You can use an action to command the syrisquito to ingest a potion or poison you provide, such as a [potion of healing](/compendium/items/potion-of-healing.md) or basic poison, which is then stored in the attached vial. You can use another action to remove the glass vial from the syrisquito to retrieve its held contents or replace the vial.
