...
This half-mask remains securely on your face thanks to its full-width diadem, which extends from the mask around the rest of your brow. It functions as a [hat of disguise](/compendium/items/hat-of-disguise.md). When you use an action to cast the [disguise self](/compendium/spells/disguise-self.md) spell from the mask, you can choose to appear identical to another creature that you can see within 60 feet of you. When you do, you can appear up to 3 feet shorter or taller to match the target's height.

## Twin Sense

For the duration of this version of the spell, you gain the following benefits:
