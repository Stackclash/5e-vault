...
- While you remain motionless, you are indistinguishable from a puddle, unless an observer succeeds on a DC 18 Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check.  
- While underwater, you have advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks made to hide, and you can take the [Hide](/compendium/rules/actions.md#Hide) action as a bonus action.  
