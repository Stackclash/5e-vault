...
The pawn moves up to 5 feet, or 10 feet if it's the first round of combat, and attacks a target within the space. On a hit, the target takes `dice:2d8|noform|noparens|avg` (`2d8`) force damage and must succeed on a Strength saving throw or be knocked [prone](/compendium/rules/conditions.md#Prone). Alternatively, you can invoke the pawn as a reaction when a hostile creature's movement provokes an opportunity attack from you.
...
When you invoke the king, you cast [antilife shell](/compendium/spells/antilife-shell.md) from it. If you haven't expended the use of all your rooks, you can also expend one of their uses as part of the same action to teleport to an unoccupied space that you can see within 30 feet of you.
