...
- You have advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks you make that rely on hearing.  
...
- You can speak the earwig's command word as an action to cast the [comprehend languages](/compendium/spells/comprehend-languages.md) spell from it. The spell ends early if you remove the earwig. This property of the earwig can't be used again until the next dawn.  
