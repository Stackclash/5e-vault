...
You may also use the staff as a [quarterstaff](/compendium/items/quarterstaff.md) with a +2 bonus to attack and damage rolls. If you hit a creature with it, they must succeed on a DC 18 Wisdom saving throw or take an additional `dice:2d6|noform|noparens|avg` (`2d6`) psychic damage.
