...
- **1. Confusion Ray.** The target must succeed on a DC 13 Wisdom saving throw or become unable to take reactions until the end of its next turn. On its turn, the target can't move, and it uses its action to make a melee or ranged [attack](/compendium/rules/actions.md#attack) against a randomly determined creature within range. If the target can't attack, it does nothing on its turn.  
...
- **4. Wounding Ray.** The target must make a DC 13 Constitution saving throw, taking `dice: 3d10|avg` (`3d10`) necrotic damage on a failed save, or half as much damage on a successful one.  
