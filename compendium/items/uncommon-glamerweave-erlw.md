...
When you make a Charisma ([Performance](/compendium/rules/skills.md#Performance)) or Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check while wearing the glamerweave, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the check. Once you use this property, it can't be used again until the next dawn.
