...
---
# Thunderous Flail
*Weapon ([flail](/compendium/items/flail.md)), major, rare (requires attunement)*  
...
This flail has 3 charges and regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges each day at dawn. You can expend 1 charge to cast the [thunderwave](/compendium/spells/thunderwave.md) spell (save DC 15). The ball of the flail is the origin of the spell. As long as the flail has at least 1 charge, you deal an extra `dice:1d6|noform|noparens|avg` (`d6`) lightning damage to the first target you hit with it on each of your turns.
