...
This ammunition is weightless and whistles softly as it moves. This piece of ammunition can be fired at its long range without disadvantage and deals an extra `dice:1d6|noform|noparens|avg` (`d6`) thunder damage to any target it hits. In addition, any magical atmospheric effect that the arrow passes through cast at 3rd level or lower, such as a [fog cloud](/compendium/spells/fog-cloud.md) or [stinking cloud](/compendium/spells/stinking-cloud.md), is dispelled.
