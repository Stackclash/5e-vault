...
The snake has 2 hit points, like normal rope, although it has resistance to all damage. It has AC 11 and a speed of 30 feet; it can climb walls and objects that aren't smooth at half its normal speed. The snake also has [blindsight](/compendium/rules/senses.md#Blindsight) out to a range of 30 feet, is blind beyond that radius, can't attack, and has an escape DC of 10. If the rope is destroyed, whether it's animated or not, it becomes a normal length of nonmagical rope.
