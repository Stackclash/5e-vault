...
When you drink this potion, it cures any short-term madness afflicting you, and if you are [charmed](/compendium/rules/conditions.md#Charmed) or [frightened](/compendium/rules/conditions.md#Frightened), it ends those conditions. In addition, if you have 2 or more levels in the monk class, you regain `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) expended ki points.
