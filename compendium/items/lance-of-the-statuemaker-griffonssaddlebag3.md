...
---
# Lance of the Statuemaker
*Weapon ([lance](/compendium/items/lance.md)), major, very rare*  
...
When you reduce a creature to 0 hit points using the lance and choose to knock the creature out instead of killing it, you can leave the lance embedded within the creature as part of the attack. When you do, the target is [petrified](/compendium/rules/conditions.md#Petrified) until another creature uses an action to make a DC 30 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check to pull out the lance or frees it with a [greater restoration](/compendium/spells/greater-restoration.md) spell or similar magic, at which point the lance falls to the ground and can be used to make attacks again. Once a creature has been [petrified](/compendium/rules/conditions.md#Petrified) in this way, it can't be [petrified](/compendium/rules/conditions.md#Petrified) by the lance again until 7 days have passed.
