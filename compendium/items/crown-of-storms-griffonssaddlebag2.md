...
- You can use an action to cast the [thunderwave](/compendium/spells/thunderwave.md) spell (2nd-level version, save DC 17). The first time you cast this spell each time you take on the aspect, it's cast at 4th level instead.  
- When an attacker within 30 feet hits you with a weapon attack, you can use your reaction to send out a bolt of lightning at the attacker. The attacker must make a DC 17 Dexterity saving throw, taking `dice:1d10|noform|noparens|avg` (`d10`) lightning damage on a failed save, or half as much damage on a successful one. Each time the attacker hits you again before the end of this turn, it must repeat the saving throw.  
