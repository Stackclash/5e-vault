...
- You may cast any of the following spells through the item, requiring no components: [darkness](compendium/spells/darkness.md) (2 charges, plus 1 additional charge for every level cast above 2nd), [spider climb](compendium/spells/spider-climb.md) (2 charges), [pass without trace](compendium/spells/pass-without-trace.md) (2 charges) [darkvision](/compendium/rules/senses.md#darkvision) (2 charges).  
- For the next hour, you cannot become lost while travelling in the Underdark. You have advantage on any Wisdom ([Survival](/compendium/rules/skills.md#Survival)) check made to locate something in the Underdark (1 charge).  
- For the next hour, you gain a [tremorsense](/compendium/rules/senses.md#tremorsense) and [darkvision](/compendium/rules/senses.md#darkvision) out to a range of 60 feet (2 charges).  
