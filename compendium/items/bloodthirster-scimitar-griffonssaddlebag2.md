...
When you take the [Attack](/compendium/rules/actions.md#Attack) action while holding this sword, you can choose to forgo one of your attacks to sacrifice your own blood. When you do, you take `dice:1d6+3|noform|noparens|avg` (`1d6 + 3`) piercing damage from the sacrifice. This damage ignores resistance and immunity. This self-inflicted harm empowers the sword, granting you a cumulative +1 bonus to attack and damage rolls made with this magic weapon that lasts for 1 minute, up to a maximum bonus of +3. While the sword is empowered in this way, it deals an extra `dice:1d6|noform|noparens|avg` (`d6`) necrotic damage to any target it hits.
