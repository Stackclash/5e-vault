...
Typically carried by oni, a tengu fan functions as a [wind fan](/compendium/items/wind-fan.md) with the following changes:
...
When used to cast the [gust of wind](/compendium/spells/gust-of-wind.md) spell, razor-sharp leaves fill the line of wind. A creature that fails the saving throw against the wind at the start of its turn also takes `dice:2d4|noform|noparens|avg` (`2d4`) slashing damage from the sharp leaves. On a successful save, the creature instead takes half as much slashing damage.
