...
This weapon resembles the head of an ancient black dragon: its two horns curl behind its head to form the weapon's sharp pick. You gain a +2 bonus to attack and damage rolls made with this magic weapon, which deals an extra `dice:1d4|noform|noparens|avg` (`d4`) acid damage to any target it hits. This extra acid damage is doubled if the target is made of metal or is wearing metal armor.
