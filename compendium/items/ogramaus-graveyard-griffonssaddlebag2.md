...
The second command word duplicates the effect of the [animate dead](/compendium/spells/animate-dead.md) spell, using a corpse stored within the orb's demiplane as the target of the spell. A [skeleton](/compendium/bestiary/undead/skeleton.md) or [zombie](/compendium/bestiary/undead/zombie.md) created in this way appears in an unoccupied space that you can see within 15 feet of you and turns to dust and is destroyed after either 24 hours have passed or it drops to 0 hit points. If you speak this command word again to create a second skeleton or zombie while the first one remains, the first skeleton or zombie turns to dust and is destroyed when the new one appears.
