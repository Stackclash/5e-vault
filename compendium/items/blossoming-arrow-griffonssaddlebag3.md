...
A creature hit by this arrow takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) poison damage from the attack, or `dice:3d6|noform|noparens|avg` (`3d6`) if the creature is a plant, and must make a DC 15 Constitution saving throw. On a failed save, the creature is [poisoned](/compendium/rules/conditions.md#Poisoned) for 1 hour. A [poisoned](/compendium/rules/conditions.md#Poisoned) creature gains the plant type, in addition to its other creature types, for as long as it remains [poisoned](/compendium/rules/conditions.md#Poisoned). After the arrow deals this poison damage, it loses its magic.
