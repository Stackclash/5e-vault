...
| 6 | Your legs become unstable for `dice:1d6\|noform\|noparens\|avg` (`d6`) hours, during which time you have disadvantage on Dexterity checks and Dexterity saving throws, and if you move your full speed on a turn, you must succeed on a DC 16 Dexterity check or fall [prone](/compendium/rules/conditions.md#Prone). |
...
| 8 | You are under the effect of the [suggestion](/compendium/spells/suggestion.md) spell for `dice:1d6\|noform\|noparens\|avg` (`d6`) hours. If you are asked to do something that isn't harmful, accompanied by the word "please" or a similar phrase, you are compelled to obey. |
