...
---
# Eldritch Halberd
*Weapon ([halberd](/compendium/items/halberd.md)), cursed item, uncommon (requires attunement)*  
...
While you aren't missing any hit points, you can use an action to cast the [eldritch blast](/compendium/spells/eldritch-blast.md) cantrip from the weapon, using a spell attack bonus of +5. If you're a warlock and holding this weapon, you can always cast the spell from the weapon as if you were casting it. This version of eldritch blast fires beams of purple energy, which look like magical bats streaking through the air.

When you use this weapon to either make an attack or cast [eldritch blast](/compendium/spells/eldritch-blast.md) and roll a 10 on a damage die, the attack deals extra psychic damage equal to your Charisma modifier (a minimum of 0). You can deal this extra damage once per turn.
