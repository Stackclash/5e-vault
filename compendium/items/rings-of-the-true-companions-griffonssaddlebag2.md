...
**4 attuned wearers:** When you use the rings to cast [cure wounds](compendium/spells/cure-wounds.md) on another wearer, you also gain `dice:1d4+1|noform|avg` (`1d4 + 1`) temporary hit points for each charge you spend.  
