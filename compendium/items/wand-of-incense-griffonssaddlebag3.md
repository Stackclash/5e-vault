...
While holding the wand, you can use an action to expend 1 of its charges to cast one of the following spells from it, using a spell attack bonus of +7: [find familiar](/compendium/spells/find-familiar.md) (form of a pseudodragon), [fog cloud](/compendium/spells/fog-cloud.md) (the cloud is made of smoke), [misty step](/compendium/spells/misty-step.md), or [scorching ray](/compendium/spells/scorching-ray.md). If your attunement to the wand ends, the familiar is lost. When you cast [misty step](/compendium/spells/misty-step.md) in this way, you leave behind and reappear in a cloud of smoke that heavily obscures both spaces until the start of your next turn.

## Draconic Ward

While you can smell the burning incense, you can't be [frightened](/compendium/rules/conditions.md#Frightened) by dragons. In addition, a dragon that smells the incense has disadvantage on any attack roll it makes against you.
