...
- You can use an action while wearing the glasses to cast the [comprehend languages](compendium/spells/comprehend-languages.md) spell from them. The spell ends early if you remove them.  
