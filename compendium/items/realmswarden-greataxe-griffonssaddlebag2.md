...
The light that comes from the diamond at the axe's center and forms the blade can be wrought to create powerful, destructive glyphs. Over the course of 1 minute, you can trace a glyph onto the surface of the axe, starting with the gem at its center, to recreate the effects of the [symbol](compendium/spells/symbol.md) spell (save DC 17) with the following changes:
