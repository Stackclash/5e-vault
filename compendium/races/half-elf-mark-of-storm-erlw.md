...
When you make a Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics)) check or any ability check involving [navigator's tools](compendium/items/navigators-tools.md), you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
