...
When you make a Wisdom ([Insight](/compendium/rules/skills.md#Insight)) or Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
