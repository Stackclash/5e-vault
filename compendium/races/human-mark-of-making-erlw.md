...
When you make an [Arcana](/compendium/rules/skills.md#Arcana) check or an ability check involving artisan's tools, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
...
You know the [mending](compendium/spells/mending.md) cantrip. You can also cast the [magic weapon](compendium/spells/magic-weapon.md) spell with this trait. When you do so, the spell lasts for 1 hour and doesn't require [concentration](/compendium/rules/conditions.md#concentration). Once you cast the spell with this trait, you can't do so again until you finish a long rest. Intelligence is your spellcasting ability for these spells.
