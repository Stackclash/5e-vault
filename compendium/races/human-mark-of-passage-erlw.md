...
When you make a Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics)) check or any ability check to operate or maintain a land vehicle, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
