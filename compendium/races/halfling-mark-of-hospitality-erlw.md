...
When you make a Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check or an ability check involving [brewer's supplies](compendium/items/brewers-supplies.md) or [cook's utensils](compendium/items/cooks-utensils.md), you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
