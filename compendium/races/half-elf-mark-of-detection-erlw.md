...
When you make an Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) or a Wisdom ([Insight](/compendium/rules/skills.md#Insight)) check, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
