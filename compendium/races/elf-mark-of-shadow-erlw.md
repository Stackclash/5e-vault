...
When you make a Charisma ([Performance](/compendium/rules/skills.md#Performance)) or Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) check, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
