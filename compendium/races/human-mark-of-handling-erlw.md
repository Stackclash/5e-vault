...
When you make a Wisdom ([Animal Handling](/compendium/rules/skills.md#Animal%20Handling)) or Intelligence ([Nature](/compendium/rules/skills.md#Nature)) check, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
