...
![](compendium/races/img/hexblood.webp#right)  
...
- **Remote Viewing.** If you are within 10 miles of the token, you can enter a trance as an action. The trance lasts for 1 minute, but it ends early if you dismiss it (no action required) or are [incapacitated](/compendium/rules/conditions.md#Incapacitated). During this trance, you can see and hear from the token as if you were located where it is. While you are using your senses at the token's location, you are [blinded](/compendium/rules/conditions.md#Blinded) and [deafened](/compendium/rules/conditions.md#Deafened) in regard to your own surroundings. When the trance ends, the token is harmlessly destroyed.  
