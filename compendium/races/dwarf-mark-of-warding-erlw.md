...
When you make an Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check or an ability check using [thieves' tools](compendium/items/thieves-tools.md), you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
