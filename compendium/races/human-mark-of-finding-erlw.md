...
When you make a Wisdom ([Perception](/compendium/rules/skills.md#Perception)) or Wisdom ([Survival](/compendium/rules/skills.md#Survival)) check, you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
