...
![](compendium/races/img/warforged.webp#right)  
...
- You have advantage on saving throws against being [poisoned](/compendium/rules/conditions.md#poisoned), and you have resistance to poison damage.  
...
When you take a long rest, you must spend at least six hours in an inactive, motionless state, rather than sleeping. In this state, you appear inert, but it doesn't render you [unconscious](/compendium/rules/conditions.md#unconscious), and you can see and hear as normal.
...
Although they were manufactured, warforged are living humanoids. Resting, healing magic, and the [Medicine](/compendium/rules/skills.md#Medicine) skill all provide the same benefits to warforged that they do to other humanoids.
...
![](compendium/races/img/warforged-001.webp#center)