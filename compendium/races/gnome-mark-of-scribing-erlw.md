...
When you make an Intelligence ([History](/compendium/rules/skills.md#History)) check or an ability check using [calligrapher's supplies](compendium/items/calligraphers-supplies.md), you can roll a `dice: d4|avg` (`d4`) and add the number rolled to the ability check.
