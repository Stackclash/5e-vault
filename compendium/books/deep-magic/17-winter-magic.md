...
> [!note]
> The Otherworldly Patron presented here includes modified or augmented [Pact Boons](/compendium/classes/warlock.md#Pact%20Boon%20(Level%203)), which can be viewed here^[Optional features from [Pact Boon](/compendium/lists/list-optfeaturetype-pb.md); defined in Deep Magic].
