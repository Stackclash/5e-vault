...
- **Death Ray.** [circle of death](compendium/spells/circle-of-death.md) (10-foot-radius sphere; `dice:4d6|noform|avg` (`4d6`) necrotic damage to all creatures in the area), [feeblemind](compendium/spells/feeblemind.md)  
- **Disintegration Ray.** [chain lightning](compendium/spells/chain-lightning.md) (primary target takes `dice:6d8|noform|avg` (`6d8`) lightning damage; two secondary targets within 30 feet of the primary target take `dice:3d8|noform|avg` (`3d8`) lightning damage each), [eyebite](compendium/spells/eyebite.md) (sickened effect; 1 minute)  
