...
> 
> To use the table, the player [casting the spell](/compendium/rules/actions.md#Cast%20a%20Spell) must roll a `dice:d100|noform|noparens|avg` (`d100`). If they roll equal to or above the number listed next to the herb they are trying to locate's corresponding position on their herb table, then the herb is present and the spell leads them to it.
> 
