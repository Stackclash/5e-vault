...
![](compendium/books/players-handbook/img/ch8.webp#center)
...
At the end of a fall, a creature takes `dice: 1d6|avg` (`1d6`) bludgeoning damage for every 10 feet it fell, to a maximum of `dice: 20d6|avg` (`20d6`). The creature lands [prone](/compendium/rules/conditions.md#prone), unless it avoids taking damage from the fall.
...
![](compendium/books/players-handbook/img/c81.webp#center)
