...
The alchemy test needed to make arrows of slaying depends on the CR of the monster in question, as described in [The Alchemy Test](compendium/tables/alchemy-test-saf.md) (page 83). The number of arrows you get is also based on the CR of the monster. Very powerful monsters yield only a single arrow. Crafting the arrows requires the services of a 9th-level spellcaster.
