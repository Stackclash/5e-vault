...
![Size Categories](compendium/tables/size-categories.md)
...
The Saving Throws entry is reserved for creatures that are adept at resisting certain kinds of effects. For example, a creature that isn't easily [charmed](/compendium/rules/conditions.md#Charmed) or [frightened](/compendium/rules/conditions.md#Frightened) might gain a bonus on its Wisdom saving throws. Most creatures don't have special saving throw bonuses, in which case this section is absent.
...
The Skills entry is reserved for monsters that are proficient in one or more skills. For example, a monster that is very perceptive and stealthy might have bonuses to Wisdom ([Perception](/compendium/rules/skills.md#Perception)) and Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks.
...
The Senses entry notes a monster's passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score, as well as any special senses the monster might have. Special senses are described below.

#### Blindsight

A monster with [blindsight](/compendium/rules/senses.md#Blindsight) can perceive its surroundings without relying on sight, within a specific radius. Creatures without eyes, such as grimlocks and gray oozes, typically have this special sense, as do creatures with echolocation or heightened senses, such as bats and true dragons.

If a monster is naturally blind, it has a parenthetical note to this effect, indicating that the radius of its [blindsight](/compendium/rules/senses.md#Blindsight) defines the maximum range of its perception.

#### Darkvision

A monster with [darkvision](/compendium/rules/senses.md#Darkvision) can see in the dark within a specific radius. The monster can see in dim light within the radius as if it were bright light, and in darkness as if it were dim light. The monster can't discern color in darkness, only shades of gray. Many creatures that live underground have this special sense.

#### Tremorsense

A monster with [tremorsense](/compendium/rules/senses.md#Tremorsense) can detect and pinpoint the origin of vibrations within a specific radius, provided that the monster and the source of the vibrations are in contact with the same ground or substance. Tremorsense can't be used to detect flying or incorporeal creatures. Many burrowing creatures, such as ankhegs and umber hulks, have this special sense.

#### Truesight

A monster with [truesight](/compendium/rules/senses.md#Truesight) can, out to a specific range, see in normal and magical darkness, see [invisible](/compendium/rules/conditions.md#Invisible) creatures and objects, automatically detect visual illusions and succeed on saving throws against them, and perceive the original form of a shapechanger or a creature that is transformed by magic. Furthermore, the monster can see into the Ethereal Plane within the same range.
...
A telepathic monster doesn't need to see a contacted creature and can end the telepathic contact at any time. The contact is broken as soon as the two creatures are no longer within range of each other or if the telepathic monster contacts a different creature within range. A telepathic monster can initiate or terminate a telepathic conversation without using an action, but while the monster is [incapacitated](/compendium/rules/conditions.md#Incapacitated), it can't initiate telepathic contact, and any current contact is terminated.
...
![Experience Points by Challenge Rating](compendium/tables/experience-points-by-challenge-rating.md)
...
When a monster takes its action, it can choose from the options in the Actions section of its stat block or use one of the actions available to all creatures, such as the [Dash](/compendium/rules/actions.md#Dash) or [Hide](/compendium/rules/actions.md#Hide) action, as described in the *Player's Handbook.*
...
> 
> A creature [grappled](/compendium/rules/conditions.md#Grappled) by the monster can use its action to try to escape. To do so, it must succeed on a Strength ([Athletics](/compendium/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics)) check against the escape DC in the monster's stat block. If no escape DC is given, assume the DC is 10 + the monster's Strength ([Athletics](/compendium/rules/skills.md#Athletics)) modifier.
...
A legendary creature can take a certain number of special actions-called legendary actions-outside its turn. Only one legendary action option can be used at a time and only at the end of another creature's turn. A legendary creature regains spent legendary actions at the start of its turn. It can forgo using them, and it can't use them while [incapacitated](/compendium/rules/conditions.md#Incapacitated) or otherwise unable to take actions. If [surprised](/compendium/rules/conditions.md#Surprised), it can't use them until after its first turn in the combat.
...
If a legendary creature has lair actions, it can use them to harness the ambient magic in its lair. On initiative count 20 (losing all initiative ties), it can use one of its lair action options. It can't do so while [incapacitated](/compendium/rules/conditions.md#Incapacitated) or otherwise unable to take actions. If [surprised](/compendium/rules/conditions.md#Surprised), it can't use one until after its first turn in the combat.
...
![Resistances](compendium/tables/resistances.md)
...
![New Action: Breath Weapon](compendium/tables/new-action-breath-weapon.md)
