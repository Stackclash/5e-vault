...
An ether cyclone is a serpentine column that spins through the plane. The cyclone appears abruptly, distorting and uprooting ethereal forms in its path and carrying the debris for leagues. Travelers with a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score of 15 or more receive `dice:1d4|noform|noparens|avg` (`d4`) rounds of warning: a deep hum in the ethereal matter.
