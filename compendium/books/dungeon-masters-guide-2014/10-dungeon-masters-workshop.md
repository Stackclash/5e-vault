...
Consider using the [New Ability Scores: Honor and Sanity](/compendium/rules/variant-rules/new-ability-scores-honor-and-sanity.md) if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](/compendium/rules/conditions.md#Frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
- [Climb onto a Bigger Creature](/compendium/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](/compendium/rules/actions.md#Disarm)  
- [Mark](/compendium/rules/actions.md#Mark)  
- [Overrun](/compendium/rules/actions.md#Overrun)  
- [Shove Aside](/compendium/rules/actions.md#Shove%20Aside)  
- [Tumble](/compendium/rules/actions.md#Tumble)  
...
- The creature is [surprised](/compendium/rules/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](/compendium/rules/conditions.md#Surprised).  
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](/compendium/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](/compendium/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](/compendium/rules/skills.md#Perception)) bonus.
