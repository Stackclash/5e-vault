...
| 5 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [wraiths](/compendium/bestiary/undead/wraith.md). The wraiths are immune to cold damage. |
| 6 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [trolls](/compendium/bestiary/giant/troll.md) looking for food. Desperate, they fight recklessly. All of their attacks are made with advantage, and attacks made against them are made with advantage. |
| 7 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [air elementals](/compendium/bestiary/elemental/air-elemental.md) |
| 8 | A dense fog gathers (treat it as a fog cloud spell). Within the fog, `dice:3d10\|noform\|noparens\|avg` (`3d10`) [zombies](/compendium/bestiary/undead/zombie.md) march mindlessly towards some unknown destination. They will not attack unless they are attacked first. |
| 9 | `dice:1d2\|noform\|noparens\|avg` (`d2`) [mammoths](/compendium/bestiary/beast/mammoth.md) are being chased by `dice:2d6\|noform\|noparens\|avg` (`2d6`) [tribal warriors](/compendium/bestiary/humanoid/tribal-warrior.md) |
| 10 | `dice:1d2\|noform\|noparens\|avg` (`d2`) [polar bears](/compendium/bestiary/beast/polar-bear.md) |
| 11 | `dice:3d8\|noform\|noparens\|avg` (`3d8`) ice [kobolds](/compendium/bestiary/humanoid/kobold.md) (they have resistance to cold damage) have dug a massive pit trap along the path. They hide, waiting for creatures to stumble into their trap. |
| 12 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [tribal warriors](/compendium/bestiary/humanoid/tribal-warrior.md) lead by 1 berserker are hauling a slain mammoth back to their den. |
| 13 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [orcs](/compendium/bestiary/humanoid/orc.md) lead by 1 [orc gladiator](/compendium/bestiary/humanoid/gladiator.md) hunt for fauna on the glacier. They are not above eating the flesh of man, however. |
| 14 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [yetikin](/compendium/bestiary/humanoid/bugbear.md). Yetkin are bugbears except they have resistance to cold damage. |
...
| 17 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [manticores](/compendium/bestiary/monstrosity/manticore.md) |
| 18 | `dice:4d4\|noform\|noparens\|avg` (`4d4`) [ice mephits](/compendium/bestiary/elemental/ice-mephit.md) surround a hole in the ice. They have caught an ice kobold who squeals in fear as the elementals taunt it. |
...
| 20 | `dice:1d2\|noform\|noparens\|avg` (`d2`) [young white dragons](/compendium/bestiary/dragon/young-white-dragon.md) |
| 21 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [banshees](/compendium/bestiary/undead/banshee.md) |
| 22 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [frost giants](/compendium/bestiary/giant/frost-giant.md) led by an additional [frost giant](/compendium/bestiary/giant/frost-giant.md) with 200 hit points lumber through the ice, returning to their home. They are indifferent towards the characters but will attack if provoked. |
^result
...
| 4 | `dice:1d2\|noform\|noparens\|avg` (`d2`) [behir](/compendium/bestiary/monstrosity/behir.md) |
...
| 6 | `dice:1d2\|noform\|noparens\|avg` (`d2`) festerwood [treants](/compendium/bestiary/plant/treant.md). They offer amber pustules in exchange for the eradication of a nearby hive of 3d6 + 3 festerwood beetles (use statistics of [giant wasps](/compendium/bestiary/beast/giant-wasp.md)), one fist-sized chunk for every 6 beetles slain. |
| 7 | `dice:1d3\|noform\|noparens\|avg` (`d3`) [shambling mounds](/compendium/bestiary/plant/shambling-mound.md). Altered by the Festerwood, they have poison immunity and absorption instead of lightning. |
| 8 | 1 [spirit naga](/compendium/bestiary/monstrosity/spirit-naga.md) |
| 9 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [will-o'-wisps](/compendium/bestiary/undead/will-o-wisp.md). If the party decides to follow them, roll again on the encounter table, ignoring results that are multiples of three. |
| 10 | `dice:4d8\|noform\|noparens\|avg` (`4d8`) [swarm of beetles](/compendium/bestiary/beast/swarm-of-beetles.md) |
| 11 | `dice:1d12\|noform\|noparens\|avg` (`d12`) [twig blights](/compendium/bestiary/plant/twig-blight.md) |
| 12 | `dice:1d4+1\|noform\|noparens\|avg` (`1d4 + 1`) [xorn](/compendium/bestiary/elemental/xorn.md). Though well-fed by the ever-present amber pustules, they offer guidance to locations in the wood in exchange for any gems or precious metals the party has. |
| 13 | `dice:3d10\|noform\|noparens\|avg` (`3d10`) [violet fungus](/compendium/bestiary/plant/violet-fungus.md) |
| 14 | `dice:2d6\|noform\|noparens\|avg` (`2d6`) [duergar](/compendium/bestiary/humanoid/duergar.md) raiding party |
...
| 17 | `dice:8d6\|noform\|noparens\|avg` (`8d6`) [giant fire beetles](/compendium/bestiary/beast/giant-fire-beetle.md). Enhanced by their diet of amber pustules, their bite attacks deal an extra 1d4 fire damage. |
...
| 20 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [black puddings](/compendium/bestiary/ooze/black-pudding.md) |
...
| 22 | `dice:4d4\|noform\|noparens\|avg` (`4d4`) [goblins](/compendium/bestiary/humanoid/goblin.md) riding [worgs](/compendium/bestiary/monstrosity/worg.md). They roam the wood searching for food and supplies for their tribe. |
^result
