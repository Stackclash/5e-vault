...
Falling from a great height is a significant risk for adventurers and their foes. The rule given in the player's handbook is simple: at the end of a fall, you take `dice:1d6|noform|noparens|avg` (`d6`) bludgeoning damage for every 10 feet you fell, to a maximum of `dice:20d6|noform|noparens|avg` (`20d6`). You also land [prone](/compendium/rules/conditions.md#Prone), unless you somehow avoid taking damage from the fall. Here are two optional rules that expand on that simple rule.
...
A flying creature in flight falls if it is knocked [prone](/compendium/rules/conditions.md#Prone), if its speed is reduced to 0 feet, or if it otherwise loses the ability to move, unless it can hover or it is being held aloft by magic, such as the [fly](/compendium/spells/fly.md) spell.

If you'd like a flying creature to have a better chance of surviving a fall than a non-flying creature does, use this rule: subtract the creature's current flying speed from the distance it fell before calculating falling damage. This rule is helpful to a flier that is knocked [prone](/compendium/rules/conditions.md#Prone) but is still conscious and has a current flying speed that is greater than 0 feet. The rule is designed to simulate the creature flapping its wings furiously or taking similar measures to slow the velocity of its fall.

If you use the rule for rate of falling in the previous section, a flying creature descends 500 feet on the turn when it falls, just as other creatures do. But if that creature starts any of its later turns still falling and is [prone](/compendium/rules/conditions.md#Prone), it can halt the fall on its turn by spending half its flying speed to counter the [prone](/compendium/rules/conditions.md#Prone) condition (as if it were standing up in midair).
...
Tools have more specific applications than skills. The [History](/compendium/rules/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/compendium/items/forgery-kit.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/compendium/items/masons-tools.md) makes a successful Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check to determine how to open the door.
...
![](/compendium/books/xanathars-guide-to-everything/img/c2001.webp#center)
...
See the [Identify a Spell](/compendium/rules/actions.md#Identify%20a%20Spell) entry.
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](/compendium/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![](/compendium/books/xanathars-guide-to-everything/img/c2005.webp#center)
...
![Monster Personality](/compendium/tables/monster-personality-xge.md)
...
![Monster Relationships](/compendium/tables/monster-relationships-xge.md)
...
![Quick Matchups](/compendium/tables/quick-matchups-xge.md)
...
![](/compendium/books/xanathars-guide-to-everything/img/c2021.webp#center)

#### Running a Simple Trap

To prepare for using a simple trap in play, start by making note of the characters' passive Wisdom ([Perception](/compendium/rules/skills.md#Perception)) scores. Most traps allow Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks to detect their triggers or other elements that can tip off their presence. If you stop to ask players for this information, they might suspect a hidden danger.
...
- [Bear Trap](/compendium/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](/compendium/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](/compendium/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](/compendium/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](/compendium/traps-hazards/net-trap-xge.md)  
- [Pit Trap](/compendium/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](/compendium/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](/compendium/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](/compendium/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![](/compendium/books/xanathars-guide-to-everything/img/c2022.webp#center)
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](/compendium/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)
...
A trigger requires a Wisdom ([Perception](/compendium/rules/skills.md#Perception)) check if simply spotting it reveals its nature. The characters can foil a pit trap hidden by a leaf-covered net if they spot the pit through a gap in the leaves. A trip wire is foiled if it is spotted, as is a pressure plate.

Other traps require careful inspection and deduction to notice. A doorknob opens a door when turned to the left, but activates a trap when turned to the right. Such a subtle trap requires a successful Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) check to notice. The trigger is obvious. Understanding its nature is not.
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](/compendium/items/thieves-tools.md), a Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check, and an Intelligence ([Arcana](/compendium/rules/skills.md#Arcana)) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](/compendium/items/thieves-tools.md) can apply to any trap that has a mechanical element. [Thieves' tools](/compendium/items/thieves-tools.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![](/compendium/books/xanathars-guide-to-everything/img/c2024.webp#center)
...
- [Path of Blades](/compendium/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](/compendium/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](/compendium/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
The trigger for a complex trap should be as foolproof as you can make it. A complex trap represents a serious expenditure of effort and magical power. No one builds such a trap and makes it easy to avoid. Wisdom ([Perception](/compendium/rules/skills.md#Perception)) and Intelligence ([Investigation](/compendium/rules/skills.md#Investigation)) checks might be unable to spot a trigger, especially a magical one, but they can still give hints about the trap before it triggers. Bloodstains, ashes, gouges in the floor, and other clues of that sort can serve as evidence of the trap's presence.
...
Not all of the characters' options need to be focused on stopping a trap from operating. Think of what characters can do to mitigate or avoid a trap's effects. Making the trap vulnerable to this sort of effort is a way to engage characters who might be ill-suited to confront the trap directly. A successful Intelligence ([Religion](/compendium/rules/skills.md#Religion)) check might provide insight into the imagery displayed by a trap in a temple or shrine, giving other characters a clue about how and where to direct their efforts. A character could stand in front of a dart trap while holding a shield that the darts can target harmlessly, while other characters trigger that element as they work to disable it.
...
![](/compendium/books/xanathars-guide-to-everything/img/c2025.webp#center)
...
![](/compendium/books/xanathars-guide-to-everything/img/c2026.webp#center)
...
![Crafting Magic Items; Magic Item Ingredients](/compendium/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
To complete a magic item, a character also needs whatever tool proficiency is appropriate, as for crafting a nonmagical object, or proficiency in the [Arcana](/compendium/rules/skills.md#Arcana) skill.
...
The character makes three checks: Strength ([Athletics](/compendium/rules/skills.md#Athletics)), Dexterity ([Acrobatics](/compendium/rules/skills.md#Acrobatics)), and a special Constitution check that has a bonus equal to a roll of the character's largest Hit Die (this roll doesn't spend that die). If desired, the character can replace one of these skill checks with an attack roll using one of the character's weapons. The DC for each of the checks is `dice:5+2d10|noform|noparens|avg` (`5 + 2d10`); generate a separate DC for each one. Consult the Pit Fighting Results table to see how the character did.
...
At the end of the required time, the character chooses to make either an Intelligence ([Religion](/compendium/rules/skills.md#Religion)) check or a Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check. The total of the check determines the benefits of service, as shown on the Religious Service table.
...
![](/compendium/books/xanathars-guide-to-everything/img/c2027.webp#center)
...
Scribing a spell scroll takes an amount of time and money related to the level of the spell the character wants to scribe, as shown in the Spell Scroll Costs table. In addition, the character must have proficiency in the [Arcana](/compendium/rules/skills.md#Arcana) skill and must provide any material components required for the casting of the spell. Moreover, the character must have the spell prepared, or it must be among the character's known spells, in order to scribe a scroll of that spell.
...
A character who wants to sell an item must make a Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check to determine what kind of offer comes in. The character can always opt not to sell, instead forfeiting the workweek of effort and trying again later. Use the Magic Item Base Prices and Magic Item Offer tables to determine the sale price.

![Selling a Magic Item; Magic Item Base Prices](/compendium/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](/compendium/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![](/compendium/books/xanathars-guide-to-everything/img/c2028.webp#center)
...
![Magic Items Awarded by Rarity - Minor](/compendium/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](/compendium/tables/magic-items-awarded-by-rarity-major-xge.md)
