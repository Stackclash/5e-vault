...
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"><a href='#Circle of the Eclipse (Level 2)' class='internal-link'>Circle of the Eclipse</a></td></tr>
...
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Eclipse Form (Level 6)' class='internal-link'>Eclipse Form</a></td></tr>
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">8th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Sight of Lightless Moon (Level 10)' class='internal-link'>Sight of Lightless Moon</a></td></tr>
> <tr class="class-progression"><td class"level">11th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">12th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">13th</td><td class"pb">+5</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Radiance of the Blinding Sun (Level 14)' class='internal-link'>Radiance of the Blinding Sun</a></td></tr>
...
When you choose this circle at 2nd level, your deep-rooted connection to plantlife grants you the ability to cast certain spells. This connection grants you access to some spells when you reach certain levels in this class, as shown on the Circle of the Eclipse Spells table.
...
|-------------|-------------------|------------------|
| 2nd | [bless](/compendium/spells/bless.md) | [bane](/compendium/spells/bane.md) |
| 3rd | [flaming sphere](/compendium/spells/flaming-sphere.md) | [darkness](/compendium/spells/darkness.md) |
| 5th | [mass healing word](/compendium/spells/mass-healing-word.md) | [hypnotic pattern](/compendium/spells/hypnotic-pattern.md) |
| 7th | [wall of fire](/compendium/spells/wall-of-fire.md) | [dimension door](/compendium/spells/dimension-door.md) |
| 9th | [flame strike](/compendium/spells/flame-strike.md) | [cone of cold](/compendium/spells/cone-of-cold.md) |
^circle-of-the-eclipse-spells

### Light and Dark Forms (Level 2)

When you choose this circle at 2nd level, your relationship to both sun and moon grants you power over light and darkness. You have two forms at 2nd level: light and dark. You can use a bonus action to change into light form or dark form. You can return to your normal form at any time (no action required). Each form grants you a series of different effects, as described below, which persist even while you are transformed into a beast by Wild Shape.
...
| 3 | Your hair turns white and golden. | Your hair turns inky black, like a crow's feather. |
...
^light-form-apperance-dark-form-appearance

### Eclipse Dice (Level 2)
...
As a bonus action, you can choose one creature that you can see within 60 feet of you and spend any number of these dice up to your proficiency bonus. Roll the spent dice and add them together. The effect of the dice depends on which form you're in.
...
### Sight of Lightless Moon (Level 10)

Starting at 10th level, you can see normally in darkness, both magical and nonmagical, to a distance of 120 feet, even if you're transformed by Wild Shape.
...
### Radiance of the Blinding Sun (Level 14)
...
- **Moon Aura (Dark Form).** The area within your aura is filled with cool, dim light. You and friendly creatures within the aura have resistance to cold damage.  
