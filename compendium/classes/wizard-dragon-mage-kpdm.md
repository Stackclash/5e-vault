...
### Invoke Dragon Mask (Level 2)

Starting at 2nd level, you can invoke a magic Dragon mask. You use a bonus action and expend a spell slot to invoke the mask, which lasts for 3 rounds for each level of the expended spell slot. The dragon mask remains as long as you are not [incapacitated](/compendium/rules/conditions.md#Incapacitated), until you use a bonus action to dismiss or replace it, or until the duration expires. The mask is a translucent magical force, in the form of a dragon's head, which covers your face. Your face is still visible through the mask, and the mask does not hinder vision.
...
- You have advantage on Wisdom ([Perception](/compendium/rules/skills.md#Perception)) checks and Charisma ([Intimidation](/compendium/rules/skills.md#Intimidation)) checks.  
...
- You are immune to the [grappled](/compendium/rules/conditions.md#Grappled) condition.  
