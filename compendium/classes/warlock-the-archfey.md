...
Starting at 14th level, you can plunge a creature into an illusory realm. As an action, choose a creature that you can see within 60 feet of you. It must make a Wisdom saving throw against your warlock spell save DC. On a failed save, it is [charmed](compendium/rules/conditions.md#charmed) or [frightened](compendium/rules/conditions.md#frightened) by you (your choice) for 1 minute or until your [concentration](compendium/rules/status.md#concentration) is broken (as if you are [concentration](compendium/rules/status.md#concentration) on a spell). This effect ends early if the creature takes any damage.
