...
*3rd-level barbarian [optional feature](/compendium/rules/variant-rules/optional-class-features-tce.md)*
...
Additionally, if you are [surprised](/compendium/rules/conditions.md#Surprised) at the beginning of combat and aren't [incapacitated](/compendium/rules/conditions.md#Incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian [optional feature](/compendium/rules/variant-rules/optional-class-features-tce.md)*
