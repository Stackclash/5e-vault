...
- domain/apocalypse
- subclass/cleric/apocalypse
aliases: ["Apocalypse Domain"]
---
# Apocalypse Domain
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [vicious mockery](compendium/spells/vicious-mockery.md), [dissonant whispers](compendium/spells/dissonant-whispers.md), [hellish rebuke](compendium/spells/hellish-rebuke.md) |
| 3rd | [enthrall](compendium/spells/enthrall.md), [magic mouth](compendium/spells/magic-mouth.md) |
| 5th | [fear](compendium/spells/fear.md), [stinking cloud](compendium/spells/stinking-cloud.md) |
| 7th | [blight](compendium/spells/blight.md), [phantasmal killer](compendium/spells/phantasmal-killer.md) |
| 9th | [contact other plane](compendium/spells/contact-other-plane.md), [telekinesis](compendium/spells/telekinesis.md) |
^apocalypse-domain-spells

### Ranting Ruin (Level 1)

At 1st level, you learn the [vicious mockery](compendium/spells/vicious-mockery.md) cantrip. You also gain proficiency in either [Arcana](/compendium/rules/skills.md#Arcana) or [Survival](/compendium/rules/skills.md#Survival) (your choice).

### Channel Divinity: Damnation (Level 2)

Starting at 2nd level, you can use your Channel Divinity to lash out at those who defy your deity's messenger. As an action, you present your [holy symbol](compendium/items/holy-symbol.md) while pronouncing doom to unbelievers. Each hostile creature that can see you and is within 30 feet of you takes `dice:3d6|noform|avg` (`3d6`) + your Cleric level necrotic damage, or half damage with a successful Wisdom saving throw. A creature that has total cover from you is not affected.
