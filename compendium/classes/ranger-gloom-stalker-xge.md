...
> 
> So you sneak around in the dark? You know most everything but humans can see in the dark, right? We all see you. Tiptoeing doesn't turn you [invisible](/compendium/rules/conditions.md#Invisible).
...
At the start of your first turn of each combat, your walking speed increases by 10 feet, which lasts until the end of that turn. If you take the [Attack](/compendium/rules/actions.md#Attack) action on that turn, you can make one additional weapon attack as part of that action. If that attack hits, the target takes an extra `dice:1d8|noform|noparens|avg` (`d8`) damage of the weapon's damage type.
