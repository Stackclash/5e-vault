...
- [Archery](/compendium/classes/fighter.md#Archery)  
- Close Quarters Shooter  
- [Defense](/compendium/classes/fighter.md#Defense)  
- [Dueling](/compendium/classes/fighter.md#Dueling)  
- [Great Weapon Fighting](/compendium/classes/fighter.md#Great%20Weapon%20Fighting)  
- Mariner  
- [Protection](/compendium/classes/fighter.md#Protection)  
- Tunnel Fighter  
...
- Unarmed Fighting  
- [Blind Fighting](/compendium/classes/fighter.md#Blind%20Fighting)  
- [Interception](/compendium/classes/fighter.md#Interception)  
- [Superior Technique](/compendium/classes/fighter.md#Superior%20Technique)  
- [Thrown Weapon Fighting](/compendium/classes/fighter.md#Thrown%20Weapon%20Fighting)  
- [Unarmed Fighting](/compendium/classes/fighter.md#Unarmed%20Fighting)  
...
- If you know any maneuvers from the [Battle Master](/compendium/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by `dice: 1d10|avg` (`1d10`) + your proficiency bonus (to a minimum of 0 damage). You must be wielding a [shield](/compendium/items/shield.md) or a simple or martial weapon to use this reaction.
...
You learn one maneuver of your choice from among those available to the [Battle Master](/compendium/classes/fighter-battle-master.md) archetype. If a maneuver you use requires your target to make a saving throw to resist the maneuver's effects, the saving throw DC equals 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).
...
When you successfully start a grapple, you can deal `dice: 1d4|avg` (`1d4`) bludgeoning damage to the [grappled](compendium/rules/conditions.md#grappled) creature. Until the grapple ends, you can also deal this damage to the creature whenever you hit it with a melee attack.