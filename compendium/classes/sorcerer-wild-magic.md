...
If a Wild Magic effect is a spell, it's too wild to be affected by Metamagic. If it normally requires [concentration](compendium/rules/status.md#concentration), it doesn't require [concentration](compendium/rules/status.md#concentration) in this case; the spell lasts for its full duration.
...
| 37-38 | `dice: 1d6|avg` (`1d6`) [flumphs](/compendium/bestiary/aberration/flumph.md) controlled by the DM appear in unoccupied spaces within 60 feet of you and are [frightened](compendium/rules/conditions.md#frightened) of you. They vanish after 1 minute. |
...
| 73-74 | A random creature within 60 feet of you becomes [poisoned](compendium/rules/conditions.md#poisoned) for `dice: 1d4|avg` (`1d4`) hours. |
