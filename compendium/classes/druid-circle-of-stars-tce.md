...
A constellation of a wise dragon appears on you. When you make an Intelligence or a Wisdom check or a Constitution saving throw to maintain [concentration](/compendium/rules/conditions.md#Concentration) on a spell, you can treat a roll of 9 or lower on the `dice:d20|noform|noparens|avg` (`d20`) as a 10.
