...
- [Disarming Attack](/compendium/classes/fighter-battle-master.md#Disarming%20Attack)  
- [Distracting Strike](/compendium/classes/fighter-battle-master.md#Distracting%20Strike)  
- [Evasive Footwork](/compendium/classes/fighter-battle-master.md#Evasive%20Footwork)  
- [Feinting Attack](/compendium/classes/fighter-battle-master.md#Feinting%20Attack)  
- [Goading Attack](/compendium/classes/fighter-battle-master.md#Goading%20Attack)  
- [Lunging Attack](/compendium/classes/fighter-battle-master.md#Lunging%20Attack)  
- [Maneuvering Attack](/compendium/classes/fighter-battle-master.md#Maneuvering%20Attack)  
- [Menacing Attack](/compendium/classes/fighter-battle-master.md#Menacing%20Attack)  
- [Parry](/compendium/classes/fighter-battle-master.md#Parry)  
- [Precision Attack](/compendium/classes/fighter-battle-master.md#Precision%20Attack)  
- [Pushing Attack](/compendium/classes/fighter-battle-master.md#Pushing%20Attack)  
- [Rally](/compendium/classes/fighter-battle-master.md#Rally)  
- [Riposte](/compendium/classes/fighter-battle-master.md#Riposte)  
- [Sweeping Attack](/compendium/classes/fighter-battle-master.md#Sweeping%20Attack)  
- [Trip Attack](/compendium/classes/fighter-battle-master.md#Trip%20Attack)  
...
If you have access to maneuvers, the following maneuvers are added to the list of options available to you. Maneuvers are available to Battle Masters but also to characters who have a special feature like the [Superior Technique](/compendium/classes/fighter.md#Superior%20Technique) fighting style or the [Martial Adept](/compendium/feats/martial-adept.md) feat.

- [Ambush](/compendium/classes/fighter-battle-master.md#Ambush)  
- [Bait and Switch](/compendium/classes/fighter-battle-master.md#Bait%20and%20Switch)  
- [Brace](/compendium/classes/fighter-battle-master.md#Brace)  
- [Commanding Presence](/compendium/classes/fighter-battle-master.md#Commanding%20Presence)  
- [Grappling Strike](/compendium/classes/fighter-battle-master.md#Grappling%20Strike)  
- [Quick Toss](/compendium/classes/fighter-battle-master.md#Quick%20Toss)  
- [Tactical Assessment](/compendium/classes/fighter-battle-master.md#Tactical%20Assessment)  
...
When you make a Dexterity ([Stealth](compendium/rules/skills.md#Stealth)) check or an initiative roll, you can expend one superiority die and add the die to the roll.
...
Immediately after you hit a creature with a melee weapon attack on your turn, you can expend one superiority die and use a bonus action to grapple the target (see chapter 9 in the Player's Handbook for rules on grappling). Add the superiority die to your Strength ([Athletics](compendium/rules/skills.md#Athletics)) check. The target is also [restrained](compendium/rules/conditions.md#restrained) while [grappled](compendium/rules/conditions.md#grappled) in this way.
...
When you make a Charisma ([Deception](compendium/rules/skills.md#Deception)) check or a Charisma ([Persuasion](compendium/rules/skills.md#Persuasion)) check, you can expend one superiority die, and add the superiority die to the ability check.
...
When you make a Wisdom ([Insight](compendium/rules/skills.md#Insight)) check or an Intelligence ([Investigation](compendium/rules/skills.md#Investigation)) check, you can expend one superiority die, and add the superiority die to the ability check.
