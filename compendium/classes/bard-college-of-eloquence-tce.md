...
You are a master at saying the right thing at the right time. When you make a Charisma ([Persuasion](compendium/rules/skills.md#Persuasion)) or Charisma ([Deception](compendium/rules/skills.md#Deception)) check, you can treat a `dice: d20|avg` (`d20`) roll of 9 or lower as a 10.
