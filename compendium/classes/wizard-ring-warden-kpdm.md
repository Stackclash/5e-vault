...
Except as noted below, ring wardens function as [transmuters](/compendium/classes/wizard.md) and use the wizard spell list.
...
Additionally, you learn the method for crafting a single kind of magic ring chosen from the following list: [ring of jumping](/compendium/items/ring-of-jumping.md), [ring of mind shielding](/compendium/items/ring-of-mind-shielding.md), [ring of protection](/compendium/items/ring-of-protection.md), [ring of the ram](/compendium/items/ring-of-the-ram.md), [ring of regeneration](/compendium/items/ring-of-regeneration.md), or [ring of resistance](/compendium/items/ring-of-resistance.md). At the GM's discretion, you can choose a ring not listed here. You must meet all the standard Prerequisites for crafting the ring and pay the required gold as normal, along with providing any Special materials or meeting any conditions set by the GM.
