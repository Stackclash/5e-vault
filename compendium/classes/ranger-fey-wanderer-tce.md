...
Whenever you start casting the spell, you can modify it so that it doesn't require [concentration](compendium/rules/status.md#concentration). If you do so, the spell's duration becomes 1 minute for that casting.
