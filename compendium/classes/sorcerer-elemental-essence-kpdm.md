...
- When you cast a spell of 1st level or higher, the aura around you intensifies until the start of your next turn. During this time, any creature that ends its turn within 5 feet of you or that enters that area takes `dice:1d6|noform|noparens|avg` (`d6`) damage of the type associated with your heritage element. This damage increases to `dice:2d6|noform|noparens|avg` (`2d6`) when you reach 7th level.  
...
- **Earth..** The creature is [restrained](/compendium/rules/conditions.md#Restrained) until the start of your next turn.  
- **Fire..** The creature is seared by your fiery magic. It is [frightened](/compendium/rules/conditions.md#Frightened) until the end of its next turn. Creatures that are immune to fire are unaffected.  
- **Water..** The creature is disoriented as the world seems to roll and pitch in waves. It is [poisoned](/compendium/rules/conditions.md#Poisoned) until the end of its next turn.  
