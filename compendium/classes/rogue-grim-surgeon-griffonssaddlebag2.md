...
When you choose this archetype at 3rd level, you gain proficiency in the [Medicine](/compendium/rules/skills.md#Medicine) skill if you don't already have it. Your proficiency bonus is doubled for any ability check you make that uses this skill.

In addition, your familiarity with blood has become magical, giving you some degree of control over it. As a result, you can use a bonus action to magically stabilize an [unconscious](/compendium/rules/conditions.md#Unconscious) creature within 5 feet of you.

You can use this same magic when you apply traditional healing techniques. You can use a bonus action to expend one use of a [healer's kit](/compendium/items/healers-kit.md) on a creature. When you do, that creature regains hit points equal `dice:1d4|noform|noparens|avg` (`d4`) + your proficiency bonus. The creature can't regain hit points from this feature again until it finishes a short or long rest.
...
By 17th level, you can command the blood inside certain creatures. Immediately after you deal Sneak Attack damage to a beast or humanoid, you can force that creature to make a Constitution saving throw. The DC is equal to 8 + your proficiency bonus + your Wisdom modifier. On a failed save, that creature is under the effect of the [dominate beast](/compendium/spells/dominate-beast.md) or [dominate person](/compendium/spells/dominate-person.md) spell, respectively, for 1 minute or until you choose to end the effect (no action required).
