...
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"><a href='#Circle of Oaks (Level 2)' class='internal-link'>Circle of Oaks</a></td></tr>
...
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Tree Walking (Level 6)' class='internal-link'>Tree Walking</a></td></tr>
> <tr class="class-progression"><td class"level">7th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">8th</td><td class"pb">+3</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">9th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">10th</td><td class"pb">+4</td><td class"feature"><a href='#Tree Merging (Level 10)' class='internal-link'>Tree Merging</a></td></tr>
> <tr class="class-progression"><td class"level">11th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">12th</td><td class"pb">+4</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">13th</td><td class"pb">+5</td><td class"feature"></td></tr>
> <tr class="class-progression"><td class"level">14th</td><td class"pb">+5</td><td class"feature"><a href='#Forest Restoration (Level 14)' class='internal-link'>Forest Restoration</a></td></tr>
...
| Druid Level | Spells |
|-------------|--------|
| 2nd | [tree heal](/compendium/spells/tree-heal-kpdm.md) |
| 3rd | [forest native](/compendium/spells/forest-native-kpdm.md), [tree speak](/compendium/spells/tree-speak-kpdm.md) |
| 5th | legion of squirrels, ley disturbance |
| 7th | [freedom of movement](/compendium/spells/freedom-of-movement.md), [quick time](/compendium/spells/quick-time-kpdm.md) |
| 9th | [commune with nature](/compendium/spells/commune-with-nature.md), lesser ley protection |
| 11th | [conjure forest defender](/compendium/spells/conjure-forest-defender-kpdm.md) |
| 13th | greater ley protection |
| 15th | [control weather](/compendium/spells/control-weather.md) |
| 17th | [forest sanctuary](/compendium/spells/forest-sanctuary-kpdm.md) |
^circle-of-oaks-spells

### Bonus Cantrip (Level 2)

When you choose the Circle of Oaks at 2nd level, you learn the [tree heal](/compendium/spells/tree-heal-kpdm.md) druid cantrip. Members of your circle often touch each tree they pass as they stroll through a wooded area, just in case the tree may be in need of assistance.
...
Starting at 10th level, you can merge your spirit with that of a tree within 5 feet of you as an action. While merged, your body resides in the Shadow Realm, petrified and invisible, while your spirit is aware of happenings in the vicinity of the tree. If you spend 6 hours merged with a tree in your bound forest, you gain the benefits of finishing a long rest. You can't communicate with anyone outside of the tree unless a creature casts [tree speak](/compendium/spells/tree-speak-kpdm.md) or [speak with plants](/compendium/spells/speak-with-plants.md). You can leave the tree as an action and your body reappears in an unoccupied space within 5 feet of the tree. If you have been merged with the tree for more than 24 hours, you must succeed on a DC 5 Constitution saving throw to exit the tree. If you have been merged with the tree for more than 48 hours, you have disadvantage on this saving throw. Each month you stay merged with the tree increases this DC by 1. If you fail this saving throw, you must wait 24 hours before you can attempt to exit the tree again. If you fail this saving throw each day for 1 week, you become permanently merged with the tree and can only exit it through powerful magic such as a [wish](/compendium/spells/wish.md) spell or if the tree is destroyed or dies. As they approach the ends of their lives, many Circle of Oaks druids choose to permanently merge with their favorite trees to forever be part of their forest.
