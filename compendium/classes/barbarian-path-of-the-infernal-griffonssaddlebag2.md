...
At 3rd level, you learn to speak, read, and write either Abyssal or Infernal (your choice). In addition, you can add your Strength modifier to any Charisma ([Intimidation](/compendium/rules/skills.md#Intimidation)) or Charisma ([Persuasion](/compendium/rules/skills.md#Persuasion)) check you make when interacting with fiends.

When you reach 10th level in this class, you can add your Strength modifier to any Charisma ([Intimidation](/compendium/rules/skills.md#Intimidation)) check you make when interacting with any creature, instead of only fiends.

### Infernal Warrior (Level 6)

By 6th level, the infernal fire within you burns hot even while you're not raging. You gain resistance to fire damage.

In addition, when you use the [Attack](/compendium/rules/actions.md#Attack) action to [grapple](/compendium/rules/actions.md#Grapple) a creature while you're raging, the target takes your Hellfire Claw's fire damage if your grapple check succeeds, and again at the end of each of that creature's turns while it remains [grappled](/compendium/rules/conditions.md#Grappled).

### Planar Conspirator (Level 10)

At 10th level, you can make minor deals with an interested archfiend or similar power to peer into the minds of other creatures and exploit their fears. You can use an action to spend 2 Hit Dice, without regaining any hit points, to cast the [detect thoughts](compendium/spells/detect-thoughts.md) spell. The DC for this spell is equal to 8 + your proficiency bonus + your Constitution modifier.

### Incinerating Wrath (Level 14)

Starting at 14th level, when you take damage from a creature that you can see within 60 feet of you while you're raging, you can use your reaction to release a punishing flame from your claw toward them, duplicating the effect of the [hellish rebuke](compendium/spells/hellish-rebuke.md) spell (3rd-level version, DC 8 + your proficiency bonus + your Constitution modifier). You can use this ability twice per rage.