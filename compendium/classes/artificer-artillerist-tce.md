...
| [Protector](compendium/objects/eldritch-cannon-protector-tce.md) | The cannon emits a burst of positive energy that grants itself and each creature of your choice within 10 feet of it a number of temporary hit points equal to `dice:1d8\|noform\|avg` (`1d8`) + your Intelligence modifier (minimum of +1). |
^eldritch-cannons
