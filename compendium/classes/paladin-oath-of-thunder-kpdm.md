...
- subclass/paladin/thunder
aliases: ["Oath of Thunder"]
---
# Oath of Thunder
...
|---------------|--------|
| 3rd | [heroism](compendium/spells/heroism.md), [thunderwave](compendium/spells/thunderwave.md) |
| 5th | [find steed](compendium/spells/find-steed.md), [gust of wind](compendium/spells/gust-of-wind.md) |
| 9th | [call lightning](compendium/spells/call-lightning.md), [elemental weapon](compendium/spells/elemental-weapon.md) |
| 13th | [freedom of movement](compendium/spells/freedom-of-movement.md), [stoneskin](compendium/spells/stoneskin.md) |
| 17th | [conjure volley](compendium/spells/conjure-volley.md), [swift quiver](compendium/spells/swift-quiver.md) |
^oath-of-thunder-spells
...
### Strike Like Lightning (Level 15)
...
- You don't have disadvantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks because of armor.  
- You have advantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks and initiative rolls.  
- Your weapon attacks deal an additional `dice:1d10|noform|avg` (`1d10`) lightning or thunder damage (your choice when you hit).  
- As an action, you can unleash a terrifying war cry. Every enemy creature in a 30-foot cone must make a successful Wisdom saving throw or become [frightened](/compendium/rules/conditions.md#Frightened) of you for 1 minute. While [frightened](/compendium/rules/conditions.md#Frightened) in this way, the creature must spend its turn trying to move as far away from you as it can. It can't take reactions. For its action, it can only use the [Dash](/compendium/rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the [Dodge](/compendium/rules/actions.md#Dodge) action. A [frightened](/compendium/rules/conditions.md#Frightened) creature that's more than 30 feet from you and can't see you repeats the saving throw at the start of its turn, ending the effect on itself on a success. A creature that succeeds on its saving throw can't be affected by this war cry for 24 hours.  
