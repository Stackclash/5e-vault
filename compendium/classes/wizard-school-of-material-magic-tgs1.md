...
- subclass/wizard/material-magic
aliases: 
...
Beginning at 2nd level, you have dedicated your studies to creation and the magic surrounding it. You gain proficiency with three artisan's tools of your choice and you learn the [mending](/compendium/spells/mending.md) cantrip. If you already know this cantrip, you learn a different wizard cantrip of your choice. The cantrip doesn't count against your number of cantrips known.
...
- *(Armor only)* If the armor would normally impose disadvantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks, it does not.  
