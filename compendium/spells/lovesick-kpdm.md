...
| 4-5 | The creature bursts into tears, takes the [Dash](/compendium/rules/actions.md#Dash) action, and uses all its movement to run off in a random direction. To determine the direction, roll a `dice:d8\|noform\|noparens\|avg` (`d8`) and assign a direction to each die face. |
...
| 7-8 | The creature drops anything it is holding in its hands and passionately embraces a randomly determined creature. Treat this as a grapple attempt which uses the [Attack](/compendium/rules/actions.md#Attack) action. |
...
**Classes**: [Sorcerer](/compendium/lists/list-spells-classes-sorcerer.md); [Wizard](/compendium/lists/list-spells-classes-wizard.md); [Cleric (Lust Domain)](/compendium/lists/list-spells-classes-lust-domain-kpdm.md "subclass=KPDM"); [Cleric](/compendium/lists/list-spells-classes-cleric.md); [Warlock](/compendium/lists/list-spells-classes-warlock.md); [Bard](/compendium/lists/list-spells-classes-bard.md)
