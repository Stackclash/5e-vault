...
The more you draw on the link, the harder it is to maintain. Each spell you cast in this manner decreases the duration of this spell's casting by 10 minutes per level of the spell you cast using the link. For example, if you cast a [fireball](/compendium/spells/fireball.md) spell using the link, you would not expend a spell slot in the casting, but the duration of this spell would decrease by 30 minutes. If you cast a spell using the link and your remaining duration is equal to or less than the spell's level × 10 minutes, then this spell ends as soon as that spell is cast.
