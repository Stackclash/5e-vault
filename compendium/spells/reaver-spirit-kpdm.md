...
When the spell ends, each affected creature must succeed on a Constitution saving throw or gain `dice:1d4|noform|avg` (`1d4`) levels of [exhaustion](/compendium/rules/conditions.md#Exhaustion).
...
**Classes**: [Bard](list-spells-classes-bard); [Cleric](list-spells-classes-cleric); [Druid](list-spells-classes-druid); [Ranger](list-spells-classes-ranger)
