...
**Classes**: [Artificer](list-spells-classes-artificer); [Bard](list-spells-classes-bard); [Cleric](list-spells-classes-cleric); [Druid](list-spells-classes-druid); [Paladin](list-spells-classes-paladin); [Sorcerer (Divine Soul)](list-spells-classes-sorcerer-divine-soul-xge); [Cleric (Festus Domain)](list-spells-classes-cleric-festus-domain-griffonssaddlebag2); [Wizard (Hedge Mage)](list-spells-classes-wizard-hedge-mage-griffonssaddlebag3)
