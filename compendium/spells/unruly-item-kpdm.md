...
**Armor:** The creature's armor shifts and moves, becoming noisy and uncomfortable. If the armor does not normally impart disadvantage on Dexterity ([Stealth](/compendium/rules/skills.md#Stealth)) checks, it does so while this spell is in effect. The creature wearing it must succeed on a Dexterity saving throw or take a 10-foot penalty to its speed and be unable to use the [Dash](/compendium/rules/actions.md#Dash) action.
