...
If your [concentration](/compendium/rules/conditions.md#concentration) ends before the spell reaches its full duration, the devil doesn't disappear if it has become immune to your verbal commands. Instead, it acts in whatever manner it chooses for `dice: 3d6|avg` (`3d6`) minutes, and then it disappears.
