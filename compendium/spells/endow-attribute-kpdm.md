...
The spell ends if you lose concentration before the transfer takes place, if either the target or the recipient dies, or if either the target or the recipient is affected by a successful [dispel magic](compendium/spells/dispel-magic.md) spell. When the spell ends, the ability score points return to the original owner. Before then, that creature can't regain the stolen attribute points, even with [greater restoration](compendium/spells/greater-restoration.md) or comparable magic.
