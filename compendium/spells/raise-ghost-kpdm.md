...
A creature affected by *raise ghost* is restored to normal, physical life by [raise dead](/compendium/spells/raise-dead.md) or comparable magic. *Raise ghost* has no effect if cast on an undead creature.

**Classes**: [Cleric](/compendium/lists/list-spells-classes-cleric.md); [Paladin](/compendium/lists/list-spells-classes-paladin.md); [Warlock](/compendium/lists/list-spells-classes-warlock.md); [Bard](/compendium/lists/list-spells-classes-bard.md)
