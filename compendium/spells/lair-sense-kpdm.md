...
**Classes**: [Bard](list-spells-classes-bard); [Wizard](list-spells-classes-wizard); [Rogue (Arcane Trickster)](list-spells-classes-rogue-arcane-trickster); [Cleric (Dragon Domain)](list-spells-classes-cleric-dragon-domain-kpdm); [Fighter (Eldritch Knight)](list-spells-classes-fighter-eldritch-knight)
