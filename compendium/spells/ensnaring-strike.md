...
While [restrained](/compendium/rules/conditions.md#Restrained) by this spell, the target takes `dice:1d6|noform|noparens|avg` (`d6`) piercing damage at the start of each of its turns. A creature [restrained](/compendium/rules/conditions.md#Restrained) by the vines or one that can touch the creature can use its action to make a Strength check against your spell save DC. On a success, the target is freed.
...
**Classes**: [Paladin (Oath of the Ancients)](/compendium/lists/list-spells-classes-oath-of-the-ancients.md); [Ranger](/compendium/lists/list-spells-classes-ranger.md); [Bard](/compendium/lists/list-spells-classes-bard.md)
