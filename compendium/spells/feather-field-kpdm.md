...
time: 1 reaction
duration: 1 round
components: V, S, fletching from an arrow
aliases: ["Feather Field"]
---
# Feather Field
...
**Classes**: [Bard](list-spells-classes-bard); [Druid](list-spells-classes-druid); [Ranger](list-spells-classes-ranger); [Warlock](list-spells-classes-warlock); [Wizard](list-spells-classes-wizard); [Rogue (Arcane Trickster)](list-spells-classes-rogue-arcane-trickster)
