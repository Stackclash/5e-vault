...
The creature takes `dice: 10d6|avg` (`10d6`) poison damage on a failed save, or half as much damage on a successful one. A [passwall](/compendium/spells/passwall.md) spell, or another spell of equal or greater level that can open a portal on a solid surface, destroys this layer.
