...
Metal constructs, as well as creatures wearing metal armor (according to DM discretion) are [paralyzed](/compendium/rules/conditions.md#Paralyzed). An affected creature or construct can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. A [grease](compendium/spells/grease.md) spell dispels *lock armor* on everything in its area.
