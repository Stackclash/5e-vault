...
**Classes**: [Bard](list-spells-classes-bard); [Wizard](list-spells-classes-wizard); [Cleric (Beer Domain)](list-spells-classes-cleric-beer-domain-kpdm); [Druid (Circle of Owls)](list-spells-classes-druid-circle-of-owls-kpdm); [Sorcerer (Fey Soul)](list-spells-classes-sorcerer-fey-soul-griffonssaddlebag3); [Cleric (Prophecy Domain)](list-spells-classes-cleric-prophecy-domain-kpdm); [Warlock (The Shapechanger)](list-spells-classes-warlock-the-shapechanger-griffonssaddlebag4); [Cleric (Time Domain)](list-spells-classes-cleric-time-domain-kpdm); [Cleric (Trickery Domain)](list-spells-classes-cleric-trickery-domain)
