...
When a creature enters the affected area for the first time on a turn or starts its turn there, the creature must succeed on a Dexterity saving throw or take `dice: 3d6|avg` (`3d6`) bludgeoning damage and be [restrained](/compendium/rules/conditions.md#restrained) by the tentacles until the spell ends. A creature that starts its turn in the area and is already [restrained](/compendium/rules/conditions.md#restrained) by the tentacles takes `dice: 3d6|avg` (`3d6`) bludgeoning damage.
