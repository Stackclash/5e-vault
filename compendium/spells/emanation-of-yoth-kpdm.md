...
components: V, S, a fistful of grave earth and a vial of child's blood
aliases: ["Emanation of Yoth"]
---
# Emanation of Yoth
...
You call forth a [ghost](compendium/bestiary/undead/ghost.md) that takes the form of a spectral, serpent-like assassin. It appears in an unoccupied space that you can see within range. The ghost disappears when it's reduced to 0 hit points or when the spell ends.
...
**At Higher Levels.** When you cast this spell using a spell slot of 6th or 7th level, you call forth two [ghosts](compendium/bestiary/undead/ghost.md). If you cast it using a spell slot of 8th or 9th level, you call forth three ghosts.
