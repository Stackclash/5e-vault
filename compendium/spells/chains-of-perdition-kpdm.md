...
components: V, S, a few links of iron chain
aliases: ["Chains of Perdition"]
---
# Chains of Perdition
...
Lengths of iron chain appear near a creature you choose within range, possibly ensnaring the target and causing it physical and mental suffering. The targeted creature must succeed on a Dexterity saving throw or be [restrained](/compendium/rules/conditions.md#Restrained) by the chains and take `dice:2d8|noform|avg` (`2d8`) bludgeoning damage and `dice:2d8|noform|avg` (`2d8`) psychic damage. The creature takes this damage on your turn every round that it remains [restrained](/compendium/rules/conditions.md#Restrained) by the chains. On its turn, a [restrained](/compendium/rules/conditions.md#Restrained) creature can make a Strength or Dexterity check (its choice) against your spell save DC. On a success, it frees itself.
...
**At Higher Levels.** When you cast this spell using a spell slot of 4th level or higher, the spell deals an extra `dice:1d8|noform|avg|text(1d8)` bludgeoning damage and `dice:1d8|noform|avg|text(1d8)` psychic damage for every two slot levels above 3rd.
