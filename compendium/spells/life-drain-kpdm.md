...
**At Higher Levels.** When you cast this spell using a spell slot of 7th level or higher, the vortex's damage increases by `dice:1d6|noform|noparens|avg|text(d6)` for each slot level above 6th.
