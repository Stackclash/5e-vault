...
| dice: d10 | Effect |
|-----------|--------|
| 1-2 | The creature is affected as if by a [slow](/compendium/spells/slow.md) spell until the start of its next turn. |
| 3-5 | The creature is [stunned](/compendium/rules/conditions.md#Stunned) until the start of its next turn. |
