...
**At Higher Levels.** When you cast this spell using a spell slot of 3rd level or higher, the weapon deals an extra `dice:1d8|noform|avg|text(1d8)` force damage for each slot level above 2nd.
