...
If this spell is cast on a corpse, its effect is identical to that of [gentle repose](/compendium/spells/gentle-repose.md), except that the corpse's appearance is restored to that of a healthy, uninjured (albeit dead) person.
...
**Classes**: [Rogue (Arcane Trickster)](/compendium/lists/list-spells-classes-arcane-trickster.md); [Sorcerer (Divine Soul)](/compendium/lists/list-spells-classes-divine-soul-xge.md "subclass=XGE"); [Fighter (Eldritch Knight)](/compendium/lists/list-spells-classes-eldritch-knight.md); [Wizard](/compendium/lists/list-spells-classes-wizard.md); [Cleric](/compendium/lists/list-spells-classes-cleric.md); [Bard](/compendium/lists/list-spells-classes-bard.md)
