...
If one creature wants to jump onto another creature, it can do so by [grappling](/compendium/rules/actions.md#Grapple). A small or Medium creature has little chance of making a successful grapple against a Huge or Gargantuan creature, however, unless magic has granted the grappler supernatural might.
...
This action is an optional addition to the game, from the optional/variant rule [Healing](/compendium/rules/variant-rules/healing.md).
...
This action is an optional addition to the game, from the optional/variant rule [Spellcasting](/compendium/rules/variant-rules/spellcasting-xge.md).
