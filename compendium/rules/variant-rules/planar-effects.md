...
If a corrupted creature doesn't leave the plane within `dice: 1d4 + 2|avg` (`1d4 + 2`) days, its alignment changes to chaotic evil. Casting the [dispel evil and good](/compendium/spells/dispel-evil-and-good.md) spell on the creature restores its original alignment.
...
A larva is a miserable fiend that retains the facial features of its previous form but has the body of a fat worm. A larva has only a few faint memories of its previous life and the statistics in the [larva](/compendium/bestiary/fiend/larva.md) stat block. Hades is crawling with larvae. Night hags, liches, and rakshasas harvest them for use in vile rituals. Other fiends like to feed on them.
