...
Characters can use their monetary treasure to purchase anything from the equipment lists in chapter 5 of the "Player's Handbook". In addition, the Adventurers League allows characters to purchase potions and spell scrolls, as detailed below. A [spell scroll](compendium/items/spell-scroll-dmg.md) can be purchased only by a character who is capable of casting the spell in question.
