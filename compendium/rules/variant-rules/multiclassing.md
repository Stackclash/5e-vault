...
![Multiclassing Prerequisites](compendium/tables/multiclassing-prerequisites.md)
...
You add together the Hit Dice granted by all your classes to form your pool of Hit Dice. if the Hit Dice are the same die type, you can simply pool them together. For example, both the fighter and the paladin have a `dice:d10|noform|avg` (`d10`), so if you are a paladin 5/fighter 5, you have ten `dice:d10|noform|avg` (`d10`) Hit Dice. If your classes give you Hit Dice of different types, keep track of them separately. If you are a paladin 5/cleric 5, for example, you have five `dice:d10|noform|avg` (`d10`) Hit Dice and five `dice:d8|noform|avg` (`d8`) Hit Dice.
...
![Multiclassing Proficiencies](compendium/tables/multiclassing-proficiencies.md)
