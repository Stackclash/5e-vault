...
- The target is unable to perform a certain kind of act involving fine motor control, such as tying knots, writing, playing an instrument, sewing, or casting spells that have somatic components. When this curse ends, the Vistana takes `dice:1d6|noform|noparens|avg` (`1d6`) psychic damage.  
- The target's appearance changes in a sinister yet purely cosmetic way. For example, the curse can place a scar on the target's face, turn the target's teeth into yellow fangs, or give the target bad breath. When this curse ends, the Vistana it takes `dice:1d6|noform|noparens|avg` (`1d6`) psychic damage.  
- A nonmagical item in the target's possession (chosen by the DM) disappears and can't be found until the curse ends. The lost item can weigh no more than 1 pound. When this curse ends, the Vistana takes `dice:1d6|noform|noparens|avg` (`1d6`) psychic damage.  
...
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [[/5. Mechanics/Bestiary/Beast/Swarm Of Ravens.md\|swarm of ravens]] (50%) or 1 [[/5. Mechanics/Bestiary/Humanoid/Wereraven (VRGR).md\|wereraven]] (see appendix D) in raven form (50%) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Beast/Dire Wolf.md\|dire wolves]] |
| 13 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [[/5. Mechanics/Bestiary/Beast/Wolf.md\|wolves]] |
| 14 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [[/5. Mechanics/Bestiary/Humanoid/Berserker.md\|berserkers]] |
| 15 | Corpse |
| 16 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Humanoid/Werewolf.md\|werewolves]] in human form |
...
| 19 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Construct/Scarecrow.md\|scarecrows]] |
...
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [[/5. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|swarm of bats]] |
| 10 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Beast/Dire Wolf.md\|dire wolves]] |
| 11 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [[/5. Mechanics/Bestiary/Beast/Wolf.md\|wolves]] |
| 12 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [[/5. Mechanics/Bestiary/Humanoid/Berserker.md\|berserkers]] |
...
| 15 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Humanoid/Werewolf.md\|werewolves]] in wolf form |
| 16 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [[/5. Mechanics/Bestiary/Undead/Zombie.md\|zombies]] |
| 17 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [[/5. Mechanics/Bestiary/Construct/Scarecrow.md\|scarecrows]] |
| 18 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [[/5. Mechanics/Bestiary/Undead/Strahd Zombie (COS).md\|Strahd zombies]] (see appendix D) |
...
The wereraven belongs to a secret order called the Keepers of the Feather. If the characters don't spot it, the wereraven shadows them for `dice:1d4|noform|noparens|avg` (`1d4`) hours. At the end of that time, or anytime sooner if the characters attack it, the creature flies home to report what it has seen.
...
| 17–19 | Sack containing `dice:3d6\|noform\|noparens\|avg` (`3d6`) pieces of cheap jewelry worth 25 gp total and `dice:1d6\|noform\|noparens\|avg` (`1d6`) pieces of fine jewelry worth 250 gp each |
