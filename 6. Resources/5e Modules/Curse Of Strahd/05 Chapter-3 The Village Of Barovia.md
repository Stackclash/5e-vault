...
If the characters explore a residence other than [[4. World Almanac/NPCs/Mad Mary (COS).md\|Mad Mary]]'s townhouse (area E3) or the burgomaster's mansion (area E4), roll a `dice: d20|avg` (`d20`) and consult the following table to determine the house's occupants.
