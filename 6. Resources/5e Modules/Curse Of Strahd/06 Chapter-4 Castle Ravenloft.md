...
| 6 | `dice: 1d4 + 1` (`1d4 + 1`) [[/5. Mechanics/Bestiary/Construct/Flying Sword.md|flying swords]] |
| 7 | Blinsky toy |
| 8 | [[/5. Mechanics/Spells/Unseen Servant.md|Unseen servant]] |
| 9 | `dice: 1d4` (`1d4`) [[/5. Mechanics/Bestiary/Humanoid/Barovian Commoner (COS).md|commoners]] |
| 10 | `dice: 2d6` (`2d6`) [[/5. Mechanics/Bestiary/Undead/Crawling Claw.md|crawling claws]] |
| 11 | `dice: 1d6` (`1d6`) [[/5. Mechanics/Bestiary/Undead/Shadow.md|shadows]] |
| 12 | `dice: 1d6` (`1d6`) [[/5. Mechanics/Bestiary/Beast/Swarm Of Bats.md|swarms of bats]] |
| 13 | 1 crawling [[/5. Mechanics/Bestiary/Undead/Strahd Zombie (COS).md|Strahd zombie]] (see appendix D) |
| 14 | `dice: 1d4 + 1` (`1d4 + 1`) Vistani [[/5. Mechanics/Bestiary/Humanoid/Vistana Thug (COS).md|thugs]] |
| 15 | `dice: 1d4` (`1d4`) [[/5. Mechanics/Bestiary/Undead/Wight.md|wights]] |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [[/5. Mechanics/Bestiary/Humanoid/Barovian Witch (COS).md|Barovian witch]] (see appendix D) |
| 19 | `dice: 1d4 + 1` (`1d4 + 1`) [[/5. Mechanics/Bestiary/Undead/Vampire Spawn.md|vampire spawn]] |
...
[[/5. Mechanics/Bestiary/Npc/Rahadin (COS).md|Rahadin]] directs the characters to a random location in the castle, determined by rolling a `dice: d6` (`d6`):
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [[/5. Mechanics/Spells/Unseen Servant.md|unseen servant]] spell in the "Player's Handbook"). Roll a `dice: d6` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking 44 (`dice: 8d10` (`8d10`)) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [[/5. Mechanics/Items/Potion Of Healing.md|potion of healing]]. |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice: 1d4` (`1d4`) hungry [[/5. Mechanics/Bestiary/Undead/Vampire Spawn.md|vampire spawn]] (see below), which arrive in `dice: 1d4 + 1` (`1d4 + 1`) rounds. |
...
The wights carry longswords that have the crest of Barovia worked into their cross guards. Each wight also carries a pouch holding `dice: 2d20` (`2d20`) ep, each coin of Barovian mintage and featuring the profiled visage of [[/5. Mechanics/Bestiary/Npc/Strahd Von Zarovich (COS).md|Strahd von Zarovich]].
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `dice: 1d6` (`1d6`) [[/5. Mechanics/Bestiary/Undead/Shadow.md|shadows]] |
| 2 | `dice: 1d4` (`1d4`) [[/5. Mechanics/Bestiary/Undead/Vampire Spawn.md|vampire spawn]] |
| 3 | `dice: 1d4` (`1d4`) [[/5. Mechanics/Bestiary/Undead/Wight.md|wights]] |
| 4 | 1 [[/5. Mechanics/Bestiary/Undead/Wraith.md|wraith]] and `dice: 1d4 + 1` (`1d4 + 1`) [[/5. Mechanics/Bestiary/Undead/Specter.md|specters]] |
^creature
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice: 1d4` (`1d4`) [[/5. Mechanics/Bestiary/Humanoid/Barovian Witch (COS).md|Barovian witches]] from area K56. They try to subdue the party with [[/5. Mechanics/Spells/Sleep.md|sleep]] spells. A witch retreats to area K56 if wounded.
...
Each witch carries a [[/5. Mechanics/Items/Potion Of Healing.md|potion of healing]] that she made herself. There is a 30|30 percent% chance chance that a potion has "gone bad," in which case it's actually a [[/5. Mechanics/Items/Potion Of Poison.md|potion of poison]].
...
The light in the hall comes from a lantern on the floor behind Cyrus. If the characters have their own light sources, Cyrus sees them, but he will not attack first. He wears a loop of twine around his neck, hanging from which is an iron key and a decorative wooden pendant fitted with a varnished human eyeball. The key unlocks the iron chest in area K60. The wooden pendant is a _hag eye_ given to Cyrus by the [[/5. Mechanics/Bestiary/Fiend/Night Hag.md|night hag]] [[/5. Mechanics/Bestiary/Npc/Morgantha (COS).md|Morgantha]] (see chapter 6), so that she could spy on Strahd. Cyrus doesn't know that the necklace is magical. See the "Hag Covens" sidebar in the hags entry in the "Monster Manual" for information about the _hag eye_.
...
The catacombs are home to tens of thousands of bats. The bats hang here during daytime hours and fly out in the evening through the high tower's central shaft (area K18a) to hunt at night. They will not attack intruders unless they are provoked or are specifically commanded to do so by Strahd. If one or more bats within a 10-foot square on the map are attacked or caught in the area of a harmful spell, `dice: 2d4` (`2d4`) [[/5. Mechanics/Bestiary/Beast/Swarm Of Bats.md|swarms of bats]] form in that area and attack. No more swarms can be formed in that square until the next dawn, when more bats arrive to replenish those that were killed.
...
If the sword is pulled from the armor, Sir Klutz appears as a [[/5. Mechanics/Bestiary/Undead/Phantom Warrior (COS).md|phantom warrior]] (see appendix D), thanks whoever pulled his weapon free, and agrees to fight alongside that character for the next seven days. Sir Klutz perished years before Strahd became a vampire, so the phantom warrior knows nothing of Strahd's downfall or the curse afflicting Barovia.
