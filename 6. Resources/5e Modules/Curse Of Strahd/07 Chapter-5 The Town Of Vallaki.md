...
Each of these wagons contains `dice: 1d4|avg` (`1d4`) sleeping Vistani (CN male and female human [[5. Mechanics/Bestiary/Humanoid/Vistana Bandit (COS).md\|bandits]]). These Vistani wake up if their wagon is shaken or if they take damage and have at least 1 hit point remaining.
...
Each of these wagons contains one Vistani adult (male or female human [[5. Mechanics/Bestiary/Humanoid/Vistana Commoner (COS).md\|commoner]]) and `dice: 1d4 + 1|avg` (`1d4 + 1`) Vistani children (male and female human noncombatants). The adult is watching the children playing games, teaching the children about their heritage, or telling a scary story to frighten the children.
