...
- **Accomplishing Story Goals.** The characters gain a level when they accomplish something significant, such lighting the beacon of Argynvostholt (chapter 7), thwarting the druids' ritual atop Yester Hill (chapter 14), or forging an alliance with [[5. Mechanics/Bestiary/Npc/Ezmerelda Davenir (COS).md|") (appendix D"]].  
...
- Allow the character who has the highest passive Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception|")"]] score to see, hear, or smell something that no one else can perceive.  
