...
If the druids and the berserkers are killed, their numbers are replenished as others return from forays into the Svalich Woods. At the end of each day, at dusk, `dice:1d4|noform|noparens|avg` (`1d4`)−1 druids and `dice:1d4|noform|noparens|avg` (`1d4`)−1 berserkers arrive until there are six of each.
