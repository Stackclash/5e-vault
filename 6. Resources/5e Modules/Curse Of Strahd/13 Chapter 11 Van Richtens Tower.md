...
The scaffolding can't support more than 200 pounds of weight. If it collapses, anyone standing on it falls 20 feet to the ground, taking `dice:1d6|noform|noparens|avg` (`1d6`) bludgeoning damage per 10 feet fallen plus an additional `dice:2d6|noform|noparens|avg` (`2d6`) piercing damage from the debris. A creature underneath the scaffolding must succeed on a DC 13 Dexterity saving throw or take `dice:4d6|noform|noparens|avg|text(14)` (`4d6`) bludgeoning damage from falling debris.
