...
The amber door to this room is sealed with an [[5. Mechanics\Spells\Arcane Lock.md|arcane lock]] spell. The password to suppress the spell is "Shalx." A character can push open the doors with a successful DC 25 Strength check. The door (AC 15, 30 hit points) can also be smashed. If the door is reduced to 0 hit points, necrotic energy fills the 30-foot cube directly in front of it. A creature in the area takes 22 (`dice: 4d10` (`4d10`)) necrotic damage, turning to dust and bones if reduced to 0 hit points.
