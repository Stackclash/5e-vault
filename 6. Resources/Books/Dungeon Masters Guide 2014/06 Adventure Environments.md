...
Use the characters' passive Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) scores to determine whether anyone in the party notices a secret door without actively searching for it. Characters can also find a secret door by actively searching the location where the door is hidden and succeeding on a Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) check. To set an appropriate DC for the check, see chapter 8.

##### Opening a Secret Door

Once a secret door is detected, a successful Intelligence ([[/5. Mechanics/Rules/Skills.md#Investigation\|Investigation]]) check might be required to determine how to open it if the opening mechanism isn't obvious. Set the DC according to the difficulty guidelines in chapter 8.
...
No ability check is required to spot a hazard unless it is hidden. A hazard that resembles something benign, such as a patch of slime or mold, can be correctly identified with a successful Intelligence ([[/5. Mechanics/Rules/Skills.md#Nature\|Nature]]) check. Use the guidelines in chapter 8 to set an appropriate DC for any check made to spot or recognize a hazard.
...
When the temperature is at or above 100 degrees Fahrenheit, a creature exposed to the heat and without access to drinkable water must succeed on a Constitution saving throw at the end of each hour or gain one level of [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]]. The DC is 5 for the first hour and increases by 1 for each additional hour.
...
A strong wind imposes disadvantage on ranged weapon attack rolls and Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) checks that rely on hearing. A strong wind also extinguishes open flames, disperses fog, and makes flying by nonmagical means nearly impossible. A flying creature in a strong wind must land at the end of its turn or fall.

A strong wind in a desert can create a sandstorm that imposes disadvantage on Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) checks that rely on sight.
...
The other hazards presented here can be identified with a successful Intelligence ([[/5. Mechanics/Rules/Skills.md#Nature\|Nature]]) check. Use the guidelines in chapter 8 to set an appropriate DC for any check made to spot or recognize a hazard.
...
A creature can be immersed in frigid water for a number of minutes equal to its Constitution score before suffering any ill effects. Each additional minute spent in frigid water requires the creature to succeed on a DC 10 Constitution saving throw or gain one level of [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]]. Creatures with resistance or immunity to cold damage automatically succeed on the saving throw, as do creatures that are naturally adapted to living in ice-cold water.
...
Slippery ice is difficult terrain. When a creature moves onto slippery ice for the first time on a turn, it must succeed on a DC 10 Dexterity ([[/5. Mechanics/Rules/Skills.md#Acrobatics\|Acrobatics]]) check or fall [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]].
...
Characters whose passive Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) scores are equal to or greater than the thief's Dexterity ([[/5. Mechanics/Rules/Skills.md#Sleight%20of%20Hand\|Sleight of Hand]]) check total catch the theft in progress.
...
Swimming through deep water is similar to traveling at high altitudes, because of the water's pressure and cold temperature. For a creature without a swimming speed, each hour spent swimming at a depth greater than 100 feet counts as 2 hours for the purpose of determining [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]]. Swimming for an hour at a depth greater than 200 feet counts as 4 hours.
...
Characters can row a boat for 8 hours per day, or can row longer at the risk of [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]] (as per the rules for a forced march in chapter 8 of the Player's Handbook). A fully crewed sailing vessel can sail all day, assuming its sailors work in shifts.
