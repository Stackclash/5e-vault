...
> Lisa suffered 8 casualties from the necromancer's army. She has to assign them to her levies first, which eliminates her levies (size `dice:1d8|noform|noparens|avg` (`1d8`)). She has assigned all her casualties, lost her levies, but still has the rest of her army.
> 
...
![[/5. Mechanics/Tables/Simple Warfare Simple Combat Resolution (SAF).md\|Simple Warfare; Simple Combat Resolution]]
