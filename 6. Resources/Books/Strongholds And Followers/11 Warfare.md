...
| Hurl Rocks | If this unit succeeds on an Attack check, it inflicts 2 casualties.  Against fortifications it inflicts `dice:1d6\|noform\|noparens\|avg` (`d6`) casualties. | 250 |
