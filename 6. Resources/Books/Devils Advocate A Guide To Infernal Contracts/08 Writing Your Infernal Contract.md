...
| 3 | a pan of baklava that always smells pleasant. Its 3 filo dough pages replenish every `dice:1d6\|noform\|noparens\|avg` (`1d6`) minutes and induce severe diarrhea when consumed. |
