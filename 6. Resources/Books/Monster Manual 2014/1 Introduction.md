...
The Saving Throws entry is reserved for creatures that are adept at resisting certain kinds of effects. For example, a creature that isn't easily [[/5. Mechanics/Rules/Conditions.md#Charmed\|charmed]] or [[/5. Mechanics/Rules/Conditions.md#Frightened\|frightened]] might gain a bonus on its Wisdom saving throws. Most creatures don't have special saving throw bonuses, in which case this section is absent.
...
The Skills entry is reserved for monsters that are proficient in one or more skills. For example, a monster that is very perceptive and stealthy might have bonuses to Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) and Dexterity ([[/5. Mechanics/Rules/Skills.md#Stealth\|Stealth]]) checks.
...
The Senses entry notes a monster's passive Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) score, as well as any special senses the monster might have. Special senses are described below.

#### Blindsight

A monster with [[/5. Mechanics/Rules/Senses.md#Blindsight\|blindsight]] can perceive its surroundings without relying on sight, within a specific radius. Creatures without eyes, such as grimlocks and gray oozes, typically have this special sense, as do creatures with echolocation or heightened senses, such as bats and true dragons.

If a monster is naturally blind, it has a parenthetical note to this effect, indicating that the radius of its [[/5. Mechanics/Rules/Senses.md#Blindsight\|blindsight]] defines the maximum range of its perception.

#### Darkvision

A monster with [[/5. Mechanics/Rules/Senses.md#Darkvision\|darkvision]] can see in the dark within a specific radius. The monster can see in dim light within the radius as if it were bright light, and in darkness as if it were dim light. The monster can't discern color in darkness, only shades of gray. Many creatures that live underground have this special sense.

#### Tremorsense

A monster with [[/5. Mechanics/Rules/Senses.md#Tremorsense\|tremorsense]] can detect and pinpoint the origin of vibrations within a specific radius, provided that the monster and the source of the vibrations are in contact with the same ground or substance. Tremorsense can't be used to detect flying or incorporeal creatures. Many burrowing creatures, such as ankhegs and umber hulks, have this special sense.

#### Truesight

A monster with [[/5. Mechanics/Rules/Senses.md#Truesight\|truesight]] can, out to a specific range, see in normal and magical darkness, see [[/5. Mechanics/Rules/Conditions.md#Invisible\|invisible]] creatures and objects, automatically detect visual illusions and succeed on saving throws against them, and perceive the original form of a shapechanger or a creature that is transformed by magic. Furthermore, the monster can see into the Ethereal Plane within the same range.
...
An innate spell can have special rules or restrictions. For example, a drow mage can innately cast the [[5. Mechanics/Spells/Levitate.md\|levitate]] spell, but the spell has a "self only" restriction, which means that the spell affects only the drow mage.
...
A monster can cast a spell from its list at a higher level if it has the spell slot to do so. For example, a drow mage with the 3rd level [[5. Mechanics/Spells/Lightning Bolt.md\|lightning bolt]] spell can cast it as a 5th-level spell by using one of its 5th-level spell slots.
...
When a monster takes its action, it can choose from the options in the Actions section of its stat block or use one of the actions available to all creatures, such as the [[/5. Mechanics/Rules/Actions.md#Dash\|Dash]] or [[/5. Mechanics/Rules/Actions.md#Hide\|Hide]] action, as described in the *Player's Handbook.*
...
> 
> A creature [[/5. Mechanics/Rules/Conditions.md#Grappled\|grappled]] by the monster can use its action to try to escape. To do so, it must succeed on a Strength ([[/5. Mechanics/Rules/Skills.md#Athletics\|Athletics]]) or Dexterity ([[/5. Mechanics/Rules/Skills.md#Acrobatics\|Acrobatics]]) check against the escape DC in the monster's stat block. If no escape DC is given, assume the DC is 10 + the monster's Strength ([[/5. Mechanics/Rules/Skills.md#Athletics\|Athletics]]) modifier.
...
A legendary creature can take a certain number of special actions-called legendary actions-outside its turn. Only one legendary action option can be used at a time and only at the end of another creature's turn. A legendary creature regains spent legendary actions at the start of its turn. It can forgo using them, and it can't use them while [[/5. Mechanics/Rules/Conditions.md#Incapacitated\|incapacitated]] or otherwise unable to take actions. If [[/5. Mechanics/Rules/Conditions.md#Surprised\|surprised]], it can't use them until after its first turn in the combat.
...
If a legendary creature has lair actions, it can use them to harness the ambient magic in its lair. On initiative count 20 (losing all initiative ties), it can use one of its lair action options. It can't do so while [[/5. Mechanics/Rules/Conditions.md#Incapacitated\|incapacitated]] or otherwise unable to take actions. If [[/5. Mechanics/Rules/Conditions.md#Surprised\|surprised]], it can't use one until after its first turn in the combat.
...
- [[5. Mechanics/Bestiary/Dragon/Faerie Dragon Green.md\|Faerie Dragon (Green)]]  
