...
journals.forEach((p,i) => {
    ...
    p.locations && p.locations.forEach((l,i2) => {
        console.log(l.path, previousJournal.locations, Array.from(history), previousJournal.locations ? l.path !== previousJournal.locations[previousJournal.locations.length-1].path : null)
