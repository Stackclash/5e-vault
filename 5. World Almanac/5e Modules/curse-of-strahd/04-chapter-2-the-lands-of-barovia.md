...
- A creature that starts its turn in the fog must succeed on a DC 20 Constitution saving throw or gain one level of [exhaustion](/6. Mechanics/rules/conditions.md#exhaustion) (see "appendix A" in the "Player's Handbook"). This [exhaustion](/6. Mechanics/rules/conditions.md#exhaustion) can't be removed while the creature is in the fog.  
...
The land of Barovia resides in its own demiplane, isolated from all other planes, including the Material Plane. No spell—not even [wish](/6. Mechanics/spells/wish.md)—allows one to escape from Strahd's domain. [Astral projection](/6. Mechanics/spells/astral-projection.md), [teleport](/6. Mechanics/spells/teleport.md), [plane shift](/6. Mechanics/spells/plane-shift.md), and similar spells cast for the purpose of leaving Barovia simply fail, as do effects that banish a creature to another plane of existence. These restrictions apply to magic items and artifacts that have properties that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](/6. Mechanics/spells/etherealness.md) spell and the Etherealness feature of incorporeal undead, is the exception to this rule. A creature that enters the Border Ethereal from Strahd's domain is pulled back into Barovia upon leaving that plane.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](/6. Mechanics/spells/sending.md)), Strahd's domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally in Barovia, as does magic that involves an extradimensional space. Any spells cast within such an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](/6. Mechanics/spells/mordenkainens-magnificent-mansion.md)) are subject to the same restrictions as magic cast in Barovia.
...
> [!quote] ...
> 
> [Alarm](/6. Mechanics/spells/alarm.md): Instead of hearing a mental ping when the alarm is triggered, the caster hears a scream.
> 
> [Bigby's hand](/6. Mechanics/spells/bigbys-hand.md): The conjured hand is skeletal.
> 
> [Find familiar](/6. Mechanics/spells/find-familiar.md): The familiar is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find steed](/6. Mechanics/spells/find-steed.md): The summoned steed is undead—not a celestial, fey, or fiend—and is immune to features that turn undead.
> 
> [Find the path](/6. Mechanics/spells/find-the-path.md): A child's spirit appears and guides the caster to the desired location. The spirit can't be harmed and doesn't speak.
> 
> [Fog cloud](/6. Mechanics/spells/fog-cloud.md): Misty, harmless claws form in the fog.
> 
> [Gust of wind](/6. Mechanics/spells/gust-of-wind.md): A ghastly moan accompanies the summoned wind.
> 
> [Mage hand](/6. Mechanics/spells/mage-hand.md): The summoned hand is skeletal.
> 
> [Maze](/6. Mechanics/spells/maze.md): The surfaces of the demiplane's maze are made of mortared skulls and bones.
> 
> [Phantom steed](/6. Mechanics/spells/phantom-steed.md): The steed resembles a skeletal horse.
> 
> [Rary's telepathic bond](/6. Mechanics/spells/rarys-telepathic-bond.md): Characters linked together by the spell can't shake the feeling that something vile is telepathically eavesdropping on them.
> 
> [Revivify](/6. Mechanics/spells/revivify.md): A creature restored to life by a [revivify](/6. Mechanics/spells/revivify.md) spell screams upon regaining consciousness, as though waking from some horrible nightmare.
> 
> [Spirit guardians](/6. Mechanics/spells/spirit-guardians.md): The spirits appear as ghostly, skeletal warriors.
> 
> [Wall of stone](/6. Mechanics/spells/wall-of-stone.md): A wall created by the spell has ghastly faces sculpted into it, as though tortured spirits were somehow trapped within the stone.
^0a7
...
[Ireena Kolyana](/6. Mechanics/bestiary/npc/ireena-kolyana-cos.md) and her brother Ismark both have souls, as do all Vistani. Which Barovians have souls and which don't is left up to you.
...
- [Strahd von Zarovich](/6. Mechanics/bestiary/npc/strahd-von-zarovich-cos.md) is a vampire, and he dwells in Castle Ravenloft. No one is welcome at the castle.  
...
- The town of Vallaki lies in the heart of the valley. Its burgomaster is named [Baron Vargas Vallakovich](/6. Mechanics/bestiary/npc/baron-vargas-vallakovich-cos.md).  
...
- Some Vistani women are blessed with prescience. Of all the great Vistani fortune-tellers, none compares to [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md). If knowledge of the future is what you seek, [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) will tell you your fate.  
...
The curse is a repayment for an injustice or a slight. The target must succeed on a Wisdom saving throw to avoid the curse. The saving throw DC is 8 + the Vistana's proficiency bonus + the Vistana's Charisma modifier. The curse lasts until ended with a [remove curse](/6. Mechanics/spells/remove-curse.md) spell, a [greater restoration](/6. Mechanics/spells/greater-restoration.md) spell, or similar magic. It doesn't end when the target dies. If a cursed target is returned to life, the curse remains in effect.
...
- The target is [blinded](/6. Mechanics/rules/conditions.md#blinded), [deafened](/6. Mechanics/rules/conditions.md#deafened), or both. When this curse ends, the Vistana takes `dice: 5d6|avg` (`5d6`) psychic damage.  

### Evil Eye

As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the [animal friendship](/6. Mechanics/spells/animal-friendship.md), [charm person](/6. Mechanics/spells/charm-person.md), or [hold person](/6. Mechanics/spells/hold-person.md) spell (Vistana's choice), but requires neither somatic nor material components. The spell save DC is 8 + the caster's proficiency bonus + the caster's Charisma modifier. If the target succeeds on the save, the Vistana is [blinded](/6. Mechanics/rules/conditions.md#blinded) until the end of the Vistana's next turn.
...
|----------------|------------------|-----------|
| 2 | `dice: 3d6|avg` (`3d6`) [commoners](/6. Mechanics/bestiary/humanoid/barovian-commoner-cos.md) |
| 3 | `dice: 1d6|avg` (`1d6`) [scouts](/6. Mechanics/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
| 7 | `dice: 1d4 + 1|avg` (`1d4 + 1`) [Vistani bandits](/6. Mechanics/bestiary/humanoid/vistana-bandit-cos.md) |
| 8 | Skeletal rider |
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice: 1d4|avg` (`1d4`) [swarm of ravens](/6. Mechanics/bestiary/beast/swarm-of-ravens.md) (50%) or 1 [wereraven](/6. Mechanics/bestiary/humanoid/wereraven-vrgr.md) (see appendix D) in raven form (50%) |
| 12 | `dice: 1d6|avg` (`1d6`) [dire wolves](/6. Mechanics/bestiary/beast/dire-wolf.md) |
| 13 | `dice: 3d6|avg` (`3d6`) [wolves](/6. Mechanics/bestiary/beast/wolf.md) |
| 14 | `dice: 1d4|avg` (`1d4`) [berserkers](/6. Mechanics/bestiary/humanoid/berserker.md) |
| 15 | Corpse |
| 16 | `dice: 1d6|avg` (`1d6`) [werewolves](/6. Mechanics/bestiary/humanoid/werewolf.md) in human form |
| 17 | 1 [druid](/6. Mechanics/bestiary/humanoid/druid.md) with `dice: 2d6|avg` (`2d6`) [twig blights](/6. Mechanics/bestiary/plant/twig-blight.md) |
| 18 | `dice: 2d4|avg` (`2d4`) [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) |
| 19 | `dice: 1d6|avg` (`1d6`) [scarecrows](/6. Mechanics/bestiary/construct/scarecrow.md) |
| 20 | 1 [revenant](/6. Mechanics/bestiary/undead/revenant.md) |
^daytime-random-encounters-in-barovia
...
| `dice: d12 + d8|avg` (`d12 + d8`) | Encounter |
|----------------|------------------|-----------|
| 2 | 1 [ghost](/6. Mechanics/bestiary/undead/ghost.md) |
| 3 | Hunting trap |
| 4 | Grave |
| 5 | Trinket |
| 6 | Corpse |
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice: 1d8|avg` (`1d8`) [swarm of bats](/6. Mechanics/bestiary/beast/swarm-of-bats.md) |
| 10 | `dice: 1d6|avg` (`1d6`) [dire wolves](/6. Mechanics/bestiary/beast/dire-wolf.md) |
| 11 | `dice: 3d6|avg` (`3d6`) [wolves](/6. Mechanics/bestiary/beast/wolf.md) |
| 12 | `dice: 1d4|avg` (`1d4`) [berserkers](/6. Mechanics/bestiary/humanoid/berserker.md) |
| 13 | 1 [druid](/6. Mechanics/bestiary/humanoid/druid.md) and `dice: 2d6|avg` (`2d6`) [twig blights](/6. Mechanics/bestiary/plant/twig-blight.md) |
| 14 | `dice: 2d4|avg` (`2d4`) [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) |
| 15 | `dice: 1d6|avg` (`1d6`) [werewolves](/6. Mechanics/bestiary/humanoid/werewolf.md) in wolf form |
| 16 | `dice: 3d6|avg` (`3d6`) [zombies](/6. Mechanics/bestiary/undead/zombie.md) |
| 17 | `dice: 1d6|avg` (`1d6`) [scarecrows](/6. Mechanics/bestiary/construct/scarecrow.md) |
| 18 | `dice: 1d8|avg` (`1d8`) [Strahd zombies](/6. Mechanics/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
| 19 | 1 [will-o'-wisp](/6. Mechanics/bestiary/undead/will-o-wisp.md) |
| 20 | 1 [revenant](/6. Mechanics/bestiary/undead/revenant.md) |
^nighttime-random-encounters-in-barovia
...
[Barovian commoners](/6. Mechanics/bestiary/humanoid/barovian-commoner-cos.md) rarely leave their settlements. This group might be a family looking for a safer place to live, or an angry mob searching for the characters or heading toward Castle Ravenloft to confront Strahd.

### Barovian Scouts

If at least one character has a passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) score of 16 or higher, read:
...
> 
> Every day and night that the characters remain in Barovia, one or more of the vampire's spies check on them and attempt to return to Strahd with a report. When a spy appears, characters who have a passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) score equal to or greater than the spy's Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) check notice it. A spy does not constitute an encounter if the characters are unaware of its presence. If they do notice it, the spy's goal is usually escape, not combat. A secondary goal for a spy might be to acquire some physical object—a possession, an article of clothing, or even some part of a character's body such as a lock of hair—that Strahd can use to improve the efficacy of his [scrying](/6. Mechanics/spells/scrying.md) spell. If one of Strahd's spies is confronted by the party, the spy attempts to grab some accessible item from a character before fleeing. If Strahd acquires such an item, he uses his [scrying](/6. Mechanics/spells/scrying.md) spell to learn as much as he can about the party before planning his next attack, and to verify what his spies have already told him.
^strahds-spies

### Berserkers

These wild mountain folk are covered head to toe in thick gray mud, which makes them hard to see in the fog and well hidden in the mountains they call home. While so camouflaged, they have advantage on Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) checks made to hide. Characters whose passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) scores are higher than the berserker's Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) check can spot the nearest [berserker](/6. Mechanics/bestiary/humanoid/berserker.md).
...
The area is lightly obscured by fog. If more than one dire wolf is present, the others aren't far behind and can be seen as dark shadows in the fog. The [dire wolves](/6. Mechanics/bestiary/beast/dire-wolf.md) of Barovia are cruel, overgrown wolves and Strahd's loyal servants. They can't be [charmed](/6. Mechanics/rules/conditions.md#charmed) or [frightened](/6. Mechanics/rules/conditions.md#frightened).
...
The Barovian wilderness is home to [druids](/6. Mechanics/bestiary/humanoid/druid.md) who worship Strahd because of his ability to control the weather and the beasts of Barovia. The druids are savage and violent, and each controls a host of [twig blights](/6. Mechanics/bestiary/plant/twig-blight.md), which fights until destroyed. If all the twig blights are destroyed or the druid loses more than half of its hit points, the druid flees, heading toward Yester Hill (area Y).
...
The [clothes](/6. Mechanics/items/common-clothes.md) have a drab Barovian style to them. They belong to a wereraven or werewolf.

### Hunting Trap

This encounter occurs only if the characters are traveling; otherwise, treat the result as no encounter.

Have each of the characters in the front rank of the party's marching order make a DC 15 Wisdom ([Survival](/6. Mechanics/rules/skills.md#Survival)) check. If one or more of them succeeds, read:
...
The woods crawl with [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) that serve the evil druids of Barovia. If the characters are moving quietly and not carrying light sources, they can try to hide from these blights.
...
If more than one [scarecrow](/6. Mechanics/bestiary/construct/scarecrow.md) is present, the others are close by. If none of the characters has a passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) score of 11 or higher, the scarecrows catch the party by surprise.

[Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md) (see chapter 10, area U3) crafted these scarecrows to hunt down and kill ravens and wereravens. The scarecrows are imbued with evil spirits and delight in murdering anyone they encounter.
...
The human [skeleton](/6. Mechanics/bestiary/undead/skeleton.md) and [warhorse skeleton](/6. Mechanics/bestiary/undead/warhorse-skeleton.md) are all that remain of a rider and mount, both of whom perished trying to escape through the fog that surrounds Barovia. They are doomed to ride through the valley in search of another way out, without hope of salvation. The skeletons ignore the characters unless attacked.
...
If the characters are moving quietly and not carrying light sources, they can try to hide from the [Strahd zombies](/6. Mechanics/bestiary/undead/strahd-zombie-cos.md). These undead soldiers once served as guards in Castle Ravenloft. They fled the castle after Strahd became a vampire but couldn't avoid their master's wrath. They still wear bits of tattered livery, and they attack the living on sight.
...
A random character finds a lost trinket. Roll on the [Trinkets table](/6. Mechanics/items/trinket-cos.md) in appendix A, select a specific trinket from the table, or create one on the fly.
...
This [wereraven](/6. Mechanics/bestiary/humanoid/wereraven-vrgr.md) in raven form watches the characters from a distance. Compare its Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) check result to the characters' passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) scores to see whether it remains hidden from the party.
...
How the [werewolves](/6. Mechanics/bestiary/humanoid/werewolf.md) act depends on the form they have taken.
...
Werewolves in wolf form follow the party from a safe distance for several hours. If their Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) checks exceed the characters' passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) scores, the werewolves attack with surprise when the characters decide to take a short or long rest. Otherwise, they wait until the characters are weakened by another random encounter before moving in for the easy kill.
...
The light is a [will-o'-wisp](/6. Mechanics/bestiary/undead/will-o-wisp.md) that enters the ruined tower and becomes [invisible](/6. Mechanics/rules/conditions.md#invisible), hoping to lure the characters inside to their doom.
...
If the characters disturb the chest, `dice: 3d6|avg` (`3d6`) [zombies](/6. Mechanics/bestiary/undead/zombie.md) erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
...
Characters have a few minutes to steel themselves before these [wolves](/6. Mechanics/bestiary/beast/wolf.md) attack. They heed the will of Strahd and can't be [charmed](/6. Mechanics/rules/conditions.md#charmed) or [frightened](/6. Mechanics/rules/conditions.md#frightened).
...
These unfortunate Barovians fell prey to the evils of the land and now shamble from place to place as a [ravenous mob](/6. Mechanics/bestiary/undead/zombie.md).
...
> [!gallery]
> ![Map 2.1: Barovia](/5. World Almanac/5e Modules/curse-of-strahd/img/007-001.jpg#gallery)
> ![Player Version](/5. World Almanac/5e Modules/curse-of-strahd/img/008-cos201.jpg#gallery)
...
> 
> **Secret Doors.** If there are obvious clues to a secret door's presence, such as scratch marks on a nearby wall or footprints leading to it, a character with a passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) score of 15 or higher notices the secret door. Otherwise, finding a secret door requires a search of the area and a successful DC 15 Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) check.
> 
...
If the characters are following the road on foot, the party member who has the highest passive Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) score notices something:
...
If the characters linger in the woods, they hear a lone wolf howl far off in the forest. Each round, one more wolf adds its voice to the howling, with the sound getting progressively closer to the party. If the characters are still in the woods after 5 rounds of howling, five [dire wolves](/6. Mechanics/bestiary/beast/dire-wolf.md) arrive and attack. If the characters are trying to leave Barovia, these dire wolves are joined by a pack of twenty [wolves](/6. Mechanics/bestiary/beast/wolf.md). The wolves and the dire wolves stop their attack if the characters return to the road and head toward the village of Barovia (area E).
...
The eight [draft horses](/6. Mechanics/bestiary/beast/draft-horse.md) drinking from the river are used to pull the Vistani wagons and aren't easily startled.
...
Twelve Vistani (male and female human [bandits](/6. Mechanics/bestiary/humanoid/vistana-bandit-cos.md)) are standing and sitting around the fire, telling stories and guzzling wine. They are intoxicated and have disadvantage on attack rolls and ability checks. Three sober Vistani (male and female human [bandit captains](/6. Mechanics/bestiary/humanoid/vistana-bandit-captain-cos.md)) are resting in three of the four wagons but leap quickly into action if an alarm is raised.
...
If the characters linger at the camp, continue with "A Vistana's Tale" below. If they seem in a hurry to leave, one of the Vistani tells them, "It was fated that you would visit our humble camp. [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) foretold your coming. She awaits you." The Vistana then points to the largest tent. If the characters head that way, continue with "[Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md)'s Tent."

> [!gallery]
> ![Map 2.2: Tser Pool Encampment](/5. World Almanac/5e Modules/curse-of-strahd/img/010-cos02-06.jpg#gallery)
> ![Player Version](/5. World Almanac/5e Modules/curse-of-strahd/img/011-cos202.jpg#gallery)
...
The Vistana storyteller doesn't remember the wizard's name, but recalls that it sounded important. If the characters haven't spoken with [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md), the storyteller urges them to do so.

#### Madam Eva's Tent

If the characters decide to see [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md), read:
...
[Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) (see appendix D) speaks the name of each party member and makes some reference to that individual's past deeds. She then asks the characters if they want their fortunes read. If they say yes, [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) produces a worn deck of cards and proceeds with the sequence outlined in chapter 1. (If the characters don't want a reading of their fates, continue play using the card reading you performed before starting the adventure.)

[Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) might seem mad, but she is, in fact, cunning and sharp of mind. She has met a good many adventurers in her time and knows they can't be fully trusted. She wants to free the land of Barovia from its curse, and her fate is interwoven with Strahd's (see appendix D for details). She does the vampire's bidding when called upon and does nothing to anger Strahd or bring harm to the Vistani. She never gives aid and never asks for any.
...
If your card reading reveals that a treasure is here, it is hidden in one of the Vistani wagons. [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) grants the characters permission to search the wagons if they ask, and any such search yields the treasure.
...
The two black [draft horses](/6. Mechanics/bestiary/beast/draft-horse.md) are under Strahd's control. The horses wait for the characters to pile into the carriage if they so desire. There is room inside for eight of them. If they get into the carriage, the horses draw it down the road to area J. The horses can't be discouraged from their course, not even by a skilled teamster.
...
A patch of green slime (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide") clings to the portcullis in the entry tunnel, and can be spotted with a successful DC 20 Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) check. The slime will not fall on characters entering the castle, but it does fall on the first character who leaves by this route.

### K. Castle Ravenloft

Chapter 4 explores Castle Ravenloft, lair of the vampire [Strahd von Zarovich](/6. Mechanics/bestiary/npc/strahd-von-zarovich-cos.md).
...
Each rowboat can safely hold five people. The person fishing on the lake is [Bluto Krogarov](/6. Mechanics/bestiary/npc/bluto-krogarov-cos.md) (NE male human [commoner](/6. Mechanics/bestiary/humanoid/commoner.md)), a resident of Vallaki. He is in a trance and doesn't respond to anything or anyone unless attacked. His boat is 400 feet from the nearest shore. Tied up in the boat is a seven-year-old Vistana named [Arabelle](/6. Mechanics/bestiary/npc/arabelle-cos.md) (LN female human [commoner](/6. Mechanics/bestiary/humanoid/vistana-commoner-cos.md) with 2 hit points and no effective attacks). She is bound with hempen rope, wrapped in a burlap sack, and lying [prone](/6. Mechanics/rules/conditions.md#prone) so that she can't be seen or heard from the shore.

#### Roleplaying Bluto

[Bluto Krogarov](/6. Mechanics/bestiary/npc/bluto-krogarov-cos.md) is a destitute drunkard. He's desperate to catch some fish and trade them for wine at the Blue Water Inn. After he was unable to catch a single fish for a week, he kidnapped [Arabelle](/6. Mechanics/bestiary/npc/arabelle-cos.md), believing that Vistani are lucky. He intends to sacrifice her to the lake, hoping it will give up some of its fish in return.
...
Characters who act quickly can save [Arabelle](/6. Mechanics/bestiary/npc/arabelle-cos.md) before she drowns. A character on the shore must succeed on a DC 15 Strength ([Athletics](/6. Mechanics/rules/skills.md#Athletics)) check to reach her in time. The DC is 10 for characters who took a rowboat out onto the lake.

[Arabelle](/6. Mechanics/bestiary/npc/arabelle-cos.md) has alabaster-white skin and raven-black hair. If rescued, she demands to be returned to her family's camp outside Vallaki (chapter 5, area N9). She is certain that her father, [Luvash](/6. Mechanics/bestiary/npc/luvash-cos.md), will give the characters a reward for doing so.

A descendant of [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) with the blood of Barovian royalty in her veins, [Arabelle](/6. Mechanics/bestiary/npc/arabelle-cos.md) is unaware of her connection to Strahd. She acts more like an adult than a child. Despite her recent misadventure, she believes that a great destiny awaits her.
...
[The Mad Mage of Mount Baratok](/6. Mechanics/bestiary/npc/the-mad-mage-of-mount-baratok-cos.md) (CN male human [archmage](/6. Mechanics/bestiary/humanoid/archmage.md)) came to Barovia more than a year ago to free its people from Strahd's tyranny, but he underestimated Strahd's hold over the land and the creatures in it. After a battle between the two in Castle Ravenloft, Strahd drove the Mad Mage to the mountains and sent the wizard hurling over Tser Falls (area H). The wizard, his staff and spellbook lost, survived the fall and retreated into the mountains, hoping to regain his power, only to be driven mad by the realization that he no longer has any hope of defeating Strahd or freeing the people of the vampire's damned realm.
...
Under normal circumstances, a [greater restoration](/6. Mechanics/spells/greater-restoration.md) spell cast on the Mad Mage would restore his wits and ends the madness, allowing him to remember that he is none other than Mordenkainen, an [archmage](/6. Mechanics/bestiary/humanoid/archmage.md) of Oerth and the leader of a powerful group of adventurers called the Circle of Eight. But in this case, the Mad Mage has cast a [mind blank](/6. Mechanics/spells/mind-blank.md) spell on himself. As long as that spell remains in effect, his sanity can't be restored by any spell. If the characters surmise that powerful magic is preventing them from restoring the Mad Mage's wits, they can, with a successful DC 15 Charisma ([Persuasion](/6. Mechanics/rules/skills.md#Persuasion)) check, convince the Mad Mage to divulge the reason why their spell failed. A character can also ascertain the cause of the spell's failure with a successful DC 18 Intelligence ([Arcana](/6. Mechanics/rules/skills.md#Arcana)) check. The Mad Mage's [mind blank](/6. Mechanics/spells/mind-blank.md) spell has a remaining duration of `dice: 3d6|avg` (`3d6`) hours, after which his madness can be cured normally.

The Mad Mage has a different spell list from that of the [archmage](/6. Mechanics/bestiary/humanoid/archmage.md) in the "Monster Manual", and he has already used one 1st-level spell slot to cast [mage armor](/6. Mechanics/spells/mage-armor.md) on himself, one 4th-level spell slot to cast [polymorph](/6. Mechanics/spells/polymorph.md) on himself, one 7th-level spell slot to cast [Mordenkainen's magnificent mansion](/6. Mechanics/spells/mordenkainens-magnificent-mansion.md) (see "The Mad Mage's Mansion"), and one 8th-level spell slot to cast [mind blank](/6. Mechanics/spells/mind-blank.md) on himself.

> [!quote] ...
> 
> Cantrips (at will): [fire bolt](/6. Mechanics/spells/fire-bolt.md), [light](/6. Mechanics/spells/light.md), [mage hand](/6. Mechanics/spells/mage-hand.md), [prestidigitation](/6. Mechanics/spells/prestidigitation.md), [shocking grasp](/6. Mechanics/spells/shocking-grasp.md)
> 
> 1st level (4 slots): [detect magic](/6. Mechanics/spells/detect-magic.md), [mage armor](/6. Mechanics/spells/mage-armor.md), [magic missile](/6. Mechanics/spells/magic-missile.md), [shield](/6. Mechanics/spells/shield.md)
> 
> 2nd level (3 slots): [mirror image](/6. Mechanics/spells/mirror-image.md), [misty step](/6. Mechanics/spells/misty-step.md), [web](/6. Mechanics/spells/web.md)
> 
> 3rd level (3 slots): [counterspell](/6. Mechanics/spells/counterspell.md), [fly](/6. Mechanics/spells/fly.md), [lightning bolt](/6. Mechanics/spells/lightning-bolt.md)
> 
> 4th level (3 slots): [Mordenkainen's faithful hound](/6. Mechanics/spells/mordenkainens-faithful-hound.md), [polymorph](/6. Mechanics/spells/polymorph.md), [stoneskin](/6. Mechanics/spells/stoneskin.md)
> 
> 5th level (3 slots): [Bigby's hand](/6. Mechanics/spells/bigbys-hand.md), [cone of cold](/6. Mechanics/spells/cone-of-cold.md), [scrying](/6. Mechanics/spells/scrying.md)
> 
> 6th level (1 slot): [true seeing](/6. Mechanics/spells/true-seeing.md)
> 
> 7th level (1 slot): [Mordenkainen's magnificent mansion](/6. Mechanics/spells/mordenkainens-magnificent-mansion.md)
> 
> 8th level (1 slot): [mind blank](/6. Mechanics/spells/mind-blank.md)
> 
> 9th level (1 slot): [time stop](/6. Mechanics/spells/time-stop.md)
^128

#### The Mad Mage's Mansion

If the characters rescue the [archmage](/6. Mechanics/bestiary/humanoid/archmage.md) from his madness, he invites them to his "mansion." He leads them up the mountain to an invisible doorway that serves as the entrance to his extradimensional lair, created using the [Mordenkainen's magnificent mansion](/6. Mechanics/spells/mordenkainens-magnificent-mansion.md) spell. There, he provides them with food and sanctuary away from the prying eyes of Strahd and his spies. Characters are free to take a short or long rest, during which time they aren't disturbed.
...
If Mordenkainen isn't the party's ally as foretold in [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md)'s card reading (see chapter 1), he declines to join them if asked. With his wits restored, he sets out to find his missing staff and spellbook, leaving the characters on their own. He doesn't allow them to help him, for he fears they might be tempted to steal either his staff or his spellbook. (Being an adventurer himself, he knows how the lure of powerful magic can bring out the worst in adventurers.) Before he leaves, as a parting gift, the [archmage](/6. Mechanics/bestiary/humanoid/archmage.md) imbues each character with a _charm of heroism_ (see ""Supernatural Gifts"" in chapter 7 of the "Dungeon Master's Guide").
...
The [archmage](/6. Mechanics/bestiary/humanoid/archmage.md) has never had his fortune read by [Madam Eva](/6. Mechanics/bestiary/npc/madam-eva-cos.md) and doesn't care to, but if he is told about the [Holy Symbol of Ravenkind](/6. Mechanics/items/holy-symbol-of-ravenkind-cos.md), the [Tome of Strahd](/6. Mechanics/items/tome-of-strahd-cos.md), and the [Sunsword](/6. Mechanics/items/sunsword-cos.md), he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.
...
Chapter 10 describes the ruins of Berez, a riverside village that is now home to the hag [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md).
