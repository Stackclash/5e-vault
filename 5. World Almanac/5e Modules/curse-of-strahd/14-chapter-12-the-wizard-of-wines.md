...
Strahd bequeathed the winery and vineyard to the noble Krezkov family as a reward for the family's loyalty. Later, an arranged marriage between the Krezkovs and the Martikov family led to the land being taken over by a Martikov descendant. The winery and vineyard have been tended by the Martikovs ever since. At some point, the Martikov family became infected with widespread lycanthropy. The current patriarch, [Davian Martikov](/6. Mechanics/bestiary/npc/davian-martikov-cos.md), is a wereraven, as are his children and grandchildren.
...
The winery is known for three wines: the unremarkable Purple Grapemash No. 3, the slightly more tantalizing Red Dragon Crush, and the rich Champagne du le Stomp. Ten years ago, one of the vineyard's magic gems was dug up and stolen, and as a result, the winery stopped producing its best vintage, the champagne. No one knows what happened to the gem. [Davian Martikov](/6. Mechanics/bestiary/npc/davian-martikov-cos.md) blames his middle son, Urwin (see chapter 5, area N2), for the loss because Urwin was on watch the night the gem was taken. Davian is convinced that Urwin shirked his duty to spend time with his betrothed, and the two men have been at odds ever since. To this day, Urwin steadfastly denies his father's accusation.

Adding to Davian's misery, the wereravens have been fending off frequent attacks by [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md)'s scarecrow constructs. Three weeks ago, during one such attack, another gem was found, dug up, and taken. Davian believes that it is in the possession of [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md) (see chapter 10, area U3).

Davian's belief is correct. The gem was a lucky find for [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md), who had previously suspected that magic was the root of the vineyard's health but knew nothing of its source. Even after this great discovery, [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md) continues to send her scarecrows against the winery, antagonizing the wereravens like a bad neighbor.
...
The beckoning figure is one of nine [wereravens](/6. Mechanics/bestiary/humanoid/wereraven-vrgr.md) (LG male and female humans) hiding in the grove north of the vineyard. If the characters ignore the cloaked figure and continue on to the winery, the wereravens keep their distance and wait to see what happens.
...
Thirty [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) (in six groups of five) emerge from the surrounding vineyard and make their way toward the characters and the winery. The blights are 120 feet away when they first become visible, and they have a walking speed of 30 feet. Characters can either barricade themselves inside the winery, thus keeping the needle blights at bay, or stand and fight. If they stay outside and fight, druids and blights from inside the winery join the battle on the rounds shown below.

| Round | Creatures |
|-------|-----------|
| 3 | 1 [druid](/6. Mechanics/bestiary/humanoid/druid.md) and 24 [twig blights](/6. Mechanics/bestiary/plant/twig-blight.md) (from area W9) |
| 4 | 1 [druid](/6. Mechanics/bestiary/humanoid/druid.md) and 5 [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) (from area W14) |
| 5 | 1 [druid](/6. Mechanics/bestiary/humanoid/druid.md) and 2 [vine blights](/6. Mechanics/bestiary/plant/vine-blight.md) (from area W20) |
^round-creatures

The druid lurking in area W16 carries a [Gulthias staff](/6. Mechanics/items/gulthias-staff-cos.md) (see appendix C). If the staff is destroyed, all blights within 300 feet of it instantly wither and die.
...
> [!gallery]
> ![Map 12.1: Wizard of Wines Winery (Area W)](/5. World Almanac/5e Modules/curse-of-strahd/img/111-028.jpg#gallery)
> ![Player Version](/5. World Almanac/5e Modules/curse-of-strahd/img/112-cos1201.jpg#gallery)

### W1. Stables

The Martikovs keep two [draft horses](/6. Mechanics/bestiary/beast/draft-horse.md) here and use them to pull their wine wagon.
...
Four [swarms of ravens](/6. Mechanics/bestiary/beast/swarm-of-ravens.md) perch on the rafters but don't attack the characters under any circumstances.

Unless they have been drawn outside, twenty-four [twig blights](/6. Mechanics/bestiary/plant/twig-blight.md) and one [druid](/6. Mechanics/bestiary/humanoid/druid.md) (NE female human) are also present. If they are here, read:
...
![Twig Blight](/5. World Almanac/5e Modules/curse-of-strahd/img/113-cos12-03.png#center)

The druid is poisoning the fermentation vats. The three westernmost vats contain poisoned wine, enough to fill a total of twenty barrels. Drinking the poisoned wine has the same effect as drinking a [potion of poison](/6. Mechanics/items/potion-of-poison.md). Pouring antitoxin into a vat neutralizes the poison, but it also spoils the taste of the wine. Casting a [purify food and drink](/6. Mechanics/spells/purify-food-and-drink.md) spell on a vat neutralizes the poison without spoiling the wine.
...
Unless they have been drawn outside, five [needle blights](/6. Mechanics/bestiary/plant/needle-blight.md) and one [druid](/6. Mechanics/bestiary/humanoid/druid.md) (NE male human) lurk in the eastern portion of the cellar. If they are here when the characters enter that part of the cellar, read:
...
On his first turn, from behind the wine rack, the druid casts a [thunderwave](/6. Mechanics/spells/thunderwave.md) spell, which shatters `dice: 1d20 + 10|avg` (`1d20 + 10`) of the wine bottles as it resounds throughout the cellar. The druid then orders the needle blights to attack.
...
The man is a [druid](/6. Mechanics/bestiary/humanoid/druid.md) (NE male human) who fights only if cornered. Otherwise, he tries to flee by dropping onto the wagon in the loading dock (area W2). He then looks for a place in the winery to hide. A character who understands Druidic can translate the his words: "Nature bows to my every whim, for I have the vampire's staff!"

A secret door in the north corner of the west wall can be pulled open to reveal a bedroom (area W17).

#### Treasure

The druid wields a [Gulthias staff](/6. Mechanics/items/gulthias-staff-cos.md) (see appendix C), which can be used to destroy the blights in the winery.

### W17. Master Bedroom

This bedroom normally belongs to [Davian Martikov](/6. Mechanics/bestiary/npc/davian-martikov-cos.md) but is currently being used by his daughter, Stefania, and son-in-law, Dag, while they raise their baby daughter.
...
![Davian Martikov](/5. World Almanac/5e Modules/curse-of-strahd/img/114-cos12-04.png#center)
...
Inside the chest are 50 gp, 270 ep (each electrum coin stamped with the profiled visage of [Strahd von Zarovich](/6. Mechanics/bestiary/npc/strahd-von-zarovich-cos.md)), and 350 sp. A secret compartment in the lid can be found with a successful DC 15 Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) check. It holds a gold locket (worth 25 gp) containing a painted portrait of a beautiful woman (Davian's deceased wife, Angelika), as well as a pouch containing five 50 gp gemstones.
...
Two [vine blights](/6. Mechanics/bestiary/plant/vine-blight.md) and one [druid](/6. Mechanics/bestiary/humanoid/druid.md) (NE female human) are in the room unless they have been drawn elsewhere, If they are here, read:
...
The contraption standing near the north wall is a printing press, which [Davian Martikov](/6. Mechanics/bestiary/npc/davian-martikov-cos.md) uses to make wine bottle labels. The ink is made from wine and stored in bottles in the cabinet, along with pieces of parchment and jars of glue.
...
If the characters leave the winery and return at a later time before dealing with Wintersplinter (see the "Druids' Ritual" section in chapter 14), the enormous [tree blight](/6. Mechanics/bestiary/plant/tree-blight-cos.md) (see appendix D) is sent from Yester Hill to ravage the vineyard and destroy the winery.
...
The Martikovs narrowly escape the carnage and flee to the Blue Water Inn in Vallaki (chapter 5, area N2). [Davian Martikov](/6. Mechanics/bestiary/npc/davian-martikov-cos.md) is crushed by the loss of the winery, and morale in Vallaki sinks to an all-time low as word of the winery's destruction spreads through town.

#### Development

Three days after Wintersplinter's attack, [Baba Lysaga](/6. Mechanics/bestiary/npc/baba-lysaga-cos.md) (see chapter 10, area U3) dispatches the seven [scarecrows](/6. Mechanics/bestiary/construct/scarecrow.md) from Berez and orders them to take up positions in the vineyard, to discourage the wereravens from returning. These scarecrows attack anyone who crosses the vineyard or approaches the ruined winery.
