...
Strahd bequeathed the winery and vineyard to the noble Krezkov family as a reward for the family's loyalty. Later, an arranged marriage between the Krezkovs and the Martikov family led to the land being taken over by a Martikov descendant. The winery and vineyard have been tended by the Martikovs ever since. At some point, the Martikov family became infected with widespread lycanthropy. The current patriarch, [[Davian Martikov%20\|(COS]].md), is a wereraven, as are his children and grandchildren.

![](/compendium/adventures/curse-of-strahd/img/110-cos12-01.png#center)
...
The winery is known for three wines: the unremarkable Purple Grapemash No. 3, the slightly more tantalizing Red Dragon Crush, and the rich Champagne du le Stomp. Ten years ago, one of the vineyard's magic gems was dug up and stolen, and as a result, the winery stopped producing its best vintage, the champagne. No one knows what happened to the gem. [[Davian Martikov%20\|(COS]].md) blames his middle son, Urwin (see chapter 5, area N2), for the loss because Urwin was on watch the night the gem was taken. Davian is convinced that Urwin shirked his duty to spend time with his betrothed, and the two men have been at odds ever since. To this day, Urwin steadfastly denies his father's accusation.

Adding to Davian's misery, the wereravens have been fending off frequent attacks by [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]]'s scarecrow constructs. Three weeks ago, during one such attack, another gem was found, dug up, and taken. Davian believes that it is in the possession of [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]] (see chapter 10, area U3).

Davian's belief is correct. The gem was a lucky find for [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]], who had previously suspected that magic was the root of the vineyard's health but knew nothing of its source. Even after this great discovery, [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]] continues to send her scarecrows against the winery, antagonizing the wereravens like a bad neighbor.
...
The beckoning figure is one of nine [[Wereraven \|(VRGR]].md) (LG male and female humans) hiding in the grove north of the vineyard. If the characters ignore the cloaked figure and continue on to the winery, the wereravens keep their distance and wait to see what happens.
...
Thirty [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] (in six groups of five) emerge from the surrounding vineyard and make their way toward the characters and the winery. The blights are 120 feet away when they first become visible, and they have a walking speed of 30 feet. Characters can either barricade themselves inside the winery, thus keeping the needle blights at bay, or stand and fight. If they stay outside and fight, druids and blights from inside the winery join the battle on the rounds shown below.

| Round | Creatures |
|-------|-----------|
| 3 | 1 [[Druid.md\|Druid]] and 24 [[/compendium/bestiary/plant/twig-blight.md\|twig blights]] (from area W9) |
| 4 | 1 [[Druid.md\|Druid]] and 5 [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] (from area W14) |
| 5 | 1 [[Druid.md\|Druid]] and 2 [[Vine Blight.md\|vine blights]] (from area W20) |
^round-creatures

The druid lurking in area W16 carries a [[Gulthias Staff%20\|(COS]].md) (see appendix C). If the staff is destroyed, all blights within 300 feet of it instantly wither and die.
...
> [!gallery]
> ![Map 12.1: Wizard of Wines Winery (Area W)](/compendium/adventures/curse-of-strahd/img/111-028.jpg#gallery)
> ![[/compendium/adventures/curse-of-strahd/img/112-cos1201.jpg#gallery\|Player Version]]

### W1. Stables

The Martikovs keep two [[/compendium/bestiary/beast/draft-horse.md\|draft horses]] here and use them to pull their wine wagon.
...
Four [[Swarm Of%20Ravens.md\|swarms of ravens]] perch on the rafters but don't attack the characters under any circumstances.

Unless they have been drawn outside, twenty-four [[/compendium/bestiary/plant/twig-blight.md\|twig blights]] and one [[Druid.md\|Druid]] (NE female human) are also present. If they are here, read:
...
![[/compendium/adventures/curse-of-strahd/img/113-cos12-03.png#center\|Twig Blight]]
...
Unless they have been drawn outside, five [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] and one [[Druid.md\|Druid]] (NE male human) lurk in the eastern portion of the cellar. If they are here when the characters enter that part of the cellar, read:
...
The man is a [[Druid.md\|Druid]] (NE male human) who fights only if cornered. Otherwise, he tries to flee by dropping onto the wagon in the loading dock (area W2). He then looks for a place in the winery to hide. A character who understands Druidic can translate the his words: "Nature bows to my every whim, for I have the vampire's staff!"

A secret door in the north corner of the west wall can be pulled open to reveal a bedroom (area W17).

#### Treasure

The druid wields a [[Gulthias Staff%20\|(COS]].md) (see appendix C), which can be used to destroy the blights in the winery.

### W17. Master Bedroom

This bedroom normally belongs to [[Davian Martikov%20\|(COS]].md) but is currently being used by his daughter, Stefania, and son-in-law, Dag, while they raise their baby daughter.
...
![[/compendium/adventures/curse-of-strahd/img/114-cos12-04.png#center\|Davian Martikov]]
...
Inside the chest are 50 gp, 270 ep (each electrum coin stamped with the profiled visage of [[Strahd Von%20Zarovich%20\|(COS]].md)), and 350 sp. A secret compartment in the lid can be found with a successful DC 15 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check. It holds a gold locket (worth 25 gp) containing a painted portrait of a beautiful woman (Davian's deceased wife, Angelika), as well as a pouch containing five 50 gp gemstones.
...
Two [[Vine Blight.md\|vine blights]] and one [[Druid.md\|Druid]] (NE female human) are in the room unless they have been drawn elsewhere, If they are here, read:
...
The contraption standing near the north wall is a printing press, which [[Davian Martikov%20\|(COS]].md) uses to make wine bottle labels. The ink is made from wine and stored in bottles in the cabinet, along with pieces of parchment and jars of glue.
...
If the characters leave the winery and return at a later time before dealing with Wintersplinter (see the "Druids' Ritual" section in chapter 14), the enormous [[/compendium/bestiary/plant/tree-blight-cos.md\|tree blight]] (see appendix D) is sent from Yester Hill to ravage the vineyard and destroy the winery.
...
The Martikovs narrowly escape the carnage and flee to the Blue Water Inn in Vallaki (chapter 5, area N2). [[Davian Martikov%20\|(COS]].md) is crushed by the loss of the winery, and morale in Vallaki sinks to an all-time low as word of the winery's destruction spreads through town.

#### Development

Three days after Wintersplinter's attack, [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]] (see chapter 10, area U3) dispatches the seven [[Scarecrow.md\|scarecrows]] from Berez and orders them to take up positions in the vineyard, to discourage the wereravens from returning. These scarecrows attack anyone who crosses the vineyard or approaches the ruined winery.

![](/compendium/adventures/curse-of-strahd/img/115-cos12-05.png#center)