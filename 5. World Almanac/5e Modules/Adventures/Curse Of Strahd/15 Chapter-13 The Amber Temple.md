...
![](/compendium/adventures/curse-of-strahd/img/116-cos13-01.png#center)
...
> ![[/compendium/adventures/curse-of-strahd/img/118-cos1301.jpg#gallery\|Player Version]]
...
An [[Arcanaloth.md\|Arcanaloth]] named Neferon guards this temple from within the hollow head of the great statue (area X5a) and attacks characters on sight with its longer-ranged spells. Thanks to its [[compendium/rules/senses.md#truesight\|truesight]], the arcanaloth can see the [[compendium/rules/conditions.md#invisible\|invisible]] and can see through magical darkness. Characters can't see Neferon unless they can penetrate the magical darkness that envelops the statue's face and head.

Once the arcanaloth begins casting spells, the three [[/compendium/bestiary/undead/flameskull.md\|flameskulls]] in area X17 take up positions behind the arrow slits that overlook the temple and cast magic missile and fireball spells at characters they can see.
...
This 40-foot-tall statue, carved out of granite, depicts a faceless god of secrets. At the base of the statue, in the back, is a secret door that can be found with a successful DC 20 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check. It can be pulled open to reveal a spiral staircase that climbs to a stone trapdoor set into the floor of the statue's hollow head.

#### Statue's Head

Neferon the [[Arcanaloth.md\|Arcanaloth]] lairs inside the statue's hollow head, within a field of magical darkness that fills the interior of the head and hides the statue's humanlike face. The darkness can be dispelled (DC 17).
...
Neferon wears gold spectacles and a magic robe (see "Treasure" below). It uses its alter self spell and [[compendium/rules/skills.md#Deception\|Deception]] skill to pass itself off as an old human wizard with a long white beard named Heinrich Stolt. "Heinrich" feigns confusion. If the characters ask him why he attacked, he claims that he was guarding the temple. If the arcanaloth loses more than half of its hit points, it teleports to the temple floor, turns [[compendium/rules/conditions.md#invisible\|invisible]], and flees by the safest route, attacking the characters again when it's safe to do so. The arcanaloth will not, under any circumstances, leave the Amber Temple.
...
![[/compendium/adventures/curse-of-strahd/img/119-cos13-03.png#center\|Vilnius and Quasit]]

Hiding behind the lectern is [[Vilnius \|(COS]].md) (NE male human [[Mage.md\|Mage]]) and his [[compendium/rules/conditions.md#invisible\|invisible]] [[Quasit.md\|Quasit]] familiar. Characters who have a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 17 or higher notice him. A character who actively searches the room for hidden occupants spots [[Vilnius \|(COS]].md) with a successful DC 12 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check.

[[Vilnius \|(COS]].md) wears scorched robes, his unkempt hair is half burned away, and his face and arms are covered with blisters from magic fire. He is the apprentice of Jakarion, the dead wizard in area X17. After the flameskulls there incinerated his master, the wounded [[Vilnius \|(COS]].md) retreated here. He eats vermin to survive. The [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] has been patrolling the hallway outside (area X8), and [[Vilnius \|(COS]].md) won't leave this room until he knows the golem has been destroyed.

[[Vilnius \|(COS]].md) is a greedy, treacherous coward. He curses his dead master for leading them to this wretched land. If the characters try to befriend him, he is suspicious of their intentions. He would like to retrieve his dead master's staff and spellbook, but otherwise he has no interest in exploring more of the Amber Temple. He knows the following information about the place:
...
[[Vilnius \|(COS]].md) carries his spellbook, which contains all the spells he has prepared. He also has a gold amulet shaped like an upside-down V hidden under his robes. Of exquisite design, the amulet is worth 1,000 gp. It is the control amulet for the [[Shield Guardian.md\|shield guardian]] in area X35.

Although he can tell that the amulet is magical, he doesn't know its purpose. The amulet thrums when it comes within 10 feet of the shield guardian. If [[Vilnius \|(COS]].md) realizes what the amulet does, he won't part with it.
...
The ceiling here is 20 feet high, and the walls are lined with empty torch sconces. The statue is a damaged [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] (use the stat block for the [[/compendium/bestiary/construct/stone-golem.md\|stone golem]] in the "Monster Manual"). It has 145 hit points and attacks any creature it sees, stopping only when it can't see any.
...
The [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] in area X10 knocked over the candlesticks and pulverized the obsidian statue, which depicted the same nameless god that stands in area X5. Amber doors in the west wall open into area X13.
...
This room contains a [[Gladiator.md\|Gladiator]] (CE female human), five [[Berserker.md\|berserkers]] (CE male and female humans), and one [[Dire Wolf.md\|dire wolf]]. The gladiator and the berserkers are bloodthirsty mountain folk, the dire wolf a servant of Strahd. The dire wolf can't be [[compendium/rules/conditions.md#charmed\|charmed]] or [[compendium/rules/conditions.md#frightened\|frightened]].
...
Three [[/compendium/bestiary/undead/flameskull.md\|flameskulls]] guard this hall, attacking creatures that enter. The flameskulls will not leave the hall.
...
The wooden chest contains an old map case in which Artimus kept floor plans of Castle Ravenloft, but the maps were lost long ago. The chest has a false bottom that can be found with a successful DC 10 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check. Inside the hidden compartment is a tome of understanding.
...
The [[/compendium/bestiary/undead/lich.md\|lich]] has fewer hit points than normal (99 hit points), doesn't remember its name ([[/compendium/bestiary/npc/exethanter-cos.md\|Exethanter]]), and has forgotten all of its prepared spells. It does know its cantrips. In its current condition, the lich has a challenge rating of 10 (5,900 XP). A greater restoration spell restores the lich's memory and all of its spells. Another casting of the spell restores its normal hit point maximum (135).
...
The scaly arm is merely a carved pedestal. The bone box is [[/compendium/bestiary/npc/exethanter-cos.md\|Exethanter]]'s phylactery. If it takes 20 or more radiant damage from a single source, the phylactery is destroyed.
...
> ![[/compendium/adventures/curse-of-strahd/img/121-cos1302.jpg#gallery\|Player Version]]
...
An earth tremor collapsed the northern part of the hall. Three [[Barovian Witch%20\|(COS]].md) (see appendix D) are trying to open the amber door to area X33a by trying different passwords, unaware that they could gain entry through the shaft in area X6. Frustrated by their lack of progress, they vent their rage by attacking the characters. The witches let loose their three [[Broom Of%20Animated%20Attack%20\|(COS]].md) (see appendix D) while they cast spells.

#### Development

If two of the witches are killed or [[compendium/rules/conditions.md#incapacitated\|incapacitated]], the surviving witch attempts to escape by flying away on her broom. Only the witches can use the brooms of animated attack in this fashion.
...
Three [[/compendium/bestiary/undead/flameskull.md\|flameskulls]] guard this room. They attack intruders on sight.
...
The ceiling here is 10 feet high. The seven hungry [[Ghast.md\|ghasts]] that lair here fight to the death. The ghasts have the following additional feature:
...
In the center of the room, a [[/compendium/bestiary/aberration/death-slaad.md\|death slaad]] has cast invisibility on itself and stands ready with its greatsword in hand. The slaad attacks anyone who enters the room, fighting until slain. It can't leave the Amber Temple.

Characters who touch the amber sarcophagi are offered dark gifts by the evil vestiges contained within them (see the "Amber Sarcophagi" sidebar).

##### North Sarcophagus

The vestige within this sarcophagus offers the dark gift of Yrrga, the Eye of Shadows. Yrrga's gift is the power of true seeing. This dark gift grants its beneficiary the benefits of [[compendium/rules/senses.md#truesight\|truesight]] out to a range of 60 feet. These benefits last for 30 days, after which the dark gift vanishes.
...
The vestige within this sarcophagus offers the dark gift of Seriach, the Hell Hound Whisperer. Seriach's gift is the power to summon and control hell hounds. As an action, the beneficiary of this dark gift can summon and control two [[Hell Hound.md\|hell hounds]]. Both hounds appear at the same time. The beneficiary can summon hounds only once, and the dark gift vanishes when they die.
...
This room was once a wizard's bedchamber. The construct is an [[compendium/rules/conditions.md#incapacitated\|incapacitated]] [[Shield Guardian.md\|shield guardian]]. Its control amulet can be found in area X9.
...
The ceiling here is 10 feet high. A [[/compendium/bestiary/undead/poltergeist.md\|poltergeist]] (see the [[Specter.md\|Specter]] entry in the "Monster Manual") haunts this room and telekinetically hurls broken furnishings at intruders so as not to give away its location.
...
An [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] once stood guard here, but it escaped after thieves broke into the treasury and looted it. The golem has since made its way upstairs (see area X10).

Not all of the thieves escaped, and the pulverized remains of those who died here lie strewn upon the floor. Their restless spirits survive here as four [[/compendium/bestiary/undead/poltergeist.md\|poltergeists]] (see the [[Specter.md\|Specter]] entry in the "Monster Manual"). The poltergeists can't leave the room and fight until destroyed.

### X40. Sealed Treasury

The amber doors to the south are sealed with an arcane lock spell. The password to suppress the spell is "Dhaviton." A character can push open the doors with a successful DC 25 Strength check. The doors (AC 15, 60 hit points) can also be smashed. If the doors are reduced to 0 hit points, a greater invisibility spell is cast on the [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] in this room. The spell lasts for 1 minute.
...
The ceiling here is 30 feet high and flat. The statue in the northern alcove is an [[/compendium/bestiary/construct/amber-golem-cos.md\|amber golem]] (use the stat block for the [[/compendium/bestiary/construct/stone-golem.md\|stone golem]] in the "Monster Manual"). It attacks any creature that disturbs the treasure. The golem can leave the room but can't leave the Amber Temple.

![[/compendium/adventures/curse-of-strahd/img/122-cos13-05.png#center\|Amber Golem]]
...
Inside the wooden crates, buried in earth, are six [[/compendium/bestiary/undead/vampire-spawn.md\|vampire spawn]] created by Strahd from a dead party of adventurers. As soon as they hear intruders in the room, the vampire spawn burst out of their crates and attack, fighting until destroyed.
...
When the conditions are met, the beneficiary instantly becomes a [[Vampire.md\|Vampire]] under the Dungeon Master's control (use the stat block in the "Monster Manual").
...
Construction of the phylactery takes 10 days. Concocting the potion takes 3 days. The two items can't be crafted concurrently. When the beneficiary drinks the potion, he or she instantly transforms into a [[/compendium/bestiary/undead/lich.md\|lich]] under the Dungeon Master's control (use the stat block in the "Monster Manual", altering the lich's prepared spells as desired).
...
Strahd's loyal chamberlain, [[Rahadin \|(COS]].md) (see appendix D), believes that his master forged a pact with the nameless god of secrets to whom the Amber Temple is dedicated. The dusk elf comes to the temple on occasion to petition the dark god into releasing his master from his torment.

[[Rahadin \|(COS]].md) rides a phantom steed along Tsolenka Pass to the Amber Temple and kneels before the great statue in area X5. (The arcanaloth that guards the temple knows [[Rahadin \|(COS]].md) and doesn't harm him. The arcanaloth and the flameskulls don't attack other visitors until [[Rahadin \|(COS]].md) is killed or leaves.) [[Rahadin \|(COS]].md) then pulls out a live toad, swallows it whole as a sacrifice, and offers a gesture of supplication to the secret god.

#### Development

[[Rahadin \|(COS]].md) knows that Strahd will deal with the characters when he sees fit. If the characters confront the dusk elf, he defends himself but won't cause them any permanent harm. Strahd's chamberlain would sooner die than allow himself to be captured. [[Rahadin \|(COS]].md) doesn't divulge his reason for visiting the temple, or even who is he or what role he serves. Left to his own devices, he rides back to Castle Ravenloft.

### Kasimir's Dark Gift

If [[Kasimir Velikov%20\|(COS]].md) (see appendix D and chapter 5, area N9a) finds his way to area X42 and accepts the dark gift of Zhudun, he then asks the characters to accompany him to the catacombs of Castle Ravenloft so that he can restore the life of his centuries-dead sister, [[Patrina Velikovna%20\|(COS]].md) (see chapter 4, area K84, crypt 21).

#### Development

If Kasimir succeeds in his quest, the newly resurrected Patrina (NE female dusk elf [[Archmage.md\|Archmage]]) feigns repentance until she regains her strength and her spells, whereupon she travels to Castle Ravenloft and attempts to return to Strahd, seeking to become his vampire bride at last. The mutilation of her brother at the hands of [[Rahadin \|(COS]].md), Strahd's chamberlain, doesn't sit well with her. She hopes to avenge her brother and distract the characters by setting them on a path to killing [[Rahadin \|(COS]].md), who has long opposed her marriage to Strahd.

Strahd has lost interest in Patrina as a consort. Given the chance, he turns her into a [[/compendium/bestiary/undead/vampire-spawn.md\|vampire spawn]] and puts her back in her crypt—a fate she would do everything in her power to prevent. Her attraction to Strahd is outmatched by a desire to increase her own power. She is no one's plaything.