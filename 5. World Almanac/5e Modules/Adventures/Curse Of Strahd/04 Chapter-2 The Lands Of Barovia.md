...
![](/compendium/adventures/curse-of-strahd/img/004-cos02-01.png#center)
...
- A creature that starts its turn in the fog must succeed on a DC 20 Constitution saving throw or gain one level of [[compendium/rules/conditions.md#exhaustion\|exhaustion]] (see "appendix A" in the "Player's Handbook"). This [[compendium/rules/conditions.md#exhaustion\|exhaustion]] can't be removed while the creature is in the fog.  
...
[[/compendium/bestiary/npc/ireena-kolyana-cos.md\|Ireena Kolyana]] and her brother Ismark both have souls, as do all Vistani. Which Barovians have souls and which don't is left up to you.
...
- [[Strahd Von%20Zarovich%20\|(COS]].md) is a vampire, and he dwells in Castle Ravenloft. No one is welcome at the castle.  
...
- The town of Vallaki lies in the heart of the valley. Its burgomaster is named [[/compendium/bestiary/npc/baron-vargas-vallakovich-cos.md\|Baron Vargas Vallakovich]].  
...
![](/compendium/adventures/curse-of-strahd/img/006-cos02-03.png#center)
...
- Some Vistani women are blessed with prescience. Of all the great Vistani fortune-tellers, none compares to [[Madam Eva%20\|(COS]].md). If knowledge of the future is what you seek, [[Madam Eva%20\|(COS]].md) will tell you your fate.  
...
- The target is [[compendium/rules/conditions.md#blinded\|blinded]], [[compendium/rules/conditions.md#deafened\|deafened]], or both. When this curse ends, the Vistana takes `dice: 5d6\|avg` (`5d6`) psychic damage.  

### Evil Eye

As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the animal friendship, charm person, or hold person spell (Vistana's choice), but requires neither somatic nor material components. The spell save DC is 8 + the caster's proficiency bonus + the caster's Charisma modifier. If the target succeeds on the save, the Vistana is [[compendium/rules/conditions.md#blinded\|blinded]] until the end of the Vistana's next turn.
...
|----------------|------------------|-----------|
| 2 | `dice: 3d6\|avg` (`3d6`) [[/compendium/bestiary/humanoid/barovian-commoner-cos.md\|commoners]] |
| 3 | `dice: 1d6\|avg` (`1d6`) [[Barovian Scout%20\|(COS]].md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
| 7 | `dice: 1d4 + 1\|avg` (`1d4 + 1`) [[Vistana Bandit%20\|(COS]].md) |
| 8 | Skeletal rider |
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice: 1d4\|avg` (`1d4`) [[Swarm Of%20Ravens.md\|swarm of ravens]] (50%) or 1 [[Wereraven \|(VRGR]].md) (see appendix D) in raven form (50%) |
| 12 | `dice: 1d6\|avg` (`1d6`) [[Dire Wolf.md\|dire wolves]] |
| 13 | `dice: 3d6\|avg` (`3d6`) [[/compendium/bestiary/beast/wolf.md\|wolves]] |
| 14 | `dice: 1d4\|avg` (`1d4`) [[Berserker.md\|berserkers]] |
| 15 | Corpse |
| 16 | `dice: 1d6\|avg` (`1d6`) [[/compendium/bestiary/humanoid/werewolf.md\|werewolves]] in human form |
| 17 | 1 [[Druid.md\|Druid]] with `dice: 2d6\|avg` (`2d6`) [[/compendium/bestiary/plant/twig-blight.md\|twig blights]] |
| 18 | `dice: 2d4\|avg` (`2d4`) [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] |
| 19 | `dice: 1d6\|avg` (`1d6`) [[Scarecrow.md\|scarecrows]] |
| 20 | 1 [[Revenant.md\|Revenant]] |
^daytime-random-encounters-in-barovia
...
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice: 1d8\|avg` (`1d8`) [[Swarm Of%20Bats.md\|swarm of bats]] |
| 10 | `dice: 1d6\|avg` (`1d6`) [[Dire Wolf.md\|dire wolves]] |
| 11 | `dice: 3d6\|avg` (`3d6`) [[/compendium/bestiary/beast/wolf.md\|wolves]] |
| 12 | `dice: 1d4\|avg` (`1d4`) [[Berserker.md\|berserkers]] |
| 13 | 1 [[Druid.md\|Druid]] and `dice: 2d6\|avg` (`2d6`) [[/compendium/bestiary/plant/twig-blight.md\|twig blights]] |
| 14 | `dice: 2d4\|avg` (`2d4`) [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] |
| 15 | `dice: 1d6\|avg` (`1d6`) [[/compendium/bestiary/humanoid/werewolf.md\|werewolves]] in wolf form |
| 16 | `dice: 3d6\|avg` (`3d6`) [[/compendium/bestiary/undead/zombie.md\|zombies]] |
| 17 | `dice: 1d6\|avg` (`1d6`) [[Scarecrow.md\|scarecrows]] |
| 18 | `dice: 1d8\|avg` (`1d8`) [[Strahd Zombie%20\|(COS]].md) (see appendix D) |
...
[[/compendium/bestiary/humanoid/barovian-commoner-cos.md\|Barovian commoners]] rarely leave their settlements. This group might be a family looking for a safer place to live, or an angry mob searching for the characters or heading toward Castle Ravenloft to confront Strahd.

### Barovian Scouts

If at least one character has a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 16 or higher, read:
...
The area is lightly obscured by fog. If more than one dire wolf is present, the others aren't far behind and can be seen as dark shadows in the fog. The [[Dire Wolf.md\|dire wolves]] of Barovia are cruel, overgrown wolves and Strahd's loyal servants. They can't be [[compendium/rules/conditions.md#charmed\|charmed]] or [[compendium/rules/conditions.md#frightened\|frightened]].
...
The Barovian wilderness is home to [[Druid.md\|druids]] who worship Strahd because of his ability to control the weather and the beasts of Barovia. The druids are savage and violent, and each controls a host of [[/compendium/bestiary/plant/twig-blight.md\|twig blights]], which fights until destroyed. If all the twig blights are destroyed or the druid loses more than half of its hit points, the druid flees, heading toward Yester Hill (area Y).
...
Have each of the characters in the front rank of the party's marching order make a DC 15 Wisdom ([[compendium/rules/skills.md#Survival\|Survival]]) check. If one or more of them succeeds, read:
...
The woods crawl with [[/compendium/bestiary/plant/needle-blight.md\|needle blights]] that serve the evil druids of Barovia. If the characters are moving quietly and not carrying light sources, they can try to hide from these blights.
...
From a distance, the [[Revenant.md\|Revenant]] looks like a zombie and might be mistaken for such. A character within 30 feet of the revenant who succeeds on a DC 10 Wisdom ([[compendium/rules/skills.md#Insight\|Insight]]) check can see the intelligence and hate in its sunken eyes. The revenant is clad in tattered chain mail that affords the same protection as leather armor.

The revenant was a [[Knight Of%20The%20Order%20\|(COS]].md) of the Silver Dragon, which was annihilated defending the valley against Strahd's armies more than four centuries ago. The revenant no longer remembers its name and wanders the land in search of Strahd's wolves and other minions, slaying them on sight. If the characters attack it, the revenant assumes they are in league with Strahd and fights them until destroyed.
...
If more than one [[Scarecrow.md\|Scarecrow]] is present, the others are close by. If none of the characters has a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 11 or higher, the scarecrows catch the party by surprise.

[[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]] (see chapter 10, area U3) crafted these scarecrows to hunt down and kill ravens and wereravens. The scarecrows are imbued with evil spirits and delight in murdering anyone they encounter.
...
A random character finds a lost trinket. Roll on the [[Trinket \|(COS]].md) in appendix A, select a specific trinket from the table, or create one on the fly.
...
This [[Wereraven \|(VRGR]].md) in raven form watches the characters from a distance. Compare its Dexterity ([[compendium/rules/skills.md#Stealth\|Stealth]]) check result to the characters' passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) scores to see whether it remains hidden from the party.
...
How the [[/compendium/bestiary/humanoid/werewolf.md\|werewolves]] act depends on the form they have taken.
...
Werewolves in wolf form follow the party from a safe distance for several hours. If their Dexterity ([[compendium/rules/skills.md#Stealth\|Stealth]]) checks exceed the characters' passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) scores, the werewolves attack with surprise when the characters decide to take a short or long rest. Otherwise, they wait until the characters are weakened by another random encounter before moving in for the easy kill.
...
The light is a [will-o'-wisp](/compendium/bestiary/undead/will-o-wisp.md) that enters the ruined tower and becomes [[compendium/rules/conditions.md#invisible\|invisible]], hoping to lure the characters inside to their doom.
...
If the characters disturb the chest, `dice: 3d6\|avg` (`3d6`) [[/compendium/bestiary/undead/zombie.md\|zombies]] erupt from the earthen floor and attack. Once the zombies appear, the will-o'-wisp becomes visible and joins the fray.
...
Characters have a few minutes to steel themselves before these [[/compendium/bestiary/beast/wolf.md\|wolves]] attack. They heed the will of Strahd and can't be [[compendium/rules/conditions.md#charmed\|charmed]] or [[compendium/rules/conditions.md#frightened\|frightened]].
...
These unfortunate Barovians fell prey to the evils of the land and now shamble from place to place as a [[/compendium/bestiary/undead/zombie.md\|ravenous mob]].
...
> ![[/compendium/adventures/curse-of-strahd/img/008-cos201.jpg#gallery\|Player Version]]
...
![](/compendium/adventures/curse-of-strahd/img/009-cos02-04.png#center)
...
> 
> **Secret Doors.** If there are obvious clues to a secret door's presence, such as scratch marks on a nearby wall or footprints leading to it, a character with a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 15 or higher notices the secret door. Otherwise, finding a secret door requires a search of the area and a successful DC 15 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check.
> 
...
If the characters are following the road on foot, the party member who has the highest passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score notices something:
...
If the characters linger in the woods, they hear a lone wolf howl far off in the forest. Each round, one more wolf adds its voice to the howling, with the sound getting progressively closer to the party. If the characters are still in the woods after 5 rounds of howling, five [[Dire Wolf.md\|dire wolves]] arrive and attack. If the characters are trying to leave Barovia, these dire wolves are joined by a pack of twenty [[/compendium/bestiary/beast/wolf.md\|wolves]]. The wolves and the dire wolves stop their attack if the characters return to the road and head toward the village of Barovia (area E).
...
The eight [[/compendium/bestiary/beast/draft-horse.md\|draft horses]] drinking from the river are used to pull the Vistani wagons and aren't easily startled.
...
Twelve Vistani (male and female human [[Vistana Bandit%20\|(COS]].md)) are standing and sitting around the fire, telling stories and guzzling wine. They are intoxicated and have disadvantage on attack rolls and ability checks. Three sober Vistani (male and female human [[Vistana Bandit%20Captain%20\|(COS]].md)) are resting in three of the four wagons but leap quickly into action if an alarm is raised.
...
If the characters linger at the camp, continue with "A Vistana's Tale" below. If they seem in a hurry to leave, one of the Vistani tells them, "It was fated that you would visit our humble camp. [[Madam Eva%20\|(COS]].md) foretold your coming. She awaits you." The Vistana then points to the largest tent. If the characters head that way, continue with "[[Madam Eva%20\|(COS]].md)'s Tent."

> [!gallery]
> ![Map 2.2: Tser Pool Encampment](/compendium/adventures/curse-of-strahd/img/010-cos02-06.jpg#gallery)
> ![[/compendium/adventures/curse-of-strahd/img/011-cos202.jpg#gallery\|Player Version]]
...
The Vistana storyteller doesn't remember the wizard's name, but recalls that it sounded important. If the characters haven't spoken with [[Madam Eva%20\|(COS]].md), the storyteller urges them to do so.

#### Madam Eva's Tent

If the characters decide to see [[Madam Eva%20\|(COS]].md), read:
...
If your card reading reveals that a treasure is here, it is hidden in one of the Vistani wagons. [[Madam Eva%20\|(COS]].md) grants the characters permission to search the wagons if they ask, and any such search yields the treasure.
...
The two black [[/compendium/bestiary/beast/draft-horse.md\|draft horses]] are under Strahd's control. The horses wait for the characters to pile into the carriage if they so desire. There is room inside for eight of them. If they get into the carriage, the horses draw it down the road to area J. The horses can't be discouraged from their course, not even by a skilled teamster.
...
A patch of green slime (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide") clings to the portcullis in the entry tunnel, and can be spotted with a successful DC 20 Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) check. The slime will not fall on characters entering the castle, but it does fall on the first character who leaves by this route.

### K. Castle Ravenloft

Chapter 4 explores Castle Ravenloft, lair of the vampire [[Strahd Von%20Zarovich%20\|(COS]].md).
...
Each rowboat can safely hold five people. The person fishing on the lake is [[/compendium/bestiary/npc/bluto-krogarov-cos.md\|Bluto Krogarov]] (NE male human [[/compendium/bestiary/humanoid/commoner.md\|commoner]]), a resident of Vallaki. He is in a trance and doesn't respond to anything or anyone unless attacked. His boat is 400 feet from the nearest shore. Tied up in the boat is a seven-year-old Vistana named [[Arabelle \|(COS]].md) (LN female human [[Vistana Commoner%20\|(COS]].md) with 2 hit points and no effective attacks). She is bound with hempen rope, wrapped in a burlap sack, and lying [[compendium/rules/conditions.md#prone\|prone]] so that she can't be seen or heard from the shore.

#### Roleplaying Bluto

[[/compendium/bestiary/npc/bluto-krogarov-cos.md\|Bluto Krogarov]] is a destitute drunkard. He's desperate to catch some fish and trade them for wine at the Blue Water Inn. After he was unable to catch a single fish for a week, he kidnapped [[Arabelle \|(COS]].md), believing that Vistani are lucky. He intends to sacrifice her to the lake, hoping it will give up some of its fish in return.
...
Characters who act quickly can save [[Arabelle \|(COS]].md) before she drowns. A character on the shore must succeed on a DC 15 Strength ([[compendium/rules/skills.md#Athletics\|Athletics]]) check to reach her in time. The DC is 10 for characters who took a rowboat out onto the lake.

[[Arabelle \|(COS]].md) has alabaster-white skin and raven-black hair. If rescued, she demands to be returned to her family's camp outside Vallaki (chapter 5, area N9). She is certain that her father, [[Luvash \|(COS]].md), will give the characters a reward for doing so.

A descendant of [[Madam Eva%20\|(COS]].md) with the blood of Barovian royalty in her veins, [[Arabelle \|(COS]].md) is unaware of her connection to Strahd. She acts more like an adult than a child. Despite her recent misadventure, she believes that a great destiny awaits her.
...
[[/compendium/bestiary/npc/the-mad-mage-of-mount-baratok-cos.md\|The Mad Mage of Mount Baratok]] (CN male human [[Archmage.md\|Archmage]]) came to Barovia more than a year ago to free its people from Strahd's tyranny, but he underestimated Strahd's hold over the land and the creatures in it. After a battle between the two in Castle Ravenloft, Strahd drove the Mad Mage to the mountains and sent the wizard hurling over Tser Falls (area H). The wizard, his staff and spellbook lost, survived the fall and retreated into the mountains, hoping to regain his power, only to be driven mad by the realization that he no longer has any hope of defeating Strahd or freeing the people of the vampire's damned realm.
...
Under normal circumstances, a greater restoration spell cast on the Mad Mage would restore his wits and ends the madness, allowing him to remember that he is none other than Mordenkainen, an [[Archmage.md\|Archmage]] of Oerth and the leader of a powerful group of adventurers called the Circle of Eight. But in this case, the Mad Mage has cast a mind blank spell on himself. As long as that spell remains in effect, his sanity can't be restored by any spell. If the characters surmise that powerful magic is preventing them from restoring the Mad Mage's wits, they can, with a successful DC 15 Charisma ([[compendium/rules/skills.md#Persuasion\|Persuasion]]) check, convince the Mad Mage to divulge the reason why their spell failed. A character can also ascertain the cause of the spell's failure with a successful DC 18 Intelligence ([[compendium/rules/skills.md#Arcana\|Arcana]]) check. The Mad Mage's mind blank spell has a remaining duration of `dice: 3d6\|avg` (`3d6`) hours, after which his madness can be cured normally.

The Mad Mage has a different spell list from that of the [[Archmage.md\|Archmage]] in the "Monster Manual", and he has already used one 1st-level spell slot to cast mage armor on himself, one 4th-level spell slot to cast polymorph on himself, one 7th-level spell slot to cast Mordenkainen's magnificent mansion (see "The Mad Mage's Mansion"), and one 8th-level spell slot to cast mind blank on himself.
...
If Mordenkainen isn't the party's ally as foretold in [[Madam Eva%20\|(COS]].md)'s card reading (see chapter 1), he declines to join them if asked. With his wits restored, he sets out to find his missing staff and spellbook, leaving the characters on their own. He doesn't allow them to help him, for he fears they might be tempted to steal either his staff or his spellbook. (Being an adventurer himself, he knows how the lure of powerful magic can bring out the worst in adventurers.) Before he leaves, as a parting gift, the [[Archmage.md\|Archmage]] imbues each character with a _charm of heroism_ (see ""Supernatural Gifts"" in chapter 7 of the "Dungeon Master's Guide").
...
The [[Archmage.md\|Archmage]] has never had his fortune read by [[Madam Eva%20\|(COS]].md) and doesn't care to, but if he is told about the [[Holy Symbol%20Of%20Ravenkind%20\|(COS]].md), the [[Tome Of%20Strahd%20\|(COS]].md), and the [[/compendium/items/sunsword-cos.md\|Sunsword]], he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.
...
Chapter 10 describes the ruins of Berez, a riverside village that is now home to the hag [[/compendium/bestiary/npc/baba-lysaga-cos.md\|Baba Lysaga]].
