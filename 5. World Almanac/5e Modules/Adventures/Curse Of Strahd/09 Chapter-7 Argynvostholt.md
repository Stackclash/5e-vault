...
When Strahd died and became a vampire, Vladimir's knights should have gone to their everlasting rest, but their spirits couldn't leave Strahd's domain. They marched to Castle Ravenloft and were confronted by the Vistani seer [[Madam Eva%20\|(COS]].md), who told them Strahd had died, only to become a prisoner in his own land, tormented by the death of his beloved Tatyana and the murder of his brother Sergei.
...
> ![[/compendium/adventures/curse-of-strahd/img/078-cos701.jpg#gallery\|Player Version]]
...
Nine [[/compendium/bestiary/beast/giant-spider.md\|giant spiders]] nest here. They attack anyone who gets too close.
...
The iron pot contains an ordinary [[Bat.md\|Bat]]. When the characters get close, it flies out and flaps about the room.
...
Hiding behind the barrels is a wounded elf named [[Savid \|(COS]].md) (N male dusk elf [[Scout.md\|Scout]]). He has 4 hit points remaining and is grateful for any healing the characters can provide.

[[Savid \|(COS]].md) lives with the other dusk elves of Barovia in the Vistani camp outside Vallaki (chapter 5, area N9). He was searching the woods for a missing Vistani girl named [[Arabelle \|(COS]].md) when a wandering mob of needle blights accosted him. He was forced to take refuge in the mansion.

[[Savid \|(COS]].md), who is more than four hundred years old, volunteers the following useful information:
...
The figures are three [[Revenant.md\|revenants]] clad in tattered chain mail that affords the same protection as leather armor. Each revenant wields a longsword. If the beacon is lit, the revenants are cleansed of their hatred and laid to rest, and the characters find three armored corpses with longswords lying on the floor in front of the altar.
...
The wooden floor creaks underfoot. Although it is safe to walk on, doing so attracts the [[/compendium/bestiary/beast/giant-spider.md\|giant spiders]] from area Q4. The spiders crawl up into the room and attack. The floor here is 20 feet above the floor of the ballroom.
...
The smoky dragonet has the statistics of a [[/compendium/bestiary/elemental/smoke-mephit.md\|smoke mephit]] but fights only in self-defense. If left alone, it flies out of the room at a speed of 30 feet, up the spiral staircase (area Q17), through the curtain at area Q30, over the rubble in area Q33, and into area Q36. Once there, it lands on the back of Vladimir's throne and disappears.
...
> ![[/compendium/adventures/curse-of-strahd/img/080-cos702.jpg#gallery\|Player Version]]
...
Four [[Phantom Warrior%20\|(COS]].md) (see appendix D) haunt this room. They manifest only when the characters enter the room or trigger the magic trap in area Q25. They fight until destroyed.
...
Three [[Phantom Warrior%20\|(COS]].md) (see appendix D) haunt this room. They manifest only when the characters enter the room or trigger the magic trap in area Q25. They fight until destroyed.
...
[[/compendium/bestiary/npc/vladimir-horngaard-cos.md\|Vladimir Horngaard]] (see area Q36) can hear visitors climbing over the rubble and can't be surprised by them.
...
[[/compendium/bestiary/npc/vladimir-horngaard-cos.md\|Vladimir Horngaard]] (see appendix D), commander of the fallen Order of the Silver Dragon, is slumped in the throne. If the beacon of Argynvostholt (see area Q53) has been lit, the corpse is lifeless, and characters can plunder it freely (see "Treasure" below).
...
> 
> "If you have come to free this land from the creature that feasts on the blood of the innocent, know this: There is no monster I hate more than [[Strahd Von%20Zarovich%20\|(COS]].md). He slew Argynvost, broke the life of the knight I loved, and destroyed the valiant order to which I devoted my life, but Strahd has already died once. He can't be allowed to die again. Instead, he must suffer eternally in a hell of his own creation, from which he can never escape. Whatever can be done to bring him misery and unrest, I will do, but I will destroy anyone who tries to end his torment."
^480

Vladimir fights in self-defense. He also rises from his throne and attacks if the characters fail to heed his warning and press him for help destroying Strahd. The first time Vladimir takes damage, six [[Phantom Warrior%20\|(COS]].md) (see appendix D) materialize and join the fray, coming to his defense.
...
[[/compendium/bestiary/npc/vladimir-horngaard-cos.md\|Vladimir Horngaard]] wields a +2 greatsword.
...
The skeletal figures are five [[Revenant.md\|revenants]]. All five are lawful evil. They are awaiting orders from Vladimir (area Q36) and fight only in self-defense. The revenants wear broken chainmail that affords as much protection as leather armor, and they wield longswords. As an action, a revenant attacks twice with its longsword, wielding the weapon with both hands and dealing 15 (`dice: 2d10 + 4\|avg` (`2d10 + 4`)) slashing damage on a hit.

One of the revenants, [[/compendium/bestiary/npc/sir-godfrey-gwilym-cos.md\|Sir Godfrey Gwilym]], is a spellcaster with a challenge rating of 6 (2,300 XP) and the following additional feature:
...
![[/compendium/adventures/curse-of-strahd/img/081-cos07-05.png#center\|Sir Godfrey Gwilym]]

Sir Godfrey can sense that the spirit of Argynvost isn't at rest and isn't happy that the order has been reduced to such a state. If the characters petition the revenants for aid, Sir Godfrey (speaking in a scratchy voice) relates all the information presented at the start of the chapter concerning Argynvost and the rise and fall of the Order of the Silver Dragon. Neither he nor the other revenants can help the characters in any meaningful way, however, because of the oaths they have sworn to [[/compendium/bestiary/npc/vladimir-horngaard-cos.md\|Vladimir Horngaard]].
...
This room once served as a bedchamber for Sir [[/compendium/bestiary/npc/vladimir-horngaard-cos.md\|Vladimir Horngaard]] and [[/compendium/bestiary/npc/sir-godfrey-gwilym-cos.md\|Sir Godfrey Gwilym]]. The bear and the dire wolf are stuffed and harmless. Looters ransacked the chest long ago, leaving nothing of value.
...
These turret rooftops are 80 feet above ground level. The spiral stairs descend 20 feet to archers' posts—small rooms lined with arrow slits. Standing guard in each of these rooms is a [[Phantom Warrior%20\|(COS]].md) (see appendix D) with a spectral longbow that shoots arrows of force energy. The two phantom warriors gain the following action options:
...
The [[/compendium/bestiary/beast/raven.md\|ravens]] that roost here are harmless, but they watch the characters with great interest. If the characters look out the windows, you can use the following text to describe what they see in the distance.
...
This encounter occurs while the characters are inside Argynvostholt. Those who have a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 11 or higher hear the clopping of horse hooves and the crunch of wagon wheels on gravel.

A cart pulled by a [[/compendium/bestiary/beast/draft-horse.md\|draft horse]] and driven by a mad Vistana named Kolya (CN male human [[Vistana Bandit%20\|(COS]].md)) stops in front of the mansion. After relieving himself on the statue of Argynvost (area Q1), Kolya untethers the horse and rides back to the Vistani camp outside Vallaki (chapter 5, area N9), leaving the cart and its cargo: a plain wooden coffin.

The coffin was made in Vallaki by the local coffin maker, [[Henrik Van%20Der%20Voort%20\|(COS]].md) (see chapter 5, area N6). It has the name of one of the characters (determined randomly) neatly chiseled into its lid. Opening the coffin releases a [[Swarm Of%20Bats.md\|swarm of bats]] from within. The swarm attacks the character whose name is engraved on the coffin. If that character isn't in sight, the swarm flies away.

### Arrigal's Hunt

[[/compendium/bestiary/npc/ezmerelda-davenir-cos.md\|Ezmerelda d'Avenir]] (see appendix D) arrives at Argynvostholt on the back of a [[Riding Horse.md\|riding horse]] stolen from the Vistani camp outside Vallaki (chapter 5, area N9). She has heard that the reportedly haunted mansion might harbor enemies of Strahd and contain secrets to the vampire's destruction.
...
Hot on Ezmerelda's trail are the Vistani leader [[Arrigal \|(COS]].md) (NE male human [[/compendium/bestiary/humanoid/assassin.md\|assassin]]) and two Vistani bodyguards (CE female [[Vistana Bandit%20\|(COS]].md)). [[Arrigal \|(COS]].md) rides a black [[Riding Horse.md\|riding horse]], while the bandits ride two [[Dire Wolf.md\|dire wolves]]. These dire wolves are servants of Strahd and can't be [[compendium/rules/conditions.md#charmed\|charmed]] or [[compendium/rules/conditions.md#frightened\|frightened]].

[[Arrigal \|(COS]].md) is determined to capture Ezmerelda and haul her back to the Vistani camp to face punishment for horse theft. He does nothing to antagonize the characters, however, and returns to the Vistani camp if he can't convince them to give up Ezmerelda. For more information on [[Arrigal \|(COS]].md), see chapter 5, area N9c.