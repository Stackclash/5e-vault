...
![](/compendium/adventures/curse-of-strahd/img/094-cos09-01.png#center)
...
> [!gallery]
> ![Map 9.1: Tsolenka Pass (Area T)](/compendium/adventures/curse-of-strahd/img/095-025.jpg#gallery)
> ![[/compendium/adventures/curse-of-strahd/img/096-cos901.jpg#gallery\|Player Version]]
...
These statues are actually two [[compendium/rules/conditions.md#petrified\|petrified]] [[Vrock.md\|vrocks]]. If they are attacked, or if the characters bypass the gatehouse, the vrocks revert to flesh and attack, pursuing prey that flees and fighting until slain.
...
The tower door is made of ironbound wood and barred from within. A character can force open the door with a successful DC 22 Strength ([[compendium/rules/skills.md#Athletics\|Athletics]]) check.
...
The forms are six [[Snow Maiden%20\|(COS]].md). Use the [[Specter.md\|Specter]] statistics, with the following modifications:
...
The snow maidens don't speak, nor are they interested in hearing what the characters have to say. If the characters don't leave at once, the snow maidens attack. When the last [[Snow Maiden%20\|(COS]].md) is defeated, the treasure that the characters seek magically appears in the swirling snow on the rooftop.
...
The cloaked rider is a manifestation of [[Strahd Von%20Zarovich%20\|(COS]].md)—a grim warning to proceed no further. If the characters interact with the manifestation in any way, the rider and horse disperse like ash in the wind.
...
As the characters cross the stone bridge (area T8) from east to west—possibly on their way back from the Amber Temple (chapter 13)—they are spotted by a [[Roc.md\|Roc]] that has survived in the mountains for thousands of years. The roc has a great nest on the top of Mount Ghakis to the southeast and feeds on fish in the nearby lake.
...
![](/compendium/adventures/curse-of-strahd/img/097-cos09-03.png#center)

### Bloodhorn's Charge

As the characters make their way along Tsolenka Pass, they encounter a beast that the druids and berserkers of Barovia call [[/compendium/bestiary/npc/sangzor-cos.md\|Sangzor]] ("Bloodhorn"):
...
If no character has a passive Wisdom ([[compendium/rules/skills.md#Perception\|Perception]]) score of 16 or higher, the party is surprised. Otherwise, read:
...
[[/compendium/bestiary/npc/sangzor-cos.md\|Sangzor]] is a [[Giant Goat.md\|giant goat]] known for its supernatural resilience and evil disposition. Mountain folk have been hunting it for years. Modify its statistics as follows:
...
A character who wears [[/compendium/bestiary/npc/sangzor-cos.md\|Sangzor]]'s pelt can command the respect of the berserkers who inhabit Strahd's domain. They will not attack the character or that character's companions unless provoked.