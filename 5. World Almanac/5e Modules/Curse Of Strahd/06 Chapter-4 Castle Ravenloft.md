...
| 6 | `dice: 1d4 + 1\|avg` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Construct/Flying Sword.md\|flying swords]] |
| 7 | Blinsky toy |
| 8 | [[/6. Mechanics/Spells/Unseen Servant.md\|Unseen servant]] |
| 9 | `dice: 1d4\|avg` (`1d4`) [[/6. Mechanics/Bestiary/Humanoid/Barovian Commoner (COS).md\|commoners]] |
| 10 | `dice: 2d6\|avg` (`2d6`) [[/6. Mechanics/Bestiary/Undead/Crawling Claw.md\|crawling claws]] |
| 11 | `dice: 1d6\|avg` (`1d6`) [[/6. Mechanics/Bestiary/Undead/Shadow.md\|shadows]] |
| 12 | `dice: 1d6\|avg` (`1d6`) [[/6. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|swarms of bats]] |
| 13 | 1 crawling [[/6. Mechanics/Bestiary/Undead/Strahd Zombie (COS).md\|Strahd zombie]] (see appendix D) |
| 14 | `dice: 1d4 + 1\|avg` (`1d4 + 1`) Vistani [[/6. Mechanics/Bestiary/Humanoid/Vistana Thug (COS).md\|thugs]] |
| 15 | `dice: 1d4\|avg` (`1d4`) [[/6. Mechanics/Bestiary/Undead/Wight.md\|wights]] |
| 16 | Trinket |
| 17 | Giant spider cocoon |
| 18 | 1 [[/6. Mechanics/Bestiary/Humanoid/Barovian Witch (COS).md\|Barovian witch]] (see appendix D) |
| 19 | `dice: 1d4 + 1\|avg` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Undead/Vampire Spawn.md\|vampire spawn]] |
...
[[/6. Mechanics/Bestiary/Npc/Rahadin (COS).md\|Rahadin]] directs the characters to a random location in the castle, determined by rolling a `dice: d6\|avg` (`d6`):
...
This unseen servant was created by Strahd and is permanent until destroyed (see the [[/6. Mechanics/Spells/Unseen Servant.md\|unseen servant]] spell in the "Player's Handbook"). Roll a `dice: d6\|avg` (`d6`) to determine what the servant is carrying, or choose one of the options below.
...
| 2 | A silver goblet (worth 50 gp) filled to the brim with wine. A character who drinks the wine must make a DC 15 Constitution saving throw, taking 44 (`dice: 8d10\|avg` (`8d10`)) poison damage on a failed save, or half as much damage on a successful one. On future occurrences of this encounter, the wine acts as a [[/6. Mechanics/Items/Potion Of Healing.md\|potion of healing]]. |
...
| 5 | A crystal dinner bell (worth 25 gp). The unseen servant rings the bell if the characters come within 10 feet of it. The sound attracts `dice: 1d4\|avg` (`1d4`) hungry [[/6. Mechanics/Bestiary/Undead/Vampire Spawn.md\|vampire spawn]] (see below), which arrive in `dice: 1d4 + 1\|avg` (`1d4 + 1`) rounds. |
...
The wights carry longswords that have the crest of Barovia worked into their cross guards. Each wight also carries a pouch holding `dice: 2d20\|avg` (`2d20`) ep, each coin of Barovian mintage and featuring the profiled visage of [[/6. Mechanics/Bestiary/Npc/Strahd Von Zarovich (COS).md\|Strahd von Zarovich]].
...
| dice: d4 | Creature |
|----------|----------|
| 1 | `dice: 1d6\|avg` (`1d6`) [[/6. Mechanics/Bestiary/Undead/Shadow.md\|shadows]] |
| 2 | `dice: 1d4\|avg` (`1d4`) [[/6. Mechanics/Bestiary/Undead/Vampire Spawn.md\|vampire spawn]] |
| 3 | `dice: 1d4\|avg` (`1d4`) [[/6. Mechanics/Bestiary/Undead/Wight.md\|wights]] |
| 4 | 1 [[/6. Mechanics/Bestiary/Undead/Wraith.md\|wraith]] and `dice: 1d4 + 1\|avg` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Undead/Specter.md\|specters]] |
^creature
...
There is no danger in this area during the day. But if the characters try to take a short rest here during the night, the rest is interrupted by the arrival of `dice: 1d4\|avg` (`1d4`) [[/6. Mechanics/Bestiary/Humanoid/Barovian Witch (COS).md\|Barovian witches]] from area K56. They try to subdue the party with [[/6. Mechanics/Spells/Sleep.md\|sleep]] spells. A witch retreats to area K56 if wounded.
...
> [!gallery]
> ![Maps 7-10: Spires and Tower of Ravenloft](036-010.jpg#gallery)
