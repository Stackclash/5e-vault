...
if (await tp.file.exists('1. DM Toolkit/Sound Board.md')) {
    const currentTFile = tp.file.find_tfile('1. DM Toolkit/Sound Board')
    await app.vault.delete(currentTFile)
}

await tp.file.move('1. DM Toolkit/Sound Board')
-%>
---
