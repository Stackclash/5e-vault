...
When the trap is triggered, the net is released, covering a 10-foot-square area. Those in the area are trapped under the net and [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]], and those that fail a DC 10 Strength saving throw are also knocked [[/5. Mechanics/Rules/Conditions.md#prone|").
