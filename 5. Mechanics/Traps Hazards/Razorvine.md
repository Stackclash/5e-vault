...
When a creature comes into direct contact with razorvine for the first time on a turn, the creature must succeed on a DC 10 Dexterity saving throw or take 5 (`dice: 1d10|avg` (`1d10`)) slashing damage from the razorvine's bladelike thorns.
