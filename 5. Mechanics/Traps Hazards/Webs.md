...
Giant spiders weave thick, sticky webs across passages and at the bottom of pits to snare prey. These web-filled areas are difficult terrain. Moreover, a creature entering a webbed area for the first time on a turn or starting its turn there must succeed on a DC 12 Dexterity saving throw or become [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]] by the webs. A [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]] creature can use its action to try to escape, doing so with a successful DC 12 Strength ([[/5. Mechanics/Rules/Skills.md#Athletics|")"]] or Dexterity ([[/5. Mechanics/Rules/Skills.md#Acrobatics|")"]] check.
