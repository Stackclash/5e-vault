...
The trip wire is 3 inches off the ground and stretches between two support beams. The DC to spot the trip wire is 10. A successful DC 15 Dexterity check using [[5. Mechanics\Items\Thieves Tools.md|thieves' tools]] disables the trip wire harmlessly. A character without [[5. Mechanics\Items\Thieves Tools.md|thieves' tools]] can attempt this check with disadvantage using any edged weapon or edged tool. On a failed check, the trap triggers.
...
When the trap is triggered, the unstable ceiling collapses. Any creature in the area beneath the unstable section must succeed on a DC 15 Dexterity saving throw, taking 22 (`dice: 4d10` (`4d10`)) bludgeoning damage on a failed save, or half as much damage on a successful one. Once the trap is triggered, the floor of the area is filled with rubble and becomes difficult terrain.
