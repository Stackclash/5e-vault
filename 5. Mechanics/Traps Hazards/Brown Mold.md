...
When a creature moves to within 5 feet of the mold for the first time on a turn or starts its turn there, it must make a DC 12 Constitution saving throw, taking `dice:4d10|text(22)` (`4d10`) cold damage on a failed save, or half as much damage on a successful one.
