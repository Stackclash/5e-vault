...
The trap activates when more than 20 pounds of weight is placed on the pressure plate, releasing four darts. Each dart makes a ranged attack with a +8 bonus against a random target within 10 feet of the pressure plate (vision is irrelevant to this attack roll). (If there are no targets in the area, the darts don't hit anything.) A target that is hit takes 2 (`dice: 1d4` (`1d4`)) piercing damage and must succeed on a DC 15 Constitution saving throw, taking 11 (`dice: 2d10` (`2d10`)) poison damage on a failed save, or half as much damage on a successful one.
