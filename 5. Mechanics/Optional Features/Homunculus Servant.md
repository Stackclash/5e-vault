...
You learn intricate methods for magically creating a special [[5. Mechanics/Bestiary/Construct/Homunculus Servant.md\|homunculus]] that serves you. The item you infuse serves as the creature's heart, around which the creature's body instantly forms.
...
The homunculus regains `dice: 2d6|avg|noform` (`2d6`) hit points if the [[5. Mechanics/Spells/Mending.md\|mending]] spell is cast on it. If you or the homunculus dies, it vanishes, leaving its heart in its space.
