...
- **Mastery Power (8th level).** When inscribed on a surface, the turisaz rune acts as a [[5. Mechanics/Spells/Glyph Of Warding.md\|glyph of warding]] that deals `dice:6d8|noform|avg` (`6d8`) lightning damage if triggered. Sketching the rune takes 1 hour, and the effect lasts for up to 24 hours, or until the glyph is triggered or dispelled.
