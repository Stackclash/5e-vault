...
**Levitas.** The target rises 10 feet per round. A levitating target can repeat the saving throw at the end of each of its turns, until they save. When the target eventually hits the ground, it takes `dice: 1d6|avg|noform` (`1d6`) damage per 10 feet fallen, with the maximum dice equal to their level (e.g., `dice: 5d6|avg|noform` (`5d6`) for level 5).
