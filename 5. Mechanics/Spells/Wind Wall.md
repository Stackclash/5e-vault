...
When the wall appears, each creature within its area must make a Strength saving throw. A creature takes `dice:3d8|noform|noparens|avg` (`3d8`) bludgeoning damage on a failed save, or half as much damage on a successful one.
