...
time: 1 action
duration: 10 minute
components: 'V, S, an amulet inscribed with a demonic or diabolic symbol'
aliases:
...
- [[/5. Mechanics/Rules/Senses.md#Darkvision\|Darkvision]] with a range of 120 feet, unimpeded by magical darkness.  
- Immunity to fire damage.  
- Immunity to poison damage and the [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]] condition.  
...
- Claws that grant you a melee weapon attack that deals `dice:1d8|noform|avg` (`1d8`) slashing damage.  
