...
Writhing ribbons of quasi-real darkness extend from your hand. As an action, you can make a melee spell attack with the tendrils against any creature within range. On a hit, the target takes `dice:2d8|noform|noparens|avg` (`2d8`) cold damage and must succeed at a Dexterity saving throw or be [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]].

A creature that starts its turn [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the shadow tendrils takes the cold damage again. It can take an action to make a Dexterity check against your spell save DC to free itself. On your turn, as a bonus action, you can drag a creature [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the shadow tendrils up to 15 feet closer to you.
