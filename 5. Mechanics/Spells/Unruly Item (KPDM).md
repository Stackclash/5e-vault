...
**Armor:** The creature's armor shifts and moves, becoming noisy and uncomfortable. If the armor does not normally impart disadvantage on Dexterity ([[/5. Mechanics/Rules/Skills.md#Stealth\|Stealth]]) checks, it does so while this spell is in effect. The creature wearing it must succeed on a Dexterity saving throw or take a 10-foot penalty to its speed and be unable to use the [[/5. Mechanics/Rules/Actions.md#Dash\|Dash]] action.
