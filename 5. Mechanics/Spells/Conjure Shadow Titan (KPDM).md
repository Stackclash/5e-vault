...
You summon a shadow titan, which appears in an unoccupied space that you can see within range. The shadow titan's statistics are identical to a [[5. Mechanics/Bestiary/Giant/Stone Giant.md\|stone giant]]'s, with two differences: its camouflage ability works in dim light instead of rocky terrain, and the "rocks" it hurls are composed of shadow-stuff and cause cold damage.
