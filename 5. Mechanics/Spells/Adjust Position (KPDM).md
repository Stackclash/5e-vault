...
You adjust the location of an ally to a better tactical position. You move one willing creature within range 5 feet. This movement does not provoke [[/5. Mechanics/Rules/Actions.md#Opportunity%20Attack\|opportunity attacks]]. The creature moves bodily through the intervening space (as opposed to teleporting), so there can be no physical obstacle (such as a wall or a door) in the path.
