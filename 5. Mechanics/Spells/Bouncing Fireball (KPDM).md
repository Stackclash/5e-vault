...
components: 'V, S, a tiny ball of bat guano and sulfur, and three iron pins'
aliases:
  - Bouncing Fireball
---
# Bouncing Fireball
...
**At Higher Levels.** When you cast this spell using a spell slot of 7th level or higher, the damage increases by `dice:1d6|noform|avg|text(1d6)` for each slot level above 6th.
