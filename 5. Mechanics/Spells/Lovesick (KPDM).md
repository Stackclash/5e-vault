...
components: 'V, S, a handful of red rose petals'
aliases:
  - Lovesick
---
# Lovesick
...
| 4-5 | The creature bursts into tears, takes the [[/5. Mechanics/Rules/Actions.md#Dash\|Dash]] action, and uses all its movement to run off in a random direction. To determine the direction, roll a `dice:d8\|noform\|avg` (`d8`) and assign a direction to each die face. |
...
**Classes**: [[List Spells Classes Bard\|Bard]]; [[List Spells Classes Cleric\|Cleric]]; [[List Spells Classes Sorcerer\|Sorcerer]]; [[List Spells Classes Warlock\|Warlock]]; [[List Spells Classes Wizard\|Wizard]]; [[List Spells Classes Cleric Lust Domain (KPDM)\|Cleric (Lust Domain)]]
