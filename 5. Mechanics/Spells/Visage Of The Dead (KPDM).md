...
ritual: true
components: >-
  V, S, M (a sliver of bone or piece of skin from an animated skeleton or
  zombie)
verbal: true
somatic: true
material: true
material_desc: a sliver of bone or piece of skin from an animated skeleton or zombie
time: 1 Action
duration: 8 hours
range: Touch
aliases:
...
- **Range:** Touch
- **Components:** V, S, M (a sliver of bone or piece of skin from an animated skeleton or zombie)
- **Duration:** 8 hours

You infuse yourself, and up to four creatures you touch, with necromantic energy, taking on aspects of the undead. The targets gain immunity to poison damage and the [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]] condition for the duration of the spell, and take on appearances similar to undead versions of themselves.
