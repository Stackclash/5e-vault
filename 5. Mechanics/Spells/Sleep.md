...
This spell sends creatures into a magical slumber. Roll `dice: 5d8|avg|noform` (`5d8`); the total is how many hit points of creatures this spell can affect. Creatures within 20 feet of a point you choose within range are affected in ascending order of their current hit points (ignoring [[/5. Mechanics/Rules/Conditions.md#unconscious\|unconscious]] creatures).
