...
Nonmagical mud or quicksand in the area no more than 10 feet deep transforms into soft stone for the spell's duration. Any creature in the mud when it transforms must make a Dexterity saving throw. On a successful save, a creature is shunted safely to the surface in an unoccupied space. On a failed save, a creature becomes [[/5. Mechanics/Rules/Conditions.md#restrained\|restrained]] by the rock. A [[/5. Mechanics/Rules/Conditions.md#restrained\|restrained]] creature, or another creature within reach, can use an action to try to break the rock by succeeding on a DC 20 Strength check or by dealing damage to it. The rock has AC 15 and 25 hit points, and it is immune to poison and psychic damage.

## Summary

**Classes**: [[5. Mechanics/Classes/Artificer.md\|Artificer]], [[5. Mechanics/Classes/Druid.md\|Druid]], [[5. Mechanics/Classes/Wizard.md\|Wizard]]
