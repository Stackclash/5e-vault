...
Make a melee spell attack against a creature you touch. On a hit, the target takes `dice:1d10|noform|noparens|avg` (`1d10`) necrotic damage. If the target is a Tiny or Small nonmagical object that isn't being worn or carried by a creature, it automatically takes maximum damage from the spell.
