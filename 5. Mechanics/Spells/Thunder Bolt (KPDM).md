...
You cast a knot of thunder at one enemy. Make a ranged spell attack against the target. If it hits, the target takes `dice:1d8|noform|noparens|avg` (`1d8`) thunder damage and can't use reactions until the start of your next turn.
