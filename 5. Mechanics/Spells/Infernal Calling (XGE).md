...
If your [[5. Mechanics/Rules/Status.md#concentration|concentration]] ends before the spell reaches its full duration, the devil doesn't disappear if it has become immune to your verbal commands. Instead, it acts in whatever manner it chooses for `dice: 3d6` (`3d6`) minutes, and then it disappears.
