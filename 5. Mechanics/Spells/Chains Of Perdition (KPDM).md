...
Lengths of iron chain appear near a creature you choose within range, possibly ensnaring the target and causing it physical and mental suffering. The targeted creature must succeed on a Dexterity saving throw or be [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the chains and take `dice:2d8|noform|avg` (`2d8`) bludgeoning damage and `dice:2d8|noform|avg` (`2d8`) psychic damage. The creature takes this damage on your turn every round that it remains [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the chains. On its turn, a [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] creature can make a Strength or Dexterity check (its choice) against your spell save DC. On a success, it frees itself.
