...
The walls of the pit are slick and slimy, requiring a DC 15 Strength ([[/5. Mechanics/Rules/Skills.md#Athletics\|Athletics]]) check to climb. Creatures and objects that remain in the pit take `dice:1d6|noform|avg` (`1d6`) necrotic damage at the start of each of their turns. If you fall into your own pit, you take damage; then the spell ends and you are [[/5. Mechanics/Rules/Conditions.md#Incapacitated\|incapacitated]] for 2 rounds. When the spell ends, the floor of the pit rises, bringing creatures in the pit back up to the original surface. Each creature in the pit must then make a Constitution saving throw. On a failed save, the creature is [[/5. Mechanics/Rules/Conditions.md#Stunned\|stunned]] for 2 rounds after the spell ends.
