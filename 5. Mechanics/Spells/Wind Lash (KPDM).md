...
Your swift gesture creates a solid lash of howling wind. Make a melee spell attack against the target. On a hit, the target takes `dice:1d8|noform|noparens|avg` (`1d8`) slashing damage from the shearing wind and is pushed 5 feet away from you.
