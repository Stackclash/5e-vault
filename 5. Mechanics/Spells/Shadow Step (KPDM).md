...
You can open a temporary portal between two darkened areas, allowing you to move from one such area to another without crossing the intervening space. If you start your turn in an area of dim light or darkness, you can open a portal to another area of dim light or darkness within range and transport yourself to that spot. Doing this uses up your movement for the turn, regardless of the distance traveled. You can use shadow step while [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]]. Moving in this manner does not draw [[/5. Mechanics/Rules/Actions.md#Opportunity%20Attack\|opportunity attacks]].
