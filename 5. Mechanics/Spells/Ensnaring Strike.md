...
While [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by this spell, the target takes `dice:1d6|noform|noparens|avg` (`1d6`) piercing damage at the start of each of its turns. A creature [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the vines or one that can touch the creature can use its action to make a Strength check against your spell save DC. On a success, the target is freed.
...
**Classes**: [[/5. Mechanics/Lists/List Spells Classes Bard.md\|Bard (Magical Secrets)]]; [[/5. Mechanics/Lists/List Spells Classes Oath Of The Ancients.md\|Paladin (Oath of the Ancients)]]; [[/5. Mechanics/Lists/List Spells Classes Ranger.md\|Ranger]]
