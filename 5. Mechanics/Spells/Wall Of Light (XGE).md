...
When the wall appears, each creature in its area must make a Constitution saving throw. On a failed save, a creature takes `dice:4d8|noform|avg` (`4d8`) radiant damage, and it is [[/5. Mechanics/Rules/Conditions.md#Blinded\|blinded]] for 1 minute. On a successful save, it takes half as much damage and isn't [[/5. Mechanics/Rules/Conditions.md#Blinded\|blinded]]. A [[/5. Mechanics/Rules/Conditions.md#Blinded\|blinded]] creature can make a Constitution saving throw at the end of each of its turns, ending the effect on itself on a success.
