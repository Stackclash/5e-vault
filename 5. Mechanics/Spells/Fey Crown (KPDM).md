...
time: 1 action
duration: 1 hour
components: 'V, S, five flowers of different colors'
aliases:
  - Fey Crown
---
# Fey Crown
...
By channeling the ancient wards of the Seelie Court, you create a crown of five flowers on your head. While wearing this crown, you have advantage on saving throws against spells and other magical effects and are immune to being [[/5. Mechanics/Rules/Conditions.md#Charmed\|charmed]]. As a bonus action, you can choose a creature within 30 feet of you (including yourself). Until the end of its next turn, the chosen creature is [[/5. Mechanics/Rules/Conditions.md#Invisible\|invisible]] and has advantage on saving throws against spells and other magical effects. Each time a chosen creature becomes [[/5. Mechanics/Rules/Conditions.md#Invisible\|invisible]], one of the blossoms in the crown closes. After the last of the blossoms closes, the spell ends at the start of your next turn and the crown disappears.
