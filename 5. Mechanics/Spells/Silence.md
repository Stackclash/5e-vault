...
**Classes**: [[List Spells Classes Bard\|Bard]]; [[List Spells Classes Cleric\|Cleric]]; [[List Spells Classes Ranger\|Ranger]]; [[List Spells Classes Druid Circle Of The Land\|Druid (Circle of the Land)]]; [[List Spells Classes Sorcerer Divine Soul (XGE)\|Sorcerer (Divine Soul)]]; [[List Spells Classes Warlock The Fathomless (TCE)\|Warlock (The Fathomless)]]; [[List Spells Classes Monk Way Of Shadow\|Monk (Way of Shadow)]]
