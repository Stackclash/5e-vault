...
At the end of each of your turns, one creature of your choice that is on the ground in the cube must succeed on a Strength saving throw or become [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]] until the spell ends. A [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]] creature can use an action to make a Strength ([[/5. Mechanics/Rules/Skills.md#Athletics|")"]] check against your spell save DC, ending the effect on itself on a success.
