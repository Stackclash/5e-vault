...
When the spell ends, each affected creature must succeed on a Constitution saving throw or gain `dice:1d4|noform|noparens|avg` (`d4`) levels of [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]].
...
**Classes**: [[5. Mechanics/Lists/List Spells Classes Bard.md\|Bard]]; [[5. Mechanics/Lists/List Spells Classes Druid.md\|Druid]]; [[5. Mechanics/Lists/List Spells Classes Cleric.md\|Cleric]]; [[5. Mechanics/Lists/List Spells Classes Ranger.md\|Ranger]]
