...
When the spell ends, each affected creature must succeed on a Constitution saving throw or gain `dice:1d4|noform|avg` (`1d4`) levels of [[/5. Mechanics/Rules/Conditions.md#Exhaustion\|exhaustion]].
...
**Classes**: [[List Spells Classes Bard\|Bard]]; [[List Spells Classes Cleric\|Cleric]]; [[List Spells Classes Druid\|Druid]]; [[List Spells Classes Ranger\|Ranger]]
