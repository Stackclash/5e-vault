...
When you cast this spell, you grow a hollow needle from your arm for the duration that can be used as a natural finesse weapon to make unarmed strikes that deal `dice:1d4|noform|noparens|avg` (`1d4`) + Dexterity modifier in damage.
