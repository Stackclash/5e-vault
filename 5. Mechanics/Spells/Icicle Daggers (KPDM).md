...
components: 'V, S, a miniature dagger shaped like an icicle'
aliases:
  - Icicle Daggers
---
# Icicle Daggers
...
When you cast this spell, three icicles appear in your hand. Each icicle has the same properties as a [[5. Mechanics/Items/Dagger.md\|dagger]] but deals an extra `dice:1d4|noform|avg` (`1d4`) cold damage on a hit.
