...
somatic: true
material: true
material_desc: a piece of tentacle from a giant octopus or a giant squid
time: 1 Action
...
When a creature enters the affected area for the first time on a turn or starts its turn there, the creature must succeed on a Dexterity saving throw or take `dice:3d6|noform|noparens|avg` (`3d6`) bludgeoning damage and be [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the tentacles until the spell ends. A creature that starts its turn in the area and is already [[/5. Mechanics/Rules/Conditions.md#Restrained\|restrained]] by the tentacles takes `dice:3d6|noform|noparens|avg` (`3d6`) bludgeoning damage.
