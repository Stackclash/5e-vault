...
A creature [[/5. Mechanics/Rules/Conditions.md#restrained|") by the tentacles can use its action to make a Strength or Dexterity check (its choice"]] against your spell save DC. On a success, it frees itself.
