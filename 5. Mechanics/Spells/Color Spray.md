...
A dazzling array of flashing, colored light springs from your hand. Roll `dice:6d10|noform|avg` (`6d10`); the total is how many hit points of creatures this spell can effect. Creatures in a 15-foot cone originating from you are affected in ascending order of their current hit points (ignoring [[/5. Mechanics/Rules/Conditions.md#Unconscious\|unconscious]] creatures and creatures that can't see).
...
**At Higher Levels.** When you cast this spell using a spell slot of 2nd level or higher, roll an additional `dice:2d10|noform|avg|text(2d10)` for each slot level above 1st.
