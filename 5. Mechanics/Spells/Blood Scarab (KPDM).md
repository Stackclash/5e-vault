...
somatic: false
material: true
material_desc: 'a drop of the caster''s blood, and the exoskeleton of a scarab beetle'
time: 1 Action
...
Your blood is absorbed into the beetle's exoskeleton to form a beautiful, ruby-like scarab that flies toward a creature of your choice within range. The target must make a successful Constitution saving throw or take `dice:1d6|noform|noparens|avg` (`1d6`) necrotic damage. You gain temporary hit points equal to the necrotic damage dealt.
