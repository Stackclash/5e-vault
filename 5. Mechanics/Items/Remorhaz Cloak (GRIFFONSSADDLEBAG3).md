...
While wearing the cloak, you can use an action to immediately gain 20 temporary hit points, which last for 1 hour. While you have these temporary hit points, any creature within 5 feet of you that hits you with a weapon attack automatically takes `dice:2d6|noform|noparens|avg` (`2d6`) fire damage, as flames erupt from your wounds. If a creature reduces these temporary hit points to 0, a wave of fire explodes from the cloak. Each creature within 10 feet of you, other than you, takes `dice:2d6|noform|noparens|avg` (`2d6`) fire damage from the explosion. Once this property has been used, it can't be used again until the next dawn.
