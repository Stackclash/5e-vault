...
When you make a Charisma ([[/5. Mechanics/Rules/Skills.md#Performance\|Performance]]) or Charisma ([[/5. Mechanics/Rules/Skills.md#Persuasion\|Persuasion]]) check while wearing the glamerweave, you can roll a `dice: d4|avg|noform` (`d4`) and add the number rolled to the check. Once you use this property, it can't be used again until the next dawn.
