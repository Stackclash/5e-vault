...
A bronze horn summons `dice: 4d4 + 4|avg|noform` (`4d4 + 4`) [[5. Mechanics/Bestiary/Humanoid/Berserker.md\|berserkers]]. To use the bronze horn, you must be proficient with medium armor.
