...
You can connect these lines to form a cutout shape in the glass. As part of the action to complete this shape, make a Dexterity ([[/5. Mechanics/Rules/Skills.md#Sleight%20of%20Hand\|Sleight of Hand]]) check. The DC for this check is equal to 8 plus half the number of actions it took to form the shape. On a success, you silently remove the cutout glass shape. On a failure, the cutout glass shatters. Once the shape is removed in this way, either in one piece or as shattered glass, your concentration ends without repairing the glass.
