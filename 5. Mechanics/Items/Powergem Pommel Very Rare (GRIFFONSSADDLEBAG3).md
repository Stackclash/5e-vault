...
tags:
  ...
  - item/tier/major
aliases:
  - Powergem Pommel (very rare)
---
# Powergem Pommel (very rare)
*Wondrous item, major, very rare (requires attunement)*  
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/GriffonsSaddlebag3/Powergem-Pommel.webp#right)  
...
|-----------------|-------------|
| Black (Black sapphire, large black pearl) | Necrotic |
| Blue (Blue sapphire, blue spinel) | Lightning |
| Colorless (Diamond) | Radiant |
| Green (Emerald, peridot) | Poison |
| Red (Fire opal, ruby) | Fire |
| White (Large pearl, opal) | Cold |
| Yellow (Large amber, topaz) | Acid |
^color-example-light-color
