...
The sword has `dice:1d4-1|noform|avg` (`1d4 - 1`) charges. While holding it, you can use an action to expend 1 charge and cast the [[5. Mechanics/Spells/Wish.md\|wish]] spell from it. This property can't be used again until the next dawn. The sword loses this property if it has no charges.
