...
When you successfully [[/5. Mechanics/Rules/Actions.md#Shove\|shove]] a creature, using the shield to push it, that creature also takes `dice:1d6|noform|noparens|avg` (`1d6`) necrotic damage.
