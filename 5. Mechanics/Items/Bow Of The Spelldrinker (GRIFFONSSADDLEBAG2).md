...
This gilded bow creates hazy illusions of the cosmos when drawn. Attacks made with this magic bow deal an extra `dice:1d4|noform|noparens|avg` (`d4`) force damage to any target hit by it.
