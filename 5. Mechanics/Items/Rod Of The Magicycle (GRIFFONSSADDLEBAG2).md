...
- The vehicle weighs 200 pounds. If it falls [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]], it can't right itself until a creature within reach pulls it upright as an action.  
...
- For every uninterrupted period of 8 hours that the vehicle is in its rod form or goes unmoved, it regains `dice:1d8|noform|noparens|avg` (`1d8`) hit points. If it drops to 0 hit points, it reverts to its rod form and can't be used again until 5 days have passed.  
