...
aliases:
  - Dragonkin Weapon +2
  - Dragonkin Double-Bladed Scimitar +2
...
These weapons are made of a scaly metal that radiates draconic elements. You gain a +2 bonus to attack and damage rolls made with this magic weapon, and it deals an extra `dice:1d6|noform|noparens|avg` (`d6`) damage of the same type as your Breath Weapon racial trait. In addition, while attuned to the weapon, you gain a +2 bonus to your breath weapon's save DC.
