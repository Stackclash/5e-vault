...
The crown recovers `dice:1d8+1|noform|avg` (`1d8 + 1`) charges at midnight. While wearing and attuned to the crown, you also gain advantage on any Dexterity ([[/5. Mechanics/Rules/Skills.md#Stealth\|Stealth]]) checks made to [[/5. Mechanics/Rules/Actions.md#Hide\|hide]] in dim light or darkness, and [[/5. Mechanics/Rules/Senses.md#Darkvision\|darkvision]] out to 60 ft.
