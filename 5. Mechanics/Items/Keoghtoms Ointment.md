...
As an action, one dose of the ointment can be swallowed or applied to the skin. The creature that receives it regains `dice: 2d8 + 2|avg|noform` (`2d8 + 2`) hit points, ceases to be [[/5. Mechanics/Rules/Conditions.md#poisoned\|poisoned]], and is cured of any disease.
