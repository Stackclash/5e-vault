...
In addition, any creature in the steed's line must succeed on a DC 15 Strength saving throw or take `dice:3d12|noform|noparens|avg` (`3d12`) force damage and be knocked [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]]. If you hit the target at the end of the line with the lance, that target must also make the saving throw: it does so with disadvantage.
