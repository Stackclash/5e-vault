...
This staff has 10 charges and regains `dice: 1d6 + 4` (`1d6 + 4`) expended charges daily at dawn. If you expend the last charge, roll a `dice: d20` (`d20`). On a 1, a [[/5. Mechanics/Bestiary/Beast/Swarm Of Insects.md|swarm of insects]] consumes and destroys the staff, then disperses.
