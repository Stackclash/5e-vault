...
When you drink this potion, you go slightly mad for the next `dice: 1d4|avg|noform` (`1d4`) hours. While in this state, you gain the ability to sense the presence of any creature within 30 feet of you that is [[/5. Mechanics/Rules/Conditions.md#invisible\|invisible]] or on the Ethereal Plane. You can pinpoint such a creature that is moving.
