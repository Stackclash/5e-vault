...
You can carve a miniaturized sigil sequence that you know into the base of the stamp, provided it doesn't have one already. If it does, you can sand it flat and carve a new one instead. Either option takes 1 hour of careful work using a set of [[5. Mechanics/Items/Woodcarvers Tools.md\|woodcarver's tools]]. If you're proficient with [[5. Mechanics/Items/Woodcarvers Tools.md\|woodcarver's tools]], it takes 10 minutes of work instead.
