...
- The first band slides into place following a successful DC 5 Intelligence check. Once solved, you begin to emit the ring's aura. The aura lasts for 1 minute and is always centered on you. While you emit this aura, you can use a bonus action on your turn to cause a creature within the aura (including you) to regain `dice:2d6|noform|noparens|avg` (`2d6`) hit points.  
