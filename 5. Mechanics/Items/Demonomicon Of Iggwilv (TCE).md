...
You can reference the _Demonomicon_ whenever you make an Intelligence check to discern information about demons or a Wisdom ([[5. Mechanics/Rules/Skills.md#Survival|Survival]]) check related to the Abyss. When you do so, you can add double your proficiency bonus to the check.
...
The first 10 pages of the _Demonomicon_ are blank. As an action while holding the book, you can target a fiend that you can see that is trapped within a [[/5. Mechanics/Spells/Magic Circle.md|magic circle]]. The fiend must succeed on a DC 20 Charisma saving throw with disadvantage or become trapped within one of the _Demonomicon's_ empty blank pages, which fills with writing detailing the trapped creature's widely known name and depravities. Once used, this action can't be used again until the next dawn.
