...
The wand regains all expended charges daily at dawn. If you expend the wand's last charge, roll a `dice: d20` (`d20`). On a 1, a sad tuba sound plays as the wand crumbles to dust and is destroyed.
