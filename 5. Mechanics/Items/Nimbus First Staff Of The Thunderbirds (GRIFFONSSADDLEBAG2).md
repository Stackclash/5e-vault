...
- *(Prerequisite: 9th level)* The first target hit by the staff on each of your turns takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) cold, lightning, or thunder damage (your choice).  
