...
As an action, you can smash this hammer into the ground to send out intense tremors. Other creatures within 10 feet of the point of impact must succeed on a Dexterity saving throw or suffer `dice:2d6|noform|noparens|avg` (`2d6`) bludgeoning damage and fall [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]]. Creatures who succeed on the throw take half as much damage and do not fall prone. You can cause this effect while you hold the hammer or when you throw it, creating the tremors at the point on the ground that the hammer lands.
