...
When the lantern is lit using holy water, the light that it sheds almost shimmers with divine magic. When lit in this way, any undead creature within the lantern's bright light has disadvantage on any attack roll it makes. Further, if such a creature starts its turn within the bright light, it immediately takes `dice:1d6|noform|avg` (`1d6`) radiant damage.
