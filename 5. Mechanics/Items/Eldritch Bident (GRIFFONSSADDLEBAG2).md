...
- When you hit a target with one of the eldritch beams, you add your Charisma modifier to the damage dealt by each beam, which deal `dice:1d12|noform|noparens|avg` (`1d12`) force damage instead of `dice:1d8|noform|noparens|avg` (`1d8`).  
