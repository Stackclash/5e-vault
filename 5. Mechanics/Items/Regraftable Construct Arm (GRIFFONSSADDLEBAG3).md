...
- Your unarmed strikes with the arm use a `dice:d8|noform|noparens|avg` (`d8`) damage die. A creature hit by an unarmed strike takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) necrotic damage.  
