...
When you cast a spell of 1st level or higher that restores hit points to a single creature, you can use your reaction to expend 2 charges to cause a different creature within 10 feet of the original target to regain `dice:1d8|noform|noparens|avg` (`1d8`) hit points per spell level. When you do, each creature has advantage on the next ability check or saving throw it makes before the end of its next turn.
