...
You can expend 1 or more charges from the bracers to cast the [[5. Mechanics/Spells/Hellish Rebuke.md\|hellish rebuke]] spell (save DC 15) from them. For 1 charge, you cast the 3rd-level version of the spell. You can increase the spell slot level by one for each additional charge you expend. The fire from this spell is a haunting emerald green.
