...
While the patch is attached to a piece of clothing you're wearing, you can't be [[/5. Mechanics/Rules/Conditions.md#Surprised\|surprised]] at the start of combat. Once the patch prevents you from being [[/5. Mechanics/Rules/Conditions.md#Surprised\|surprised]] in this way, it falls off. Alternatively, you can choose to peel off the patch as part of making a Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) check. You make this decision after you roll the `dice:d20|noform|avg` (`d20`), but before knowing the result of the check. When you do, roll a `dice:d4|noform|avg` (`d4`) and add it to the total.
