...
This herb has `dice: 1d4|avg` (`1d4`) charges. As an action, you may use a charge to scatter a pouch of this herb in a 5-foot-square area in front of you. Any creature that enters the area must succeed on a DC 15 Dexterity saving throw or stop moving and take `dice: 1|avg` (`1`) piercing damage. Until the creature regains at least 1 hit point, its walking speed is reduced by 10 feet. A creature moving through the area at half speed doesn't need to make the saving throw.
