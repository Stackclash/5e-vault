...
The scabbard has 3 charges and regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn. When you use the scabbard to grant a weapon a +1 bonus to its attack and damage rolls, you can choose to expend 1 of its charges to increase that weapon's bonus to +2 for the duration instead.
