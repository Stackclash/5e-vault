...
While wearing this armor, you can use a bonus action to speak its command word to force the armor to move more rapidly. When it does, you gain the effect of the [[5. Mechanics/Spells/Haste.md\|haste]] spell (no concentration required), and the armor's joints creak and groan from the increased strain. At the end of each of your turns while you're under this effect, there is a cumulative 20 percent chance that the armor overheats. When it does, you take `dice:1d10|noform|noparens|avg` (`d10`) fire damage from the armor, and the effect ends. Once this property of the armor has been used, it can't be used again until the next dawn.
