...
- **2. Fear Ray.** The targeted creature must succeed on a DC 13 Wisdom saving throw or be [[/5. Mechanics/Rules/Conditions.md#Frightened\|frightened]] for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
- **3. Psychic Ray.** The target must succeed on a DC 13 Intelligence saving throw or take `dice:6d8|noform|avg` (`6d8`) psychic damage.  
...
The wand recovers `dice:1d4|noform|avg` (`1d4`) charges at dawn. When you use the last charge of the wand, there is a 10 percent chance that it crumbles into ashes and is destroyed.
