...
Any creature besides [[5. Mechanics\Bestiary\Npc\Orcus (MPMM).md|Orcus]] that tries to attune to the wand must make a DC 17 Constitution saving throw. On a successful save, the creature takes `dice: 10d6` (`10d6`) necrotic damage. On a failed save, the creature dies and rises as a [[5. Mechanics\Bestiary\Undead\Zombie.md|zombie]].

In the hands of one who is attuned to it, the wand can be wielded as a magic [[5. Mechanics\Items\Mace.md|mace]] that grants a +3 bonus to attack and damage rolls made with it. The wand deals an extra `dice: 2d12` (`2d12`) necrotic damage on a hit.
