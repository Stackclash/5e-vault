...
This magic dagger was made from pieces of a slain basilisk and still retains some of its properties. The dagger deals an extra `dice:1d4|noform|avg` (`1d4`) poison damage to any target it hits.
