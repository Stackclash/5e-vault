...
While the ring has 3 charges, you gain a +3 bonus to damage rolls from weapon attacks, and the minimum number you have to roll on a `dice:d20|noform|noparens|avg` (`d20`) to score a critical hit with a weapon attack is reduced by 1.
