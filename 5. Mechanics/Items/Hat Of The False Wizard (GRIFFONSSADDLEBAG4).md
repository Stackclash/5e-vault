...
This curse is only revealed and extended to you when you cast a spell that isn't a cantrip and are wearing the hat. As long as you're cursed, you can't remove the hat unless you are targeted by the [[5. Mechanics/Spells/Remove Curse.md\|remove curse]] spell or similar magic. While you're cursed, you must first succeed on a DC 13 Constitution saving throw whenever you cast a spell that isn't a cantrip. On a failed save, the spell fails, and the action is wasted.
