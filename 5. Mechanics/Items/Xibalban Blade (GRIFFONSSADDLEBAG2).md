...
If the sword has dealt necrotic damage in this way in the past hour, you can use an action to hold the sword aloft and speak its command word to summon a blood elemental, as if you had cast the [[/5. Mechanics/Spells/Conjure Elemental.md\|conjure elemental]] spell. Once this property of the sword has been used, it can't be used again until the next dawn. A blood elemental uses the same statistics as a [[/5. Mechanics/Bestiary/Elemental/Water Elemental.md\|water elemental]], with the following changes:
