...
A creature hit by this arrow takes an extra `dice:2d6|noform|noparens|avg` (`2d6`) poison damage from the attack, or `dice:3d6|noform|noparens|avg` (`3d6`) if the creature is a plant, and must make a DC 15 Constitution saving throw. On a failed save, the creature is [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]] for 1 hour. A [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]] creature gains the plant type, in addition to its other creature types, for as long as it remains [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]]. After the arrow deals this poison damage, it loses its magic.
