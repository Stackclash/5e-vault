...
In addition, while wearing the hat, you can use an action to speak its command word and throw it on the ground within 10 feet of you. The hat becomes a [[5. Mechanics/Bestiary/Beast/Giant Scorpion.md\|giant scorpion]] under your control and acts on its own initiative count. By using a bonus action to speak the command word again, you return the hat to its normal form in a space formerly occupied by the scorpion.
