...
You can use an action to spray the perfume on a willing creature within 5 feet of you. For 1 hour, that creature can't be disarmed of any item against its will. For the duration, it also gains a +2 bonus to any ability check it makes to hold onto something, such as pulling an item out of another creature's hands, pickpocketing a key from a guard, or holding onto a stone ledge while climbing.
