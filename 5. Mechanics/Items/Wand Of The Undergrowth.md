...
The wand regains `dice: 1d6|avg|noform` (`1d6`) expended charges daily at dawn. If you expend the wand's last charge, roll a `dice: d20|avg|noform` (`d20`). On a 1, the wand crumbles into compost and is destroyed.
