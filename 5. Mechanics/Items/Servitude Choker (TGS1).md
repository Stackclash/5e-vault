...
The necklace can animate an object for up to 8 hours or until it takes damage. When the effect ends, the necklace can't be used again for another `dice:1d8|noform|noparens|avg` (`d8`) hours.
