...
You can remove the patch using an action to magically enhance your reading comprehension and writing skill. You read and write twice as fast for 1 hour. Further, you gain a `dice:1d4|noform|noparens|avg` (`1d4`) bonus to the first Intelligence check you make for the duration.
