...
`dice: [[Teeth Of Dahlver Nar.md#^teeth-of-dahlver-nar]]`

| dice: d20 | Tale and Tooth | Creatures Summoned | Implanted Effect |
|-----------|----------------|--------------------|------------------|
| 1 | The Staring Cats of Uldun-dar (ivory cat molar) | 9 [[5. Mechanics/Bestiary/Beast/Cat.md\|cats]] | The tooth has 8 charges. As an action, you can expend 1 charge to cast the [[5. Mechanics/Spells/Revivify.md\|revivify]] spell from the tooth. If you are dead at the start of your turn, the tooth expends 1 charge and casts [[5. Mechanics/Spells/Revivify.md\|revivify]] on you. |
| 2 | Duggle's Surprising Day (human molar) | 1 [[5. Mechanics/Bestiary/Humanoid/Commoner.md\|commoner]] | When you finish a long rest, the tooth casts [[5. Mechanics/Spells/Sanctuary.md\|sanctuary]] (DC 18) on you, and the spell lasts for 24 hours or until you break it. |
| 3 | The Golden Age of Dhakaan (golden goblin bicuspid) | 10 [[5. Mechanics/Bestiary/Humanoid/Goblin.md\|goblins]], 1 [[5. Mechanics/Bestiary/Humanoid/Goblin Boss.md\|goblin boss]] | When you are hit by an attack and an ally is within 5 feet of you, you can use your reaction to cause them to be hit instead. You can't use this reaction again until you finish a short or long rest. |
| 4 | The Mill Road Murders (halfling canine) | 3 [[5. Mechanics/Bestiary/Fey/Green Hag.md\|green hags]] in a coven | When you damage a target that hasn't taken a turn in this combat, the target takes an extra `dice: 3d10\|avg|noform` (`3d10`) slashing damage from ghostly blades. |
| 5 | Dooms of the Malpheggi (emerald lizardfolk fang) | 1 [[5. Mechanics/Bestiary/Humanoid/Lizard Queen.md\|lizardfolk queen]] and 4 [[5. Mechanics/Bestiary/Humanoid/Lizardfolk.md\|lizardfolk]] | You gain reptilian scales, granting you a +2 bonus to your AC. Additionally, when you finish a long rest, you must succeed on a DC 15 Constitution saving throw or gain 1 level of [[/5. Mechanics/Rules/Conditions.md#exhaustion\|exhaustion]]. |
| 6 | The Stable Hand's Secret (sweet-tasting human canine) | 2 [[5. Mechanics/Bestiary/Fiend/Incubus.md\|incubi]] | When you make a Charisma check against a humanoid, you can roll a `dice: d10\|avg|noform` (`d10`) and add the number rolled as a bonus to the result. The creature then becomes hostile to you at the next dawn. |
| 7 | The Donkey's Dream (rainbow-colored donkey molar) | 1 [[5. Mechanics/Bestiary/Celestial/Unicorn.md\|unicorn]] | The tooth has 3 charges. As an action, you can expend 1 charge to touch a creature. The target regains `dice: 2d8 + 2\|avg|noform` (`2d8 + 2`) hit points, and all diseases and poisons affecting it are removed. When you use this action, a shimmering image of a unicorn's horn appears until the end of your turn, sprouting from your forehead. The tooth regains all expended charges daily at dawn. You gain the following flaw: "When I see wickedness in action, I must oppose it." |
| 8 | Beyond the Rock of Bral (silver mind flayer tooth) | 2 [[5. Mechanics/Bestiary/Aberration/Mind Flayer.md\|mind flayers]] | You gain telepathy out to 120 feet as described in the Monster Manual, and you can cast the [[5. Mechanics/Spells/Detect Thoughts.md\|detect thoughts]] spell at will, requiring no components. You also have disadvantage on Wisdom ([[/5. Mechanics/Rules/Skills.md#Insight\|Insight]]) and Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) checks from constant whispers of memories and nearby minds. |
| 9 | The Disappearances of Half Hollow (vomerine tooth of a Large toad) | 4 [[5. Mechanics/Bestiary/Beast/Giant Toad.md\|giant toads]] | Your long jump is up to 30 feet and your high jump is up to 15 feet, with or without a running start. |
| 10 | Legendry of Phantoms and Ghosts (obsidian human molar) | 1 [[5. Mechanics/Bestiary/Beast/Giant Octopus.md\|giant octopus]], 1 [[5. Mechanics/Bestiary/Humanoid/Mage.md\|mage]], 1 [[5. Mechanics/Bestiary/Undead/Specter.md\|specter]] | As an action, you can use the tooth to cast the [[5. Mechanics/Spells/Evards Black Tentacles.md\|Evard's black tentacles]] spell (DC 18). Once this property is used, it can't be used again until the next dawn. |
| 11 | The Thousand Deaths of Jander Sunstar (yellowed vampire fang) | 1 [[5. Mechanics/Bestiary/Undead/Vampire.md\|vampire]] | You can make a bite attack as an unarmed strike. On a hit, it deals `dice: 1d6\|avg|noform` (`1d6`) piercing damage plus `dice: 3d6\|avg|noform` (`3d6`) necrotic damage. You regain a number of hit points equal to the necrotic damage dealt. While you are in sunlight, you can't regain hit points. |
| 12 | Nightmares of Kaggash (twisted beholder tooth) | 1 [[5. Mechanics/Bestiary/Aberration/Beholder.md\|beholder]] | As an action, you can cast the [[5. Mechanics/Spells/Eyebite.md\|eyebite]] spell from the tooth. Once you use this action, it can't be used again until the next dawn. Whenever you finish a long rest, roll a `dice: d20\|avg|noform` (`d20`). On a 20, an aberration chosen by the DM appears within 30 feet of you and attacks. |
...
| 18 | The Last Tarrasque (jagged sliver of tarrasque tooth) | 1 [[5. Mechanics/Bestiary/Monstrosity/Tarrasque.md\|tarrasque]] (ignores you and your commands appears for `dice: 1d4\|avg|noform` (`1d4`) rounds then vanishes) | You deal double damage to objects and structures. If you take 20 or more damage in one turn, you must succeed on a DC 18 Wisdom saving throw or spend your next turn in a murderous fury. During this rage, you must use your action to make an unarmed strike against a creature that damaged you, or a random creature you can see if you weren't damaged by a creature, moving as close as you can to the target if necessary. |
| 19 | Incendax's Tooth (ruby-veined red dragon fang) | 1 [[5. Mechanics/Bestiary/Dragon/Ancient Red Dragon.md\|ancient red dragon]] | You gain immunity to fire damage, and as an action, you can exhale fire in a 90-foot cone. Each creature in that area must make a DC 24 Dexterity saving throw, taking `dice: 26d6\|avg|noform` (`26d6`) fire damage on a failed save, or half as much damage on a successful one. After using the breath weapon, you gain 2 levels of [[/5. Mechanics/Rules/Conditions.md#exhaustion\|exhaustion]]. |
