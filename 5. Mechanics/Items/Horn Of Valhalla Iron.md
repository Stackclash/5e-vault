...
The iron horn summons `dice:5d4+5|noform|avg` (`5d4 + 5`) [[5. Mechanics/Bestiary/Humanoid/Berserker.md\|berserkers]]. To use the iron horn, you must be proficient with all martial weapons.
