...
You gain a +1 to attack and damage rolls made with this weapon. When you hit an attack using this weapon, the target takes an additional `dice:1d6|noform|avg` (`1d6`) radiant damage.
