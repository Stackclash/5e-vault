...
While enlarged in this way, you have advantage on Strength checks and Strength saving throws, and your weapon attacks done with your enlarged weapons deal an extra `dice: 1d4|avg|noform` (`1d4`) damage. In addition, when you use this ability, you also gain a random trollish mutation for the duration of the enlargement. Roll a `dice: d4|avg|noform` (`d4`) and consult the table below to find your mutation.

**Trollish Mutation**

`dice: [[Amulet Of The Dire.md#^trollish-mutation]]`
...
| 3 | You gain an extra set of arms tipped with claws. As a bonus action, you may make an unarmed strike with them, dealing `dice: 1d6\|avg\|noform` (`1d6`) + your Strength modifier slashing damage on a successful hit. |
