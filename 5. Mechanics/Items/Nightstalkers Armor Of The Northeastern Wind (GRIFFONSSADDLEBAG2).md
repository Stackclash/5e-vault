...
When you take damage from a creature that is within 5 feet of you while wearing this armor, you can use your reaction to deal `dice:1d6|noform|noparens|avg` (`1d6`) cold damage to that creature.
...
- You can take the [[/5. Mechanics/Rules/Actions.md#Attack\|Attack]] action while in this form. When you do, your attacks are unarmed strikes that deal `dice:1d6|noform|noparens|avg` (`1d6`) cold damage, instead of their normal damage.  
