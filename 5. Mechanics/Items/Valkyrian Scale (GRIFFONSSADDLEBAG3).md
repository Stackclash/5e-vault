...
You gain a +2 bonus to your Constitution score, up to a maximum of 20, while wearing this armor. In addition, when a creature that you can see within 5 feet of you takes damage, you can use your reaction to magically reduce that damage by `dice:1d8|noform|noparens|avg` (`1d8`). You take the same amount of damage that was reduced in this way, which ignores resistance and immunity. Record the damage taken in this way, which resets to 0 when you finish a long rest.
