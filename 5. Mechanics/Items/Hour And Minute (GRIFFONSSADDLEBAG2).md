...
If you attune to one of the weapons while another creature is attuned to the other, you are each aware of the other creature's attunement and must make an Intelligence ([[/5. Mechanics/Rules/Skills.md#Arcana\|Arcana]]) check contested by the other creature's Intelligence ([[/5. Mechanics/Rules/Skills.md#Arcana\|Arcana]]) check. The creature that wins the contest remains attuned to the item, and for the next 24 hours, its attunement cannot be broken by another creature attempting to attune to the other weapon. The creature that loses the contest is no longer attuned to the weapon.
