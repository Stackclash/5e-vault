...
Unlike normal scrolls, a scroll of film has multiple uses. Each use requires you to pull out a perforated length of the scroll from its leather case. When found the scroll has `dice:1d6+4|noform|avg` (`1d6 + 4`) lengths.
