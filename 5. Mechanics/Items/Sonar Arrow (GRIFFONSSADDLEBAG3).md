...
A creature that has the Keen Hearing trait gains a +5 bonus to any Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) check it makes until the end of its next turn after hearing the frequency. If the arrow hits a creature with this trait, it takes an extra `dice:3d10|noform|avg` (`3d10`) thunder damage from the attack, instead of `dice:2d10|noform|avg` (`2d10`).
