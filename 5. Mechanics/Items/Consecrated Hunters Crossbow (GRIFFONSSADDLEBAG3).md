...
When the weapon is drawn, radiant, celestial runes appear on the front of the crossbow. A target hit by a bolt fired from this weapon takes an extra `dice:1d4|noform|avg` (`1d4`) radiant damage. If the target is a fiend, undead, or shapechanger, you deal the maximum extra radiant damage, instead of rolling.
