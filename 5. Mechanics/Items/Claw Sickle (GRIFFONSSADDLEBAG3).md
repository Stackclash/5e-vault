...
You can benefit from this magic weapon's following properties even if you aren't attuned to it. The sickle deals `dice:2d4|noform|avg` (`2d4`) slashing damage on a hit, instead of `dice:1d4|noform|avg` (`1d4`), and if you're wielding a claw sickle in either hand and engage in two-weapon fighting, you can add your ability modifier to the damage of the second attack.
