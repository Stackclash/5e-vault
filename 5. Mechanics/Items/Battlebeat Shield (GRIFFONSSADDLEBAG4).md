...
While holding this shield, you have a +1 bonus to AC. This bonus is in addition to the shield's normal bonus to AC. In addition, any thunder damage you take while holding the shield is reduced by `dice:1d6|noform|avg` (`1d6`).
