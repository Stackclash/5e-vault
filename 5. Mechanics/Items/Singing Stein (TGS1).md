...
The stein sings songs slightly out of key if the drink inside is poisoned, which can be heard following a successful Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) check as determined by the GM. If there are multiple kinds of alcohol within it, the stein either alternates between song types or does its best to combine their various lyrics.
