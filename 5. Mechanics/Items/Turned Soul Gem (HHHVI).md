...
If you die while holding this gem, and if this gem has at least 1 charge, you return to life within `dice:1d10|noform|noparens|avg` (`1d10`) days so long as the gem is in contact with you for the entire duration. If it ever leaves contact with you, the magic of the gem fades and becomes a mundane object. At the end of the `dice:1d10|noform|noparens|avg` (`1d10`) days, the gem loses 1 charge and you return to life as if the [[/5. Mechanics/Spells/Reincarnate.md\|reincarnate]] spell had been cast on you, with your new body identical to one of the creatures whose soul had been devoured by this item (chosen randomly). Once a body has been chosen, it cannot be chosen again.
