...
This flail has the two-handed, heavy, and reach properties. Attacks made with the flail deal an extra `dice:1d8|noform|noparens|avg` (`1d8`) bludgeoning damage, or `dice:2d8|noform|noparens|avg` (`2d8`) if the target is a structure. When you roll a 20 on an attack roll made with this magic weapon against a Huge or smaller creature, that creature must succeed on a DC 16 Strength saving throw or be knocked [[/5. Mechanics/Rules/Conditions.md#Prone\|prone]].
