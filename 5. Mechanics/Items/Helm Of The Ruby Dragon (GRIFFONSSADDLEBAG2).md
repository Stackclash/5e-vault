...
When you use your breath weapon while wearing this helmet, you can choose to exhale a blast of pure, concussive force. When you do, your breath weapon deals force damage, instead of its normal damage type, and any creature that fails the saving throw takes an extra `dice:2d6|noform|avg` (`2d6`) psychic damage and is [[/5. Mechanics/Rules/Conditions.md#Stunned\|stunned]] until the end of your next turn. This property of the helm can't be used again until the next dawn.
