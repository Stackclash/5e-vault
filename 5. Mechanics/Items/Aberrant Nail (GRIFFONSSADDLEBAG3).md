...
While attuned to this sword, your Intelligence score is 19. It has no effect on you if your Intelligence is already 19 or higher without it. When you hit with an attack using this weapon, the target takes an extra `dice:1d8|noform|noparens|avg` (`1d8`) psychic damage. While holding the sword, you have resistance to psychic damage.
