...
This potion contains trace amounts of gorgon blood. When you drink this potion, you're immune to being [[/5. Mechanics/Rules/Conditions.md#Petrified\|petrified]] for `dice:1d4|noform|noparens|avg` (`d4`) hours. If you're already [[/5. Mechanics/Rules/Conditions.md#Petrified\|petrified]], another creature can apply the potion to you and suspend the effect for `dice:1d4|noform|noparens|avg` (`d4`) hours instead. In either case, for the duration of the potion's effects, your skin hardens into flexible metal plates; your AC can't be lower than 18.
