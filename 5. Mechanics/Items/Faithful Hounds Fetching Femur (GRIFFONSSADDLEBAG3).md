...
- You can use an action to throw the rod at a target that you can see within 30 feet of you (attack bonus +10). On a hit, the rod deals `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) bludgeoning damage, plus your Strength or Dexterity modifier (your choice), and the hound immediately moves to the target's space and attacks it. Hit or miss, the hound then returns the rod to your hand or drops it at your feet (your choice). It then remains in a space of your choice within 5 feet of you until it's moved again.  
