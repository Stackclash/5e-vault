...
When a creature that you can see within 60 feet of you makes a saving throw against being [[/5. Mechanics/Rules/Conditions.md#Blinded\|blinded]], [[/5. Mechanics/Rules/Conditions.md#Deafened\|deafened]], diseased, [[/5. Mechanics/Rules/Conditions.md#Paralyzed\|paralyzed]], [[/5. Mechanics/Rules/Conditions.md#Petrified\|petrified]], or [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]], you can expend 1 of the necklace's charges as a reaction to grant that creature a bonus to the save equal to `dice:1d10|noform|avg` (`1d10`). Regardless of whether the saving throw succeeds or fails, the creature also gains a number of temporary hit points equal to the roll's bonus.
