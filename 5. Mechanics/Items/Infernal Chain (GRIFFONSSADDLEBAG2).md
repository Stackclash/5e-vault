...
When swung, the chain releases flames and billowing smoke. This magic weapon has the reach and heavy properties, and any target hit with it takes an extra `dice:1d8|noform|noparens|avg` (`1d8`) fire damage.

You can choose to use this chain instead of your normal reach when you [[/5. Mechanics/Rules/Actions.md#Grapple\|grapple]] a target on your turn. While a target is [[/5. Mechanics/Rules/Conditions.md#Grappled\|grappled]] by the chain, you can't use the chain to make a weapon attack, but you can use a bonus action to pull the target 5 feet toward you. At the start of each of its turns, a creature [[/5. Mechanics/Rules/Conditions.md#Grappled\|grappled]] by the chain takes `dice:2d8|noform|noparens|avg` (`2d8`) fire damage. A creature [[/5. Mechanics/Rules/Conditions.md#Grappled\|grappled]] by the chain doesn't have its speed reduced as a result of the grapple, but it can't move farther than 10 feet away from you until the grapple ends.
