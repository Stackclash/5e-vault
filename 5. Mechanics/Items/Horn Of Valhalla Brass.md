...
A brass horn summons `dice: 3d4 + 3|avg` (`3d4 + 3`) [[5. Mechanics/Bestiary/Humanoid/Berserker.md\|berserkers]]. To use the brass horn, you must be proficient with all simple weapons.
