...
A newly found rod has `dice:1d10|noform|noparens|avg` (`d10`) levels of spell energy stored in it already. A rod that can no longer absorb spell energy and has no energy remaining becomes nonmagical.
