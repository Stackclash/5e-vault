...
- When one creature you can see takes damage from an evocation spell you cast, you can use your reaction and expend 1 charge to deal an extra `dice: 2d6|avg|noform` (`2d6`) force damage to the creature and knock the creature [[/5. Mechanics/Rules/Conditions.md#prone\|prone]] if it is Large or smaller.  
