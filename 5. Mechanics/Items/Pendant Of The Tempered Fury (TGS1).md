...
In addition, the pendant has 3 charges and regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn. You can use a bonus action to expend 1 of its charges to ignite your hands in a magical flame. While lit, your arms and hands cast bright light in a 10-foot radius and dim light for another 10 feet, and your unarmed attacks deal an additional `dice:1d4|noform|noparens|avg` (`1d4`) fire damage to any target they hit. Your hands remain lit for 1 minute or until you use a bonus action to quench them.
