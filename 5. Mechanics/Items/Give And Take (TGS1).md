...
The scimitars have a collective 10 charges and regain `dice:1d6+4|noform|noparens|avg` (`1d6 + 4`) expended charges daily at midday. When you hit a creature with one of these magic weapons, you can expend 1 of their charges to create an effect based on the blade used in the attack:

## Give

When you hit a creature with *Give* and expend 1 charge, you and all other creatures within 5 feet of the target (other than the target) gain `dice:2d6|noform|noparens|avg` (`2d6`) temporary hit points that last for 1 minute.
