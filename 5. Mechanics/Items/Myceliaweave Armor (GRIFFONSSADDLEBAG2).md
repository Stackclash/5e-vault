...
Once you don and attune to this magic armor, you can't doff it unless you die or are targeted by the [[5. Mechanics/Spells/Remove Curse.md\|remove curse]] spell: a side effect of the violet fungus' magical and parasitic effects. When your attunement to the armor ends, your Constitution score is reduced by 2 (to a minimum score of 1) until `dice:2d6+6|noform|noparens|avg` (`2d6 + 6`) days have passed or until you attune to the armor again.
