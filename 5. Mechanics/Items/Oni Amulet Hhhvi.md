...
- You may spend a bonus action to summon a magical glaive into your empty hand. You are proficient in wielding this glaive if you weren't already before. In addition, if for whatever reason you grow in size, this glaive grows in proportion with you and deals an additional `dice: 1d10|avg` (`1d10`) damage if you become larger than Medium sized. This glaive disappears if it is out of your hand for more than 1 minute.  
