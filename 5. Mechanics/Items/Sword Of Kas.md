...
While the sword is on your person, you can use an action to cast one of the following spells (save 18) from it: [[5. Mechanics\Spells\Call Lightning.md|call lightning]], [[5. Mechanics\Spells\Divine Word.md|divine word]], or [[5. Mechanics\Spells\Finger Of Death.md|finger of death]]. Once you use the sword to cast a spell, you can't cast that spell again from it until the next dawn.
...
The sword's purpose is to bring ruin to Vecna. Killing Vecna's worshipers, destroying the [[5. Mechanics\Bestiary\Undead\Lich.md|lich's]] works, and foiling his machinations all help to fulfill this goal.

The Sword of Kas also seeks to destroy anyone corrupted by the Eye and [[5. Mechanics\Items\Hand Of Vecna.md|Hand of Vecna]]. The sword's obsession with those artifacts eventually becomes a fixation for its wielder.
