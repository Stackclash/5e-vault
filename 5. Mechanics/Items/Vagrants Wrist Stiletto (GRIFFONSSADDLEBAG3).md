...
If you're a rogue and extend the blade from the bracer as part of the [[/5. Mechanics/Rules/Actions.md#Attack\|Attack]] action, you can use your Sneak Attack when you make an attack with the magic dagger this turn even if you don't have advantage on the attack roll, but not if you have disadvantage on it. When you deal your Sneak Attack damage in this way, the target takes an extra `dice:1d6|noform|noparens|avg` (`1d6`) damage. All the other rules for Sneak Attack still apply to you.
