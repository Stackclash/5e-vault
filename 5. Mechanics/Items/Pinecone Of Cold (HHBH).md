...
As an action, you may throw this pinecone up to 20 feet, causing it to explode upon impact. All creatures within 5 feet of impact must make a DC 15 Constitution saving throw, suffering `dice:4d6|noform|avg` (`4d6`) cold damage on a failure or half that on a success.
