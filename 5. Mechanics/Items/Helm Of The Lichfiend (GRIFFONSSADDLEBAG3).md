...
The [[/5. Mechanics/Bestiary/Undead/Skeleton.md\|skeleton]] deals an extra `dice:1d6|noform|noparens|avg` (`1d6`) fire damage to any target it hits.

A creature that touches the skeleton or hits it with a melee attack while within 5 feet of it takes `dice:1d6|noform|noparens|avg` (`1d6`) fire damage.
