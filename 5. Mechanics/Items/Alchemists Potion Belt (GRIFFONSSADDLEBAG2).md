...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/GriffonsSaddlebag2/Items/Alchemists-Potion-Belt.webp#right)  
...
When you roll a 1 on a Dexterity saving throw or are hit by a critical hit, roll a `dice:d20|noform|avg` (`d20`). On a 1, one of the bottles on the belt shatters and is destroyed.
