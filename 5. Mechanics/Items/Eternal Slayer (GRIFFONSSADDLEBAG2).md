...
aliases:
  - Eternal Slayer
  - Eternal Slayer Double-Bladed Scimitar
  - Eternal Slayer Greatsword
  - Eternal Slayer Longsword
...
You gain a +2 bonus to attack and damage rolls made with this magic weapon. When you make an attack with this sword, the toothed chain stretching along its lower edge begins to whir and spin, spewing flame and ripping apart any target it hits. Any target hit by this sword takes an extra `dice:1d6|noform|noparens|avg` (`d6`) fire damage and `dice:1d6|noform|noparens|avg` (`d6`) slashing damage. If the target is an aberration or fiend, this extra damage is doubled. This fire damage ignores resistance and immunity. A wooden creature, object, or structure hit by this weapon takes the maximum amount of damage from the attack.
