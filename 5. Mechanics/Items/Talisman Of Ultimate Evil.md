...
This item symbolizes unrepentant evil. A creature that is neither good nor evil in alignment takes `dice: 6d6` (`6d6`) necrotic damage upon touching the talisman. A good creature takes `dice: 8d6` (`8d6`) necrotic damage upon touching the talisman. Either sort of creature takes the damage again each time it ends its turn holding or carrying the talisman.
