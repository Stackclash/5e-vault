...
While wearing the armor, you can use an action to cast either the hold monster or [[5. Mechanics/Spells/Hold Person.md\|hold person]] spell from the armor, using your spell save DC. When you do, the spell holds the target in place with magical chains; for the spell's duration, the target takes `dice:3d6|noform|avg` (`3d6`) bludgeoning damage from the chains at the start of each of its turns. Once you cast a spell in this way, that spell can't be cast from the armor again until the next dawn.
