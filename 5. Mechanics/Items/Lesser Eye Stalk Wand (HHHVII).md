...
- **1. Devour Magic Ray.** The targeted creature must succeed on a DC 14 Dexterity saving throw or have one of its magic items lose all magical properties until the start of your next turn. If the object is a charged item, it also loses `dice:1d4|noform|noparens|avg` (`d4`) charges. Determine the affected item randomly, ignoring single-use items such as potions and scrolls.  
- **2. Enervation Ray.** The targeted creature must make a DC 14 Constitution saving throw, taking `dice:4d8|noform|noparens|avg` (`4d8`) necrotic damage on a failed save, or half as much damage on a successful one.  
...
- **4. Fire Ray.** The targeted creature must succeed on a DC 14 Dexterity saving throw or take `dice:4d10|noform|noparens|avg` (`4d10`) fire damage.  
...
The wand recovers `dice:1d2|noform|noparens|avg` (`d2`) charges at dawn. When you use the last charge of the wand, there is a 10 percent chance that it crumbles into ashes and is destroyed.
