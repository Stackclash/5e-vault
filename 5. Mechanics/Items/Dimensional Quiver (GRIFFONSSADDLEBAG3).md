...
The quiver also functions as an efficient quiver. The first time you hit a target on each of your turns using a piece of ammunition or a weapon drawn from the quiver, that target takes an extra `dice:1d12|noform|noparens|avg` (`1d12`) force damage from the attack.
