...
You can doff the shield when planting it by using an action to do so instead of a bonus action. The shield magically remains upright and in place and can be used as half cover to any creature standing immediately behind it in the space it was left in. The shield falls down when you fall unconscious or when knocked over following a successful DC 20 Strength ([[/5. Mechanics/Rules/Skills.md#Athletics\|Athletics]]) check. You can move the shield while it's planted by donning the shield again.
