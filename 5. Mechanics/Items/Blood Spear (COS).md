...
- **Damage**:
  ...
  - Two-handed: 1d8 P
- **Range**: 20/60
- **Properties**: [[5. Mechanics/Rules/Item Properties.md#Requires%20Attunement|Requires Attunement]], [[5. Mechanics/Rules/Item Properties.md#Thrown|Thrown]], [[5. Mechanics/Rules/Item Properties.md#Versatile|Versatile]]
- **Cost**: ⏤
- **Weight**: 3.0 lbs.
...
When you hit with a melee attack using this magic spear and reduce the target to 0 hit points, you gain `dice: 2d6` (`2d6`) temporary hit points.
