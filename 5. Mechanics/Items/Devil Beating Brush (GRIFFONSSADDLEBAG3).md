...
You can use an action to paint on a devil. Make a Dexterity or Charisma check using the paintbrush against the devil's AC. On a success, the devil takes `dice:4d6|noform|avg` (`4d6`) radiant damage. If you roll a 20 on the ability check, the devil must also succeed on a DC 15 Charisma saving throw or be banished to its home plane of existence, unless it's already there.
