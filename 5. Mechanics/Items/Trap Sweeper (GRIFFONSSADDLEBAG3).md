...
Once the broom has been used to sweep for the third time in this way, it can't do so again until `dice:1d4-1|noform|avg` (`1d4 - 1`) days have passed. If you roll a 1 on the `dice:d4|noform|avg` (`d4`), the broom regains all uses of this property and can be used again immediately.
