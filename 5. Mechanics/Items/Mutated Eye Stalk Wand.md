...
- **3. Psychic Ray.** The target must succeed on a DC 13 Intelligence saving throw or take `dice: 6d8|avg|noform` (`6d8`) psychic damage.  
...
The wand recovers `dice: 1d4|avg|noform` (`1d4`) charges at dawn. When you use the last charge of the wand, there is a 90% chance chance that it crumbles into ashes and is destroyed.
