...
A creature that starts its turn within the bright light or enters it for the first time on its turn must succeed on a DC 15 Constitution saving throw or take `dice:2d6|noform|noparens|avg` (`2d6`) radiant damage.
