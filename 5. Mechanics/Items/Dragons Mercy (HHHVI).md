...
Once this item has been used once, it cannot be used again for `dice:1d4|noform|noparens|avg` (`1d4`) hours.
...
- [[/5. Mechanics/Items/Dragons Mercy Wyrmling (HHHVI).md\|Dragon's Mercy (Wyrmling)]]
- [[/5. Mechanics/Items/Dragons Mercy Young (HHHVI).md\|Dragon's Mercy (Young)]]
- [[/5. Mechanics/Items/Dragons Mercy Adult (HHHVI).md\|Dragon's Mercy (Adult)]]
