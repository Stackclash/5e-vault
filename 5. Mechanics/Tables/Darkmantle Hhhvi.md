...
`dice: [[Darkmantle Hhhvi.md#^dc-item-description-value-weight-crafting]]`
...
| 15 | Darkmantle Otolith | A bony structure on the inside of a darkmantle's head that acts as its ear. Skilled artificers can use this to create a variety of audio enhancing magical items. | 2 gp | 1 lb | [[5. Mechanics/Items/Ear Horn Of Hearing (XGE).md\|Ear Horn of Hearing]] |
^dc-item-description-value-weight-crafting