...
| 7 | The creature doesn't require food, drink, or sleep for `dice:1d4\|noform\|noparens\|avg` (`1d4`) days. For the duration, the creature can't be put to sleep by magic, and its dreams intrude upon its waking thoughts, imposing disadvantage on its Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) checks. |
