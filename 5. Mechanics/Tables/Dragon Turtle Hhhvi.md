...
`dice: [[Dragon Turtle Hhhvi.md#^dc-item-description-value-weight-crafting]]`
...
| 25 | Dragon Turtle Shell Shard | Almost thicker than the scales of an ancient dragon, the shell of a dragon turtle is able to deflect almost anything the sea can throw at it. Although it can be difficult to find one that is suitable, a shard of a dragon turtle's shell can make for one of the finest shields known outside of legends. | 6,000 gp | 10 lb | +3 Shield |
^dc-item-description-value-weight-crafting