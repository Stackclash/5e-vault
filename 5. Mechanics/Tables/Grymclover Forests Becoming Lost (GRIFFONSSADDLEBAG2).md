...
| 8 | Despite getting lost, the party recovers and ends the day only `dice:1d4\|noform\|noparens\|avg` (`1d4`) miles away from their intended destination for that day. |
^setback
