...
`dice: [[Secondary Tables Punishment.md#^punishment]]`
...
| 9-12 | You were caught and convicted. You spent time in jail, chained to an oar, or performing hard labor. You served a sentence of `dice: 1d4\|avg|noform` (`1d4`) years or succeeded in escaping after that much time. |
^punishment
