...
| 1d6 + <span title='default=0, max=2, min=0'>[+2 if the characters ignored an event]</span>;2d6 + <span title='default=0, max=2, min=0'>[+2 if the characters ignored an event]</span> | Encounter |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
