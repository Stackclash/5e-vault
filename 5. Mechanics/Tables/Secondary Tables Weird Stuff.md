...
`dice: [[Secondary Tables Weird Stuff.md#^weird-stuff]]`

| dice: d12 | What Happened |
|-----------|---------------|
| 1 | You were turned into a toad and remained in that form for `dice: 1d4\|avg|noform` (`1d4`) weeks. |
...
| 3 | You were enslaved by a hag, a satyr, or some other being and lived in that creature's thrall for `dice: 1d6\|avg|noform` (`1d6`) years. |
| 4 | A dragon held you as a prisoner for `dice: 1d4\|avg|noform` (`1d4`) months until adventurers killed it. |
...
| 7 | You went insane for `dice: 1d6\|avg|noform` (`1d6`) years and recently regained your sanity. A tic or some other bit of odd behavior might linger. |
