...
`dice: [[Deep Scion Trinket Table.md#^item-value-weight]]`
...
| 5 | `dice: 1d8\|avg|noform` (`1d8`) pieces of vibrant coral | 2 sp | 4 lb |
| 6 | `dice: 1d4\|avg|noform` (`1d4`) pilfered trinkets | 5 gp | 2 lb |
| 7 | 1 memento of previous life (picture, doll, small piece of jewelry) | Varies | Varies |
| 8 | `dice: 4d10\|avg|noform` (`4d10`) [[5. Mechanics/Items/Silver Sp.md\|silver pieces]] | Varies | Varies |
^item-value-weight
