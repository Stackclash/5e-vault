...
|----|------|-------------|-------|--------|----------|
| 15 | Gazer Eyestalk | The tiny stalks of a gazer are incredibly difficult to harvest undamaged, and the wands they create are just as fragile. They are best treated as weapons of last resort for a mage that is out of options. If a player harvests an eye stalk, roll `dice:1d4\|noform\|noparens\|avg` (`1d4`). The type of eye stalk they receive corresponds to the number rolled, as described in the gazer's statblock. | 1 gp | 1 lb | [[/5. Mechanics/Items/Minor Eye Stalk Wand (HHHVII).md\|Minor Eye Stalk Wand]] |
