...
| 86–95 | Other creatures appear within the Mists. Roll any die. If you roll an even number, a lost and terrified [[5. Mechanics/Bestiary/Humanoid/Commoner.md\|commoner]] appears. If you roll an odd number, `dice:2d6\|noform\|avg` (`2d6`) [[5. Mechanics/Bestiary/Undead/Skeleton.md\|skeletons]] or 1 [[5. Mechanics/Bestiary/Monstrosity/Unspeakable Horror (VRGR).md\|unspeakable horror]] (see "chapter 5") appears. After the encounter, another `dice:1d6\|noform\|avg` (`1d6`) hours pass, then roll on this table again. |
