...
| 21–40 | Characters wander the Mists for another `dice:1d6\|noform\|noparens\|avg` (`1d6`) hours, then roll on this table again. |
| 41–65 | Characters emerge from the Mists on stable ground `dice:1d100\|noform\|noparens\|avg` (`1d100`) feet away from where they entered. |
...
| 86–95 | Other creatures appear within the Mists. Roll any die. If you roll an even number, a lost and terrified [[/5. Mechanics/Bestiary/Humanoid/Commoner.md\|commoner]] appears. If you roll an odd number, `dice:2d6\|noform\|noparens\|avg` (`2d6`) [[/5. Mechanics/Bestiary/Undead/Skeleton.md\|skeletons]] or 1 [[/5. Mechanics/Bestiary/Monstrosity/Unspeakable Horror (VRGR).md\|unspeakable horror]] (see "chapter 5") appears. After the encounter, another `dice:1d6\|noform\|noparens\|avg` (`1d6`) hours pass, then roll on this table again. |
...
| 100 | Characters emerge from the Mists on a world on the Material Plane. After `dice:1d6\|noform\|noparens\|avg` (`1d6`) hours, the Mists rise around them once more. Roll again on this table. |
^wandering-the-mists
