...
| 26–30 | A cluster of `dice: 1d4 + 2\|avg` (`1d4 + 2`) faintly glowing grubs appears in an unoccupied space within 30 feet of the party. Any creature that consumes one of these succulent grubs receives the benefits of a [[5. Mechanics/Items/Potion Of Healing.md\|potion of healing]]. |
