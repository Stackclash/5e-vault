...
`dice: [[/5. Mechanics/Tables/Githyanki Trinket Table (HHHVIII).md#^item-value-weight]]`

| dice: d8 | Item | Value | Weight |
|----------|------|-------|--------|
| 1 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) energy stimulating chewable roots | 8 sp | — |
...
| 8 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) stolen trinkets | 10 gp | 2 lb |
^item-value-weight
