...
| 21-30 | While attuned to the artifact, you regain `dice:1d6\|noform\|noparens\|avg` (`1d6`) hit points at the start of your turn if you have at least 1 hit point. |
| 31-40 | When you hit with a weapon attack while attuned to the artifact, the target takes an extra `dice:1d6\|noform\|noparens\|avg` (`1d6`) damage of the weapon's type. |
