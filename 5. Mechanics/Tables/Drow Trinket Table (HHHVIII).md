...
`dice: [[/5. Mechanics/Tables/Drow Trinket Table (HHHVIII).md#^item-value-weight]]`
...
| 5 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) bags of spider eggs | 2 sp | 1 lb |
| 6 | 1 gilded hair comb | 2 gp | — |
| 7 | 1 seal of their house | 10 gp | 2 lb |
| 8 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) spikes designed for torture and interrogation | 2 sp | 1 lb |
^item-value-weight
