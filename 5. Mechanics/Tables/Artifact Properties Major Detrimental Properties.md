...
| 26-30 | The artifact imprisons a [[5. Mechanics/Bestiary/Aberration/Death Slaad.md|") (see the Monster Manual"]]. Each time you use one of the artifact's properties as an action, the slaad has a 10% chance chance of escaping, whereupon it appears within 15 feet of you and attacks you. |
...
| 81-85 | Each time you become attuned to the artifact, you age `dice: 3d10\|avg` (`3d10`) years. You must succeed on a DC 10 Constitution saving throw or die from the shock. If you die, you are instantly transformed into a [[5. Mechanics/Bestiary/Undead/Wight.md|") (see the Monster Manual"]] under the DM's control that is sworn to protect the artifact. |
