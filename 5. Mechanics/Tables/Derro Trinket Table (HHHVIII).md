...
`dice: [[/5. Mechanics/Tables/Derro Trinket Table (HHHVIII).md#^item-value-weight]]`

| dice: d8 | Item | Value | Weight |
|----------|------|-------|--------|
| 1 | 1 stolen ale [[/5. Mechanics/Items/Flask.md\|flask]] | 2 sp | 1 lb |
| 2 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) dried fungus [[/5. Mechanics/Items/Rations 1 Day.md\|rations]] | 3 sp | 1 lb |
...
| 6 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) semi-precious gems | 10 gp | 3 lb |
| 7 | 1 bag of dirt | 1 cp | 5 lb |
| 8 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) stolen trinkets | 5 gp | 2 lb |
^item-value-weight
