...
aliases: ["Bugbear Trinket Table"]
---
# Bugbear Trinket Table
*Source: Hamund's Harvesting Handbook: Volume I p. 15* 

`dice: [[Bugbear Trinket Table.md#^item-value-weight]]`

| dice: d8 | Item | Value | Weight |
|----------|------|-------|--------|
| 1 | `dice: 1d4\|avg` (`1d4`) days' worth of [[5. Mechanics/Items/Rations 1 Day.md\|rations]] (mouldy produce) | 8 cp | 2 lb |
