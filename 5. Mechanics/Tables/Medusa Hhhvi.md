...
`dice: [[Medusa Hhhvi.md#^dc-item-description-value-weight-crafting]]`
...
| 20 | Medusa Head | **.** The notorious visage of a medusa transforms any creature that gazes upon it to stone. This property persists even into its death, and unfortunate adventurers can find themselves accidentally petrified when they go to inspect their kill. Even though the idea may be macabre, the preserved head of a medusa can be attached to equipment to petrify any that gaze upon it.<br /><br />**Use.** The head of the medusa carries the same petrifying gaze ability as listed in the statblock of the medusa, with the exception that the head cannot petrify itself. | 130 gp | 10 lb | [[5. Mechanics/Items/Medusa Helm Hhhvi.md\|Medusa Helm]] |
^dc-item-description-value-weight-crafting