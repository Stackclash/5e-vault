...
`dice: [[Blessed Radiance Effects.md#^blessed-radiance-effects]]`
...
| 07–12 | Radiant energy erupts in a 10-foot-radius sphere centered on one random creature in the region. Each creature in the sphere that isn't undead regains `dice: 3d6\|avg\|noform` (`3d6`) hit points. Each undead creature in the sphere takes `dice: 3d6\|avg\|noform` (`3d6`) radiant damage. |
...
| 25–30 | One character in the region is suffused with celestial power. For 1 minute, the character's melee attacks deal an extra `dice: 2d6\|avg\|noform` (`2d6`) radiant damage on a hit. |
