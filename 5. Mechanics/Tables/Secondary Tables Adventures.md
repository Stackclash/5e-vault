...
| dice: d100 | Outcome |
|------------|---------|
| 1-10 | You nearly died. You have nasty scars on your body, and you are missing an ear, `dice: 1d3\|avg` (`1d3`) fingers, or `dice: 1d4\|avg` (`1d4`) toes. |
...
| 81-90 | You found some treasure on your adventure. You have `dice: 2d6\|avg` (`2d6`) gp left from your share of it. |
| 91-99 | You found a considerable amount of treasure on your adventure. You have `dice: 1d20+50\|avg` (`1d20+50`) gp left from your share of it. |
