...
`dice: [[Spirit Naga Hhhvi.md#^dc-item-description-value-weight-crafting]]`
...
| 15 | Spirit Naga Fang (×2) | Nagas require no glands to produce their venom as their fangs remain venomous even when the naga is reduced to a skeletal form. Proper extraction and then re-smithing allows these fangs to serve as powerful weapons with an extra poisonous punch. Beware though, as a revived naga may not take kindly to the idea of a mortal running around with one of their teeth. | 30 gp | 12 lb | [[5. Mechanics/Items/Viper Strike Hhhvi.md\|Viper Strike]] |
^dc-item-description-value-weight-crafting