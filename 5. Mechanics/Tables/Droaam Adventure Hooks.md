...
`dice: [[Droaam Adventure Hooks.md#^droaam-adventure-hooks]]`

| dice: d6 | Adventure Hook |
|----------|----------------|
| 1 | A [[5. Mechanics/Bestiary/Monstrosity/Medusa.md\|medusa]] sends authorities a broken stone finger bearing a distinctive signet ring, and invites emissaries to bring gold, a magic item, or some other ransom for the [[/5. Mechanics/Rules/Conditions.md#petrified\|petrified]] individual's release. |
...
| 6 | An [[5. Mechanics/Bestiary/Giant/Ogre.md\|ogre]] warlord is accused of destroying a village just outside the borders of Droaam. The characters must bring the warlord to justice or work with the ogre to find the real culprit. |
^droaam-adventure-hooks
