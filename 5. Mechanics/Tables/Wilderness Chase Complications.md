...
| 3 | You run through a [[/5. Mechanics/Bestiary/Beast/Swarm Of Insects.md\|swarm of insects]] (see the Monster Manual for game statistics, with the DM choosing whichever kind of insects makes the most sense). The swarm makes an opportunity attack against you (`dice:1d20+3\|noform\|noparens\|text(+3)` to hit; `dice:4d4\|noform\|noparens\|avg` (`4d4`) piercing damage on a hit). |
