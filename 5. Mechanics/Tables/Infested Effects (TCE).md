...
| 26–30 | A cluster of `dice:1d4+2\|noform\|avg` (`1d4 + 2`) faintly glowing grubs appears in an unoccupied space within 30 feet of the party. Any creature that consumes one of these succulent grubs receives the benefits of a [[5. Mechanics/Items/Potion Of Healing.md\|potion of healing]]. |
...
| 61–65 | One random creature in the region must succeed on a DC 16 Constitution saving throw or contract the [[/5. Mechanics/Rules/Diseases.md#Sight%20Rot\|sight rot disease]] (see the "Dungeon Master's Guide") from minute parasites. |
