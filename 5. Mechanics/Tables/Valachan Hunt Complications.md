...
`dice: [[Valachan Hunt Complications.md#^valachan-hunt-complications]]`
...
| 4 | [[5. Mechanics/Bestiary/Aberration/Chuul.md\|Chuuls]], [[5. Mechanics/Bestiary/Plant/Vine Blight.md\|vine blights]], or [[5. Mechanics/Bestiary/Undead/Zombie Plague Spreader.md\|zombie plague spreaders]] (see "chapter 5") ambush the party. |
| 5 | The characters find a tree bound in rope. One or more withered, oversized hearts hang from cords attached to its branches. Roll a die. If you roll an even number, the hearts look grim but are harmless. If you roll an odd number, the `dice: 1d6\|avg|noform` (`1d6`) hearts have the statistics of gnashing [[5. Mechanics/Bestiary/Undead/Deaths Head.md\|death's heads]] (see "chapter 5") and attack. |
