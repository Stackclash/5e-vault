...
`dice: [[/5. Mechanics/Tables/Artifact Properties Minor Detrimental Properties.md#^minor-detrimental-properties]]`
...
| 81-85 | While attuned to the artifact, you deal `dice:1d6\|noform\|noparens\|avg` (`1d6`) necrotic damage to any plant you touch that isn't a creature. |
