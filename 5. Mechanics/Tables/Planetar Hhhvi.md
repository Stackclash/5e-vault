...
|----|------|-------------|-------|--------|----------|
| 5 | Planetar Ear (×2) | **.** A planetar is known for its ability to hear lies whenever they are spoken. Their ears carry on this trait even in death and can be seen twitching when falsehood passes through them.<br /><br />**Use.** While holding two of these ears, you have advantage on Wisdom (Insight) ability checks to detect a lie being spoken. | 200 gp | 2 lb | — |
