...
`dice: [[/5. Mechanics/Tables/Hazlan Adventures (VRGR).md#^hazlan-adventures]]`
...
| 3 | Innumerable [[/5. Mechanics/Bestiary/Monstrosity/Gremishka (VRGR).md\|gremishkas]] collect in caves along what's known as the Gnawing Path. The creatures plot to overwhelm Sly-Var and will pass through Toyalis in the process. Members of both communities request exterminators. |
...
| 5 | One of Hazlik's apprentices sends multiple groups to capture a star spawn emissary that emerged from a meteor in Moonstone Valley. But the shape-shifter disappears, slipping in among its would-be captors. |
