...
`dice: [[/5. Mechanics/Tables/Borca Adventures (VRGR).md#^borca-adventures]]`
...
| 8 | Members of the Ulmist Inquisition accuse the characters of crimes they haven't yet committed. They relent only if the characters undertake a mission against the [[/5. Mechanics/Bestiary/Humanoid/Priest Of Osybus (VRGR).md\|priests of Osybus]]. |
^borca-adventures
