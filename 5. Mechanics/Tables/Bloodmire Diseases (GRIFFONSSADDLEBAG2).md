...
| dice: 2d8 | Disease |
|-----------|---------|
| 2–3 | Bloodburnt Rash: At the start of each of your turns when you are not under the bloodwater, you take `dice:1d6\|noform\|noparens\|avg` (`1d6`) fire damage. This disease lasts until you take fire damage equal to half your hit point maximum in this way. |
...
| 9–15 | Rusting Flesh: Sometimes called the Iron Curse, this disease causes your flesh to corrode and slough off. You take `dice:1d8\|noform\|noparens\|avg` (`1d8`) necrotic damage and your maximum hit points are reduced by the same amount each day at dusk. If your hit point maximum drops to 0 in this way, you die. This disease lasts until 7 days have passed. |
