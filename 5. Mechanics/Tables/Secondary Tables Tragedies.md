...
| 5 | You were imprisoned for a crime you didn't commit and spent `dice: 1d6\|avg\|noform` (`1d6`) years at hard labor, in jail, or shackled to an oar in a slave galley. |
...
| 11 | A romantic relationship ended. Roll a `dice: d6\|avg\|noform` (`d6`). An odd number means it ended with bad feelings, while an even number means it ended amicably. |
| 12 | A current or prospective romantic partner of yours died. Roll on the Cause of Death supplemental table to find out how. If the result is murder, roll a `dice: d12\|avg\|noform` (`d12`). On a 1, you were responsible, whether directly or indirectly. |
^tragedies
