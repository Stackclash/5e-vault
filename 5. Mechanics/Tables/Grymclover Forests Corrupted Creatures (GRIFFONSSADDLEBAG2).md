...
| 4 | The creature is covered in dense brambles, which grant it a +2 bonus to AC and deals `dice:1d6\|noform\|noparens\|avg` (`1d6`) piercing damage to any creature that [[/5. Mechanics/Rules/Actions.md#Grapple\|grapples]] it or is [[/5. Mechanics/Rules/Conditions.md#Grappled\|grappled]] by it at the start of each of its turns. |
