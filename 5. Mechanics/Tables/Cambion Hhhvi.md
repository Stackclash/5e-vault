...
`dice: [[Cambion Hhhvi.md#^dc-item-description-value-weight-crafting]]`
...
| 15 | Cambion Wing (×2) | As with many fiends, the wings of a cambion are useful in creating the famous item: [[5. Mechanics/Items/Infernal Wings Hhhvi.md\|infernal wings]]. When taken whole, they can serve as a majority of the base, forming bat wings when the final item is put to use. | 30 gp | 20 lb | [[5. Mechanics/Items/Infernal Wings Hhhvi.md\|Infernal Wings]] |
^dc-item-description-value-weight-crafting