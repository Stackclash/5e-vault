...
|----------|------|-------|--------|
| 1 | `dice: 1d4\|avg` (`1d4`) days' worth of [[5. Mechanics/Items/Rations-1 Day.md\|rations]] (mouldy produce) | 2 sp | 2 lb |
| 2 | 1 mottled dragon scale | 7 sp | 3 lb |
| 3 | `dice: 1d4\|avg` (`1d4`) shiny trinkets | 2 sp | 1 lb |
...
| 7 | `dice: 2d6\|avg` (`2d6`) horns of a deceased relative | 5 cp | 2 lb |
