...
![[5. Mechanics/Backgrounds/img/investigator.webp#right]]  
...
- **Equipment.** A [[5. Mechanics/Items/Magnifying Glass.md\|magnifying glass]], evidence from a past case (choose one or roll for a trinket from the [[5. Mechanics/Items/Horror Trinket.md\|Horror Trinkets]] later in this chapter), a [[5. Mechanics/Items/Common Clothes.md\|set of common clothes]], and 10 gp  
...
`dice: [[Investigator.md#^first-case]]`
...
`dice: [[Investigator.md#^horror-character-personality-traits]]`
...
`dice: [[Investigator.md#^horror-character-ideals]]`
...
`dice: [[Investigator.md#^horror-character-bonds]]`
...
`dice: [[Investigator.md#^horror-character-flaws]]`
