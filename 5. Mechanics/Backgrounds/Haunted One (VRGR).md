...
- **Equipment.** [[5. Mechanics/Items/Monster Hunters Pack (VRGR).md\|Monster hunter's pack]] (containing a chest, a crowbar, a hammer, three wooden stakes, a holy symbol, a flask of holy water, a set of manacles, a steel mirror, a flask of oil, a tinderbox, and 3 torches), a set of common clothes, one [[5. Mechanics/Items/Trinket (COS).md\|trinket]] of special significance (choose one or roll on the Horror Trinkets table), and 1 sp  
