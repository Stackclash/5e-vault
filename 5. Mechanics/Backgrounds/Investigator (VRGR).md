...
- **Equipment.** A [[5. Mechanics/Items/Magnifying Glass.md|magnifying glass]], evidence from a past case (choose one or roll for a trinket from the [[5. Mechanics/Items/Horror Trinket (VRGR).md|") later in this chapter"]], a [[5. Mechanics/Items/Co(MM)on Clothes.md|set of common clothes]], and 10 gp  
