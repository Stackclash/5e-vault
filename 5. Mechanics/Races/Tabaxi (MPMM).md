...
You can use your claws to make unarmed strikes. When you hit with them, the strike deals `dice:1d6|noform|avg` (`1d6`) + your Strength modifier slashing damage, instead of the bludgeoning damage normal for an unarmed strike.
