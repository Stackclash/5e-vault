...
![[5. Mechanics/Races/img/bugbear.webp#right]]  
...
You are proficient in the [[/5. Mechanics/Rules/Skills.md#Stealth\|Stealth]] skill. In addition, without squeezing, you can move through and stop in a space large enough for a Small creature.

### Surprise Attack

If you hit a creature with an attack roll, the creature takes an extra `dice: 2d6|avg|noform` (`2d6`) damage if it hasn't taken a turn yet in the current combat.
