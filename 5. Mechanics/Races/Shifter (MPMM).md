...
- **Beasthide.** You gain `dice:1d6|noform|avg` (`1d6`) additional temporary hit points. While shifted, you have a +1 bonus to your Armor Class.  
- **Longtooth.** When you shift and as a bonus action on your other turns while shifted, you can use your elongated fangs to make an unarmed strike. If you hit with your fangs, you can deal piercing damage equal to `dice:1d6|noform|avg` (`1d6`) + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike.  
