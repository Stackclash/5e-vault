...
At 1st level, you can cause an attacker's own body to turn against itself. When a creature within 5 feet of you that you can see hits you with an attack, you can use your reaction to cause the creature to make a Constitution saving throw against your cleric spell save DC. On a failed save, the creature takes `dice:1d12|noform|avg` (`1d12`) poison damage and is [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]] until the end of its next turn. On a successful one, it takes half as much poison damage and isn't [[/5. Mechanics/Rules/Conditions.md#Poisoned\|poisoned]].
...
At 17th level, you can say a special prayer before eating a meal to enchant it and other food of your choice within 30 feet of you with unique protections. A creature that eats this enchanted food over the next 10 minutes gains `dice:2d6+10|noform|avg` (`2d6 + 10`) temporary hit points, is immune to being [[/5. Mechanics/Rules/Conditions.md#Charmed\|charmed]], and can't be put to sleep by magic. These benefits last for 8 hours and don't set in until these 10 minutes are over. You and up to six other willing creatures of your choice gain these benefits by partaking in the meal.
