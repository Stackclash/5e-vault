...
- You gain temporary hit points equal to `dice: 1d10|avg|noform` (`1d10`) + your warlock level.  
...
In addition, when you would be reduced to 0 hit points, you can use your reaction to drop to 1 hit point instead and cause your body to erupt with deathly energy. Each creature of your choice that is within 30 feet of you takes necrotic damage equal to `dice: 2d10|avg|noform` (`2d10`) + your warlock level. You then gain 1 level of [[/5. Mechanics/Rules/Conditions.md#exhaustion\|exhaustion]]. Once you use this reaction, you can't do so again until you finish `dice: 1d4|avg|noform` (`1d4`) long rests.
...
- You have a flying speed equal to your walking speed and can hover. You can move through creatures and objects as if they were difficult terrain, but you take `dice: 1d10|avg|noform` (`1d10`) force damage if you end your turn inside a creature or an object.  
