...
- When you jump, you can make a Strength ([[Skills#Athletics|Athletics]]) check and extend your jump by a number of feet equal to the check's total. You can make this special check only once per turn.  
