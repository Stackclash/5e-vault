...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#Hunting%20Domain%20(Level%201)'>Hunting Domain</a></td></tr>
> <tr class="class-progression"><td class"level">2nd</td><td class"pb">+2</td><td class"feature"><a href='#Channel%20Divinity%20Undetected%20(Level%202)'>Channel Divinity: Undetected</a></td></tr>
...
> <tr class="class-progression"><td class"level">6th</td><td class"pb">+3</td><td class"feature"><a href='#Resolute%20Hunter%20(Level%206)'>Resolute Hunter</a></td></tr>
...
> <tr class="class-progression"><td class"level">17th</td><td class"pb">+6</td><td class"feature"><a href='#Deadly%20Stalker%20(Level%2017)'>Deadly Stalker</a></td></tr>
...
At 2nd level, you can use your Channel Divinity to camouflage yourself in any environment, gaining advantage on [[/5. Mechanics/Rules/Skills.md#Stealth\|Stealth]] checks made to move quietly or to hide. You also leave no scent. The effect lasts for a number of rounds equal to your cleric level + Wisdom modifier.
...
At 8th level, you gain the ability to infuse your weapon strikes with divine energy. On your turn, you can cause one successful weapon attack against a creature to deal an extra `dice:1d8|noform|avg` (`1d8`) damage of the type dealt by the weapon. When you reach 14th level, the extra damage increases to `dice:2d8|noform|avg` (`2d8`).

### Deadly Stalker (Level 17)

At 17th level, you can use an action to describe or name a creature that is familiar to you or that you can see within 120 feet. For 24 hours or until the target is dead, whichever occurs first, you have advantage on Wisdom ([[/5. Mechanics/Rules/Skills.md#Survival\|Survival]]) checks to track your target and Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception\|Perception]]) checks to detect your target. In addition, you have advantage on weapon attack rolls against the target.
