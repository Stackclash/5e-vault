...
You are a master at saying the right thing at the right time. When you make a Charisma ([[/5. Mechanics/Rules/Skills.md#Persuasion\|Persuasion]]) or Charisma ([[/5. Mechanics/Rules/Skills.md#Deception\|Deception]]) check, you can treat a `dice: d20|avg` (`d20`) roll of 9 or lower as a 10.
