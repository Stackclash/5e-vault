...
While within the sphere, you and your allies gain a +5 bonus to Dexterity ([[Skills#Stealth|Stealth]]) and Wisdom ([[Skills#Perception|Perception]]) checks, and any light from open flames in the sphere (a campfire, torches, or the like) isn't visible outside it.
...
When you finish a short rest, you can cast one of the following spells, without expending a spell slot or requiring material components: [[Dream|dream]] (with you as the messenger), [[Scrying|scrying]], or [[Teleportation Circle|teleportation circle]].

This use of [[Teleportation Circle|teleportation circle]] is special. Rather than opening a portal to a permanent [[Teleportation Circle|teleportation circle]], it opens a portal to the last location where you finished a long rest on your current plane of existence. If you haven't taken a long rest on your current plane, the spell fails but isn't wasted.
