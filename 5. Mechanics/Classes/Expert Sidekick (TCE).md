...
> [!note]
> Note: this class is intended for NPC [[/5. Mechanics/Rules/Variant Rules/Sidekicks (TCE).md\|sidekicks]].
...
The sidekick is adept at giving well-timed assistance; the sidekick can take the [[/5. Mechanics/Rules/Actions.md#Help\|Help]] action as a bonus action.

### Cunning Action (Level 2)

*2nd-level Expert feature*

The sidekick's agility or quick thinking allows it to act speedily. On its turn in combat, it can take the [[/5. Mechanics/Rules/Actions.md#Dash\|Dash]], [[/5. Mechanics/Rules/Actions.md#Disengage\|Disengage]], or [[/5. Mechanics/Rules/Actions.md#Hide\|Hide]] action as a bonus action.
