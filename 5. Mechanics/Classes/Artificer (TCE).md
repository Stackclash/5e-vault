...
> 
> | Level | [[5. Mechanics/Optional Features/List Artificer Infusion (TCE).md\|Infusions Known]] | Infused Items | Cantrips Known | 1st | 2nd | 3rd | 4th | 5th |
> |-------|--------------------------------------------------------------------------------|---------------|----------------|-----|-----|-----|-----|-----|
> | 1st | ⏤ | ⏤ | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 2nd | 4 | 2 | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 3rd | 4 | 2 | 2 | 3 | ⏤ | ⏤ | ⏤ | ⏤ |
...
When you gain this feature, pick four artificer infusions to learn, choosing from the "[[5. Mechanics/Optional Features/List Artificer Infusion (TCE).md\|Artificer Infusions]]" section at the end of the class's description. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.
...
> ![[5. Mechanics/Optional Features/List Artificer Infusion (TCE).md#Artificer%20Infusion\|Artificer Infusion]]
