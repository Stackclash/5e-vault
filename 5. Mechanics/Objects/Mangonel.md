...
```ad-statblock
title: Mangonel
![[5. Mechanics\Bestiary\Null\token\mangonel.png#token]]
*Large Siege weapon*
...
***Mangonel Stone.*** *Ranged Weapon Attack:* ++5 to hit, range 200/800 ft. (can't hit targets within 60 feet of it), one target. *Hit:* 27 (`dice: 5d10` (`5d10`)) bludgeoning damage.
```
^statblock