...
```ad-statblock
title: Trebuchet
![[5. Mechanics\Bestiary\Null\token\trebuchet.png#token]]
*Huge Siege weapon*
...
***Trebuchet Stone.*** *Ranged Weapon Attack:* ++5 to hit, range 300/1,200 ft. (can't hit targets within 60 feet of it), one target. *Hit:* 44 (`dice: 8d10` (`8d10`)) bludgeoning damage.
```
^statblock