...
```ad-statblock
title: Cannon
![[5. Mechanics\Bestiary\Null\token\cannon.png#token]]
*Large Siege weapon*
...
***Cannon Ball.*** *Ranged Weapon Attack:* ++6 to hit, range 600/2,400 ft., one target. *Hit:* 44 (`dice: 8d10` (`8d10`)) bludgeoning damage.
```
^statblock