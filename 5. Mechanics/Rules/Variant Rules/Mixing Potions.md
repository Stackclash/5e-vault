...
| dice: d100 | Result |
|------------|--------|
| 01 | The mixture creates a magical explosion, dealing `dice: 6d10` (`6d10`) force damage to the mixer and `dice: 1d10` (`1d10`) force damage to each creature within 5 feet of the mixer. |
...
| 00 | Only one potion works, but its effect is permanent. Choose the simplest effect to make permanent, or the one that seems the most fun. For example, a [[/5. Mechanics/Items/Potion Of Healing.md|potion of healing]] might increase the drinker's hit point maximum by 4, or [[/5. Mechanics/Items/Oil Of Etherealness.md|oil of etherealness]] might permanently trap the user in the Ethereal Plane. At your discretion, an appropriate spell, such as [[/5. Mechanics/Spells/Dispel Magic.md|dispel magic]] or [[/5. Mechanics/Spells/Remove Curse.md|remove curse]], might end this lasting effect. |
^potion-miscibility