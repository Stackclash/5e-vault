...
Under this variant, the players roll a `dice: d20` (`d20`) for their initiative as a group, or side. You also roll a `dice: d20` (`d20`). Neither roll receives any modifiers. Whoever rolls highest wins initiative. In case of a tie, keep rerolling until the tie is broken.
