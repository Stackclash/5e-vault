...
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Buying A Magic Item (XGE).md\|Buying a Magic Item]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Carousing (XGE).md\|Carousing]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Crafting An Item (XGE).md\|Crafting an Item]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Crime (XGE).md\|Crime]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Gambling (XGE).md\|Gambling]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Pit Fighting (XGE).md\|Pit Fighting]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Relaxation (XGE).md\|Relaxation]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Religious Service (XGE).md\|Religious Service]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Research (XGE).md\|Research]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Scribing A Spell Scroll (XGE).md\|Scribing a Spell Scroll]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Selling A Magic Item (XGE).md\|Selling a Magic Item]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Training (XGE).md\|Training]]  
- [[/5. Mechanics/Rules/Variant Rules/Downtime Activity Work (XGE).md\|Work]]
