...
| 5 | The caster suffers a minor but bizarre effect related to the spell. Such effects last only as long as the original spell's duration, or `dice: 1d10\|avg` (`1d10`) minutes for spells that take effect instantaneously. For example, a [[5. Mechanics/Spells/Fireball.md\|fireball]] might cause smoke to billow from the caster's ears for `dice: 1d10\|avg` (`1d10`) minutes.  |
