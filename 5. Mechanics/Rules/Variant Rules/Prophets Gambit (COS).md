...
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Artifact\|Artifact]].** Swap your Fate card with the Focus card.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Beast\|Beast]].** Each player discards a card, then draws a card from the Common Deck.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Broken%20One\|Broken One]].** Discard all the remaining cards in your hand. Then draw a new card from the Common Deck for each one discarded.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Darklord\|Darklord]].** Choose another player. Look at their hand of cards and choose one for them to discard. Then they draw a card from the Common Deck.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Donjon\|Donjon]].** Each player must discard cards until they have three left in their hand. The game immediately advances to the Reveal.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Executioner\|Executioner]].** Keep this card on the table in front of you. Regardless of who wins the execution you decide whether to kill or save the Focus card.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Mists\|Mists]].** Rotate the Fate cards one player clockwise.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Ghost\|Ghost]].** Take a card from the discard pile, then discard a card.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Horseman\|Horseman]].** Draw two cards from the Common Deck and then discard two cards.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Innocent\|Innocent]].** Keep this card on the table in front of you. You and your cards can't be affected by any future High Deck cards.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Marionette\|Marionette]].** Choose another player who hasn't had a turn this round. That player must either play their highest or lowest numbered card, as directed by you.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Raven\|Raven]].** Each player chooses a card from their hand and passes it to the player on their left.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Seer\|Seer]].** Look at all player's Fate cards once.  
**[[/5. Mechanics/Decks/Tarokka Deck (COS).md#Tempter\|Tempter]].** Choose a card from your hand and a random card from another player's hand to swap.
