...
Symptoms manifest `dice: 1d4` (`1d4`) hours after infection and include fever and disorientation. The infected creature gains one level of [[\5. Mechanics\Rules\Conditions.md#exhaustion|exhaustion]] that can't be removed until the disease is cured.
