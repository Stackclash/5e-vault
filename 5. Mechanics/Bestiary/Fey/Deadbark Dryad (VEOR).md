...
- "desc": "The dryad casts one of the following spells, requiring no material components\
    ...
    \n2/day each: [[5. Mechanics/Spells/Pass Without Trace.md|Pass without Trace]],\
...
- "desc": "Melee or Ranged Weapon Attack: +8 to hit, reach 5 ft. or range 120 ft.,\
    ...
    \ throw or have the [[/5. Mechanics/Rules/Conditions.md#Poisoned|poisoned]] condition\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 30 ft., one target. Hit: The\
    ...
    \ [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]] in this way takes 13\
    ...
    \ damage). Destroying a vine deals no damage to the dryad, but any creature [[/5. Mechanics/Rules/Conditions.md#Grappled|grappled]]\
    \ by that vine no longer has the [[/5. Mechanics/Rules/Conditions.md#Grappled|grappled]]\
