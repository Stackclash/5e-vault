...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hag magically turns [[5. Mechanics/Rules/Conditions.md#invisible|invisible]]\
    \ until she attacks or casts a spell, or until her [[5. Mechanics/Rules/Status.md#concentration|concentration]]\
    \ ends (as if [[5. Mechanics/Rules/Status.md#concentration|concentration]] on a spell).\
    \ While [[5. Mechanics/Rules/Conditions.md#invisible|invisible]], she leaves no physical\
    \ evidence of her passage, so she can be tracked only by magic. Any equipment\
    \ she wears or carries is [[5. Mechanics/Rules/Conditions.md#invisible|invisible]]\
    \ with her."
...
- "WBtW"
- "JttRC"
"image": "5. Mechanics/Bestiary/Fey/token/green-hag.png"
```
^statblock
