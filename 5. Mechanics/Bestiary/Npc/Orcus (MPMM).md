...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "While holding the [[/5. Mechanics/Items/Wand Of Orcus.md|Wand of Orcus]],\
...
- "MPMM"
- "MTF"
"image": "5. Mechanics/Bestiary/Npc/token/orcus.png"
```
^statblock