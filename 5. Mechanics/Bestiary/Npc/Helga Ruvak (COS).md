...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Helga, [[5. Mechanics/Rules/Conditions.md#incapacitated|incapacitated]], or\
    \ [[5. Mechanics/Rules/Conditions.md#restrained|restrained]]. Hit: dice: 1d6 + 3|avg\
...
"source":
- "CoS"
"image": "5. Mechanics/Bestiary/Npc/token/helga-ruvak.png"
```
^statblock
