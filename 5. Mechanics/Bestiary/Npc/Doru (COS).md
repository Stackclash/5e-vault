...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ by Doru, [[5. Mechanics/Rules/Conditions.md#incapacitated|incapacitated]], or [[5. Mechanics/Rules/Conditions.md#restrained|restrained]].\
...
"source":
- "CoS"
"image": "5. Mechanics/Bestiary/Npc/token/doru.png"
```
^statblock
