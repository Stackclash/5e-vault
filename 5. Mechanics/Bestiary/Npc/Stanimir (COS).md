...
- "desc": "Stanimir is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ 1st-level slots): [[5. Mechanics/Spells/Charm Person.md|charm person]], [mage\
    \ armor](compendium/spells/mage-armor.md), [[5. Mechanics/Spells/Shield.md|shield]],\
    \ [[5. Mechanics/Spells/Sleep.md|sleep]]\n\n2nd level (3 2nd-level slots): [misty\
    \ step](compendium/spells/misty-step.md), [[5. Mechanics/Spells/Suggestion.md|suggestion]]\n\
    \n3rd level (3 3rd-level slots): [[5. Mechanics/Spells/Bestow Curse.md|bestow curse]],\
...
"source":
- "CoS"
"image": "5. Mechanics/Bestiary/Npc/token/stanimir.png"
```
^statblock
