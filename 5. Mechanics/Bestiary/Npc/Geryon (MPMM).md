...
- "desc": "Geryon casts one of the following spells, requiring no material components\
    ...
    \ [[5. Mechanics/Spells/Invisibility.md|") (self only"]], [[5. Mechanics/Spells/Locate Object.md|locate object]],\
...
- "desc": "Melee Weapon Attack: dice: d20+16 (+16 to hit), reach 15 ft., one target.\
    ...
    \ or smaller, it is [[/5. Mechanics/Rules/Conditions.md#grappled|") (DC 24"]],\
