...
- Strahd observes the characters to see who among them are most easily swayed, then tries to charm characters who have low Wisdom scores and use them as thralls. At the very least, he can order a [[Conditions#charmed|charmed]] character to guard him against other members of the adventuring party.  
...
| 13–15 | `dice: 1d4 + 1` (`1d4 + 1`) [[/5. Mechanics/Bestiary/Undead/Vampire Spawn.md|vampire spawn]] |
...
The ability of the Heart of Sorrow to absorb damage is suppressed if it or Strahd is fully within an [[Antimagic Field|antimagic field]].
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    ...
    \ [[5. Mechanics/Rules/Conditions.md#restrained|restrained]]. Hit: dice: 1d6 + 4|avg\
    ...
    \ rises the following night as a [[/5. Mechanics/Bestiary/Undead/Vampire Spawn.md|vampire spawn]]\
...
"source":
- "CoS"
"image": "5. Mechanics/Bestiary/Npc/token/strahd-von-zarovich.png"
```
^statblock