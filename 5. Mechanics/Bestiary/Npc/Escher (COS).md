...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ necrotic damage taken, and Escher regains hit points equal to that amount. The\
...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one creature.\
    ...
    \ damage, Escher can grapple the target (escape DC 13)."
  "name": "Claws"
"source":
- "CoS"
"image": "5. Mechanics/Bestiary/Npc/token/escher.png"
```
^statblock
