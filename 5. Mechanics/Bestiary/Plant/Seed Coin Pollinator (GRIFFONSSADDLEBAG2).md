...
"traits":
  ...
  - "desc": "The pollinator doesn't require sleep. If the pollinator spends 1 hour\
      \ in direct sunlight, it receives enough nourishment to sustain itself for one\
...
"actions":
  ...
  - "desc": "The pollinator hurls a flurry of [[5. Mechanics/Bestiary/Plant/Seed Coin (GRIFFONSSADDLEBAG2).md|seed coins]]\
      ...
      \ by 5 or more, one of the seed coins gets lodged on the target's body (for\
      \ example, in a pocket or a fold in its clothing)."
