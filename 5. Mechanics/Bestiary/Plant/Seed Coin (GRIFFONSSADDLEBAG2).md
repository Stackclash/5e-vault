...
- "desc": "Melee Weapon Attack: +0 to hit, reach 0 ft., one humanoid that has the\
    ...
    \ immune to the [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]] condition are\
    ...
    \ that time, the creature becomes [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]]\
    ...
    \ in this way. This infestation lasts until the [[5. Mechanics/Bestiary/Plant/Seed Coin Pollinator (GRIFFONSSADDLEBAG2).md|seed coin pollinator]]\
