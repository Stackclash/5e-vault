...
- "desc": "The stall's innate spellcasting ability is Charisma (spell save DC 15).\
    ...
    \n3/day each: [[5. Mechanics/Spells/Comprehend Languages.md|comprehend languages]],\
    \ [[5. Mechanics/Spells/Suggestion.md|suggestion]], [[5. Mechanics/Spells/Unseen Servant.md|unseen servant]]"
...
- "desc": "Whenever a humanoid ends its turn within 60 feet of the stall, it must\
    ...
    \ the next 24 hours. If the creature fails three of these saves, it becomes [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]]\
...
- "desc": "The stall is indistinguishable from a normal merchant stall. However, a\
    \ creature that has [[/5. Mechanics/Rules/Senses.md#Truesight|truesight]] sees a\
    \ deep red aura radiating from the stall, and a creature within 30 feet of it\
    \ that is under the effect of a [[5. Mechanics/Spells/Detect Poison And Disease.md|detect poison and disease]]\
...
- "desc": "The stall causes dark, creeping vines to protrude from itself and its staff,\
    ...
    \ throw or be [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]] by the\
    \ vines for 1 minute. While [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
    ...
    \ again. It can also choose to end the effect early on any number of [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
...
- "desc": "The stall attempts to magically compel one creature [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]]\
    ...
    \ a [[5. Mechanics/Bestiary/Plant/Seed Coin (GRIFFONSSADDLEBAG2).md|seed coin]]. The\
    ...
    \ the coin and is no longer [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]]\
