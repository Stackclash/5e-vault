...
"traits":
  ...
  - "desc": "When it drops to 0 hit points outside its resting place, the vampire\
      ...
      \ falling [[/5. Mechanics/Rules/Conditions.md#Unconscious|unconscious]], provided\
      ...
      \ its resting place, it reverts to its vampire form. It is then [[/5. Mechanics/Rules/Conditions.md#Paralyzed|paralyzed]]\
...
"actions":
  ...
  - "desc": "The vampire targets one humanoid it can see within 30 feet of it. If\
      ...
      \ saving throw against this magic or be [[/5. Mechanics/Rules/Conditions.md#Charmed|charmed]]\
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the vampire spellcaster can expend a use to take one of the following actions.\
  \ The vampire spellcaster regains all expended uses at the start of each of its\
  \ turns."
"legendary_actions":
