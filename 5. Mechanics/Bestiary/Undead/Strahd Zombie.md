...
- "desc": "Whenever the zombie takes at least 5 bludgeoning or slashing damage at\
    \ one time, roll a dice: d20|avg|noform (d20) to determine what else happens\
    ...
    \ The zombie is decapitated.\n\nIf the zombie is reduced to 0 hit points, all\
    \ parts of it die. Until then, a severed part acts on the zombie's initiative\
    \ and has its own action and movement. A severed part has AC 8. Any damage it\
    \ takes is subtracted from the zombie's hit points.\n\nA severed leg is unable\
    \ to attack and has a speed of 5 feet.\n\nA severed arm has a speed of 5 feet\
    \ and can make one claw attack on its turn, with disadvantage on the attack roll.\
    \ Each time the zombie loses an arm, it loses a claw attack.\n\nIf its head is\
    \ severed, the zombie loses its bite attack and its body is [[/5. Mechanics/Rules/Conditions.md#blinded|blinded]]\
