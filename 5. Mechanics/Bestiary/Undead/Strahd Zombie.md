...
- "desc": "Whenever the zombie takes at least 5 bludgeoning or slashing damage at\
    ...
    \ and its body is [[/5. Mechanics/Rules/Conditions.md#blinded|blinded]] unless the\
    ...
    \ if it's missing a leg. If it loses both legs, it falls [[/5. Mechanics/Rules/Conditions.md#prone|prone]].\
