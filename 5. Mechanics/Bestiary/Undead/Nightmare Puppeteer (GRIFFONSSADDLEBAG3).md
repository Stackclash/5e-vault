...
- "desc": "The puppeteer's spellcasting ability is Intelligence (spell save DC 19,\
    ...
    \ [[5. Mechanics/Spells/Prismatic Spray.md|prismatic spray]]\n\n3/day each: [[5. Mechanics/Spells/Color Spray.md|color\
    \ spray]] (as a 5th-level spell), [[5. Mechanics/Spells/Scorching Ray.md|scorching\
    \ ray]] (as a 4th-level spell)"
...
- "desc": "As a bonus action, the puppeteer can magically turn [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]]\
    \ until it makes an attack, forces a creature to make a saving throw, or its [[/5. Mechanics/Rules/Conditions.md#Concentration|concentration]]\
    ...
    \ the puppeteer wears or carries are [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]]\
    \ with it."
  "name": "Invisibility"
...
- "desc": "The puppeteer attempts to flick or throw one creature within 5 feet of\
    ...
    \ target is flung up to 60 feet away from the puppeteer and knocked [[/5. Mechanics/Rules/Conditions.md#Prone|prone]],\
...
- "desc": "The puppeteer launches a string from each of its fingertips at one creature\
    ...
    \ [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]] in this way, the target\
...
- "desc": "The puppeteer attempts to take total control of a creature that has at\
    ...
    \ ([[/5. Mechanics/Rules/Skills.md#Persuasion|Persuasion]]) check, it uses the puppeteer's\
...
- "desc": "The puppeteer snaps its fingers creating a sonic boom that is audible out\
    ...
    \ damage and is [[/5. Mechanics/Rules/Conditions.md#Stunned|stunned]] until the end\
    \ of the puppeteer's next turn. On a successful save, a creature takes half as\
    \ much damage and isn't [[/5. Mechanics/Rules/Conditions.md#Stunned|stunned]]. The\
