...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 6\
      ...
      \ by this attack rises 24 hours later as a [[5. Mechanics/Bestiary/Undead/Zombie.md|zombie]]\
...
"source":
  - "MPMM"
  - "MTF"
"image": "5. Mechanics/Bestiary/Undead/token/deathlock-wight-mpmm.webp"
```
^statblock
