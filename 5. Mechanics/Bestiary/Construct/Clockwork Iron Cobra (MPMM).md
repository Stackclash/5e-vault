...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ an unarmed strike. If no creature is visible within 30 feet, it takes the [[/5. Mechanics/Rules/Actions.md#Dash|Dash]]\
    \ action, moving toward the nearest creature.  \n- 3–4 Paralysis. The target\
    \ is [[/5. Mechanics/Rules/Conditions.md#paralyzed|paralyzed]] until the end of its\
