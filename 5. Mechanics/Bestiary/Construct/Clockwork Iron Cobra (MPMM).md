...
`dice: [[/5. Mechanics/Bestiary/Construct/Clockwork Iron Cobra (MPMM).md#^clockwork-enhancements]]`
...
`dice: [[/5. Mechanics/Bestiary/Construct/Clockwork Iron Cobra (MPMM).md#^clockwork-malfunctions]]`
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6 (1d6\
      ...
      \ creature is visible within 30 feet, it takes the [[/5. Mechanics/Rules/Actions.md#Dash|Dash]]\
      \ action, moving toward the nearest creature.  \n- **3–4 Paralysis.** The target\
      \ is [[/5. Mechanics/Rules/Conditions.md#Paralyzed|paralyzed]] until the end of\
