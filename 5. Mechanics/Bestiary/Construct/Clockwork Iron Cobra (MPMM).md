...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    \ Hit: 6 (dice: 1d6 + 3|avg (1d6 + 3)) piercing damage. If the target is\
    \ a creature, it must succeed on a DC 13 Constitution saving throw or suffer one\
    \ random effect (roll a dice: d6|avg (d6)):\n\n- 1–2 Confusion. On its\
    \ next turn, the target must use its action to make one weapon attack against\
    ...
    \ until the end of its next turn.  \n- 5–6 Poison. The target takes 13 (dice:\
