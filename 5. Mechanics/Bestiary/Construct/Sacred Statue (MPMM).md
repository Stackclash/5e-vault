...
- "desc": "If the statue is motionless at the start of combat, it has advantage on\
    ...
    \ or act, that creature must succeed on a DC 18 Intelligence ([[/5. Mechanics/Rules/Skills.md#Investigation|")"]]\
    \ check to discern that the statue isn't an object."
  "name": "False Appearance"
- "desc": "The [[5. Mechanics/Bestiary/Undead/Eidolon (MPMM).md|eidolon]] that enters the\
