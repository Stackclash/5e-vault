...
- "desc": "The hellfire engine moves up to its speed in a straight line. During this\
    ...
    \ the [[/5. Mechanics/Rules/Conditions.md#Prone|prone]] creature's space, the creature\
    \ is also [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]] until it's\
    \ no longer in the same space as the hellfire engine. While [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
...
- "desc": "The hellfire engine uses one of the following options (choose one or roll\
    ...
    \ in 1d4 hours. If the creature isn't revived before then, only a [[5. Mechanics/Spells/Wish.md|wish]]\
    \ spell or killing the [[5. Mechanics/Bestiary/Fiend/Lemure.md|lemure]] and casting\
