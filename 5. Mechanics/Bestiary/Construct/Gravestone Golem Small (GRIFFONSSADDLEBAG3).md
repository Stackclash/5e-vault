...
"actions":
  ...
  - "desc": "The golem magically animates one Medium or Small humanoid corpse within\
      \ 30 feet of it. The animated creature has the same statistics as a zombie,\
      \ but it has the golem's Necrotic Absorption trait. The zombie acts as an ally\
      \ of the golem. The zombie remains animated for 1 minute or until it dies; until\
