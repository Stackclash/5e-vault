...
- "desc": "Melee Weapon Attack: dice: d20+17 (+17 to hit), reach 10 ft., one target.\
    \ Hit: 36 (dice: 4d12 + 10|avg (4d12 + 10)) force damage. Or Ranged Weapon\
    \ Attack: dice: d20+17 (+17 to hit), range 120 ft., one target. Hit: 36 (dice:\
    \ 4d12 + 10|avg (4d12 + 10)) force damage. If the target is an object, it takes\
    \ triple damage."
...
- "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ save, a creature takes 26 (dice: 4d12|avg (4d12)) bludgeoning damage and\
