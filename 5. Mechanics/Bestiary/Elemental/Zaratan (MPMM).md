...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "After moving at least 10 feet on the ground, the zaratan sends a shock\
    ...
    \ is [[5. Mechanics/Rules/Status.md#concentration|concentration]] must succeed on\
    \ a DC 25 Constitution saving throw or the creature's [[5. Mechanics/Rules/Status.md#concentration|concentration]]\
    ...
    \ takes dice: 5d6|avg (5d6) bludgeoning damage, is knocked [[5. Mechanics/Rules/Conditions.md#prone|prone]],\
