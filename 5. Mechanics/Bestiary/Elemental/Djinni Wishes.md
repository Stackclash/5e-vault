...
"traits":
  - "desc": "The djinni's innate spellcasting ability is Charisma (spell save DC 17,\
      ...
      \n1/year each: [[5. Mechanics/Spells/Wish.md|wish]] (see Wishes)"
  ...
  - "desc": "The genie power to grant wishes is legendary among mortals. Only the\
      ...
      \ cast the [[5. Mechanics/Spells/Wish.md|wish]] spell on the creature's behalf\
...
"actions":
  ...
  - "desc": "A 5-foot-radius, 30-foot-tall cylinder of swirling air magically forms\
      ...
      \ on a DC 18 Strength saving throw or be [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
      \ by it. The djinni can move the whirlwind up to 60 feet as an action, and creatures\
      \ [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]] by the whirlwind\
      \ move with it. The whirlwind ends if the djinni loses sight of it.\n\nA creature\
      \ can use its action to free a creature [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
