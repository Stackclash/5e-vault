...
- The effects of time are altered such that every creature in the lair must succeed on a DC 15 Constitution saving throw or become `dice:1d20|noform|noparens|avg` (`d20`) years older or younger (the sphinx's choice), but never any younger than 1 year old. A [[5. Mechanics/Spells/Greater Restoration.md|greater restoration]] spell can restore a creature's age to normal.  
