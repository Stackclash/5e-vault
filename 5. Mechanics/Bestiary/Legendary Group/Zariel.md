...
- Once every 60 feet within 1 mile of the lair, 10-foot-high gouts of flame rise from the ground. Any creature or object that touches the flame takes `dice:2d6|text(7)` (`2d6`) fire damage, though it can take this damage no more than once per round.  
...
If Zariel dies, these effects fade over the course of `dice: 1d10|avg|noform` (`1d10`) days.
