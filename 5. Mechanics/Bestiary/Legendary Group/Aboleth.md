...
- Water in the aboleth's lair magically becomes a conduit for the creature's rage. The aboleth can target any number of creatures it can see in such water within 90 feet of it. A target must succeed on a DC 14 Wisdom saving throw or take `dice:2d6|text(7)` (`2d6`) psychic damage. The aboleth can't use this lair action again until it has used a different one.  
...
If the aboleth dies, the first two effects fade over the course of `dice: 3d10|avg|noform` (`3d10`) days.
