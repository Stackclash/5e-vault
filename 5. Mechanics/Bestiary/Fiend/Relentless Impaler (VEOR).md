...
"traits":
  - "desc": "The impaler is magically bound to the ceremonial stake and the sacrificed\
      ...
      \ hit points, it disappears, then re-forms 1d8 hours later in the nearest unoccupied\
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the relentless impaler can expend a use to take one of the following actions.\
  \ The relentless impaler regains all expended uses at the start of each of its turns."
"legendary_actions":
