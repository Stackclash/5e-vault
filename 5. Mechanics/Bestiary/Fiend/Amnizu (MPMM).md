...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The amnizu targets one creature it can see within 60 feet of it. That creature\
    ...
    \ for 1 minute. A [[5. Mechanics/Rules/Conditions.md#stunned|stunned]] creature repeats\
    \ the saving throw at the end of each of its turns, ending the effect on itself\
    \ on a success. If the target is [[5. Mechanics/Rules/Conditions.md#stunned|stunned]]\
