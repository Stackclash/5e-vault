...
Each narzugon claims a [[Nightmare|nightmare]] as its mount. These steeds are bound by [[Infernal Tack (MTF)|infernal tack]] and must respond to the summons and commands of the spurs' wearer.
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 10 ft., one target.\
    ...
    \ then, only a [[/5. Mechanics/Spells/Wish.md|wish]] spell or killing the lemure\
