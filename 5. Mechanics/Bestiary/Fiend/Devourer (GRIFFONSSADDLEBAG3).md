...
- "desc": "While in dim light or darkness, the devourer can take the Hide action as\
    \ a bonus action. While in darkness, the devourer is [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]]\
...
- "desc": "The devourer magically turns [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]]\
    ...
    \ a spell). Any equipment the devourer wears or carries is [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]]\
    \ with it."
  "name": "Invisibility"
"source":
- "GriffonsSaddlebag3"
