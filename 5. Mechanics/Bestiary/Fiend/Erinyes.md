...
> 
> Some erinyes carry a [[5. Mechanics/Items/Rope Of Entanglement.md|") (detailed in the Dungeon Master's Guide"]]. When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
