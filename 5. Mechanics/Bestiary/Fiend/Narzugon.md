...
Each narzugon claims a [[5. Mechanics/Bestiary/Fiend/Nightmare.md|nightmare]] as its mount. These steeds are bound by [[5. Mechanics/Items/Infernal Tack.md|infernal tack]] and must respond to the summons and commands of the spurs' wearer.
...
"cr": "13"
"traits":
- "desc": "The narzugon wears spurs that are part of [[5. Mechanics/Items/Infernal Tack.md|infernal tack]],\
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 11\
    ...
    \ in Avernus in 1d4 hours. If the creature isn't revived before then, only a [[5. Mechanics/Spells/Wish.md|wish]]\
