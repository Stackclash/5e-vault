...
- "desc": "- The dragon creates fog as if it had cast the [[5. Mechanics/Spells/Fog Cloud.md|fog cloud]]\
    ...
    \ of the dragon must succeed on a DC 15 Constitution saving throw or take dice:\
    \ 1d10|avg (1d10) cold damage. Gases and vapors are dispersed by the wind,\
    \ and unprotected flames are extinguished. Protected flames, such as lanterns,\
...
- "desc": "- Once per day, the dragon can alter the weather in a 6-mile radius centered\
    ...
    \ identical to the [[5. Mechanics/Spells/Control Weather.md|control weather]] spell.\
...
- "SKT"
- "GoS"
"image": "5. Mechanics/Bestiary/Dragon/token/adult-silver-dragon.webp"
```
^statblock
