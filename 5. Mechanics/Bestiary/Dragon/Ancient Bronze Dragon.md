...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
      ...
      \ as though it had cast the [[/5. Mechanics/Spells/Fog Cloud.md|fog cloud]] spell.\
      ...
      \ discretion, a legendary ([[/5. Mechanics/Bestiary/Dragon/Adult Bronze Dragon.md|adult]]\
      \ or [[/5. Mechanics/Bestiary/Dragon/Ancient Bronze Dragon.md|ancient]]) bronze\
...
"regional_effects":
  - "desc": "The region containing a legendary bronze dragon's lair is warped by the\
      ...
      \ the effect is identical to the [[/5. Mechanics/Spells/Control Weather.md|control weather]]\
...
"source":
  - "MM"
"image": "/5. Mechanics/Bestiary/Dragon/token/ancient-bronze-dragon.webp"
```
^statblock
