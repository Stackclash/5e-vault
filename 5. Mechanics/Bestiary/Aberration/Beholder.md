...
"actions":
  ...
  - "desc": "The beholder shoots three of the following magical eye rays at random\
      ...
      \ The targeted creature must succeed on a DC 16 Wisdom saving throw or be [[/5. Mechanics/Rules/Conditions.md#Frightened|frightened]]\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **4. Slowing Ray.**\
      ...
      \ or until the beholder is [[/5. Mechanics/Rules/Conditions.md#Incapacitated|incapacitated]].\
...
"lair_actions":
  - "desc": "When fighting inside its lair, a beholder can invoke the ambient magic\
      ...
      \n- A 50-foot-square area of ground within 120 feet of the beholder becomes\
      ...
      \ a DC 15 Dexterity saving throw or be [[/5. Mechanics/Rules/Conditions.md#Grappled|grappled]].\
      ...
      \ can't repeat an effect until they have all been used, and it can't use the\
...
"regional_effects":
  - "desc": "A region containing a beholder's lair is warped by the creature's unnatural\
      ...
      \ within 1 mile of the beholder's lair sometimes feel as if they're being watched\
      \ when they aren't.  \n- When the beholder sleeps, minor warps in reality occur\
      \ within 1 mile of its lair and then vanish 24 hours later. Marks on cave walls\
      \ might change subtly, an eerie trinket might appear where none existed before,\
      \ harmless slime might coat a statue, and so on. These effects apply only to\
