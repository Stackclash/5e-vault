...
> 
> Someone who is proficient in Wisdom ([[/5. Mechanics/Rules/Skills.md#Medicine|")"]] can remove the gem from an [[/5. Mechanics/Rules/Conditions.md#incapacitated|incapacitated]] slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([[/5. Mechanics/Rules/Skills.md#Medicine|")"]] check. Each failed attempt deals 22 (`dice: 4d10|avg` (`4d10`)) psychic damage to the slaad.
...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ [[5. Mechanics/Spells/Invisibility.md|") (self only"]], [[5. Mechanics/Spells/Mage Hand.md|mage hand]],\
...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: 9 (dice: 1d8 + 5|avg (1d8 + 5)) piercing damage plus 7 (dice: 2d6|avg\
    \ (2d6)) necrotic damage."
  "name": "Bite (Slaad Form Only)"
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: 10 (dice: 1d10 + 5|avg (1d10 + 5)) slashing damage plus 7 (dice:\
    \ 2d6|avg (2d6)) necrotic damage."
  "name": "Claws (Slaad Form Only)"
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: 12 (dice: 2d6 + 5|avg (2d6 + 5)) slashing damage plus 7 (dice: 2d6|avg\
    \ (2d6)) necrotic damage."
  "name": "Greatsword"
"source":
- "MM"
