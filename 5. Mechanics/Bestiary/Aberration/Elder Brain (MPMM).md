...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 30 ft., one target.\
    ...
    \ Huge or smaller creature, it is [[5. Mechanics/Rules/Conditions.md#grappled|grappled]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The elder brain targets one creature within 120 feet of it with which it\
    \ has a psychic link. The elder brain breaks the creature's [[5. Mechanics/Rules/Status.md#concentration|concentration]]\
