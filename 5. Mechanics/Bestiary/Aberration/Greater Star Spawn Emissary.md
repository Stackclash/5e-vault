...
- "desc": "Melee Weapon Attack: dice: d20+14 (+14) to hit, reach 15 ft., one\
    \ target. Hit: dice:2d10 + 7|text(20) (2d10 + 7) piercing damage plus dice:3d8|text(13)\
    \ (3d8) acid damage."
  "name": "Lashing Maw"
- "desc": "Ranged Spell Attack: dice: d20+15 (+15) to hit, range 120 ft., one\
    \ creature. Hit: dice:3d12 + 8|text(27) (3d12 + 8) psychic damage."
  "name": "Psychic Orb"
- "desc": "The emissary expels bile that splashes all creatures in a 30-foot-radius\
    ...
    \ that area must make a DC 23 Dexterity saving throw, taking dice:10d10|text(55)\
...
- "desc": "The emissary causes the ground in a 20-foot square that it can see within\
    ...
    \ The area becomes difficult terrain for the duration. Any creature takes dice:3d6|text(10)\
...
- "desc": "The emissary unleashes a psychic wave. Each creature within 30 feet of\
    \ the emissary must succeed on a DC 23 Wisdom saving throw or take dice:5d12|text(32)\
