...
"actions":
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 3\
      \ (d6) piercing damage, and the target must succeed on a DC 11 Constitution\
      \ saving throw or take 3 (d6) poison damage."
    "name": "Bite"
"source":
  - "GriffonsSaddlebag2"
```
