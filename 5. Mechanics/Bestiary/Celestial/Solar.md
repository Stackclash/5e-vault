...
- "desc": "Melee Weapon Attack: dice: d20+15 (+15 to hit), reach 5 ft., one target.\
    \ Hit: 22 (dice: 4d6 + 8|avg (4d6 + 8)) slashing damage plus 27 (dice:\
    \ 6d8|avg (6d8)) radiant damage."
  "name": "Greatsword"
- "desc": "Ranged Weapon Attack: dice: d20+13 (+13 to hit), range 150/600 ft.,\
    \ one target. Hit: 15 (dice: 2d8 + 6|avg (2d8 + 6)) piercing damage plus\
    \ 27 (dice: 6d8|avg (6d8)) radiant damage. If the target is a creature that\
...
- "desc": "The solar emits magical, divine energy. Each creature of its choice in\
    ...
    \ 4d6|avg (4d6)) fire damage plus 14 (dice: 4d6|avg (4d6)) radiant damage\
