...
`dice: [[War Priest.md#^war-priest-holy-symbols]]`
...
| 4 | Clay figurine of a [[5. Mechanics/Bestiary/Celestial/Ki Rin.md|ki-rin]] or another Celestial |
...
- "desc": "The war priest targets one creature it can see within 60 feet of it. The\
    ...
    \ dice:2d8 + 3|text(12) (2d8 + 3) radiant damage, and it is [[/5. Mechanics/Rules/Conditions.md#blinded|blinded]]\
