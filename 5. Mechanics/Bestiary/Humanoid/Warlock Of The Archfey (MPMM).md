...
Warlocks of the Archfey gain their powers through magical pacts forged with lords of the Feywild. These warlocks commonly associate with lesser Fey creatures such as [[Boggle (MPMM)|boggles]], [[Quickling (MPMM)|quicklings]], and [[Redcap (MPMM)|redcaps]] (all appear in "this book") or even [[Satyr|satyrs]] and [[Sprite|sprites]].
...
- "MPMM"
- "VGM"
"image": "5. Mechanics/Bestiary/Humanoid/token/warlock-of-the-archfey.png"
```
^statblock
