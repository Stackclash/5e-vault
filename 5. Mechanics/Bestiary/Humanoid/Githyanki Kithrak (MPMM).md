...
Militarized githyanki cultures assign ranks and responsibilities to citizens. Groups of ten warriors follow the commands of sarths ([[5. Mechanics/Bestiary/Humanoid/Githyanki Warrior.md|")"]], while ten sarths obey the commands of a mighty kith'rak. These champions undergo torturous training and psionic testing until they can command the respect of their underlings.
...
- "desc": "The githyanki casts one of the following spells, requiring no spell components\
    ...
    \ will: [[5. Mechanics/Spells/Mage Hand.md|") (the hand is invisible"]]\n\
...
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one target.\
    \ Hit: 11 (dice: 2d6 + 4|avg (2d6 + 4)) slashing damage plus 17 (dice:\
    \ 5d6|avg (5d6)) psychic damage."
  "name": "Greatsword"
"bonus_actions":
