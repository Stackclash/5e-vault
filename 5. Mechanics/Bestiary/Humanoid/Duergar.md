...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The duergar magically turns [[5. Mechanics/Rules/Conditions.md#invisible|invisible]]\
    \ until it attacks, casts a spell, or uses its Enlarge, or until its [[5. Mechanics/Rules/Status.md#concentration|concentration]]\
    \ is broken, up to 1 hour (as if [[5. Mechanics/Rules/Status.md#concentration|concentration]]\
