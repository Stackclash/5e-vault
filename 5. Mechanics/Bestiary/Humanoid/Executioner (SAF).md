...
- "desc": "Prerequisite: 3rd-level retainer\n\nThe executioner whips a serrated\
    ...
    \ damage on a hit. The creature must make a Dexterity saving throw or be [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]].\
    \ At the start of the executioners turn, they automatically deal dice: 3d6|avg\
    \ (3d6) slashing damage to the [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]]\
