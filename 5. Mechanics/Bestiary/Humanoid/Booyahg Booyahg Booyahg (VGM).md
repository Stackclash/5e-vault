...
This goblin is a sorcerer with the wild magic origin whose every casting, including cantrips, is accompanied by a wild magic surge. Each time the goblin casts a spell, there is an accompanying surge of wild magic; roll on the [[5. Mechanics/Tables/Wild Magic Surge (PHB).md|Wild Magic Surge]] table in the "Player's Handbook" to determine the wild magic effect.
...
"traits":
  ...
  - "desc": "Each time the goblin casts a spell (including cantrips), there is an\
      \ accompanying surge of wild magic; roll on the [[5. Mechanics/Tables/Wild Magic Surge (PHB).md|Wild Magic Surge]]\
