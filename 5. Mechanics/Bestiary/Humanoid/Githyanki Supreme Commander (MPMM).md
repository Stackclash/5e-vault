...
Supreme commanders lead armies, each one commanding ten kith'raks, who in turn lead the rest of their forces. Most supreme commanders ride [[Adult Red Dragon|red dragons]] into battle.
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+12 (+12 to hit), reach 5 ft., one target.\
    ...
    \ the [[/5. Mechanics/Spells/Astral Projection.md|astral projection]] spell), the\
