...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The abjurer casts one of the following spells, using Intelligence as the\
    ...
    \n2/day each: [[/5. Mechanics/Spells/Dispel Magic.md|dispel magic]], [lightning\
    \ bolt](/compendium/spells/lightning-bolt.md), [[/5. Mechanics/Spells/Mage Armor.md|mage armor]]"
  "name": "spells"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- "MPMM"
- "VGM"
"image": "5. Mechanics/Bestiary/Humanoid/token/abjurer-wizard.png"
```
^statblock
