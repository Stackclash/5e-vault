...
"actions":
  ...
  - "desc": "The hedge mage magically animates a Medium or smaller plant it touches,\
      ...
      \ of any special senses that the plant has. During this time, the hedge mage\
      \ is deaf and blind with regard to its own senses."
    "name": "Animate Plant (4/Day)"
  - "desc": "The hedge mage or one willing creature it chooses within 30 feet of it\
      \ becomes magically protected against acid, cold, fire, lightning, or poison\
      \ damage (hedge mage's choice) for 1 hour. For the duration, any damage the\
      \ target takes of the chosen type is reduced by 10."
