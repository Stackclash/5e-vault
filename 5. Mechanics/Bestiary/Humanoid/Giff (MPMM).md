...
- "desc": "The giff can try to knock a creature over; if the giff moves at least 20\
    ...
    \ that creature must succeed on a DC 14 Strength saving throw or take 7 (dice:\
    \ 2d6|avg (2d6)) bludgeoning damage and be knocked [[/5. Mechanics/Rules/Conditions.md#prone|prone]]."
...
- "desc": "Ranged Weapon Attack: dice: d20+4 (+4 to hit), range 40/120 ft., one\
    \ target. Hit: 8 (dice: 1d12 + 2|avg (1d12 + 2)) piercing damage."
  "name": "Musket"
