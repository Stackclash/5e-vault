...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    \ Hit: 5 (dice: 1d4 + 3|avg (1d4 + 3)) piercing damage plus 10 (dice: 3d6|avg\
    \ (3d6)) psychic damage, or 1 piercing damage plus 10 (dice: 3d6|avg (3d6))\
...
- "desc": "For 1 minute, the duergar magically decreases in size, along with anything\
    ...
    \ disadvantage if they use Strength. It gains a +5 bonus to all Dexterity ([[/5. Mechanics/Rules/Skills.md#Stealth|")"]]\
