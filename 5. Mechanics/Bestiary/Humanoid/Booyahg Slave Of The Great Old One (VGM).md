...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The goblin is a 14th-level spellcaster. Its spellcasting ability is Charisma\
    ...
    \n1st-5th level (3 5th-level slots): [[/5. Mechanics/Spells/Armor Of Agathys.md|armor of Agathys]],\
...
"source":
- "VGM"
"image": "5. Mechanics/Bestiary/Humanoid/token/booyahg-slave-of-the-great-old-one.png"
```
^statblock
