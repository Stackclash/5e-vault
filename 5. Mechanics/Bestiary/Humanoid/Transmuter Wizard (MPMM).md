...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The transmuter casts one of the following spells, using Intelligence as\
    ...
    \ each: [[/5. Mechanics/Spells/Fireball.md|fireball]], [[/5. Mechanics/Spells/Hold Person.md|hold person]],\
...
- "MPMM"
- "VGM"
"image": "5. Mechanics/Bestiary/Humanoid/token/transmuter-wizard.png"
```
^statblock
