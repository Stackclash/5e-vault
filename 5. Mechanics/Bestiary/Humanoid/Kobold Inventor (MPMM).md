...
"actions":
  ...
  - "desc": "The kobold uses one of the following options (choose one or roll a d8);\
      ...
      \ hit, range 5/20 ft., one target. *Hit:* 5 (1d10) acid damage, and the target\
      \ is covered in slime until a creature uses its action to scrape or wash the\
      \ slime off. A target covered in the slime takes 5 (1d10) acid damage at the\
      ...
      \ a [[/5. Mechanics/Bestiary/Beast/Scorpion.md|scorpion]] tied to the end of a\
