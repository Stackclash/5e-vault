...
Any temple of [[/5. Mechanics/Deities/Drow Lolth (MTF).md|Lolth]] also functions as a matron mother's lair while she is inside it, unless she has renounced Lolth or another matron mother is present. When two or more matron mothers gather within a temple of their goddess, none of them can use it as their lair.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 15 ft., one creature. *Hit:*\
      \ 3 (1d6) bludgeoning damage. If the target is hit three times by the [[/5. Mechanics/Items/Tentacle Rod.md|rod]]\
  ...
  - "desc": "The drow casts one of the following spells, requiring no material components\
      ...
      \ will:** [[/5. Mechanics/Spells/Command.md|command]], [[/5. Mechanics/Spells/Dancing Lights.md|dancing lights]],\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the drow can take one\
      ...
      \ [[/5. Mechanics/Rules/Conditions.md#Invisible|invisible]] condition against her.\
      ...
      \ point must succeed a DC 19 Dexterity saving throw or be [[/5. Mechanics/Rules/Conditions.md#Restrained|restrained]]\
