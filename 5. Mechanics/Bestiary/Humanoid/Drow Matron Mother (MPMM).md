...
A matron mother is almost never encountered alone. She is typically accompanied by a [[Drow Favored Consort (MPMM)|drow favored consort]] and a [[Drow House Captain (MPMM)|drow house captain]], each of whom appears in this book. Other Underdark creatures might also be in the priestess's presence, providing protection or advice.
