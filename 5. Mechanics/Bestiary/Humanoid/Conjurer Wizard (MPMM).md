...
- "desc": "The conjurer magically summons an [[5. Mechanics/Bestiary/Elemental/Air Element(AL).md|air elemental]],\
    \ an [[5. Mechanics/Bestiary/Elemental/Earth Element(AL).md|earth elemental]], a [[5. Mechanics/Bestiary/Elemental/Fire Element(AL).md|fire\
    \ elemental]], or a [[5. Mechanics/Bestiary/Elemental/Water Element(AL).md|water elemental]].\
