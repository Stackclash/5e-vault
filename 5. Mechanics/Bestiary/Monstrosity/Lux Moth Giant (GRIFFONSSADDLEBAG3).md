...
- "desc": "Any non-moth creature that moves within 10 feet of the moth or starts its\
    ...
    \ If a creature that fails this save is already [[/5. Mechanics/Rules/Conditions.md#Poisoned|poisoned]]\
    ...
    \ A [[/5. Mechanics/Rules/Conditions.md#Poisoned|poisoned]] creature can repeat its\
...
- "desc": "The moth bristles its wings, causing the vibrating patterns to fog the\
    ...
    \ creature must make a DC 12 Wisdom saving throw or be [[/5. Mechanics/Rules/Conditions.md#Stunned|stunned]]\
