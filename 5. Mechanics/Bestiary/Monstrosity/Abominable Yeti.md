...
- "desc": "If the yeti takes fire damage, it has disadvantage on attack rolls and\
  ...
  "name": "Fear of Fire"
- "desc": "The yeti has advantage on Wisdom ([[/5. Mechanics/Rules/Skills.md#Perception|")"]]\
    \ checks that rely on smell."
  "name": "Keen Smell"
- "desc": "The yeti has advantage on Dexterity ([[/5. Mechanics/Rules/Skills.md#Stealth|")"]]\
