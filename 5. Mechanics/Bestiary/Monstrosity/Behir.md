...
- "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 10 ft., one target.\
    \ Hit: 22 (dice: 3d10 + 6|avg (3d10 + 6)) piercing damage."
  "name": "Bite"
- "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft., one Large\
    \ or smaller creature. Hit: 17 (dice: 2d10 + 6|avg (2d10 + 6)) bludgeoning\
    \ damage plus 17 (dice: 2d10 + 6|avg (2d10 + 6)) slashing damage. The target\
    \ is [[/5. Mechanics/Rules/Conditions.md#grappled|") (escape DC 16"]] if the\
...
- "desc": "The behir makes one bite attack against a Medium or smaller target it is\
    ...
    \ against attacks and other effects outside the behir, and it takes 21 (dice:\
    \ 6d6|avg (6d6)) acid damage at the start of each of the behir's turns. A behir\
