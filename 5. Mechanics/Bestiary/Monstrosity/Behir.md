...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The behir makes one bite attack against a Medium or smaller target it is\
    ...
    \ which falls [[5. Mechanics/Rules/Conditions.md#prone|prone]] in a space within\
    \ 10 feet of the behir. If the behir dies, a swallowed creature is no longer [[5. Mechanics/Rules/Conditions.md#restrained|restrained]]\
