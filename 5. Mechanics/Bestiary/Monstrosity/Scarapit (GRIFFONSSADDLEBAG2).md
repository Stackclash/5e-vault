...
"traits":
  ...
  - "desc": "The scarapit can breathe normally in any environment, and it has advantage\
      ...
      \ and [[5. Mechanics/Spells/Stinking Cloud.md|stinking cloud]] effects, inhaled\
  ...
  - "desc": "While the scarapit is underground, it always knows how far it is from\
      \ the surface, it can't be surprised while it isn't [[/5. Mechanics/Rules/Conditions.md#Incapacitated|incapacitated]],\
