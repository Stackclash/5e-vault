...
- "desc": "When a shadow mastiff howls, all creatures within a 300-foot radius who\
    ...
    \ panicked. On each of its turns, a panicked creature must take the [[/5. Mechanics/Rules/Actions.md#Dash|Dash]]\
...
- "desc": "Whenever a shadow mastiff hits an opponent with a bite attack for the first\
    \ time on a turn, the opponent falls [[/5. Mechanics/Rules/Conditions.md#Prone|prone]]\
