...
"traits":
  - "desc": "When a shadow mastiff howls, all creatures within a 300-foot radius who\
      \ are not evil monstrosities must succeed on a DC 13 Wisdom saving throw or\
      \ be panicked. On each of its turns, a panicked creature must take the [[/5. Mechanics/Rules/Actions.md#Dash|Dash]]\
      \ action and move away from the mastiff by the safest and shortest route, if\
      \ such a route exists. If the target moves out of range of this ability, the\
      \ effect ends."
    "name": "Bay"
  - "desc": "The shadow mastiff has advantage on Wisdom checks that rely on their\
      \ sense of smell."
    "name": "Scent"
  - "desc": "Shadow mastiffs can hide in any condition of illumination other than\
      \ bright light."
    "name": "Shadow Blend"
  - "desc": "Whenever a shadow mastiff hits an opponent with a bite attack for the\
      \ first time on a turn, the opponent falls [[/5. Mechanics/Rules/Conditions.md#Prone|prone]]\
