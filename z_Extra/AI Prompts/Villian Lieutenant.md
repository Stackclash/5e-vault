...
When creating lieutenants:
	...
	- Each lieutenant must be capable of operating independently
...
Describe:
	- Power dynamics (trusted, expendable, rival, manipulated)
...
Outline multiple possible outcomes for this lieutenant:
	...
	- Capture or exposure
	- Redemption, defection, or betrayal
	- Replacement by a worse successor
...
After all lieutenants are defined, describe:
	- Rivalries or cooperation between lieutenants
	- How they compete or undermine one another
...
For each lieutenant:
	- Name & Title:
	- Aspect of Villain’s Plan Represented:
	- Core Motivation:
	- Primary Methods & Domain:
	- Relationship to Villain:
	- Key PC Entanglements:
	- Escalation Behavior:
	- Possible Fates:
...
Style Requirements
	- DM-facing tone
	- No stat blocks or mechanical detail
	- Focus on agency, ideology, and consequence
	- Designed for reuse in arcs, locations, and sessions