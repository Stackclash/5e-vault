...
-  Villain Scope: (Local / Regional / World-shaping / Cosmic)
...
Include conflicting or incomplete understandings held by the world.
...
Describe the transformed world the villain seeks to create if unopposed.
...
-  Escalation Trajectory: (Early → Mid → Late)
