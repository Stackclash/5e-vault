...
How danger is managed:
	- Magic in the Settlement:
Common, feared, regulated, commercialized, or restricted.
	- Monster Threat Level:
Rare, seasonal, nearby, or constant.
	- Defenses & Coping Mechanisms:
Walls, wards, militias, mercenaries, rituals, bribes, or denial.
	- Everyday Risk:
...
Describe the spiritual life of the settlement:
	- Prevalent Faiths or Gods
	- Environmental & Occupational Influence on Belief
	- Religious Practices & Customs
...
If races or species are defined, describe:
	- Population Makeup:
Which groups are present and in what proportions.
	- Intergroup Relations:
Cooperation, segregation, resentment, alliance, or exploitation.
	- Historical Causes:
Past wars, migration, labor roles, religious differences, or external blame.
	- Current Tensions or Unity:
Laws, customs, or incidents shaping trust or distrust.
...
List 5–8 rumors:
	- Mix of true, distorted, and false
	- Connected to:
	- Local problems
	- Regional or world events
	- Villain or faction activity
	- Indicate which are accurate (for the DM)
...
Describe how the settlement evolves if:
	- Helped
	- Exploited
	- Ignored
...
Canonical Summary Format
	...
	- Tone:
	- Who Holds Power:
	- Magic & Monster Baseline:
	- Dominant Faiths & Customs:
	- Racial / Species Dynamics:
	- Key Districts or Areas:
	- Active Problems:
	- Key Rumors:
	- PC Relevance:
...
Style Requirements
	...
	- Focus on belief, power, and consequence
	- Designed for immediate table use