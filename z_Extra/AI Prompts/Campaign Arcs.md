...
Each campaign phase must arise from the actions, plans, or agents of the primary villain, and collectively build toward a final confrontation or resolution—the nature of which remains player-determined.
...
(Paste directly)
	•	Intended Campaign Length:
(Short / Medium / Long / Epic)
	•	Preferred Structure (Optional):
(e.g., 3 acts, 5 acts, episodic, spiral escalation)
	•	Known Lieutenants or Factions (Optional):
(If already defined)
	•	Player Character Emphasis (Optional):
(Specific arcs, themes, or PCs to highlight)
	•	Hard Constraints (Optional):
(Events that must or must not occur)
...
When building the campaign arc:
	...
	•	A direct action
	•	A consequence of their long-term plan
	•	The actions of a lieutenant or aligned faction
	•	Each phase must advance or reveal an aspect of the villain’s plan
	•	Even if the players misinterpret it at the time
	•	The arc must converge toward confrontation
	•	Physical, ideological, political, or metaphysical
	•	The outcome must remain unresolved
	•	The villain must evolve
	•	Adapt strategy
	•	Escalate commitment
...
Divide the campaign into phases appropriate to the campaign length.
...
Describe how the villain changes over the course of the campaign:
	•	Strategy shifts
	•	Increased desperation or confidence
...
Explain how player decisions can:
	•	Alter the order or nature of later phases
...
Describe the shape of the endgame without scripting it:
	•	Where confrontation is likely to occur
	•	What the villain risks or sacrifices
	•	How earlier phases influence the final encounter
...
When revising the arc:
	...
	•	Preserve convergence toward confrontation
...
Style Requirements
	...
	•	Emphasize causality, pressure, and escalation
	•	Designed for modular, reactive storytelling