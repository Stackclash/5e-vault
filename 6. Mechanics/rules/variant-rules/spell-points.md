...
The Spell Points by Level table applies to [bards](/6. Mechanics/classes/bard.md), [clerics](/6. Mechanics/classes/cleric.md), [druids](/6. Mechanics/classes/druid.md), [sorcerers](/6. Mechanics/classes/sorcerer.md), and [wizards](/6. Mechanics/classes/wizard.md). For a [paladin](/6. Mechanics/classes/paladin.md) or [ranger](/6. Mechanics/classes/ranger.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](/6. Mechanics/classes/fighter-eldritch-knight.md) or [rogue (Arcane Trickster)](/6. Mechanics/classes/rogue-arcane-trickster.md), divide the character's level in that class by three.
