...
| Proficiency | Items |
|-------------|-------|
| [Herbalism kit](/6. Mechanics/items/herbalism-kit.md) | Antitoxin, [potion of healing](/6. Mechanics/items/potion-of-healing.md) |
| [Leatherworker's tools](/6. Mechanics/items/leatherworkers-tools.md) | Leather armor, boots |
| [Smith's tools](/6. Mechanics/items/smiths-tools.md) | Armor, weapons |
| [Weaver's tools](/6. Mechanics/items/weavers-tools.md) | Cloaks, robes |
^proficiency-items
...
To complete a magic item, a character also needs whatever tool proficiency is appropriate, as for crafting a nonmagical object, or proficiency in the [Arcana](/6. Mechanics/rules/skills.md#Arcana) skill.
