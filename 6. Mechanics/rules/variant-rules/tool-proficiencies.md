...
Tools have more specific applications than skills. The [History](/6. Mechanics/rules/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/6. Mechanics/items/forgery-kit.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/6. Mechanics/items/masons-tools.md) makes a successful Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/6. Mechanics/rules/skills.md#Investigation)) check to determine how to open the door.
...
[Alchemist's supplies](/6. Mechanics/items/alchemists-supplies.md) enable a character to produce useful concoctions, such as acid or alchemist's fire.

##### Components

[alchemist's supplies](/6. Mechanics/items/alchemists-supplies.md) include two glass beakers, a metal frame to hold a beaker in place over an open flame, a glass stirring rod, a small mortar and pestle, and a pouch of common alchemical ingredients, including salt, powdered iron, and purified water.

##### Arcana

Proficiency with [alchemist's supplies](/6. Mechanics/items/alchemists-supplies.md) allows you to unlock more information on [Arcana](/6. Mechanics/rules/skills.md#Arcana) checks involving potions and similar materials.

##### Investigation

When you inspect an area for clues, proficiency with [alchemist's supplies](/6. Mechanics/items/alchemists-supplies.md) grants additional insight into any chemicals or other substances that might have been used in the area.

##### Alchemical Crafting

You can use this tool proficiency to create alchemical items. A character can spend money to collect raw materials, which weigh 1 pound for every 50 gp spent. The DM can allow a character to make a check using the indicated skill with advantage. As part of a long rest, you can use [alchemist's supplies](/6. Mechanics/items/alchemists-supplies.md) to make one dose of [acid](/6. Mechanics/items/acid-vial.md), [alchemist's fire](/6. Mechanics/items/alchemists-fire-flask.md), [antitoxin](/6. Mechanics/items/antitoxin-vial.md), [oil](/6. Mechanics/items/oil-flask.md), [perfume](/6. Mechanics/items/perfume-vial.md), or [soap](/6. Mechanics/items/soap.md). Subtract half the value of the created item from the total gp worth of raw materials you are carrying.
...
[Brewer's supplies](/6. Mechanics/items/brewers-supplies.md) include a large glass jug, a quantity of hops, a siphon, and several feet of tubing.

##### History

Proficiency with [brewer's supplies](/6. Mechanics/items/brewers-supplies.md) gives you additional insight on Intelligence ([History](/6. Mechanics/rules/skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
A stiff drink can help soften the hardest heart. Your proficiency with [brewer's supplies](/6. Mechanics/items/brewers-supplies.md) can help you ply someone with drink, giving them just enough alcohol to mellow their mood.
...
[Calligrapher's supplies](/6. Mechanics/items/calligraphers-supplies.md) include ink, a dozen sheets of parchment, and three quills.
...
[Carpenter's tools](/6. Mechanics/items/carpenters-tools.md) include a saw, a hammer, nails, a hatchet, a square, a ruler, an adze, a plane, and a chisel.
...
Using [cartographer's tools](/6. Mechanics/items/cartographers-tools.md), you can create accurate maps to make travel easier for yourself and those who come after you. These maps can range from large-scale depictions of mountain ranges to diagrams that show the layout of a dungeon level.

##### Components

[Cartographer's tools](/6. Mechanics/items/cartographers-tools.md) consist of a quill, ink, parchment, a pair of compasses, calipers, and a ruler.
...
[Cobbler's tools](/6. Mechanics/items/cobblers-tools.md) consist of a hammer, an awl, a knife, a shoe stand, a cutter, spare leather, and thread.
...
As part of a long rest, you can repair your companions' shoes. For the next 24 hours, up to six creatures of your choice who wear shoes you worked on can travel up to 10 hours a day without making saving throws to avoid [exhaustion](/6. Mechanics/rules/conditions.md#exhaustion).

##### Craft Hidden Compartment

With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](/6. Mechanics/rules/skills.md#Investigation)) check DC needed to find the compartment.
...
[Cook's utensils](/6. Mechanics/items/cooks-utensils.md) include a metal pot, knives, forks, a stirring spoon, and a ladle.
...
As part of a short rest, you can prepare a tasty meal that helps your companions regain their strength. You and up to five creatures of your choice regain 1 extra hit point per Hit Die spent during a short rest, provided you have access to your [cook's utensils](/6. Mechanics/items/cooks-utensils.md) and sufficient food.
...
The perfect tool for anyone who wants to engage in trickery, a [disguise kit](/6. Mechanics/items/disguise-kit.md) enables its owner to adopt a false identity.

##### Components

A [disguise kit](/6. Mechanics/items/disguise-kit.md) includes cosmetics, hair dye, small props, and a few pieces of clothing.
...
A [forgery kit](/6. Mechanics/items/forgery-kit.md) is designed to duplicate documents and to make it easier to copy a person's seal or signature.

##### Components

A [forgery kit](/6. Mechanics/items/forgery-kit.md) includes several different types of ink, a variety of parchments and papers, several quills, seals and sealing wax, gold and silver leaf, and small tools to sculpt melted wax to mimic a seal.

##### Arcana

A [forgery kit](/6. Mechanics/items/forgery-kit.md) can be used in conjunction with the [Arcana](/6. Mechanics/rules/skills.md#Arcana) skill to determine if a magic item is real or fake.
...
A [forgery kit](/6. Mechanics/items/forgery-kit.md) combined with your knowledge of history improves your ability to create fake historical documents or to tell if an old document is authentic.

##### Investigation

When you examine objects, proficiency with a [forgery kit](/6. Mechanics/items/forgery-kit.md) is useful for determining how an object was made and whether it is genuine.

##### Other Tools

Knowledge of other tools makes your forgeries that much more believable. For example, you could combine proficiency with a [forgery kit](/6. Mechanics/items/forgery-kit.md) and proficiency with [cartographer's tools](/6. Mechanics/items/cartographers-tools.md) to make a fake map.

##### Quick Fake

As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](/6. Mechanics/items/forgery-kit.md) determines the DC for someone else's Intelligence ([Investigation](/6. Mechanics/rules/skills.md#Investigation)) check to spot the fake.
...
Someone who is proficient with [glassblower's tools](/6. Mechanics/items/glassblowers-tools.md) has not only the ability to shape glass, but also specialized knowledge of the methods used to produce glass objects.
...
Proficiency with an [herbalism kit](/6. Mechanics/items/herbalism-kit.md) allows you to identify plants and safely collect their useful elements.

##### Components

An [herbalism kit](/6. Mechanics/items/herbalism-kit.md) includes pouches to store herbs, clippers and leather gloves for collecting plants, a mortar and pestle, and several glass jars.
...
Training with [jeweler's tools](/6. Mechanics/items/jewelers-tools.md) includes the basic techniques needed to beautify gems. It also gives you expertise in identifying precious stones.

##### Components

[Jeweler's tools](/6. Mechanics/items/jewelers-tools.md) consist of a small saw and hammer, files, pliers, and tweezers.

##### Arcana

Proficiency with [jeweler's tools](/6. Mechanics/items/jewelers-tools.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](/6. Mechanics/rules/skills.md#Arcana) checks related to gems or gem-encrusted items.

##### Investigation

When you inspect jeweled objects, your proficiency with [jeweler's tools](/6. Mechanics/items/jewelers-tools.md) aids you in picking out clues they might hold.
...
[Leatherworker's tools](/6. Mechanics/items/leatherworkers-tools.md) include a knife, a small mallet, an edger, a hole punch, thread, and leather scraps.
...
[Mason's tools](/6. Mechanics/items/masons-tools.md) allow you to craft stone structures, including walls and buildings crafted from brick.

##### Components

[Mason's tools](/6. Mechanics/items/masons-tools.md) consist of a trowel, a hammer, a chisel, brushes, and a square.
...
Proficiency with [navigator's tools](/6. Mechanics/items/navigators-tools.md) helps you determine a true course based on observing the stars. It also grants you insight into charts and maps while developing your sense of direction.

##### Components

[Navigator's tools](/6. Mechanics/items/navigators-tools.md) include a sextant, a compass, calipers, a ruler, parchment, ink, and a quill.

##### Survival

Knowledge of [navigator's tools](/6. Mechanics/items/navigators-tools.md) helps you avoid becoming lost and also grants you insight into the most likely location for roads and settlements.
...
Proficiency with [painter's supplies](/6. Mechanics/items/painters-supplies.md) represents your ability to paint and draw. You also acquire an understanding of art history, which can aid you in examining works of art.

##### Components

[Painter's supplies](/6. Mechanics/items/painters-supplies.md) include an easel, canvas, paints, brushes, charcoal sticks, and a palette.
...
A [poisoner's kit](/6. Mechanics/items/poisoners-kit.md) is a favored resource for thieves, assassins, and others who engage in skulduggery. It allows you to apply poisons and create them from various materials. Your knowledge of poisons also helps you treat them.

##### Components

A [poisoner's kit](/6. Mechanics/items/poisoners-kit.md) includes glass vials, a mortar and pestle, chemicals, and a glass stirring rod.
...
Your knowledge of poisons has taught you to handle those substances carefully, giving you an edge when you inspect [poisoned](/6. Mechanics/rules/conditions.md#poisoned) objects or try to extract clues from events that involve poison.
...
| Activity | DC |
|----------|----|
| Spot a [poisoned](/6. Mechanics/rules/conditions.md#poisoned) object | 10 |
| Determine the effects of a poison | 20 |
^poisoners-tools

#### Potter's Tools

[Potter's tools](/6. Mechanics/items/potters-tools.md) are used to create a variety of ceramic objects, most typically pots and similar vessels.

##### Components

[Potter's tools](/6. Mechanics/items/potters-tools.md) include potter's needles, ribs, scrapers, a knife, and calipers.
...
[Smith's tools](/6. Mechanics/items/smiths-tools.md) allow you to work metal, heating it to alter its shape, repair damage, or work raw ingots into useful items.

##### Components

[Smith's tools](/6. Mechanics/items/smiths-tools.md) include hammers, tongs, charcoal, rags, and a whetstone.
...
Perhaps the most common tools used by adventurers, [thieves' tools](/6. Mechanics/items/thieves-tools.md) are designed for picking locks and foiling traps. Proficiency with the tools also grants you a general knowledge of traps and locks.

##### Components

[Thieves' tools](/6. Mechanics/items/thieves-tools.md) include a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers.
...
A set of [tinker's tools](/6. Mechanics/items/tinkers-tools.md) is designed to enable you to repair many mundane objects. Though you can't manufacture much with [tinker's tools](/6. Mechanics/items/tinkers-tools.md), you can mend torn clothes, sharpen a worn sword, and patch a tattered suit of chain mail.

##### Components

[Tinker's tools](/6. Mechanics/items/tinkers-tools.md) include a variety of hand tools, thread, needles, a whetstone, scraps of cloth and leather, and a small pot of glue.
...
[Weaver's tools](/6. Mechanics/items/weavers-tools.md) allow you to create cloth and tailor it into articles of clothing.

##### Components

[Weaver's tools](/6. Mechanics/items/weavers-tools.md) include thread, needles, and scraps of cloth. You know how to work a loom, but such equipment is too large to transport.
...
[Woodcarver's tools](/6. Mechanics/items/woodcarvers-tools.md) allow you to craft intricate objects from wood, such as wooden tokens or arrows.

##### Components

[Woodcarver's tools](/6. Mechanics/items/woodcarvers-tools.md) consist of a knife, a gouge, and a small saw.
