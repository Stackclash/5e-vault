...
To attempt a crime, the character makes three checks: Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)), Dexterity using [thieves' tools](/6. Mechanics/items/thieves-tools.md), and the player's choice of Intelligence ([Investigation](/6. Mechanics/rules/skills.md#Investigation)), Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)), or Charisma ([Deception](/6. Mechanics/rules/skills.md#Deception)).
