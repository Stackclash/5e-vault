...
The character makes three checks: Wisdom ([Insight](/6. Mechanics/rules/skills.md#Insight)), Charisma ([Deception](/6. Mechanics/rules/skills.md#Deception)), and Charisma ([Intimidation](/6. Mechanics/rules/skills.md#Intimidation)). If the character has proficiency with an appropriate gaming set, that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `dice: 5 + 2d10|avg` (`5 + 2d10`); generate a separate DC for each one. Consult the Gambling Results table to see how the character did.
