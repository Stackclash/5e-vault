...
|-------------|----------------|
| 1–5 | Roll `dice: 1d6|avg` (`1d6`) times on Magic Item Table A. |
| 6–10 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table B. |
| 11–15 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table C. |
| 16–20 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table D. |
| 21–25 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table E. |
| 26–30 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table F. |
| 31–35 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table G. |
| 36–40 | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table H. |
| 41+ | Roll `dice: 1d4|avg` (`1d4`) times on Magic Item Table I. |
^buying-magic-items
