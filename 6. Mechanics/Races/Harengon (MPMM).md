...
When you fail a Dexterity saving throw, you can use your reaction to roll a `dice: d4\|avg` (`d4`) and add it to the save, potentially turning the failure into a success. You can't use this reaction if you're [[6. Mechanics/Rules/conditions.md#prone\|prone]] or your speed is 0.
