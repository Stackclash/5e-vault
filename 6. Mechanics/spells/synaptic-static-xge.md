...
After a failed save, a target has muddled thoughts for 1 minute. During that time, it rolls a `dice: d6|avg` (`d6`) and subtracts the number rolled from all its attack rolls and ability checks, as well as its Constitution saving throws to maintain [concentration](/6. Mechanics/rules/status.md#concentration). The target can make an Intelligence saving throw at the end of each of its turns, ending the effect on itself on a success.
