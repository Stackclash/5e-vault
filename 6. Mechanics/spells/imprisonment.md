...
Heavy chains, firmly rooted in the ground, hold the target in place. The target is [restrained](/6. Mechanics/rules/conditions.md#restrained) until the spell ends, and it can't move or be moved by any means until then.
...
A [dispel magic](/6. Mechanics/spells/dispel-magic.md) spell can end the spell only if it is cast as a 9th-level spell, targeting either the prison or the special component used to create it.
