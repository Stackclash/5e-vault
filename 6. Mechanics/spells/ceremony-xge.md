...
You touch one willing creature whose alignment has changed, and you make a DC 20 Wisdom ([Insight](/6. Mechanics/rules/skills.md#Insight)) check. On a successful check, you restore the target to its original alignment.

## Bless Water

You touch one [vial](/6. Mechanics/items/vial.md) of water and cause it to become [holy water](/6. Mechanics/items/holy-water-flask.md).
...
You touch one corpse, and for the next 7 days, the target can't become undead by any means short of a [wish](/6. Mechanics/spells/wish.md) spell.
...
**Classes**: [Cleric](/6. Mechanics/classes/cleric.md), [Paladin](/6. Mechanics/classes/paladin.md), [Sorcerer (Divine Soul)](/6. Mechanics/classes/sorcerer-divine-soul-xge.md)
