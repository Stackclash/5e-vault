...
![[/6. Mechanics/Bestiary/Dragon/Token/white-dragon-wyrmling.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 2\|avg` (`1d10 + 2`) piercing damage plus `dice: 1d4\|avg` (`1d4`) cold damage.

***Cold Breath (Recharge 5-6).*** The dragon exhales an icy blast of hail in a 15-foot cone. Each creature in that area must make a DC 12 Constitution saving throw, taking 22 (`dice: 5d8\|avg` (`5d8`)) cold damage on a failed save, or half as much damage on a successful one.
```
^statblock