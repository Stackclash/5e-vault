...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dragon exhales fire in a 60-foot cone. Each creature in that area must\
    \ make a DC 21 Dexterity saving throw, taking 63 (dice: 18d6|avg (18d6)) fire\
...
![[/6. Mechanics/Bestiary/Dragon/Token/adult-red-dragon.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 8` (`2d10 + 8`) piercing damage plus `dice: 2d6` (`2d6`) fire damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 8` (`2d6 + 8`) slashing damage.

***Tail.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 15 ft., one target. Hit: `dice: 2d8 + 8` (`2d8 + 8`) bludgeoning damage.
...
***Fire Breath (Recharge 5-6).*** The dragon exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking 63 (`dice: 18d6` (`18d6`)) fire damage on a failed save, or half as much damage on a successful one.
