...
- "BGDIA"
- "DSotDQ"
"image": "/compendium/bestiary/dragon/token/red-dragon-wyrmling.png"
aliases: ["Red Dragon Wyrmling"]
---
# Red Dragon Wyrmling
*Source: Monster Manual p. 98, Curse of Strahd, Waterdeep: Dungeon of the Mad Mage, Baldur's Gate: Descent Into Avernus, Dragonlance: Shadow of the Dragon Queen*  
...
![[/6. Mechanics/Bestiary/Dragon/Token/red-dragon-wyrmling.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) piercing damage plus `dice: 1d6` (`1d6`) fire damage.

***Fire Breath (Recharge 5-6).*** The dragon exhales fire in a 15-foot cone. Each creature in that area must make a DC 13 Dexterity saving throw, taking 24 (`dice: 7d6` (`7d6`)) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock