...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dragon exhales shadowy fire in a 30-foot cone. Each creature in that\
    ...
    \ A humanoid reduced to 0 hit points by this damage dies, and an undead [[/6. Mechanics/Bestiary/Undead/shadow.md\|shadow]]\
...
The dragon's proficiency bonus is doubled for its Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]]) checks.
...
While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on sight.
...
![[/6. Mechanics/Bestiary/Dragon/Token/young-red-shadow-dragon.png#token]]
...
***Sunlight Sensitivity.*** While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on sight.

## Actions

***Multiattack.*** The dragon makes three attacks: one with its bite and two with its claws.

***Bite.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 6` (`2d10 + 6`) piercing damage plus `dice: 1d6` (`1d6`) necrotic damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 6` (`2d6 + 6`) slashing damage.

***Shadow Breath (Recharge 5-6).*** The dragon exhales shadowy fire in a 30-foot cone. Each creature in that area must make a DC 18 Dexterity saving throw, taking 56 (`dice: 16d6` (`16d6`)) necrotic damage on a failed save, or half as much damage on a successful one. A humanoid reduced to 0 hit points by this damage dies, and an undead [[/6. Mechanics/Bestiary/Undead/shadow.md\|shadow]] rises from its corpse and acts immediately after the dragon in the initiative count. The shadow is under the dragon's control.
```
^statblock
