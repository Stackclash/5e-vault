...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \ [[/6. Mechanics/Spells/hallucinatory-terrain.md\|hallucinatory terrain]], [mage\
    \ hand](/compendium/spells/mage-hand.md), [[/6. Mechanics/Spells/major-image.md\|major image]],\
    \ [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]], [[/6. Mechanics/Spells/mirror-image.md\|mirror image]],\
    \ [[/6. Mechanics/Spells/polymorph.md\|polymorph]], [[/6. Mechanics/Spells/suggestion.md\|suggestion]]"
  "name": "innate"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
*Source: Monster Manual p. 133, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Explorer's Guide to Wildemount, The Wild Beyond the Witchlight*  
...
![[/6. Mechanics/Bestiary/Dragon/Token/faerie-dragon-violet.png#token]]
...
If the faerie dragon dies, these effects fade over the course of `dice: 1d10` (`1d10`) days.
```
^statblock
