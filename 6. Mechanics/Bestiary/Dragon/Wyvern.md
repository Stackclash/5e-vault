...
***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one creature. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) slashing damage.

***Stinger.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one creature. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage. The target must make a DC 15 Constitution saving throw, taking 24 (`dice: 7d6` (`7d6`)) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
