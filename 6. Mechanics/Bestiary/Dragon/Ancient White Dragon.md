...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dragon exhales an icy blast in a 90-foot cone. Each creature in that\
    \ area must make a DC 22 Constitution saving throw, taking 72 (dice: 16d8|avg\
...
- "EGW"
- "IDRotF"
"image": "/compendium/bestiary/dragon/token/ancient-white-dragon.png"
...
![[/6. Mechanics/Bestiary/Dragon/Token/ancient-white-dragon.png#token]]
*Gargantuan dragon, Chaotic Evil*

- **Armor Class** 20 (natural armor)
- **Hit Points** `dice: 18d20 + 144|text(333)` (18d20 + 144) 
- **Speed** walk 40 ft., burrow 40 ft., fly 80 ft., swim 40 ft.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 15 ft., one target. Hit: `dice: 2d10 + 8` (`2d10 + 8`) piercing damage plus `dice: 2d8` (`2d8`) cold damage.
...
***Cold Breath (Recharge 5-6).*** The dragon exhales an icy blast in a 90-foot cone. Each creature in that area must make a DC 22 Constitution saving throw, taking 72 (`dice: 16d8` (`16d8`)) cold damage on a failed save, or half as much damage on a successful one.
