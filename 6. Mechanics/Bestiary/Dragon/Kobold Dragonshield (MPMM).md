...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the kobold is [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ or [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] by an effect that allows\
...
![[/6. Mechanics/Bestiary/Dragon/Token/kobold-dragonshield.png#token]]
*Small dragon, Any alignment*

- **Armor Class** 15 ([[/6. Mechanics/Items/leather-armor.md\|leather]], [[/6. Mechanics/Items/shield.md\|shield]])
- **Hit Points** `dice: 8d6 + 16|text(44)` (8d6 + 16) 
- **Speed** walk 20 ft.
...
***Dragon's Resistance.*** The kobold has resistance to a type of damage based on the color of dragon that invested it with power (choose or roll a `dice: d10` (`d10`)): 1–2, acid (black or copper); 3–4, cold (silver or white); 5–6, fire (brass, gold, or red); 7–8, lightning (blue or bronze); 9–10, poison (green).

***Heart of the Dragon.*** If the kobold is [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] or [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] by an effect that allows a saving throw, it can repeat the save at the start of its turn to end the effect on itself and all kobolds within 30 feet of it. Any kobold that benefits from this trait (including the dragonshield) has advantage on its next attack roll.
