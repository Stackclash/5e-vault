...
***Bite.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 15 ft., one target. Hit: `dice: 2d10 + 8` (`2d10 + 8`) piercing damage plus `dice: 2d8` (`2d8`) acid damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 10 ft., one target. Hit: `dice: 2d6 + 8` (`2d6 + 8`) slashing damage.
...
***Acid Breath (Recharge 5-6).*** The dragon exhales acid in a 90-foot line that is 10 feet wide. Each creature in that line must make a DC 22 Dexterity saving throw, taking 67 (`dice: 15d8` (`15d8`)) acid damage on a failed save, or half as much damage on a successful one.
