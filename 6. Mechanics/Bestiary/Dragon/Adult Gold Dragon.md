...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The dragon uses one of the following breath weapons.\n\n- Fire Breath.\
    ...
    \ a DC 21 Dexterity saving throw, taking 66 (dice: 12d10|avg (12d10)) fire\
...
![[/6. Mechanics/Bestiary/Dragon/Token/adult-gold-dragon.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 8` (`2d10 + 8`) piercing damage.
...
- **Fire Breath.** The dragon exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking 66 (`dice: 12d10` (`12d10`)) fire damage on a failed save, or half as much damage on a successful one.  
