...
```ad-statblock
title: Guard Drake
![[/6. Mechanics/Bestiary/Dragon/Token/guard-drake.png#token]]
...
***Tail.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) bludgeoning damage.
```
^statblock
