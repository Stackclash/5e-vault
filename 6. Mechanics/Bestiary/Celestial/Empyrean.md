...
***Maul.*** *Melee Weapon Attack:* `dice: d20+17` (+17 to hit), reach 10 ft., one target. Hit: `dice: 6d6 + 10\|avg` (`6d6 + 10`) bludgeoning damage. If the target is a creature, it must succeed on a DC 15 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] until the end of the empyrean's next turn.
