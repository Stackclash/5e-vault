...
```ad-statblock
title: Deva
![[/6. Mechanics/Bestiary/Celestial/Token/deva.png#token]]
...
***Angelic Weapons.*** The deva's weapon attacks are magical. When the deva hits with any weapon, the weapon deals an extra `dice: 4d8` (`4d8`) radiant damage (included in the attack).
...
***Healing Touch (3/Day).*** The deva touches another creature. The target magically regains 20 (`dice: 4d8 + 2` (`4d8 + 2`)) hit points and is freed from any curse, disease, poison, blindness, or deafness.
