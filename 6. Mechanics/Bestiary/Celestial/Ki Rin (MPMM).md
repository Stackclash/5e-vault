...
***Hoof.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one target. Hit: `dice: 2d4 + 5\|avg` (`2d4 + 5`) force damage.

***Horn.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 5\|avg` (`2d8 + 5`) radiant damage.

***Sacred Fire.*** *Ranged Spell Attack:* `dice: d20+9` (+9 to hit), range 120 ft., one target. Hit: `dice: 3d8 + 5\|avg` (`3d8 + 5`) radiant damage.
