...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The ki-rin casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/light.md\|light]], [[/6. Mechanics/Spells/major-image.md\|major image]]\
    \ (6th-level version), [[/6. Mechanics/Spells/thaumaturgy.md\|thaumaturgy]]\n\n1/day\
    \ each: [[/6. Mechanics/Spells/banishment.md\|banishment]], [[/6. Mechanics/Spells/calm-emotions.md\|calm emotions]],\
    \ [[/6. Mechanics/Spells/create-food-and-water.md\|create food and water]], [greater\
    \ restoration](/compendium/spells/greater-restoration.md), [[/6. Mechanics/Spells/plane-shift.md\|plane shift]],\
    \ [[/6. Mechanics/Spells/protection-from-evil-and-good.md\|protection from evil and good]],\
    \ [[/6. Mechanics/Spells/revivify.md\|revivify]], [[/6. Mechanics/Spells/wind-walk.md\|wind walk]]\n\
    \n3/day each: [[/6. Mechanics/Spells/cure-wounds.md\|cure wounds]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]],\
    \ [[/6. Mechanics/Spells/lesser-restoration.md\|lesser restoration]], [[/6. Mechanics/Spells/sending.md\|sending]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Ki-rin
![[/6. Mechanics/Bestiary/Celestial/Token/ki-rin.png#token]]
*Large celestial, Lawful Good*

- **Armor Class** 20 (natural armor)
- **Hit Points** `dice: 18d10 + 54|text(153)` (18d10 + 54) 
- **Speed** walk 60 ft., fly 120 ft. (hover)
...
**At will**: [[/6. Mechanics/Spells/light.md\|light]], [[/6. Mechanics/Spells/major-image.md\|major image]] (6th-level version), [[/6. Mechanics/Spells/thaumaturgy.md\|thaumaturgy]]

**1/day each**: [[/6. Mechanics/Spells/banishment.md\|banishment]], [[/6. Mechanics/Spells/calm-emotions.md\|calm emotions]], [[/6. Mechanics/Spells/create-food-and-water.md\|create food and water]], [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]], [[/6. Mechanics/Spells/plane-shift.md\|plane shift]], [[/6. Mechanics/Spells/protection-from-evil-and-good.md\|protection from evil and good]], [[/6. Mechanics/Spells/revivify.md\|revivify]], [[/6. Mechanics/Spells/wind-walk.md\|wind walk]]

**3/day each**: [[/6. Mechanics/Spells/cure-wounds.md\|cure wounds]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/lesser-restoration.md\|lesser restoration]], [[/6. Mechanics/Spells/sending.md\|sending]]

## Actions

***Multiattack.*** The ki-rin makes two Hoof attacks and one Horn attack, or it makes two Sacred Fire attacks.

***Hoof.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one target. Hit: `dice: 2d4 + 5` (`2d4 + 5`) force damage.

***Horn.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 5` (`2d8 + 5`) radiant damage.

***Sacred Fire.*** *Ranged Spell Attack:* `dice: d20+9` (+9 to hit), range 120 ft., one target. Hit: `dice: 3d8 + 5` (`3d8 + 5`) radiant damage.

## Legendary Actions

***Move.*** The ki-rin moves up to half its speed without provoking opportunity attack||opportunity attacks.
...
- **Controlled Weather.** A ki-rin can cast [[/6. Mechanics/Spells/control-weather.md\|control weather]] while it is within 3 miles of its lair. The spell's point of origin is always the point outdoors closest to the center of its lair. The ki-rin doesn't need to maintain a clear path to the sky or to concentrate for the change in weather to persist.  
