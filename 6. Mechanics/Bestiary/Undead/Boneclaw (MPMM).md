...
***Rejuvenation.*** While its master lives, a destroyed boneclaw gains a new body in `dice: 1d10\|avg` (`1d10`) hours, with all its hit points. The new body appears within 1 mile of the boneclaw's master.
