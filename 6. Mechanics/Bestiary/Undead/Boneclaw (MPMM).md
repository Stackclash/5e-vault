...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 15 ft., one target.\
    ...
    \ the target up to 10 feet toward itself, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
```ad-statblock
title: Boneclaw
![[/6. Mechanics/Bestiary/Undead/Token/boneclaw.png#token]]
*Large undead, Chaotic Evil*

- **Armor Class** 16 (natural armor)
- **Hit Points** `dice: 20d10 + 40|text(150)` (20d10 + 40) 
- **Speed** walk 40 ft.
...
***Rejuvenation.*** While its master lives, a destroyed boneclaw gains a new body in `dice: 1d10` (`1d10`) hours, with all its hit points. The new body appears within 1 mile of the boneclaw's master.
...
***Piercing Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 15 ft., one target. Hit: `dice: 3d10 + 4` (`3d10 + 4`) piercing damage plus `dice: 2d10` (`2d10`) necrotic damage. If the target is a creature, the boneclaw can pull the target up to 10 feet toward itself, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 14). The boneclaw has two claws. While a claw grapples a target, the claw can attack only that target.

***Shadow Jump (Recharge 5-6).*** If the boneclaw is in dim light or darkness, each creature of the boneclaw's choice within 15 feet of it must succeed on a DC 14 Constitution saving throw or take `dice: 5d12 + 2` (`5d12 + 2`) necrotic damage.
