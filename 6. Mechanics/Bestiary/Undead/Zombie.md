...
```ad-statblock
title: Zombie
![[/6. Mechanics/Bestiary/Undead/Token/zombie.png#token]]
*Medium undead, Neutral Evil*

- **Armor Class** 8 
- **Hit Points** `dice: 3d8 + 9|text(22)` (3d8 + 9) 
- **Speed** walk 20 ft.
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 1` (`1d6 + 1`) bludgeoning damage.
```
^statblock
