...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The poltergeist is [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]."
  "name": "Invisibility"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The poltergeist targets a creature or unattended object within 30 feet\
    ...
    \ or heavy object, the target takes dice: 1d6|avg (1d6) damage per 10 feet\
...
***Incorporeal Movement.*** The poltergeist can move through other creatures and objects as if they were difficult terrain. It takes `dice: 1d10` (`1d10`) force damage if it ends its turn inside an object.
...
***Forceful Slam.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 3d6` (`3d6`) force damage.
...
If the target is a creature, the poltergeist makes a Charisma check contested by the target's Strength check. If the poltergeist wins the contest, the poltergeist hurls the target up to 30 feet in any direction, including upward. If the target then comes into contact with a hard surface or heavy object, the target takes `dice: 1d6` (`1d6`) damage per 10 feet moved.

If the target is an object that isn't being worn or carried, the poltergeist hurls it up to 30 feet in any direction. The poltergeist can use the object as a ranged weapon, attacking one creature along the object's path (`dice: d20+4` (+4 to hit)) and dealing 5 (`dice: 2d4` (`2d4`)) bludgeoning damage on a hit.
```
^statblock
