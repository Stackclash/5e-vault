...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the commander has taken damage during this combat, it gives itself advantage\
    ...
    \ + 1) [[/6. Mechanics/Bestiary/Undead/Sword Wraith Warrior (MPMM).md\|sword wraith warriors]]\
...
![[/6. Mechanics/Bestiary/Undead/Token/sword-wraith-commander.png#token]]
*Medium undead, Lawful Evil*

- **Armor Class** 18 ([[/6. Mechanics/Items/breastplate.md\|breastplate]], [[/6. Mechanics/Items/shield.md\|shield]])
...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) slashing damage, or 9 (`dice: 1d10 + 4` (`1d10 + 4`)) slashing damage if used with two hands.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage.

***Call to Honor (1/Day).*** If the commander has taken damage during this combat, it gives itself advantage on attack rolls until the end of its next turn, and `dice: 1d4 + 1` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Undead/Sword Wraith Warrior (MPMM).md\|sword wraith warriors]] appear in unoccupied spaces within 30 feet of it. The warriors last until they drop to 0 hit points, and they take their turns immediately after the commander's turn on the same initiative count.

## Bonus Actions

***Martial Fury.*** The commander makes one Longsword or Longbow attack, which deals an extra 9 (`dice: 2d8` (`2d8`)) necrotic damage on a hit, and attack rolls against it have advantage until the start of its next turn.
```
^statblock
