...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "A creature dies if reduced to 0 hit points by the nightwalker and can't\
    \ be revived except by a [[/6. Mechanics/Spells/wish.md\|wish]] spell."
  "name": "Life Eater"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The nightwalker points at one creature it can see within 300 feet of it.\
    ...
    \ (6d12) necrotic damage and become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ until the end of the nightwalker's next turn. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ in this way, the creature is also [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]].\
...
```ad-statblock
title: Nightwalker
![[/6. Mechanics/Bestiary/Undead/Token/nightwalker.png#token]]
*Huge undead, Chaotic Evil*

- **Armor Class** 14 
- **Hit Points** `dice: 25d12 + 175|text(337)` (25d12 + 175) 
- **Speed** walk 40 ft., fly 40 ft.
...
***Annihilating Aura.*** Any creature that starts its turn within 30 feet of the nightwalker must succeed on a DC 21 Constitution saving throw or take `dice: 6d6` (`6d6`) necrotic damage. Undead are immune to this aura.

***Life Eater.*** A creature dies if reduced to 0 hit points by the nightwalker and can't be revived except by a [[/6. Mechanics/Spells/wish.md\|wish]] spell.
...
***Enervating Focus.*** *Melee Weapon Attack:* `dice: d20+12` (+12 to hit), reach 15 ft., one target. Hit: `dice: 5d8 + 6` (`5d8 + 6`) necrotic damage. The target must succeed on a DC 21 Constitution saving throw or its hit point maximum is reduced by an amount equal to the necrotic damage taken. This reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0.

***Finger of Doom (Recharge 6).*** The nightwalker points at one creature it can see within 300 feet of it. The target must succeed on a DC 21 Wisdom saving throw or take `dice: 6d12` (`6d12`) necrotic damage and become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] until the end of the nightwalker's next turn. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] in this way, the creature is also [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]. If a target's saving throw is successful, the target is immune to the nightwalker's Finger of Doom for the next 24 hours.
```
^statblock
