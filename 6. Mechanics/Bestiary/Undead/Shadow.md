...
```ad-statblock
title: Shadow
![[/6. Mechanics/Bestiary/Undead/Token/shadow.png#token]]
...
If a non-evil humanoid dies from this attack, a new shadow rises from the corpse `dice: 1d4` (`1d4`) hours later.
```
^statblock
