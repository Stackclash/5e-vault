...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 0 ft., one creature\
    ...
    \ creature must succeed on a DC 12 Strength saving throw or be [[6. Mechanics/Rules/conditions.md#restrained\|restrained]].\
...
***Undead Mass.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 0 ft., one target in the swarm's space. Hit: `dice: 1d6 + 2` (`1d6 + 2`) bludgeoning damage, or 4 (`dice: 1d4 + 2` (`1d4 + 2`)) bludgeoning damage if the swarm has half of its hit points or fewer.

***Grasping Limbs.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 0 ft., one creature in the swarm's space. Hit: `dice: 2d6` (`2d6`) necrotic damage, and the creature must succeed on a DC 12 Strength saving throw or be [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]. The creature can repeat the saving throw at the end of each of its turns, taking 7 (`dice: 2d6` (`2d6`)) necrotic damage on a failed save. The creature is freed if it succeeds on this saving throw, the swarm moves out of the creature's space, or the swarm dies.
```
^statblock