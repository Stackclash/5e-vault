...
***Pseudopod.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 10 ft., one target. Hit: `dice: 1d6 + 2\|avg` (`1d6 + 2`) necrotic damage, and the target must succeed on a DC 14 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the start of the necrichor's next turn.
