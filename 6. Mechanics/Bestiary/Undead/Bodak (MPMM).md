...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When a creature that can see the bodak's eyes starts its turn within 30\
    ...
    \ throw if the bodak isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
    \ and can see the creature. If the saving throw fails by 5 or more, the creature\
    \ is reduced to 0 hit points unless it is immune to the [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One creature that the bodak can see within 60 feet of it must make a DC\
    \ 13 Constitution saving throw, taking 22 (dice: 4d10|avg (4d10)) necrotic\
...
```ad-statblock
title: Bodak
![[/6. Mechanics/Bestiary/Undead/Token/bodak.png#token]]
...
***Death Gaze.*** When a creature that can see the bodak's eyes starts its turn within 30 feet of the bodak, the bodak can force it to make a DC 13 Constitution saving throw if the bodak isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] and can see the creature. If the saving throw fails by 5 or more, the creature is reduced to 0 hit points unless it is immune to the [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] condition. Otherwise, a creature takes `dice: 3d10` (`3d10`) psychic damage on a failed save.
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2` (`1d4 + 2`) bludgeoning damage plus `dice: 2d8` (`2d8`) necrotic damage.

***Withering Gaze.*** One creature that the bodak can see within 60 feet of it must make a DC 13 Constitution saving throw, taking 22 (`dice: 4d10` (`4d10`)) necrotic damage on a failed save, or half as much damage on a successful one.
