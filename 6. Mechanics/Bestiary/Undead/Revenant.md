...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 5 ft., one target.\
    ...
    \ creature against which the revenant has sworn vengeance, the target takes an\
    \ extra 14 (dice: 4d6|avg (4d6)) bludgeoning damage. Instead of dealing damage,\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The revenant targets one creature it can see within 30 feet of it and against\
    ...
    \ turn. When the paralysis ends, the target is [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ of the revenant for 1 minute. The [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
    \ if it can see the revenant, ending the [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) bludgeoning damage. If the target is a creature against which the revenant has sworn vengeance, the target takes an extra 14 (`dice: 4d6` (`4d6`)) bludgeoning damage. Instead of dealing damage, the revenant can grapple the target (escape DC 14) provided the target is Large or smaller.
