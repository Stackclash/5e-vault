...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The mist touches one creature in its space. The target must succeed on\
    ...
    \ or it takes dice: 2d6 + 3|avg (2d6 + 3) necrotic damage, the mist regains\
...
In billowing clouds of fog lurk vampiric mists, the wretched remnants of [[/6. Mechanics/Bestiary/Undead/Vampire.md\|vampires]] that were prevented from finding rest. Indistinguishable from the mists they lurk within, they strike unseen and undetected to bleed their victims dry.

Vampiric mists, sometimes called crimson mists, are all that remain of [[/6. Mechanics/Bestiary/Undead/Vampire.md\|vampires]] who couldn't return to their burial places after being defeated or suffering some mishap. Denied the restorative power of these places, the [[/6. Mechanics/Bestiary/Undead/Vampire.md\|vampires']] bodies dissolve into mist. The transformation strips the intelligence and personality from them until only an unholy, insatiable thirst for blood remains.
...
```ad-statblock
title: Vampiric Mist
![[/6. Mechanics/Bestiary/Undead/Token/vampiric-mist.png#token]]
...
***Life Drain.*** The mist touches one creature in its space. The target must succeed on a DC 13 Constitution saving throw (Undead and Constructs automatically succeed), or it takes `dice: 2d6 + 3` (`2d6 + 3`) necrotic damage, the mist regains 10 hit points, and the target's hit point maximum is reduced by an amount equal to the necrotic damage taken. This reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0.
```
^statblock
