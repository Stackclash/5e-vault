...
***Deathly Claw.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2\|avg` (`2d6 + 2`) necrotic damage.

***Grave Bolt.*** *Ranged Spell Attack:* `dice: d20+5` (+5 to hit), range 120 ft., one target. Hit: `dice: 2d10 + 3\|avg` (`2d10 + 3`) necrotic damage.
```
^statblock
