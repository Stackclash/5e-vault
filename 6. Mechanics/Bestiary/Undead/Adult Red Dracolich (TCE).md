...
![[/6. Mechanics/Bestiary/Undead/Token/adult-red-dracolich.png#token]]
...
***Fire Breath (Recharge 5-6).*** The dracolich exhales fire in a 60-foot cone. Each creature in that area must make a DC 21 Dexterity saving throw, taking 63 (`dice: 18d6` (`18d6`)) fire damage on a failed save, or half as much damage on a successful one.
