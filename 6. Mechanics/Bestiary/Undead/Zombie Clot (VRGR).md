...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature that starts its turn within 10 feet of the zombie must succeed\
    ...
    \ damage and be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The zombie flings a detached clump of corpses at a creature it can see\
    ...
    \ entombed in the dead flesh is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]],\
...
```ad-statblock
title: Zombie Clot
![[/6. Mechanics/Bestiary/Undead/Token/zombie-clot.png#token]]
...
***Deathly Stench.*** Any creature that starts its turn within 10 feet of the zombie must succeed on a DC 14 Constitution saving throw or take `dice: 2d8` (`2d8`) poison damage and be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the start of the creature's next turn.
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 5` (`3d8 + 5`) bludgeoning damage.

***Flesh Entomb (Recharge 5-6).*** The zombie flings a detached clump of corpses at a creature it can see within 30 feet of it. The target must succeed on a DC 16 Strength saving throw or take `dice: 3d10` (`3d10`) bludgeoning damage, and if the target is a Large or smaller creature, it becomes entombed in dead flesh.

A creature entombed in the dead flesh is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], has total cover against attacks and other effects outside the dead flesh, and takes `dice: 3d6` (`3d6`) necrotic damage at the start of each of its turns. The creature can be freed if the dead flesh is destroyed. The dead flesh is a Large object with AC 10, 25 hit points, and immunity to poison and psychic damage.
```
^statblock