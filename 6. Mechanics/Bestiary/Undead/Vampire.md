...
```ad-statblock
title: Vampire
![[/6. Mechanics/Bestiary/Undead/Token/vampire.png#token]]
...
***Children of the Night (1/Day).*** The vampire magically calls `dice: 2d4\|avg` (`2d4`) swarms of [[/6. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|bats]] or [[/6. Mechanics/Bestiary/Beast/Swarm Of Rats.md\|rats]], provided that the sun isn't up. While outdoors, the vampire can call `dice: 3d6\|avg` (`3d6`) [[/6. Mechanics/Bestiary/Beast/Wolf.md\|wolves]] instead. The called creatures arrive in `dice: 1d4\|avg` (`1d4`) rounds, acting as allies of the vampire and obeying its spoken commands. The beasts remain for 1 hour, until the vampire dies, or until the vampire dismisses them as a bonus action.
