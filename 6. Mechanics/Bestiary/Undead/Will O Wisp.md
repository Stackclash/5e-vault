...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shock"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The will-o'-wisp and its light magically become [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]\
    \ until it attacks or uses its Consume Life, or until its [[6. Mechanics/Rules/status.md#concentration\|concentration]]\
...
```ad-statblock
title: Will-o'-Wisp
![[/6. Mechanics/Bestiary/Undead/Token/will-o-wisp.png#token]]
...
***Consume Life.*** As a bonus action, the will-o'-wisp can target one creature it can see within 5 feet of it that has 0 hit points and is still alive. The target must succeed on a DC 10 Constitution saving throw against this magic or die. If the target dies, the will-o'-wisp regains 10 (`dice: 3d6` (`3d6`)) hit points.

***Ephemeral.*** The will-o'-wisp can't wear or carry anything.

***Incorporeal Movement.*** The will-o'-wisp can move through other creatures and objects as if they were difficult terrain. It takes `dice: 1d10` (`1d10`) force damage if it ends its turn inside an object.
...
***Shock.*** *Melee Spell Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 2d8` (`2d8`) lightning damage.

***Invisibility.*** The will-o'-wisp and its light magically become [[6. Mechanics/Rules/conditions.md#invisible\|invisible]] until it attacks or uses its Consume Life, or until its [[6. Mechanics/Rules/status.md#concentration\|concentration]] ends (as if [[6. Mechanics/Rules/status.md#concentration\|concentration]] on a spell).
```
^statblock
