...
```ad-statblock
title: Ogre Zombie
![[/6. Mechanics/Bestiary/Undead/Token/ogre-zombie.png#token]]
*Large undead, Neutral Evil*

- **Armor Class** 8 
- **Hit Points** `dice: 9d10 + 36|text(85)` (9d10 + 36) 
- **Speed** walk 30 ft.
...
***Morningstar.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) bludgeoning damage.
```
^statblock