...
```ad-statblock
title: Crawling Claw
![[/6. Mechanics/Bestiary/Undead/Token/crawling-claw.png#token]]
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1` (`1d4 + 1`) bludgeoning or slashing damage (claw's choice).
```
^statblock