...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The alhoon casts one of the following spells, requiring no material components\
    ...
    \ will: [[/6. Mechanics/Spells/dancing-lights.md\|dancing lights]], [[/6. Mechanics/Spells/detect-magic.md\|detect magic]],\
    \ [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/disguise-self.md\|disguise self]],\
    ...
    \ [[/6. Mechanics/Spells/invisibility.md\|invisibility]], [[/6. Mechanics/Spells/modify-memory.md\|modify memory]],\
    \ [[/6. Mechanics/Spells/plane-shift.md\|plane shift]] (self only), [[/6. Mechanics/Spells/wall-of-force.md\|wall of force]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The alhoon magically emits psychic energy in a 60-foot cone. Each creature\
    ...
    \ 4d8 + 4|avg (4d8 + 4) psychic damage and be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
...
```ad-statblock
title: Alhoon
![[/6. Mechanics/Bestiary/Undead/Token/alhoon.png#token]]
