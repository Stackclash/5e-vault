...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The gas spore explodes when it drops to 0 hit points. Each creature within\
    ...
    \ save. Creatures immune to the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
    ...
    \ In half that time, the creature becomes [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
...
```ad-statblock
title: Gas Spore
![[/6. Mechanics/Bestiary/Plant/Token/gas-spore.png#token]]
*Large plant, Unaligned*

- **Armor Class** 5 
- **Hit Points** `dice: 1d10 - 4|text(1)` (1d10 - 4) 
- **Speed** walk 0 ft., fly 10 ft. (hover)
...
***Death Burst.*** The gas spore explodes when it drops to 0 hit points. Each creature within 20 feet of it must succeed on a DC 15 Constitution saving throw or take `dice: 3d6` (`3d6`) poison damage and become infected with a disease on a failed save. Creatures immune to the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] condition are immune to this disease.

Spores invade an infected creature's system, killing the creature in a number of hours equal to `dice: 1d12` (`1d12`) + the creature's Constitution score, unless the disease is removed. In half that time, the creature becomes [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for the rest of the duration. After the creature dies, it sprouts `dice: 2d4` (`2d4`) Tiny gas spores that grow to full size in 7 days.
...
***Touch.*** *Melee Weapon Attack:* `dice: d20+0` (+0 to hit), reach 5 ft., one creature. Hit: 1 poison damage, and the creature must succeed on a DC 10 Constitution saving throw or become infected with the disease described in the Death Burst trait.
```
^statblock
