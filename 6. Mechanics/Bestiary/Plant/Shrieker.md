...
```ad-statblock
title: Shrieker
![[/6. Mechanics/Bestiary/Plant/Token/shrieker.png#token]]
...
***Shriek.*** When bright light or a creature is within 30 feet of the shrieker, it emits a shriek audible within 300 feet of it. The shrieker continues to shriek until the disturbance moves out of range and for `dice: 1d4` (`1d4`) of the shrieker's turns afterward.
```
^statblock
