...
![[/6. Mechanics/Bestiary/Plant/Token/myconid-sprout.png#token]]
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+1` (+1 to hit), reach 5 ft., one target. Hit: `dice: 1d4 - 1|avg` (`1d4 - 1`) bludgeoning damage plus `dice: 1d4\|avg` (`1d4`) poison damage.
