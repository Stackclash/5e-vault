...
```ad-statblock
title: Twig Blight
![[/6. Mechanics/Bestiary/Plant/Token/twig-blight.png#token]]
...
***Claws.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1` (`1d4 + 1`) piercing damage.
```
^statblock
