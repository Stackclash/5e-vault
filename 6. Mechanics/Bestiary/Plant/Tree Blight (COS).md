...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 15 ft., one creature\
    \ not [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by the blight. Hit:\
    \ The target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one creature\
    \ [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by the blight. Hit: dice:\
...
```ad-statblock
title: Tree Blight
![[/6. Mechanics/Bestiary/Plant/Token/tree-blight.png#token]]
...
***Branch.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one target. Hit: `dice: 3d6 + 6` (`3d6 + 6`) bludgeoning damage.

***Grasping Root.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one creature not [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by the blight. Hit: The target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 15). Until the grapple ends, the target takes `dice: 1d6 + 6` (`1d6 + 6`) bludgeoning damage at the start of each of its turns. The root has AC 15 and can be severed by dealing 6 slashing damage or more to it at once. Cutting the root doesn't hurt the blight, but ends the grapple.

## Bonus Actions

***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by the blight. Hit: `dice: 3d8 + 6` (`3d8 + 6`) piercing damage.
```
^statblock