...
***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by the blight. Hit: `dice: 3d8 + 6\|avg` (`3d8 + 6`) piercing damage.
```
^statblock