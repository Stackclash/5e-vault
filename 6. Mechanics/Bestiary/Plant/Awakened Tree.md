...
An awakened tree is an ordinary tree given sentience and mobility by the [[/6. Mechanics/Spells/awaken.md\|awaken]] spell or similar magic.

```ad-statblock
title: Awakened Tree
![[/6. Mechanics/Bestiary/Plant/Token/awakened-tree.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 3d6 + 4` (`3d6 + 4`) bludgeoning damage.
```
^statblock
