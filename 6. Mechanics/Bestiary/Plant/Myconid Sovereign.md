...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The myconid ejects spores at one creature it can see within 5 feet of it.\
    \ The target must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
    \ for 1 minute. The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target\
    \ is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] while it hallucinates.\
    \ The target can repeat the saving throw at the end of each of its turns, ending\
    \ the effect on itself on a success."
  "name": "Hallucination Spores"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The myconid ejects spores at one creature it can see within 5 feet of it.\
    \ The target must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
...
![[/6. Mechanics/Bestiary/Plant/Token/myconid-sovereign.png#token]]
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 3d4 + 1` (`3d4 + 1`) bludgeoning damage plus `dice: 3d4` (`3d4`) poison damage.

***Animating Spores (3/Day).*** The myconid targets one corpse of a humanoid or a Large or smaller beast within 5 feet of it and releases spores at the corpse. In 24 hours, the corpse rises as a spore servant. The corpse stays animated for `dice: 1d4 + 1` (`1d4 + 1`) weeks or until destroyed, and it can't be animated again in this way.

***Hallucination Spores.*** The myconid ejects spores at one creature it can see within 5 feet of it. The target must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] while it hallucinates. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Pacifying Spores.*** The myconid ejects spores at one creature it can see within 5 feet of it. The target must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
