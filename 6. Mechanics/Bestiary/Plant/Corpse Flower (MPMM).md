...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Each creature that starts its turn within 10 feet of the corpse flower\
    ...
    \ creature is a Construct or an Undead. On a failed save, the creature is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Digest"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The corpse flower animates one corpse in its body, turning it into a [[/6. Mechanics/Bestiary/Undead/zombie.md\|zombie]].\
...
With or without corpses nested in its body, a corpse flower exudes a stench of decay that can overwhelm the senses of nearby creatures, causing them to become nauseated. The stench, which serves as a defense mechanism, fades `dice: 2d4` (`2d4`) days after the corpse flower dies.
...
***Corpses.*** When first encountered, a corpse flower contains the corpses of `dice: 1d6 + 3` (`1d6 + 3`) Humanoids. A corpse flower can hold the remains of up to nine Humanoids. These remains have total cover against attacks and other effects outside the corpse flower. If the corpse flower dies, the corpses within it can be pulled free.
...
***Tentacle.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 10 ft., one target. Hit: `dice: 2d6 + 2` (`2d6 + 2`) bludgeoning damage plus `dice: 3d6` (`3d6`) poison damage.
...
***Digest.*** The corpse flower digests one corpse in its body and instantly regains 11 (`dice: 2d10` (`2d10`)) hit points. Nothing of the digested corpse remains. Any equipment on the corpse is expelled from the corpse flower in its space.
