...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The vegepygmy has advantage on Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "A 15-foot-radius cloud of toxic spores extends out from the vegepygmy.\
    ...
    \ must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]].\
...
- "MPMM"
- "VGM"
"image": "/compendium/bestiary/plant/token/vegepygmy-chief.png"
aliases: ["Vegepygmy Chief"]
---
# Vegepygmy Chief
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 253, Volo's Guide to Monsters p. 197*  

As a [[/6. Mechanics/Bestiary/Plant/Vegepygmy (MPMM).md\|vegepygmy]] ages, it grows tougher and develops spore clusters on its body. Other vegepygmies defer to these so-called chiefs. A chief can expel its spores in a burst, infecting nearby creatures. If a creature dies while infected, its corpse produces vegepygmies the same way russet mold does.
...
![[/6. Mechanics/Bestiary/Plant/Token/vegepygmy-chief.png#token]]
*Small plant, Neutral*

- **Armor Class** 14 (natural armor)
- **Hit Points** `dice: 6d6 + 12|text(33)` (6d6 + 12) 
- **Speed** walk 30 ft.
...
***Plant Camouflage.*** The vegepygmy has advantage on Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]]) checks it makes in any terrain with ample obscuring vegetation.
...
***Claws.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) slashing damage.

***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage, or 6 (`dice: 1d8 + 2` (`1d8 + 2`)) piercing damage if used with two hands to make a melee attack.

***Spores (1/Day).*** A 15-foot-radius cloud of toxic spores extends out from the vegepygmy. The spores spread around corners. Each creature in that area that isn't a Plant must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]. While [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] in this way, a target takes `dice: 2d8` (`2d8`) poison damage at the start of each of its turns. A target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
