...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The wood woad has advantage on Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]])\
...
***Plant Camouflage.*** The wood woad has advantage on Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]]) checks it makes in any terrain with ample obscuring vegetation.
...
***Club.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 4d4 + 4` (`4d4 + 4`) force damage.
```
^statblock
