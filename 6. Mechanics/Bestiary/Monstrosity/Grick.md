...
```ad-statblock
title: Grick
![[/6. Mechanics/Bestiary/Monstrosity/Token/grick.png#token]]
...
***Tentacles.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2` (`2d6 + 2`) slashing damage.

***Beak.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage.
```
^statblock
