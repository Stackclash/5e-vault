...
***Longbow (Yuan-ti Form Only).*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage plus `dice: 2d6` (`2d6`) poison damage.
```
^statblock
