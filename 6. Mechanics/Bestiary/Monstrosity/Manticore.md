...
```ad-statblock
title: Manticore
![[/6. Mechanics/Bestiary/Monstrosity/Token/manticore.png#token]]
...
***Tail Spike.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 100/200 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) piercing damage.
```
^statblock
