...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The sorrowsworn has advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#blinded\|blinded]],\
...
![[/6. Mechanics/Bestiary/Monstrosity/Token/angry-sorrowsworn.png#token]]
*Medium monstrosity, Neutral Evil*

- **Armor Class** 18 (natural armor)
- **Hit Points** `dice: 30d8 + 120|text(255)` (30d8 + 120) 
- **Speed** walk 30 ft.
...
***Two Heads.*** The sorrowsworn has advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#blinded\|blinded]], [[6. Mechanics/Rules/conditions.md#charmed\|charmed]], [[6. Mechanics/Rules/conditions.md#deafened\|deafened]], [[6. Mechanics/Rules/conditions.md#frightened\|frightened]], [[6. Mechanics/Rules/conditions.md#stunned\|stunned]], or knocked [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]].

***Rising Anger.*** If another creature deals damage to the sorrowsworn, the sorrowsworn's attack rolls have advantage until the end of its next turn, and the first time it hits with a Hook attack on its next turn, the attack's target takes an extra 19 (`dice: 3d12` (`3d12`)) psychic damage.
...
***Hook.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d12 + 3` (`2d12 + 3`) piercing damage.
```
^statblock
