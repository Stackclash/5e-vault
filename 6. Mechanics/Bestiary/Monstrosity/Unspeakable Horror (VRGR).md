...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The horror can move through the space of another creature. The first time\
    ...
    \ must succeed on a DC 16 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
...
***Bile Body (Oozing Organs Only).*** Any creature that touches the horror or hits it with a melee attack takes `dice: 1d10` (`1d10`) acid damage.
...
***Limbs.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 3d10 + 5` (`3d10 + 5`) bludgeoning damage.

***Hex Blast (Recharge 5-6).*** The horror expels necrotic energy in a 30-foot cone. Each creature in that area must make a DC 15 Constitution saving throw, taking 45 (`dice: 7d12` (`7d12`)) necrotic damage on a failed save, or half as much damage on a successful one.
```
^statblock