...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Claw"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One Large or smaller creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The cave fisher extends a sticky filament up to 60 feet, and the filament\
    \ adheres to anything that touches it. A creature the filament adheres to is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
```ad-statblock
title: Cave Fisher
![[/6. Mechanics/Bestiary/Monstrosity/Token/cave-fisher.png#token]]
