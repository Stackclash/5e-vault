...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the bulette jumps at least 15 feet as part of its movement, it can then\
    ...
    \ saving throw (target's choice) or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]\
    ...
    \ only half the damage, isn't knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]],\
    ...
    \ instead falls [[6. Mechanics/Rules/conditions.md#prone\|prone]] in the bulette's\
    \ space."
  "name": "Deadly Leap"
"source":
- "MM"
