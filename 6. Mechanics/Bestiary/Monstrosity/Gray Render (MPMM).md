...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 10 ft., one target.\
    ...
    \ bludgeoning damage if the target is [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Claw"
"reactions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Gray Render
![[/6. Mechanics/Bestiary/Monstrosity/Token/gray-render.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d12 + 4` (`2d12 + 4`) piercing damage. If the target is Medium or smaller, the target must succeed on a DC 16 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) slashing damage, plus `dice: 3d6` (`3d6`) bludgeoning damage if the target is [[6. Mechanics/Rules/conditions.md#prone\|prone]].
