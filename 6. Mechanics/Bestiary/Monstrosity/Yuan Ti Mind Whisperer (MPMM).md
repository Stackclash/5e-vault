...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The yuan-ti casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/message.md\|message]], [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]],\
...
![[/6. Mechanics/Bestiary/Monstrosity/Token/yuan-ti-mind-whisperer.png#token]]
...
**At will**: [[/6. Mechanics/Spells/animal-friendship.md\|animal friendship]] (snakes only), [[/6. Mechanics/Spells/message.md\|message]], [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]], [[/6. Mechanics/Spells/prestidigitation.md\|prestidigitation]]

**2/day each**: [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/hypnotic-pattern.md\|hypnotic pattern]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) piercing damage plus `dice: 2d6` (`2d6`) poison damage.
...
***Spectral Fangs.*** *Ranged Spell Attack:* `dice: d20+5` (+5 to hit), range 120 ft., one target. Hit: `dice: 3d8 + 3` (`3d8 + 3`) psychic damage.
