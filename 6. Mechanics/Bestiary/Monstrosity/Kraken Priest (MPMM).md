...
***Thunderbolt.*** *Ranged Spell Attack:* `dice: d20+5` (+5 to hit), range 60 ft., one target. Hit: `dice: 2d10\|avg` (`2d10`) lightning damage plus 11 (`dice: 2d10\|avg` (`2d10`)) thunder damage, and the target is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
