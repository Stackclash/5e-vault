...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    ...
    \ make a DC 11 Constitution saving throw, taking 18 (dice: 4d8|avg (4d8))\
    ...
    \ regaining hit points, and is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
...
```ad-statblock
title: Phase Spider
![[/6. Mechanics/Bestiary/Monstrosity/Token/phase-spider.png#token]]
