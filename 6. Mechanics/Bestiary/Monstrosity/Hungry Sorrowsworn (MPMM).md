...
***Life Hunger.*** If a creature within 60 feet of the sorrowsworn regains hit points, the sorrowsworn gains two benefits until the end of its next turn: it has advantage on attack rolls, and its Bite deals an extra 22 (`dice: 4d10` (`4d10`)) necrotic damage on a hit.

## Actions

***Multiattack.*** The sorrowsworn makes one Bite attack and one Claw attack.

***Bite.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) piercing damage plus `dice: 3d8` (`3d8`) necrotic damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 4d6 + 4` (`4d6 + 4`) slashing damage. If the target is Medium or smaller, it is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 16), and it is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] until the grapple ends. While grappling a creature, the sorrowsworn can't make a Claw attack.
```
^statblock
