...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The harpy sings a magical melody. Every humanoid and giant within 300 feet\
    ...
    \ or be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] until the song ends.\
    \ The harpy must take a bonus action on its subsequent turns to continue singing.\
    \ It can stop singing at any time. The song ends if the harpy is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].\n\
    \nWhile [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by the harpy, a target\
    \ is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] and ignores\
    \ the songs of other harpies. If the [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
```ad-statblock
title: Harpy
![[/6. Mechanics/Bestiary/Monstrosity/Token/harpy.png#token]]
...
***Club.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1` (`1d4 + 1`) bludgeoning damage.

***Luring Song.*** The harpy sings a magical melody. Every humanoid and giant within 300 feet of the harpy that can hear the song must succeed on a DC 11 Wisdom saving throw or be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] until the song ends. The harpy must take a bonus action on its subsequent turns to continue singing. It can stop singing at any time. The song ends if the harpy is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].

While [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by the harpy, a target is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] and ignores the songs of other harpies. If the [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] target is more than 5 feet away from the harpy, the target must move on its turn toward the harpy by the most direct route. It doesn't avoid opportunity attacks, but before moving into damaging terrain, such as lava or a pit, and whenever it takes damage from a source other than the harpy, a target can repeat the saving throw. A creature can also repeat the saving throw at the end of each of its turns. If a creature's saving throw is successful, the effect ends on it.
