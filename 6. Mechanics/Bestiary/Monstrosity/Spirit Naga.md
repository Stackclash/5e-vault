...
***Rejuvenation.*** If it dies, the naga returns to life in `dice: 1d6\|avg` (`1d6`) days and regains all its hit points. Only a [[/6. Mechanics/Spells/wish.md\|wish]] spell can prevent this trait from functioning.
