...
```ad-statblock
title: Centaur
![[/6. Mechanics/Bestiary/Monstrosity/Token/centaur.png#token]]
...
***Charge.*** If the centaur moves at least 30 feet straight toward a target and then hits it with a pike attack on the same turn, the target takes an extra 10 (`dice: 3d6` (`3d6`)) piercing damage.

## Actions

***Multiattack.*** The centaur makes two attacks: one with its pike and one with its hooves or two with its longbow.

***Pike.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) piercing damage.
