...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one Small\
    \ or Tiny creature. Hit: The target is stuck to the steeder's leg and [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
```ad-statblock
title: Male Steeder
![[/6. Mechanics/Bestiary/Monstrosity/Token/male-steeder.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage plus `dice: 1d8` (`1d8`) poison damage.

***Sticky Leg.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one Small or Tiny creature. Hit: The target is stuck to the steeder's leg and [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 12). The steeder can have only one creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] at a time.
```
^statblock
