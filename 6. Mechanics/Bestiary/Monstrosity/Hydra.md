...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hydra has five heads. While it has more than one head, the hydra has\
    \ advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#blinded\|blinded]],\
...
```ad-statblock
title: Hydra
![[/6. Mechanics/Bestiary/Monstrosity/Token/hydra.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 5` (`1d10 + 5`) piercing damage.
```
^statblock
