...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    ...
    \ or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. The\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+4 (+4 to hit), range 30/60 ft., one\
    \ Large or smaller creature. Hit: The creature is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]\
...
```ad-statblock
title: Ettercap
![[/6. Mechanics/Bestiary/Monstrosity/Token/ettercap.png#token]]
