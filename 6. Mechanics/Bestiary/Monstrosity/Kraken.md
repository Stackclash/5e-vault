...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The kraken ignores difficult terrain, and magical effects can't reduce\
    \ its speed or cause it to be [[6. Mechanics/Rules/conditions.md#restrained\|restrained]].\
    \ It can spend 5 feet of movement to escape from nonmagical restraints or being\
    \ [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]."
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+17 (+17 to hit), reach 5 ft., one target.\
    \ Hit: dice: 3d8 + 10|avg (3d8 + 10) piercing damage. If the target is a Large\
    ...
    \ creature is [[6. Mechanics/Rules/conditions.md#blinded\|blinded]] and [[6. Mechanics/Rules/conditions.md#restrained\|restrained]],\
    ...
    \ end of that turn or regurgitate all swallowed creatures, which fall [[6. Mechanics/Rules/conditions.md#prone\|prone]]\
    ...
    \ can escape from the corpse using 15 feet of movement, exiting [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Bite"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+17 (+17 to hit), reach 30 ft., one target.\
    \ Hit: dice: 3d6 + 10|avg (3d6 + 10) bludgeoning damage, and the target is\
    \ [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 18). Until this\
    \ grapple ends, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]].\
    \ The kraken has ten tentacles, each of which can grapple one target."
  "name": "Tentacle"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One Large or smaller object held or creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ by the kraken is thrown up to 60 feet in a random direction and knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].\
    ...
    \ saving throw or take the same damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Fling"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The kraken magically creates three bolts of lightning, each of which can\
    ...
    \ a DC 23 Dexterity saving throw, taking 22 (dice: 4d10|avg (4d10)) lightning\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "While underwater, the kraken expels an ink cloud in a 60-foot radius. The\
    ...
    \ there must succeed on a DC 23 Constitution saving throw, taking 16 (dice: 3d10|avg\
...
***Ink Cloud (Costs 3 Actions).*** While underwater, the kraken expels an ink cloud in a 60-foot radius. The cloud spreads around corners, and that area is heavily obscured to creatures other than the kraken. Each creature other than the kraken that ends its turn there must succeed on a DC 23 Constitution saving throw, taking 16 (`dice: 3d10` (`3d10`)) poison damage on a failed save, or half as much damage on a successful one. A strong current disperses the cloud, which otherwise disappears at the end of the kraken's next turn.
...
- The water in the kraken's lair becomes electrically charged. All creatures within 120 feet of the kraken must succeed on a DC 23 Constitution saving throw, taking 10 (`dice: 3d6` (`3d6`)) lightning damage on a failed save, or half as much damage on a successful one.  
