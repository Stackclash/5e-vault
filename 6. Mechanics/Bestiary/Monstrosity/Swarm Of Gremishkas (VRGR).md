...
***Bites.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 0 ft., one target in the swarm's space. Hit: `dice: 3d6 + 2` (`3d6 + 2`) piercing damage, or 5 (`dice: 1d6 + 2` (`1d6 + 2`)) piercing damage if the swarm has half of its hit points or fewer, plus `dice: 2d6` (`2d6`) force damage.
