...
```ad-statblock
title: Rust Monster
![[/6. Mechanics/Bestiary/Monstrosity/Token/rust-monster.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 1\|avg` (`1d8 + 1`) piercing damage.
