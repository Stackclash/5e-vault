...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The leucrotta can mimic Beast sounds and Humanoid voices. A creature that\
    ...
    \ ([[6. Mechanics/Rules/skills.md#Insight\|Insight]]) check."
  "name": "Mimicry"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature other than a leucrotta or gnoll that starts its turn within\
    ...
    \ be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the start of the\
...
```ad-statblock
title: Leucrotta
![[/6. Mechanics/Bestiary/Monstrosity/Token/leucrotta.png#token]]
...
***Mimicry.*** The leucrotta can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations only with a successful DC 14 Wisdom ([[6. Mechanics/Rules/skills.md#Insight\|Insight]]) check.

***Stench.*** Any creature other than a leucrotta or gnoll that starts its turn within 5 feet of the leucrotta must succeed on a DC 12 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the start of the creature's next turn. On a successful saving throw, the creature is immune to the Stench of all leucrottas for 1 hour.

## Actions

***Multiattack.*** The leucrotta makes one Bite attack and one Hooves attack.

***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) piercing damage. If the leucrotta scores a critical hit, it rolls the damage dice three times, instead of twice.
