...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one Medium\
    \ or smaller creature. Hit: The target is stuck to the steeder's leg and [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ (escape DC 12). The steeder can have only one creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ at a time."
  "name": "Sticky Leg"
"source":
- "MPMM"
...
![[/6. Mechanics/Bestiary/Monstrosity/Token/female-steeder.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) piercing damage plus `dice: 2d8` (`2d8`) poison damage.

***Sticky Leg.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one Medium or smaller creature. Hit: The target is stuck to the steeder's leg and [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 12). The steeder can have only one creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] at a time.
```
^statblock
