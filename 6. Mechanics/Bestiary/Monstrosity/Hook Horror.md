...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hook horror can't use its blindsight while [[6. Mechanics/Rules/conditions.md#deafened\|deafened]]."
  "name": "Echolocation"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hook horror has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
```ad-statblock
title: Hook Horror
![[/6. Mechanics/Bestiary/Monstrosity/Token/hook-horror.png#token]]
...
***Echolocation.*** The hook horror can't use its blindsight while [[6. Mechanics/Rules/conditions.md#deafened\|deafened]].

***Keen Hearing.*** The hook horror has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing.

## Actions

***Multiattack.*** The hook horror makes two hook attacks.

***Hook.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage.
```
^statblock
