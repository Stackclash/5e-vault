...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When a creature that can see the medusa's eyes starts its turn within 30\
    ...
    \ throw if the medusa isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
    \ and can see the creature. If the saving throw fails by 5 or more, the creature\
    \ is instantly [[6. Mechanics/Rules/conditions.md#petrified\|petrified]]. Otherwise,\
    \ a creature that fails the save begins to turn to stone and is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]].\
    \ The [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] creature must repeat\
    \ the saving throw at the end of its next turn, becoming [[6. Mechanics/Rules/conditions.md#petrified\|petrified]]\
    \ on a failure or ending the effect on a success. The petrification lasts until\
    \ the creature is freed by the  [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one creature.\
    \ Hit: dice: 1d4 + 2|avg (1d4 + 2) piercing damage plus dice: 4d6|avg (4d6)\
    \ poison damage."
  "name": "Snake Hair"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Medusa
![[/6. Mechanics/Bestiary/Monstrosity/Token/medusa.png#token]]
...
***Petrifying Gaze.*** When a creature that can see the medusa's eyes starts its turn within 30 feet of the medusa, the medusa can force it to make a DC 14 Constitution saving throw if the medusa isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] and can see the creature. If the saving throw fails by 5 or more, the creature is instantly [[6. Mechanics/Rules/conditions.md#petrified\|petrified]]. Otherwise, a creature that fails the save begins to turn to stone and is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]. The [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] creature must repeat the saving throw at the end of its next turn, becoming [[6. Mechanics/Rules/conditions.md#petrified\|petrified]] on a failure or ending the effect on a success. The petrification lasts until the creature is freed by the  [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]] spell or other magic.
...
***Snake Hair.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one creature. Hit: `dice: 1d4 + 2` (`1d4 + 2`) piercing damage plus `dice: 4d6` (`4d6`) poison damage.

***Shortsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage plus `dice: 2d6` (`2d6`) poison damage.
```
^statblock
