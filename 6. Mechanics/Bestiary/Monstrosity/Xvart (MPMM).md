...
```ad-statblock
title: Xvart
![[/6. Mechanics/Bestiary/Monstrosity/Token/xvart.png#token]]
...
***Shortsword.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: 5 (`dice: 1d6 + 2` (`1d6 + 2`)) piercing damage. If at least one of the xvart's allies is within 5 feet of the target, the xvart can push the target 5 feet if the target is a Medium or smaller creature.
