...
```ad-statblock
title: Gnoll Hunter
![[/6. Mechanics/Bestiary/Monstrosity/Token/gnoll-hunter.png#token]]
...
***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage, or 6 (`dice: 1d8 + 2` (`1d8 + 2`)) piercing damage when used with two hands to make a melee attack.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage, and the target's speed is reduced by 10 feet until the end of its next turn.
