...
![[/6. Mechanics/Bestiary/Monstrosity/Token/young-remorhaz.png#token]]
...
***Heated Body.*** A creature that touches the remorhaz or hits it with a melee attack while within 5 feet of it takes `dice: 2d6` (`2d6`) fire damage.

## Actions

***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 3d10 + 4` (`3d10 + 4`) piercing damage plus `dice: 2d6` (`2d6`) fire damage.
```
^statblock
