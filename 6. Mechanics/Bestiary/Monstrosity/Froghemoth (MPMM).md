...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft., one target.\
    ...
    \ if it is a Medium or smaller creature. A swallowed creature is [[6. Mechanics/Rules/conditions.md#blinded\|blinded]]\
    \ and [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], has total cover\
    ...
    \ all swallowed creatures, each of which falls [[6. Mechanics/Rules/conditions.md#prone\|prone]]\
    ...
    \ by it and can escape from the corpse using 10 feet of movement, exiting [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Bite"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 20 ft., one target.\
    \ Hit: dice: 3d8 + 6|avg (3d8 + 6) bludgeoning damage, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 3d10 + 6` (`3d10 + 6`) piercing damage, and the target is swallowed if it is a Medium or smaller creature. A swallowed creature is [[6. Mechanics/Rules/conditions.md#blinded\|blinded]] and [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], has total cover against attacks and other effects outside the froghemoth, and takes `dice: 3d6` (`3d6`) acid damage at the start of each of the froghemoth's turns.

The froghemoth's gullet can hold up to two creatures at a time. If the froghemoth takes 20 damage or more on a single turn from a creature inside it, the froghemoth must succeed on a DC 20 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, each of which falls [[6. Mechanics/Rules/conditions.md#prone\|prone]] in a space within 10 feet of the froghemoth. If the froghemoth dies, any swallowed creature is no longer [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] by it and can escape from the corpse using 10 feet of movement, exiting [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Tentacle.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 20 ft., one target. Hit: `dice: 3d8 + 6` (`3d8 + 6`) bludgeoning damage, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 16) if it is a Huge or smaller creature. Until the grapple ends, the froghemoth can't use this tentacle on another target. The froghemoth has four tentacles.
