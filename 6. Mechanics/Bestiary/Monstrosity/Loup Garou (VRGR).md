...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    ...
    \ it must succeed on a DC 17 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
...
Once a loup garou is slain, a [[/6. Mechanics/Spells/remove-curse.md\|remove curse]] spell cast during the night of a full moon on any afflicted werewolf it created forces the target to make a DC 17 Constitution saving throw. On a success, the curse is broken, and the target returns to its normal form and gains 3 levels of exhaustion. On a failure, the curse remains, and the target automatically fails any saving throw made to break this curse for 1 month.

## Stat Block

```ad-statblock
title: Loup Garou
![[/6. Mechanics/Bestiary/Monstrosity/Token/loup-garou.png#token]]
...
***Bite (Dire Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) piercing damage plus `dice: 4d6` (`4d6`) necrotic damage. If the target is a Humanoid, it must succeed on a DC 17 Constitution saving throw or be cursed with loup garou lycanthropy.

***Claws (Dire Wolf or Hybrid Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) slashing damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Longsword (Humanoid Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) slashing damage, or 15 (`dice: 2d10 + 4` (`2d10 + 4`)) slashing damage if used with two hands.
