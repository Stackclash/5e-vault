...
```ad-statblock
title: Basilisk
![[/6. Mechanics/Bestiary/Monstrosity/Token/basilisk.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 3` (`2d6 + 3`) piercing damage plus `dice: 2d6` (`2d6`) poison damage.
```
^statblock
