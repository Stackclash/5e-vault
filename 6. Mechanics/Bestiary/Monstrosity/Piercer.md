...
***Drop.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), one creature directly underneath the piercer. Hit: `dice: 1d6` (`1d6`) piercing damage per 10 feet fallen, up to 21 (`dice: 6d6` (`6d6`)). Miss: The piercer takes half the normal falling damage for the distance fallen.
```
^statblock
