...
![[/6. Mechanics/Bestiary/Monstrosity/Token/kruthik-hive-lord.png#token]]
...
***Stab.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) piercing damage.

***Spike.*** *Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), range 30/120 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) piercing damage.

***Acid Spray (Recharge 5-6).*** The kruthik sprays acid in a 15-foot cone. Each creature in that area must make a DC 14 Dexterity saving throw, taking 22 (`dice: 4d10` (`4d10`)) acid damage on a failed save, or half as much damage on a successful one.
```
^statblock
