...
***Acid Spray (Recharge 5-6).*** The kruthik sprays acid in a 15-foot cone. Each creature in that area must make a DC 14 Dexterity saving throw, taking 22 (`dice: 4d10\|avg` (`4d10`)) acid damage on a failed save, or half as much damage on a successful one.
```
^statblock
