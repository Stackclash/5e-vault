...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the trapper is motionless on a floor, wall, or ceiling at the start\
    ...
    \ 18 Intelligence ([[6. Mechanics/Rules/skills.md#Investigation\|Investigation]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One Large or smaller creature within 10 feet of the trapper must succeed\
    \ on a DC 13 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    ...
    \ start of each of its turns. While [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ in this way, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]],\
    \ [[6. Mechanics/Rules/conditions.md#blinded\|blinded]], and deprived of air. The\
...
***Smother.*** One Large or smaller creature within 10 feet of the trapper must succeed on a DC 13 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 14). Until the grapple ends, the target takes `dice: 3d6 + 3` (`3d6 + 3`) bludgeoning damage plus `dice: 1d6` (`1d6`) acid damage at the start of each of its turns. While [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] in this way, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], [[6. Mechanics/Rules/conditions.md#blinded\|blinded]], and deprived of air. The trapper can smother only one creature at a time.
```
^statblock
