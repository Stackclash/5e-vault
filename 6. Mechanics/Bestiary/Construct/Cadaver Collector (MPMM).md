...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The collector releases paralyzing gas in a 30-foot cone. Each creature\
    \ in that area must make a successful DC 18 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
    \ for 1 minute. A [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] creature\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The collector calls up the enslaved spirits of those it has slain; dice:\
    \ 1d4|avg (1d4) [[/6. Mechanics/Bestiary/Undead/specter.md\|specters]] (without\
...
![[/6. Mechanics/Bestiary/Construct/Token/cadaver-collector.png#token]]
