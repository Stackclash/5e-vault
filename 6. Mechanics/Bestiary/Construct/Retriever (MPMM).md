...
***Foreleg.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 6\|avg` (`2d8 + 6`) slashing damage.

***Force Beam.*** The retriever targets one creature it can see within 60 feet of it. The target must make a DC 16 Dexterity saving throw, taking 27 (`dice: 5d10\|avg` (`5d10`)) force damage on a failed save, or half as much damage on a successful one.
