...
![[/6. Mechanics/Bestiary/Construct/Token/animated-object-huge.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d12 + 4` (`2d12 + 4`) bludgeoning damage.
```
^statblock