...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The screamer emits destructive energy in a 15-foot cube. Each creature\
    ...
    \ (2d6) thunder damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Sonic Scream"
"reactions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
![[/6. Mechanics/Bestiary/Construct/Token/duergar-screamer.png#token]]
...
***Drill.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d12 + 4` (`1d12 + 4`) piercing damage.

***Sonic Scream.*** The screamer emits destructive energy in a 15-foot cube. Each creature in that area must succeed on a DC 11 Strength saving throw or take `dice: 2d6` (`2d6`) thunder damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
