...
***Sonic Scream.*** The screamer emits destructive energy in a 15-foot cube. Each creature in that area must succeed on a DC 11 Strength saving throw or take `dice: 2d6\|avg` (`2d6`) thunder damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
