...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one target.\
    ...
    \ Large or smaller, it is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Slam"
"reactions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
