...
```ad-statblock
title: Monodrone
![[/6. Mechanics/Bestiary/Construct/Token/monodrone.png#token]]
...
***Dagger.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1\|avg` (`1d4 + 1`) piercing damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 1d6\|avg` (`1d6`) piercing damage.
```
^statblock