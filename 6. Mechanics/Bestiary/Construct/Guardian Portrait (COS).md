...
***Antimagic Susceptibility.*** The portrait is [[compendium/rules/conditions.md#incapacitated\|incapacitated]] while in the area of an antimagic field. If targeted by dispel magic, the portrait must succeed on a Constitution saving throw against the caster's spell save DC or become [[compendium/rules/conditions.md#unconscious\|unconscious]] for 1 minute.
