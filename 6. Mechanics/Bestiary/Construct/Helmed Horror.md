...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The helmed horror is immune to three spells chosen by its creator. Typical\
    \ immunities include [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/heat-metal.md\|heat metal]],\
    \ and [[/6. Mechanics/Spells/lightning-bolt.md\|lightning bolt]]."
  "name": "Spell Immunity"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Helmed Horror
![[/6. Mechanics/Bestiary/Construct/Token/helmed-horror.png#token]]
...
***Spell Immunity.*** The helmed horror is immune to three spells chosen by its creator. Typical immunities include [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/heat-metal.md\|heat metal]], and [[/6. Mechanics/Spells/lightning-bolt.md\|lightning bolt]].
