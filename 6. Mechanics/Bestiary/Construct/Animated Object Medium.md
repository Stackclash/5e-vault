...
![[/6. Mechanics/Bestiary/Construct/Token/animated-object-medium.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 1` (`2d6 + 1`) bludgeoning damage.
```
^statblock