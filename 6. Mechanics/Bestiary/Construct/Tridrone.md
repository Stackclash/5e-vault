...
```ad-statblock
title: Tridrone
![[/6. Mechanics/Bestiary/Construct/Token/tridrone.png#token]]
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1` (`1d4 + 1`) bludgeoning damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 1d6 + 1` (`1d6 + 1`) piercing damage.
```
^statblock