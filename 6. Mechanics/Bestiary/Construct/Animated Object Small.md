...
```ad-statblock
title: Animated Object (Small)
![[/6. Mechanics/Bestiary/Construct/Token/animated-object-small.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) bludgeoning damage.
```
^statblock