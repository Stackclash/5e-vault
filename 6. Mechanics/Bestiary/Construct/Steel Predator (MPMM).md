...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The steel predator casts one of the following spells, requiring no spell\
    ...
    \ [[/6. Mechanics/Spells/dimension-door.md\|dimension door]] (self only), [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]\
    \ (self only)"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The steel predator emits a roar in a 60-foot cone. Each creature in that\
    ...
    \ and is [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
    \ creature can repeat the saving throw at the end of each of its turns, ending\
    \ the effect on itself on a success. On a successful save, a creature takes half\
    \ as much damage and isn't [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]."
...
![[/6. Mechanics/Bestiary/Construct/Token/steel-predator.png#token]]
*Large construct, Lawful Neutral*

- **Armor Class** 20 (natural armor)
- **Hit Points** `dice: 18d10 + 108|text(207)` (18d10 + 108) 
- **Speed** walk 40 ft.
...
**3/day each**: [[/6. Mechanics/Spells/dimension-door.md\|dimension door]] (self only), [[/6. Mechanics/Spells/plane-shift.md\|plane shift]] (self only)

## Actions

***Multiattack.*** The steel predator makes one Bite attack and two Claw attacks.

***Bite.*** *Melee Weapon Attack:* `dice: d20+12` (+12 to hit), reach 5 ft., one target. Hit: `dice: 2d10 + 7` (`2d10 + 7`) lightning damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+12` (+12 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 7` (`2d8 + 7`) force damage.

***Stunning Roar (Recharge 5-6).*** The steel predator emits a roar in a 60-foot cone. Each creature in that area must make a DC 19 Constitution saving throw. On a failed save, a creature takes `dice: 6d10` (`6d10`) thunder damage, drops everything it's holding, and is [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. On a successful save, a creature takes half as much damage and isn't [[6. Mechanics/Rules/conditions.md#stunned\|stunned]].
```
^statblock
