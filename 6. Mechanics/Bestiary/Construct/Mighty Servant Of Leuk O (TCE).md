...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+17 (+17 to hit), reach 10 ft., one target.\
    \ Hit: dice: 4d12 + 10|avg (4d12 + 10) force damage. Or Ranged Weapon Attack:\
    \ dice: d20+17 (+17 to hit), range 120 ft., one target. Hit: dice: 4d12 + 10|avg\
    \ (4d12 + 10) force damage. If the target is an object, it takes triple damage."
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ save, a creature takes dice: 4d12|avg (4d12) bludgeoning damage and is knocked\
    \ [[6. Mechanics/Rules/conditions.md#prone\|prone]]. On a successful save, a creature\
    \ takes half as much damage and isn't knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Crushing Leap"
"source":
- "TCE"
...
![[/6. Mechanics/Bestiary/Construct/Token/mighty-servant-of-leuk-o.png#token]]
*Huge construct, Unaligned*

- **Armor Class** 22 (natural armor)
- **Hit Points** `dice: 27d12 + 135|text(310)` (27d12 + 135) 
- **Speed** walk 60 ft.
