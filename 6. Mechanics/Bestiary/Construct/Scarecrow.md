...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 5 ft., one target.\
    ...
    \ it must succeed on a DC 11 Wisdom saving throw or be [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The scarecrow targets one creature it can see within 30 feet of it. If\
    ...
    \ saving throw or be magically [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ until the end of the scarecrow's next turn. The [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ target is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]."
...
```ad-statblock
title: Scarecrow
![[/6. Mechanics/Bestiary/Construct/Token/scarecrow.png#token]]
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1` (`2d4 + 1`) slashing damage. If the target is a creature, it must succeed on a DC 11 Wisdom saving throw or be [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] until the end of the scarecrow's next turn.

***Terrifying Glare.*** The scarecrow targets one creature it can see within 30 feet of it. If the target can see the scarecrow, the target must succeed on a DC 11 Wisdom saving throw or be magically [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] until the end of the scarecrow's next turn. The [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] target is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]].
```
^statblock
