...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the stone cursed is motionless at the start of combat, it has advantage\
    ...
    \ move or act, that creature must succeed on a DC 18 Intelligence ([[6. Mechanics/Rules/skills.md#Investigation\|Investigation]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ stone and is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] until the\
    \ end of its next turn, when it must repeat the saving throw. The effect ends\
    \ if the second save is successful; otherwise the target is [[6. Mechanics/Rules/conditions.md#petrified\|petrified]]\
    \ for 24 hours."
...
Even though a creature transformed into a stone cursed is long dead, a vague whisper of their memories lives on in the obsidian skull embedded within the stone cursed's body. At the end of a short rest, a character can make a DC 20 Intelligence ([[6. Mechanics/Rules/skills.md#Arcana\|Arcana]]) check to attempt to extract a memory from the skull that is a response to a verbal question posed to the skull by the character. Once this check is made, whether it succeeds or fails, the skull can't be used in this manner again.

## Stat Block

```ad-statblock
title: Stone Cursed
![[/6. Mechanics/Bestiary/Construct/Token/stone-cursed.png#token]]
...
***False Appearance.*** If the stone cursed is motionless at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the stone cursed move or act, that creature must succeed on a DC 18 Intelligence ([[6. Mechanics/Rules/skills.md#Investigation\|Investigation]]) check to discern that the stone cursed isn't a statue.

***Unusual Nature.*** The stone cursed doesn't require air, food, drink, or sleep.

## Actions

***Petrifying Claws.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 3` (`2d8 + 3`) slashing damage. If the target is a creature, it must succeed on a DC 12 Constitution saving throw, or it begins to turn to stone and is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] until the end of its next turn, when it must repeat the saving throw. The effect ends if the second save is successful; otherwise the target is [[6. Mechanics/Rules/conditions.md#petrified\|petrified]] for 24 hours.
```
^statblock
