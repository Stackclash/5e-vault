...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the end of its\
...
![[/6. Mechanics/Bestiary/Construct/Token/clockwork-iron-cobra.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) piercing damage. If the target is a creature, it must succeed on a DC 13 Constitution saving throw or suffer one random effect (roll a `dice: d6` (`d6`)):
...
- **3–4 Paralysis.** The target is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the end of its next turn.  
- **5–6 Poison.** The target takes `dice: 3d8` (`3d8`) poison damage.  
```
^statblock
