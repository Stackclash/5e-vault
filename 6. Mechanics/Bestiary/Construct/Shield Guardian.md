...
![[/6. Mechanics/Bestiary/Construct/Token/shield-guardian.png#token]]
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) bludgeoning damage.
