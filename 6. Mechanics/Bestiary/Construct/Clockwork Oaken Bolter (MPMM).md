...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+7 (+7 to hit), range 50/200 ft., one\
    ...
    \ is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 12). While\
    \ [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] in this way, a creature's\
...
"bonus_actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The clockwork pulls the creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
***Lancing Bolt.*** *Melee or Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft. or range 100/400 ft., one target. Hit: `dice: 2d10 + 4` (`2d10 + 4`) piercing damage.

***Harpoon.*** *Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), range 50/200 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) piercing damage, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 12). While [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] in this way, a creature's speed isn't reduced, but it can move only in directions that bring it closer to the clockwork. A creature takes `dice: 1d10` (`1d10`) slashing damage if it escapes from the grapple or if it tries and fails. The clockwork can grapple only one creature at a time with its harpoon.

***Explosive Bolt (Recharge 5-6).*** The clockwork launches an explosive charge at a point within 120 feet. Each creature in a 20-foot-radius sphere centered on that point must make a DC 15 Dexterity saving throw, taking 17 (`dice: 5d6` (`5d6`)) fire damage on a failed save, or half as much damage on a successful one.
