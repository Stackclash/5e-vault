...
***Slam.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 5 ft., one target. Hit: `dice: 3d8 + 7` (`3d8 + 7`) bludgeoning damage.

***Sword.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 10 ft., one target. Hit: `dice: 3d10 + 7` (`3d10 + 7`) slashing damage.

***Poison Breath (Recharge 5-6).*** The golem exhales poisonous gas in a 15-foot cone. Each creature in that area must make a DC 19 Constitution saving throw, taking 45 (`dice: 10d8` (`10d8`)) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock