...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the flind isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 10 ft., one target.\
    \ Hit: dice: 1d10 + 5|avg (1d10 + 5) bludgeoning damage, and the target must\
    \ succeed on a DC 16 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
...
```ad-statblock
title: Flind
![[/6. Mechanics/Bestiary/Fiend/Token/flind.png#token]]
...
***Aura of Blood Thirst.*** If the flind isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]], any creature with the Rampage trait can make a Bite attack as a bonus action while within 10 feet of the flind.
...
***Flail of Chaos.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 5` (`1d10 + 5`) bludgeoning damage, and the target must make a DC 16 Wisdom saving throw. On a failed save, the target must use its reaction, if available, to make one melee attack against a random creature, other than the flind, within its reach. If there's no creature within reach, the target instead moves half its speed in a random direction.

***Flail of Pain.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 5` (`1d10 + 5`) bludgeoning damage plus `dice: 3d10` (`3d10`) psychic damage.

***Flail of Paralysis.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 5` (`1d10 + 5`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the end of its next turn.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage.
```
^statblock
