...
***Fist.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 6\|avg` (`1d10 + 6`) bludgeoning damage, and if the target is a Large or smaller creature, it must succeed on a DC 18 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
...
***Flying Stone.*** The target takes `dice: 5d8\|avg` (`5d8`) bludgeoning damage and is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] until the start of the juggernaut's next turn, and the implement vanishes.
