...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The draegloth casts one of the following spells, requiring no material\
    ...
    \nAt will: [[/6. Mechanics/Spells/dancing-lights.md\|dancing lights]], [[/6. Mechanics/Spells/darkness.md\|darkness]]\n\
    \n1/day each: [[/6. Mechanics/Spells/confusion.md\|confusion]], [[/6. Mechanics/Spells/faerie-fire.md\|faerie fire]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The draegloth has advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]],\
...
A draegloth is a demon created by an elf priest of Lolth in an unholy, dangerous ritual in which it is infused with the fey essence of the creator and the fiendish essence of a [[/6. Mechanics/Bestiary/Fiend/glabrezu.md\|glabrezu]]. This ritual rarely succeeds, but Lolth's faithful consider it worth the risk, as the resulting creature is gifted with innate magic and physical might. The draegloth usually serves its creator, lending its thirst for destruction to the creator's plans to triumph over rivals.
...
```ad-statblock
title: Draegloth
![[/6. Mechanics/Bestiary/Fiend/Token/draegloth.png#token]]
...
***Fey Ancestry.*** The draegloth has advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]], and magic can't put it to sleep.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one creature. Hit: `dice: 2d10 + 5` (`2d10 + 5`) piercing damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 5` (`2d10 + 5`) slashing damage.
```
^statblock
