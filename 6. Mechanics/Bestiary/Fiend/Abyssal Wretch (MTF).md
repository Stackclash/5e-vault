...
![[/6. Mechanics/Bestiary/Fiend/Token/abyssal-wretch.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 1` (`1d8 + 1`) slashing damage.
```
^statblock