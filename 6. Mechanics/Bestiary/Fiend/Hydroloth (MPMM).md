...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hydroloth casts one of the following spells, requiring no material\
    ...
    \ [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]]\
    \ (self only)\n\n3/day each: [[/6. Mechanics/Spells/control-water.md\|control water]],\
    \ [[/6. Mechanics/Spells/crown-of-madness.md\|crown of madness]], [[/6. Mechanics/Spells/fear.md\|fear]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: dice: 2d10 + 5|avg (2d10 + 5) force damage plus dice: 2d10|avg (2d10)\
    \ psychic damage."
  "name": "Bite"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
    ...
    \ the effect on itself on a success. A [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]]\
    \ or [[/6. Mechanics/Spells/remove-curse.md\|remove curse]] spell cast on the target\
...
```ad-statblock
title: Hydroloth
![[/6. Mechanics/Bestiary/Fiend/Token/hydroloth.png#token]]
...
**At will**: [[/6. Mechanics/Spells/darkness.md\|darkness]], [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only)

**3/day each**: [[/6. Mechanics/Spells/control-water.md\|control water]], [[/6. Mechanics/Spells/crown-of-madness.md\|crown of madness]], [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/suggestion.md\|suggestion]]

## Actions

***Multiattack.*** The hydroloth makes two Bite or Claw attacks. It can replace one attack with a use of Spellcasting.

***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d10 + 5` (`2d10 + 5`) force damage plus `dice: 2d10` (`2d10`) psychic damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target.  Hit: `dice: 2d8 + 5` (`2d8 + 5`) force damage plus `dice: 2d10` (`2d10`) psychic damage.

***Steal Memory (1/Day).*** The hydroloth targets one creature it can see within 60 feet of it. The target takes `dice: 4d6` (`4d6`) psychic damage, and it must make a DC 16 Intelligence saving throw. On a successful save, the target becomes immune to this hydroloth's Steal Memory for 24 hours. On a failed save, the target loses all proficiencies; it can't cast spells; it can't understand language; and if its Intelligence and Charisma scores are higher than 5, they become 5. Each time the target finishes a long rest, it can repeat the saving throw, ending the effect on itself on a success. A [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]] or [[/6. Mechanics/Spells/remove-curse.md\|remove curse]] spell cast on the target ends this effect early.
