...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The babau casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/darkness.md\|darkness]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]],\
    \ [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/heat-metal.md\|heat metal]],\
...
```ad-statblock
title: Babau
![[/6. Mechanics/Bestiary/Fiend/Token/babau.png#token]]
...
**At will**: [[/6. Mechanics/Spells/darkness.md\|darkness]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/heat-metal.md\|heat metal]], [[/6. Mechanics/Spells/levitate.md\|levitate]]

## Actions

***Multiattack.*** The babau makes two Claw attacks. It can replace one attack with a use of Spellcasting or Weakening Gaze.

***Claw.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 4` (`1d4 + 4`) slashing damage plus `dice: 1d4` (`1d4`) acid damage.
