...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The demon vomits in a 15-foot cube. Each creature in that area must succeed\
    ...
    \ and fall [[6. Mechanics/Rules/conditions.md#prone\|prone]] in the spew."
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 2` (`2d8 + 2`) piercing damage.

***Disgorge (Recharge 6).*** The demon vomits in a 15-foot cube. Each creature in that area must succeed on a DC 11 Dexterity saving throw or take `dice: 2d10` (`2d10`) acid damage and fall [[6. Mechanics/Rules/conditions.md#prone\|prone]] in the spew.
```
^statblock
