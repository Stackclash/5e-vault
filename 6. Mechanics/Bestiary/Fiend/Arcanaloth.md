...
**1st level (4 1st-level slots)**: detect magic, identify, shield, Tenser's floating disk

**2nd level (3 2nd-level slots)**: detect thoughts, mirror image, phantasmal force, suggestion

**3rd level (3 3rd-level slots)**: counterspell, fear, fireball

**4th level (3 4th-level slots)**: banishment, dimension door

**5th level (2 5th-level slots)**: contact other plane, hold monster

**6th level (1 6th-level slots)**: chain lightning

**7th level (1 7th-level slots)**: finger of death
