...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Scimitar"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The abishai casts [[/6. Mechanics/Spells/darkness.md\|darkness]] at a point\
    \ within 120 feet of it, requiring no spell components or [[6. Mechanics/Rules/status.md#concentration\|concentration]].\
...
- "MPMM"
- "MTF"
"image": "/compendium/bestiary/fiend/token/black-abishai.png"
...
```ad-statblock
title: Black Abishai
![[/6. Mechanics/Bestiary/Fiend/Token/black-abishai.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 3` (`1d10 + 3`) piercing damage plus `dice: 2d8` (`2d8`) acid damage.

***Scimitar.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) force damage.

***Creeping Darkness (Recharge 6).*** The abishai casts [[/6. Mechanics/Spells/darkness.md\|darkness]] at a point within 120 feet of it, requiring no spell components or [[6. Mechanics/Rules/status.md#concentration\|concentration]]. Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.
