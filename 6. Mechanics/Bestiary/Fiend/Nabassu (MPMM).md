...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "A nabassu can eat the soul of a creature it has killed within the last\
    ...
    \ to life only by a [[/6. Mechanics/Spells/wish.md\|wish]] spell."
  "name": "Devour Soul"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The nabassu targets one creature it can see within 30 feet of it. If the\
    ...
    \ [[/6. Mechanics/Bestiary/Undead/ghoul.md\|ghoul]] under the nabassu's control."
...
```ad-statblock
title: Nabassu
![[/6. Mechanics/Bestiary/Fiend/Token/nabassu.png#token]]
*Medium fiend(demon), Chaotic Evil*

- **Armor Class** 18 (natural armor)
- **Hit Points** `dice: 20d8 + 100|text(190)` (20d8 + 100) 
- **Speed** walk 40 ft., fly 60 ft.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 5 ft., one target. Hit: `dice: 5d12 + 6` (`5d12 + 6`) necrotic damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 5 ft., one target. Hit: `dice: 4d10 + 6` (`4d10 + 6`) force damage.

***Soul-Stealing Gaze.*** The nabassu targets one creature it can see within 30 feet of it. If the target isn't a Construct or an Undead, it must succeed on a DC 16 Charisma saving throw or take `dice: 2d12` (`2d12`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage dealt, and the nabassu regains hit points equal to half that amount. This reduction lasts until the target finishes a short or long rest. The target dies if its hit point maximum is reduced to 0, and if the target is a Humanoid, it immediately rises as a [[/6. Mechanics/Bestiary/Undead/ghoul.md\|ghoul]] under the nabassu's control.
```
^statblock
