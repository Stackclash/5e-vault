...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The oinoloth casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/darkness.md\|darkness]], [[/6. Mechanics/Spells/detect-magic.md\|detect magic]],\
    \ [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/hold-monster.md\|hold monster]],\
    \ [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only)\n\n1/day each:\
    \ [[/6. Mechanics/Spells/feeblemind.md\|feeblemind]], [[/6. Mechanics/Spells/globe-of-invulnerability.md\|globe of invulnerability]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
    ...
    \ the target or remove one of the following conditions from it: [[6. Mechanics/Rules/conditions.md#blinded\|blinded]],\
    \ [[6. Mechanics/Rules/conditions.md#deafened\|deafened]], [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]],\
    \ or [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]. The target then gains\
    \ 1 level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]], and its\
    \ hit point maximum is reduced by 7 (dice: 2d6|avg (2d6)). This reduction\
    \ can be removed only by a [[/6. Mechanics/Spells/wish.md\|wish]] spell or by casting\
    \ [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]] on the target\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on itself.\
    ...
    \ damage and is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]. On a successful\
    \ save, the creature is immune to the oinoloth's Bringer of Plagues for the next\
    \ 24 hours.\n\nThe [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature\
    \ can't regain hit points. After every 24 hours that elapse, the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
