...
***Claw (Bite in Beast Form).*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3\|avg` (`1d4 + 3`) piercing damage, and the target must succeed on a DC 10 Constitution saving throw or take `dice: 2d4\|avg` (`2d4`) poison damage and become [[compendium/rules/conditions.md#poisoned\|poisoned]] for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Scare (1/Day).*** One creature of the quasit's choice within 20 feet of it must succeed on a DC 10 Wisdom saving throw or be [[compendium/rules/conditions.md#frightened\|frightened]] for 1 minute. The target can repeat the saving throw at the end of each of its turns, with disadvantage if the quasit is within line of sight, ending the effect on itself on a success.

***Invisibility.*** The quasit magically turns [[compendium/rules/conditions.md#invisible\|invisible]] until it attacks or uses Scare, or until its [[compendium/rules/status.md#concentration\|concentration]] ends (as if [[compendium/rules/status.md#concentration\|concentration]] on a spell). Any equipment the quasit wears or carries is [[compendium/rules/conditions.md#invisible\|invisible]] with it.
```
^statblock