...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The merrenoloth casts one of the following spells, requiring no material\
    ...
    \ 13):\n\nAt will: [[/6. Mechanics/Spells/charm-person.md\|charm person]], [[/6. Mechanics/Spells/darkness.md\|darkness]],\
    \ [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]],\
    \ [[/6. Mechanics/Spells/gust-of-wind.md\|gust of wind]]\n\n3/day: [[/6. Mechanics/Spells/control-water.md\|control water]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The merrenoloth targets one creature it can see within 60 feet of it. The\
    \ target must succeed on a DC 13 Wisdom saving throw or become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ of the merrenoloth for 1 minute. The [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
***Oar.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 3` (`2d4 + 3`) fire damage.
...
- **Repair.** The vessel regains 22 (`dice: 4d10` (`4d10`)) hit points.  
...
If the merrenoloth dies, these effects fade over the course of `dice: 1d6` (`1d6`) hours.
```
^statblock
