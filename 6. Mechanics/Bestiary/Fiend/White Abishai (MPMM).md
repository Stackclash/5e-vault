...
```ad-statblock
title: White Abishai
![[/6. Mechanics/Bestiary/Fiend/Token/white-abishai.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) piercing damage plus `dice: 1d6` (`1d6`) cold damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 3` (`1d10 + 3`) slashing damage.

***Longsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) force damage, or 8 (`dice: 1d10 + 3` (`1d10 + 3`)) force damage if used with two hands.
