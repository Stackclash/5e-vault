...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "At the start of each of the wastrilith's turns, exposed water within 30\
    ...
    \ At the end of this time, the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
    \ creature must repeat the saving throw. On a failure, the creature takes dice:\
    \ 4d8|avg (4d8) poison damage and is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
...
```ad-statblock
title: Wastrilith
![[/6. Mechanics/Bestiary/Fiend/Token/wastrilith.png#token]]
...
A creature that consumes this foul water or swims in it must make a DC 18 Constitution saving throw. On a successful save, the creature is immune to the foul water for 24 hours. On a failed save, the creature takes `dice: 4d6` (`4d6`) poison damage and is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. At the end of this time, the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature must repeat the saving throw. On a failure, the creature takes `dice: 4d8` (`4d8`) poison damage and is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until it finishes a long rest.

If another demon drinks the foul water as an action, it gains 11 (`dice: 2d10` (`2d10`)) temporary hit points.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 4d12 + 4` (`4d12 + 4`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 4d6 + 4` (`4d6 + 4`) slashing damage.

***Grasping Spout.*** The wastrilith magically launches a spout of water at one creature it can see within 60 feet of it. The target must make a DC 17 Strength saving throw, and it has disadvantage if it's underwater. On a failed save, it takes `dice: 4d8 + 4` (`4d8 + 4`) acid damage and is pulled up to 60 feet toward the wastrilith. On a successful save, it takes half as much damage and isn't pulled.
