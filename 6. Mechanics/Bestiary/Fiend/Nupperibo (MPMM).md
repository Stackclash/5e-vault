...
Individually, nupperibos are weak, but they're rarely alone and can be dangerous when gathered into packs. Clouds of stinging insects, [[/6. Mechanics/Bestiary/Beast/Stirge.md\|stirges]], and other vermin surround them in a terrifying, reeking sheath that torments any non-devil that draws near.
...
```ad-statblock
title: Nupperibo
![[/6. Mechanics/Bestiary/Fiend/Token/nupperibo.png#token]]
...
***Cloud of Vermin.*** Any creature, other than a devil, that starts its turn within 20 feet of one or more nupperibos must succeed on a DC 11 Constitution saving throw or take `dice: 2d4\|avg` (`2d4`) acid damage. A creature within the areas of two or more nupperibos makes the saving throw with disadvantage.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3\|avg` (`1d6 + 3`) piercing damage.
```
^statblock