...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hound has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hound exhales fire in a 15-foot cone. Each creature in that area must\
    \ make a DC 12 Dexterity saving throw, taking 21 (dice: 6d6|avg (6d6)) fire\
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) piercing damage plus `dice: 2d6` (`2d6`) fire damage.

***Fire Breath (Recharge 5-6).*** The hound exhales fire in a 15-foot cone. Each creature in that area must make a DC 12 Dexterity saving throw, taking 21 (`dice: 6d6` (`6d6`)) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
