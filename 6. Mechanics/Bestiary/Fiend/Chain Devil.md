...
***Chain.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 2d6 + 4\|avg` (`2d6 + 4`) slashing damage. The target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 14) if the devil isn't already grappling a creature. Until this grapple ends, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] and takes `dice: 2d6\|avg` (`2d6`) piercing damage at the start of each of its turns.
