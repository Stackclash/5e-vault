...
***Pincer.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 5\|avg` (`2d10 + 5`) bludgeoning damage. If the target is a Medium or smaller creature, it is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 15). The glabrezu has two pincers, each of which can grapple only one target.
