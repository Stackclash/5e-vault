...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft., one target.\
    ...
    \ the target is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute.\
    \ The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target can repeat the\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+7 (+7 to hit), range 100/400 ft., one\
    ...
    \ must each make a successful DC 17 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#blinded\|blinded]]\
    ...
    \ a successful DC 17 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]\
    ...
    \ successful DC 17 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
    \ for 1 minute. The [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] target\
...
"bonus_actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The orthon becomes [[6. Mechanics/Rules/conditions.md#invisible\|invisible]].\
    \ Any equipment it wears or carries is also [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]\
...
```ad-statblock
title: Orthon
![[/6. Mechanics/Bestiary/Fiend/Token/orthon.png#token]]
...
***Infernal Dagger.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 6` (`2d4 + 6`) force damage, and the target must make a DC 17 Constitution saving throw, taking 22 (`dice: 4d10` (`4d10`)) poison damage on a failed save, or half as much damage on a successful one. On a failure, the target is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

***Brass Crossbow.*** *Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), range 100/400 ft., one target. Hit: `dice: 2d10 + 3` (`2d10 + 3`) force damage. The target also suffers one of the following effects of the orthon's choice; the orthon can't use the same effect two rounds in a row:

- **Acid.** The target must make a DC 17 Constitution saving throw, taking an additional 17 (`dice: 5d6` (`5d6`)) acid damage on a failed save, or half as much damage on a successful one.  
- **Blindness.** The target takes `dice: 1d10` (`1d10`) radiant damage. In addition, the target and all other creatures within 20 feet of it must each make a successful DC 17 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#blinded\|blinded]] until the end of the orthon's next turn.  
- **Concussion.** The target and each creature within 20 feet of it must make a DC 17 Constitution saving throw, taking 13 (`dice: 2d12` (`2d12`)) thunder damage on a failed save, or half as much damage on a successful one.  
- **Entanglement.** The target must make a successful DC 17 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] for 1 hour by strands of sticky webbing. The target can escape by taking an action to make a DC 17 Strength or Dexterity check and succeeding.  
- **Paralysis.** The target takes `dice: 4d10` (`4d10`) lightning damage and must make a successful DC 17 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
...
***Invisibility Field (Recharge 4-6).*** The orthon becomes [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]. Any equipment it wears or carries is also [[6. Mechanics/Rules/conditions.md#invisible\|invisible]] as long as the equipment is on its person. This invisibility ends immediately after it makes an attack roll or is hit by an attack roll.

## Reactions

***Explosive Retribution.*** In response to dropping to 15 hit points or fewer, the orthon explodes. All other creatures within 30 feet of it must each make a DC 17 Dexterity saving throw, taking 9 (`dice: 2d8` (`2d8`)) fire damage plus `dice: 2d8` (`2d8`) thunder damage on a failed save, or half as much damage on a successful one. The orthon, its infernal dagger, and its brass crossbow are destroyed.
```
^statblock
