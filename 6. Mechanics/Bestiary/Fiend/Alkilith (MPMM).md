...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature that isn't a demon that starts its turn within 30 feet of\
    ...
    \ fails by 5 or more, the creature is instead subjected to the [[/6. Mechanics/Spells/confusion.md\|confusion]]\
    \ spell for 1 minute (no [[6. Mechanics/Rules/status.md#concentration\|concentration]]\
...
```ad-statblock
title: Alkilith
![[/6. Mechanics/Bestiary/Fiend/Token/alkilith.png#token]]
...
***Abyssal Rift.*** If the alkilith surrounds a door, window, or similar opening continuously for `dice: 6d6` (`6d6`) days, the opening becomes a permanent portal to a random layer of the Abyss.

***Amorphous.*** The alkilith can move through a space as narrow as 1 inch wide without squeezing.

***False Appearance.*** If the alkilith is motionless at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the alkilith move or act, that creature must succeed on a DC 18 Intelligence ([[6. Mechanics/Rules/skills.md#Investigation\|Investigation]]) check to discern that the alkilith isn't ordinary slime or fungus.
...
If the saving throw against Foment Confusion fails by 5 or more, the creature is instead subjected to the [[/6. Mechanics/Spells/confusion.md\|confusion]] spell for 1 minute (no [[6. Mechanics/Rules/status.md#concentration\|concentration]] required by the alkilith). While under the effect of that confusion, the creature is immune to Foment Confusion.
...
***Tentacle.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 15 ft., one target. Hit: `dice: 4d6 + 4` (`4d6 + 4`) acid damage.
```
^statblock
