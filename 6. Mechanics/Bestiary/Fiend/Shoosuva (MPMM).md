...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 15 ft., one creature.\
    ...
    \ on a DC 14 Constitution saving throw or become [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]].\
    \ While [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] in this way, the target\
    \ is also [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]. The target can\
...
```ad-statblock
title: Shoosuva
![[/6. Mechanics/Bestiary/Fiend/Token/shoosuva.png#token]]
