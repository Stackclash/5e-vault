...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The abishai casts one of the following spells, requiring no material components\
    ...
    \n1/day each: [[/6. Mechanics/Spells/confusion.md\|confusion]], [[/6. Mechanics/Spells/dominate-person.md\|dominate person]],\
    \ [[/6. Mechanics/Spells/mass-suggestion.md\|mass suggestion]]\n\n3/day each:\
    \ [[/6. Mechanics/Spells/charm-person.md\|charm person]], [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]],\
    \ [[/6. Mechanics/Spells/fear.md\|fear]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one target.\
    ...
    \ (3d10) poison damage and become [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
...
```ad-statblock
title: Green Abishai
![[/6. Mechanics/Bestiary/Fiend/Token/green-abishai.png#token]]
...
**At will**: [[/6. Mechanics/Spells/alter-self.md\|alter self]], [[/6. Mechanics/Spells/major-image.md\|major image]]

**1/day each**: [[/6. Mechanics/Spells/confusion.md\|confusion]], [[/6. Mechanics/Spells/dominate-person.md\|dominate person]], [[/6. Mechanics/Spells/mass-suggestion.md\|mass suggestion]]

**3/day each**: [[/6. Mechanics/Spells/charm-person.md\|charm person]], [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/fear.md\|fear]]

## Actions

***Multiattack.*** The abishai makes two Fiendish Claw attacks, or it makes one Fiendish Claw attack and uses Spellcasting.

***Fiendish Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 3` (`2d8 + 3`) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or take `dice: 3d10` (`3d10`) poison damage and become [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
