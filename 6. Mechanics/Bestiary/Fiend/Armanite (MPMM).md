...
```ad-statblock
title: Armanite
![[/6. Mechanics/Bestiary/Fiend/Token/armanite.png#token]]
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 5` (`2d4 + 5`) slashing damage plus `dice: 2d8` (`2d8`) lightning damage.

***Hooves.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 5` (`2d6 + 5`) bludgeoning damage. If the target is a Large or smaller creature, it must succeed on a DC 16 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Serrated Tail.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 5` (`2d10 + 5`) slashing damage.

***Lightning Lance (Recharge 5-6).*** The armanite looses a bolt of lightning in a line that is 60 feet long and 10 feet wide. Each creature in the line must make a DC 15 Dexterity saving throw, taking 36 (`dice: 8d8` (`8d8`)) lightning damage on a failed save, or half as much damage on a successful one.
```
^statblock
