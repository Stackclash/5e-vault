...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Magical darkness doesn't impede the merregon's [[6. Mechanics/Rules/senses.md#darkvision\|darkvision]]."
  "name": "Devil's Sight"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Merregon
![[/6. Mechanics/Bestiary/Fiend/Token/merregon.png#token]]
...
***Devil's Sight.*** Magical darkness doesn't impede the merregon's [[6. Mechanics/Rules/senses.md#darkvision\|darkvision]].
...
***Halberd.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) slashing damage.

***Heavy Crossbow.*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 100/400 ft., one target. Hit: `dice: 1d10 + 2` (`1d10 + 2`) piercing damage.
