...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The sibriex casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/command.md\|command]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The sibriex targets up to three creatures it can see within 120 feet of\
    ...
    \ save, the target is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]], which\
    \ causes it to also gain 1 level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]].\
    ...
    \ [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]] caused by it. Each failed\
    \ save causes the target to gain another level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]].\
    \ Once the target reaches 6 levels of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]],\
    \ it dies and instantly transforms into a living [[/6. Mechanics/Bestiary/Fiend/Manes.md\|manes]]\
    \ under the sibriex's control. The transformation of the body can be undone only\
    \ by a [[/6. Mechanics/Spells/wish.md\|wish]] spell."
  "name": "Warp Creature"
"legendary_actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
***Contamination.*** The sibriex emits an aura of corruption 30 feet in every direction. Vegetation withers in the aura, and the ground in the aura is difficult terrain for other creatures. Any creature that starts its turn in the aura must succeed on a DC 20 Constitution saving throw or take `dice: 4d6` (`4d6`) poison damage. A creature that succeeds on the save is immune to this sibriex's Contamination for 24 hours.
...
***Chain.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 15 ft., one target. Hit: `dice: 2d12 + 7` (`2d12 + 7`) force damage.

***Squirt Bile.*** The sibriex targets one creature it can see within 120 feet of it. The target must succeed on a DC 20 Dexterity saving throw or take `dice: 9d6` (`9d6`) acid damage.
