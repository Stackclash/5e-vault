...
***Beaks.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target in the swarm's space. Hit: `dice: 2d6` (`2d6`) piercing damage, or 3 (`dice: 1d6` (`1d6`)) piercing damage if the swarm has half of its hit points or fewer.
```
^statblock
