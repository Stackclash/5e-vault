...
```ad-statblock
title: Eagle
![[/6. Mechanics/Bestiary/Beast/Token/eagle.png#token]]
...
***Talons.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2` (`1d4 + 2`) slashing damage.
```
^statblock
