...
```ad-statblock
title: Swarm of Bats
![[/6. Mechanics/Bestiary/Beast/Token/swarm-of-bats.png#token]]
...
***Echolocation.*** The swarm can't use its blindsight while [[6. Mechanics/Rules/conditions.md#deafened\|deafened]].

***Keen Hearing.*** The swarm has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing.
