...
***Bites.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 0 ft., one creature in the swarm's space. Hit: `dice: 2d4` (`2d4`) piercing damage, or 2 (`dice: 1d4` (`1d4`)) piercing damage if the swarm has half of its hit points or fewer.
```
^statblock
