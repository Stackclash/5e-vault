...
***Stomp.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one [[6. Mechanics/Rules/conditions.md#prone\|prone]] creature. Hit: `dice: 3d10 + 6\|avg` (`3d10 + 6`) bludgeoning damage.
```
^statblock
