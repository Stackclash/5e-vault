...
```ad-statblock
title: Giant Vulture
![[/6. Mechanics/Bestiary/Beast/Token/giant-vulture.png#token]]
...
***Keen Sight and Smell.*** The vulture has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on sight or smell.

***Pack Tactics.*** The vulture has advantage on an attack roll against a creature if at least one of the vulture's allies is within 5 feet of the creature and the ally isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].
...
***Talons.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2` (`2d6 + 2`) slashing damage.
```
^statblock
