...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 0 ft., one target\
    ...
    \ but [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 hour, even after\
    \ regaining hit points, and [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
...
![[/6. Mechanics/Bestiary/Beast/Token/swarm-of-centipedes.png#token]]
...
A creature reduced to 0 hit points by a swarm of centipedes is stable but [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 hour, even after regaining hit points, and [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] while [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] in this way.
```
^statblock
