...
```ad-statblock
title: Cow
![[/6. Mechanics/Bestiary/Beast/Token/cow.png#token]]
...
***Charge.*** If the cow moves at least 20 feet straight toward a target and then hits it with a gore attack on the same turn, the target takes an extra 7 (`dice: 2d6` (`2d6`)) piercing damage.
