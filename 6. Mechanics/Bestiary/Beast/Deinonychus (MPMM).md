...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the deinonychus moves at least 20 feet straight toward a creature and\
    ...
    \ a DC 12 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].\
    \ If the target is [[6. Mechanics/Rules/conditions.md#prone\|prone]], the deinonychus\
...
```ad-statblock
title: Deinonychus
![[/6. Mechanics/Bestiary/Beast/Token/deinonychus.png#token]]
