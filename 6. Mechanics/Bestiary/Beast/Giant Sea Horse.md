...
![[/6. Mechanics/Bestiary/Beast/Token/giant-sea-horse.png#token]]
...
***Charge.*** If the sea horse moves at least 20 feet straight toward a target and then hits it with a ram attack on the same turn, the target takes an extra 7 (`dice: 2d6` (`2d6`)) bludgeoning damage. If the target is a creature, it must succeed on a DC 11 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Water Breathing.*** The sea horse can breathe only underwater.

## Actions

***Ram.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 1` (`1d6 + 1`) bludgeoning damage.
```
^statblock
