...
***Tail.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 4d6 + 4\|avg` (`4d6 + 4`) bludgeoning damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
