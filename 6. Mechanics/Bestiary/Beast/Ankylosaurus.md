...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 10 ft., one target.\
    ...
    \ creature, it must succeed on a DC 14 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Tail"
"source":
- "MM"
- "ToA"
...
```ad-statblock
title: Ankylosaurus
![[/6. Mechanics/Bestiary/Beast/Token/ankylosaurus.png#token]]
*Huge beast, Unaligned*

- **Armor Class** 15 (natural armor)
- **Hit Points** `dice: 8d12 + 16|text(68)` (8d12 + 16) 
- **Speed** walk 30 ft.
...
***Tail.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 4d6 + 4` (`4d6 + 4`) bludgeoning damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
