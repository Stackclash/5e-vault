...
```ad-statblock
title: Pteranodon
![[/6. Mechanics/Bestiary/Beast/Token/pteranodon.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1` (`2d4 + 1`) piercing damage
```
^statblock
