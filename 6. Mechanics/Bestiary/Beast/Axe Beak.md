...
```ad-statblock
title: Axe Beak
![[/6. Mechanics/Bestiary/Beast/Token/axe-beak.png#token]]
...
***Beak.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) slashing damage.
```
^statblock
