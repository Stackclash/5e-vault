...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+5 (+5 to hit), range 30/60 ft., one\
    \ creature. Hit: The target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]\
...
```ad-statblock
title: Giant Spider
![[/6. Mechanics/Bestiary/Beast/Token/giant-spider.png#token]]
