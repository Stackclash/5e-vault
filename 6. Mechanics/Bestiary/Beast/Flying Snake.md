...
```ad-statblock
title: Flying Snake
![[/6. Mechanics/Bestiary/Beast/Token/flying-snake.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: 1 piercing damage plus `dice: 3d4` (`3d4`) poison damage.
```
^statblock
