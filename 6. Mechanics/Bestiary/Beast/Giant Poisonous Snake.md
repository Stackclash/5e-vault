...
![[/6. Mechanics/Bestiary/Beast/Token/giant-poisonous-snake.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 1d4 + 4` (`1d4 + 4`) piercing damage, and the target must make a DC 11 Constitution saving throw, taking 10 (`dice: 3d6` (`3d6`)) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
