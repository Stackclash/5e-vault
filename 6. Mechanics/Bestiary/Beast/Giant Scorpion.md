...
![[/6. Mechanics/Bestiary/Beast/Token/giant-scorpion.png#token]]
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) bludgeoning damage, and the target is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 12). The scorpion has two claws, each of which can grapple only one target.

***Sting.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 1d10 + 2` (`1d10 + 2`) piercing damage, and the target must make a DC 12 Constitution saving throw, taking 22 (`dice: 4d10` (`4d10`)) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
