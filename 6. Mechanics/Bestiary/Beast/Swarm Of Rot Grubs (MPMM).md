...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+0 (+0 to hit), reach 0 ft., one creature\
    ...
    \ target must succeed on a DC 10 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]].\
    \ At the end of each of the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
    \ target's turns, the target takes dice: 1d6|avg (1d6) poison damage. Whenever\
    \ the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target takes fire damage,\
    \ the target can repeat the saving throw, ending the effect on itself on a success.\
    \ If the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target ends its turn\
...
Any creature that comes into contact with a single rot grub must succeed on a DC 10 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]], as the rot grub burrows into the creature. The [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature takes `dice: 1d6` (`1d6`) poison damage at the end of each of its turns. Whenever the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature takes fire damage, the creature can repeat the saving throw, ending the effect on itself on a success. If the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature ends its turn with 0 hit points, it dies, as the rot grub kills it.

## Stat Block

```ad-statblock
title: Swarm of Rot Grubs
![[/6. Mechanics/Bestiary/Beast/Token/swarm-of-rot-grubs.png#token]]
...
***Bites.*** *Melee Weapon Attack:* `dice: d20+0` (+0 to hit), reach 0 ft., one creature in the swarm's space. Hit: `dice: 2d6` (`2d6`) piercing damage, and the target must succeed on a DC 10 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]. At the end of each of the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target's turns, the target takes `dice: 1d6` (`1d6`) poison damage. Whenever the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target takes fire damage, the target can repeat the saving throw, ending the effect on itself on a success. If the [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] target ends its turn with 0 hit points, it dies.
```
^statblock
