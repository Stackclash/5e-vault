...
![[/6. Mechanics/Bestiary/Beast/Token/quetzalcoatlus.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 10 ft., one creature. Hit: `dice: 3d6 + 2` (`3d6 + 2`) piercing damage. If the quetzalcoatlus flew least 30 feet toward the target immediately before the hit, the target takes an extra 10 (`dice: 3d6` (`3d6`)) piercing damage.
```
^statblock
