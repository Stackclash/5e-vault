...
```ad-statblock
title: Stegosaurus
![[/6. Mechanics/Bestiary/Beast/Token/stegosaurus.png#token]]
...
***Tail.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 6d6 + 5` (`6d6 + 5`) piercing damage.
```
^statblock
