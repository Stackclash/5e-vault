...
```ad-statblock
title: Elk
![[/6. Mechanics/Bestiary/Beast/Token/elk.png#token]]
...
***Charge.*** If the elk moves at least 20 feet straight toward a target and then hits it with a ram attack on the same turn, the target takes an extra 7 (`dice: 2d6` (`2d6`)) damage. If the target is a creature, it must succeed on a DC 13 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

## Actions

***Ram.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) bludgeoning damage.

***Hooves.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one [[6. Mechanics/Rules/conditions.md#prone\|prone]] creature. Hit: `dice: 2d4 + 3` (`2d4 + 3`) bludgeoning damage.
```
^statblock
