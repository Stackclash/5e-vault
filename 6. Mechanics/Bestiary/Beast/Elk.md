...
***Hooves.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one [[6. Mechanics/Rules/conditions.md#prone\|prone]] creature. Hit: `dice: 2d4 + 3\|avg` (`2d4 + 3`) bludgeoning damage.
```
^statblock
