...
```ad-statblock
title: Plesiosaurus
![[/6. Mechanics/Bestiary/Beast/Token/plesiosaurus.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 10 ft., one target. Hit: `dice: 3d6 + 4` (`3d6 + 4`) piercing damage.
```
^statblock
