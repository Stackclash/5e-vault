...
```ad-statblock
title: Giant Ape
![[/6. Mechanics/Bestiary/Beast/Token/giant-ape.png#token]]
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 3d10 + 6` (`3d10 + 6`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+9` (+9 to hit), range 50/100 ft., one target. Hit: `dice: 7d6 + 6` (`7d6 + 6`) bludgeoning damage.
```
^statblock
