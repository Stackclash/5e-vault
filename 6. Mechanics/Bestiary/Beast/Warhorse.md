...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the horse moves at least 20 feet straight toward a creature and then\
    ...
    \ DC 14 Strength saving throw or be knocked [[6. Mechanics/Rules/Conditions.md#prone|prone]].\
    \ If the target is [[6. Mechanics/Rules/Conditions.md#prone|prone]], the horse can\
...
- "CRCotN"
- "DSotDQ"
"image": "6. Mechanics/Bestiary/Beast/token/warhorse.png"
```
^statblock
