...
```ad-statblock
title: Pony
![[/6. Mechanics/Bestiary/Beast/Token/pony.png#token]]
...
***Hooves.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 2` (`2d4 + 2`) bludgeoning damage.
```
^statblock
