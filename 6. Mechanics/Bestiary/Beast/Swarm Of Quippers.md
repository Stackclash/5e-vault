...
![[/6. Mechanics/Bestiary/Beast/Token/swarm-of-quippers.png#token]]
...
***Bites.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 0 ft., one creature in the swarm's space. Hit: `dice: 4d6` (`4d6`) piercing damage, or 7 (`dice: 2d6` (`2d6`)) piercing damage if the swarm has half of its hit points or fewer.
```
^statblock
