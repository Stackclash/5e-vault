...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The leviathan magically creates a wave of water that extends from a point\
    ...
    \ (7d12) bludgeoning damage and is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].\
    \ On a successful save, a creature takes half as much damage and isn't knocked\
    \ [[6. Mechanics/Rules/conditions.md#prone\|prone]]. The water spreads out across\
...
```ad-statblock
title: Leviathan
![[/6. Mechanics/Bestiary/Elemental/Token/leviathan.png#token]]
*Gargantuan elemental, Neutral*

- **Armor Class** 17 
- **Hit Points** `dice: 16d20 + 160|text(328)` (16d20 + 160) 
- **Speed** walk 40 ft., swim 120 ft.
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 20 ft., one target. Hit: `dice: 2d12 + 8` (`2d12 + 8`) bludgeoning damage plus `dice: 2d12` (`2d12`) acid damage.

***Tail.*** *Melee Weapon Attack:* `dice: d20+14` (+14 to hit), reach 20 ft., one target. Hit: `dice: 2d10 + 8` (`2d10 + 8`) bludgeoning damage plus `dice: 3d6` (`3d6`) acid damage.

***Tidal Wave (Recharge 6).*** The leviathan magically creates a wave of water that extends from a point it can see within 120 feet of itself. The wave is up to 250 feet long, up to 250 feet tall, and up to 50 feet wide. Each creature in the wave must make a DC 24 Strength saving throw. On a failed save, a creature takes `dice: 7d12` (`7d12`) bludgeoning damage and is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]. On a successful save, a creature takes half as much damage and isn't knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]. The water spreads out across the ground in all directions, extinguishing unprotected flames in its area and within 250 feet of it, and then it vanishes.
