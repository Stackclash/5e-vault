...
If the snail succeeds on its saving throw against a spell or a spell's attack roll misses it, the snail's shell converts some of the spell's energy into a burst of destructive force if the spell is of 1st level or higher; each creature within 30 feet of the snail must make a DC 15 Constitution saving throw, taking 3 (`dice: 1d6\|avg` (`1d6`)) force damage per level of the spell on a failed save, or half as much damage on a successful one.

## Actions

***Multiattack.*** The snail makes five Flail Tentacle attacks.

***Flail Tentacle.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 10 ft., one target. Hit: `dice: 1d4 + 3\|avg` (`1d4 + 3`) bludgeoning damage.
