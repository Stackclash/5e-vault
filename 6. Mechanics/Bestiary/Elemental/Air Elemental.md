...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Each creature in the elemental's space must make a DC 13 Strength saving\
    ...
    \ and knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]. If a thrown target\
    ...
    \ and isn't flung away or knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
...
```ad-statblock
title: Air Elemental
![[/6. Mechanics/Bestiary/Elemental/Token/air-elemental.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 5` (`2d8 + 5`) bludgeoning damage.

***Whirlwind (Recharge 4-6).*** Each creature in the elemental's space must make a DC 13 Strength saving throw. On a failure, a target takes `dice: 3d8 + 2` (`3d8 + 2`) bludgeoning damage and is flung up 20 feet away from the elemental in a random direction and knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]. If a thrown target strikes an object, such as a wall or floor, the target takes `dice: 1d6` (`1d6`) bludgeoning damage for every 10 feet it was thrown. If the target is thrown at another creature, that creature must succeed on a DC 13 Dexterity saving throw or take the same damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

If the saving throw is successful, the target takes half the bludgeoning damage and isn't flung away or knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
