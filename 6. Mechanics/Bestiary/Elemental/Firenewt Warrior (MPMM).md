...
- "MPMM"
- "VGM"
"image": "/compendium/bestiary/elemental/token/firenewt-warrior.png"
...
![[/6. Mechanics/Bestiary/Elemental/Token/firenewt-warrior.png#token]]
*Medium elemental, Neutral*

- **Armor Class** 13 ([[/6. Mechanics/Items/shield.md\|shield]])
...
***Spit Fire (Recharges after a Short or Long Rest).*** The firenewt spits fire at a creature within 10 feet of it. The creature must make a DC 11 Dexterity saving throw, taking 9 (`dice: 2d8` (`2d8`)) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock
