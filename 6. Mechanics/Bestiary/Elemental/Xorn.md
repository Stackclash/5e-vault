...
```ad-statblock
title: Xorn
![[/6. Mechanics/Bestiary/Elemental/Token/xorn.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 3d6 + 3` (`3d6 + 3`) piercing damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) slashing damage.
```
^statblock
