...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The stalker is [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]."
  "name": "Invisibility"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
![[/6. Mechanics/Bestiary/Elemental/Token/invisible-stalker.png#token]]
...
***Invisibility.*** The stalker is [[6. Mechanics/Rules/conditions.md#invisible\|invisible]].
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 3` (`2d6 + 3`) bludgeoning damage.
```
^statblock
