...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The myrmidon makes one Flail attack. On a hit, the target takes an extra\
    ...
    \ a DC 13 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
...
***Flail.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) force damage.

***Lightning Strike (Recharge 6).*** The myrmidon makes one Flail attack. On a hit, the target takes an extra 18 (`dice: 4d8` (`4d8`)) lightning damage, and the target must succeed on a DC 13 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] until the end of the myrmidon's next turn.
```
^statblock