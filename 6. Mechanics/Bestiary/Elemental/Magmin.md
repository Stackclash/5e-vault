...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When the magmin dies, it explodes in a burst of fire and magma. Each creature\
    \ within 10 feet of it must make a DC 11 Dexterity saving throw, taking 7 (dice:\
    \ 2d6|avg (2d6)) fire damage on a failed save, or half as much damage on a\
    \ successful one. Flammable objects that aren't being worn or carried in that\
    \ area are ignited."
  "name": "Death Burst"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    \ Hit: dice: 2d6|avg (2d6) fire damage. If the target is a creature or a flammable\
    \ object, it ignites. Until a creature takes an action to douse the fire, the\
    \ target takes dice: 1d6|avg (1d6) fire damage at the end of each of its turns."
  "name": "Touch"
"source":
- "MM"
- "PotA"
...
```ad-statblock
title: Magmin
![[/6. Mechanics/Bestiary/Elemental/Token/magmin.png#token]]
...
***Death Burst.*** When the magmin dies, it explodes in a burst of fire and magma. Each creature within 10 feet of it must make a DC 11 Dexterity saving throw, taking 7 (`dice: 2d6` (`2d6`)) fire damage on a failed save, or half as much damage on a successful one. Flammable objects that aren't being worn or carried in that area are ignited.

***Ignited Illumination.*** As a bonus action, the magmin can set itself ablaze or extinguish its flames. While ablaze, the magmin sheds bright light in a 10-foot radius and dim light for an additional 10 feet.

## Actions

***Touch.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6` (`2d6`) fire damage. If the target is a creature or a flammable object, it ignites. Until a creature takes an action to douse the fire, the target takes `dice: 1d6` (`1d6`) fire damage at the end of each of its turns.
```
^statblock