...
![[/6. Mechanics/Bestiary/Elemental/Token/earth-elemental.png#token]]
*Large elemental, Neutral*

- **Armor Class** 17 (natural armor)
- **Hit Points** `dice: 12d10 + 60|text(126)` (12d10 + 60) 
- **Speed** walk 30 ft., burrow 30 ft.
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 5` (`2d8 + 5`) bludgeoning damage.
```
^statblock
