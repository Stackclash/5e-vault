...
***Revitalize (Costs 2 Actions).*** The zaratan can use this option only if it is retracted in its shell. It regains 52 (`dice: 5d20` (`5d20`)) hit points. The next time it takes a legendary action, it must take its Emerge action.
