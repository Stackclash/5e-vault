...
***Heated Body.*** A creature that touches the azer or hits it with a melee attack while within 5 feet of it takes `dice: 1d10` (`1d10`) fire damage.

***Heated Weapons.*** When the azer hits with a metal melee weapon, it deals an extra 3 (`dice: 1d6` (`1d6`)) fire damage (included in the attack).

***Illumination.*** The azer sheds bright light in a 10-foot radius and dim light for an additional 10 feet.

## Actions

***Warhammer.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) bludgeoning damage, or 8 (`dice: 1d10 + 3` (`1d10 + 3`)) bludgeoning damage if used with two hands to make a melee attack, plus `dice: 1d6` (`1d6`) fire damage.
```
^statblock