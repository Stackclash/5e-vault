...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the galeb duhr rolls at least 20 feet straight toward a target and then\
    ...
    \ on a DC 16 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Rolling Charge"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The galeb duhr magically animates up to two boulders it can see within\
    ...
    \ has Intelligence 1 and Charisma 1, it can't be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
    \ or [[6. Mechanics/Rules/conditions.md#frightened\|frightened]], and it lacks this\
    \ action option. A boulder remains animated as long as the galeb duhr maintains\
    \ [[6. Mechanics/Rules/status.md#concentration\|concentration]], up to 1 minute (as\
    \ if [[6. Mechanics/Rules/status.md#concentration\|concentration]] on a spell)."
...
```ad-statblock
title: Galeb Duhr
![[/6. Mechanics/Bestiary/Elemental/Token/galeb-duhr.png#token]]
...
***Rolling Charge.*** If the galeb duhr rolls at least 20 feet straight toward a target and then hits it with a slam attack on the same turn, the target takes an extra 7 (`dice: 2d6` (`2d6`)) bludgeoning damage. If the target is a creature, it must succeed on a DC 16 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].

## Actions

***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 5` (`2d6 + 5`) bludgeoning damage.

***Animate Boulders (1/Day).*** The galeb duhr magically animates up to two boulders it can see within 60 feet of it. A boulder has statistics like those of a galeb duhr, except it has Intelligence 1 and Charisma 1, it can't be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] or [[6. Mechanics/Rules/conditions.md#frightened\|frightened]], and it lacks this action option. A boulder remains animated as long as the galeb duhr maintains [[6. Mechanics/Rules/status.md#concentration\|concentration]], up to 1 minute (as if [[6. Mechanics/Rules/status.md#concentration\|concentration]] on a spell).
```
^statblock
