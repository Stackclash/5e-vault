...
![[/6. Mechanics/Bestiary/Humanoid/Token/gnoll-pack-lord.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one creature. Hit: `dice: 1d4 + 3` (`1d4 + 3`) piercing damage.

***Glaive.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 10 ft., one target. Hit: `dice: 1d10 + 3` (`1d10 + 3`) slashing damage.
