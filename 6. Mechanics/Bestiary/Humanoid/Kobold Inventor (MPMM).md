...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The kobold uses one of the following options (choose one or roll a dice:\
    ...
    - 1 Acid. The kobold hurls a [[/6. Mechanics/Items/acid-vial.md\|flask of acid]].\
    ...
    \ throws a [[/6. Mechanics/Items/alchemists-fire-flask.md\|flask of alchemist's fire]].\
    \ Ranged Weapon Attack: dice: d20+4 (+4 to hit), range 5/20 ft., one target.\
    ...
    \ within 20 feet of it, and it breaks open on impact. A [[/6. Mechanics/Bestiary/Beast/Swarm Of Rot Grubs (MPMM).md\|swarm of rot grubs]]\
    \ (in this book) emerges from the shattered pot and remains a hazard in that square.\
    \  \n- 6 Scorpion on a Stick. The kobold makes a melee attack with a [[/6. Mechanics/Bestiary/Beast/Scorpion.md\|scorpion]]\
    ...
    \ must succeed on a DC 9 Constitution saving throw, or it retches and is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
    ...
    \ bag into a 5-foot-square space within 20 feet of it. A [[/6. Mechanics/Bestiary/Beast/Swarm Of Wasps.md\|swarm of insects (wasps)]]\
...
***Weapon Invention.*** The kobold uses one of the following options (choose one or roll a `dice: d8` (`d8`)); the kobold can use each one no more than once per day:

- **1 Acid.** The kobold hurls a [[/6. Mechanics/Items/acid-vial.md\|flask of acid]]. *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 5/20 ft., one target. Hit: `dice: 2d6` (`2d6`) acid damage.  
- **2 Alchemist's Fire.** The kobold throws a [[/6. Mechanics/Items/alchemists-fire-flask.md\|flask of alchemist's fire]]. *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 5/20 ft., one target. Hit: `dice: 1d4` (`1d4`) fire damage at the start of each of the target's turns. The target can end this damage by using its action to make a DC 10 Dexterity check to extinguish the flames.  
...
- **4 Green Slime Pot.** The kobold throws a clay pot full of green slime at the target, and it breaks open on impact. *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 5/20 ft., one target. Hit: `dice: 1d10` (`1d10`) acid damage, and the target is covered in slime until a creature uses its action to scrape or wash the slime off. A target covered in the slime takes `dice: 1d10` (`1d10`) acid damage at the start of each of its turns.  
