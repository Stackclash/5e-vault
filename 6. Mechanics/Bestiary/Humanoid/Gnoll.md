...
```ad-statblock
title: Gnoll
![[/6. Mechanics/Bestiary/Humanoid/Token/gnoll.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 1d4 + 2` (`1d4 + 2`) piercing damage.
