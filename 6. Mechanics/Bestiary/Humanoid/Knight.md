...
***Brave.*** The knight has advantage on saving throws against being [[compendium/rules/conditions.md#frightened\|frightened]].
...
***Leadership (Recharges after a Short or Long Rest).*** For 1 minute, the knight can utter a special command or warning whenever a nonhostile creature that it can see within 30 feet of it makes an attack roll or a saving throw. The creature can add a `dice: d4\|avg` (`d4`) to its roll provided it can hear and understand the knight. A creature can benefit from only one Leadership die at a time. This effect ends if the knight is [[compendium/rules/conditions.md#incapacitated\|incapacitated]].
