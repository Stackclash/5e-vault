...
***Brave.*** The gladiator has advantage on saving throws against being [[compendium/rules/conditions.md#frightened\|frightened]].
...
***Shield Bash.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one creature. Hit: `dice: 2d4 + 4\|avg` (`2d4 + 4`) bludgeoning damage. If the target is a Medium or smaller creature, it must succeed on a DC 15 Strength saving throw or be knocked [[compendium/rules/conditions.md#prone\|prone]].
