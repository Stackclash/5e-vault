...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The githzerai casts one of the following spells, requiring no spell components\
    ...
    \ each: [[/6. Mechanics/Spells/globe-of-invulnerability.md\|globe of invulnerability]],\
    \ [[/6. Mechanics/Spells/plane-shift.md\|plane shift]], [[/6. Mechanics/Spells/wall-of-force.md\|wall of force]]\n\
    \n3/day each: [[/6. Mechanics/Spells/see-invisibility.md\|see invisibility]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Teleport"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The githzerai casts the [[/6. Mechanics/Spells/reverse-gravity.md\|reverse gravity]]\
...
![[/6. Mechanics/Bestiary/Humanoid/Token/githzerai-anarch.png#token]]
...
**1/day each**: [[/6. Mechanics/Spells/globe-of-invulnerability.md\|globe of invulnerability]], [[/6. Mechanics/Spells/plane-shift.md\|plane shift]], [[/6. Mechanics/Spells/wall-of-force.md\|wall of force]]

**3/day each**: [[/6. Mechanics/Spells/see-invisibility.md\|see invisibility]], [[/6. Mechanics/Spells/telekinesis.md\|telekinesis]]

## Actions

***Multiattack.*** The githzerai makes three Unarmed Strike attacks.

***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 5` (`1d8 + 5`) bludgeoning damage plus `dice: 4d8` (`4d8`) psychic damage.
...
***Change Gravity (Costs 3 Actions).*** The githzerai casts the [[/6. Mechanics/Spells/reverse-gravity.md\|reverse gravity]] spell, using Wisdom as the spellcasting ability. The spell has the normal effect, except that the githzerai can orient the area in any direction and creatures and objects fall toward the end of the area.
...
If the anarch dies, these effects end after `dice: 1d6` (`1d6`) rounds. All formed substance becomes a chaotic churn of energy and matter, unraveling into unformed substance that dissipates `dice: 1d6` (`1d6`) rounds later.
```
^statblock