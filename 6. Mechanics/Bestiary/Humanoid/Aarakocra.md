...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
    ...
    \ dance and must maintain [[6. Mechanics/Rules/status.md#concentration\|concentration]]\
    \ while doing so (as if [[6. Mechanics/Rules/status.md#concentration\|concentration]]\
...
***Dive Attack.*** If the aarakocra is flying and dives at least 30 feet straight toward a target and then hits it with a melee weapon attack, the attack deals an extra 3 (`dice: 1d6` (`1d6`)) damage to the target.

## Actions

***Talon.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2` (`1d4 + 2`) slashing damage.
