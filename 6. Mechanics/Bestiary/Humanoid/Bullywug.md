...
```ad-statblock
title: Bullywug
![[/6. Mechanics/Bestiary/Humanoid/Token/bullywug.png#token]]
*Medium humanoid(bullywug), Neutral Evil*

- **Armor Class** 15 ([[/6. Mechanics/Items/hide-armor.md\|hide armor]], [[/6. Mechanics/Items/shield.md\|shield]])
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 1\|avg` (`1d4 + 1`) bludgeoning damage.
