...
The half-dragon gains [[6. Mechanics/Rules/senses.md#blindsight\|blindsight]] with a radius of 10 feet and [[6. Mechanics/Rules/senses.md#darkvision\|darkvision]] with a radius of 60 feet.
...
Here the half-dragon template has been applied to a human [[/6. Mechanics/Bestiary/Humanoid/veteran.md\|veteran]] to create a half-red dragon veteran. [[/6. Mechanics/Items/splint-armor.md\|Splint armor]] has been replaced with [[/6. Mechanics/Items/plate-armor.md\|plate]].

## Stat Block

```ad-statblock
title: Half-Red Dragon Veteran
![[/6. Mechanics/Bestiary/Humanoid/Token/half-red-dragon-veteran.png#token]]
...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3\|avg` (`1d8 + 3`) slashing damage, or 8 (`dice: 1d10 + 3\|avg` (`1d10 + 3`)) slashing damage if used with two hands.
...
***Fire Breath (Recharge 5-6).*** The veteran exhales fire in a 15-foot cone. Each creature in that area must make a DC 15 Dexterity saving throw, taking 24 (`dice: 7d6\|avg` (`7d6`)) fire damage on a failed save, or half as much damage on a successful one.
```
^statblock