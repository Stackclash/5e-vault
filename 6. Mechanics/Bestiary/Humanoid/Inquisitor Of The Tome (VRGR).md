...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The inquisitor casts one of the following spells, requiring no components\
    ...
    \ will: [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]],\
    \ [[/6. Mechanics/Spells/levitate.md\|levitate]], [[/6. Mechanics/Spells/mage-armor.md\|mage armor]],\
    \ [[/6. Mechanics/Spells/mage-hand.md\|mage hand]], [[/6. Mechanics/Spells/sending.md\|sending]]\n\
    \n1/day each: [[/6. Mechanics/Spells/otilukes-resilient-sphere.md\|Otiluke's resilient sphere]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Each creature in a 20-foot-radius sphere centered on a point the inquisitor\
    ...
    \ or take dice: 6d8 + 4|avg (6d8 + 4) force damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]\
...
![[/6. Mechanics/Bestiary/Humanoid/Token/inquisitor-of-the-tome.png#token]]
...
**At will**: [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], [[/6. Mechanics/Spells/levitate.md\|levitate]], [[/6. Mechanics/Spells/mage-armor.md\|mage armor]], [[/6. Mechanics/Spells/mage-hand.md\|mage hand]], [[/6. Mechanics/Spells/sending.md\|sending]]

**1/day each**: [[/6. Mechanics/Spells/otilukes-resilient-sphere.md\|Otiluke's resilient sphere]], [[/6. Mechanics/Spells/telekinesis.md\|telekinesis]]

## Actions

***Multiattack.*** The inquisitor attacks twice.

***Force Bolt.*** *Ranged Spell Attack:* `dice: d20+7` (+7 to hit), range 120 ft., one target. Hit: `dice: 4d8 + 4` (`4d8 + 4`) force damage, and if the target is a Large or smaller creature, the inquisitor can push it up to 10 feet away.
...
***Implode (Recharge 4-6).*** Each creature in a 20-foot-radius sphere centered on a point the inquisitor can see within 120 feet of it must succeed on a DC 15 Constitution saving throw or take `dice: 6d8 + 4` (`6d8 + 4`) force damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]] and moved to the unoccupied space closest to the sphere's center. Large and smaller objects that aren't being worn or carried in the sphere automatically take the damage and are similarly moved.
