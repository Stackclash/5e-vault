...
***Force Bolt.*** *Ranged Spell Attack:* `dice: d20+7` (+7 to hit), range 120 ft., one target. Hit: `dice: 4d8 + 4\|avg` (`4d8 + 4`) force damage, and if the target is a Large or smaller creature, the inquisitor can push it up to 10 feet away.

***Silver Longsword.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4\|avg` (`1d8 + 4`) slashing damage, or 9 (`dice: 1d10 + 4\|avg` (`1d10 + 4`)) if used with two hands, plus `dice: 4d8\|avg` (`4d8`) force damage.
