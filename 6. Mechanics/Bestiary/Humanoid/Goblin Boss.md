...
- "WBtW"
- "KftGV"
"image": "/compendium/bestiary/humanoid/token/goblin-boss.png"
aliases: ["Goblin Boss"]
---
# Goblin Boss
...
```ad-statblock
title: Goblin Boss
![[/6. Mechanics/Bestiary/Humanoid/Token/goblin-boss.png#token]]
...
***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 1d6` (`1d6`) piercing damage.
