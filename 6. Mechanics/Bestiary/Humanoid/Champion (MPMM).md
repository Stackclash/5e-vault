...
```ad-statblock
title: Champion
![[/6. Mechanics/Bestiary/Humanoid/Token/champion.png#token]]
*Medium humanoid, Any alignment*

- **Armor Class** 18 ([[/6. Mechanics/Items/plate-armor.md\|plate]])
- **Hit Points** `dice: 22d8 + 44|text(143)` (22d8 + 44) 
- **Speed** walk 30 ft.
...
***Greatsword.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 5` (`2d6 + 5`) slashing damage, plus `dice: 2d6` (`2d6`) slashing damage if the champion has more than half of its total hit points remaining.

***Shortbow.*** *Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), range 80/320 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage, plus `dice: 2d6` (`2d6`) piercing damage if the champion has more than half of its total hit points remaining.
