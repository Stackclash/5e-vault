...
```ad-statblock
title: Archer
![[/6. Mechanics/Bestiary/Humanoid/Token/archer.png#token]]
...
***Shortsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) piercing damage.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) piercing damage.

## Bonus Actions

***Archer's Eye (3/Day).*** Immediately after making an attack roll or a damage roll with a ranged weapon, the archer can roll a `dice: d10` (`d10`) and add the number rolled to the total.
```
^statblock
