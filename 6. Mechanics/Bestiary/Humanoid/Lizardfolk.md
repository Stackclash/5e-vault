...
```ad-statblock
title: Lizardfolk
![[/6. Mechanics/Bestiary/Humanoid/Token/lizardfolk.png#token]]
*Medium humanoid(lizardfolk), Neutral*

- **Armor Class** 15 (natural armor, [[/6. Mechanics/Items/shield.md\|shield]])
...
***Heavy Club.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) bludgeoning damage.
...
***Spiked Shield.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage.
```
^statblock
