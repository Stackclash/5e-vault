...
```ad-statblock
title: Winged Kobold
![[/6. Mechanics/Bestiary/Humanoid/Token/winged-kobold.png#token]]
...
***Dropped Rock.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), one target directly below the kobold. Hit: `dice: 1d6 + 3` (`1d6 + 3`) bludgeoning damage.
```
^statblock
