...
***Quarterstaff.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit) (`dice: d20+4` (+4 to hit) with shillelagh), reach 5 ft., one target. Hit: `dice: 1d6\|avg` (`1d6`) bludgeoning damage, 4 (`dice: 1d8\|avg` (`1d8`)) bludgeoning damage if wielded with two hands, or 6 (`dice: 1d8 + 2\|avg` (`1d8 + 2`)) bludgeoning damage with [[/6. Mechanics/Spells/shillelagh.md\|shillelagh]].
```
^statblock
