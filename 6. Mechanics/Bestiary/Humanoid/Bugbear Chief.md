...
```ad-statblock
title: Bugbear Chief
![[/6. Mechanics/Bestiary/Humanoid/Token/bugbear-chief.png#token]]
*Medium humanoid(goblinoid), Chaotic Evil*

- **Armor Class** 17 ([[/6. Mechanics/Items/chain-shirt.md\|chain shirt]], [[/6. Mechanics/Items/shield.md\|shield]])
...
***Heart of Hruggek.*** The bugbear has advantage on saving throws against being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]], [[6. Mechanics/Rules/conditions.md#frightened\|frightened]], [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]], [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]], [[6. Mechanics/Rules/conditions.md#stunned\|stunned]], or put to sleep.

## Actions

***Multiattack.*** The bugbear makes two melee attacks.

***Morningstar.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 3` (`2d8 + 3`) piercing damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 2d6 + 3` (`2d6 + 3`) piercing damage in melee or 5 (`dice: 1d6 + 3` (`1d6 + 3`)) piercing damage at range.
```
^statblock
