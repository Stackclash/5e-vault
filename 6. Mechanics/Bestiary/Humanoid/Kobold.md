...
```ad-statblock
title: Kobold
![[/6. Mechanics/Bestiary/Humanoid/Token/kobold.png#token]]
...
***Dagger.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2` (`1d4 + 2`) piercing damage.
