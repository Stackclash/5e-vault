...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The shadar-kai casts one of the following spells, requiring no material\
    ...
    \ 16):\n\n1/day each: [[/6. Mechanics/Spells/bestow-curse.md\|bestow curse]],\
    \ [[/6. Mechanics/Spells/finger-of-death.md\|finger of death]], [[/6. Mechanics/Spells/gaseous-form.md\|gaseous form]],\
    \ [[/6. Mechanics/Spells/seeming.md\|seeming]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The shadar-kai emits weariness in a 60-foot cube. Each creature in that\
    ...
    \ takes dice: 10d8|avg (10d8) psychic damage and suffers 1 level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]].\
    \ On a successful save, it takes half as much damage and doesn't gain a level\
    \ of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]]."
...
![[/6. Mechanics/Bestiary/Humanoid/Token/shadar-kai-soul-monger.png#token]]
*Medium humanoid(elf), Neutral Evil*

- **Armor Class** 15 ([[/6. Mechanics/Items/studded-leather-armor.md\|studded leather]])
- **Hit Points** `dice: 21d8 + 42|text(136)` (21d8 + 42) 
- **Speed** walk 30 ft.
...
**1/day each**: [[/6. Mechanics/Spells/bestow-curse.md\|bestow curse]], [[/6. Mechanics/Spells/finger-of-death.md\|finger of death]], [[/6. Mechanics/Spells/gaseous-form.md\|gaseous form]], [[/6. Mechanics/Spells/seeming.md\|seeming]]

## Actions

***Multiattack.*** The shadar-kai makes two Shadow Dagger attacks.

***Shadow Dagger.*** *Melee or Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 4d4 + 3` (`4d4 + 3`) piercing damage plus `dice: 3d12` (`3d12`) necrotic damage, and the target has disadvantage on saving throws until the end of the shadar-kai's next turn. Hit or Miss: The dagger magically returns to the shadar-kai's hand immediately after a ranged attack.

***Wave of Weariness (Recharge 4-6).*** The shadar-kai emits weariness in a 60-foot cube. Each creature in that area must make a DC 16 Constitution saving throw. On a failed save, a creature takes `dice: 10d8` (`10d8`) psychic damage and suffers 1 level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]]. On a successful save, it takes half as much damage and doesn't gain a level of [[6. Mechanics/Rules/conditions.md#exhaustion\|exhaustion]].
```
^statblock
