...
***Martial Advantage.*** Once per turn, the hobgoblin can deal an extra 14 (`dice: 4d6\|avg` (`4d6`)) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the hobgoblin that isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].
...
***Shield Bash.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one creature. Hit: `dice: 1d4 + 3\|avg` (`1d4 + 3`) bludgeoning damage. If the target is Large or smaller, it must succeed on a DC 14 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
