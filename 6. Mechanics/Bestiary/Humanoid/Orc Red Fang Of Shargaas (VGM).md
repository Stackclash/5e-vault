...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Dart"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The orc casts [[/6. Mechanics/Spells/darkness.md\|darkness]] without any components.\
...
![[/6. Mechanics/Bestiary/Humanoid/Token/orc-red-fang-of-shargaas.png#token]]
...
***Scimitar.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 3d6 + 3` (`3d6 + 3`) slashing damage.

***Dart.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 20/60 ft., one target. Hit: `dice: 3d4 + 3` (`3d4 + 3`) piercing damage.

***Veil of Shargaas (Recharges after a Short or Long Rest).*** The orc casts [[/6. Mechanics/Spells/darkness.md\|darkness]] without any components. Wisdom is its spellcasting ability.
```
^statblock
