...
***Scimitar.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 3d6 + 3\|avg` (`3d6 + 3`) slashing damage.

***Dart.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 20/60 ft., one target. Hit: `dice: 3d4 + 3\|avg` (`3d4 + 3`) piercing damage.
