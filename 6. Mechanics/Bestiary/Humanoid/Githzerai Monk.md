...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
    ...
    \ (the hand is invisible)\n\n3/day each: [[/6. Mechanics/Spells/feather-fall.md\|feather fall]],\
    \ [[/6. Mechanics/Spells/jump.md\|jump]], [[/6. Mechanics/Spells/see-invisibility.md\|see invisibility]],\
...
![[/6. Mechanics/Bestiary/Humanoid/Token/githzerai-monk.png#token]]
...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) bludgeoning damage plus `dice: 2d8` (`2d8`) psychic damage. This is a magic weapon attack.
```
^statblock