...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 2\|avg` (`1d8 + 2`) bludgeoning damage plus `dice: 2d8\|avg` (`2d8`) psychic damage. This is a magic weapon attack.
```
^statblock