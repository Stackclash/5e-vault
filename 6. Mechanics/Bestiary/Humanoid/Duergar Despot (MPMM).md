...
***Stomping Foot.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 5\|avg` (`1d10 + 5`) bludgeoning damage, or 21 (`dice: 3d10 + 5\|avg` (`3d10 + 5`)) to a [[6. Mechanics/Rules/conditions.md#prone\|prone]] target.
