...
***Spiked Bone Club.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3\|avg` (`1d4 + 3`) bludgeoning damage plus `dice: 1d4\|avg` (`1d4`) piercing damage.
```
^statblock
