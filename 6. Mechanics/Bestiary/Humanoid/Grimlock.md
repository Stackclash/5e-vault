...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The grimlock can't use its blindsight while [[6. Mechanics/Rules/conditions.md#deafened\|deafened]]\
    \ and unable to smell."
  "name": "Blind Senses"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The grimlock has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
```ad-statblock
title: Grimlock
![[/6. Mechanics/Bestiary/Humanoid/Token/grimlock.png#token]]
...
***Blind Senses.*** The grimlock can't use its blindsight while [[6. Mechanics/Rules/conditions.md#deafened\|deafened]] and unable to smell.

***Keen Hearing and Smell.*** The grimlock has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing or smell.

***Stone Camouflage.*** The grimlock has advantage on Dexterity (Stealth) checks made to hide in rocky terrain.

## Actions

***Spiked Bone Club.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) bludgeoning damage plus `dice: 1d4` (`1d4`) piercing damage.
```
^statblock
