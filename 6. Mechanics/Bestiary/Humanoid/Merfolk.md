...
***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 1d6` (`1d6`) piercing damage, or 4 (`dice: 1d8` (`1d8`)) piercing damage if used with two hands to make a melee attack.
```
^statblock
