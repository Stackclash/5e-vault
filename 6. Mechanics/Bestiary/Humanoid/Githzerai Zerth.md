...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
    ...
    \ (the hand is invisible)\n\n1/day each: [[/6. Mechanics/Spells/phantasmal-killer.md\|phantasmal killer]],\
    \ [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]\n\n3/day each: [feather\
    \ fall](/compendium/spells/feather-fall.md), [[/6. Mechanics/Spells/jump.md\|jump]],\
    \ [[/6. Mechanics/Spells/see-invisibility.md\|see invisibility]], [[/6. Mechanics/Spells/shield.md\|shield]]"
  "name": "innate"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
Githzerai revere Zerthimon, the founder of their race. Although Gith won their people's freedom, Zerthimon saw her as unfit to lead. He believed that her warmongering would soon make her a tyrant no better than the [[/6. Mechanics/Bestiary/Aberration/Mind Flayer.md\|mind flayers]].
...
![[/6. Mechanics/Bestiary/Humanoid/Token/githzerai-zerth.png#token]]
*Medium humanoid(gith), Lawful Neutral*

- **Armor Class** 17 
- **Hit Points** `dice: 13d8 + 26|text(84)` (13d8 + 26) 
- **Speed** walk 30 ft.
...
**1/day each**: [[/6. Mechanics/Spells/phantasmal-killer.md\|phantasmal killer]], [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]

**3/day each**: [[/6. Mechanics/Spells/feather-fall.md\|feather fall]], [[/6. Mechanics/Spells/jump.md\|jump]], [[/6. Mechanics/Spells/see-invisibility.md\|see invisibility]], [[/6. Mechanics/Spells/shield.md\|shield]]

## Actions

***Multiattack.*** The githzerai makes two unarmed strikes.

***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) bludgeoning damage plus `dice: 3d8` (`3d8`) psychic damage. This is a magic weapon attack.
```
^statblock