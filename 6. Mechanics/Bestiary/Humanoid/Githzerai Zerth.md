...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4\|avg` (`2d6 + 4`) bludgeoning damage plus `dice: 3d8\|avg` (`3d8`) psychic damage. This is a magic weapon attack.
```
^statblock