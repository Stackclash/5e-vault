...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The illusionist casts one of the following spells, using Intelligence as\
    ...
    \ [[/6. Mechanics/Spells/mage-armor.md\|mage armor]], [[/6. Mechanics/Spells/major-image.md\|major image]],\
    \ [[/6. Mechanics/Spells/phantasmal-force.md\|phantasmal force]], [[/6. Mechanics/Spells/phantom-steed.md\|phantom steed]]"
  "name": "spells"
"actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The illusionist projects an illusion that makes the illusionist appear\
    ...
    \ is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]], or if its\
    \ speed becomes 0."
...
![[/6. Mechanics/Bestiary/Humanoid/Token/illusionist-wizard.png#token]]
...
**At will**: [[/6. Mechanics/Spells/dancing-lights.md\|dancing lights]], [[/6. Mechanics/Spells/mage-hand.md\|mage hand]], [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]]

**2/day each**: [[/6. Mechanics/Spells/disguise-self.md\|disguise self]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]], [[/6. Mechanics/Spells/mage-armor.md\|mage armor]], [[/6. Mechanics/Spells/major-image.md\|major image]], [[/6. Mechanics/Spells/phantasmal-force.md\|phantasmal force]], [[/6. Mechanics/Spells/phantom-steed.md\|phantom steed]]

## Actions

***Multiattack.*** The illusionist makes two Arcane Burst attacks.

***Arcane Burst.*** *Melee or Ranged Spell Attack:* `dice: d20+5` (+5 to hit), reach 5 ft. or range 120 ft., one target. Hit: `dice: 2d10 + 3` (`2d10 + 3`) psychic damage.

## Bonus Actions

***Displacement (Recharge 5-6).*** The illusionist projects an illusion that makes the illusionist appear to be standing in a place a few inches from its actual location, causing any creature to have disadvantage on attack rolls against the illusionist. The effect lasts for 1 minute, and it ends early if the illusionist takes damage, if it is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]], or if its speed becomes 0.
```
^statblock
