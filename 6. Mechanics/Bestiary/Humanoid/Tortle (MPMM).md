...
```ad-statblock
title: Tortle
![[/6. Mechanics/Bestiary/Humanoid/Token/tortle.png#token]]
...
***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) piercing damage, or 6 (`dice: 1d8 + 2` (`1d8 + 2`)) piercing damage if used with two hands in melee.

***Light Crossbow.*** *Ranged Weapon Attack:* `dice: d20+2` (+2 to hit), range 80/320 ft., one target. Hit: `dice: 1d8` (`1d8`) piercing damage.
