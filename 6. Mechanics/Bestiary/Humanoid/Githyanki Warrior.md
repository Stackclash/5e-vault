...
![[/6. Mechanics/Bestiary/Humanoid/Token/githyanki-warrior.png#token]]
*Medium humanoid(gith), Lawful Evil*

- **Armor Class** 17 ([[/6. Mechanics/Items/half-plate-armor.md\|half plate armor]])
- **Hit Points** `dice: 9d8 + 9|text(49)` (9d8 + 9) 
- **Speed** walk 30 ft.
...
**3/day each**: [[/6. Mechanics/Spells/jump.md\|jump]], [[/6. Mechanics/Spells/misty-step.md\|misty step]], [[/6. Mechanics/Spells/nondetection.md\|nondetection]] (self only)

## Actions

***Multiattack.*** The githyanki makes two greatsword attacks.

***Greatsword.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2` (`2d6 + 2`) slashing damage plus `dice: 2d6` (`2d6`) psychic damage.
```
^statblock