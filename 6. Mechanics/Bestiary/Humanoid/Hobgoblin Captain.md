...
***Martial Advantage.*** Once per turn, the hobgoblin can deal an extra 10 (`dice: 3d6\|avg` (`3d6`)) damage to a creature it hits with a weapon attack if that creature is within 5 feet of an ally of the hobgoblin that isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].
