...
![[/6. Mechanics/Bestiary/Humanoid/Token/sahuagin-baron.png#token]]
*Large humanoid(sahuagin), Lawful Evil*

- **Armor Class** 16 ([[/6. Mechanics/Items/breastplate.md\|breastplate]])
- **Hit Points** `dice: 9d10 + 27|text(76)` (9d10 + 27) 
- **Speed** walk 30 ft., swim 50 ft.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 4` (`2d4 + 4`) piercing damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) slashing damage.

***Trident.*** *Melee or Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage, or 13 (`dice: 2d8 + 4` (`2d8 + 4`)) piercing damage if used with two hands to make a melee attack.
```
^statblock
