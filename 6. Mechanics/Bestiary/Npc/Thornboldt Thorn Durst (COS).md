...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One humanoid that Thorn can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
    ...
    \ out by an effect like the [[/6. Mechanics/Spells/dispel-evil-and-good.md\|dispel evil and good]]\
...
![[/6. Mechanics/Bestiary/Npc/Token/thornboldt-thorn-durst.png#token]]
...
***Incorporeal Movement.*** Thorn can move through other creatures and objects as if they were difficult terrain. It takes `dice: 1d10` (`1d10`) force damage if it ends its turn inside an object.
