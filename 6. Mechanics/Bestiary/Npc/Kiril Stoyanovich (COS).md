...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shapechanger"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Kiril has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
![[/6. Mechanics/Bestiary/Npc/Token/kiril-stoyanovich.png#token]]
*Medium humanoid(human, shapechanger), Chaotic Evil*

- **Armor Class** 11 (12 from natural armor in wolf or hybrid form)
- **Hit Points** `dice: 9d8 + 18|text(90)` (9d8 + 18) 
- **Speed** walk 30 ft. (40 ft. in wolf form)
...
***Keen Hearing and Smell.*** Kiril has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing or smell.
