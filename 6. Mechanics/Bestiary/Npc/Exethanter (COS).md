...
```ad-statblock
title: Exethanter
![[/6. Mechanics/Bestiary/Npc/Token/exethanter.png#token]]
...
***Disrupt Life (Costs 3 Actions).*** Each non-undead creature within 20 feet of Exethanter must make a DC 18 Constitution saving throw against this magic, taking 21 (`dice: 6d6` (`6d6`)) necrotic damage on a failed save, or half as much damage on a successful one.
