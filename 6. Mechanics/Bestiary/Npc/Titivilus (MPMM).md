...
***Silver Sword.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4\|avg` (`1d8 + 4`) force damage, or 9 (`dice: 1d10 + 4\|avg` (`1d10 + 4`)) force damage if used with two hands, plus `dice: 3d10\|avg` (`3d10`) necrotic damage. If the target is a creature, its hit point maximum is reduced by an amount equal to half the necrotic damage taken.
