...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Titivilus casts one of the following spells, requiring no material components\
    ...
    \ [[/6. Mechanics/Spells/alter-self.md\|alter self]], [[/6. Mechanics/Spells/major-image.md\|major image]],\
    \ [[/6. Mechanics/Spells/nondetection.md\|nondetection]], [[/6. Mechanics/Spells/sending.md\|sending]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Titivilus targets one creature he can see within 10 feet of him. The target\
    \ must succeed on a DC 21 Wisdom saving throw or become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ of him for 1 minute. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Titivilus targets one creature he can see within 60 feet of him. The target\
    \ must succeed on a DC 21 Charisma saving throw or become [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
    \ by Titivilus for 1 minute. The [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
"legendary_actions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Titivilus uses Twisting Words. Alternatively, he targets one creature [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
    \ by him that is within 60 feet of him; that [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
```ad-statblock
title: Titivilus
![[/6. Mechanics/Bestiary/Npc/Token/titivilus.png#token]]
*Medium fiend(devil), Lawful Evil*

- **Armor Class** 20 (natural armor)
- **Hit Points** `dice: 20d8 + 60|text(150)` (20d8 + 60) 
- **Speed** walk 40 ft., fly 60 ft.
...
**At will**: [[/6. Mechanics/Spells/alter-self.md\|alter self]], [[/6. Mechanics/Spells/major-image.md\|major image]], [[/6. Mechanics/Spells/nondetection.md\|nondetection]], [[/6. Mechanics/Spells/sending.md\|sending]], [[/6. Mechanics/Spells/suggestion.md\|suggestion]]

**3/day each**: [[/6. Mechanics/Spells/mislead.md\|mislead]], [[/6. Mechanics/Spells/modify-memory.md\|modify memory]]

## Actions

***Multiattack.*** Titivilus makes one Silver Sword attack, and he uses Frightful Word.

***Silver Sword.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) force damage, or 9 (`dice: 1d10 + 4` (`1d10 + 4`)) force damage if used with two hands, plus `dice: 3d10` (`3d10`) necrotic damage. If the target is a creature, its hit point maximum is reduced by an amount equal to half the necrotic damage taken.

***Frightful Word.*** Titivilus targets one creature he can see within 10 feet of him. The target must succeed on a DC 21 Wisdom saving throw or become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] of him for 1 minute. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] in this way, the target must take the Dash action and move away from Titivilus by the safest available route on each of its turns, unless there is nowhere to move, in which case it needn't take the Dash action. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
***Twisting Words.*** Titivilus targets one creature he can see within 60 feet of him. The target must succeed on a DC 21 Charisma saving throw or become [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by Titivilus for 1 minute. The [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] target can repeat the saving throw if Titivilus deals any damage to it. A creature that succeeds on the saving throw is immune to Titivilus's Twisting Words for 24 hours.

## Legendary Actions

***Corrupting Guidance.*** Titivilus uses Twisting Words. Alternatively, he targets one creature [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by him that is within 60 feet of him; that [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] target must succeed on a DC 21 Charisma saving throw, or Titivilus decides how the target acts during its next turn.
