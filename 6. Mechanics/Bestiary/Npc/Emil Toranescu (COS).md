...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shapechanger"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Emil has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
![[/6. Mechanics/Bestiary/Npc/Token/emil-toranescu.png#token]]
...
***Keen Hearing and Smell.*** Emil has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing or smell.
