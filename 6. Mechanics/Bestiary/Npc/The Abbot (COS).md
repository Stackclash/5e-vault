...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The Abbot's spellcasting ability is Charisma (spell save DC 17). The Abbot\
    ...
    \n1/day each: [[/6. Mechanics/Spells/commune.md\|commune]], [[/6. Mechanics/Spells/raise-dead.md\|raise dead]]"
  "name": "innate"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: The Abbot
![[/6. Mechanics/Bestiary/Npc/Token/the-abbot.png#token]]
...
***Angelic Weapons.*** The Abbot's weapon attacks are magical. When The Abbot hits with any weapon, the weapon deals an extra `dice: 4d8` (`4d8`) radiant damage (included in the attack).
...
***Mace.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) bludgeoning damage plus `dice: 4d8` (`4d8`) radiant damage.

***Healing Touch (3/Day).*** The Abbot touches another creature. The target magically regains 20 (`dice: 4d8 + 2` (`4d8 + 2`)) hit points and is freed from any curse, disease, poison, blindness, or deafness.
