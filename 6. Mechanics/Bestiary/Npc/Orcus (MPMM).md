...
***Wand Spellcasting.*** While holding the [[/6. Mechanics/Items/wand-of-orcus.md\|Wand of Orcus]], Orcus casts one of the following spells (spell save DC 18), some of which require charges; the wand has 7 charges to fuel these spells, and it regains `dice: 1d4 + 3` (`1d4 + 3`) charges daily at dawn:
...
***Wand of Orcus.*** *Melee Weapon Attack:* `dice: d20+19` (+19 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 11` (`3d8 + 11`) bludgeoning damage plus `dice: 2d12` (`2d12`) necrotic damage.

***Tail.*** *Melee Weapon Attack:* `dice: d20+16` (+16 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 8` (`3d8 + 8`) force damage plus `dice: 2d8` (`2d8`) poison damage.

***Necrotic Bolt.*** *Ranged Spell Attack:* `dice: d20+15` (+15 to hit), range 120 ft., one target. Hit: `dice: 5d8 + 7` (`5d8 + 7`) necrotic damage.
...
If Orcus dies, these effects fade over the course of `dice: 1d10` (`1d10`) days.
```
^statblock