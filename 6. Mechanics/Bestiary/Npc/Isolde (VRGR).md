...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Isolde's spellcasting ability is Charisma (spell save DC 14). Isolde can\
    ...
    \ [[/6. Mechanics/Spells/alter-self.md\|alter self]], [[/6. Mechanics/Spells/command.md\|command]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+10 (+10 to hit), reach 5 ft.., one target.\
    \ Hit: dice: 1d8 + 7|avg (1d8 + 7) slashing damage, or 12 (dice: 1d10 + 7|avg\
    \ (1d10 + 7)) slashing damage if used with two hands to make a melee attack.\
    \ If the target is a fiend or an undead, it takes an extra 11 (dice: 2d10|avg\
    \ (2d10)) radiant damage."
  "name": "Nepenthe"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One humanoid Isolde can see within 30 feet of it must succeed on a DC 14\
    \ Wisdom saving throw or be magically [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
"source":
- "VRGR"
"image": "/compendium/bestiary/npc/token/isolde.png"
aliases: ["Isolde"]
---
# Isolde
...
***Nepenthe.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft.., one target. Hit: `dice: 1d8 + 7` (`1d8 + 7`) slashing damage, or 12 (`dice: 1d10 + 7` (`1d10 + 7`)) slashing damage if used with two hands to make a melee attack. If the target is a fiend or an undead, it takes an extra 11 (`dice: 2d10` (`2d10`)) radiant damage.
