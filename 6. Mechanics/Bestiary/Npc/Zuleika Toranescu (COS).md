...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Shapechanger"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Zuleika has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
---
# Zuleika Toranescu
*Source: Curse of Strahd p. 204, Derived from Werewolf (MM)*  

```ad-statblock
title: Zuleika Toranescu
![[/6. Mechanics/Bestiary/Npc/Token/zuleika-toranescu.png#token]]
...
***Keen Hearing and Smell.*** Zuleika has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on hearing or smell.
