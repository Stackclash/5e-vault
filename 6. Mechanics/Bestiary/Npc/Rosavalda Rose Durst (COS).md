...
![[/6. Mechanics/Bestiary/Npc/Token/rosavalda-rose-durst.png#token]]
...
***Incorporeal Movement.*** Rose can move through other creatures and objects as if they were difficult terrain. It takes `dice: 1d10` (`1d10`) force damage if it ends its turn inside an object.
