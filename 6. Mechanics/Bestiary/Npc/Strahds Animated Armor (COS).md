...
***Greatsword.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 3` (`2d6 + 3`) slashing damage plus `dice: 1d6` (`1d6`) lightning damage.

***Shocking Bolt.*** *Ranged Spell Attack:* `dice: d20+4` (+4 to hit) (with advantage on the attack roll if the target is wearing armor made of metal), range 60 ft., one target. Hit: `dice: 3d6` (`3d6`) lightning damage.
```
^statblock