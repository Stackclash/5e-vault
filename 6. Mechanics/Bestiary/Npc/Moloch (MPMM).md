...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Moloch casts one of the following spells, requiring no material components\
    ...
    \ his appearance), [[/6. Mechanics/Spells/confusion.md\|confusion]], [[/6. Mechanics/Spells/detect-magic.md\|detect magic]],\
    \ [[/6. Mechanics/Spells/fly.md\|fly]], [[/6. Mechanics/Spells/major-image.md\|major image]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Moloch exhales in a 30-foot cube. Each creature in that area must succeed\
    ...
    \ drop whatever it is holding, and become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
    \ of Moloch for 1 minute. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]]\
...
```ad-statblock
title: Moloch
![[/6. Mechanics/Bestiary/Npc/Token/moloch.png#token]]
*Large fiend(devil), Lawful Evil*

- **Armor Class** 19 (natural armor)
- **Hit Points** `dice: 22d10 + 132|text(253)` (22d10 + 132) 
- **Speed** walk 30 ft.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 5 ft., one target. Hit: `dice: 4d8 + 8` (`4d8 + 8`) fire damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 8` (`2d8 + 8`) force damage.

***Many-Tailed Whip.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 30 ft., one target. Hit: `dice: 2d4 + 8` (`2d4 + 8`) lightning damage plus `dice: 2d10` (`2d10`) thunder damage. If the target is a creature, it must succeed on a DC 24 Strength saving throw or be pulled up to 30 feet in a straight line toward Moloch.

***Breath of Despair (Recharge 5-6).*** Moloch exhales in a 30-foot cube. Each creature in that area must succeed on a DC 21 Wisdom saving throw or take `dice: 5d10` (`5d10`) psychic damage, drop whatever it is holding, and become [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] of Moloch for 1 minute. While [[6. Mechanics/Rules/conditions.md#frightened\|frightened]] in this way, a creature must take the Dash action and move away from Moloch by the safest available route on each of its turns, unless there is nowhere to move, in which case it needn't take the Dash action. If the creature ends its turn in a location where it doesn't have line of sight to Moloch, the creature can repeat the saving throw, ending the effect on itself on a success.
