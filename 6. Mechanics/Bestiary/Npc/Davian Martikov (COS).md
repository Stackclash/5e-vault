...
"source":
- "CoS"
"image": "/compendium/bestiary/npc/token/davian-martikov.png"
aliases: ["Davian Martikov"]
---
# Davian Martikov
*Source: Curse of Strahd p. 173, Derived from Wereraven (VRGR)*  

```ad-statblock
title: Davian Martikov
![[/6. Mechanics/Bestiary/Npc/Token/davian-martikov.png#token]]
...
***Regeneration.*** Davian regains 10 hit points at the start of its turn. If Davian takes damage from a silvered weapon or a spell, this trait doesn't function at the start of Davian's next turn. Davian dies only if it starts its turn with 0 hit points and doesn't regenerate.
