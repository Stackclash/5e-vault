...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Majesto magically turns [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]\
    ...
    \ Any equipment Majesto wears or carries is [[6. Mechanics/Rules/conditions.md#invisible\|invisible]]\
    \ with it."
  "name": "Invisibility"
"source":
- "CoS"
...
```ad-statblock
title: Majesto
![[/6. Mechanics/Bestiary/Npc/Token/majesto.png#token]]
