...
| 13–15 | `dice: 1d4 + 1\|avg` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Undead/vampire-spawn.md\|vampire spawn]] |
...
***Children of the Night (1/Day).*** Strahd magically calls `dice: 2d4\|avg` (`2d4`) [[/6. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|swarms of bats]] or [[/6. Mechanics/Bestiary/Beast/Swarm Of Rats.md\|swarms of rats]], provided that the sun isn't up. While outdoors, Strahd can call `dice: 3d6\|avg` (`3d6`) [[/6. Mechanics/Bestiary/Beast/Wolf.md\|wolves]] instead. The called creatures arrive in `dice: 1d4\|avg` (`1d4`) rounds, acting as allies of Strahd and obeying his spoken commands. The beasts remain for 1 hour, until Strahd dies, or until he dismisses them as a bonus action.
