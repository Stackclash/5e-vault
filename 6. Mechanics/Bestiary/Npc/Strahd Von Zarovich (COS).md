...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Strahd is a 9th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/nondetection.md\|nondetection]]\n\
    \n4th level (3 4th-level slots): [[/6. Mechanics/Spells/blight.md\|blight]], [greater\
    \ invisibility](/compendium/spells/greater-invisibility.md), [[/6. Mechanics/Spells/polymorph.md\|polymorph]]\n\
    \n5th level (1 5th-level slots): [[/6. Mechanics/Spells/animate-objects.md\|animate objects]],\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When Strahd drops to 0 hit points outside his coffin, he transforms into\
    \ a cloud of mist (as in the Shapechanger trait) instead of falling [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]],\
    ...
    \ Once in his coffin, he reverts to his vampire form. He is then [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Strahd has the following flaws:\n\n_Forbiddance._ He can't enter a residence\
    ...
    \ is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] in his coffin,\
    \ he is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the stake\
    \ is removed.\n\n_Sunlight Hypersensitivity._ While in sunlight, Strahd takes\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: dice: 1d8 + 4|avg (1d8 + 4) slashing damage, plus dice: 4d6|avg (4d6)\
    \ necrotic damage. If the target is a creature, Strahd can grapple it (escape\
    \ DC 18) instead of dealing the slashing damage."
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    ...
    \ by Strahd, [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]], or\
    \ [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]. Hit: dice: 1d6 + 4|avg\
    \ (1d6 + 4) piercing damage plus dice: 3d6|avg (3d6) necrotic damage. The\
    ...
    \ rises the following night as a [[/6. Mechanics/Bestiary/Undead/vampire-spawn.md\|vampire spawn]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Strahd targets one humanoid he can see within 30 feet of him. If the target\
    ...
    \ this magic or be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]. The [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
  ...
  "name": "Charm"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Strahd magically calls dice: 2d4|avg (2d4) [[/6. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|swarms of bats]]\
    \ or [[/6. Mechanics/Bestiary/Beast/Swarm Of Rats.md\|swarms of rats]], provided that\
    \ the sun isn't up. While outdoors, Strahd can call dice: 3d6|avg (3d6) [[/6. Mechanics/Bestiary/Beast/Wolf.md\|wolves]]\
...
| 13–15 | `dice: 1d4 + 1` (`1d4 + 1`) [[/6. Mechanics/Bestiary/Undead/vampire-spawn.md\|vampire spawn]] |
...
![[/6. Mechanics/Bestiary/Npc/Token/strahd-von-zarovich.png#token]]
...
***Misty Escape.*** When Strahd drops to 0 hit points outside his coffin, he transforms into a cloud of mist (as in the Shapechanger trait) instead of falling [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]], provided that he isn't in running water or sunlight. If he can't transform, he is destroyed.

While he has 0 hit points in mist form, he can't revert to his vampire form, and he must reach his coffin within 2 hours or be destroyed. Once in his coffin, he reverts to his vampire form. He is then [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until he regains at least 1 hit point. After 1 hour in his coffin with 0 hit points, he regains 1 hit point.
...
_Stake to the Heart._ If a piercing weapon made of wood is driven into his heart while he is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] in his coffin, he is [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] until the stake is removed.
...
**3rd level (3 3rd-level slots)**: [[/6. Mechanics/Spells/animate-dead.md\|animate dead]], [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/nondetection.md\|nondetection]]

**4th level (3 4th-level slots)**: [[/6. Mechanics/Spells/blight.md\|blight]], [[/6. Mechanics/Spells/greater-invisibility.md\|greater invisibility]], [[/6. Mechanics/Spells/polymorph.md\|polymorph]]

**5th level (1 5th-level slots)**: [[/6. Mechanics/Spells/animate-objects.md\|animate objects]], [[/6. Mechanics/Spells/scrying.md\|scrying]]

## Actions

***Multiattack (Vampire Form Only).*** Strahd makes two attacks, only one of which can be a bite attack.

***Unarmed Strike (Vampire or Wolf Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) slashing damage, plus `dice: 4d6` (`4d6`) necrotic damage. If the target is a creature, Strahd can grapple it (escape DC 18) instead of dealing the slashing damage.

***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one willing creature, or a creature that is [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by Strahd, [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]], or [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]. Hit: `dice: 1d6 + 4` (`1d6 + 4`) piercing damage plus `dice: 3d6` (`3d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and Strahd regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if its hit point maximum is reduced to 0. A humanoid slain in this way and then buried in the ground rises the following night as a [[/6. Mechanics/Bestiary/Undead/vampire-spawn.md\|vampire spawn]] under Strahd's control.

***Charm.*** Strahd targets one humanoid he can see within 30 feet of him. If the target can see Strahd, the target must succeed on a DC 17 Wisdom saving throw against this magic or be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]. The [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] target regards Strahd as a trusted friend to be heeded and protected. The target isn't under Strahd's control, but it takes Strahd's requests and actions in the most favorable way and lets Strahd bite it.
...
***Children of the Night (1/Day).*** Strahd magically calls `dice: 2d4` (`2d4`) [[/6. Mechanics/Bestiary/Beast/Swarm Of Bats.md\|swarms of bats]] or [[/6. Mechanics/Bestiary/Beast/Swarm Of Rats.md\|swarms of rats]], provided that the sun isn't up. While outdoors, Strahd can call `dice: 3d6` (`3d6`) [[/6. Mechanics/Bestiary/Beast/Wolf.md\|wolves]] instead. The called creatures arrive in `dice: 1d4` (`1d4`) rounds, acting as allies of Strahd and obeying his spoken commands. The beasts remain for 1 hour, until Strahd dies, or until he dismisses them as a bonus action.
