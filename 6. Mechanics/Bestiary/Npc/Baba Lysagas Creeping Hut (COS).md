...
***Antimagic Susceptibility.*** The hut is [[compendium/rules/conditions.md#incapacitated\|incapacitated]] while the magic gem that animates it is in the area of an antimagic field. If targeted by dispel magic, the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall [[compendium/rules/conditions.md#unconscious\|unconscious]] for 1 minute.
