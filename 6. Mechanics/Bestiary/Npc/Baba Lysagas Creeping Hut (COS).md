...
![[/6. Mechanics/Bestiary/Npc/Token/baba-lysagas-creeping-hut.png#token]]
...
***Antimagic Susceptibility.*** The hut is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] while the magic gem that animates it is in the area of an [[/6. Mechanics/Spells/antimagic-field.md\|antimagic field]]. If targeted by [[/6. Mechanics/Spells/dispel-magic.md\|dispel magic]], the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]] for 1 minute.
...
***Root.*** *Melee Weapon Attack:* `dice: d20+12` (+12 to hit), reach 60 ft., one target. Hit: `dice: 4d10 + 8` (`4d10 + 8`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+12` (+12 to hit), range 120 ft., one target. Hit: `dice: 3d8 + 8` (`3d8 + 8`) bludgeoning damage.
```
^statblock