...
![[/6. Mechanics/Bestiary/Npc/Token/baron-vargas-vallakovich.png#token]]
...
***Rapier.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 1` (`1d8 + 1`) piercing damage.
