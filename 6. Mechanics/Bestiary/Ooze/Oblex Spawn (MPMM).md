...
```ad-statblock
title: Oblex Spawn
![[/6. Mechanics/Bestiary/Ooze/Token/oblex-spawn.png#token]]
...
***Pseudopod.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) bludgeoning damage plus `dice: 1d4` (`1d4`) psychic damage.
```
^statblock
