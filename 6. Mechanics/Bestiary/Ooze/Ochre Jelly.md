...
```ad-statblock
title: Ochre Jelly
![[/6. Mechanics/Bestiary/Ooze/Token/ochre-jelly.png#token]]
...
***Pseudopod.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 2` (`2d6 + 2`) bludgeoning damage plus `dice: 1d6` (`1d6`) acid damage.
