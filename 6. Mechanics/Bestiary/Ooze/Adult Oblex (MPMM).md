...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The oblex casts one of the following spells, requiring no spell components\
    ...
    \ each: [[/6. Mechanics/Spells/charm-person.md\|charm person]] (as 5th-level spell),\
    \ [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/hypnotic-pattern.md\|hypnotic pattern]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The oblex targets one creature it can see within 5 feet of it. The target\
    ...
    \ [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]] for 1 hour. The effect\
...
```ad-statblock
title: Adult Oblex
![[/6. Mechanics/Bestiary/Ooze/Token/adult-oblex.png#token]]
