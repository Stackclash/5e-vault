...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the slithering tracker is motionless at the start of combat, it has\
    ...
    \ ([[6. Mechanics/Rules/skills.md#Investigation\|Investigation]]) check to discern\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "One Large or smaller creature that the slithering tracker can see within\
    \ 5 feet of it must succeed on a DC 13 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ (escape DC 13). Until this grapple ends, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]]\
    \ and unable to breathe unless it can breathe water. In addition, the [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If underwater, the slithering tracker takes the Hide action, and it makes\
    \ the Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]]) check with advantage."
  "name": "Watery Stealth"
"source":
- "MPMM"
- "VGM"
...
![[/6. Mechanics/Bestiary/Ooze/Token/slithering-tracker.png#token]]
...
***Slam.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 3` (`1d10 + 3`) bludgeoning damage.

***Life Leech.*** One Large or smaller creature that the slithering tracker can see within 5 feet of it must succeed on a DC 13 Dexterity saving throw or be [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] (escape DC 13). Until this grapple ends, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] and unable to breathe unless it can breathe water. In addition, the [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] target takes `dice: 3d10` (`3d10`) necrotic damage at the start of each of its turns. The slithering tracker can grapple only one target at a time.
...
***Watery Stealth.*** If underwater, the slithering tracker takes the Hide action, and it makes the Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]]) check with advantage.
```
^statblock
