...
On a failed save, the cube enters the creature's space, and the creature takes `dice: 3d6\|avg` (`3d6`) acid damage and is engulfed. The engulfed creature can't breathe, is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], and takes `dice: 6d6\|avg` (`6d6`) acid damage at the start of each of the cube's turns. When the cube moves, the engulfed creature moves with it.
