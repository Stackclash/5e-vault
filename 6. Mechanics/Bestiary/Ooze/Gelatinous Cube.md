...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The cube takes up its entire space. Other creatures can enter the space,\
    ...
    \ check, and the creature making the attempt takes dice: 3d6|avg (3d6) acid\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    \ Hit: dice: 3d6|avg (3d6) acid damage."
  "name": "Pseudopod"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The cube moves up to its speed. While doing so, it can enter Large or smaller\
    ...
    \ dice: 3d6|avg (3d6) acid damage and is engulfed. The engulfed creature can't\
    \ breathe, is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], and takes\
    \ dice: 6d6|avg (6d6) acid damage at the start of each of the cube's turns.\
...
![[/6. Mechanics/Bestiary/Ooze/Token/gelatinous-cube.png#token]]
...
A creature within 5 feet of the cube can take an action to pull a creature or object out of the cube. Doing so requires a successful DC 12 Strength check, and the creature making the attempt takes `dice: 3d6` (`3d6`) acid damage.
...
***Pseudopod.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 3d6` (`3d6`) acid damage.

***Engulf.*** The cube moves up to its speed. While doing so, it can enter Large or smaller creatures' spaces. Whenever the cube enters a creature's space, the creature must make a DC 12 Dexterity saving throw.

On a successful save, the creature can choose to be pushed 5 feet back or to the side of the cube. A creature that chooses not to be pushed suffers the consequences of a failed saving throw.

On a failed save, the cube enters the creature's space, and the creature takes `dice: 3d6` (`3d6`) acid damage and is engulfed. The engulfed creature can't breathe, is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]], and takes `dice: 6d6` (`6d6`) acid damage at the start of each of the cube's turns. When the cube moves, the engulfed creature moves with it.
