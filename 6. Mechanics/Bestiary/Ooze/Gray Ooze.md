...
```ad-statblock
title: Gray Ooze
![[/6. Mechanics/Bestiary/Ooze/Token/gray-ooze.png#token]]
...
***Pseudopod.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 1\|avg` (`1d6 + 1`) bludgeoning damage plus `dice: 2d6\|avg` (`2d6`) acid damage, and if the target is wearing nonmagical metal armor, its armor is partly corroded and takes a permanent and cumulative −1 penalty to the AC it offers. The armor is destroyed if the penalty reduces its AC to 10.
```
^statblock
