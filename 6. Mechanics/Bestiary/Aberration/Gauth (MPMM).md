...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "When a creature that can see the gauth's central eye starts its turn within\
    ...
    \ if the gauth isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
    \ and can see the creature. A creature that fails the save is [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 5 ft., one target.\
    \ Hit: dice: 2d8|avg (2d8) piercing damage."
  "name": "Bite"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The gauth shoots three of the following magical eye rays at random (roll\
    ...
    \ must succeed on a DC 14 Dexterity saving throw or take dice: 4d10|avg (4d10)\
    ...
    \ throw or fall asleep and remain [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]]\
...
A [[/6. Mechanics/Bestiary/Aberration/Beholder.md\|beholder]] usually drives away or kills any gauths that enter its territory, but it might choose to force them to serve it as lieutenants. Gauths are less xenophobic than beholders, so they might form small clusters and work together, though they're just as likely to ignore each other entirely.

```ad-statblock
title: Gauth
![[/6. Mechanics/Bestiary/Aberration/Token/gauth.png#token]]
...
***Stunning Gaze.*** When a creature that can see the gauth's central eye starts its turn within 30 feet of the gauth, the gauth can force it to make a DC 14 Wisdom saving throw if the gauth isn't [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] and can see the creature. A creature that fails the save is [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] until the start of its next turn.
...
***Death Throes.*** When the gauth dies, the magical energy within it explodes, and each creature within 10 feet of it must make a DC 14 Dexterity saving throw, taking 13 (`dice: 3d8` (`3d8`)) force damage on a failed save, or half as much damage on a successful one.

## Actions

***Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d8` (`2d8`) piercing damage.

***Eye Rays.*** The gauth shoots three of the following magical eye rays at random (roll three `dice: d6` (`d6`)s, and reroll duplicates), targeting one to three creatures it can see within 120 feet of it:

- **1 Devour Magic Ray.** The target must succeed on a DC 14 Dexterity saving throw or have one of its magic items lose all magical properties until the start of the gauth's next turn. If the object is a charged item, it also loses `dice: 1d4` (`1d4`) charges. Determine the affected item randomly, ignoring single-use items such as potions and scrolls.  
- **2 Enervation Ray.** The target must make a DC 14 Constitution saving throw, taking 18 (`dice: 4d8` (`4d8`)) necrotic damage on a failed save, or half as much damage on a successful one.  
- **3 Fire Ray.** The target must succeed on a DC 14 Dexterity saving throw or take `dice: 4d10` (`4d10`) fire damage.  
- **4 Paralyzing Ray.** The target must succeed on a DC 14 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#paralyzed\|paralyzed]] for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
...
- **6 Sleep Ray.** The target must succeed on a DC 14 Wisdom saving throw or fall asleep and remain [[6. Mechanics/Rules/conditions.md#unconscious\|unconscious]] for 1 minute. The target awakens if it takes damage or another creature takes an action to wake it. This ray has no effect on Constructs and Undead.  
```
^statblock
