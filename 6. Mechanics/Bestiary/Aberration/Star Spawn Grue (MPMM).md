...
![[/6. Mechanics/Bestiary/Aberration/Token/star-spawn-grue.png#token]]
...
***Confounding Bite.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1\|avg` (`2d4 + 1`) piercing damage, and the target must succeed on a DC 10 Wisdom saving throw or attack rolls against it have advantage until the start of the grue's next turn.
```
^statblock
