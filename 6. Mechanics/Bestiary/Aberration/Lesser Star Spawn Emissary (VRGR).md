...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The emissary targets a creature it can see within 30 feet of it and psychically\
    ...
    \ throw or take dice: 8d8|avg (8d8) psychic damage and be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
...
![[/6. Mechanics/Bestiary/Aberration/Token/lesser-star-spawn-emissary.png#token]]
...
***Lashing Maw.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 15 ft., one target. Hit: `dice: 2d10 + 5` (`2d10 + 5`) piercing damage plus `dice: 3d8` (`3d8`) acid damage.

***Psychic Orb.*** *Ranged Spell Attack:* `dice: d20+13` (+13 to hit), range 120 ft., one creature. Hit: `dice: 2d10 + 7` (`2d10 + 7`) psychic damage.
