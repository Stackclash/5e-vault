...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The nothic has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The nothic targets one creature it can see within 30 feet of it. The target\
    ...
    \ target. The target automatically wins if it is immune to being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]."
  "name": "Weird Insight"
"source":
- "MM"
- "CoS"
...
```ad-statblock
title: Nothic
![[/6. Mechanics/Bestiary/Aberration/Token/nothic.png#token]]
...
***Keen Sight.*** The nothic has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on sight.

## Actions

***Multiattack.*** The nothic makes two claw attacks.

***Claw.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) slashing damage.

***Rotting Gaze.*** The nothic targets one creature it can see within 30 feet of it. The target must succeed on a DC 12 Constitution saving throw against this magic or take `dice: 3d6` (`3d6`) necrotic damage.

***Weird Insight.*** The nothic targets one creature it can see within 30 feet of it. The target must contest its Charisma (Deception) check against the nothic's Wisdom (Insight) check. If the nothic wins, it magically learns one fact or secret about the target. The target automatically wins if it is immune to being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]].
```
^statblock
