...
![[/6. Mechanics/Bestiary/Aberration/Token/star-spawn-mangler.png#token]]
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 4` (`1d8 + 4`) slashing damage. If the attack roll has advantage, the target also takes `dice: 2d6` (`2d6`) psychic damage.

***Flurry of Claws (Recharge 5-6).*** The mangler makes six Claw attacks. Either before or after these attacks, it can move up to its speed without provoking opportunity attack||opportunity attacks.
