...
***Devour Intellect.*** The intellect devourer targets one creature it can see within 10 feet of it that has a brain. The target must succeed on a DC 12 Intelligence saving throw against this magic or take `dice: 2d10\|avg` (`2d10`) psychic damage. Also on a failure, roll `dice: 3d6\|avg` (`3d6`): If the total equals or exceeds the target's Intelligence score, that score is reduced to 0. The target is [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] until it regains at least one point of Intelligence.
