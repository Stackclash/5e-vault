...
***Multiattack.*** The hulk makes two Slam attacks. If both attacks hit the same target, the target also takes `dice: 2d8\|avg` (`2d8`) psychic damage and must succeed on a DC 17 Constitution saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] until the end of the target's next turn.

***Slam.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 2d8 + 5\|avg` (`2d8 + 5`) bludgeoning damage.
