...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+2 (+2 to hit), reach 5 ft., one target.\
    ...
    \ the derro can choose to deal no damage and knock it [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
  "name": "Hooked Spear"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- "MPMM"
- "MTF"
"image": "/compendium/bestiary/aberration/token/derro.png"
aliases: ["Derro"]
---
# Derro
...
```ad-statblock
title: Derro
![[/6. Mechanics/Bestiary/Aberration/Token/derro.png#token]]
...
***Hooked Spear.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 1d6` (`1d6`) piercing damage. If the target is Medium or smaller, the derro can choose to deal no damage and knock it [[6. Mechanics/Rules/conditions.md#prone\|prone]].

***Light Crossbow.*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 80/320 ft., one target. Hit: `dice: 1d8 + 2` (`1d8 + 2`) piercing damage.
```
^statblock
