...
***Hooked Spear.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 1d6\|avg` (`1d6`) piercing damage. If the target is Medium or smaller, the derro can choose to deal no damage and knock it [[6. Mechanics/Rules/conditions.md#prone\|prone]].
