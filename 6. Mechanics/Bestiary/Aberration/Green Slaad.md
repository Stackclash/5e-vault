...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \ [[/6. Mechanics/Spells/mage-hand.md\|mage hand]]\n\n1/day: [[/6. Mechanics/Spells/fireball.md\|fireball]]\n\
    \n2/day each: [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]]\
    \ (self only)"
  "name": "innate"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Green Slaad
![[/6. Mechanics/Bestiary/Aberration/Token/green-slaad.png#token]]
...
**At will**: [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/mage-hand.md\|mage hand]]

**1/day**: [[/6. Mechanics/Spells/fireball.md\|fireball]]

**2/day each**: [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only)
...
***Bite (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage.

***Claw (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) slashing damage.

***Staff.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) bludgeoning damage.

***Hurl Flame.*** *Ranged Spell Attack:* `dice: d20+4` (+4 to hit), range 60 ft., one target. Hit: `dice: 3d6` (`3d6`) fire damage. The fire ignites flammable objects that aren't being worn or carried.
```
^statblock