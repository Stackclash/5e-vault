...
***Psychic Drain (Costs 2 Actions).*** One creature [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by the aboleth takes `dice: 3d6\|avg` (`3d6`) psychic damage, and the aboleth regains hit points equal to the damage the creature takes.
