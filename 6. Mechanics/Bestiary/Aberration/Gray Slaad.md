...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \nAt will: [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]],\
    \ [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only), [[/6. Mechanics/Spells/mage-hand.md\|mage hand]],\
    \ [[/6. Mechanics/Spells/major-image.md\|major image]]\n\n1/day: [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]\
    \ (self only)\n\n2/day each: [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/fly.md\|fly]],\
    \ [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/tongues.md\|tongues]]"
  "name": "innate"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
```ad-statblock
title: Gray Slaad
![[/6. Mechanics/Bestiary/Aberration/Token/gray-slaad.png#token]]
...
**2/day each**: [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/fly.md\|fly]], [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/tongues.md\|tongues]]

## Actions

***Multiattack.*** The slaad makes three attacks: one with its bite and two with its claws or greatsword.

***Bite (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3` (`1d6 + 3`) piercing damage.

***Claws (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 3` (`1d10 + 3`) slashing damage.

***Greatsword.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 3` (`2d6 + 3`) slashing damage.
```
^statblock
