...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ magic](/compendium/spells/detect-magic.md), [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]],\
    \ [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only), [[/6. Mechanics/Spells/mage-hand.md\|mage hand]],\
    \ [[/6. Mechanics/Spells/major-image.md\|major image]]\n\n1/day each: [[/6. Mechanics/Spells/cloudkill.md\|cloudkill]],\
    \ [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]\n\n2/day each: [[/6. Mechanics/Spells/fear.md\|fear]],\
...
> 
> **Control Gem.** Implanted in the slaad's brain is a magic control gem. The slaad must obey whoever possesses the gem and is immune to being [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] while so controlled.
> 
> Certain spells can be used to acquire the gem. If the slaad fails its saving throw against imprisonment, the spell can transfer the gem to the spellcaster's open hand, instead of imprisoning the slaad. A [[/6. Mechanics/Spells/wish.md\|wish]] spell, if cast in the slaad's presence, can be worded to acquire the gem.
> 
> A [[/6. Mechanics/Spells/greater-restoration.md\|greater restoration]] spell cast on the slaad destroys the gem without harming the slaad.
> 
> Someone who is proficient in Wisdom ([[6. Mechanics/Rules/skills.md#Medicine\|Medicine]]) can remove the gem from an [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([[6. Mechanics/Rules/skills.md#Medicine\|Medicine]]) check. Each failed attempt deals 22 (`dice: 4d10` (`4d10`)) psychic damage to the slaad.
...
```ad-statblock
title: Death Slaad
![[/6. Mechanics/Bestiary/Aberration/Token/death-slaad.png#token]]
*Medium aberration(shapechanger), Chaotic Evil*

- **Armor Class** 18 (natural armor)
- **Hit Points** `dice: 20d8 + 80|text(170)` (20d8 + 80) 
- **Speed** walk 30 ft.
...
***Innate Spellcasting.*** The slaad's innate spellcasting ability is Charisma (spell save DC 15, `dice: d20+7` (+7 to hit) with spell attacks). The slaad can innately cast the following spells, requiring no material components:

**At will**: [[/6. Mechanics/Spells/detect-magic.md\|detect magic]], [[/6. Mechanics/Spells/detect-thoughts.md\|detect thoughts]], [[/6. Mechanics/Spells/invisibility.md\|invisibility]] (self only), [[/6. Mechanics/Spells/mage-hand.md\|mage hand]], [[/6. Mechanics/Spells/major-image.md\|major image]]

**1/day each**: [[/6. Mechanics/Spells/cloudkill.md\|cloudkill]], [[/6. Mechanics/Spells/plane-shift.md\|plane shift]]

**2/day each**: [[/6. Mechanics/Spells/fear.md\|fear]], [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/fly.md\|fly]], [[/6. Mechanics/Spells/tongues.md\|tongues]]

## Actions

***Multiattack.*** The slaad makes three attacks: one with its bite and two with its claws or greatsword.

***Bite (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 5` (`1d8 + 5`) piercing damage plus `dice: 2d6` (`2d6`) necrotic damage.

***Claws (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 5` (`1d10 + 5`) slashing damage plus `dice: 2d6` (`2d6`) necrotic damage.

***Greatsword.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 5` (`2d6 + 5`) slashing damage plus `dice: 2d6` (`2d6`) necrotic damage.
```
^statblock