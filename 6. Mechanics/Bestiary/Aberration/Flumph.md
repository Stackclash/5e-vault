...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If the flumph is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]],\
    \ roll a die. On an odd result, the flumph lands upside-down and is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].\
    \ At the end of each of its turns, the flumph can make a DC 10 Dexterity saving\
    \ throw, righting itself and ending the [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    ...
    \ ending the recurring acid damage on a success. A [[/6. Mechanics/Spells/lesser-restoration.md\|lesser restoration]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Each creature in a 15-foot cone originating from the flumph must succeed\
    ...
    \ The coated creature is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] as\
    \ long as the stench lasts, and other creatures are [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]\
...
```ad-statblock
title: Flumph
![[/6. Mechanics/Bestiary/Aberration/Token/flumph.png#token]]
...
***Prone Deficiency.*** If the flumph is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]], roll a die. On an odd result, the flumph lands upside-down and is [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]]. At the end of each of its turns, the flumph can make a DC 10 Dexterity saving throw, righting itself and ending the [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]] condition if it succeeds.
...
***Tendrils.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one creature. Hit: `dice: 1d4 + 2` (`1d4 + 2`) piercing damage plus `dice: 1d4` (`1d4`) acid damage. At the end of each of its turns, the target must make a DC 10 Constitution saving throw, taking 2 (`dice: 1d4` (`1d4`)) acid damage on a failure or ending the recurring acid damage on a success. A [[/6. Mechanics/Spells/lesser-restoration.md\|lesser restoration]] spell cast on the target also ends the recurring acid damage.

***Stench Spray (1/Day).*** Each creature in a 15-foot cone originating from the flumph must succeed on a DC 10 Dexterity saving throw or be coated in a foul-smelling liquid. A coated creature exudes a horrible stench for `dice: 1d4` (`1d4`) hours. The coated creature is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] as long as the stench lasts, and other creatures are [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] while with in 5 feet of the coated creature. A creature can remove the stench on itself by using a short rest to bathe in water, alcohol, or vinegar.
```
^statblock
