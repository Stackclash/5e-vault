...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one target.\
    ...
    \ forms a [[/6. Mechanics/Bestiary/Aberration/Slaad Tadpole.md\|slaad tadpole]]. In\
...
- "IDRotF"
- "DSotDQ"
"image": "/compendium/bestiary/aberration/token/red-slaad.png"
aliases: ["Red Slaad"]
---
# Red Slaad
...
```ad-statblock
title: Red Slaad
![[/6. Mechanics/Bestiary/Aberration/Token/red-slaad.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 3` (`2d4 + 3`) piercing damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) piercing damage. If the target is a humanoid, it must succeed on a DC 14 Constitution saving throw or be infected with a disease—a minuscule slaad egg.

A humanoid host can carry only one slaad egg to term at a time. Over three months, the egg moves to the chest cavity, gestates, and forms a [[/6. Mechanics/Bestiary/Aberration/Slaad Tadpole.md\|slaad tadpole]]. In the 24-hour period before giving birth, the host starts to feel unwell, its speed is halved, and it has disadvantage on attack rolls, ability checks, and saving throws. At birth, the tadpole chews its way through vital organs and out of the host's chest in 1 round, killing the host in the process.
