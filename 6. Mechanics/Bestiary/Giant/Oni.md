...
***Glaive.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 4\|avg` (`2d10 + 4`) slashing damage, or 9 (`dice: 1d10 + 4\|avg` (`1d10 + 4`)) slashing damage in Small or Medium form.
