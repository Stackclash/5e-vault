...
***Greataxe.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 3d12 + 7\|avg` (`3d12 + 7`) slashing damage, or 30 (`dice: 3d12 + 11\|avg` (`3d12 + 11`)) slashing damage while raging.
