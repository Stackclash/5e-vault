...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 5 ft., one creature.\
    ...
    \ on a DC 15 Wisdom saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
    \ for 1 minute. The [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] target can\
...
```ad-statblock
title: Spirit Troll
![[/6. Mechanics/Bestiary/Giant/Token/spirit-troll.png#token]]
*Large giant, Chaotic Evil*

- **Armor Class** 17 (natural armor)
- **Hit Points** `dice: 20d10 + 20|text(130)` (20d10 + 20) 
- **Speed** walk 30 ft.
...
***Incorporeal Movement.*** The troll can move through other creatures and objects as if they were difficult terrain. It takes `dice: 1d10` (`1d10`) force damage if it ends its turn inside an object.
