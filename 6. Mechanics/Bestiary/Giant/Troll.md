...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The troll has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
```ad-statblock
title: Troll
![[/6. Mechanics/Bestiary/Giant/Token/troll.png#token]]
...
***Keen Smell.*** The troll has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on smell.
