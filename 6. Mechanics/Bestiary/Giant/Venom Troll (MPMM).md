...
***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4\|avg` (`1d6 + 4`) piercing damage plus `dice: 1d8\|avg` (`1d8`) poison damage, and the creature is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the start of the troll's next turn.
