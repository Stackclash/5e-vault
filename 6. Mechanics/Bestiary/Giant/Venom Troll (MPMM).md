...
```ad-statblock
title: Venom Troll
![[/6. Mechanics/Bestiary/Giant/Token/venom-troll.png#token]]
...
***Poison Splash.*** When the troll takes damage of any type but psychic, each creature within 5 feet of the troll takes `dice: 2d8` (`2d8`) poison damage.
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) piercing damage plus `dice: 1d8` (`1d8`) poison damage, and the creature is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] until the start of the troll's next turn.

***Claws.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) slashing damage plus `dice: 1d8` (`1d8`) poison damage.

***Venom Spray (Recharge 6).*** The troll slices itself with a claw, releasing a spray of poison in a 15-foot cube. The troll takes `dice: 2d6` (`2d6`) slashing damage (this damage can't be reduced in any way). Each creature in the area must make a DC 16 Constitution saving throw. On a failed save, a creature takes `dice: 4d8` (`4d8`) poison damage and is [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 minute. On a successful save, the creature takes half as much damage and isn't [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]]. A [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
