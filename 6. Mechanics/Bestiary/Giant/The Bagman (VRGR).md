...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The Bagman has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  ...
  "name": "Regeneration"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The Bagman has advantage on attack rolls against any creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ by it."
  "name": "Grappler"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If a creature tries to read the Bagman's thoughts, that creature must succeed\
    \ on a DC 8 Intelligence saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]]\
    \ for 1 minute. The [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] creature\
...
```ad-statblock
title: The Bagman
![[/6. Mechanics/Bestiary/Giant/Token/the-bagman.png#token]]
...
***Keen Smell.*** The Bagman has advantage on Wisdom ([[6. Mechanics/Rules/skills.md#Perception\|Perception]]) checks that rely on smell.
...
***Grappler.*** The Bagman has advantage on attack rolls against any creature [[6. Mechanics/Rules/conditions.md#grappled\|grappled]] by it.

***Amorphous.*** The Bagman can move through a space as narrow as 1 inch wide without squeezing.

***Alien Mind.*** If a creature tries to read the Bagman's thoughts, that creature must succeed on a DC 8 Intelligence saving throw or be [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] for 1 minute. The [[6. Mechanics/Rules/conditions.md#stunned\|stunned]] creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

## Actions

***Multiattack.*** The Bagman makes three attacks: one with its bite and two with its claws.

***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4` (`1d6 + 4`) piercing damage.
