...
***Rancid Degeneration.*** At the end of each of the troll's turns, each creature within 5 feet of it takes `dice: 2d10` (`2d10`) necrotic damage, unless the troll has taken acid or fire damage since the end of its last turn.

## Actions

***Multiattack.*** The troll makes one Bite attack and two Claw attacks.

***Bite.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 4` (`1d10 + 4`) piercing damage plus `dice: 3d10` (`3d10`) necrotic damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) slashing damage plus `dice: 2d6` (`2d6`) necrotic damage.
```
^statblock
