...
![[/6. Mechanics/Bestiary/Giant/Token/ogre-battering-ram.png#token]]
...
***Bash.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d10 + 4` (`2d10 + 4`) bludgeoning damage, and the ogre can push the target 5 feet away if the target is Huge or smaller.
