...
***Evil Eye.*** The fomorian magically forces a creature it can see within 60 feet of it to make a DC 14 Charisma saving throw. The creature takes `dice: 6d8` (`6d8`) psychic damage on a failed save, or half as much damage on a successful one.
