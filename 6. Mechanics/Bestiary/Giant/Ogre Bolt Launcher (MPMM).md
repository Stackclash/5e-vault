...
![[/6. Mechanics/Bestiary/Giant/Token/ogre-bolt-launcher.png#token]]
...
***Bolt Launcher.*** *Ranged Weapon Attack:* `dice: d20+3` (+3 to hit), range 120/480 ft., one target. Hit: `dice: 3d10 + 1` (`3d10 + 1`) piercing damage.
```
^statblock
