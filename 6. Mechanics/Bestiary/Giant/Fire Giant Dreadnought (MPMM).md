...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The giant moves up to 30 feet in a straight line and can move through the\
    ...
    \ 4d6|avg (4d6) fire damage and be pushed up to 30 feet and knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]]."
...
![[/6. Mechanics/Bestiary/Giant/Token/fire-giant-dreadnought.png#token]]
*Huge giant, Lawful Evil*

- **Armor Class** 21 ([[/6. Mechanics/Items/plate-armor.md\|plate]], [[/6. Mechanics/Items/shield.md\|Dual Shields]])
...
***Fireshield.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 5 ft., one target. Hit: `dice: 4d6 + 8` (`4d6 + 8`) bludgeoning damage plus `dice: 2d6` (`2d6`) fire damage plus `dice: 2d6` (`2d6`) piercing damage.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+13` (+13 to hit), range 60/240 ft., one target. Hit: `dice: 4d10 + 8` (`4d10 + 8`) bludgeoning damage.

***Shield Charge (Recharge 5-6).*** The giant moves up to 30 feet in a straight line and can move through the space of any creature smaller than Huge. The first time it enters a creature's space during this move, that creature must succeed on a DC 21 Strength saving throw or take `dice: 8d6 + 8` (`8d6 + 8`) bludgeoning damage plus `dice: 4d6` (`4d6`) fire damage and be pushed up to 30 feet and knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
