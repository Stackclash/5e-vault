...
```ad-statblock
title: Ogre
![[/6. Mechanics/Bestiary/Giant/Token/ogre.png#token]]
...
***Greatclub.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4` (`2d8 + 4`) bludgeoning damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 2d6 + 4` (`2d6 + 4`) piercing damage.
```
^statblock
