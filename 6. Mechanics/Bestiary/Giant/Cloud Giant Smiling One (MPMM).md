...
***Slam.*** *Melee Weapon Attack:* `dice: d20+12` (+12 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 8` (`3d8 + 8`) bludgeoning damage plus `dice: 1d10` (`1d10`) psychic damage.

***Telekinetic Strike.*** *Ranged Spell Attack:* `dice: d20+7` (+7 to hit), range 240 ft., one target. Hit: `dice: 4d10 + 3` (`4d10 + 3`) force damage.
