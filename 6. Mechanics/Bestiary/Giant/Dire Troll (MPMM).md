...
```ad-statblock
title: Dire Troll
![[/6. Mechanics/Bestiary/Giant/Token/dire-troll.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 1d8 + 6` (`1d8 + 6`) piercing damage plus `dice: 1d10` (`1d10`) poison damage.

***Claws.*** *Melee Weapon Attack:* `dice: d20+11` (+11 to hit), reach 10 ft., one target. Hit: `dice: 3d6 + 6` (`3d6 + 6`) slashing damage.

***Whirlwind of Claws (Recharge 5-6).*** Each creature within 10 feet of the troll must make a DC 19 Dexterity saving throw, taking 44 (`dice: 8d10` (`8d10`)) slashing damage on a failed save, or half as much damage on a successful one.
```
^statblock
