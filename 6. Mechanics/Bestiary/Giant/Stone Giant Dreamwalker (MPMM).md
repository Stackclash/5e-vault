...
***Rock.*** *Ranged Weapon Attack:* `dice: d20+10` (+10 to hit), range 60/240 ft., one target. Hit: `dice: 3d10 + 6\|avg` (`3d10 + 6`) bludgeoning damage. If the target is a creature, it must succeed on a DC 17 Strength saving throw or be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
