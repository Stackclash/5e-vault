...
***Greatclub.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 6` (`3d8 + 6`) bludgeoning damage.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+9` (+9 to hit), range 30/120 ft., one target. Hit: `dice: 4d10 + 6` (`4d10 + 6`) bludgeoning damage.
```
^statblock
