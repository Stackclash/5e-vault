...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The eladrin casts one of the following spells, requiring no material components\
    ...
    \ restoration](/compendium/spells/greater-restoration.md), [[/6. Mechanics/Spells/revivify.md\|revivify]]\n\
    \n2/day each: [[/6. Mechanics/Spells/cure-wounds.md\|cure wounds]] (as a 5th-level\
    \ spell), [[/6. Mechanics/Spells/lesser-restoration.md\|lesser restoration]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
"reactions":
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "If a creature [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by the\
...
***Longsword.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 1` (`1d8 + 1`) slashing damage, or 6 (`dice: 1d10 + 1` (`1d10 + 1`)) slashing damage if used with two hands, plus `dice: 5d8` (`5d8`) psychic damage.
