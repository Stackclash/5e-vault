...
***Bite.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4\|avg` (`2d6 + 4`) piercing damage, plus `dice: 4d6\|avg` (`4d6`) psychic damage if the target is [[6. Mechanics/Rules/conditions.md#frightened\|frightened]].
