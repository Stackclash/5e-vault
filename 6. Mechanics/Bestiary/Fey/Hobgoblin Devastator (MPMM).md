...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
    ...
    \ [[/6. Mechanics/Spells/fog-cloud.md\|fog cloud]], [[/6. Mechanics/Spells/gust-of-wind.md\|gust of wind]],\
...
![[/6. Mechanics/Bestiary/Fey/Token/hobgoblin-devastator.png#token]]
*Medium fey(goblinoid), Lawful Neutral*

- **Armor Class** 13 ([[/6. Mechanics/Items/studded-leather-armor.md\|studded leather]])
...
**2/day each**: [[/6. Mechanics/Spells/fireball.md\|fireball]], [[/6. Mechanics/Spells/fly.md\|fly]], [[/6. Mechanics/Spells/fog-cloud.md\|fog cloud]], [[/6. Mechanics/Spells/gust-of-wind.md\|gust of wind]], [[/6. Mechanics/Spells/lightning-bolt.md\|lightning bolt]]

## Actions

***Multiattack.*** The hobgoblin makes two Quarterstaff or Devastating Bolt attacks.

***Quarterstaff.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 1` (`1d6 + 1`) bludgeoning damage, or 5 (`dice: 1d8 + 1` (`1d8 + 1`)) bludgeoning damage if used with two hands, plus `dice: 3d8` (`3d8`) force damage.

***Devastating Bolt.*** *Ranged Spell Attack:* `dice: d20+5` (+5 to hit), range 60 ft., one target. Hit: `dice: 4d8 + 3` (`4d8 + 3`) force damage, and the target is knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
