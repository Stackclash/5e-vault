...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    ...
    \ (2d6) psychic damage, and the target is [[6. Mechanics/Rules/conditions.md#blinded\|blinded]]\
...
![[/6. Mechanics/Bestiary/Fey/Token/dolphin-delighter.png#token]]
...
***Dazzling Slam.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) bludgeoning damage plus `dice: 2d6` (`2d6`) psychic damage, and the target is [[6. Mechanics/Rules/conditions.md#blinded\|blinded]] until the start of the dolphin's next turn.

## Bonus Actions

***Delightful Light (Recharge 5-6).*** The dolphin magically emanates light in a 10-foot radius for a moment. The dolphin and each creature of its choice in that light gain 11 (`dice: 2d10` (`2d10`)) temporary hit points.
