...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The eladrin casts one of the following spells, requiring no material components\
    ...
    \ will: [[/6. Mechanics/Spells/fog-cloud.md\|fog cloud]], [[/6. Mechanics/Spells/gust-of-wind.md\|gust of wind]],\
    \ [[/6. Mechanics/Spells/sleet-storm.md\|sleet storm]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any non-eladrin creature that starts its turn within 60 feet of the eladrin\
    ...
    \ [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] by the eladrin for 1 minute.\
    \ While [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] in this way, the creature\
    \ has disadvantage on ability checks and saving throws. The [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
    ...
    \ [[6. Mechanics/Rules/conditions.md#charmed\|charmed]] creature, the [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    \ Hit: dice: 1d8|avg (1d8) slashing damage, or 5 (dice: 1d10|avg (1d10))\
...
- "MPMM"
- "MTF"
"image": "/compendium/bestiary/fey/token/winter-eladrin.png"
...
![[/6. Mechanics/Bestiary/Fey/Token/winter-eladrin.png#token]]
...
**At will**: [[/6. Mechanics/Spells/fog-cloud.md\|fog cloud]], [[/6. Mechanics/Spells/gust-of-wind.md\|gust of wind]], [[/6. Mechanics/Spells/sleet-storm.md\|sleet storm]]

## Actions

***Multiattack.*** The eladrin makes two Longsword or Longbow attacks. It can replace one attack with a use of Spellcasting.

***Longsword.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d8` (`1d8`) slashing damage, or 5 (`dice: 1d10` (`1d10`)) slashing damage if used with two hands, plus `dice: 3d8` (`3d8`) cold damage.

***Longbow.*** *Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), range 150/600 ft., one target. Hit: `dice: 1d8 + 3` (`1d8 + 3`) piercing damage plus `dice: 3d8` (`3d8`) cold damage.
...
***Frigid Rebuke.*** When the eladrin takes damage from a creature the eladrin can see within 60 feet of it, the eladrin can force that creature to make a DC 16 Constitution saving throw. On a failed save, the creature takes `dice: 2d10` (`2d10`) cold damage.
```
^statblock
