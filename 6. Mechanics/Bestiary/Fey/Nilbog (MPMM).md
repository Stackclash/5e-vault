...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The nilbog casts one of the following spells, using Charisma as the spellcasting\
    ...
    \ [[/6. Mechanics/Spells/tashas-hideous-laughter.md\|Tasha's hideous laughter]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Any creature that attempts to damage the nilbog must first succeed on a\
    \ DC 12 Charisma saving throw or be [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
    \ until the end of the creature's next turn. A creature [[6. Mechanics/Rules/conditions.md#charmed\|charmed]]\
...
```ad-statblock
title: Nilbog
![[/6. Mechanics/Bestiary/Fey/Token/nilbog.png#token]]
...
**At will**: [[/6. Mechanics/Spells/mage-hand.md\|mage hand]], [[/6. Mechanics/Spells/tashas-hideous-laughter.md\|Tasha's hideous laughter]]

## Actions

***Fool's Scepter.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2` (`1d6 + 2`) bludgeoning damage.

***Mocking Word.*** The nilbog targets one creature it can see within 60 feet of it. The target must succeed on a DC 12 Wisdom saving throw or take `dice: 2d4` (`2d4`) psychic damage and have disadvantage on its next attack roll before the end of its next turn.
...
***Reversal of Fortune.*** In response to another creature dealing damage to the nilbog, the nilbog reduces the damage to 0 and regains 3 (`dice: 1d6` (`1d6`)) hit points.
```
^statblock
