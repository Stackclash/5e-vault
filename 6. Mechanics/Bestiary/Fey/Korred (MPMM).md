...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The korred casts one of the following spells, requiring no spell components\
    ...
    \ [[/6. Mechanics/Spells/commune-with-nature.md\|commune with nature]] (as an action),\
    \ [[/6. Mechanics/Spells/meld-into-stone.md\|meld into stone]], [[/6. Mechanics/Spells/stone-shape.md\|stone shape]]\n\
    \n1/day: [[/6. Mechanics/Spells/ottos-irresistible-dance.md\|Otto's irresistible dance]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The korred has advantage on Dexterity ([[6. Mechanics/Rules/skills.md#Stealth\|Stealth]])\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one target.\
    \ Hit: dice: 1d8 + 6|avg (1d8 + 6) bludgeoning damage, or 19 (dice: 3d8 +\
    \ 6|avg (3d8 + 6)) bludgeoning damage if the korred is on the ground."
  "name": "Greatclub"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "Ranged Weapon Attack: dice: d20+9 (+9 to hit), range 60/120 ft., one\
    \ target. Hit: dice: 1d8 + 6|avg (1d8 + 6) bludgeoning damage, or 19 (dice:\
...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The korred has at least one 50-foot-long rope woven out of its hair. The\
    ...
    \ succeed on a DC 13 Dexterity saving throw or become [[6. Mechanics/Rules/conditions.md#grappled\|grappled]]\
    \ by the rope (escape DC 13). Until this grapple ends, the target is [[6. Mechanics/Rules/conditions.md#restrained\|restrained]].\
    \ The korred can use a bonus action to release the target, which is also freed\
    \ if the korred dies or becomes [[6. Mechanics/Rules/conditions.md#incapacitated\|incapacitated]].\n\
...
***Greatclub.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 6` (`1d8 + 6`) bludgeoning damage, or 19 (`dice: 3d8 + 6` (`3d8 + 6`)) bludgeoning damage if the korred is on the ground.

***Rock.*** *Ranged Weapon Attack:* `dice: d20+9` (+9 to hit), range 60/120 ft., one target. Hit: `dice: 1d8 + 6` (`1d8 + 6`) bludgeoning damage, or 19 (`dice: 3d8 + 6` (`3d8 + 6`)) bludgeoning damage if the korred is on the ground.
