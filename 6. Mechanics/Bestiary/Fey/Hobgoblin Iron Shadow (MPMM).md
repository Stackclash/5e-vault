...
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
  "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
    \ the spellcasting ability (spell save DC 12):\n\nAt will: [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]],\
    \ [[/6. Mechanics/Spells/prestidigitation.md\|prestidigitation]]\n\n1/day each:\
    \ [[/6. Mechanics/Spells/charm-person.md\|charm person]], [[/6. Mechanics/Spells/disguise-self.md\|disguise self]],\
    \ [[/6. Mechanics/Spells/silent-image.md\|silent image]]"
  "name": "spells"
- !!dev.ebullient.convert.tools.dnd5e.qute.Trait
...
![[/6. Mechanics/Bestiary/Fey/Token/hobgoblin-iron-shadow.png#token]]
...
**At will**: [[/6. Mechanics/Spells/minor-illusion.md\|minor illusion]], [[/6. Mechanics/Spells/prestidigitation.md\|prestidigitation]]

**1/day each**: [[/6. Mechanics/Spells/charm-person.md\|charm person]], [[/6. Mechanics/Spells/disguise-self.md\|disguise self]], [[/6. Mechanics/Spells/silent-image.md\|silent image]]
...
***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) bludgeoning damage.

***Dart.*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 20/60 ft., one target. Hit: `dice: 1d4 + 3` (`1d4 + 3`) piercing damage.
