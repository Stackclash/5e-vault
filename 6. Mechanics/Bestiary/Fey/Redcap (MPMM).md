...
***Ironbound Pursuit.*** The redcap moves up to its speed to a creature it can see and kicks with its iron boots. The target must succeed on a DC 14 Dexterity saving throw or take `dice: 3d10 + 4\|avg` (`3d10 + 4`) bludgeoning damage and be knocked [[6. Mechanics/Rules/conditions.md#prone\|prone]].
```
^statblock
