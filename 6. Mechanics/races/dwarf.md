...
You have proficiency with the [battleaxe](/6. Mechanics/items/battleaxe.md), [handaxe](/6. Mechanics/items/handaxe.md), [light hammer](/6. Mechanics/items/light-hammer.md), and [warhammer](/6. Mechanics/items/warhammer.md).

### Tool Proficiency

You gain proficiency with the artisan's tools of your choice: [Smith's tools](/6. Mechanics/items/smiths-tools.md), [brewer's supplies](/6. Mechanics/items/brewers-supplies.md), or [mason's tools](/6. Mechanics/items/masons-tools.md).

### Stonecunning

Whenever you make an Intelligence ([History](/6. Mechanics/rules/skills.md#History)) check related to the origin of stonework, you are considered proficient in the [History](/6. Mechanics/rules/skills.md#History) skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.
