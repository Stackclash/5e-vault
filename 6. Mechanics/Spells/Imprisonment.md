...
Heavy chains, firmly rooted in the ground, hold the target in place. The target is [[6. Mechanics/Rules/Conditions.md#restrained\|restrained]] until the spell ends, and it can't move or be moved by any means until then.
...
A [[/6. Mechanics/Spells/Dispel Magic.md\|dispel magic]] spell can end the spell only if it is cast as a 9th-level spell, targeting either the prison or the special component used to create it.
