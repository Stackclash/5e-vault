...
- **Armor:** light, medium, heavy, [shields](/6. Mechanics/items/shield.md)
...
- (a) [chain mail](/6. Mechanics/items/chain-mail.md) or (b) [leather armor](/6. Mechanics/items/leather-armor.md), [longbow](/6. Mechanics/items/longbow.md), and [20 arrows](/6. Mechanics/items/arrows-20.md)  
- (a) a martial weapon and a [shield](/6. Mechanics/items/shield.md) or (b) two martial weapons  
- (a) a [light crossbow](/6. Mechanics/items/light-crossbow.md) and [20 bolts](/6. Mechanics/items/crossbow-bolts-20.md) or (b) two [handaxes](/6. Mechanics/items/handaxe.md)  
...
- [Great Weapon Fighting](/6. Mechanics/classes/fighter.md#Great%20Weapon%20Fighting)  
- Mariner  
- [Protection](/6. Mechanics/classes/fighter.md#Protection)  
- Tunnel Fighter  
...
When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by `dice: 1d10|avg` (`1d10`) + your proficiency bonus (to a minimum of 0 damage). You must be wielding a [shield](/6. Mechanics/items/shield.md) or a simple or martial weapon to use this reaction.
...
You learn one maneuver of your choice from among those available to the [Battle Master](/6. Mechanics/classes/fighter-battle-master.md) archetype. If a maneuver you use requires your target to make a saving throw to resist the maneuver's effects, the saving throw DC equals 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).
...
Your unarmed strikes can deal bludgeoning damage equal to `dice: 1d6|avg` (`1d6`) + your Strength modifier on a hit. If you aren't wielding any weapons or a [shield](/6. Mechanics/items/shield.md) when you make the attack roll, the `dice: d6|avg` (`d6`) becomes a `dice: d8|avg` (`d8`).

At the start of each of your turns, you can deal `dice: 1d4|avg` (`1d4`) bludgeoning damage to one creature [grappled](/6. Mechanics/rules/conditions.md#grappled) by you.
