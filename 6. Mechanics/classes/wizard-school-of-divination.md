...
Starting at 10th level, you can use your action to increase your powers of perception. When you do so, choose one of the following benefits, which lasts until you are [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) or you take a short or long rest. You can't use the feature again until you finish a rest.

- **Darkvision.** You gain [darkvision](/6. Mechanics/rules/senses.md#darkvision) out to a range of 60 feet.  
- **Ethereal Sight.** You can see into the Ethereal Plane within 60 feet of you.  
- **Greater Comprehension.** You can read any language.  
- **See Invisibility.** You can see [invisible](/6. Mechanics/rules/conditions.md#invisible) creatures and objects within 10 feet of you that are within line of sight.  
