...
- **Armor:** none
- **Weapons:** [daggers](/6. Mechanics/items/dagger.md), [darts](/6. Mechanics/items/dart.md), [slings](/6. Mechanics/items/sling.md), [quarterstaffs](/6. Mechanics/items/quarterstaff.md), [light crossbows](/6. Mechanics/items/light-crossbow.md)
- **Tools:** none
...
- Two [daggers](/6. Mechanics/items/dagger.md)  
...
For example, if you know the 1st-level spell [burning hands](/6. Mechanics/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/6. Mechanics/spells/burning-hands.md) using either slot.
...
- [Careful Spell](/6. Mechanics/classes/sorcerer.md#Careful%20Spell)  
- [Distant Spell](/6. Mechanics/classes/sorcerer.md#Distant%20Spell)  
- [Empowered Spell](/6. Mechanics/classes/sorcerer.md#Empowered%20Spell)  
- [Extended Spell](/6. Mechanics/classes/sorcerer.md#Extended%20Spell)  
- [Heightened Spell](/6. Mechanics/classes/sorcerer.md#Heightened%20Spell)  
- [Quickened Spell](/6. Mechanics/classes/sorcerer.md#Quickened%20Spell)  
- [Subtle Spell](/6. Mechanics/classes/sorcerer.md#Subtle%20Spell)  
- [Twinned Spell](/6. Mechanics/classes/sorcerer.md#Twinned%20Spell)  
...
To be eligible, a spell must be incapable of targeting more than one creature at the spell's current level. For example, [magic missile](/6. Mechanics/spells/magic-missile.md) and [scorching ray](/6. Mechanics/spells/scorching-ray.md) aren't eligible, but [ray of frost](/6. Mechanics/spells/ray-of-frost.md) and [chromatic orb](/6. Mechanics/spells/chromatic-orb.md) are.
