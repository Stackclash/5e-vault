...
- (a) a [quarterstaff](/6. Mechanics/items/quarterstaff.md) or (b) a [dagger](/6. Mechanics/items/dagger.md)  
- (a) a [component pouch](/6. Mechanics/items/component-pouch.md) or (b) an arcane focus  
- (a) a [scholar's pack](/6. Mechanics/items/scholars-pack.md) or (b) an [explorer's pack](/6. Mechanics/items/explorers-pack.md)  
- A [spellbook](/6. Mechanics/items/spellbook.md)  
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/6. Mechanics/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](/6. Mechanics/rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
