...
Beginning at 10th level, when you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in [counterspell](/6. Mechanics/spells/counterspell.md) and [dispel magic](/6. Mechanics/spells/dispel-magic.md)), you add your proficiency bonus to that ability check.
