...
- (a) a [rapier](/6. Mechanics/items/rapier.md), (b) a [longsword](/6. Mechanics/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](/6. Mechanics/items/diplomats-pack.md) or (b) an [entertainer's pack](/6. Mechanics/items/entertainers-pack.md)  
- (a) a [lute](/6. Mechanics/items/lute.md) or (b) any other musical instrument  
- [Leather armor](/6. Mechanics/items/leather-armor.md), and a [dagger](/6. Mechanics/items/dagger.md)  
...
For example, if you know the 1st-level spell [cure wounds](/6. Mechanics/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](/6. Mechanics/spells/cure-wounds.md) using either slot.
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](/6. Mechanics/rules/conditions.md#frightened) or [charmed](/6. Mechanics/rules/conditions.md#charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) or silenced or if you voluntarily end it (no action required).
