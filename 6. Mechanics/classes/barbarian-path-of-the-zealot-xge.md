...
At 3rd level, your soul is marked for endless battle. If a spell, such as [raise dead](/6. Mechanics/spells/raise-dead.md), has the sole effect of restoring you to life (but not undeath), the caster doesn't need material components to cast the spell on you.
...
While you're raging, having 0 hit points doesn't knock you [unconscious](/6. Mechanics/rules/conditions.md#unconscious). You still must make death saving throws, and you suffer the normal effects of taking damage while at 0 hit points. However, if you would die due to failing death saving throws, you don't die until your rage ends, and you die then only if you still have 0 hit points.