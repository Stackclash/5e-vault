...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](/6. Mechanics/spells/beast-sense.md) and [speak with animals](/6. Mechanics/spells/speak-with-animals.md) spells, but only as rituals, as described in "chapter 10".
...
At 10th level, you can cast the [commune with nature](/6. Mechanics/spells/commune-with-nature.md) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
...
- **Bear**  
    ...
    While you're raging, any creature within 5 feet of you that's hostile to you has disadvantage on attack rolls against targets other than you or another character with this feature. An enemy is immune to this effect if it can't see or hear you or if it can't be [frightened](/6. Mechanics/rules/conditions.md#frightened).  
...
- **Wolf**  
    ...
    While you're raging, you can use a bonus action on your turn to knock a Large or smaller creature [prone](/6. Mechanics/rules/conditions.md#prone) when you hit it with melee weapon attack.