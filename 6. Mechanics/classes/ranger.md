...
- **Armor:** light, medium, [shields](/6. Mechanics/items/shield.md)
...
- (a) [scale mail](/6. Mechanics/items/scale-mail.md) or (b) [leather armor](/6. Mechanics/items/leather-armor.md)  
- (a) two [shortswords](/6. Mechanics/items/shortsword.md) or (b) two simple melee weapons  
- (a) a [dungeoneer's pack](/6. Mechanics/items/dungeoneers-pack.md) or (b) an [explorer's pack](/6. Mechanics/items/explorers-pack.md)  
- A [longbow](/6. Mechanics/items/longbow.md) and a [quiver](/6. Mechanics/items/quiver.md) of [20 arrows](/6. Mechanics/items/arrows-20.md)  
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/6. Mechanics/bestiary/humanoid/gnoll.md) and [orcs](/6. Mechanics/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](/6. Mechanics/rules/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
- [Archery](/6. Mechanics/classes/fighter.md#Archery)  
- Close Quarters Shooter  
- [Defense](/6. Mechanics/classes/fighter.md#Defense)  
- [Dueling](/6. Mechanics/classes/fighter.md#Dueling)  
- Mariner  
- Tunnel Fighter  
- [Two-Weapon Fighting](/6. Mechanics/classes/fighter.md#Two-Weapon%20Fighting)  
- Blind Fighting  
- Interception  
...
For example, if you know the 1st-level spell [animal friendship](/6. Mechanics/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/6. Mechanics/spells/animal-friendship.md) using either slot.
...
In addition, you have advantage on saving throws against plants that are magically created or manipulated to impede movement, such as those created by the [entangle](/6. Mechanics/spells/entangle.md) spell.

### Hide in Plain Sight (Level 10)

Starting at 10th level, you can spend 1 minute creating camouflage for yourself. You must have access to fresh mud, dirt, plants, soot, and other naturally occurring materials with which to create your camouflage.

Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](/6. Mechanics/rules/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](/6. Mechanics/rules/conditions.md#invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](/6. Mechanics/rules/conditions.md#blinded) or [deafened](/6. Mechanics/rules/conditions.md#deafened).
...
You have [blindsight](/6. Mechanics/rules/senses.md#blindsight) with a range of 10 feet. Within that range, you can effectively see anything that isn't behind total cover, even if you're [blinded](/6. Mechanics/rules/conditions.md#blinded) or in darkness. Moreover, you can see an [invisible](/6. Mechanics/rules/conditions.md#invisible) creature within that range, unless the creature successfully hides from you.
...
When you successfully start a grapple, you can deal `dice: 1d4|avg` (`1d4`) bludgeoning damage to the [grappled](/6. Mechanics/rules/conditions.md#grappled) creature. Until the grapple ends, you can also deal this damage to the creature whenever you hit it with a melee attack.