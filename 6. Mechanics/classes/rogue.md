...
- **Armor:** light
- **Weapons:** simple, [hand crossbows](/6. Mechanics/items/hand-crossbow.md), [longswords](/6. Mechanics/items/longsword.md), [rapiers](/6. Mechanics/items/rapier.md), [shortswords](/6. Mechanics/items/shortsword.md)
- **Tools:** [thieves' tools](/6. Mechanics/items/thieves-tools.md)
...
- (a) a [rapier](/6. Mechanics/items/rapier.md) or (b) a [shortsword](/6. Mechanics/items/shortsword.md)  
- (a) a [shortbow](/6. Mechanics/items/shortbow.md) and [quiver](/6. Mechanics/items/quiver.md) of [20 arrows](/6. Mechanics/items/arrows-20.md) or (b) a [shortsword](/6. Mechanics/items/shortsword.md)  
- (a) a [burglar's pack](/6. Mechanics/items/burglars-pack.md), (b) a [dungeoneer's pack](/6. Mechanics/items/dungeoneers-pack.md), or (c) an [explorer's pack](/6. Mechanics/items/explorers-pack.md)  
- [Leather armor](/6. Mechanics/items/leather-armor.md), two [daggers](/6. Mechanics/items/dagger.md), and [thieves' tools](/6. Mechanics/items/thieves-tools.md)  
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](/6. Mechanics/items/thieves-tools.md). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/6. Mechanics/items/thieves-tools.md)) to gain this benefit.
...
You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated), and you don't have disadvantage on the attack roll.
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/6. Mechanics/items/thieves-tools.md)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](/6. Mechanics/spells/ice-storm.md) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](/6. Mechanics/rules/conditions.md#invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated).
