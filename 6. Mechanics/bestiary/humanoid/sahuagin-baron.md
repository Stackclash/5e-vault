...
![[token/sahuagin-baron.png#token]]
*Large humanoid(sahuagin), Lawful Evil*

- **Armor Class** 16 ([breastplate](/6. Mechanics/items/breastplate.md))
...
***Trident.*** *Melee or Ranged Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) piercing damage, or 13 (`dice: 2d8 + 4|avg` (`2d8 + 4`)) piercing damage if used with two hands to make a melee attack.
```
^statblock
