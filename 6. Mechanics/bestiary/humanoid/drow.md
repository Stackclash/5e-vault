...
```ad-statblock
title: Drow
![[token/drow.png#token]]
*Medium humanoid(elf), Neutral Evil*

- **Armor Class** 15 ([chain shirt](/6. Mechanics/items/chain-shirt.md))
