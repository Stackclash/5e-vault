...
Distilled from spider venom and the flora of the Underdark, poison can be found in abundance among the drow, and it plays an important part in their culture and politics. Drow mages concoct a viscid toxin that leaves enemies [unconscious](/6. Mechanics/rules/conditions.md#unconscious). Drow warriors coat their blades and crossbow bolts with this venom, looking forward to the interrogation and torture that follows combat.
...
```ad-statblock
title: Drow Mage
![[token/drow-mage.png#token]]
*Medium humanoid(elf), Neutral Evil*

- **Armor Class** 12 (15 with [mage armor](/6. Mechanics/spells/mage-armor.md))
...
***Fey Ancestry.*** The drow has advantage on saving throws against being [charmed](/6. Mechanics/rules/conditions.md#charmed), and magic can't put the drow to sleep.

***Sunlight Sensitivity.*** While in sunlight, the drow has disadvantage on attack rolls, as well as on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on sight.

***Innate Spellcasting.*** The drow's spellcasting ability is Charisma (spell save DC 12). It can innately cast the following spells, requiring no material components:

**At will**: [dancing lights](/6. Mechanics/spells/dancing-lights.md)

**1/day each**: [darkness](/6. Mechanics/spells/darkness.md), [faerie fire](/6. Mechanics/spells/faerie-fire.md), [levitate](/6. Mechanics/spells/levitate.md) (self only)
...
**Cantrips (at will)**: [mage hand](/6. Mechanics/spells/mage-hand.md), [minor illusion](/6. Mechanics/spells/minor-illusion.md), [poison spray](/6. Mechanics/spells/poison-spray.md), [ray of frost](/6. Mechanics/spells/ray-of-frost.md)

**1st level (4 1st-level slots)**: [mage armor](/6. Mechanics/spells/mage-armor.md), [magic missile](/6. Mechanics/spells/magic-missile.md), [shield](/6. Mechanics/spells/shield.md), [witch bolt](/6. Mechanics/spells/witch-bolt.md)

**2nd level (3 2nd-level slots)**: [alter self](/6. Mechanics/spells/alter-self.md), [misty step](/6. Mechanics/spells/misty-step.md), [web](/6. Mechanics/spells/web.md)

**3rd level (3 3rd-level slots)**: [fly](/6. Mechanics/spells/fly.md), [lightning bolt](/6. Mechanics/spells/lightning-bolt.md)

**4th level (3 4th-level slots)**: [Evard's black tentacles](/6. Mechanics/spells/evards-black-tentacles.md), [greater invisibility](/6. Mechanics/spells/greater-invisibility.md)

**5th level (2 5th-level slots)**: [cloudkill](/6. Mechanics/spells/cloudkill.md)

## Actions

***Staff.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 1d6 - 1|avg` (`1d6 - 1`) bludgeoning damage, or 3 (`dice: 1d8 - 1|avg` (`1d8 - 1`)) bludgeoning damage if used with two hands, plus `dice: 1d6|avg` (`1d6`) poison damage.

***Summon Demon (1/Day).*** The drow magically summons a [quasit](/6. Mechanics/bestiary/fiend/quasit.md), or attempts to summon a [shadow demon](/6. Mechanics/bestiary/fiend/shadow-demon.md) with a 50|50 percent|50% summoning chance% chance chance of success. The summoned demon appears in an unoccupied space within 60 feet of its summoner, acts as an ally of its summoner, and can't summon other demons. It remains for 10 minutes, until it or its summoner dies, or until its summoner dismisses it as an action.
```
^statblock
