...
![[token/vistana-assassin.png#token]]
...
***Sneak Attack (1/Turn).*** The assassin deals an extra 14 (`dice: 4d6|avg` (`4d6`)) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the assassin that isn't [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) and the assassin doesn't have disadvantage on the attack roll.
