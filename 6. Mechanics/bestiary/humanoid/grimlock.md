...
***Blind Senses.*** The grimlock can't use its blindsight while [deafened](/6. Mechanics/rules/conditions.md#deafened) and unable to smell.

***Keen Hearing and Smell.*** The grimlock has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on hearing or smell.
