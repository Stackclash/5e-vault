...
```ad-statblock
title: Bugbear Chief
![[token/bugbear-chief.png#token]]
*Medium humanoid(goblinoid), Chaotic Evil*

- **Armor Class** 17 ([chain shirt](/6. Mechanics/items/chain-shirt.md), [shield](/6. Mechanics/items/shield.md))
...
***Heart of Hruggek.*** The bugbear has advantage on saving throws against being [charmed](/6. Mechanics/rules/conditions.md#charmed), [frightened](/6. Mechanics/rules/conditions.md#frightened), [paralyzed](/6. Mechanics/rules/conditions.md#paralyzed), [poisoned](/6. Mechanics/rules/conditions.md#poisoned), [stunned](/6. Mechanics/rules/conditions.md#stunned), or put to sleep.
