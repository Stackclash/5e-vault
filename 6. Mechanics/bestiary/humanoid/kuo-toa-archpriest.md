...
![[token/kuo-toa-archpriest.png#token]]
...
***Otherworldly Perception.*** The kuo-toa can sense the presence of any creature within 30 feet of it that is [invisible](/6. Mechanics/rules/conditions.md#invisible) or on the Ethereal Plane. It can pinpoint such a creature that is moving.

***Slippery.*** The kuo-toa has advantage on ability checks and saving throws made to escape a grapple.

***Sunlight Sensitivity.*** While in sunlight, the kuo-toa has disadvantage on attack rolls, as well as on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on sight.
...
**Cantrips (at will)**: [guidance](/6. Mechanics/spells/guidance.md), [sacred flame](/6. Mechanics/spells/sacred-flame.md), [thaumaturgy](/6. Mechanics/spells/thaumaturgy.md)

**1st level (4 1st-level slots)**: [detect magic](/6. Mechanics/spells/detect-magic.md), [sanctuary](/6. Mechanics/spells/sanctuary.md), [shield of faith](/6. Mechanics/spells/shield-of-faith.md)

**2nd level (3 2nd-level slots)**: [hold person](/6. Mechanics/spells/hold-person.md), [spiritual weapon](/6. Mechanics/spells/spiritual-weapon.md)

**3rd level (3 3rd-level slots)**: [spirit guardians](/6. Mechanics/spells/spirit-guardians.md), [tongues](/6. Mechanics/spells/tongues.md)

**4th level (3 4th-level slots)**: [control water](/6. Mechanics/spells/control-water.md), [divination](/6. Mechanics/spells/divination.md)

**5th level (2 5th-level slots)**: [mass cure wounds](/6. Mechanics/spells/mass-cure-wounds.md), [scrying](/6. Mechanics/spells/scrying.md)

## Actions

***Multiattack.*** The kuo-toa makes two melee attacks.

***Scepter.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) bludgeoning damage plus `dice: 4d6|avg` (`4d6`) lightning damage.

***Unarmed Strike.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 3|avg` (`1d4 + 3`) bludgeoning damage.
```
^statblock
