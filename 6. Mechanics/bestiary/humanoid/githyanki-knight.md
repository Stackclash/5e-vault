...
These silver swords channel the force of the wielder's will, dealing psychic as well as physical damage. A githyanki can't become a knight until it masters the singular discipline needed to will such a blade into existence. A silver sword is equivalent to a [greatsword](/6. Mechanics/items/greatsword.md), and takes on the properties of a +3 greatsword in the hands of its creator.
...
The warlike githyanki and the contemplative githzerai are a sundered people-two cultures that utterly despise one another. Before there were githyanki or githzerai, these creatures were a single race enslaved by the [mind flayers](/6. Mechanics/bestiary/aberration/mind-flayer.md). Although they attempted to overthrow their masters many times, their rebellions were repeatedly crushed until a great leader named Gith arose.
...
Whether these tall, gaunt creatures were peaceful or savage, cultured or primitive before the [mind flayers](/6. Mechanics/bestiary/aberration/mind-flayer.md) enslaved and changed them, none can say. Not even the original name of their race remains from that distant time.
...
![[token/githyanki-knight.png#token]]
...
**At will**: [mage hand](/6. Mechanics/spells/mage-hand.md) (the hand is invisible)

**1/day each**: [plane shift](/6. Mechanics/spells/plane-shift.md), [telekinesis](/6. Mechanics/spells/telekinesis.md)

**3/day each**: [jump](/6. Mechanics/spells/jump.md), [misty step](/6. Mechanics/spells/misty-step.md), [nondetection](/6. Mechanics/spells/nondetection.md) (self only), [tongues](/6. Mechanics/spells/tongues.md)

## Actions

***Multiattack.*** The githyanki makes two silver greatsword attacks.

***Silver Greatsword.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 6|avg` (`2d6 + 6`) slashing damage plus `dice: 3d6|avg` (`3d6`) psychic damage. This is a magic weapon attack. On a critical hit against a target in an astral body (as with the [astral projection](/6. Mechanics/spells/astral-projection.md) spell), the githyanki can cut the silvery cord that tethers the target to its material body, instead of dealing damage.
```
^statblock