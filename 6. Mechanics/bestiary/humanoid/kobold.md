...
```ad-statblock
title: Kobold
![[token/kobold.png#token]]
*Small humanoid(kobold), Lawful Evil*

- **Armor Class** 12 
- **Hit Points** `dice: 2d6 - 2|text(5)` (2d6 - 2) 
- **Speed** walk 30 ft.
...
***Sunlight Sensitivity.*** While in sunlight, the kobold has disadvantage on attack rolls, as well as on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on sight.

***Pack Tactics.*** The kobold has advantage on an attack roll against a creature if at least one of the kobold's allies is within 5 feet of the creature and the ally isn't [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated).

## Actions

***Dagger.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d4 + 2|avg` (`1d4 + 2`) piercing damage.
