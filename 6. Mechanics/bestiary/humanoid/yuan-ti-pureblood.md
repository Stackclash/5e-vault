...
![[token/yuan-ti-pureblood.png#token]]
...
**3/day each**: [poison spray](/6. Mechanics/spells/poison-spray.md), [suggestion](/6. Mechanics/spells/suggestion.md)
...
***Shortbow.*** *Ranged Weapon Attack:* `dice: d20+3` (+3 to hit), range 80/320 ft., one target. Hit: `dice: 1d6 + 1|avg` (`1d6 + 1`) piercing damage plus `dice: 2d6|avg` (`2d6`) poison damage.
```
^statblock
