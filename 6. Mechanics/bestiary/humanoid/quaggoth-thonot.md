...
![[token/quaggoth-thonot.png#token]]
...
***Wounded Fury.*** While it has 10 hit points or fewer, the quaggoth has advantage on attack rolls. In addition, it deals an extra 7 (`dice: 2d6|avg` (`2d6`)) damage to any target it hits with a melee attack.
...
**At will**: [feather fall](/6. Mechanics/spells/feather-fall.md), [mage hand](/6. Mechanics/spells/mage-hand.md) (the hand is invisible)

**1/day each**: [cure wounds](/6. Mechanics/spells/cure-wounds.md), [enlarge/reduce](/6. Mechanics/spells/enlarge-reduce.md), [heat metal](/6. Mechanics/spells/heat-metal.md), [mirror image](/6. Mechanics/spells/mirror-image.md)
