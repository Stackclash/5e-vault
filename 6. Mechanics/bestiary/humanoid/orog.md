...
***Greataxe.*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft., one target. Hit: `dice: 1d12 + 4|avg` (`1d12 + 4`) slashing damage.

***Javelin.*** *Melee or Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft. or range 30/120 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) piercing damage.
```
^statblock
