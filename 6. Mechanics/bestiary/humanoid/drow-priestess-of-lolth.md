...
![[token/drow-priestess-of-lolth.png#token]]
*Medium humanoid(elf), Neutral Evil*

- **Armor Class** 16 ([scale mail](/6. Mechanics/items/scale-mail.md))
...
**Cantrips (at will)**: [guidance](/6. Mechanics/spells/guidance.md), [poison spray](/6. Mechanics/spells/poison-spray.md), [resistance](/6. Mechanics/spells/resistance.md), [spare the dying](/6. Mechanics/spells/spare-the-dying.md), [thaumaturgy](/6. Mechanics/spells/thaumaturgy.md)

**1st level (4 1st-level slots)**: [animal friendship](/6. Mechanics/spells/animal-friendship.md), [cure wounds](/6. Mechanics/spells/cure-wounds.md), [detect poison and disease](/6. Mechanics/spells/detect-poison-and-disease.md), [ray of sickness](/6. Mechanics/spells/ray-of-sickness.md)

**2nd level (3 2nd-level slots)**: [lesser restoration](/6. Mechanics/spells/lesser-restoration.md), [protection from poison](/6. Mechanics/spells/protection-from-poison.md), [web](/6. Mechanics/spells/web.md)

**3rd level (3 3rd-level slots)**: [conjure animals](/6. Mechanics/spells/conjure-animals.md) (2 [giant spiders](/6. Mechanics/bestiary/beast/giant-spider.md)), [dispel magic](/6. Mechanics/spells/dispel-magic.md)

**4th level (3 4th-level slots)**: [divination](/6. Mechanics/spells/divination.md), [freedom of movement](/6. Mechanics/spells/freedom-of-movement.md)

**5th level (2 5th-level slots)**: [insect plague](/6. Mechanics/spells/insect-plague.md), [mass cure wounds](/6. Mechanics/spells/mass-cure-wounds.md)

## Actions

***Multiattack.*** The drow makes two scourge attacks.

***Scourge.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 2|avg` (`1d6 + 2`) piercing damage plus `dice: 5d6|avg` (`5d6`) poison damage.

***Summon Demon (1/Day).*** The drow attempts to magically summon a [yochlol](/6. Mechanics/bestiary/fiend/yochlol.md) with a 30|30 percent|30% summoning chance% chance chance of success. If the attempt fails, the drow takes `dice: 1d10|avg` (`1d10`) psychic damage. Otherwise, the summoned demon appears in an unoccupied space within 60 feet of its summoner, acts as an ally of its summoner, and can't summon other demons. It remains for 10 minutes, until it or its summoner dies, or until its summoner dismisses it as an action.
```
^statblock
