...
The half-dragon gains [blindsight](/6. Mechanics/rules/senses.md#blindsight) with a radius of 10 feet and [darkvision](/6. Mechanics/rules/senses.md#darkvision) with a radius of 60 feet.
...
Here the half-dragon template has been applied to a human [veteran](/6. Mechanics/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](/6. Mechanics/items/splint-armor.md) has been replaced with [plate](/6. Mechanics/items/plate-armor.md).

## Stat Block

```ad-statblock
title: Half-Red Dragon Veteran
![[token/half-red-dragon-veteran.png#token]]
