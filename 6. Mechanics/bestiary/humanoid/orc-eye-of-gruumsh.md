...
![[token/orc-eye-of-gruumsh.png#token]]
*Medium humanoid(orc), Chaotic Evil*

- **Armor Class** 16 ([ring mail](/6. Mechanics/items/ring-mail.md), [shield](/6. Mechanics/items/shield.md))
...
***Gruumsh's Fury.*** The orc deals an extra 4 (`dice: 1d8|avg` (`1d8`)) damage when it hits with a weapon attack (included in the attacks).
...
**Cantrips (at will)**: [guidance](/6. Mechanics/spells/guidance.md), [resistance](/6. Mechanics/spells/resistance.md), [thaumaturgy](/6. Mechanics/spells/thaumaturgy.md)

**1st level (4 1st-level slots)**: [bless](/6. Mechanics/spells/bless.md), [command](/6. Mechanics/spells/command.md)

**2nd level (2 2nd-level slots)**: [augury](/6. Mechanics/spells/augury.md), [spiritual weapon](/6. Mechanics/spells/spiritual-weapon.md) (spear)

## Actions

***Spear.*** *Melee or Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: 11 (`dice: 1d6 + 3|avg` (`1d6 + 3`) plus `dice: 1d8|avg` (`1d8`)) piercing damage, or 12 (`dice: 2d8 + 3|avg` (`2d8 + 3`)) piercing damage if used with two hands to make a melee attack.
```
^statblock
