...
***Rolling Charge.*** If the galeb duhr rolls at least 20 feet straight toward a target and then hits it with a slam attack on the same turn, the target takes an extra 7 (`dice: 2d6|avg` (`2d6`)) bludgeoning damage. If the target is a creature, it must succeed on a DC 16 Strength saving throw or be knocked [prone](/6. Mechanics/rules/conditions.md#prone).

## Actions

***Slam.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 5|avg` (`2d6 + 5`) bludgeoning damage.

***Animate Boulders (1/Day).*** The galeb duhr magically animates up to two boulders it can see within 60 feet of it. A boulder has statistics like those of a galeb duhr, except it has Intelligence 1 and Charisma 1, it can't be [charmed](/6. Mechanics/rules/conditions.md#charmed) or [frightened](/6. Mechanics/rules/conditions.md#frightened), and it lacks this action option. A boulder remains animated as long as the galeb duhr maintains [concentration](/6. Mechanics/rules/status.md#concentration), up to 1 minute (as if [concentration](/6. Mechanics/rules/status.md#concentration) on a spell).
```
^statblock
