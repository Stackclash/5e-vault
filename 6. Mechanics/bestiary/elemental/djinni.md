...
**At will**: [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [detect magic](/6. Mechanics/spells/detect-magic.md), [thunderwave](/6. Mechanics/spells/thunderwave.md)

**1/day each**: [conjure elemental](/6. Mechanics/spells/conjure-elemental.md) ([air elemental](/6. Mechanics/bestiary/elemental/air-elemental.md) only), [creation](/6. Mechanics/spells/creation.md), [gaseous form](/6. Mechanics/spells/gaseous-form.md), [invisibility](/6. Mechanics/spells/invisibility.md), [major image](/6. Mechanics/spells/major-image.md), [plane shift](/6. Mechanics/spells/plane-shift.md)

**3/day each**: [create food and water](/6. Mechanics/spells/create-food-and-water.md) (can create wine instead of water), [tongues](/6. Mechanics/spells/tongues.md), [wind walk](/6. Mechanics/spells/wind-walk.md)
...
***Create Whirlwind.*** A 5-foot-radius, 30-foot-tall cylinder of swirling air magically forms on a point the djinni can see within 120 feet of it. The whirlwind lasts as long as the djinni maintains [concentration](/6. Mechanics/rules/status.md#concentration) (as if [concentration](/6. Mechanics/rules/status.md#concentration) on a spell). Any creature but the djinni that enters the whirlwind must succeed on a DC 18 Strength saving throw or be [restrained](/6. Mechanics/rules/conditions.md#restrained) by it. The djinni can move the whirlwind up to 60 feet as an action, and creatures [restrained](/6. Mechanics/rules/conditions.md#restrained) by the whirlwind move with it. The whirlwind ends if the djinni loses sight of it.

A creature can use its action to free a creature [restrained](/6. Mechanics/rules/conditions.md#restrained) by the whirlwind, including itself, by succeeding on a DC 18 Strength check. If the check succeeds, the creature is no longer [restrained](/6. Mechanics/rules/conditions.md#restrained) and moves to the nearest space outside the whirlwind.
```
^statblock
