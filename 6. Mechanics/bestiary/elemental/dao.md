...
***Sure-Footed.*** The dao has advantage on Strength and Dexterity saving throws made against effects that would knock it [prone](/6. Mechanics/rules/conditions.md#prone).
...
**At will**: [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [detect magic](/6. Mechanics/spells/detect-magic.md), [stone shape](/6. Mechanics/spells/stone-shape.md)

**1/day each**: [conjure elemental](/6. Mechanics/spells/conjure-elemental.md) ([earth elemental](/6. Mechanics/bestiary/elemental/earth-elemental.md) only), [gaseous form](/6. Mechanics/spells/gaseous-form.md), [invisibility](/6. Mechanics/spells/invisibility.md), [phantasmal killer](/6. Mechanics/spells/phantasmal-killer.md), [plane shift](/6. Mechanics/spells/plane-shift.md), [wall of stone](/6. Mechanics/spells/wall-of-stone.md)

**3/day each**: [passwall](/6. Mechanics/spells/passwall.md), [move earth](/6. Mechanics/spells/move-earth.md), [tongues](/6. Mechanics/spells/tongues.md)

## Actions

***Multiattack.*** The Dao makes two fist attacks or two maul attacks.

***Fist.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 6|avg` (`2d8 + 6`) bludgeoning damage.

***Maul.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft., one target. Hit: `dice: 4d6 + 6|avg` (`4d6 + 6`) bludgeoning damage. If the target is a Huge or smaller creature, it must succeed on a DC 18 Strength check or be knocked [prone](/6. Mechanics/rules/conditions.md#prone).
```
^statblock
