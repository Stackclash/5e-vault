...
***Innate Spellcasting (1/Day).*** The mephit can innately cast [dancing lights](/6. Mechanics/spells/dancing-lights.md), requiring no material components. Its innate spellcasting ability is Charisma.
...
***Cinder Breath (Recharge 6).*** The mephit exhales a 15-foot cone of smoldering ash. Each creature in that area must succeed on a DC 10 Dexterity saving throw or be [blinded](/6. Mechanics/rules/conditions.md#blinded) until the end of the mephit's next turn.
```
^statblock
