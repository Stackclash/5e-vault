...
**At will**: [create or destroy water](/6. Mechanics/spells/create-or-destroy-water.md), [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [detect magic](/6. Mechanics/spells/detect-magic.md), [fog cloud](/6. Mechanics/spells/fog-cloud.md), [purify food and drink](/6. Mechanics/spells/purify-food-and-drink.md)

**1/day each**: [conjure elemental](/6. Mechanics/spells/conjure-elemental.md) ([water elemental](/6. Mechanics/bestiary/elemental/water-elemental.md) only), [control water](/6. Mechanics/spells/control-water.md), [gaseous form](/6. Mechanics/spells/gaseous-form.md), [invisibility](/6. Mechanics/spells/invisibility.md), [plane shift](/6. Mechanics/spells/plane-shift.md)

**3/day each**: [tongues](/6. Mechanics/spells/tongues.md), [water breathing](/6. Mechanics/spells/water-breathing.md), [water walk](/6. Mechanics/spells/water-walk.md)

## Actions

***Multiattack.*** The marid makes two trident attacks.

***Trident.*** *Melee or Ranged Weapon Attack:* `dice: d20+10` (+10 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 2d6 + 6|avg` (`2d6 + 6`) piercing damage, or 15 (`dice: 2d8 + 6|avg` (`2d8 + 6`)) piercing damage if used with two hands to make a melee attack.

***Water Jet.*** The marid magically shoots water in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 16 Dexterity saving throw. On a failure, a target takes `dice: 6d6|avg` (`6d6`) bludgeoning damage and, if it is Huge or smaller, is pushed up to 20 feet away from the marid and knocked [prone](/6. Mechanics/rules/conditions.md#prone). On a success, a target takes half the bludgeoning damage, but is neither pushed nor knocked [prone](/6. Mechanics/rules/conditions.md#prone).
```
^statblock
