...
***Tail.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) bludgeoning damage plus `dice: 2d6|avg` (`2d6`) fire damage, and the target is [grappled](/6. Mechanics/rules/conditions.md#grappled) (escape DC 14). Until this grapple ends, the target is [restrained](/6. Mechanics/rules/conditions.md#restrained), the salamander can automatically hit the target with its tail, and the salamander can't make tail attacks against other targets.
```
^statblock
