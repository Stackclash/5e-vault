...
![[token/mind-flayer-arcanist.png#token]]
*Medium aberration, Lawful Evil*

- **Armor Class** 15 ([breastplate](/6. Mechanics/items/breastplate.md))
...
**At will**: [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [levitate](/6. Mechanics/spells/levitate.md)

**1/day each**: [dominate monster](/6. Mechanics/spells/dominate-monster.md), [plane shift](/6. Mechanics/spells/plane-shift.md) (self only)
...
**Cantrips (at will)**: [blade ward](/6. Mechanics/spells/blade-ward.md), [dancing lights](/6. Mechanics/spells/dancing-lights.md), [mage hand](/6. Mechanics/spells/mage-hand.md), [shocking grasp](/6. Mechanics/spells/shocking-grasp.md)

**1st level (4 1st-level slots)**: [detect magic](/6. Mechanics/spells/detect-magic.md), [disguise self](/6. Mechanics/spells/disguise-self.md), [shield](/6. Mechanics/spells/shield.md), [sleep](/6. Mechanics/spells/sleep.md)

**2nd level (3 2nd-level slots)**: [blur](/6. Mechanics/spells/blur.md), [invisibility](/6. Mechanics/spells/invisibility.md), [ray of enfeeblement](/6. Mechanics/spells/ray-of-enfeeblement.md)

**3rd level (3 3rd-level slots)**: [clairvoyance](/6. Mechanics/spells/clairvoyance.md), [lightning bolt](/6. Mechanics/spells/lightning-bolt.md), [sending](/6. Mechanics/spells/sending.md)

**4th level (3 4th-level slots)**: [confusion](/6. Mechanics/spells/confusion.md), [hallucinatory terrain](/6. Mechanics/spells/hallucinatory-terrain.md)

**5th level (2 5th-level slots)**: [telekinesis](/6. Mechanics/spells/telekinesis.md), [wall of force](/6. Mechanics/spells/wall-of-force.md)

## Actions

***Tentacles.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one creature. Hit: `dice: 2d10 + 4|avg` (`2d10 + 4`) psychic damage. If the target is Medium or smaller, it is [grappled](/6. Mechanics/rules/conditions.md#grappled) (escape DC 15) and must succeed on a DC 15 Intelligence saving throw or be [stunned](/6. Mechanics/rules/conditions.md#stunned) until this grapple ends.

***Extract Brain.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) humanoid [grappled](/6. Mechanics/rules/conditions.md#grappled) by the mind flayer. Hit: The target takes `dice: 10d10|avg` (`10d10`) piercing damage. If this damage reduces the target to 0 hit points, the mind flayer kills the target by extracting and devouring its brain.

***Mind Blast (Recharge 5-6).*** The mind flayer magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 15 Intelligence saving throw or take `dice: 4d8 + 4|avg` (`4d8 + 4`) psychic damage and be [stunned](/6. Mechanics/rules/conditions.md#stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
```
^statblock
