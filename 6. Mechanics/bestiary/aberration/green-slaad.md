...
**At will**: [detect magic](/6. Mechanics/spells/detect-magic.md), [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [mage hand](/6. Mechanics/spells/mage-hand.md)

**1/day**: [fireball](/6. Mechanics/spells/fireball.md)

**2/day each**: [fear](/6. Mechanics/spells/fear.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only)
...
***Bite (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) piercing damage.

***Claw (Slaad Form Only).*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) slashing damage.

***Staff.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) bludgeoning damage.

***Hurl Flame.*** *Ranged Spell Attack:* `dice: d20+4` (+4 to hit), range 60 ft., one target. Hit: `dice: 3d6|avg` (`3d6`) fire damage. The fire ignites flammable objects that aren't being worn or carried.
```
^statblock