...
***Tentacles.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 10 ft., one creature. Hit: `dice: 1d10 + 2|avg` (`1d10 + 2`) piercing damage, and the target must succeed on a DC 11 Constitution saving throw or be [poisoned](/6. Mechanics/rules/conditions.md#poisoned) for 1 minute. The [poisoned](/6. Mechanics/rules/conditions.md#poisoned) target is [paralyzed](/6. Mechanics/rules/conditions.md#paralyzed), and it can repeat the saving throw at the end of each of its turns, ending the effect on a success.

The target is also [grappled](/6. Mechanics/rules/conditions.md#grappled) (escape DC 15). If the target is Medium or smaller, it is also [restrained](/6. Mechanics/rules/conditions.md#restrained) until this grapple ends. While grappling the target, the grell has advantage on attack rolls against it and can 't use this attack against other targets. When the grell moves, any Medium or smaller target it is grappling moves with it.
