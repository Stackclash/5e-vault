...
***Battleaxe.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 5|avg` (`2d8 + 5`) slashing damage.

***Morningstar.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 5|avg` (`2d8 + 5`) piercing damage.
```
^statblock
