...
***Keen Smell.*** The giant has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on smell.

***Innate Spellcasting.*** The giant's innate spellcasting ability is Charisma. It can innately cast the following spells, requiring no material components:

**At will**: [detect magic](/6. Mechanics/spells/detect-magic.md), [fog cloud](/6. Mechanics/spells/fog-cloud.md), [light](/6. Mechanics/spells/light.md)

**1/day each**: [control weather](/6. Mechanics/spells/control-weather.md), [gaseous form](/6. Mechanics/spells/gaseous-form.md)

**3/day each**: [feather fall](/6. Mechanics/spells/feather-fall.md), [fly](/6. Mechanics/spells/fly.md), [misty step](/6. Mechanics/spells/misty-step.md), [telekinesis](/6. Mechanics/spells/telekinesis.md)
