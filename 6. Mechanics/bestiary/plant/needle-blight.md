...
***Claws.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1|avg` (`2d4 + 1`) piercing damage.

***Needles.*** *Ranged Weapon Attack:* `dice: d20+3` (+3 to hit), range 30/60 ft., one target. Hit: `dice: 2d6 + 1|avg` (`2d6 + 1`) piercing damage.
```
^statblock
