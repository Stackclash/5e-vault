...
An awakened tree is an ordinary tree given sentience and mobility by the [awaken](/6. Mechanics/spells/awaken.md) spell or similar magic.

```ad-statblock
title: Awakened Tree
![[token/awakened-tree.png#token]]
