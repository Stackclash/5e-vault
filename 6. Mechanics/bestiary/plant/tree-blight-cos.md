...
***Branch.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one target. Hit: 3d6 + 6\|avg (`3d6 + 6`) bludgeoning damage.

***Grasping Root.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 15 ft., one creature not [[compendium/rules/conditions.md#grappled|grappled]] by the blight. Hit: The target is [[compendium/rules/conditions.md#grappled|grappled]] (escape DC 15). Until the grapple ends, the target takes 1d6 + 6\|avg (`1d6 + 6`) bludgeoning damage at the start of each of its turns. The root has AC 15 and can be severed by dealing 6 slashing damage or more to it at once. Cutting the root doesn't hurt the blight, but ends the grapple.

## Bonus Actions

***Bite.*** *Melee Weapon Attack:* `dice: d20+9` (+9 to hit), reach 5 ft., one creature [[compendium/rules/conditions.md#grappled|grappled]] by the blight. Hit: 3d8 + 6\|avg (`3d8 + 6`) piercing damage.
```
^statblock