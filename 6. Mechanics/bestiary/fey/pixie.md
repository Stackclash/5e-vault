...
**1/day each**: [confusion](/6. Mechanics/spells/confusion.md), [dancing lights](/6. Mechanics/spells/dancing-lights.md), [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [dispel magic](/6. Mechanics/spells/dispel-magic.md), [entangle](/6. Mechanics/spells/entangle.md), [fly](/6. Mechanics/spells/fly.md), [phantasmal force](/6. Mechanics/spells/phantasmal-force.md), [polymorph](/6. Mechanics/spells/polymorph.md), [sleep](/6. Mechanics/spells/sleep.md)

## Actions

***Superior Invisibility.*** The pixie magically turns [invisible](/6. Mechanics/rules/conditions.md#invisible) until its [concentration](/6. Mechanics/rules/status.md#concentration) ends (as if [concentration](/6. Mechanics/rules/status.md#concentration) on a spell). Any equipment the pixie wears or carries is [invisible](/6. Mechanics/rules/conditions.md#invisible) with it.
```
^statblock
