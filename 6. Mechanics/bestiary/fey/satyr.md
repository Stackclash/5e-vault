...
```ad-statblock
title: Satyr
![[token/satyr.png#token]]
*Medium fey, Chaotic Neutral*

- **Armor Class** 14 ([leather armor](/6. Mechanics/items/leather-armor.md))
...
***Ram.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 1|avg` (`2d4 + 1`) bludgeoning damage.
