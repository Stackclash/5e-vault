...
![[token/adult-copper-dragon.png#token]]
...
- **Acid Breath.** The dragon exhales acid in a 60-foot line that is 5 feet wide. Each creature in that line must make a DC 18 Dexterity saving throw, taking 54 (`dice: 12d8|avg` (`12d8`)) acid damage on a failed save, or half as much damage on a successful one.  
