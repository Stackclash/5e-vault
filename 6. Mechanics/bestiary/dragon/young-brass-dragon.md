...
![[token/young-brass-dragon.png#token]]
...
- **Sleep Breath.** The dragon exhales sleep gas in a 30-foot cone. Each creature in that area must succeed on a DC 14 Constitution saving throw or fall [unconscious](/6. Mechanics/rules/conditions.md#unconscious) for 5 minutes. This effect ends for a creature if the creature takes damage or someone uses an action to wake it.  
```
^statblock
