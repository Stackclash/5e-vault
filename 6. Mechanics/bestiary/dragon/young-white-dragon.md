...
![[token/young-white-dragon.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 10 ft., one target. Hit: `dice: 2d10 + 4|avg` (`2d10 + 4`) piercing damage plus `dice: 1d8|avg` (`1d8`) cold damage.

***Claw.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d6 + 4|avg` (`2d6 + 4`) slashing damage.

***Cold Breath (Recharge 5-6).*** The dragon exhales an icy blast in a 30-foot cone. Each creature in that area must make a DC 15 Constitution saving throw, taking 45 (`dice: 10d8|avg` (`10d8`)) cold damage on a failed save, or half as much damage on a successful one.
```
^statblock
