...
![[token/bronze-dragon-wyrmling.png#token]]
...
- **Lightning Breath.** The dragon exhales lightning in a 40-foot line that is 5 feet wide. Each creature in that line must make a DC 12 Dexterity saving throw, taking 16 (`dice: 3d10|avg` (`3d10`)) lightning damage on a failed save, or half as much damage on a successful one.  
