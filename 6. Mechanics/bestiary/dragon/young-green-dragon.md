...
![[token/young-green-dragon.png#token]]
...
***Poison Breath (Recharge 5-6).*** The dragon exhales poisonous gas in a 30-foot cone. Each creature in that area must make a DC 14 Constitution saving throw, taking 42 (`dice: 12d6|avg` (`12d6`)) poison damage on a failed save, or half as much damage on a successful one.
```
^statblock
