...
***Marshal Undead.*** Unless the death knight is [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated), it and undead creatures of its choice within 60 feet of it have advantage on saving throws against features that turn undead.
...
**1st level (4 1st-level slots)**: [command](/6. Mechanics/spells/command.md), [compelled duel](/6. Mechanics/spells/compelled-duel.md), [searing smite](/6. Mechanics/spells/searing-smite.md)

**2nd level (3 2nd-level slots)**: [hold person](/6. Mechanics/spells/hold-person.md), [magic weapon](/6. Mechanics/spells/magic-weapon.md)

**3rd level (3 3rd-level slots)**: [dispel magic](/6. Mechanics/spells/dispel-magic.md), [elemental weapon](/6. Mechanics/spells/elemental-weapon.md)

**4th level (3 4th-level slots)**: [banishment](/6. Mechanics/spells/banishment.md), [staggering smite](/6. Mechanics/spells/staggering-smite.md)

**5th level (2 5th-level slots)**: [destructive wave](/6. Mechanics/spells/destructive-wave.md) (necrotic)
