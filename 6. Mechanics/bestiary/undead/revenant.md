...
```ad-statblock
title: Revenant
![[token/revenant.png#token]]
*Medium undead, Neutral*

- **Armor Class** 13 ([leather armor](/6. Mechanics/items/leather-armor.md))
