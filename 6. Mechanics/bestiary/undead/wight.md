...
```ad-statblock
title: Wight
![[token/wight.png#token]]
*Medium undead, Neutral Evil*

- **Armor Class** 14 ([studded leather](/6. Mechanics/items/studded-leather-armor.md))
...
***Sunlight Sensitivity.*** While in sunlight, the wight has disadvantage on attack rolls, as well as on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on sight.
...
A humanoid slain by this attack rises 24 hours later as a [zombie](/6. Mechanics/bestiary/undead/zombie.md) under the wight's control, unless the humanoid is restored to life or its body is destroyed. The wight can have no more than twelve zombies under its control at one time.
