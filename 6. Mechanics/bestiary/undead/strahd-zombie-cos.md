...
If its head is severed, the zombie loses its bite attack and its body is [blinded](/6. Mechanics/rules/conditions.md#blinded) unless the head can see it. The severed head has a speed of 0 feet. It can make a bite attack, but only against a target in its space.

The zombie's speed is halved if it's missing a leg. If it loses both legs, it falls [prone](/6. Mechanics/rules/conditions.md#prone). If it has both arms, it can crawl. With only one arm, it can still crawl, but its speed is halved. With no arms or legs, its speed is 0 feet, and it can't benefit from bonuses to speed.
