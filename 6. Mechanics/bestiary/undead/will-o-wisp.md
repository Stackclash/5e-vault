...
***Invisibility.*** The will-o'-wisp and its light magically become [invisible](/6. Mechanics/rules/conditions.md#invisible) until it attacks or uses its Consume Life, or until its [concentration](/6. Mechanics/rules/status.md#concentration) ends (as if [concentration](/6. Mechanics/rules/status.md#concentration) on a spell).
```
^statblock
