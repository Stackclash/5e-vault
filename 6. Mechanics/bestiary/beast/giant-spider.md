...
***Web (Recharge 5-6).*** *Ranged Weapon Attack:* `dice: d20+5` (+5 to hit), range 30/60 ft., one creature. Hit: The target is [restrained](/6. Mechanics/rules/conditions.md#restrained) by webbing. As an action, the [restrained](/6. Mechanics/rules/conditions.md#restrained) target can make a DC 12 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage).
```
^statblock
