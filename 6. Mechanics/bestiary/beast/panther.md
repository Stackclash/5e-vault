...
***Keen Smell.*** The panther has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on smell.

***Pounce.*** If the panther moves at least 20 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 12 Strength saving throw or be knocked [prone](/6. Mechanics/rules/conditions.md#prone). If the target is [prone](/6. Mechanics/rules/conditions.md#prone), the panther can make one bite attack against it as a bonus action.
