...
![[token/tyrannosaurus-rex.png#token]]
...
***Bite.*** *Melee Weapon Attack:* `dice: d20+10` (+10 to hit), reach 10 ft., one target. Hit: `dice: 4d12 + 7|avg` (`4d12 + 7`) piercing damage. If the target is a Medium or smaller creature, it is [grappled](/6. Mechanics/rules/conditions.md#grappled) (escape DC 17). Until this grapple ends, the target is [restrained](/6. Mechanics/rules/conditions.md#restrained), and the tyrannosaurus can't bite another target.
