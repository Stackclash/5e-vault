...
![[token/baba-lysagas-creeping-hut.png#token]]
...
***Antimagic Susceptibility.*** The hut is [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) while the magic gem that animates it is in the area of an [antimagic field](/6. Mechanics/spells/antimagic-field.md). If targeted by [dispel magic](/6. Mechanics/spells/dispel-magic.md), the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](/6. Mechanics/rules/conditions.md#unconscious) for 1 minute.
