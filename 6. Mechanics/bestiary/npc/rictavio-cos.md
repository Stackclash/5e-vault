...
```ad-statblock
title: Rictavio
![[token/rictavio.png#token]]
*Medium humanoid(human), Lawful Good*

- **Armor Class** 12 ([leather armor](/6. Mechanics/items/leather-armor.md))
...
***Special Equipment.*** In addition to his sword cane, Rictavio wears a [hat of disguise](/6. Mechanics/items/hat-of-disguise.md) and a [ring of mind shielding](/6. Mechanics/items/ring-of-mind-shielding.md), and he carries a [spell scroll](/6. Mechanics/items/spell-scroll-5th-level.md) of [raise dead](/6. Mechanics/spells/raise-dead.md).
...
**Cantrips (at will)**: [guidance](/6. Mechanics/spells/guidance.md), [light](/6. Mechanics/spells/light.md), [mending](/6. Mechanics/spells/mending.md), [thaumaturgy](/6. Mechanics/spells/thaumaturgy.md)

**1st level (4 1st-level slots)**: [cure wounds](/6. Mechanics/spells/cure-wounds.md), [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [protection from evil and good](/6. Mechanics/spells/protection-from-evil-and-good.md), [sanctuary](/6. Mechanics/spells/sanctuary.md)

**2nd level (3 2nd-level slots)**: [augury](/6. Mechanics/spells/augury.md), [lesser restoration](/6. Mechanics/spells/lesser-restoration.md), [protection from poison](/6. Mechanics/spells/protection-from-poison.md)

**3rd level (3 3rd-level slots)**: [magic circle](/6. Mechanics/spells/magic-circle.md), [remove curse](/6. Mechanics/spells/remove-curse.md), [speak with dead](/6. Mechanics/spells/speak-with-dead.md)

**4th level (3 4th-level slots)**: [death ward](/6. Mechanics/spells/death-ward.md), [freedom of movement](/6. Mechanics/spells/freedom-of-movement.md)

**5th level (1 5th-level slots)**: [dispel evil and good](/6. Mechanics/spells/dispel-evil-and-good.md)

## Actions

***Multiattack.*** Rictavio makes two attacks with his sword cane.

***Sword Cane.*** *Melee Weapon Attack:* `dice: d20+4` (+4 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 1|avg` (`1d6 + 1`) bludgeoning damage (wooden cane) or piercing damage (silvered sword).
```
^statblock