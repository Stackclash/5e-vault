...
```ad-statblock
title: Rahadin
![[token/rahadin.png#token]]
*Medium humanoid(elf), Lawful Evil*

- **Armor Class** 18 ([studded leather](/6. Mechanics/items/studded-leather-armor.md))
...
***Deathly Choir.*** Any creature within 10 feet of Rahadin that isn't protected by a [mind blank](/6. Mechanics/spells/mind-blank.md) spell hears in its mind the screams of the thousands of people Rahadin has killed. As a bonus action, Rahadin can force all creatures that can hear the screams to make a DC 16 Wisdom saving throw. Each creature takes `dice: 3d10|avg` (`3d10`) psychic damage on a failed save, or half as much damage on a successful one.

***Fey Ancestry.*** Rahadin has advantage on saving throws against being [charmed](/6. Mechanics/rules/conditions.md#charmed), and magic can't put him to sleep.
...
**1/day**: [magic weapon](/6. Mechanics/spells/magic-weapon.md), [nondetection](/6. Mechanics/spells/nondetection.md)

**3/day**: [misty step](/6. Mechanics/spells/misty-step.md), [phantom steed](/6. Mechanics/spells/phantom-steed.md)

## Actions

***Multiattack.*** Rahadin attacks three times with his scimitar, or twice with his [poisoned](/6. Mechanics/rules/conditions.md#poisoned) darts.
