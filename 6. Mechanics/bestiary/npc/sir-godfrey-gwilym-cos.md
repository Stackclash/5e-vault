...
![[token/sir-godfrey-gwilym.png#token]]
...
**1st level (4 1st-level slots)**: [command](/6. Mechanics/spells/command.md), [divine favor](/6. Mechanics/spells/divine-favor.md), [thunderous smite](/6. Mechanics/spells/thunderous-smite.md)

**2nd level (3 2nd-level slots)**: [branding smite](/6. Mechanics/spells/branding-smite.md), [magic weapon](/6. Mechanics/spells/magic-weapon.md)

**3rd level (3 3rd-level slots)**: [blinding smite](/6. Mechanics/spells/blinding-smite.md), [dispel magic](/6. Mechanics/spells/dispel-magic.md)

**4th level (2 4th-level slots)**: [staggering smite](/6. Mechanics/spells/staggering-smite.md)
...
***Vengeful Glare.*** The knight targets one creature it can see within 30 feet of it and against which it has sworn vengeance. The target must make a DC 15 Wisdom saving throw. On a failure, the target is [paralyzed](/6. Mechanics/rules/conditions.md#paralyzed) until the knight deals damage to it, or until the end of the knight's next turn. When the paralysis ends, the target is [frightened](/6. Mechanics/rules/conditions.md#frightened) of the knight for 1 minute. The [frightened](/6. Mechanics/rules/conditions.md#frightened) target can repeat the saving throw at the end of each of its turns, with disadvantage if it can see the knight, ending the [frightened](/6. Mechanics/rules/conditions.md#frightened) condition on itself on a success.
```
^statblock
