...
```ad-statblock
title: Arrigal
![[token/arrigal.png#token]]
*Medium humanoid(human), Neutral Evil*

- **Armor Class** 15 ([studded leather](/6. Mechanics/items/studded-leather-armor.md))
...
***Sneak Attack (1/Turn).*** Arrigal deals an extra 14 (`dice: 4d6|avg` (`4d6`)) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Arrigal that isn't [incapacitated](/6. Mechanics/rules/conditions.md#incapacitated) and Arrigal doesn't have disadvantage on the attack roll.
...
The curse lasts until ended with a [greater restoration](/6. Mechanics/spells/greater-restoration.md) spell, a [remove curse](/6. Mechanics/spells/remove-curse.md) spell, or similar magic. It doesn't end when the target dies. If a cursed target is returned to life, the curse remains in effect.

***Evil Eye (Recharges after a Short or Long Rest).*** As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the [animal friendship](/6. Mechanics/spells/animal-friendship.md), [charm person](/6. Mechanics/spells/charm-person.md), or [hold person](/6. Mechanics/spells/hold-person.md) spell (Vistana's choice; spell DC 11), but requires neither somatic nor material components. If the target succeeds on the save, the Vistana is [blinded](/6. Mechanics/rules/conditions.md#blinded) until the end of the Vistana's next turn.
