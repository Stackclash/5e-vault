...
![[token/vladimir-horngaard.png#token]]
*Medium undead, Lawful Evil*

- **Armor Class** 17 ([half plate armor](/6. Mechanics/items/half-plate-armor.md))
...
***Vengeful Glare.*** Vladimir can target Strahd within 30 feet provided he can see Strahd. Strahd must make a DC 15 Wisdom saving throw. One a failure, Strahd is [paralyzed](/6. Mechanics/rules/conditions.md#paralyzed) until Vladimir deals damage to him, or until the end of Vladimir's next turn. When the paralysis ends, Strahd is [frightened](/6. Mechanics/rules/conditions.md#frightened) of Vladimir for 1 minute. Strahd can repeat the saving throw at the end of each of his turns, with disadvantage if he can see Vladimir, ending the [frightened](/6. Mechanics/rules/conditions.md#frightened) condition on itself on a success.
```
^statblock