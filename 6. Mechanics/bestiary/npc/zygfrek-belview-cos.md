...
![](/compendium/bestiary/npc/token/zygfrek-belview.png#token)
...
***Claw.*** *Melee Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft., one target. Hit: 1d4 + 1\|avg (`1d4 + 1`) slashing damage.

***Dagger.*** *Melee or Ranged Weapon Attack:* `dice: d20+3` (+3 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: 1d4 + 1\|avg (`1d4 + 1`) piercing damage.
```
^statblock