...
***Shapechanger.*** Baba Lysaga can use an action to polymorph into a [swarm of insects](/6. Mechanics/bestiary/beast/swarm-of-insects.md) (flies), or back into her true form. While in swarm form, she has a walking speed of 5 feet and a flying speed of 30 feet. Anything she is wearing transforms with her, but nothing she is carrying does.

***Blessing of Mother Night.*** Baba Lysaga is shielded against divination magic, as though protected by a [nondetection](/6. Mechanics/spells/nondetection.md) spell.
...
**Cantrips (at will)**: [acid splash](/6. Mechanics/spells/acid-splash.md), [fire bolt](/6. Mechanics/spells/fire-bolt.md), [light](/6. Mechanics/spells/light.md), [mage hand](/6. Mechanics/spells/mage-hand.md), [prestidigitation](/6. Mechanics/spells/prestidigitation.md)

**1st level (4 1st-level slots)**: [detect magic](/6. Mechanics/spells/detect-magic.md), [magic missile](/6. Mechanics/spells/magic-missile.md), [sleep](/6. Mechanics/spells/sleep.md), [witch bolt](/6. Mechanics/spells/witch-bolt.md)

**2nd level (3 2nd-level slots)**: [crown of madness](/6. Mechanics/spells/crown-of-madness.md), [enlarge/reduce](/6. Mechanics/spells/enlarge-reduce.md), [misty step](/6. Mechanics/spells/misty-step.md)

**3rd level (3 3rd-level slots)**: [dispel magic](/6. Mechanics/spells/dispel-magic.md), [fireball](/6. Mechanics/spells/fireball.md), [lightning bolt](/6. Mechanics/spells/lightning-bolt.md)

**4th level (3 4th-level slots)**: [blight](/6. Mechanics/spells/blight.md), [Evard's black tentacles](/6. Mechanics/spells/evards-black-tentacles.md), [polymorph](/6. Mechanics/spells/polymorph.md)

**5th level (2 5th-level slots)**: [cloudkill](/6. Mechanics/spells/cloudkill.md), [geas](/6. Mechanics/spells/geas.md), [scrying](/6. Mechanics/spells/scrying.md)

**6th level (1 6th-level slots)**: [programmed illusion](/6. Mechanics/spells/programmed-illusion.md), [true seeing](/6. Mechanics/spells/true-seeing.md)

**7th level (1 7th-level slots)**: [finger of death](/6. Mechanics/spells/finger-of-death.md), [mirage arcane](/6. Mechanics/spells/mirage-arcane.md)

**8th level (1 8th-level slots)**: [power word stun](/6. Mechanics/spells/power-word-stun.md)

## Actions

***Multiattack.*** Baba Lysaga makes three attacks with her quarterstaff.

***Quarterstaff.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d6 + 4|avg` (`1d6 + 4`) bludgeoning damage, or 8 (`dice: 1d8 + 4|avg` (`1d8 + 4`)) bludgeoning damage if wielded with two hands.

***Summon Swarms of Insects (Recharges after a Short or Long Rest).*** Baba Lysaga summons `dice: 1d4|avg` (`1d4`) swarms of insects. A summoned swarm appears in an unoccupied space within 60 feet of Baba Lysaga and acts as her ally. It remains until it dies or until Baba Lysaga dismisses it as an action.
```
^statblock