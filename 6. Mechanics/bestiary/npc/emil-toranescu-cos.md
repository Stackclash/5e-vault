...
![[token/emil-toranescu.png#token]]
...
***Keen Hearing and Smell.*** Emil has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on hearing or smell.
