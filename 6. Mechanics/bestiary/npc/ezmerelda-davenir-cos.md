...
![[token/ezmerelda-davenir.png#token]]
...
***Special Equipment.*** In addition to her magic armor and weapons, Ezmerelda has two [potions of greater healing](/6. Mechanics/items/potion-of-greater-healing.md), six [vials of holy water](/6. Mechanics/items/holy-water-flask.md), and three wooden stakes.
...
**Cantrips (at will)**: [fire bolt](/6. Mechanics/spells/fire-bolt.md), [light](/6. Mechanics/spells/light.md), [mage hand](/6. Mechanics/spells/mage-hand.md), [prestidigitation](/6. Mechanics/spells/prestidigitation.md)

**1st level (4 1st-level slots)**: [protection from evil and good](/6. Mechanics/spells/protection-from-evil-and-good.md), [magic missile](/6. Mechanics/spells/magic-missile.md), [shield](/6. Mechanics/spells/shield.md)

**2nd level (3 2nd-level slots)**: [darkvision](/6. Mechanics/spells/darkvision.md), [knock](/6. Mechanics/spells/knock.md), [mirror image](/6. Mechanics/spells/mirror-image.md)

**3rd level (3 3rd-level slots)**: [clairvoyance](/6. Mechanics/spells/clairvoyance.md), [lightning bolt](/6. Mechanics/spells/lightning-bolt.md), [magic circle](/6. Mechanics/spells/magic-circle.md)

**4th level (1 4th-level slots)**: [greater invisibility](/6. Mechanics/spells/greater-invisibility.md)

## Actions

***Multiattack.*** Ezmerelda makes three attacks: two with her +1 rapier and one with her +1 handaxe or her silvered shortsword.

***Rapier +1.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 5|avg` (`1d8 + 5`) piercing damage.

***Handaxe +1.*** *Melee or Ranged Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft. or range 20/60 ft., one target. Hit: `dice: 1d6 + 3|avg` (`1d6 + 3`) slashing damage.
