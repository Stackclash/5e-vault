...
***Angelic Weapons.*** The solar's weapon attacks are magical. When the solar hits with any weapon, the weapon deals an extra `dice: 6d8|avg` (`6d8`) radiant damage (included in the attack).
...
**At will**: [detect evil and good](/6. Mechanics/spells/detect-evil-and-good.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only)

**1/day each**: [commune](/6. Mechanics/spells/commune.md), [control weather](/6. Mechanics/spells/control-weather.md)

**3/day each**: [blade barrier](/6. Mechanics/spells/blade-barrier.md), [dispel evil and good](/6. Mechanics/spells/dispel-evil-and-good.md), [resurrection](/6. Mechanics/spells/resurrection.md)

## Actions

***Multiattack.*** The solar makes two greatsword attacks.

***Greatsword.*** *Melee Weapon Attack:* `dice: d20+15` (+15 to hit), reach 5 ft., one target. Hit: `dice: 4d6 + 8|avg` (`4d6 + 8`) slashing damage plus `dice: 6d8|avg` (`6d8`) radiant damage.

***Slaying Longbow.*** *Ranged Weapon Attack:* `dice: d20+13` (+13 to hit), range 150/600 ft., one target. Hit: `dice: 2d8 + 6|avg` (`2d8 + 6`) piercing damage plus `dice: 6d8|avg` (`6d8`) radiant damage. If the target is a creature that has 100 hit points or fewer, it must succeed on a DC 15 Constitution saving throw or die.

***Flying Sword.*** The solar releases its greatsword to hover magically in an unoccupied space within 5 feet of it. If the solar can see the sword, the solar can mentally command it as a bonus action to fly up to 50 feet and either make one attack against a target or return to the solar's hands. If the hovering sword is targeted by any effect, the solar is considered to be holding it. The hovering sword falls if the solar dies.

***Healing Touch (4/Day).*** The solar touches another creature. The target magically regains 40 (`dice: 8d8 + 4|avg` (`8d8 + 4`)) hit points and is freed from any curse, disease, poison, blindness, or deafness.

## Legendary Actions

***Teleport.*** The solar magically teleports, along with any equipment it is wearing or carrying, up to 120 feet to an unoccupied space it can see.

***Searing Burst (Costs 2 Actions).*** The solar emits magical, divine energy. Each creature of its choice in a 10-foot radius must make a DC 23 Dexterity saving throw, taking 14 (`dice: 4d6|avg` (`4d6`)) fire damage plus `dice: 4d6|avg` (`4d6`) radiant damage on a failed save, or half as much damage on a successful one.

***Blinding Gaze (Costs 3 Actions).*** The solar targets one creature it can see within 30 feet of it. If the target can see it, the target must succeed on a DC 15 Constitution saving throw or be [blinded](/6. Mechanics/rules/conditions.md#blinded) until magic such as the [lesser restoration](/6. Mechanics/spells/lesser-restoration.md) spell removes the blindness.
```
^statblock