...
Ruined desert cities and the tombs of forgotten monarchs make perfect lairs for the wicked lamias. These decadent monsters take what has been forgotten and make it the seat of their hedonistic rule, surrounding themselves with sycophants. Lamias rely on [jackalweres](/6. Mechanics/bestiary/humanoid/jackalwere.md) to perform various tasks, sending them across the wastes to capture slaves or steal treasures from caravans, encampments, or villages, concealed by the lamia's magic as they attack.
...
Using its intoxicating touch, a lamia weakens the minds of its enemies, making them more susceptible to its enchantment spells and turning them into its slaves. Those it beguiles with [geas](/6. Mechanics/spells/geas.md) spells are pitted against each other in elaborate contests for the lamia's amusement.

## Vain Predators

Always anxious to gain more wealth and slaves, a lamia uses a pool of water or a mirror in conjunction with a [scrying](/6. Mechanics/spells/scrying.md) spell to view its domain. A lamia uses this power to watch over trade routes and nearby settlements, or to seek out objects and creatures it fancies.
...
**At will**: [disguise self](/6. Mechanics/spells/disguise-self.md) (any humanoid form), [major image](/6. Mechanics/spells/major-image.md)

**1/day**: [geas](/6. Mechanics/spells/geas.md)

**3/day each**: [charm person](/6. Mechanics/spells/charm-person.md), [mirror image](/6. Mechanics/spells/mirror-image.md), [scrying](/6. Mechanics/spells/scrying.md), [suggestion](/6. Mechanics/spells/suggestion.md)
