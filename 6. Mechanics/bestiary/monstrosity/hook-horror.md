...
***Echolocation.*** The hook horror can't use its blindsight while [deafened](/6. Mechanics/rules/conditions.md#deafened).

***Keen Hearing.*** The hook horror has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on hearing.
