...
***Keen Sight.*** The hippogriff has advantage on Wisdom ([Perception](/6. Mechanics/rules/skills.md#Perception)) checks that rely on sight.

## Actions

***Multiattack.*** The hippogriff makes two attacks: one with its beak and one with its claws.

***Beak.*** *Melee Weapon Attack:* `dice: d20+5` (+5 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 3|avg` (`1d10 + 3`) piercing damage.
