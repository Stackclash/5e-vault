...
***Tendril.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 50 ft., one creature. Hit: The target is [grappled](/6. Mechanics/rules/conditions.md#grappled) (escape DC 15). Until the grapple ends, the target is [restrained](/6. Mechanics/rules/conditions.md#restrained) and has disadvantage on Strength checks and Strength saving throws, and the roper can't use the same tendril on another target.

***Reel.*** The roper pulls each creature [grappled](/6. Mechanics/rules/conditions.md#grappled) by it up to 25 feet straight toward it.
```
^statblock
