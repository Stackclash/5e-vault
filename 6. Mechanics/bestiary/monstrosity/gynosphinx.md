...
**Cantrips (at will)**: [mage hand](/6. Mechanics/spells/mage-hand.md), [minor illusion](/6. Mechanics/spells/minor-illusion.md), [prestidigitation](/6. Mechanics/spells/prestidigitation.md)

**1st level (4 1st-level slots)**: [detect magic](/6. Mechanics/spells/detect-magic.md), [identify](/6. Mechanics/spells/identify.md), [shield](/6. Mechanics/spells/shield.md)

**2nd level (3 2nd-level slots)**: [darkness](/6. Mechanics/spells/darkness.md), [locate object](/6. Mechanics/spells/locate-object.md), [suggestion](/6. Mechanics/spells/suggestion.md)

**3rd level (3 3rd-level slots)**: [dispel magic](/6. Mechanics/spells/dispel-magic.md), [remove curse](/6. Mechanics/spells/remove-curse.md), [tongues](/6. Mechanics/spells/tongues.md)

**4th level (3 4th-level slots)**: [banishment](/6. Mechanics/spells/banishment.md), [greater invisibility](/6. Mechanics/spells/greater-invisibility.md)

**5th level (1 5th-level slots)**: [legend lore](/6. Mechanics/spells/legend-lore.md)

## Actions

***Multiattack.*** The sphinx makes two claw attacks.

***Claw.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 2d8 + 4|avg` (`2d8 + 4`) slashing damage.
...
- The effects of time are altered such that every creature in the lair must succeed on a DC 15 Constitution saving throw or become `dice: 1d20|avg` (`1d20`) years older or younger (the sphinx's choice), but never any younger than 1 year old. A [greater restoration](/6. Mechanics/spells/greater-restoration.md) spell can restore a creature's age to normal.  
- The flow of time within the lair is altered such that everything within moves up to 10 years forward or backward (sphinx's choice). Only the sphinx is immediately aware of the time change. A [wish](/6. Mechanics/spells/wish.md) spell can return the caster and up to seven other creatures designated by the caster to their normal time.  
