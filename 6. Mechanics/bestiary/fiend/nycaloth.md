...
The elite airborne shock troops of the yugoloths, nycaloths look like muscular gargoyles. Powerful bat wings bear them swiftly aloft in battle, and the razorsharp claws of their hands and feet cut through flesh and bone with ease. A nightmarish foe, a nycaloth strikes hard and fast without warning, then teleports away. It uses its innate magic to turn [invisible](/6. Mechanics/rules/conditions.md#invisible) or create illusory doubles of itself, further confounding its enemies.
...
**At will**: [darkness](/6. Mechanics/spells/darkness.md), [detect magic](/6. Mechanics/spells/detect-magic.md), [dispel magic](/6. Mechanics/spells/dispel-magic.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only), [mirror image](/6. Mechanics/spells/mirror-image.md)
