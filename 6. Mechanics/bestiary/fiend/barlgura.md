...
**1/day each**: [entangle](/6. Mechanics/spells/entangle.md), [phantasmal force](/6. Mechanics/spells/phantasmal-force.md)

**2/day each**: [disguise self](/6. Mechanics/spells/disguise-self.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only)
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 1d10 + 4|avg` (`1d10 + 4`) bludgeoning damage.
```
^statblock