...
**At will**: [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [web](/6. Mechanics/spells/web.md)

**1/day**: [dominate person](/6. Mechanics/spells/dominate-person.md)

## Actions

***Multiattack.*** The yochlol makes two melee attacks.

***Slam (Bite in Spider Form).*** *Melee Weapon Attack:* `dice: d20+6` (+6 to hit), reach 5 ft. (10 feet in demon form), one target. Hit: 5 (`dice: 1d6 + 2|avg` (`1d6 + 2`)) bludgeoning (piercing in spider form) damage plus `dice: 6d6|avg` (`6d6`) poison damage.
