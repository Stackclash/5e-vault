...
**At will**: [alter self](/6. Mechanics/spells/alter-self.md), [darkness](/6. Mechanics/spells/darkness.md), [heat metal](/6. Mechanics/spells/heat-metal.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only), [magic missile](/6. Mechanics/spells/magic-missile.md)
...
**Cantrips (at will)**: [fire bolt](/6. Mechanics/spells/fire-bolt.md), [mage hand](/6. Mechanics/spells/mage-hand.md), [minor illusion](/6. Mechanics/spells/minor-illusion.md), [prestidigitation](/6. Mechanics/spells/prestidigitation.md)

**1st level (4 1st-level slots)**: [detect magic](/6. Mechanics/spells/detect-magic.md), [identify](/6. Mechanics/spells/identify.md), [shield](/6. Mechanics/spells/shield.md), [Tenser's floating disk](/6. Mechanics/spells/tensers-floating-disk.md)

**2nd level (3 2nd-level slots)**: [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [mirror image](/6. Mechanics/spells/mirror-image.md), [phantasmal force](/6. Mechanics/spells/phantasmal-force.md), [suggestion](/6. Mechanics/spells/suggestion.md)

**3rd level (3 3rd-level slots)**: [counterspell](/6. Mechanics/spells/counterspell.md), [fear](/6. Mechanics/spells/fear.md), [fireball](/6. Mechanics/spells/fireball.md)

**4th level (3 4th-level slots)**: [banishment](/6. Mechanics/spells/banishment.md), [dimension door](/6. Mechanics/spells/dimension-door.md)

**5th level (2 5th-level slots)**: [contact other plane](/6. Mechanics/spells/contact-other-plane.md), [hold monster](/6. Mechanics/spells/hold-monster.md)

**6th level (1 6th-level slots)**: [chain lightning](/6. Mechanics/spells/chain-lightning.md)

**7th level (1 7th-level slots)**: [finger of death](/6. Mechanics/spells/finger-of-death.md)

**8th level (1 8th-level slots)**: [mind blank](/6. Mechanics/spells/mind-blank.md)

## Actions

***Claws.*** *Melee Weapon Attack:* `dice: d20+7` (+7 to hit), reach 5 ft., one target. Hit: `dice: 2d4 + 3|avg` (`2d4 + 3`) slashing damage. The target must make a DC 14 Constitution saving throw, taking 10 (`dice: 3d6|avg` (`3d6`)) poison damage on a failed save, or half as much damage on a successful one.
