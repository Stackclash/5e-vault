...
**At will**: [alter self](/6. Mechanics/spells/alter-self.md), [clairvoyance](/6. Mechanics/spells/clairvoyance.md), [darkness](/6. Mechanics/spells/darkness.md), [detect magic](/6. Mechanics/spells/detect-magic.md), [detect thoughts](/6. Mechanics/spells/detect-thoughts.md), [dispel magic](/6. Mechanics/spells/dispel-magic.md), [invisibility](/6. Mechanics/spells/invisibility.md) (self only), [suggestion](/6. Mechanics/spells/suggestion.md)

**1/day each**: [fire storm](/6. Mechanics/spells/fire-storm.md), [mass suggestion](/6. Mechanics/spells/mass-suggestion.md)

**3/day each**: [dimension door](/6. Mechanics/spells/dimension-door.md), [fear](/6. Mechanics/spells/fear.md), [wall of fire](/6. Mechanics/spells/wall-of-fire.md)

## Actions

***Multiattack.*** The ultroloth can use its Hypnotic Gaze and makes three melee attacks.

***Longsword.*** *Melee Weapon Attack:* `dice: d20+8` (+8 to hit), reach 5 ft., one target. Hit: `dice: 1d8 + 3|avg` (`1d8 + 3`) slashing damage, or 8 (`dice: 1d10 + 3|avg` (`1d10 + 3`)) slashing damage if used with two hands.

***Hypnotic Gaze.*** The ultroloth's eyes sparkle with opalescent light as it targets one creature it can see within 30 feet of it. If the target can see the ultroloth, the target must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](/6. Mechanics/rules/conditions.md#charmed) until the end of the ultroloth's next turn. The [charmed](/6. Mechanics/rules/conditions.md#charmed) target is [stunned](/6. Mechanics/rules/conditions.md#stunned). If the target's saving throw is successful, the target is immune to the ultroloth's gaze for the next 24 hours.
