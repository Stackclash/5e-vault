...
***Charge.*** If the goristro moves at least 15 feet straight toward a target and then hits it with a gore attack on the same turn, the target takes an extra 38 (`dice: 7d10|avg` (`7d10`)) piercing damage. If the target is a creature, it must succeed on a DC 21 Strength saving throw or be pushed up to 20 feet away and knocked [prone](/6. Mechanics/rules/conditions.md#prone).
...
***Fist.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 10 ft., one target. Hit: `dice: 3d8 + 7|avg` (`3d8 + 7`) bludgeoning damage.

***Hoof.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 5 ft., one target. Hit: `dice: 3d10 + 7|avg` (`3d10 + 7`) bludgeoning damage. If the target is a creature, it must succeed on a DC 21 Strength saving throw or be knocked [prone](/6. Mechanics/rules/conditions.md#prone).

***Gore.*** *Melee Weapon Attack:* `dice: d20+13` (+13 to hit), reach 10 ft., one target. Hit: `dice: 7d10 + 7|avg` (`7d10 + 7`) piercing damage.
```
^statblock