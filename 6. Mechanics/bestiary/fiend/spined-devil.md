...
***Bite.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 2d4|avg` (`2d4`) slashing damage.

***Fork.*** *Melee Weapon Attack:* `dice: d20+2` (+2 to hit), reach 5 ft., one target. Hit: `dice: 1d6|avg` (`1d6`) piercing damage.

***Tail Spine.*** *Ranged Weapon Attack:* `dice: d20+4` (+4 to hit), range 20/80 ft., one target. Hit: `dice: 1d4 + 2|avg` (`1d4 + 2`) piercing damage plus `dice: 1d6|avg` (`1d6`) fire damage.
```
^statblock