...
The Spell Points by Level table applies to [[/6. Mechanics/Classes/Bard.md|bards]], [[/6. Mechanics/Classes/Cleric.md|clerics]], [[/6. Mechanics/Classes/Druid.md|druids]], [[/6. Mechanics/Classes/Sorcerer.md|sorcerers]], and [[/6. Mechanics/Classes/Wizard.md|wizards]]. For a [[/6. Mechanics/Classes/Paladin.md|paladin]] or [[/6. Mechanics/Classes/Ranger.md|ranger]], halve the character's level in that class and then consult the table. For a [[/6. Mechanics/Classes/Fighter Eldritch Knight.md|fighter (Eldritch Knight)]] or [[/6. Mechanics/Classes/Rogue Arcane Trickster.md|rogue (Arcane Trickster)]], divide the character's level in that class by three.
