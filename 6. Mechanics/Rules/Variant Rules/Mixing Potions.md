...
| 00 | Only one potion works, but its effect is permanent. Choose the simplest effect to make permanent, or the one that seems the most fun. For example, a [[/6. Mechanics/Items/Potion Of Healing.md|potion of healing]] might increase the drinker's hit point maximum by 4, or [[/6. Mechanics/Items/Oil Of Etherealness.md|oil of etherealness]] might permanently trap the user in the Ethereal Plane. At your discretion, an appropriate spell, such as [[/6. Mechanics/Spells/Dispel Magic.md|dispel magic]] or [[/6. Mechanics/Spells/Remove Curse.md|remove curse]], might end this lasting effect. |
^potion-miscibility