...
|-------------|----------------|
| 1–5 | Roll `dice: 1d6` (`1d6`) times on Magic Item Table A. |
| 6–10 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table B. |
| 11–15 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table C. |
| 16–20 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table D. |
| 21–25 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table E. |
| 26–30 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table F. |
| 31–35 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table G. |
| 36–40 | Roll `dice: 1d4` (`1d4`) times on Magic Item Table H. |
| 41+ | Roll `dice: 1d4` (`1d4`) times on Magic Item Table I. |
^buying-magic-items
...
| Rarity | Asking Price* |
|--------|---------------|
| Common | (`dice: 1d6 + 1` (`1d6 + 1`)) × 10 gp |
| Uncommon | `1d6 × 100` gp |
| Rare | `2d10 × 1,000` gp |
| Very rare | (`dice: 1d4 + 1` (`1d4 + 1`)) × 10,000 gp |
