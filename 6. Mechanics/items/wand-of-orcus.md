...
Any creature besides Orcus that tries to attune to the wand must make a DC 17 Constitution saving throw. On a successful save, the creature takes `dice: 10d6|avg` (`10d6`) necrotic damage. On a failed save, the creature dies and rises as a [zombie](/6. Mechanics/bestiary/undead/zombie.md).

In the hands of one who is attuned to it, the wand can be wielded as a magic [mace](/6. Mechanics/items/mace.md) that grants a +3 bonus to attack and damage rolls made with it. The wand deals an extra `dice: 2d12|avg` (`2d12`) necrotic damage on a hit.
...
The wand has 7 charges. While holding it, you can use an action and expend 1 or more of its charges to cast one of the following spells (save DC 18) from it: [animate dead](/6. Mechanics/spells/animate-dead.md) (1 charge), [blight](/6. Mechanics/spells/blight.md) (2 charges), [circle of death](/6. Mechanics/spells/circle-of-death.md) (3 charges), [finger of death](/6. Mechanics/spells/finger-of-death.md) (3 charges), [power word kill](/6. Mechanics/spells/power-word-kill.md) (4 charges), or [speak with dead](/6. Mechanics/spells/speak-with-dead.md) (1 charge). The wand regains `dice: 1d4 + 3|avg` (`1d4 + 3`) expended charges daily at dawn.
...
The Wand of Orcus is a sentient, chaotic evil item with an Intelligence of 16, a Wisdom of 12, and a Charisma of 16. It has hearing and [darkvision](/6. Mechanics/rules/senses.md#darkvision) out to a range of 120 feet.
