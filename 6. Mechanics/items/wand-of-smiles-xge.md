...
The wand regains all expended charges daily at dawn. If you expend the wand's last charge, roll a `dice: d20|avg` (`d20`). On a 1, the wand transforms into a [wand of scowls](/6. Mechanics/items/wand-of-scowls-xge.md).
