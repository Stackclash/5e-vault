...
While within 30 feet of the icon, a creature is under the effect of a [protection from evil and good](/6. Mechanics/spells/protection-from-evil-and-good.md) spell against fiends and undead. Only a creature attuned to the icon can use its other properties.

## Augury

You can use an action to cast an [augury](/6. Mechanics/spells/augury.md) spell from the icon, with no material components required. Once used, this property can't be used again until the next dawn.
