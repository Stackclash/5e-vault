...
- **Damage**:
  - One-handed: 1d8 R
  - Two-handed: 1d10 R
- **Properties**: [Finesse](/6. Mechanics/rules/item-properties.md#Finesse), [Martial](/6. Mechanics/rules/item-properties.md#Martial), [Requires Attunement](/6. Mechanics/rules/item-properties.md#Requires%20Attunement), [Versatile](/6. Mechanics/rules/item-properties.md#Versatile)
- **Cost**: ⏤
- **Weight**: 3.0 lbs.
...
The hilt, which is sentient, knows that it can never be reunited with its original crystal blade. It has, however, gained the properties of a [sun blade](/6. Mechanics/items/sun-blade.md):
