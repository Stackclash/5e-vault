...
The silver horn summons `dice: 2d4 + 2|avg` (`2d4 + 2`) [berserkers](/6. Mechanics/bestiary/humanoid/berserker.md).

The [berserkers](/6. Mechanics/bestiary/humanoid/berserker.md) are friendly to you and your companions and follow your commands.
