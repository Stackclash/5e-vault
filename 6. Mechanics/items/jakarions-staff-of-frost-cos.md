...
- **Damage**:
  - One-handed: 1d6 B
  - Two-handed: 1d8 B
- **Properties**: [[compendium/rules/item-properties.md#Requires Attunement|Requires Attunement]], [[compendium/rules/item-properties.md#Versatile|Versatile]]
- **Cost**: ⏤
- **Weight**: 4.0 lbs.
...
The staff regains 1d6 + 4\|avg (`1d6 + 4`) expended charges daily at dawn. If you expend the last charge, roll a d20\|avg (`d20`). On a 1. the staff turns to water and is destroyed.
