...
While attuned to an orb, you can use an action to peer into the orb's depths and speak its command word. You must then make a DC 15 Charisma check. On a successful check, you control the orb for as long as you remain attuned to it. On a failed check, you become [charmed](/6. Mechanics/rules/conditions.md#charmed) by the orb for as long as you remain attuned to it.

While you are [charmed](/6. Mechanics/rules/conditions.md#charmed) by the orb, you can't voluntarily end your attunement to it, and the orb casts [suggestion](/6. Mechanics/spells/suggestion.md) on you at will (save DC 18), urging you to work toward the evil ends it desires. The dragon essence within the orb might want many things: the annihilation of a particular people, freedom from the orb, to spread suffering in the world, to advance the worship of Takhisis (Tiamat's name on Krynn), or something else the DM decides.
...
The orb has 7 charges and regains `dice: 1d4 + 3|avg` (`1d4 + 3`) expended charges daily at dawn. If you control the orb, you can use an action and expend 1 or more charges to cast one of the following spells (save DC 18) from it: [cure wounds](/6. Mechanics/spells/cure-wounds.md) (5th-level version, 3 charges), [daylight](/6. Mechanics/spells/daylight.md) (1 charge), [death ward](/6. Mechanics/spells/death-ward.md) (2 charges), or [scrying](/6. Mechanics/spells/scrying.md) (3 charges). You can also use an action to cast the [detect magic](/6. Mechanics/spells/detect-magic.md) spell from the orb without using any charges.
...
An Orb of Dragonkind appears fragile but is impervious to most damage, including the attacks and breath weapons of dragons. A [disintegrate](/6. Mechanics/spells/disintegrate.md) spell or one good hit from a +3 magic weapon is sufficient to destroy an orb, however.
