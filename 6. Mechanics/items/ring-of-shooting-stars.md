...
While wearing this ring in dim light or darkness, you can cast [dancing lights](/6. Mechanics/spells/dancing-lights.md) and [light](/6. Mechanics/spells/light.md) from the ring at will. Casting either spell from the ring requires an action.
...
You can expend 1 charge as an action to cast [faerie fire](/6. Mechanics/spells/faerie-fire.md) from the ring.
...
Each sphere appears in an unoccupied space you can see within 120 feet of you. The spheres last as long as you concentrate (as if [concentration](/6. Mechanics/rules/status.md#concentration) on a spell), up to 1 minute. Each sphere sheds dim light in a 30-foot radius.
