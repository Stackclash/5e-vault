...
Once you've read and studied the book, you gain a protective halo. This halo sheds bright light in a 10-foot radius and dim light for an additional 10 feet. You can dismiss or manifest the halo as a bonus action. While present, the halo gives you advantage on Charisma ([Persuasion](/6. Mechanics/rules/skills.md#Persuasion)) checks made to interact with good creatures and Charisma ([Intimidation](/6. Mechanics/rules/skills.md#Intimidation)) checks made to interact with evil creatures. In addition, fiends and undead within the halo's bright light make attack rolls against you with disadvantage.
