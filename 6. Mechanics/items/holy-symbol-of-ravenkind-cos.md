...
As an action, you can expend 1 charge and present the holy symbol to make it flare with holy power. Vampires and [vampire spawn](/6. Mechanics/bestiary/undead/vampire-spawn.md) within 30 feet of the holy symbol when it flares must make a DC 15 Wisdom saving throw. On a failed save, a target is [paralyzed](/6. Mechanics/rules/conditions.md#paralyzed) for 1 minute. It can repeat the saving throw at the end of its turns to end the effect on itself.
