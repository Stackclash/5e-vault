...
- **Damage**: 1d6 B
- **Properties**: [[Item Properties#Requires Attunement|Requires Attunement]]
- **Cost**: ⏤
- **Weight**: 4.0 lbs.

Saint Markovia's thighbone has the properties of a mace of disruption. If it scores one or more hits against a [[Vampire.md\|Vampire]] or a [[/compendium/bestiary/undead/vampire-spawn.md\|vampire spawn]] in the course of a single battle, the thighbone crumbles into dust once the battle concludes.
...
Markovia had long considered Strahd a mad tyrant, but only after his transformation into a [[Vampire.md\|Vampire]] did she dare to challenge him. As she rallied her followers and prepared to march on Castle Ravenloft, Strahd sent a group of [[/compendium/bestiary/undead/vampire-spawn.md\|vampire spawn]] to her abbey. They confronted Markovia and were destroyed to a one.
