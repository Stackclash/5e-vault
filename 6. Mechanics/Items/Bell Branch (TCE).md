...
The branch has 3 charges, and it regains `dice: 1d3\|avg` (`1d3`) expended charges daily at dawn. You can use the charges in the following ways while holding it:
...
- As an action, you can expend 1 charge to cast [[/6. Mechanics/Spells/protection-from-evil-and-good.md\|protection from evil and good]].  
