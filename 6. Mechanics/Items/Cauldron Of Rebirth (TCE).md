...
This Tiny pot bears relief scenes of heroes on its cast iron sides. You can use the cauldron as a spellcasting focus for your spells, and it functions as a suitable component for the [[/6. Mechanics/Spells/Scrying.md|scrying]] spell. When you finish a long rest, you can use the cauldron to create a [[/6. Mechanics/Items/Potion Of Greater Healing.md|potion of greater healing]]. The potion lasts for 24 hours, then loses its magic if not consumed.
