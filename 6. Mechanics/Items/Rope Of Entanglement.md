...
You can release the creature by using a bonus action to speak a second command word. A target [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] by the rope can use an action to make a DC 15 Strength or Dexterity check (target's choice). On a success, the creature is no longer [[6. Mechanics/Rules/conditions.md#restrained\|restrained]] by the rope.
