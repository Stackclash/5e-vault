...
An etched crystal sphere the size of a grapefruit hums faintly and pulses with irregular flares of inner light. While you are touching the crystal, you can retrieve and store information and spells within the crystal at the same rate as reading and writing. When found, the crystal contains the following spells: [[/6. Mechanics/Spells/Detect Thoughts.md|detect thoughts]], [[/6. Mechanics/Spells/Intellect Fortress (TCE).md|intellect fortress]], [[/6. Mechanics/Spells/Rarys Telepathic Bond.md|Rary's telepathic bond]], [[/6. Mechanics/Spells/Sending.md|sending]], [[/6. Mechanics/Spells/Telekinesis.md|telekinesis]], [[/6. Mechanics/Spells/Tashas Mind Whip (TCE).md|Tasha's mind whip]], and [[/6. Mechanics/Spells/Tensers Floating Disk.md|Tenser's floating disk]]. It functions as a spellbook for you, with its spells and other writing psychically encoded within it.

While you are holding the crystal, you can use it as a spellcasting focus for your wizard spells, and you know the [[/6. Mechanics/Spells/Mage Hand.md|mage hand]], [[/6. Mechanics/Spells/Mind Sliver (TCE).md|mind sliver]] (appears in this book), and [[/6. Mechanics/Spells/Message.md|message]] cantrips if you don't already know them.

The crystal has 3 charges, and it regains `dice: 1d3` (`1d3`) expended charges daily at dawn. You can use the charges in the following ways while holding it:
