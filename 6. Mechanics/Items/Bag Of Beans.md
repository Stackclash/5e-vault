...
|------------|--------------|--------|
| 01 | `dice: 5d4\|avg` (`5d4`) toadstools sprout. If a creature eats a toadstool, roll any die. On an odd roll, the eater must succeed on a DC 15 Constitution saving throw or take `dice: 5d6\|avg` (`5d6`) poison damage and become [[6. Mechanics/Rules/conditions.md#poisoned\|poisoned]] for 1 hour. On an even roll, the eater gains `dice: 5d6\|avg` (`5d6`) temporary hit points for 1 hour. |
...
| 41-50 | `dice: 1d6 + 6\|avg` (`1d6 + 6`) [[/6. Mechanics/Bestiary/Plant/Shrieker.md\|shriekers]] sprout. |
