...
At 3rd level, you learn magical theory or some of the secrets of nature—typical for practitioners of this elven martial tradition. You choose to gain proficiency in either the [[6. Mechanics/Rules/skills.md#Arcana\|Arcana]] or the [[6. Mechanics/Rules/skills.md#Nature\|Nature]] skill, and you choose to learn either the [[/6. Mechanics/Spells/prestidigitation.md\|prestidigitation]] or the [[/6. Mechanics/Spells/druidcraft.md\|druidcraft]] cantrip.
...
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Banishing%20Arrow\|Banishing Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Beguiling%20Arrow\|Beguiling Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Bursting%20Arrow\|Bursting Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Enfeebling%20Arrow\|Enfeebling Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Grasping%20Arrow\|Grasping Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Piercing%20Arrow\|Piercing Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Seeking%20Arrow\|Seeking Arrow]]  
- [[/6. Mechanics/Classes/Fighter Arcane Archer (XGE).md#Shadow%20Arrow\|Shadow Arrow]]  
...
When this arrow strikes its target, conjuration magic creates grasping, poisonous brambles, which wrap around the target. The creature hit by the arrow takes an extra `dice: 2d6\|avg` (`2d6`) poison damage, its speed is reduced by 10 feet, and it takes `dice: 2d6\|avg` (`2d6`) slashing damage the first time on each turn it moves 1 foot or more without teleporting. The target or any creature that can reach it can use its action to remove the brambles with a successful Strength ([[6. Mechanics/Rules/skills.md#Athletics\|Athletics]]) check against your Arcane Shot save DC. Otherwise, the brambles last for 1 minute or until you use this option again.
