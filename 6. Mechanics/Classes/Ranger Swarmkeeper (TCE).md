...
You learn the [[/6. Mechanics/Spells/Mage Hand.md|mage hand]] cantrip if you don't already know it. When you cast it, the hand takes the form of your swarming nature spirits.
...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [[/6. Mechanics/Spells/Faerie Fire.md|faerie fire]] |
| 5th | [[/6. Mechanics/Spells/Web.md|web]] |
| 9th | [[/6. Mechanics/Spells/Gaseous Form.md|gaseous form]] |
| 13th | [[/6. Mechanics/Spells/Arcane Eye.md|arcane eye]] |
| 17th | [[/6. Mechanics/Spells/Insect Plague.md|insect plague]] |
^swarmkeeper-spells
...
You can condense part of your swarm into a focused mass that lifts you up. As a bonus action, you gain a flying speed of 10 feet and can hover. This effect lasts for 1 minute or until you are [[6. Mechanics/Rules/Conditions.md#incapacitated|incapacitated]].
...
- The damage of Gathered Swarm increases to `dice: 1d8` (`1d8`).  
- If a creature fails its saving throw against being moved by Gathered Swarm, you can also cause the swarm to knock the creature [[6. Mechanics/Rules/Conditions.md#prone|prone]].  
