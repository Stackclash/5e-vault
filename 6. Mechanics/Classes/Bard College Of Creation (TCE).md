...
Once you animate an item with this feature, you can't do so again until you finish a long rest, unless you expend a spell slot of 3rd level or higher to use this feature again. You can have only one item animated by this feature at a time; if you use this action and already have a [[/6. Mechanics/Bestiary/Construct/Dancing Item (TCE).md\|dancing item]] from this feature, the first one immediately becomes inanimate.
