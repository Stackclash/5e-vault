...
- "desc": "Sul Khatesh's spellcasting ability is Intelligence (spell save DC 26, +18\
    ...
    \ [[5. Mechanics/Spells/Shield.md|shield]]\n\n1/day each: [[5. Mechanics/Spells/Foresight.md|foresight]],\
    \ [[5. Mechanics/Spells/Gate.md|gate]], [[5. Mechanics/Spells/Power Word Kill.md|power word kill]],\
    \ [[5. Mechanics/Spells/Teleport.md|teleport]]\n\n3/day each: [[5. Mechanics/Spells/Chain Lightning.md|chain lightning]],\
...
- "desc": "Sul Khatesh has advantage on Constitution saving throws to maintain [[/5. Mechanics/Rules/Conditions.md#concentration|concentration]]."
...
- "desc": "Sul Khatesh conjures orbs of magical energy that plummet to the ground\
    ...
    \ affected only once. The area of each arcane burst then acts as an [[5. Mechanics/Spells/Antimagic Field.md|antimagic\
    \ field]] for 1 hour. Sul Khatesh and spells\
...
- "desc": "Sul Khatesh targets a creature within 120 feet of her who is concentrating\
    ...
    \ its [[/5. Mechanics/Rules/Conditions.md#concentration|concentration]] is broken\
...
- "desc": "Sul Khatesh whispers an arcane secret into the mind of a creature she can\
    ...
    \ saving throw but can't expend a spell slot is instead [[/5. Mechanics/Rules/Conditions.md#stunned|stunned]]\
    \ until the end of its next turn."
  "name": "Maddening Secrets (Costs 3 Actions)"
"source":
- "ERLW"
"image": "4. World Almanac/NPCs/token/sul-khatesh-erlw.webp"
```
^statblock
