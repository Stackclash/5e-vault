...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    ...
    \ and then buried in the ground rises the following night as a vampire spawn under\
    \ Strahd's control."
  "name": "Bite"
- "desc": "Strahd targets one humanoid he can see within 30 feet of him. If the target\
  ...
  "name": "Charm"
- "desc": "Strahd magically calls dice: 2d4|avg (2d4) swarms of bats or swarms\
    \ of rats, provided that the sun isn't up. While outdoors, Strahd can call dice:\
    \ 3d6|avg (3d6) wolves instead. The called creatures arrive in dice: 1d4|avg\
    \ (1d4) rounds, acting as allies of Strahd and obeying his spoken commands.\
    \ The beasts remain for 1 hour, until Strahd dies, or until he dismisses them\
    \ as a bonus action."
