...
---
# [Ludmilla Vilisevic](compendium\bestiary\npc/ludmilla-vilisevic-cos.md)
...
- "desc": "Ludmilla has the following flaws:\n\nForbiddance. Ludmilla can't enter\
    ...
    Sunlight Hypersensitivity. Ludmilla takes 20 radiant damage when it starts its\
...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    \ creature, or a creature that is grappled by Ludmilla, incapacitated, or restrained.\
    ...
    \ equal to the necrotic damage taken, and Ludmilla regains hit points equal to\
