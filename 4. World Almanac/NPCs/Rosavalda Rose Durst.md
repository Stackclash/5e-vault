...
> ![[4. World Almanac/NPCs/img/rosavalda-rose-durst.webp|cover hm-sm]] 
> ###### Bio
>  |
>  ---|---|
...
- "desc": "One humanoid that Rose can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is incapacitated and loses control of its body. Rose now controls\
    ...
    \nThe possession lasts until the body drops to 0 hit points, Rose ends it as a\
    \ bonus action, or Rose is turned or forced out by an effect like the dispel evil\
    \ and good spell. When the possession ends, Rose reappears in an unoccupied space\
...
"source":
- "CoS"
"image": "4. World Almanac/NPCs/token/rosavalda-rose-durst.png"
```
^statblock
