...
- "desc": "Melee Weapon Attack: +16 to hit, reach 15 ft., one target. Hit: 22\
    ...
    \ or be [[/5. Mechanics/Rules/Conditions.md#paralyzed|paralyzed]] until the start\
...
- "desc": "- Incite the Pack. Until the next initiative count 20, all gnolls and\
    ...
    \ and is [[/5. Mechanics/Rules/Conditions.md#restrained|restrained]] by being impaled\
