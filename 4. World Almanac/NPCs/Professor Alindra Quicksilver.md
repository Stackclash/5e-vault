...
condition: healthy
images:
  - z_Assets/NPCs/Alindra Quicksilver.png
relationships: []
tags:
  - npc
aliases:
  - Professor Alindra Quicksilver
pronounced: ah-LIN-drah QUICK-sil-ver
race: "[[5. Mechanics/Races/Gnome Rock.md|Gnome Rock]]"
gender: female
age: 80
...
description: |-
  ...
  She speaks rapidly, often jumping from one topic to another mid-sentence.
  Her laboratory is rumored to explode at least once every few months.
history: Alindra has pioneered several experimental magical alloys and once accidentally transformed herself into a marble statue for three days during a transmutation mishap.
personality: Energetic and endlessly curious.
ideal: Everything can change.
bond: Believes magic should constantly evolve.
flaw: Her experiments sometimes explode.
